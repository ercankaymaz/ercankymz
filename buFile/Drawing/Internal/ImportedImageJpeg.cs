...
// Type: PdfSharp.Drawing.Internal.ImportedImageJpeg
...
internal class ImportedImageJpeg(
  ...
  PdfDocument document) : ImportedImage(importer, (ImagePrivateData) data, document)
{
  ...
  {
    ImagePrivateDataDct data = (ImagePrivateDataDct) this.Data;
    return (ImageData) new ImageDataDct()
    {
      Data = data.Data,
      Length = data.Length
    };
