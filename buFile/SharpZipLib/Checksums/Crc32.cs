...
// Type: PdfSharp.SharpZipLib.Checksums.Crc32
...
{
  private const uint CrcSeed = 4294967295 /*0xFFFFFFFF*/;
  ...
  {
    return Crc32.CrcTable[((int) oldCrc ^ (int) value) & (int) byte.MaxValue] ^ oldCrc >> 8;
  }
  ...
  public void Update(byte[] buffer, int offset, int count)
  {
    ...
    if ((offset < 0 ? 1 : (offset + count > buffer.Length ? 1 : 0)) != 0)
