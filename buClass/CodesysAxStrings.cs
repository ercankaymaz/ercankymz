...
public class CodesysAxStrings : buSerilization
{
  ...
  {
    return $"Run : {this.strRuntimeVar.ToString()} , Set: {this.strSettingsVar.ToString()} , Exe: {this.strRunExe.ToString()} , Bool: {this.strRunBool.ToString()}";
  }
}
