...
public class SystemRuntime : buSerilization
{
  ...
  public TimeSpan OperationTime = new TimeSpan();
  ...
  {
    return $"Status: {this.Status.ToString()} ; Run: {this.Run.ToString()} ; HomingDone: {this.HomingDone.ToString()} ; Enabled: {this.Enabled.ToString()} ; Alarm Count: {this.AlarmCount.ToString()}";
  }
}
