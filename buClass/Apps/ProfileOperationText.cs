...
// Type: buClass.Apps.ProfileOperationText
...
public class ProfileOperationText : ProfileOperation
{
  ...
  {
    return $"{ProfileOperation.strText} X: {this.OperationData.Position.X.ToString("f2")} T: {this.Text.ToString()} - H: {this.Height.ToString("f3")}";
  }
}
