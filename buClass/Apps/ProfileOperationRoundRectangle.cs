...
// Type: buClass.Apps.ProfileOperationRoundRectangle
...
public class ProfileOperationRoundRectangle : ProfileOperation
{
  ...
  {
    return $"{ProfileOperation.strRoundRect} X: {this.OperationData.Position.X.ToString("f2")} W: {this.Width.ToString("f3")} - H: {this.Height.ToString("f3")} - R: {this.Radius.ToString("f3")}";
  }
}
