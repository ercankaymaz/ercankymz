...
// Type: buClass.Apps.ProfileOperationRectangle
...
public class ProfileOperationRectangle : ProfileOperation
{
  ...
  {
    return $"{ProfileOperation.strRectangle} X: {this.OperationData.Position.X.ToString("f2")} W: {this.Width.ToString("f3")} - H: {this.Height.ToString("f3")}";
  }
}
