...
// Type: buClass.Apps.DiemakerPerfoPropSettings
...
public class DiemakerPerfoPropSettings : buSerilization
{
  ...
  {
    return $"PerfoType : {this.PerfoType.ToString()} - MaleWidth : {this.MaleWidth.ToString()} - FamaleWidth : {this.FamaleWidth.ToString()} - Height : {this.PerfoHeight.ToString()}";
  }
}
