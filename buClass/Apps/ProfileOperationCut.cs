...
// Type: buClass.Apps.ProfileOperationCut
...
public class ProfileOperationCut : ProfileOperation
{
  ...
  {
    return $"{ProfileOperation.strCut} X: {this.OperationData.Position.X.ToString("f2")} W: {this.CutWidth.ToString("f3")} - H: {this.CutHeight.ToString("f3")}";
  }
}
