...
// Type: buClass.Apps.ProfileOperationDataHole
...
[Serializable]
public class ProfileOperationDataHole : buSerilization
{
  ...
  public override string ToString() => "Dia : " + this.HoleDiameter.ToString();
}
