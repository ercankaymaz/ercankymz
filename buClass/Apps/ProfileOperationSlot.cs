...
// Type: buClass.Apps.ProfileOperationSlot
...
public class ProfileOperationSlot : ProfileOperation
{
  ...
  public ProfileOperationSlot(ProfileOperationSlot data)
  {
  ...
  {
    return $"{ProfileOperation.strSlot} X: {this.OperationData.Position.X.ToString("f2")} W: {this.Width.ToString("f3")} - D: {this.Diameter.ToString("f3")}";
  }
}
