...
// Type: buClass.Apps.ProfileOperationEllipse
...
public class ProfileOperationEllipse : ProfileOperation
{
  ...
  public ProfileOperationEllipse()
  {
  }

  public ProfileOperationEllipse(ProfileOperationEllipse data)
  {
  ...
  {
    return $"{ProfileOperation.strEllipse} X: {this.OperationData.Position.X.ToString("f2")} W: {this.Width.ToString("f3")} - H: {this.Height.ToString("f3")}";
  }
}
