...
public class TuftData : buSerilization
{
  ...
  {
    this.PileHeight = pileH;
    this.StitchLength = stitchLen;
  ...
  {
    return $"{this.StitchMode.ToString()} - SL: {this.StitchLength.ToString()} - PH: {this.PileHeight.ToString()}";
  }
}
