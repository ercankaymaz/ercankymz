...
public class G1Properties : buSerilization
{
  ...
  public G1Properties(G1Properties data)
  {
    ...
    this.AuxCodeForFirstRisingG1 = new CodeUsing(data.AuxCodeForFirstRisingG1);
    this.AuxCodeForAllG1 = new CodeUsing(data.AuxCodeForAllG1);
  }
}
