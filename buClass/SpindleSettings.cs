...
[Serializable]
public class SpindleSettings : buSerilization
{
  public double SpindleOverride = 100.0;
  ...
  public SpindleSettings()
  {
  }

  public SpindleSettings(SpindleSettings data)
  {
  ...
  {
    return $"SpindleMinSpeed: {this.SpindleMinSpeed.ToString()} , SpindleMaxSpeed : {this.SpindleMaxSpeed.ToString()}";
  }
}
