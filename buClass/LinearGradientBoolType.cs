...
// Type: buClass.LinearGradientBoolType
...
public class LinearGradientBoolType : buSerilization
{
  ...
  {
    return $"EnableFirst: {buStatics.ColorToString(this.EnableFirstColor, ColorConvertType.Html)} - EnableSecond : {buStatics.ColorToString(this.EnableSecondColor, ColorConvertType.Html)}";
  }
}
