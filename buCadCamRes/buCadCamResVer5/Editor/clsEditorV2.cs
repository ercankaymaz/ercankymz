...
public class clsEditorV2
{
  ...
  public void cmdOpen(string FileName = "")
  {
    ...
    clsEditorV2.Class6 stateMachine = new clsEditorV2.Class6();
    ...
    // ISSUE: reference to a compiler-generated field
    stateMachine.asyncVoidMethodBuilder_0.Start<clsEditorV2.Class6>(ref stateMachine);
  }
  ...
  public void cmdSave()
  {
    ...
    if (buFile5.getFileExtension(saveFileDialog.FileName).ToLower() == ".dxf" | buFile5.getFileExtension(saveFileDialog.FileName).ToLower() == ".dwg")
      clsInit.cFile5.SaveDxfDwgAsyc((Design) clsItem.frmEditorV2.viewport, saveFileDialog.FileName);
  ...
  public void Sim_Tick(object sender, EventArgs e)
  {
    if (this.sortedEntitiesSimIndex >= 0 & this.sortedEntitiesSimIndex <= this.sortedEntitiesSimPoints.Count - 1)
    {
      ...
      {
        Entity entity1 = clsItem.frmEditorV2.viewport.Entities[clsItem.frmEditorV2.viewport.Entities.Count - 1];
        ...
        Entity entity2 = clsItem.frmEditorV2.viewport.Entities[clsItem.frmEditorV2.viewport.Entities.Count - 1];
  ...
  public void AddEllipse(UClick start, UClick end)
  {
    ...
    else
    {
      ...
      if ((rx <= 0.001 ? 0 : (ry > 0.001 ? 1 : 0)) != 0)
      {
        ...
        clsItem.frmEditorV2.viewport.Entities.Add((Entity) ellipse);
      }
      this.Reset();
    }
  }
  ...
  public void AddSlot(UClick first, UClick second, UClick third)
  {
    if (clsVar.varEditorRuntimeSet.isSketchMode)
    {
      ...
      Entity[] entityArray = clsItem.frmEditorV2.viewport.CurrentSketch.AddSlot(position1.X, position1.Y, position1.DistanceTo(position2), this.SlotRad(position1, position2, position3), (position2 - position1).AsVector.Angle);
  ...
  public void UndoBuffer()
  {
    ...
    for (int index = 0; index <= clsItem.frmEditorV2.viewport.Entities.Count - 1; ++index)
    {
      Entity entity = (Entity) clsItem.frmEditorV2.viewport.Entities[index].Clone();
      if (entity != null)
