...
public class ccVars
{
  public static ViewportCC activeViewport = (ViewportCC) null;
  public static actionTypeBU Action = actionTypeBU.None;
  public static List<buCadCamResVer5.Pages> Pages = new List<buCadCamResVer5.Pages>();
  ...
  public static MachineDef SimMachine = (MachineDef) null;
  public static KinematicBase5 KinematicOrjinal = (KinematicBase5) null;
  ...
  public static Brep.Face selectedFace = (Brep.Face) null;
  ...
  public static AxesEnableXYZ ConstantCoordinateEnable = new AxesEnableXYZ(false, false, false);
  ...
  public static Point3D[] pntDrawDynamicArr = (Point3D[]) null;
  public static List<buClass.ContourPoints> ContourPoints = new List<buClass.ContourPoints>();
  public static List<buEyeBaseVer5.ContourPoints5> ContourPoints5 = new List<buEyeBaseVer5.ContourPoints5>();
  ...
  public static List<List<Entity>> entityEdges = (List<List<Entity>>) null;
