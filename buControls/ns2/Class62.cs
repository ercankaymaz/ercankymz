...
internal sealed class Class62 : ExpandableObjectConverter
{
    ...
    Type destinationType)
  {
    ...
    {
      int num = ((buControlGround) value).TopHeight;
      string str1 = num.ToString();
      num = ((buControlGround) value).BottomHeight;
      string str2 = num.ToString();
      obj = (object) $"{str1} , {str2}";
    }
    else
    {
