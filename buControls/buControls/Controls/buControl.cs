...
// Type: buControls.Controls.buControl
...
public abstract class buControl : Control
{
  public static int SecurityActive = 1;
  ...
  private buControlAux buControlAux_0 = new buControlAux();
  ...
  private buControlMotion buControlMotion_0 = new buControlMotion();

  [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
  [Browsable(true)]
  public buControlAux Aux
  {
    get => this.buControlAux_0;
    set
    {
      this.buControlAux_0 = value;
      if (this.Parent == null)
        return;
  ...
  [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
  [Browsable(true)]
  public buControlMotion Motion
  {
    get => this.buControlMotion_0;
    set
    {
      this.buControlMotion_0 = value;
      if (this.Parent == null)
        return;
      this.Parent.Invalidate();
    }
  ...
  public int ImageIndex
  {
    get
    {
      return this.imageList_0 != null ? (this.int_0 < this.imageList_0.Images.Count ? this.int_0 : -1) : -1;
    }
    set
    {
      if (value < -1)
