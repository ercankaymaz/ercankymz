...
// Type: buControls.Controls.buPanel
...
public class buPanel : buContainerControl
{
  ...
  {
    add => this.Events.AddHandler(buPanel.object_1, (Delegate) value);
    remove => this.Events.RemoveHandler(buPanel.object_1, (Delegate) value);
  }
  ...
  {
    EventHandler eventHandler = (EventHandler) this.Events[buPanel.object_1];
  ...
  protected override void OnPaint(PaintEventArgs e)
  {
    ...
    if (this.Width > 0 & this.Height > 0)
    {
      ...
      if (this.Enabled)
        ...
        ControlPaint.DrawStringDisabled(e.Graphics, this.Text, this.Font, this.BackColor, rectangleFromImage, ControlGeometry.AlignmentToStringFormat(this.Display.Fonts.Alignment));
