...
// Type: buControls.Controls.buLabel
...
public class buLabel : buControl
{
  ...
  public buLabel()
  {
    ...
    Class39.smethod_349(this.UseMnemonic, this);
  ...
  {
    add => this.Events.AddHandler(buLabel.object_1, (Delegate) value);
    remove => this.Events.RemoveHandler(buLabel.object_1, (Delegate) value);
  }
  ...
  public bool UseMnemonic
  {
    ...
    set
    {
      if (this.bool_0 == value)
        return;
      this.bool_0 = value;
      Class39.smethod_349(this.bool_0, this);
      this.Invalidate();
    }
  }
  ...
  protected override void OnClick(EventArgs e)
  {
    ...
    {
      buControlCommands.smethod_0(nameof (buLabel));
      if (!buControlCommands.bool_0)
      {
  ...
  {
    EventHandler eventHandler = (EventHandler) this.Events[buLabel.object_1];
  ...
  protected override void OnPaint(PaintEventArgs e)
  {
    ...
    local = new RectangleF((float) left1, (float) top1, (float) width1, (float) height1);
    ...
    rectDraw rectDraw = new rectDraw(new RectangleF((float) left2, (float) top2, (float) width2, (float) height2), RoundRectangleType.RoundRectAll);
    ...
    if (this.Width > 0 & this.Height > 0)
    {
      ...
      if (this.Enabled)
        ...
        ControlPaint.DrawStringDisabled(e.Graphics, this.Text, this.Display.Fonts.Font, this.Display.DisableColor, rectDraw.rect, ControlGeometry.AlignmentToStringFormat(this.Display.Fonts.Alignment));
      this.DrawImage(e.Graphics, this.Image, this.ClientRectangle, this.ImageAlign);
      if (this.FontAngle != 0)
        ControlGeometry.drawString(rectDraw.rectText, Text, (float) this.FontAngle, this.Display, this.hotkeyPrefix_0, ref graphics);
      else
        ControlGeometry.drawString(rectDraw.rectText, Text, this.Display, this.hotkeyPrefix_0, ref graphics);
    }
