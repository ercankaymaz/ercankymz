...
// Type: buControls.Forms.buControlForms.Marble.F_PerpendicularCut
...
public class F_PerpendicularCut : Form
{
  ...
  {
    Class39.smethod_187(this);
    this.spn_depth.Click += new EventHandler(this.spn_lengthver_Click);
    this.spn_itemcount1_hor.Click += new EventHandler(this.spn_lengthver_Click);
    this.spn_itemcount2_hor.Click += new EventHandler(this.spn_lengthver_Click);
    this.spn_itemcount3_hor.Click += new EventHandler(this.spn_lengthver_Click);
    this.spn_itemcount4_hor.Click += new EventHandler(this.spn_lengthver_Click);
    this.spn_itemcount5_hor.Click += new EventHandler(this.spn_lengthver_Click);
    this.spn_itemcount1_ver.Click += new EventHandler(this.spn_lengthver_Click);
    this.spn_itemcount2_ver.Click += new EventHandler(this.spn_lengthver_Click);
    this.spn_itemcount3_ver.Click += new EventHandler(this.spn_lengthver_Click);
    this.spn_itemcount4_ver.Click += new EventHandler(this.spn_lengthver_Click);
    this.spn_itemcount5_ver.Click += new EventHandler(this.spn_lengthver_Click);
    this.spn_itemEA1_hor.Click += new EventHandler(this.spn_lengthver_Click);
    this.spn_itemEA2_hor.Click += new EventHandler(this.spn_lengthver_Click);
    this.spn_itemEA3_hor.Click += new EventHandler(this.spn_lengthver_Click);
    this.spn_itemEA4_hor.Click += new EventHandler(this.spn_lengthver_Click);
    this.spn_itemEA5_hor.Click += new EventHandler(this.spn_lengthver_Click);
    this.spn_itemEA1_ver.Click += new EventHandler(this.spn_lengthver_Click);
    this.spn_itemEA2_ver.Click += new EventHandler(this.spn_lengthver_Click);
    this.spn_itemEA3_ver.Click += new EventHandler(this.spn_lengthver_Click);
    this.spn_itemEA4_ver.Click += new EventHandler(this.spn_lengthver_Click);
    this.spn_itemEA5_ver.Click += new EventHandler(this.spn_lengthver_Click);
    this.spn_itemlen1_hor.Click += new EventHandler(this.spn_lengthver_Click);
    this.spn_itemlen2_hor.Click += new EventHandler(this.spn_lengthver_Click);
    this.spn_itemlen3_hor.Click += new EventHandler(this.spn_lengthver_Click);
    this.spn_itemlen4_hor.Click += new EventHandler(this.spn_lengthver_Click);
    this.spn_itemlen5_hor.Click += new EventHandler(this.spn_lengthver_Click);
    this.spn_itemlen1_ver.Click += new EventHandler(this.spn_lengthver_Click);
    this.spn_itemlen2_ver.Click += new EventHandler(this.spn_lengthver_Click);
    this.spn_itemlen3_ver.Click += new EventHandler(this.spn_lengthver_Click);
    this.spn_itemlen4_ver.Click += new EventHandler(this.spn_lengthver_Click);
    this.spn_itemlen5_ver.Click += new EventHandler(this.spn_lengthver_Click);
    this.spn_itemSA1_hor.Click += new EventHandler(this.spn_lengthver_Click);
    this.spn_itemSA2_hor.Click += new EventHandler(this.spn_lengthver_Click);
    this.spn_itemSA3_hor.Click += new EventHandler(this.spn_lengthver_Click);
    this.spn_itemSA4_hor.Click += new EventHandler(this.spn_lengthver_Click);
    this.spn_itemSA5_hor.Click += new EventHandler(this.spn_lengthver_Click);
    this.spn_itemSA1_ver.Click += new EventHandler(this.spn_lengthver_Click);
    this.spn_itemSA2_ver.Click += new EventHandler(this.spn_lengthver_Click);
    this.spn_itemSA3_ver.Click += new EventHandler(this.spn_lengthver_Click);
    this.spn_itemSA4_ver.Click += new EventHandler(this.spn_lengthver_Click);
    this.spn_itemSA5_ver.Click += new EventHandler(this.spn_lengthver_Click);
    this.spn_lengthhor.Click += new EventHandler(this.spn_lengthver_Click);
    this.spn_lengthver.Click += new EventHandler(this.spn_lengthver_Click);
  }
  ...
  public void Init()
  {
    try
    {
      ...
      this.spn_lengthhor.Value = this.varPerpendicularCut.CutHorizontalLength;
      this.spn_lengthver.Value = this.varPerpendicularCut.CutVerticalLength;
      ...
      Class39.smethod_331(this);
      Class39.smethod_482(this);
      this.LoadLanguage();
      this.bool_1 = true;
    }
    catch (Exception ex)
  ...
  public void LoadLanguage()
  {
    try
    {
      if (F_PerpendicularCut.Captions.Count <= 20)
        return;
      this.buGround_0.Text = F_PerpendicularCut.Captions[0];
      this.buButton_12.Text = F_PerpendicularCut.Captions[1];
      this.buButton_14.Text = F_PerpendicularCut.Captions[1];
      this.buButton_11.Text = F_PerpendicularCut.Captions[2];
      this.buButton_13.Text = F_PerpendicularCut.Captions[2];
      this.spn_lengthhor.Caption.Caption = F_PerpendicularCut.Captions[3];
      this.spn_lengthver.Caption.Caption = F_PerpendicularCut.Captions[3];
      this.buLabel_0.Text = F_PerpendicularCut.Captions[4];
      this.buButton_15.Text = F_PerpendicularCut.Captions[5];
      this.buButton_2.Text = F_PerpendicularCut.Captions[6];
      this.buButton_3.Text = F_PerpendicularCut.Captions[7];
      this.tabPage_0.Text = F_PerpendicularCut.Captions[8];
      this.tabPage_1.Text = F_PerpendicularCut.Captions[9];
      this.buLabel_1.Text = F_PerpendicularCut.Captions[10];
      this.buLabel_12.Text = F_PerpendicularCut.Captions[10];
      this.buLabel_9.Text = F_PerpendicularCut.Captions[11];
      this.buLabel_20.Text = F_PerpendicularCut.Captions[11];
      this.buLabel_8.Text = F_PerpendicularCut.Captions[12];
      this.buLabel_19.Text = F_PerpendicularCut.Captions[12];
      this.buLabel_7.Text = F_PerpendicularCut.Captions[13];
      this.buLabel_18.Text = F_PerpendicularCut.Captions[13];
      this.buButton_6.Text = F_PerpendicularCut.Captions[14];
      this.buButton_4.Text = F_PerpendicularCut.Captions[14];
      this.buLabel_24.Text = F_PerpendicularCut.Captions[15];
      this.buLabel_21.Text = F_PerpendicularCut.Captions[15];
      this.buButton_16.Text = F_PerpendicularCut.Captions[16 /*0x10*/];
      this.buButton_17.Text = F_PerpendicularCut.Captions[17];
      this.buLabel_10.Text = F_PerpendicularCut.Captions[18];
      this.buLabel_11.Text = F_PerpendicularCut.Captions[19];
      this.buButton_5.Text = F_PerpendicularCut.Captions[20];
    }
    catch (Exception ex)
    {
    }
  ...
  internal void method_2(object sender, EventArgs e)
  {
    ...
    if (control2.Name == this.buButton_16.Name)
    {
      ...
      if (saveFileDialog.ShowDialog() == DialogResult.OK)
      {
        ...
        Class39.smethod_632(this);
        Class39.smethod_635(this);
    ...
    if (control2.Name == this.buButton_18.Name)
    {
      OpenFileDialog openFileDialog = new OpenFileDialog();
      openFileDialog.InitialDirectory = this.pathFiles;
    ...
    if (control2.Name == this.buButton_11.Name && this.bool_3)
    {
      ...
      this.spn_lengthhor.Value = buControlCoreClass.cVector.Length3D(this.StartPosHor, this.EndPosHor);
      // ISSUE: reference to a compiler-generated field
    ...
    if (control2.Name == this.buButton_13.Name && this.bool_2)
    {
      ...
      this.spn_lengthver.Value = buControlCoreClass.cVector.Length3D(this.StartPosVer, this.EndPosVer);
      // ISSUE: reference to a compiler-generated field
      if (this.marbleSetStartPositionHandler_1 != null)
      {
        // ISSUE: reference to a compiler-generated field
  ...
  private void spn_lengthver_Click(object sender, EventArgs e)
  {
    try
    {
      if (!AppBool.TouchPad)
