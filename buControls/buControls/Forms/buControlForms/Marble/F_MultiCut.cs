...
// Type: buControls.Forms.buControlForms.Marble.F_MultiCut
...
public class F_MultiCut : Form
{
  ...
  public F_MultiCut()
  {
    Class39.smethod_716(this);
    this.spn_depth.Click += new EventHandler(this.spn_length_Click);
    this.spn_itemcount1.Click += new EventHandler(this.spn_length_Click);
    this.spn_itemcount2.Click += new EventHandler(this.spn_length_Click);
    this.spn_itemcount3.Click += new EventHandler(this.spn_length_Click);
    this.spn_itemcount4.Click += new EventHandler(this.spn_length_Click);
    this.spn_itemcount5.Click += new EventHandler(this.spn_length_Click);
    this.spn_itemEA1.Click += new EventHandler(this.spn_length_Click);
    this.spn_itemEA2.Click += new EventHandler(this.spn_length_Click);
    this.spn_itemEA3.Click += new EventHandler(this.spn_length_Click);
    this.spn_itemEA4.Click += new EventHandler(this.spn_length_Click);
    this.spn_itemEA5.Click += new EventHandler(this.spn_length_Click);
    this.spn_itemlen1.Click += new EventHandler(this.spn_length_Click);
    this.spn_itemlen2.Click += new EventHandler(this.spn_length_Click);
    this.spn_itemlen3.Click += new EventHandler(this.spn_length_Click);
    this.spn_itemlen4.Click += new EventHandler(this.spn_length_Click);
    this.spn_itemlen5.Click += new EventHandler(this.spn_length_Click);
    this.spn_itemSA1.Click += new EventHandler(this.spn_length_Click);
    this.spn_itemSA2.Click += new EventHandler(this.spn_length_Click);
    this.spn_itemSA3.Click += new EventHandler(this.spn_length_Click);
    this.spn_itemSA4.Click += new EventHandler(this.spn_length_Click);
    this.spn_itemSA5.Click += new EventHandler(this.spn_length_Click);
  ...
  public void LoadLanguage()
  {
    try
    {
      if (F_MultiCut.Captions.Count <= 18)
        return;
      this.buGround_0.Text = F_MultiCut.Captions[0];
      this.buButton_9.Text = F_MultiCut.Captions[1];
      this.buButton_8.Text = F_MultiCut.Captions[2];
      this.spn_length.Caption.Caption = F_MultiCut.Captions[3];
      this.buLabel_0.Text = F_MultiCut.Captions[4];
      this.buButton_10.Text = F_MultiCut.Captions[5];
      this.buButton_2.Text = F_MultiCut.Captions[6];
      this.buButton_3.Text = F_MultiCut.Captions[7];
      this.buButton_11.Text = F_MultiCut.Captions[8];
      this.buButton_12.Text = F_MultiCut.Captions[9];
      this.buLabel_1.Text = F_MultiCut.Captions[10];
      this.buLabel_9.Text = F_MultiCut.Captions[11];
      this.buLabel_8.Text = F_MultiCut.Captions[12];
      this.buLabel_7.Text = F_MultiCut.Captions[13];
      this.buButton_15.Text = F_MultiCut.Captions[14];
      this.buLabel_10.Text = F_MultiCut.Captions[15];
      this.buButton_13.Text = F_MultiCut.Captions[16 /*0x10*/];
      this.buButton_14.Text = F_MultiCut.Captions[17];
      this.buButton_7.Text = F_MultiCut.Captions[18];
    }
    catch (Exception ex)
    {
    }
  ...
  internal void method_2(object sender, EventArgs e)
  {
    ...
    if (control2.Name == this.buButton_15.Name)
    {
      ...
      this.spn_itemlen1.Value = 0.0;
      this.spn_itemlen2.Value = 0.0;
      this.spn_itemlen3.Value = 0.0;
      this.spn_itemlen4.Value = 0.0;
      this.spn_itemlen5.Value = 0.0;
    }
