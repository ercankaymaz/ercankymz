...
// Type: buControls.Forms.WinControlForms.Marble.F_CamMarbleClosed
...
public class F_CamMarbleClosed : Form
{
  ...
  public F_CamMarbleClosed() => Class39.smethod_406(this);
  ...
  public void Init()
  {
    ...
    buGeneral.GetEnumTypeValues((object) this.camPars.Offsets.ClosedContour, ref EnumItems1);
    buControlCommands.ComboboxAddItem(EnumItems1, Convert.ToInt32((object) this.camPars.Offsets.ClosedContour), ref this.comboBox_1);
    ArrayList EnumItems2 = new ArrayList();
    buGeneral.GetEnumTypeValues((object) this.camPars.Operations.Direction, ref EnumItems2);
    buControlCommands.ComboboxAddItem(EnumItems2, Convert.ToInt32((object) this.camPars.Operations.Direction), ref this.comboBox_0);
    ...
    this.numericUpDown_3.Value = (Decimal) this.camPars.Offsets.Offset;
    this.checkBox_3.Checked = this.Operation.ReverseAngleA;
    ...
    this.numericUpDown_14.Value = (Decimal) this.camPars.Distances.Safe;
    this.numericUpDown_21.Value = (Decimal) this.camPars.Distances.StepUp;
    ArrayList EnumItems3 = new ArrayList();
    buGeneral.GetEnumTypeValues((object) this.camPars.LeadIn.LeadType, ref EnumItems3);
    buControlCommands.ComboboxAddItem(EnumItems3, Convert.ToInt32((object) this.camPars.LeadIn.LeadType), ref this.comboBox_3);
    ArrayList EnumItems4 = new ArrayList();
    buGeneral.GetEnumTypeValues((object) this.camPars.LeadOut.LeadType, ref EnumItems4);
    buControlCommands.ComboboxAddItem(EnumItems4, Convert.ToInt32((object) this.camPars.LeadOut.LeadType), ref this.comboBox_2);
    this.numericUpDown_12.Value = (Decimal) this.camPars.LeadIn.ExtendLength;
    this.numericUpDown_13.Value = (Decimal) this.camPars.LeadIn.ArcRadius;
    this.numericUpDown_9.Value = (Decimal) this.camPars.LeadIn.ArcSweepAngle;
    this.numericUpDown_7.Value = (Decimal) this.camPars.LeadIn.TangentAngle;
    this.numericUpDown_5.Value = (Decimal) this.camPars.LeadIn.Length;
    this.numericUpDown_10.Value = (Decimal) this.camPars.LeadOut.ExtendLength;
    this.numericUpDown_11.Value = (Decimal) this.camPars.LeadOut.ArcRadius;
    this.numericUpDown_8.Value = (Decimal) this.camPars.LeadOut.ArcSweepAngle;
    this.numericUpDown_6.Value = (Decimal) this.camPars.LeadOut.TangentAngle;
    this.numericUpDown_4.Value = (Decimal) this.camPars.LeadOut.Length;
    ...
    if (this.comboBox_3.SelectedIndex == 1)
    {
    ...
    this.numericUpDown_17.Value = (Decimal) this.camPars.Steps.StartValue;
    this.numericUpDown_16.Value = (Decimal) this.camPars.Steps.EndValue;
    this.numericUpDown_15.Value = (Decimal) this.camPars.Steps.Count;
    this.checkBox_2.Checked = this.camPars.Steps.Enable;
    this.Refresh();
    this.Properties.Result = DialogResult.None;
    this.Properties.Inited = true;
    this.ControlUpdate();
    Class39.smethod_503(this);
  }
  ...
  public void ControlUpdate()
  {
    ...
    this.panel_12.Enabled = this.checkBox_2.Checked;
    this.panel_11.Enabled = this.checkBox_2.Checked;
    this.panel_10.Enabled = this.checkBox_2.Checked;
  ...
  internal void method_4(object sender, EventArgs e)
  {
    ...
    if (!this.Properties.Inited)
      return;
    if (control2.Name == this.comboBox_3.Name)
      this.ControlUpdate();
  ...
  internal void method_5(object sender, EventArgs e)
  {
    ...
    if (control2.Name == this.checkBox_2.Name)
      this.ControlUpdate();
    if (control2.Name == this.checkBox_1.Name)
      this.ControlUpdate();
  ...
  internal void method_6(object sender, EventArgs e)
  {
    Control control1 = new Control();
    Control control2 = (Control) sender;
    if (!this.Properties.Inited || !(control2.Name == this.comboBox_1.Name))
      return;
    this.ControlUpdate();
  }
