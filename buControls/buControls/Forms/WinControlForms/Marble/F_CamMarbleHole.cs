...
// Type: buControls.Forms.WinControlForms.Marble.F_CamMarbleHole
...
public class F_CamMarbleHole : Form
{
  ...
  public F_CamMarbleHole() => Class39.smethod_792(this);
  ...
  public void Init()
  {
    ...
    this.numericUpDown_8.Value = (Decimal) this.Operation.OffsetX;
    this.numericUpDown_9.Value = (Decimal) this.Operation.OffsetY;
