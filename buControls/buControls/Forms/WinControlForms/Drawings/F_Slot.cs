...
// Type: buControls.Forms.WinControlForms.Drawings.F_Slot
...
public class F_Slot : Form
{
  ...
  public F_Slot() => Class39.smethod_827(this);

  public void Init()
  {
    this.bool_0 = false;
    this.numericUpDown_3.Value = (Decimal) this.Slot.Width;
    this.numericUpDown_2.Value = (Decimal) this.Slot.Height;
    this.numericUpDown_4.Value = (Decimal) this.Slot.Rotation;
    this.numericUpDown_1.Value = (Decimal) this.Slot.BasePoint.X;
    this.numericUpDown_0.Value = (Decimal) this.Slot.BasePoint.Y;
    this.Result = DialogResult.None;
    this.bool_0 = true;
    Class39.smethod_833(this);
  }
  ...
  public void Init(ShapeData slot)
  {
    ...
    if (slot.GetType() == typeof (SlotData))
      this.Slot = new SlotData((SlotData) slot);
    this.numericUpDown_3.Value = (Decimal) this.Slot.Width;
    this.numericUpDown_2.Value = (Decimal) this.Slot.Height;
    this.numericUpDown_4.Value = (Decimal) this.Slot.Rotation;
    this.numericUpDown_1.Value = (Decimal) this.Slot.BasePoint.X;
  ...
  public void Apply()
  {
    this.Slot.Width = (double) this.numericUpDown_3.Value;
    this.Slot.Height = (double) this.numericUpDown_2.Value;
    this.Slot.Rotation = (double) this.numericUpDown_4.Value;
    this.Slot.BasePoint = new Pnt3D((double) this.numericUpDown_1.Value, (double) this.numericUpDown_0.Value, 0.0);
  }
