...
// Type: buControls.Forms.WinControlForms.Drawings.F_RectangleRound
...
public class F_RectangleRound : Form
{
  ...
  public F_RectangleRound() => Class39.smethod_723(this);

  public void Init()
  {
    this.bool_0 = false;
    this.numericUpDown_3.Value = (Decimal) this.Rect.Height;
    this.numericUpDown_4.Value = (Decimal) this.Rect.Width;
    this.numericUpDown_0.Value = (Decimal) this.Rect.Radius;
    this.numericUpDown_2.Value = (Decimal) this.Rect.CornerPoint.X;
    this.numericUpDown_1.Value = (Decimal) this.Rect.CornerPoint.Y;
    this.numericUpDown_5.Value = (Decimal) this.Rect.Rotation;
  ...
  public void Init(ShapeData rect)
  {
    ...
    if (rect.GetType() == typeof (RectangleCornerFilletData))
      this.Rect = new RectangleCornerFilletData((RectangleCornerFilletData) rect);
    this.numericUpDown_3.Value = (Decimal) this.Rect.Height;
    this.numericUpDown_4.Value = (Decimal) this.Rect.Width;
    this.numericUpDown_0.Value = (Decimal) this.Rect.Radius;
    this.numericUpDown_2.Value = (Decimal) this.Rect.CornerPoint.X;
  ...
  public void Apply()
  {
    this.Rect.Height = (double) this.numericUpDown_3.Value;
    this.Rect.Width = (double) this.numericUpDown_4.Value;
    this.Rect.Rotation = (double) this.numericUpDown_5.Value;
    this.Rect.Radius = (double) this.numericUpDown_0.Value;
    this.Rect.CornerPoint = new Pnt3D((double) this.numericUpDown_2.Value, (double) this.numericUpDown_1.Value, 0.0);
  }
