...
// Type: buControls.Forms.WinControlForms.Layer.F_LayerListSelectable
...
public class F_LayerListSelectable : Form
{
  ...
  public F_LayerListSelectable() => Class39.smethod_768(this);
  ...
  public void Init()
  {
    ...
    Class39.smethod_746(this);
    Class39.smethod_386(this);
  ...
  internal void method_0(object sender, EventArgs e)
  {
    ...
    {
      this.btn_ok.Focus();
      Class39.smethod_540(this);
      for (int index = 0; index <= this.checkedListBox_0.Items.Count - 1; ++index)
        this.Layers[index].Enable = this.checkedListBox_0.GetItemCheckState(index) == CheckState.Checked;
