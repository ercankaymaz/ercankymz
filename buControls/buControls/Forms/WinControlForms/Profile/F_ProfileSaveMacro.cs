...
// Type: buControls.Forms.WinControlForms.Profile.F_ProfileSaveMacro
...
public class F_ProfileSaveMacro : Form
{
  ...
  public F_ProfileSaveMacro() => Class39.smethod_112(this);
  ...
  public void Init()
  {
    ...
    this.checkBox_0.Checked = this.Options.MoveToXZeroPoint;
    if (this.Options.MotoToXZeroFromCenter)
      this.radioButton_0.Checked = true;
    else
      this.radioButton_1.Checked = true;
    for (int index = 0; index <= this.Operations.Count - 1; ++index)
      this.checkedListBox_0.Items.Add((object) this.Operations[index].OperationData.OperationType.ToString(), true);
  ...
  public void LoadLangueage()
  {
    ...
    try
    {
      if (F_ProfileSaveMacro.Captions.Count >= 1)
        ;
    }
    catch (Exception ex)
    {
