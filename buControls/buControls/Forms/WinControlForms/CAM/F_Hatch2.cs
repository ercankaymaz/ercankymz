...
// Type: buControls.Forms.WinControlForms.CAM.F_Hatch2
...
public class F_Hatch2 : Form
{
  ...
  public F_Hatch2() => Class39.smethod_367(this);
  ...
  public void Init()
  {
    ...
    int num3 = 0;
    this.panel_10.Visible = this.DistanceEnable.Safe;
    ...
    {
      this.panel_7.Top = 6 + num3 * 32 /*0x20*/;
      int num4 = num3 + 1;
    }
    int num5 = 0;
    this.comboBox_0.Visible = this.StepEnable.Type;
    this.panel_15.Visible = this.StepEnable.StartValue;
    if (this.StepEnable.StartValue)
    {
      this.panel_15.Top = 40 + num5 * 32 /*0x20*/;
      ++num5;
    }
    this.panel_14.Visible = this.StepEnable.EndValue;
    if (this.StepEnable.EndValue)
    {
      this.panel_14.Top = 40 + num5 * 32 /*0x20*/;
      ++num5;
    }
    this.panel_12.Visible = this.StepEnable.Step;
    if (this.StepEnable.Step)
    {
      this.panel_12.Top = 40 + num5 * 32 /*0x20*/;
      ++num5;
    }
    this.panel_11.Visible = this.StepEnable.Count;
    if (this.StepEnable.Count)
    {
      this.panel_11.Top = 40 + num5 * 32 /*0x20*/;
      ++num5;
    }
    this.panel_13.Visible = this.StepEnable.Distance;
    if (this.StepEnable.Distance)
    {
      this.panel_13.Top = 40 + num5 * 32 /*0x20*/;
      int num6 = num5 + 1;
    }
    int num7 = 0;
    this.comboBox_1.Visible = this.LeadInOutEnable.LeadType;
    this.panel_23.Visible = this.LeadInOutEnable.Length;
    if (this.LeadInOutEnable.Length)
    {
      this.panel_23.Top = 40 + num7 * 32 /*0x20*/;
      ++num7;
    }
    this.panel_22.Visible = this.LeadInOutEnable.TangentAngle;
    if (this.LeadInOutEnable.TangentAngle)
    {
      this.panel_22.Top = 40 + num7 * 32 /*0x20*/;
      ++num7;
    }
    this.panel_21.Visible = this.LeadInOutEnable.ArcRadius;
    if (this.LeadInOutEnable.ArcRadius)
    {
      this.panel_21.Top = 40 + num7 * 32 /*0x20*/;
      ++num7;
    }
    this.panel_20.Visible = this.LeadInOutEnable.ArcSweepAngle;
    if (this.LeadInOutEnable.ArcSweepAngle)
    {
      this.panel_20.Top = 40 + num7 * 32 /*0x20*/;
      int num8 = num7 + 1;
    }
    int num9 = 0;
    this.comboBox_2.Visible = this.LeadInOutEnable.LeadType;
    this.panel_27.Visible = this.LeadInOutEnable.Length;
    if (this.LeadInOutEnable.Length)
    {
      this.panel_27.Top = 40 + num9 * 32 /*0x20*/;
      ++num9;
    }
    this.panel_26.Visible = this.LeadInOutEnable.TangentAngle;
    if (this.LeadInOutEnable.TangentAngle)
    {
      this.panel_26.Top = 40 + num9 * 32 /*0x20*/;
      ++num9;
    }
    this.panel_25.Visible = this.LeadInOutEnable.ArcRadius;
    if (this.LeadInOutEnable.ArcRadius)
    {
      this.panel_25.Top = 40 + num9 * 32 /*0x20*/;
      ++num9;
    }
    this.panel_24.Visible = this.LeadInOutEnable.ArcSweepAngle;
    if (this.LeadInOutEnable.ArcSweepAngle)
    {
      this.panel_24.Top = 40 + num9 * 32 /*0x20*/;
      int num10 = num9 + 1;
    }
    this.numericUpDown_14.Value = (Decimal) this.Hatch.TotalWidth;
    this.numericUpDown_17.Value = (Decimal) this.Hatch.OperationZ;
    this.numericUpDown_15.Value = (Decimal) this.Hatch.CutStep;
    this.numericUpDown_16.Value = (Decimal) this.Hatch.CutLength;
    if (this.Hatch.CuttingDirection == CamHatchCuttingDirection.XDirection)
    {
      this.radioButton_0.Checked = true;
      this.radioButton_1.Checked = false;
    }
    if (this.Hatch.CuttingDirection == CamHatchCuttingDirection.YDirection)
    {
      this.radioButton_0.Checked = false;
      this.radioButton_1.Checked = true;
    }
    if (this.Hatch.CuttingModes == CamHatchCuttingMode.Forward)
    {
      this.radioButton_4.Checked = true;
      this.radioButton_3.Checked = false;
      this.radioButton_2.Checked = false;
    }
    if (this.Hatch.CuttingModes == CamHatchCuttingMode.ForwardBackward)
    {
      this.radioButton_4.Checked = false;
      this.radioButton_3.Checked = true;
      this.radioButton_2.Checked = false;
    }
    if (this.Hatch.CuttingModes == CamHatchCuttingMode.ForwardNextBackward)
    {
      this.radioButton_4.Checked = false;
      this.radioButton_3.Checked = false;
      this.radioButton_2.Checked = true;
    }
    this.numericUpDown_5.Value = (Decimal) this.Velocity.Feed;
    this.numericUpDown_0.Value = (Decimal) this.Velocity.BackwardFeed;
    this.numericUpDown_4.Value = (Decimal) this.Velocity.Plunge;
    this.numericUpDown_2.Value = (Decimal) this.Velocity.Finish;
    this.numericUpDown_3.Value = (Decimal) this.Velocity.Leave;
    this.numericUpDown_1.Value = (Decimal) this.Velocity.Rapid;
    this.numericUpDown_7.Value = (Decimal) this.Distance.Air;
    this.checkBox_0.Checked = this.Distance.IncrementalSafe;
    this.numericUpDown_8.Value = (Decimal) this.Distance.Safe;
    this.numericUpDown_6.Value = (Decimal) this.Distance.StepUp;
    ArrayList EnumItems = new ArrayList();
    buGeneral.GetEnumTypeValues((object) this.Step.StepType, ref EnumItems);
    buControlCommands.ComboboxAddItem(EnumItems, Convert.ToInt32((object) this.Step.StepType), ref this.comboBox_0);
    this.checkBox_1.Checked = this.Step.Enable;
    this.numericUpDown_9.Value = (Decimal) this.Step.Count;
    this.numericUpDown_11.Value = (Decimal) this.Step.Distance;
    this.numericUpDown_12.Value = (Decimal) this.Step.EndValue;
    this.numericUpDown_13.Value = (Decimal) this.Step.StartValue;
    this.numericUpDown_10.Value = (Decimal) this.Step.Step;
    EnumItems = new ArrayList();
    buGeneral.GetEnumTypeValues((object) this.LeadIn.LeadType, ref EnumItems);
    buControlCommands.ComboboxAddItem(EnumItems, Convert.ToInt32((object) this.LeadIn.LeadType), ref this.comboBox_1);
    EnumItems = new ArrayList();
    buGeneral.GetEnumTypeValues((object) this.LeadOut.LeadType, ref EnumItems);
    buControlCommands.ComboboxAddItem(EnumItems, Convert.ToInt32((object) this.LeadOut.LeadType), ref this.comboBox_2);
    this.checkBox_2.Checked = this.LeadIn.Enable;
    this.numericUpDown_19.Value = (Decimal) this.LeadIn.ArcRadius;
    this.numericUpDown_18.Value = (Decimal) this.LeadIn.ArcSweepAngle;
    this.numericUpDown_21.Value = (Decimal) this.LeadIn.Length;
    this.numericUpDown_20.Value = (Decimal) this.LeadIn.TangentAngle;
    this.checkBox_3.Checked = this.LeadOut.Enable;
    this.numericUpDown_23.Value = (Decimal) this.LeadOut.ArcRadius;
    this.numericUpDown_22.Value = (Decimal) this.LeadOut.ArcSweepAngle;
    this.numericUpDown_25.Value = (Decimal) this.LeadOut.Length;
    this.numericUpDown_24.Value = (Decimal) this.LeadOut.TangentAngle;
