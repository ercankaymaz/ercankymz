...
// Type: buControls.Forms.WinControlForms.Grinding.F_CamGrindingContourSawOpen
...
public class F_CamGrindingContourSawOpen : Form
{
  ...
  public F_CamGrindingContourSawOpen() => Class39.smethod_672(this);
  ...
  public void Init()
  {
    ...
    buControlCommands.ComboboxAddItem(EnumItems, Convert.ToInt32((object) this.camPars.Offsets.OpenContourOld), ref this.comboBox_2);
    this.comboBox_2.Items.RemoveAt(4);
    this.comboBox_2.Items.RemoveAt(3);
