...
// Type: buControls.Forms.WinControlForms.Grinding.F_GrindingAddVacuum
...
public class F_GrindingAddVacuum : Form
{
  ...
  public F_GrindingAddVacuum() => Class39.smethod_93(this);
  ...
  public void Init()
  {
    ...
    this.numericUpDown_1.Value = (Decimal) this.Operation.VacuumThickness;
    this.numericUpDown_2.Value = (Decimal) this.Operation.VacuumHeight;
    this.numericUpDown_0.Value = (Decimal) this.Operation.VacuumDiameter;
    this.Refresh();
    this.Properties.Result = DialogResult.None;
    this.Properties.Inited = true;
    Class39.smethod_42(this);
  }
