...
// Type: buControls.Forms.WinControlForms.Grinding.F_CamGrindingPocket
...
public class F_CamGrindingPocket : Form
{
  ...
  public F_CamGrindingPocket() => Class39.smethod_801(this);
  ...
  public void Init()
  {
    ...
    buGeneral.GetEnumTypeValues((object) this.camPars.LeadIn.LeadType, ref EnumItems1);
    buControlCommands.ComboboxAddItem(EnumItems1, Convert.ToInt32((object) this.camPars.LeadIn.LeadType), ref this.comboBox_1);
    ArrayList EnumItems2 = new ArrayList();
    buGeneral.GetEnumTypeValues((object) this.camPars.LeadOut.LeadType, ref EnumItems2);
    buControlCommands.ComboboxAddItem(EnumItems2, Convert.ToInt32((object) this.camPars.LeadOut.LeadType), ref this.comboBox_0);
