...
// Type: buControls.Forms.WinControlForms.File.F_Cf2PropertiesList
...
public class F_Cf2PropertiesList : Form
{
  ...
  public F_Cf2PropertiesList() => Class39.smethod_1(this);
  ...
  public void Init()
  {
    ...
    Class39.smethod_233(this);
    Class39.smethod_769(this);
  ...
  internal void method_0(object sender, EventArgs e)
  {
    ...
    if (control2.Name == this.btn_add.Name)
    {
      ...
      Class39.smethod_757(this, ref cf2FileProperties_0);
  ...
  {
    this.numericUpDown_5.Value = (Decimal) props.ToolNo;
    this.numericUpDown_2.Value = (Decimal) props.PtIndex;
    this.numericUpDown_1.Value = (Decimal) props.PtRealValue;
    this.numericUpDown_0.Value = (Decimal) props.Cf2CodeMatchType;
    this.label_16.BackColor = props.MatchColor;
    this.numericUpDown_3.Value = (Decimal) props.SelectedThickness;
    this.numericUpDown_4.Value = (Decimal) props.Thickness;
    this.textBox_0.Text = props.Explanation;
    this.checkBox_0.Checked = props.Selectable;
    this.checkBox_1.Checked = props.Visible;
    this.label_9.BackColor = props.Color;
    this.label_8.BackColor = props.SelectedColor;
  ...
  internal void method_3(object sender, EventArgs e)
  {
    Control control1 = new Control();
    Control control2 = (Control) sender;
    if (control2.Name == this.label_9.Name)
    {
      ColorDialogBox.ShowDialog(this.label_9.BackColor);
      if (ColorDialogBox.Result == DialogResult.OK)
      {
        this.label_9.BackColor = ColorDialogBox.Color;
        this.label_9.ForeColor = buImage.InvertColorNoGray(this.label_9.BackColor);
        this.label_9.Text = buImage.GetColorKnownName(this.label_9.BackColor);
      }
    }
    if (control2.Name == this.label_8.Name)
    {
      ColorDialogBox.ShowDialog(this.label_9.BackColor);
      if (ColorDialogBox.Result == DialogResult.OK)
      {
        this.label_8.BackColor = ColorDialogBox.Color;
        this.label_8.ForeColor = buImage.InvertColorNoGray(this.label_8.BackColor);
        this.label_8.Text = buImage.GetColorKnownName(this.label_8.BackColor);
      }
    }
    if (!(control2.Name == this.label_16.Name))
      return;
    ColorDialogBox.ShowDialog(this.label_16.BackColor);
    if (ColorDialogBox.Result != DialogResult.OK)
      return;
    this.label_16.BackColor = ColorDialogBox.Color;
    this.label_16.ForeColor = buImage.InvertColorNoGray(this.label_16.BackColor);
    this.label_16.Text = buImage.GetColorKnownName(this.label_16.BackColor);
  }
