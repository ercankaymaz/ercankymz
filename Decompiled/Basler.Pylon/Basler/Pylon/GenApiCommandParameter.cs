...
internal class GenApiCommandParameter : GenApiParameter, ICommandParameter
{
	private unsafe ICommand* m_pCommand;

	public GenApiCommandParameter(string name, string wrapperName, ObjectState parentState)
	...
	public unsafe virtual void Execute()
	{
		...
		try
		{
			...
			try
			{
				...
				ICommand* pCommand = m_pCommand;
				((delegate* unmanaged[Thiscall, Thiscall]<IntPtr, byte, void>)(int)(*(uint*)(int)(*(uint*)pCommand)))((nint)pCommand, 1);
			}
	...
	public unsafe virtual bool IsExecuting()
	{
		ScopedObjectStateLock scopedObjectStateLock = null;
		int num = (int)stackalloc byte[global::_003CModule_003E.__CxxQueryExceptionSize()];
		ScopedObjectStateLock scopedObjectStateLock2 = new ScopedObjectStateLock(m_parentState);
		...
		try
		{
			...
			{
				RaiseExceptionIfDisposed();
				if (string.Compare(Name, "DeviceReset", ignoreCase: true) == 0)
				{
					bool flag = false;
					b = 1;
					((IDisposable)scopedObjectStateLock).Dispose();
				...
				{
					num2 = (nint)((byte*)pNode + *(int*)(((int*)pNode)[1] + 4) + 4);
				}
				if (!global::_003CModule_003E.GenApi_3_1_Basler_pylon_002EIsReadable((IBase*)num2))
				{
					bool flag2 = false;
					b = 1;
					((IDisposable)scopedObjectStateLock).Dispose();
				...
				ICommand* pCommand = m_pCommand;
				bool flag3 = ((delegate* unmanaged[Thiscall, Thiscall]<IntPtr, byte, byte>)(int)(*(uint*)(*(int*)pCommand + 8)))((nint)pCommand, 1) == 0;
				bool flag4 = flag3;
				b = 1;
				((IDisposable)scopedObjectStateLock).Dispose();
				return flag3;
	...
	public unsafe override bool Attach(INodeMap* pNodeMap)
	{
		...
		try
		{
			return (byte)(((m_pCommand = AttachImpl_003CGenApi_3_1_Basler_pylon_003A_003AICommand_003E(pNodeMap)) != null) ? 1u : 0u) != 0;
		}
		catch when (global::_003CModule_003E.__CxxExceptionFilter((void*)Marshal.GetExceptionPointers(), System.Runtime.CompilerServices.Unsafe.AsPointer(ref global::_003CModule_003E._003F_003F_R0_003FAVInvalidArgumentException_0040GenICam_3_1_Basler_pylon_0040_0040_00408), 9, &ptr) != 0)
		{
			uint num2 = 0u;
