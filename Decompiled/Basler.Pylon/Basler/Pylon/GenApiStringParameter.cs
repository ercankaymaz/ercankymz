...
internal class GenApiStringParameter : GenApiParameter, IStringParameter
{
	private unsafe IString* m_pString;

	public GenApiStringParameter(string name, string wrapperName, ObjectState parentState)
		: base(name, wrapperName, parentState)
	{
	}

	public unsafe virtual void SetValue(string value)
	{
		...
		try
		{
			...
			try
			{
				if (value == null)
				{
					throw global::_003CModule_003E.Basler_002EPylon_002ESetExceptionSource_003Cclass_0020System_003A_003AArgumentNullException_002Cclass_0020System_003A_003AString_0020_005E_003E(new ArgumentNullException("value"), m_parentState.m_name);
				}
				...
				try
				{
					IString* pString = m_pString;
					((delegate* unmanaged[Thiscall, Thiscall]<IntPtr, gcstring*, byte, void>)(int)(*(uint*)(int)(*(uint*)pString)))((nint)pString, ptr, 1);
				}
				catch
				{
					//try-fault
	...
	public unsafe virtual string GetValue()
	{
		...
		try
		{
			...
			try
			{
				...
				IString* pString = m_pString;
				System.Runtime.CompilerServices.Unsafe.SkipInit(out gcstring gcstring2);
				int num2 = (int)((delegate* unmanaged[Thiscall, Thiscall]<IntPtr, gcstring*, byte, byte, gcstring*>)(int)(*(uint*)(*(int*)pString + 8)))((nint)pString, &gcstring2, 0, 0);
				string text;
				try
				{
					text = global::_003CModule_003E.msclr_002Einterop_002Emarshal_as_003Cclass_0020System_003A_003AString_0020_005E_002Cclass_0020GenICam_3_1_Basler_pylon_003A_003Agcstring_003E((gcstring*)num2);
				}
				catch
				{
					//try-fault
	...
	public unsafe virtual int GetMaxLength()
	{
		ScopedObjectStateLock scopedObjectStateLock = null;
		int num = (int)stackalloc byte[global::_003CModule_003E.__CxxQueryExceptionSize()];
		ScopedObjectStateLock scopedObjectStateLock2 = new ScopedObjectStateLock(m_parentState);
		...
		try
		{
			...
			try
			{
				...
				RaiseExceptionIfNotReadable();
				IString* pString = m_pString;
				long num2 = ((delegate* unmanaged[Thiscall, Thiscall]<IntPtr, long>)(int)(*(uint*)(*(int*)pString + 20)))((nint)pString);
				if (num2 < 0)
				{
					int num3 = 0;
					b = 1;
				...
				int result = Convert.ToInt32(num2);
				b = 1;
				((IDisposable)scopedObjectStateLock).Dispose();
				return result;
			}
	...
	public unsafe override bool Attach(INodeMap* pNodeMap)
	{
		...
		try
		{
			return (byte)(((m_pString = AttachImpl_003CGenApi_3_1_Basler_pylon_003A_003AIString_003E(pNodeMap)) != null) ? 1u : 0u) != 0;
		}
		catch when (global::_003CModule_003E.__CxxExceptionFilter((void*)Marshal.GetExceptionPointers(), System.Runtime.CompilerServices.Unsafe.AsPointer(ref global::_003CModule_003E._003F_003F_R0_003FAVInvalidArgumentException_0040GenICam_3_1_Basler_pylon_0040_0040_00408), 9, &ptr) != 0)
		{
			uint num2 = 0u;
