...
internal class GenApiFloatParameter : GenApiParameter, IFloatParameter
{
	private unsafe IFloat* m_pFloat;

	public GenApiFloatParameter(string name, string wrapperName, ObjectState parentState)
		: base(name, wrapperName, parentState)
	{
	}

	public unsafe virtual void SetValue(double value)
	{
		...
		try
		{
			...
			try
			{
				...
				IFloat* pFloat = m_pFloat;
				((delegate* unmanaged[Thiscall, Thiscall]<IntPtr, double, byte, void>)(int)(*(uint*)(int)(*(uint*)pFloat)))((nint)pFloat, value, 1);
			}
	...
	public unsafe virtual double GetValue()
	{
		ScopedObjectStateLock scopedObjectStateLock = null;
		int num = (int)stackalloc byte[global::_003CModule_003E.__CxxQueryExceptionSize()];
		ScopedObjectStateLock scopedObjectStateLock2 = new ScopedObjectStateLock(m_parentState);
		...
		try
		{
			...
			try
			{
				...
				IFloat* pFloat = m_pFloat;
				double result = ((delegate* unmanaged[Thiscall, Thiscall]<IntPtr, byte, byte, double>)(int)(*(uint*)(*(int*)pFloat + 8)))((nint)pFloat, 0, 0);
				b = 1;
				((IDisposable)scopedObjectStateLock).Dispose();
				return result;
			}
	...
	public unsafe virtual double GetMaximum()
	{
		ScopedObjectStateLock scopedObjectStateLock = null;
		int num = (int)stackalloc byte[global::_003CModule_003E.__CxxQueryExceptionSize()];
		ScopedObjectStateLock scopedObjectStateLock2 = new ScopedObjectStateLock(m_parentState);
		...
		try
		{
			...
			try
			{
				...
				RaiseExceptionIfNotReadable();
				IFloat* pFloat = m_pFloat;
				double result = ((delegate* unmanaged[Thiscall, Thiscall]<IntPtr, double>)(int)(*(uint*)(*(int*)pFloat + 24)))((nint)pFloat);
				b = 1;
				((IDisposable)scopedObjectStateLock).Dispose();
				return result;
			}
	...
	public unsafe virtual double GetMinimum()
	{
		ScopedObjectStateLock scopedObjectStateLock = null;
		int num = (int)stackalloc byte[global::_003CModule_003E.__CxxQueryExceptionSize()];
		ScopedObjectStateLock scopedObjectStateLock2 = new ScopedObjectStateLock(m_parentState);
		...
		try
		{
			...
			try
			{
				...
				RaiseExceptionIfNotReadable();
				IFloat* pFloat = m_pFloat;
				double result = ((delegate* unmanaged[Thiscall, Thiscall]<IntPtr, double>)(int)(*(uint*)(*(int*)pFloat + 20)))((nint)pFloat);
				b = 1;
				((IDisposable)scopedObjectStateLock).Dispose();
				return result;
			}
	...
	public unsafe virtual double? GetIncrement()
	{
		ScopedObjectStateLock scopedObjectStateLock = null;
		int num = (int)stackalloc byte[global::_003CModule_003E.__CxxQueryExceptionSize()];
		ScopedObjectStateLock scopedObjectStateLock2 = new ScopedObjectStateLock(m_parentState);
		...
		try
		{
			...
			try
			{
				...
				RaiseExceptionIfNotReadable();
				IFloat* pFloat = m_pFloat;
				if (((delegate* unmanaged[Thiscall, Thiscall]<IntPtr, byte>)(int)(*(uint*)(*(int*)pFloat + 28)))((nint)pFloat) != 0)
				{
					IFloat* pFloat2 = m_pFloat;
					double? num2 = ((delegate* unmanaged[Thiscall, Thiscall]<IntPtr, double>)(int)(*(uint*)(*(int*)pFloat2 + 36)))((nint)pFloat2);
					double? result = num2;
					b = 1;
					((IDisposable)scopedObjectStateLock).Dispose();
					return result;
		...
		try
		{
			System.Runtime.CompilerServices.Unsafe.SkipInit(out double? result2);
			return result2;
		}
		catch
		{
	...
	public unsafe override bool Attach(INodeMap* pNodeMap)
	{
		...
		try
		{
			return (byte)(((m_pFloat = AttachImpl_003CGenApi_3_1_Basler_pylon_003A_003AIFloat_003E(pNodeMap)) != null) ? 1u : 0u) != 0;
		}
		catch when (global::_003CModule_003E.__CxxExceptionFilter((void*)Marshal.GetExceptionPointers(), System.Runtime.CompilerServices.Unsafe.AsPointer(ref global::_003CModule_003E._003F_003F_R0_003FAVInvalidArgumentException_0040GenICam_3_1_Basler_pylon_0040_0040_00408), 9, &ptr) != 0)
		{
			uint num2 = 0u;
	...
	protected unsafe override object GetValueAsObject()
	{
		int num = (int)stackalloc byte[global::_003CModule_003E.__CxxQueryExceptionSize()];
		try
		{
