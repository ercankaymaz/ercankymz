...
internal class ScopedBufferFixation : IDisposable
{
	private GCHandle hPinnedMemory;

	private IntPtr m_ptrBuffer;
	...
	public bool IsValid
	{
		...
		get
		{
			return m_ptrBuffer != IntPtr.Zero;
		}
	}

	public long LongLength => (long)m_bufferSize & 0x7FFFFFFFFFFFFFFFL;

	public int Length => (int)(m_bufferSize & 0x7FFFFFFF);

	public uint BufferSize => m_bufferSize;

	public IntPtr PointerToBuffer => m_ptrBuffer;

	public ScopedBufferFixation(object buffer)
	{
		FromObject(buffer, null, null);
	}

	public ScopedBufferFixation(object buffer, string exceptionSourceName, string exceptionArgumentName)
	{
		FromObject(buffer, exceptionSourceName, exceptionArgumentName);
	}

	private void _007EScopedBufferFixation()
	{
		_0021ScopedBufferFixation();
	}

	private void _0021ScopedBufferFixation()
	{
		if (hPinnedMemory.IsAllocated)
		{
			hPinnedMemory.Free();
		}
	}
	...
	[return: MarshalAs(UnmanagedType.U1)]
	private unsafe bool FromObject(object buffer, string exceptionSourceName, string exceptionArgumentName)
	{
		int num = (int)stackalloc byte[global::_003CModule_003E.__CxxQueryExceptionSize()];
		bool flag = !string.IsNullOrEmpty(exceptionSourceName);
		if (buffer == null)
		{
			return true;
		}
		if (buffer is IImage)
		{
			IImage image = buffer as IImage;
			if (!image.IsValid)
			{
				if (flag)
				{
					throw global::_003CModule_003E.Basler_002EPylon_002ESetExceptionSource_003Cclass_0020System_003A_003AArgumentException_002Cclass_0020System_003A_003AString_0020_005E_003E(new ArgumentException("The image passed is invalid.", exceptionArgumentName), exceptionSourceName);
				}
				return false;
			}
			if (image.PixelData.GetType() == typeof(IntPtr))
			{
				...
				try
				{
					m_bufferSize = global::_003CModule_003E.Pylon_002EComputeBufferSize((EPixelType)image.PixelTypeValue, (uint)image.Width, (uint)image.Height, (uint)image.PaddingX);
				}
				...
				catch when (global::_003CModule_003E.__CxxExceptionFilter((void*)Marshal.GetExceptionPointers(), System.Runtime.CompilerServices.Unsafe.AsPointer(ref global::_003CModule_003E._003F_003F_R0_003FAVOutOfRangeException_0040GenICam_3_1_Basler_pylon_0040_0040_00408), 9, &ptr2) != 0)
				{
					...
					try
					{
						try
						{
							...
							ex2.Source = exceptionSourceName;
							throw ex2;
						}
						catch when (((Func<bool>)delegate
						{
				...
				catch when (global::_003CModule_003E.__CxxExceptionFilter((void*)Marshal.GetExceptionPointers(), System.Runtime.CompilerServices.Unsafe.AsPointer(ref global::_003CModule_003E._003F_003F_R0_003FAVAccessException_0040GenICam_3_1_Basler_pylon_0040_0040_00408), 9, &ptr3) != 0)
				{
					...
					try
					{
						try
						{
							...
							ex3.Source = exceptionSourceName;
							throw ex3;
						}
						catch when (((Func<bool>)delegate
						{
				...
				catch when (global::_003CModule_003E.__CxxExceptionFilter((void*)Marshal.GetExceptionPointers(), System.Runtime.CompilerServices.Unsafe.AsPointer(ref global::_003CModule_003E._003F_003F_R0_003FAVTimeoutException_0040GenICam_3_1_Basler_pylon_0040_0040_00408), 9, &ptr4) != 0)
				{
					...
					try
					{
						try
						{
							...
							ex4.Source = exceptionSourceName;
							throw ex4;
						}
						catch when (((Func<bool>)delegate
						{
				...
				catch when (global::_003CModule_003E.__CxxExceptionFilter((void*)Marshal.GetExceptionPointers(), System.Runtime.CompilerServices.Unsafe.AsPointer(ref global::_003CModule_003E._003F_003F_R0_003FAVLogicalErrorException_0040GenICam_3_1_Basler_pylon_0040_0040_00408), 9, &ptr5) != 0)
				{
					...
					try
					{
						try
						{
							...
							ex5.Source = exceptionSourceName;
							throw ex5;
						}
						catch when (((Func<bool>)delegate
						{
				...
				catch when (global::_003CModule_003E.__CxxExceptionFilter((void*)Marshal.GetExceptionPointers(), System.Runtime.CompilerServices.Unsafe.AsPointer(ref global::_003CModule_003E._003F_003F_R0_003FAVBadAllocException_0040GenICam_3_1_Basler_pylon_0040_0040_00408), 9, &ptr6) != 0)
				{
					...
					try
					{
						try
						{
							...
							ex6.Source = exceptionSourceName;
							throw ex6;
						}
						catch when (((Func<bool>)delegate
						{
				...
				catch when (global::_003CModule_003E.__CxxExceptionFilter((void*)Marshal.GetExceptionPointers(), System.Runtime.CompilerServices.Unsafe.AsPointer(ref global::_003CModule_003E._003F_003F_R0_003FAVRuntimeException_0040GenICam_3_1_Basler_pylon_0040_0040_00408), 9, &ptr7) != 0)
				{
					...
					try
					{
						try
						{
							...
							ex7.Source = exceptionSourceName;
							throw ex7;
						}
						catch when (((Func<bool>)delegate
						{
				...
				catch when (global::_003CModule_003E.__CxxExceptionFilter((void*)Marshal.GetExceptionPointers(), System.Runtime.CompilerServices.Unsafe.AsPointer(ref global::_003CModule_003E._003F_003F_R0_003FAVDynamicCastException_0040GenICam_3_1_Basler_pylon_0040_0040_00408), 9, &ptr8) != 0)
				{
					...
					try
					{
						try
						{
							...
							ex8.Source = exceptionSourceName;
							throw ex8;
						}
						catch when (((Func<bool>)delegate
						{
				...
				catch when (global::_003CModule_003E.__CxxExceptionFilter((void*)Marshal.GetExceptionPointers(), System.Runtime.CompilerServices.Unsafe.AsPointer(ref global::_003CModule_003E._003F_003F_R0_003FAVGenericException_0040GenICam_3_1_Basler_pylon_0040_0040_00408), 9, &ptr9) != 0)
				{
					...
					try
					{
						try
						{
							...
							ex9.Source = exceptionSourceName;
							throw ex9;
						}
						catch when (((Func<bool>)delegate
						{
				...
				catch when (global::_003CModule_003E.__CxxExceptionFilter((void*)Marshal.GetExceptionPointers(), System.Runtime.CompilerServices.Unsafe.AsPointer(ref global::_003CModule_003E._003F_003F_R0_003FAVexception_0040std_0040_0040_00408), 9, &ptr10) != 0)
				{
					...
					try
					{
						try
						{
							...
							ex10.Source = exceptionSourceName;
							throw ex10;
						}
						catch when (((Func<bool>)delegate
						{
				...
				}).Invoke())
				{
					...
					try
					{
						try
						{
							...
							ex12.Source = exceptionSourceName;
							throw ex12;
						}
						catch when (((Func<bool>)delegate
						{
				...
				ref IntPtr ptrBuffer = ref m_ptrBuffer;
				ptrBuffer = (IntPtr)image.PixelData;
				return true;
			}
			buffer = image.PixelData;
		}
		if (buffer.GetType().IsArray)
		{
			...
			{
				int length = ((Array)buffer).Length;
				m_bufferSize = (uint)(Marshal.SizeOf(elementType) * length);
				GCHandle gCHandle = GCHandle.Alloc(buffer, GCHandleType.Pinned);
				hPinnedMemory = gCHandle;
				IntPtr ptrBuffer2 = hPinnedMemory.AddrOfPinnedObject();
				m_ptrBuffer = ptrBuffer2;
				return true;
			}
			if (flag)
			{
				throw global::_003CModule_003E.Basler_002EPylon_002ESetExceptionSource_003Cclass_0020System_003A_003AArgumentException_002Cclass_0020System_003A_003AString_0020_005E_003E(new ArgumentException("Unsupported element type in the array that is used as buffer.", exceptionArgumentName), exceptionSourceName);
			}
			return false;
		}
		if (flag)
		{
			throw global::_003CModule_003E.Basler_002EPylon_002ESetExceptionSource_003Cclass_0020System_003A_003AArgumentException_002Cclass_0020System_003A_003AString_0020_005E_003E(new ArgumentException("Unsupported buffer type passed.", exceptionArgumentName), exceptionSourceName);
		}
		return false;
	}
