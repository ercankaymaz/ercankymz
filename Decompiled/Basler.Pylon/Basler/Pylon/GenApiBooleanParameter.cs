...
internal class GenApiBooleanParameter : GenApiParameter, IBooleanParameter
{
	private unsafe IBoolean* m_pBoolean;

	public GenApiBooleanParameter(string name, string wrapperName, ObjectState parentState)
		: base(name, wrapperName, parentState)
	{
	}

	public unsafe virtual void SetValue([MarshalAs(UnmanagedType.U1)] bool value)
	{
		...
		try
		{
			...
			try
			{
				...
				IBoolean* pBoolean = m_pBoolean;
				((delegate* unmanaged[Thiscall, Thiscall]<IntPtr, byte, byte, void>)(int)(*(uint*)(int)(*(uint*)pBoolean)))((nint)pBoolean, value ? ((byte)1) : ((byte)0), 1);
			}
	...
	public unsafe virtual bool GetValue()
	{
		ScopedObjectStateLock scopedObjectStateLock = null;
		int num = (int)stackalloc byte[global::_003CModule_003E.__CxxQueryExceptionSize()];
		ScopedObjectStateLock scopedObjectStateLock2 = new ScopedObjectStateLock(m_parentState);
		...
		try
		{
			...
			try
			{
				...
				IBoolean* pBoolean = m_pBoolean;
				bool flag = ((delegate* unmanaged[Thiscall, Thiscall]<IntPtr, byte, byte, byte>)(int)(*(uint*)(*(int*)pBoolean + 8)))((nint)pBoolean, 0, 0) != 0;
				bool flag2 = flag;
				b = 1;
				((IDisposable)scopedObjectStateLock).Dispose();
				return flag;
	...
	{
		return (byte)(((m_pBoolean = AttachImpl_003CGenApi_3_1_Basler_pylon_003A_003AIBoolean_003E(pNodeMap)) != null) ? 1u : 0u) != 0;
	}
