...
public static class NativeMethods
{
	...
	public struct ILoaderVTable32
	{
		...
		public delegate int ReleaseDelegate(nint self);

		[UnmanagedFunctionPointer(CallingConvention.StdCall)]
		public unsafe delegate int AddDataDelegate(nint self, byte* data, int length);

		[UnmanagedFunctionPointer(CallingConvention.StdCall)]
		public delegate nint ConvertToDocumentDelegate(nint self);
	...
	public struct SCNotification
	{
		...
		public nint annotationLinesAdded;
	...
	public const int CARET_SLOP = 1;

	public const int CARET_STRICT = 4;

	public const int CARET_JUMPS = 16;

	public const int CARET_EVEN = 8;
	...
	public const int SCFIND_NONE = 0;
	...
	public static extern nint MB_GetString(uint hInst);

	public static string GetMessageBoxString(uint msgId)
	{
		return Marshal.PtrToStringUni(MB_GetString(msgId));
	}
