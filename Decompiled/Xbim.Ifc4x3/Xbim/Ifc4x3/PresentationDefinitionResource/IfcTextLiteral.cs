...
{
	private Xbim.Ifc4x3.PresentationAppearanceResource.IfcPresentableText _literal;
	...
	Xbim.Ifc4.PresentationAppearanceResource.IfcPresentableText IIfcTextLiteral.Literal
	{
		...
		set
		{
			Literal = new Xbim.Ifc4x3.PresentationAppearanceResource.IfcPresentableText(value);
		}
	}
	...
	public Xbim.Ifc4x3.PresentationAppearanceResource.IfcPresentableText Literal
	{
		get
		{
			if (_activated)
		...
		set
		{
			SetValue(delegate(Xbim.Ifc4x3.PresentationAppearanceResource.IfcPresentableText v)
			{
				_literal = v;
