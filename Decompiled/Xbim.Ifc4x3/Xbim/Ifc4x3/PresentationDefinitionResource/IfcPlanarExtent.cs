...
{
	private Xbim.Ifc4x3.MeasureResource.IfcLengthMeasure _sizeInX;

	private Xbim.Ifc4x3.MeasureResource.IfcLengthMeasure _sizeInY;
	...
	Xbim.Ifc4.MeasureResource.IfcLengthMeasure IIfcPlanarExtent.SizeInX
	{
		...
		set
		{
			SizeInX = new Xbim.Ifc4x3.MeasureResource.IfcLengthMeasure(value);
		}
	}
	...
	Xbim.Ifc4.MeasureResource.IfcLengthMeasure IIfcPlanarExtent.SizeInY
	{
		...
		set
		{
			SizeInY = new Xbim.Ifc4x3.MeasureResource.IfcLengthMeasure(value);
		}
	}

	[EntityAttribute(1, EntityAttributeState.Mandatory, EntityAttributeType.None, EntityAttributeType.None, null, null, 3)]
	public Xbim.Ifc4x3.MeasureResource.IfcLengthMeasure SizeInX
	{
		get
		{
			if (_activated)
	...
	public Xbim.Ifc4x3.MeasureResource.IfcLengthMeasure SizeInY
	{
		get
		{
			if (_activated)
