...
public class IfcExtrudedAreaSolidTapered : IfcExtrudedAreaSolid, IInstantiableEntity, IPersistEntity, IPersist, IContainsEntityReferences, IEquatable<IfcExtrudedAreaSolidTapered>, IIfcExtrudedAreaSolidTapered, IIfcExtrudedAreaSolid, IIfcSweptAreaSolid, IIfcSolidModel, IIfcGeometricRepresentationItem, IIfcRepresentationItem, IfcLayeredItem, IIfcLayeredItem, IExpressSelectType, Xbim.Ifc4.GeometricModelResource.IfcBooleanOperand, IIfcBooleanOperand, IfcSolidOrShell, IIfcSolidOrShell
{
	...
	[CrossSchemaAttribute(typeof(IIfcExtrudedAreaSolidTapered), 5)]
