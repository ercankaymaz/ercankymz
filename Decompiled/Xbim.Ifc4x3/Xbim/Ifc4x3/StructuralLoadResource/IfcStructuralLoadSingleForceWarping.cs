...
{
	private Xbim.Ifc4x3.MeasureResource.IfcWarpingMomentMeasure? _warpingMoment;
	...
	Xbim.Ifc4.MeasureResource.IfcWarpingMomentMeasure? IIfcStructuralLoadSingleForceWarping.WarpingMoment
	{
		...
		set
		{
			WarpingMoment = (value.HasValue ? new Xbim.Ifc4x3.MeasureResource.IfcWarpingMomentMeasure?(new Xbim.Ifc4x3.MeasureResource.IfcWarpingMomentMeasure(value.Value)) : ((Xbim.Ifc4x3.MeasureResource.IfcWarpingMomentMeasure?)null));
		}
	}

	[EntityAttribute(8, EntityAttributeState.Optional, EntityAttributeType.None, EntityAttributeType.None, null, null, 8)]
	public Xbim.Ifc4x3.MeasureResource.IfcWarpingMomentMeasure? WarpingMoment
	{
		get
		{
			if (_activated)
		...
		set
		{
			SetValue(delegate(Xbim.Ifc4x3.MeasureResource.IfcWarpingMomentMeasure? v)
			{
				_warpingMoment = v;
