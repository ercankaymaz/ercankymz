...
{
	private Xbim.Ifc4x3.MeasureResource.IfcPlanarForceMeasure? _planarForceX;

	private Xbim.Ifc4x3.MeasureResource.IfcPlanarForceMeasure? _planarForceY;

	private Xbim.Ifc4x3.MeasureResource.IfcPlanarForceMeasure? _planarForceZ;
	...
	Xbim.Ifc4.MeasureResource.IfcPlanarForceMeasure? IIfcStructuralLoadPlanarForce.PlanarForceX
	{
		...
		set
		{
			PlanarForceX = (value.HasValue ? new Xbim.Ifc4x3.MeasureResource.IfcPlanarForceMeasure?(new Xbim.Ifc4x3.MeasureResource.IfcPlanarForceMeasure(value.Value)) : ((Xbim.Ifc4x3.MeasureResource.IfcPlanarForceMeasure?)null));
		}
	}
	...
	Xbim.Ifc4.MeasureResource.IfcPlanarForceMeasure? IIfcStructuralLoadPlanarForce.PlanarForceY
	{
		...
		set
		{
			PlanarForceY = (value.HasValue ? new Xbim.Ifc4x3.MeasureResource.IfcPlanarForceMeasure?(new Xbim.Ifc4x3.MeasureResource.IfcPlanarForceMeasure(value.Value)) : ((Xbim.Ifc4x3.MeasureResource.IfcPlanarForceMeasure?)null));
		}
	}
	...
	Xbim.Ifc4.MeasureResource.IfcPlanarForceMeasure? IIfcStructuralLoadPlanarForce.PlanarForceZ
	{
		...
		set
		{
			PlanarForceZ = (value.HasValue ? new Xbim.Ifc4x3.MeasureResource.IfcPlanarForceMeasure?(new Xbim.Ifc4x3.MeasureResource.IfcPlanarForceMeasure(value.Value)) : ((Xbim.Ifc4x3.MeasureResource.IfcPlanarForceMeasure?)null));
		}
	}

	[EntityAttribute(2, EntityAttributeState.Optional, EntityAttributeType.None, EntityAttributeType.None, null, null, 2)]
	public Xbim.Ifc4x3.MeasureResource.IfcPlanarForceMeasure? PlanarForceX
	{
		get
		{
			if (_activated)
		...
		set
		{
			SetValue(delegate(Xbim.Ifc4x3.MeasureResource.IfcPlanarForceMeasure? v)
			{
				_planarForceX = v;
	...
	public Xbim.Ifc4x3.MeasureResource.IfcPlanarForceMeasure? PlanarForceY
	{
		get
		{
			if (_activated)
	...
	public Xbim.Ifc4x3.MeasureResource.IfcPlanarForceMeasure? PlanarForceZ
	{
		get
		{
			if (_activated)
