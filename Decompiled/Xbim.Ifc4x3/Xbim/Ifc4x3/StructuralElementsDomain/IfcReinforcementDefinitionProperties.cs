...
public class IfcReinforcementDefinitionProperties : Xbim.Ifc4x3.Kernel.IfcPreDefinedPropertySet, IIfcReinforcementDefinitionProperties, IIfcPreDefinedPropertySet, IIfcPropertySetDefinition, IIfcPropertyDefinition, IIfcRoot, IPersistEntity, IPersist, Xbim.Ifc4.Kernel.IfcDefinitionSelect, IIfcDefinitionSelect, IExpressSelectType, Xbim.Ifc4.Kernel.IfcPropertySetDefinitionSelect, IIfcPropertySetDefinitionSelect, IInstantiableEntity, IContainsEntityReferences, IEquatable<IfcReinforcementDefinitionProperties>
{
	private Xbim.Ifc4x3.MeasureResource.IfcLabel? _definitionType;
	...
	Xbim.Ifc4.MeasureResource.IfcLabel? IIfcReinforcementDefinitionProperties.DefinitionType
	{
		...
		set
		{
			DefinitionType = (value.HasValue ? new Xbim.Ifc4x3.MeasureResource.IfcLabel?(new Xbim.Ifc4x3.MeasureResource.IfcLabel(value.Value)) : ((Xbim.Ifc4x3.MeasureResource.IfcLabel?)null));
		}
	}
	...
	public Xbim.Ifc4x3.MeasureResource.IfcLabel? DefinitionType
	{
		get
		{
			if (_activated)
