...
public class IfcTendon : IfcReinforcingElement, IIfcTendon, IIfcReinforcingElement, IIfcElementComponent, IIfcElement, IIfcProduct, IIfcObject, IIfcObjectDefinition, IIfcRoot, IPersistEntity, IPersist, IfcDefinitionSelect, IIfcDefinitionSelect, IExpressSelectType, IfcProductSelect, IIfcProductSelect, IfcStructuralActivityAssignmentSelect, IIfcStructuralActivityAssignmentSelect, IInstantiableEntity, IContainsEntityReferences, IContainsIndexedReferences, IEquatable<IfcTendon>
{
	...
	private Xbim.Ifc4x3.MeasureResource.IfcForceMeasure? _tensionForce;

	private Xbim.Ifc4x3.MeasureResource.IfcPressureMeasure? _preStress;

	private Xbim.Ifc4x3.MeasureResource.IfcNormalisedRatioMeasure? _frictionCoefficient;

	private Xbim.Ifc4x3.MeasureResource.IfcPositiveLengthMeasure? _anchorageSlip;

	private Xbim.Ifc4x3.MeasureResource.IfcPositiveLengthMeasure? _minCurvatureRadius;
	...
	Xbim.Ifc4.MeasureResource.IfcForceMeasure? IIfcTendon.TensionForce
	{
		...
		set
		{
			TensionForce = (value.HasValue ? new Xbim.Ifc4x3.MeasureResource.IfcForceMeasure?(new Xbim.Ifc4x3.MeasureResource.IfcForceMeasure(value.Value)) : ((Xbim.Ifc4x3.MeasureResource.IfcForceMeasure?)null));
		}
	}
	...
	Xbim.Ifc4.MeasureResource.IfcPressureMeasure? IIfcTendon.PreStress
	{
		...
		set
		{
			PreStress = (value.HasValue ? new Xbim.Ifc4x3.MeasureResource.IfcPressureMeasure?(new Xbim.Ifc4x3.MeasureResource.IfcPressureMeasure(value.Value)) : ((Xbim.Ifc4x3.MeasureResource.IfcPressureMeasure?)null));
		}
	}
	...
	Xbim.Ifc4.MeasureResource.IfcNormalisedRatioMeasure? IIfcTendon.FrictionCoefficient
	{
		...
		set
		{
			FrictionCoefficient = (value.HasValue ? new Xbim.Ifc4x3.MeasureResource.IfcNormalisedRatioMeasure?(new Xbim.Ifc4x3.MeasureResource.IfcNormalisedRatioMeasure(value.Value)) : ((Xbim.Ifc4x3.MeasureResource.IfcNormalisedRatioMeasure?)null));
		}
	}
	...
	Xbim.Ifc4.MeasureResource.IfcPositiveLengthMeasure? IIfcTendon.AnchorageSlip
	{
		...
		set
		{
			AnchorageSlip = (value.HasValue ? new Xbim.Ifc4x3.MeasureResource.IfcPositiveLengthMeasure?(new Xbim.Ifc4x3.MeasureResource.IfcPositiveLengthMeasure(value.Value)) : ((Xbim.Ifc4x3.MeasureResource.IfcPositiveLengthMeasure?)null));
		}
	}
	...
	Xbim.Ifc4.MeasureResource.IfcPositiveLengthMeasure? IIfcTendon.MinCurvatureRadius
	{
		...
		set
		{
			MinCurvatureRadius = (value.HasValue ? new Xbim.Ifc4x3.MeasureResource.IfcPositiveLengthMeasure?(new Xbim.Ifc4x3.MeasureResource.IfcPositiveLengthMeasure(value.Value)) : ((Xbim.Ifc4x3.MeasureResource.IfcPositiveLengthMeasure?)null));
		}
	}
	...
	public Xbim.Ifc4x3.MeasureResource.IfcForceMeasure? TensionForce
	{
		get
		{
			if (_activated)
		...
		set
		{
			SetValue(delegate(Xbim.Ifc4x3.MeasureResource.IfcForceMeasure? v)
			{
				_tensionForce = v;
	...
	public Xbim.Ifc4x3.MeasureResource.IfcPressureMeasure? PreStress
	{
		get
		{
			if (_activated)
		...
		set
		{
			SetValue(delegate(Xbim.Ifc4x3.MeasureResource.IfcPressureMeasure? v)
			{
				_preStress = v;
	...
	public Xbim.Ifc4x3.MeasureResource.IfcNormalisedRatioMeasure? FrictionCoefficient
	{
		get
		{
			if (_activated)
	...
	public Xbim.Ifc4x3.MeasureResource.IfcPositiveLengthMeasure? AnchorageSlip
	{
		get
		{
			if (_activated)
	...
	public Xbim.Ifc4x3.MeasureResource.IfcPositiveLengthMeasure? MinCurvatureRadius
	{
		get
		{
			if (_activated)
