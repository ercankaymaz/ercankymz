...
public class IfcTendonConduitType : IfcReinforcingElementType, IInstantiableEntity, IPersistEntity, IPersist, IContainsEntityReferences, IContainsIndexedReferences, IEquatable<IfcTendonConduitType>
{
	...
	internal IfcTendonConduitType(IModel model, int label, bool activated)
	...
	public bool Equals(IfcTendonConduitType other)
	{
		return this == other;
	}
}
