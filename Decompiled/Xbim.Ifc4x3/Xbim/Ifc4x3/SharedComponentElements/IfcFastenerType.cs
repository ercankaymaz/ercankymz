...
public class IfcFastenerType : IfcElementComponentType, IIfcFastenerType, IIfcElementComponentType, IIfcElementType, IIfcTypeProduct, IIfcTypeObject, IIfcObjectDefinition, IIfcRoot, IPersistEntity, IPersist, Xbim.Ifc4.Kernel.IfcDefinitionSelect, IIfcDefinitionSelect, IExpressSelectType, Xbim.Ifc4.Kernel.IfcProductSelect, IIfcProductSelect, IInstantiableEntity, IContainsEntityReferences, IContainsIndexedReferences, IEquatable<IfcFastenerType>
{
	private IfcFastenerTypeEnum _predefinedType;

	[CrossSchemaAttribute(typeof(IIfcFastenerType), 10)]
	Xbim.Ifc4.Interfaces.IfcFastenerTypeEnum IIfcFastenerType.PredefinedType
	{
		get
		{
