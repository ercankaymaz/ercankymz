...
public abstract class IfcRepresentation : PersistEntity, IIfcRepresentation, IPersistEntity, IPersist, Xbim.Ifc4.PresentationOrganizationResource.IfcLayeredItem, IIfcLayeredItem, IExpressSelectType, Xbim.Ifc4x3.PresentationOrganizationResource.IfcLayeredItem, IEquatable<IfcRepresentation>
{
	private IfcRepresentationContext _contextOfItems;

	private Xbim.Ifc4x3.MeasureResource.IfcLabel? _representationIdentifier;

	private Xbim.Ifc4x3.MeasureResource.IfcLabel? _representationType;
	...
	Xbim.Ifc4.MeasureResource.IfcLabel? IIfcRepresentation.RepresentationIdentifier
	{
		...
		set
		{
			RepresentationIdentifier = (value.HasValue ? new Xbim.Ifc4x3.MeasureResource.IfcLabel?(new Xbim.Ifc4x3.MeasureResource.IfcLabel(value.Value)) : ((Xbim.Ifc4x3.MeasureResource.IfcLabel?)null));
		}
	}
	...
	Xbim.Ifc4.MeasureResource.IfcLabel? IIfcRepresentation.RepresentationType
	{
		...
		set
		{
			RepresentationType = (value.HasValue ? new Xbim.Ifc4x3.MeasureResource.IfcLabel?(new Xbim.Ifc4x3.MeasureResource.IfcLabel(value.Value)) : ((Xbim.Ifc4x3.MeasureResource.IfcLabel?)null));
		}
	}
	...
	public Xbim.Ifc4x3.MeasureResource.IfcLabel? RepresentationIdentifier
	{
		get
		{
			if (_activated)
	...
	public Xbim.Ifc4x3.MeasureResource.IfcLabel? RepresentationType
	{
		get
		{
			if (_activated)
	...
	public IEnumerable<Xbim.Ifc4x3.PresentationOrganizationResource.IfcPresentationLayerAssignment> LayerAssignments => base.Model.Instances.Where((Xbim.Ifc4x3.PresentationOrganizationResource.IfcPresentationLayerAssignment e) => e.AssignedItems != null && e.AssignedItems.Contains(this), "AssignedItems", this);
