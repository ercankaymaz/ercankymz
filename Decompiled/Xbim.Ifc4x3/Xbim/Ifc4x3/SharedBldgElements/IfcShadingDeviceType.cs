...
public class IfcShadingDeviceType : IfcBuiltElementType, IIfcShadingDeviceType, IIfcBuildingElementType, IIfcElementType, IIfcTypeProduct, IIfcTypeObject, IIfcObjectDefinition, IIfcRoot, IPersistEntity, IPersist, Xbim.Ifc4.Kernel.IfcDefinitionSelect, IIfcDefinitionSelect, IExpressSelectType, Xbim.Ifc4.Kernel.IfcProductSelect, IIfcProductSelect, IInstantiableEntity, IContainsEntityReferences, IContainsIndexedReferences, IEquatable<IfcShadingDeviceType>
{
	private IfcShadingDeviceTypeEnum _predefinedType;

	[CrossSchemaAttribute(typeof(IIfcShadingDeviceType), 10)]
	Xbim.Ifc4.Interfaces.IfcShadingDeviceTypeEnum IIfcShadingDeviceType.PredefinedType
	{
		get
		{
