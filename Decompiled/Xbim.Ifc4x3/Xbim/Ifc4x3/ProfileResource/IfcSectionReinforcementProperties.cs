...
public class IfcSectionReinforcementProperties : IfcPreDefinedProperties, IIfcSectionReinforcementProperties, IIfcPreDefinedProperties, IIfcPropertyAbstraction, IPersistEntity, IPersist, IfcResourceObjectSelect, IIfcResourceObjectSelect, IExpressSelectType, IInstantiableEntity, IContainsEntityReferences, IEquatable<IfcSectionReinforcementProperties>
{
	private Xbim.Ifc4x3.MeasureResource.IfcLengthMeasure _longitudinalStartPosition;

	private Xbim.Ifc4x3.MeasureResource.IfcLengthMeasure _longitudinalEndPosition;

	private Xbim.Ifc4x3.MeasureResource.IfcLengthMeasure? _transversePosition;
	...
	Xbim.Ifc4.MeasureResource.IfcLengthMeasure IIfcSectionReinforcementProperties.LongitudinalStartPosition
	{
		...
		set
		{
			LongitudinalStartPosition = new Xbim.Ifc4x3.MeasureResource.IfcLengthMeasure(value);
		}
	}
	...
	Xbim.Ifc4.MeasureResource.IfcLengthMeasure IIfcSectionReinforcementProperties.LongitudinalEndPosition
	{
		...
		set
		{
			LongitudinalEndPosition = new Xbim.Ifc4x3.MeasureResource.IfcLengthMeasure(value);
		}
	}
	...
	Xbim.Ifc4.MeasureResource.IfcLengthMeasure? IIfcSectionReinforcementProperties.TransversePosition
	{
		...
		set
		{
			TransversePosition = (value.HasValue ? new Xbim.Ifc4x3.MeasureResource.IfcLengthMeasure?(new Xbim.Ifc4x3.MeasureResource.IfcLengthMeasure(value.Value)) : ((Xbim.Ifc4x3.MeasureResource.IfcLengthMeasure?)null));
		}
	}
	...
	Xbim.Ifc4.Interfaces.IfcReinforcingBarRoleEnum IIfcSectionReinforcementProperties.ReinforcementRole
	{
		get
		{
			...
			{
				IfcReinforcingBarRoleEnum.ANCHORING => Xbim.Ifc4.Interfaces.IfcReinforcingBarRoleEnum.ANCHORING, 
		...
		set
		{
			...
			case Xbim.Ifc4.Interfaces.IfcReinforcingBarRoleEnum.ANCHORING:
				ReinforcementRole = IfcReinforcingBarRoleEnum.ANCHORING;
				break;
	...
	public Xbim.Ifc4x3.MeasureResource.IfcLengthMeasure LongitudinalStartPosition
	{
		get
		{
			if (_activated)
	...
	public Xbim.Ifc4x3.MeasureResource.IfcLengthMeasure LongitudinalEndPosition
	{
		get
		{
			if (_activated)
	...
	public Xbim.Ifc4x3.MeasureResource.IfcLengthMeasure? TransversePosition
	{
		get
		{
			if (_activated)
