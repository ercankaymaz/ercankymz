...
public class IfcReinforcementBarProperties : IfcPreDefinedProperties, IIfcReinforcementBarProperties, IIfcPreDefinedProperties, IIfcPropertyAbstraction, IPersistEntity, IPersist, IfcResourceObjectSelect, IIfcResourceObjectSelect, IExpressSelectType, IInstantiableEntity, IEquatable<IfcReinforcementBarProperties>
{
	private Xbim.Ifc4x3.MeasureResource.IfcAreaMeasure _totalCrossSectionArea;

	private Xbim.Ifc4x3.MeasureResource.IfcLabel _steelGrade;

	private IfcReinforcingBarSurfaceEnum? _barSurface;

	private Xbim.Ifc4x3.MeasureResource.IfcLengthMeasure? _effectiveDepth;

	private Xbim.Ifc4x3.MeasureResource.IfcPositiveLengthMeasure? _nominalBarDiameter;

	private Xbim.Ifc4x3.MeasureResource.IfcCountMeasure? _barCount;
	...
	Xbim.Ifc4.MeasureResource.IfcAreaMeasure IIfcReinforcementBarProperties.TotalCrossSectionArea
	{
		...
		set
		{
			TotalCrossSectionArea = new Xbim.Ifc4x3.MeasureResource.IfcAreaMeasure(value);
		}
	}
	...
	Xbim.Ifc4.MeasureResource.IfcLabel IIfcReinforcementBarProperties.SteelGrade
	{
		...
		set
		{
			SteelGrade = new Xbim.Ifc4x3.MeasureResource.IfcLabel(value);
		}
	}
	...
	Xbim.Ifc4.MeasureResource.IfcLengthMeasure? IIfcReinforcementBarProperties.EffectiveDepth
	{
		...
		set
		{
			EffectiveDepth = (value.HasValue ? new Xbim.Ifc4x3.MeasureResource.IfcLengthMeasure?(new Xbim.Ifc4x3.MeasureResource.IfcLengthMeasure(value.Value)) : ((Xbim.Ifc4x3.MeasureResource.IfcLengthMeasure?)null));
		}
	}
	...
	Xbim.Ifc4.MeasureResource.IfcPositiveLengthMeasure? IIfcReinforcementBarProperties.NominalBarDiameter
	{
		...
		set
		{
			NominalBarDiameter = (value.HasValue ? new Xbim.Ifc4x3.MeasureResource.IfcPositiveLengthMeasure?(new Xbim.Ifc4x3.MeasureResource.IfcPositiveLengthMeasure(value.Value)) : ((Xbim.Ifc4x3.MeasureResource.IfcPositiveLengthMeasure?)null));
		}
	}
	...
	Xbim.Ifc4.MeasureResource.IfcCountMeasure? IIfcReinforcementBarProperties.BarCount
	{
		get
		{
			...
			return new Xbim.Ifc4.MeasureResource.IfcCountMeasure((long)BarCount.Value);
		}
		set
		{
			BarCount = (value.HasValue ? new Xbim.Ifc4x3.MeasureResource.IfcCountMeasure?(new Xbim.Ifc4x3.MeasureResource.IfcCountMeasure(value.Value)) : ((Xbim.Ifc4x3.MeasureResource.IfcCountMeasure?)null));
		}
	}

	[EntityAttribute(1, EntityAttributeState.Mandatory, EntityAttributeType.None, EntityAttributeType.None, null, null, 2)]
	public Xbim.Ifc4x3.MeasureResource.IfcAreaMeasure TotalCrossSectionArea
	{
		get
		{
			if (_activated)
	...
	public Xbim.Ifc4x3.MeasureResource.IfcLabel SteelGrade
	{
		get
		{
			if (_activated)
	...
	public Xbim.Ifc4x3.MeasureResource.IfcLengthMeasure? EffectiveDepth
	{
		get
		{
			if (_activated)
	...
	public Xbim.Ifc4x3.MeasureResource.IfcPositiveLengthMeasure? NominalBarDiameter
	{
		get
		{
			if (_activated)
	...
	public Xbim.Ifc4x3.MeasureResource.IfcCountMeasure? BarCount
	{
		get
		{
			if (_activated)
