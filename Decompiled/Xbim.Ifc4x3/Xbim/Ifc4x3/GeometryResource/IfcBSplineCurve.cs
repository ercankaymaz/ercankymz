...
public abstract class IfcBSplineCurve : IfcBoundedCurve, IEquatable<IfcBSplineCurve>, IIfcBSplineCurve, IIfcBoundedCurve, IIfcCurve, IIfcGeometricRepresentationItem, IIfcRepresentationItem, IPersistEntity, IPersist, IfcLayeredItem, IIfcLayeredItem, IExpressSelectType, IfcGeometricSetSelect, IIfcGeometricSetSelect, IfcCurveOrEdgeCurve, IIfcCurveOrEdgeCurve
{
	private Xbim.Ifc4x3.MeasureResource.IfcInteger _degree;

	private readonly ItemSet<IfcCartesianPoint> _controlPointsList;

	private IfcBSplineCurveForm _curveForm;

	private Xbim.Ifc4x3.MeasureResource.IfcLogical _closedCurve;
	...
	public Xbim.Ifc4x3.MeasureResource.IfcInteger Degree
	{
		get
		{
			if (_activated)
	...
	public Xbim.Ifc4x3.MeasureResource.IfcInteger UpperIndexOnControlPoints => ControlPointsList.Count - 1;
	...
	Xbim.Ifc4.MeasureResource.IfcInteger IIfcBSplineCurve.Degree
	{
		get
		{
			return new Xbim.Ifc4.MeasureResource.IfcInteger(Degree);
		}
		set
		{
			Degree = new Xbim.Ifc4x3.MeasureResource.IfcInteger(value);
		}
	}
	...
	Xbim.Ifc4.MeasureResource.IfcLogical IIfcBSplineCurve.ClosedCurve
	{
		get
		{
			return new Xbim.Ifc4.MeasureResource.IfcLogical(ClosedCurve);
		}
		set
		{
			ClosedCurve = new Xbim.Ifc4x3.MeasureResource.IfcLogical(value);
		}
	}

	[CrossSchemaAttribute(typeof(IIfcBSplineCurve), 5)]
	Xbim.Ifc4.MeasureResource.IfcLogical IIfcBSplineCurve.SelfIntersect
	{
		get
		{
	...
	Xbim.Ifc4.MeasureResource.IfcInteger IIfcBSplineCurve.UpperIndexOnControlPoints => new Xbim.Ifc4.MeasureResource.IfcInteger(UpperIndexOnControlPoints);
