...
public class IfcThirdOrderPolynomialSpiral : IfcSpiral, IInstantiableEntity, IPersistEntity, IPersist, IContainsEntityReferences, IEquatable<IfcThirdOrderPolynomialSpiral>
{
	...
	public IfcLengthMeasure? QuadraticTerm
	{
		...
		set
		{
			...
			{
				_quadraticTerm = v;
			}, _quadraticTerm, value, "QuadraticTerm", 3);
		}
	}
	...
	public IfcLengthMeasure? LinearTerm
	{
		...
		set
		{
			...
			{
				_linearTerm = v;
			}, _linearTerm, value, "LinearTerm", 4);
		}
	}
	...
	public IfcLengthMeasure? ConstantTerm
	{
		...
		set
		{
			...
			{
				_constantTerm = v;
			}, _constantTerm, value, "ConstantTerm", 5);
		}
	}
	...
	internal IfcThirdOrderPolynomialSpiral(IModel model, int label, bool activated)
