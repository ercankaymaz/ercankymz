...
public class IfcSurfaceOfRevolution : IfcSweptSurface, IInstantiableEntity, IPersistEntity, IPersist, IContainsEntityReferences, IEquatable<IfcSurfaceOfRevolution>, IIfcSurfaceOfRevolution, IIfcSweptSurface, IIfcSurface, IIfcGeometricRepresentationItem, IIfcRepresentationItem, IfcLayeredItem, IIfcLayeredItem, IExpressSelectType, IfcGeometricSetSelect, IIfcGeometricSetSelect, IfcSurfaceOrFaceSurface, IIfcSurfaceOrFaceSurface
{
	...
	public XbimLine AxisLine
	{
		get
		{
			...
			{
				if (!(AxisPosition.Location is IfcCartesianPoint ifcCartesianPoint))
				{
