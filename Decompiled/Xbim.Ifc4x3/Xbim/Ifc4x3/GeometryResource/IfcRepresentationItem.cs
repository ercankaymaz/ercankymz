...
public abstract class IfcRepresentationItem : PersistEntity, Xbim.Ifc4x3.PresentationOrganizationResource.IfcLayeredItem, IIfcLayeredItem, IExpressSelectType, IPersist, IPersistEntity, IEquatable<IfcRepresentationItem>, IIfcRepresentationItem, Xbim.Ifc4.PresentationOrganizationResource.IfcLayeredItem
{
	...
	public IEnumerable<Xbim.Ifc4x3.PresentationOrganizationResource.IfcPresentationLayerAssignment> LayerAssignment => base.Model.Instances.Where((Xbim.Ifc4x3.PresentationOrganizationResource.IfcPresentationLayerAssignment e) => e.AssignedItems != null && e.AssignedItems.Contains(this), "AssignedItems", this);
