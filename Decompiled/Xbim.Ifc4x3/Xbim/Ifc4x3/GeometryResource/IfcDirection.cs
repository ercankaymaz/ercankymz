...
public class IfcDirection : IfcGeometricRepresentationItem, IInstantiableEntity, IPersistEntity, IPersist, Xbim.Ifc4x3.GeometricConstraintResource.IfcGridPlacementDirectionSelect, IExpressSelectType, IIfcGridPlacementDirectionSelect, IfcVectorOrDirection, IIfcVectorOrDirection, IEquatable<IfcDirection>, IIfcDirection, IIfcGeometricRepresentationItem, IIfcRepresentationItem, IfcLayeredItem, IIfcLayeredItem, Xbim.Ifc4.GeometricConstraintResource.IfcGridPlacementDirectionSelect, Xbim.Ifc4.GeometryResource.IfcVectorOrDirection
{
	private readonly ItemSet<Xbim.Ifc4x3.MeasureResource.IfcReal> _directionRatios;

	[EntityAttribute(1, EntityAttributeState.Mandatory, EntityAttributeType.List, EntityAttributeType.None, new int[] { 2 }, new int[] { 3 }, 3)]
	public IItemSet<Xbim.Ifc4x3.MeasureResource.IfcReal> DirectionRatios
	{
		get
		{
			if (_activated)
	...
	IItemSet<Xbim.Ifc4.MeasureResource.IfcReal> IIfcDirection.DirectionRatios => new ProxyValueSet<Xbim.Ifc4x3.MeasureResource.IfcReal, Xbim.Ifc4.MeasureResource.IfcReal>(DirectionRatios, (Xbim.Ifc4x3.MeasureResource.IfcReal s) => new Xbim.Ifc4.MeasureResource.IfcReal(s), (Xbim.Ifc4.MeasureResource.IfcReal t) => new Xbim.Ifc4x3.MeasureResource.IfcReal(t));
	...
	{
		_directionRatios = new ItemSet<Xbim.Ifc4x3.MeasureResource.IfcReal>(this, 3, 1);
	}
