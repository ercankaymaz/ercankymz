...
public class IfcRepresentationMap : PersistEntity, IInstantiableEntity, IPersistEntity, IPersist, Xbim.Ifc4x3.RepresentationResource.IfcProductRepresentationSelect, IIfcProductRepresentationSelect, IExpressSelectType, IContainsEntityReferences, IContainsIndexedReferences, IEquatable<IfcRepresentationMap>, IIfcRepresentationMap, Xbim.Ifc4.RepresentationResource.IfcProductRepresentationSelect
{
	private IfcAxis2Placement _mappingOrigin;

	private Xbim.Ifc4x3.RepresentationResource.IfcRepresentation _mappedRepresentation;
	...
	public Xbim.Ifc4x3.RepresentationResource.IfcRepresentation MappedRepresentation
	{
		get
		{
			if (_activated)
		...
		set
		{
			...
			SetValue(delegate(Xbim.Ifc4x3.RepresentationResource.IfcRepresentation v)
			{
	...
	public IEnumerable<Xbim.Ifc4x3.RepresentationResource.IfcShapeAspect> HasShapeAspects => base.Model.Instances.Where((Xbim.Ifc4x3.RepresentationResource.IfcShapeAspect e) => Equals(e.PartOfProductDefinitionShape), "PartOfProductDefinitionShape", this);
	...
	IIfcRepresentation IIfcRepresentationMap.MappedRepresentation
	{
		...
		set
		{
			MappedRepresentation = value as Xbim.Ifc4x3.RepresentationResource.IfcRepresentation;
		}
	}
	...
	public override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
	{
		...
		case 0:
			...
			break;
		case 1:
			_mappedRepresentation = (Xbim.Ifc4x3.RepresentationResource.IfcRepresentation)value.EntityVal;
			break;
		default:
