...
public struct IfcTimeStamp : IfcSimpleValue, IfcValue, IfcAppliedValueSelect, IExpressSelectType, IPersist, IfcMetricValueSelect, IExpressValueType, IExpressIntegerType, IEquatable<long>
{
	private long _value;
