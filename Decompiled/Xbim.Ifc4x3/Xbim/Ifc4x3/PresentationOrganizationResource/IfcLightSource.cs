...
public abstract class IfcLightSource : IfcGeometricRepresentationItem, IIfcLightSource, IIfcGeometricRepresentationItem, IIfcRepresentationItem, IPersistEntity, IPersist, Xbim.Ifc4.PresentationOrganizationResource.IfcLayeredItem, IIfcLayeredItem, IExpressSelectType, IEquatable<IfcLightSource>
{
	...
	private Xbim.Ifc4x3.MeasureResource.IfcNormalisedRatioMeasure? _ambientIntensity;

	private Xbim.Ifc4x3.MeasureResource.IfcNormalisedRatioMeasure? _intensity;
	...
	Xbim.Ifc4.MeasureResource.IfcNormalisedRatioMeasure? IIfcLightSource.AmbientIntensity
	{
		...
		set
		{
			AmbientIntensity = (value.HasValue ? new Xbim.Ifc4x3.MeasureResource.IfcNormalisedRatioMeasure?(new Xbim.Ifc4x3.MeasureResource.IfcNormalisedRatioMeasure(value.Value)) : ((Xbim.Ifc4x3.MeasureResource.IfcNormalisedRatioMeasure?)null));
		}
	}
	...
	Xbim.Ifc4.MeasureResource.IfcNormalisedRatioMeasure? IIfcLightSource.Intensity
	{
		...
		set
		{
			Intensity = (value.HasValue ? new Xbim.Ifc4x3.MeasureResource.IfcNormalisedRatioMeasure?(new Xbim.Ifc4x3.MeasureResource.IfcNormalisedRatioMeasure(value.Value)) : ((Xbim.Ifc4x3.MeasureResource.IfcNormalisedRatioMeasure?)null));
		}
	}
	...
	public Xbim.Ifc4x3.MeasureResource.IfcNormalisedRatioMeasure? AmbientIntensity
	{
		get
		{
			if (_activated)
	...
	public Xbim.Ifc4x3.MeasureResource.IfcNormalisedRatioMeasure? Intensity
	{
		get
		{
			if (_activated)
