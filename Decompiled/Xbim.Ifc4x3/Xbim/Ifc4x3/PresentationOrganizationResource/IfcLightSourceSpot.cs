...
public class IfcLightSourceSpot : IfcLightSourcePositional, IIfcLightSourceSpot, IIfcLightSourcePositional, IIfcLightSource, IIfcGeometricRepresentationItem, IIfcRepresentationItem, IPersistEntity, IPersist, Xbim.Ifc4.PresentationOrganizationResource.IfcLayeredItem, IIfcLayeredItem, IExpressSelectType, IInstantiableEntity, IContainsEntityReferences, IEquatable<IfcLightSourceSpot>
{
	...
	private Xbim.Ifc4x3.MeasureResource.IfcReal? _concentrationExponent;

	private Xbim.Ifc4x3.MeasureResource.IfcPositivePlaneAngleMeasure _spreadAngle;

	private Xbim.Ifc4x3.MeasureResource.IfcPositivePlaneAngleMeasure _beamWidthAngle;
	...
	Xbim.Ifc4.MeasureResource.IfcReal? IIfcLightSourceSpot.ConcentrationExponent
	{
		...
		set
		{
			ConcentrationExponent = (value.HasValue ? new Xbim.Ifc4x3.MeasureResource.IfcReal?(new Xbim.Ifc4x3.MeasureResource.IfcReal(value.Value)) : ((Xbim.Ifc4x3.MeasureResource.IfcReal?)null));
		}
	}
	...
	Xbim.Ifc4.MeasureResource.IfcPositivePlaneAngleMeasure IIfcLightSourceSpot.SpreadAngle
	{
		...
		set
		{
			SpreadAngle = new Xbim.Ifc4x3.MeasureResource.IfcPositivePlaneAngleMeasure(value);
		}
	}
	...
	Xbim.Ifc4.MeasureResource.IfcPositivePlaneAngleMeasure IIfcLightSourceSpot.BeamWidthAngle
	{
		...
		set
		{
			BeamWidthAngle = new Xbim.Ifc4x3.MeasureResource.IfcPositivePlaneAngleMeasure(value);
		}
	}
	...
	public Xbim.Ifc4x3.MeasureResource.IfcReal? ConcentrationExponent
	{
		get
		{
			if (_activated)
	...
	public Xbim.Ifc4x3.MeasureResource.IfcPositivePlaneAngleMeasure SpreadAngle
	{
		get
		{
			if (_activated)
		...
		set
		{
			SetValue(delegate(Xbim.Ifc4x3.MeasureResource.IfcPositivePlaneAngleMeasure v)
			{
				_spreadAngle = v;
	...
	public Xbim.Ifc4x3.MeasureResource.IfcPositivePlaneAngleMeasure BeamWidthAngle
	{
		get
		{
			if (_activated)
