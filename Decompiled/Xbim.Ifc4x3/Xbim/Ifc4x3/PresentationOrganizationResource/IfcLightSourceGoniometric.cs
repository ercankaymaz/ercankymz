...
public class IfcLightSourceGoniometric : IfcLightSource, IIfcLightSourceGoniometric, IIfcLightSource, IIfcGeometricRepresentationItem, IIfcRepresentationItem, IPersistEntity, IPersist, Xbim.Ifc4.PresentationOrganizationResource.IfcLayeredItem, IIfcLayeredItem, IExpressSelectType, IInstantiableEntity, IContainsEntityReferences, IEquatable<IfcLightSourceGoniometric>
{
	...
	private Xbim.Ifc4x3.MeasureResource.IfcThermodynamicTemperatureMeasure _colourTemperature;

	private Xbim.Ifc4x3.MeasureResource.IfcLuminousFluxMeasure _luminousFlux;
	...
	Xbim.Ifc4.MeasureResource.IfcThermodynamicTemperatureMeasure IIfcLightSourceGoniometric.ColourTemperature
	{
		...
		set
		{
			ColourTemperature = new Xbim.Ifc4x3.MeasureResource.IfcThermodynamicTemperatureMeasure(value);
		}
	}
	...
	Xbim.Ifc4.MeasureResource.IfcLuminousFluxMeasure IIfcLightSourceGoniometric.LuminousFlux
	{
		...
		set
		{
			LuminousFlux = new Xbim.Ifc4x3.MeasureResource.IfcLuminousFluxMeasure(value);
		}
	}
	...
	public Xbim.Ifc4x3.MeasureResource.IfcThermodynamicTemperatureMeasure ColourTemperature
	{
		get
		{
			if (_activated)
	...
	public Xbim.Ifc4x3.MeasureResource.IfcLuminousFluxMeasure LuminousFlux
	{
		get
		{
			if (_activated)
		...
		set
		{
			SetValue(delegate(Xbim.Ifc4x3.MeasureResource.IfcLuminousFluxMeasure v)
			{
				_luminousFlux = v;
