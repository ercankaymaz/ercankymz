...
public class IfcActuator : IfcDistributionControlElement, IInstantiableEntity, IPersistEntity, IPersist, IContainsEntityReferences, IContainsIndexedReferences, IEquatable<IfcActuator>, IIfcActuator, IIfcDistributionControlElement, IIfcDistributionElement, IIfcElement, IIfcProduct, IIfcObject, IIfcObjectDefinition, IIfcRoot, IfcDefinitionSelect, IIfcDefinitionSelect, IExpressSelectType, IfcProductSelect, IIfcProductSelect, IfcStructuralActivityAssignmentSelect, IIfcStructuralActivityAssignmentSelect
{
	...
	[CrossSchemaAttribute(typeof(IIfcActuator), 9)]
	Xbim.Ifc4.Interfaces.IfcActuatorTypeEnum? IIfcActuator.PredefinedType
	{
		get
		{
