...
public class IfcAlarm : IfcDistributionControlElement, IInstantiableEntity, IPersistEntity, IPersist, IContainsEntityReferences, IContainsIndexedReferences, IEquatable<IfcAlarm>, IIfcAlarm, IIfcDistributionControlElement, IIfcDistributionElement, IIfcElement, IIfcProduct, IIfcObject, IIfcObjectDefinition, IIfcRoot, IfcDefinitionSelect, IIfcDefinitionSelect, IExpressSelectType, IfcProductSelect, IIfcProductSelect, IfcStructuralActivityAssignmentSelect, IIfcStructuralActivityAssignmentSelect
{
	...
	Xbim.Ifc4.Interfaces.IfcAlarmTypeEnum? IIfcAlarm.PredefinedType
	{
		get
		{
			return PredefinedType switch
			{
				...
				IfcAlarmTypeEnum.RAILWAYCROCODILE => this.GetUserDefined<Xbim.Ifc4.Interfaces.IfcAlarmTypeEnum>(), 
				IfcAlarmTypeEnum.RAILWAYDETONATOR => this.GetUserDefined<Xbim.Ifc4.Interfaces.IfcAlarmTypeEnum>(), 
