...
public class IfcDocumentInformationRelationship : IfcResourceLevelRelationship, IInstantiableEntity, IPersistEntity, IPersist, IContainsEntityReferences, IContainsIndexedReferences, IEquatable<IfcDocumentInformationRelationship>, IIfcDocumentInformationRelationship, IIfcResourceLevelRelationship
{
	private IfcDocumentInformation _relatingDocument;

	private readonly ItemSet<IfcDocumentInformation> _relatedDocuments;

	private Xbim.Ifc4x3.MeasureResource.IfcLabel? _relationshipType;
	...
	public Xbim.Ifc4x3.MeasureResource.IfcLabel? RelationshipType
	{
		get
		{
			if (_activated)
	...
	Xbim.Ifc4.MeasureResource.IfcLabel? IIfcDocumentInformationRelationship.RelationshipType
	{
		...
		set
		{
			RelationshipType = (value.HasValue ? new Xbim.Ifc4x3.MeasureResource.IfcLabel?(new Xbim.Ifc4x3.MeasureResource.IfcLabel(value.Value)) : ((Xbim.Ifc4x3.MeasureResource.IfcLabel?)null));
		}
	}
