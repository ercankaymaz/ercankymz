...
public class IfcMaterialLayerSetUsage : IfcMaterialUsageDefinition, IIfcMaterialLayerSetUsage, IIfcMaterialUsageDefinition, IPersistEntity, IPersist, Xbim.Ifc4.MaterialResource.IfcMaterialSelect, IIfcMaterialSelect, IExpressSelectType, IInstantiableEntity, IContainsEntityReferences, IEquatable<IfcMaterialLayerSetUsage>
{
	...
	private Xbim.Ifc4x3.MeasureResource.IfcLengthMeasure _offsetFromReferenceLine;
	...
	Xbim.Ifc4.MeasureResource.IfcLengthMeasure IIfcMaterialLayerSetUsage.OffsetFromReferenceLine
	{
		...
		set
		{
			OffsetFromReferenceLine = new Xbim.Ifc4x3.MeasureResource.IfcLengthMeasure(value);
		}
	}
	...
	public Xbim.Ifc4x3.MeasureResource.IfcLengthMeasure OffsetFromReferenceLine
	{
		get
		{
			if (_activated)
