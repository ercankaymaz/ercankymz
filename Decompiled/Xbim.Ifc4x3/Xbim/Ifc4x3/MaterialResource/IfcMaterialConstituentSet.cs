...
public class IfcMaterialConstituentSet : IfcMaterialDefinition, IIfcMaterialConstituentSet, IIfcMaterialDefinition, IPersistEntity, IPersist, Xbim.Ifc4.MaterialResource.IfcMaterialSelect, IIfcMaterialSelect, IExpressSelectType, IfcObjectReferenceSelect, IIfcObjectReferenceSelect, IfcResourceObjectSelect, IIfcResourceObjectSelect, IInstantiableEntity, IContainsEntityReferences, IContainsIndexedReferences, IEquatable<IfcMaterialConstituentSet>
{
	...
	Xbim.Ifc4.MeasureResource.IfcLabel? IIfcMaterialConstituentSet.Name
	{
		get
		{
			if (!Name.HasValue)
	...
	Xbim.Ifc4.MeasureResource.IfcText? IIfcMaterialConstituentSet.Description
	{
		get
		{
