...
public class IfcDoorLiningProperties : Xbim.Ifc4x3.Kernel.IfcPreDefinedPropertySet, IInstantiableEntity, IPersistEntity, IPersist, IContainsEntityReferences, IEquatable<IfcDoorLiningProperties>, IIfcDoorLiningProperties, IIfcPreDefinedPropertySet, IIfcPropertySetDefinition, IIfcPropertyDefinition, IIfcRoot, Xbim.Ifc4.Kernel.IfcDefinitionSelect, IIfcDefinitionSelect, IExpressSelectType, Xbim.Ifc4.Kernel.IfcPropertySetDefinitionSelect, IIfcPropertySetDefinitionSelect
{
	...
	private Xbim.Ifc4x3.MeasureResource.IfcPositiveLengthMeasure? _thresholdDepth;

	private Xbim.Ifc4x3.MeasureResource.IfcNonNegativeLengthMeasure? _thresholdThickness;

	private Xbim.Ifc4x3.MeasureResource.IfcNonNegativeLengthMeasure? _transomThickness;

	private Xbim.Ifc4x3.MeasureResource.IfcLengthMeasure? _transomOffset;

	private Xbim.Ifc4x3.MeasureResource.IfcLengthMeasure? _liningOffset;

	private Xbim.Ifc4x3.MeasureResource.IfcLengthMeasure? _thresholdOffset;

	private Xbim.Ifc4x3.MeasureResource.IfcPositiveLengthMeasure? _casingThickness;

	private Xbim.Ifc4x3.MeasureResource.IfcPositiveLengthMeasure? _casingDepth;
	...
	public Xbim.Ifc4x3.MeasureResource.IfcPositiveLengthMeasure? ThresholdDepth
	{
		get
		{
			if (_activated)
	...
	public Xbim.Ifc4x3.MeasureResource.IfcNonNegativeLengthMeasure? ThresholdThickness
	{
		get
		{
			if (_activated)
	...
	public Xbim.Ifc4x3.MeasureResource.IfcLengthMeasure? TransomOffset
	{
		get
		{
			if (_activated)
	...
	public Xbim.Ifc4x3.MeasureResource.IfcLengthMeasure? ThresholdOffset
	{
		get
		{
			if (_activated)
	...
	public Xbim.Ifc4x3.MeasureResource.IfcPositiveLengthMeasure? CasingThickness
	{
		get
		{
			if (_activated)
	...
	public Xbim.Ifc4x3.MeasureResource.IfcPositiveLengthMeasure? CasingDepth
	{
		get
		{
			if (_activated)
	...
	Xbim.Ifc4.MeasureResource.IfcPositiveLengthMeasure? IIfcDoorLiningProperties.ThresholdDepth
	{
		...
		set
		{
			ThresholdDepth = (value.HasValue ? new Xbim.Ifc4x3.MeasureResource.IfcPositiveLengthMeasure?(new Xbim.Ifc4x3.MeasureResource.IfcPositiveLengthMeasure(value.Value)) : ((Xbim.Ifc4x3.MeasureResource.IfcPositiveLengthMeasure?)null));
		}
	}
	...
	Xbim.Ifc4.MeasureResource.IfcNonNegativeLengthMeasure? IIfcDoorLiningProperties.ThresholdThickness
	{
		get
		{
			...
			return new Xbim.Ifc4.MeasureResource.IfcNonNegativeLengthMeasure(ThresholdThickness.Value);
		}
		set
		{
			ThresholdThickness = (value.HasValue ? new Xbim.Ifc4x3.MeasureResource.IfcNonNegativeLengthMeasure?(new Xbim.Ifc4x3.MeasureResource.IfcNonNegativeLengthMeasure(value.Value)) : ((Xbim.Ifc4x3.MeasureResource.IfcNonNegativeLengthMeasure?)null));
		}
	}
	...
	Xbim.Ifc4.MeasureResource.IfcLengthMeasure? IIfcDoorLiningProperties.TransomOffset
	{
		...
		set
		{
			TransomOffset = (value.HasValue ? new Xbim.Ifc4x3.MeasureResource.IfcLengthMeasure?(new Xbim.Ifc4x3.MeasureResource.IfcLengthMeasure(value.Value)) : ((Xbim.Ifc4x3.MeasureResource.IfcLengthMeasure?)null));
		}
	}
	...
	Xbim.Ifc4.MeasureResource.IfcLengthMeasure? IIfcDoorLiningProperties.ThresholdOffset
	{
		...
		set
		{
			ThresholdOffset = (value.HasValue ? new Xbim.Ifc4x3.MeasureResource.IfcLengthMeasure?(new Xbim.Ifc4x3.MeasureResource.IfcLengthMeasure(value.Value)) : ((Xbim.Ifc4x3.MeasureResource.IfcLengthMeasure?)null));
		}
	}
	...
	Xbim.Ifc4.MeasureResource.IfcPositiveLengthMeasure? IIfcDoorLiningProperties.CasingThickness
	{
		...
		set
		{
			CasingThickness = (value.HasValue ? new Xbim.Ifc4x3.MeasureResource.IfcPositiveLengthMeasure?(new Xbim.Ifc4x3.MeasureResource.IfcPositiveLengthMeasure(value.Value)) : ((Xbim.Ifc4x3.MeasureResource.IfcPositiveLengthMeasure?)null));
		}
	}
	...
	Xbim.Ifc4.MeasureResource.IfcPositiveLengthMeasure? IIfcDoorLiningProperties.CasingDepth
	{
		...
		set
		{
			CasingDepth = (value.HasValue ? new Xbim.Ifc4x3.MeasureResource.IfcPositiveLengthMeasure?(new Xbim.Ifc4x3.MeasureResource.IfcPositiveLengthMeasure(value.Value)) : ((Xbim.Ifc4x3.MeasureResource.IfcPositiveLengthMeasure?)null));
		}
	}
