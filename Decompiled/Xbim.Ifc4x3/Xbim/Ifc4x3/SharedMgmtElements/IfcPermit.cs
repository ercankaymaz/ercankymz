...
public class IfcPermit : Xbim.Ifc4x3.Kernel.IfcControl, IIfcPermit, IIfcControl, IIfcObject, IIfcObjectDefinition, IIfcRoot, IPersistEntity, IPersist, Xbim.Ifc4.Kernel.IfcDefinitionSelect, IIfcDefinitionSelect, IExpressSelectType, IInstantiableEntity, IContainsEntityReferences, IEquatable<IfcPermit>
{
	...
	Xbim.Ifc4.Interfaces.IfcPermitTypeEnum? IIfcPermit.PredefinedType
	{
		get
		{
			return PredefinedType switch
			{
				IfcPermitTypeEnum.ACCESS => Xbim.Ifc4.Interfaces.IfcPermitTypeEnum.ACCESS, 
				IfcPermitTypeEnum.BUILDING => Xbim.Ifc4.Interfaces.IfcPermitTypeEnum.BUILDING, 
				IfcPermitTypeEnum.WORK => Xbim.Ifc4.Interfaces.IfcPermitTypeEnum.WORK, 
				IfcPermitTypeEnum.USERDEFINED => Xbim.Ifc4.Interfaces.IfcPermitTypeEnum.USERDEFINED, 
				IfcPermitTypeEnum.NOTDEFINED => Xbim.Ifc4.Interfaces.IfcPermitTypeEnum.NOTDEFINED, 
				null => null, 
		...
		set
		{
			switch (value)
			{
			case Xbim.Ifc4.Interfaces.IfcPermitTypeEnum.ACCESS:
				PredefinedType = IfcPermitTypeEnum.ACCESS;
				break;
			case Xbim.Ifc4.Interfaces.IfcPermitTypeEnum.BUILDING:
				PredefinedType = IfcPermitTypeEnum.BUILDING;
				break;
			case Xbim.Ifc4.Interfaces.IfcPermitTypeEnum.WORK:
				PredefinedType = IfcPermitTypeEnum.WORK;
				break;
			case Xbim.Ifc4.Interfaces.IfcPermitTypeEnum.USERDEFINED:
				PredefinedType = IfcPermitTypeEnum.USERDEFINED;
				break;
			case Xbim.Ifc4.Interfaces.IfcPermitTypeEnum.NOTDEFINED:
