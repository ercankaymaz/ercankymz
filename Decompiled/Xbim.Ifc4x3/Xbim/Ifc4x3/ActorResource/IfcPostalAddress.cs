...
public class IfcPostalAddress : IfcAddress, IInstantiableEntity, IPersistEntity, IPersist, IEquatable<IfcPostalAddress>, IIfcPostalAddress, IIfcAddress, IfcObjectReferenceSelect, IIfcObjectReferenceSelect, IExpressSelectType
{
	private Xbim.Ifc4x3.MeasureResource.IfcLabel? _internalLocation;

	private readonly OptionalItemSet<Xbim.Ifc4x3.MeasureResource.IfcLabel> _addressLines;

	private Xbim.Ifc4x3.MeasureResource.IfcLabel? _postalBox;

	private Xbim.Ifc4x3.MeasureResource.IfcLabel? _town;

	private Xbim.Ifc4x3.MeasureResource.IfcLabel? _region;

	private Xbim.Ifc4x3.MeasureResource.IfcLabel? _postalCode;

	private Xbim.Ifc4x3.MeasureResource.IfcLabel? _country;

	[EntityAttribute(4, EntityAttributeState.Optional, EntityAttributeType.None, EntityAttributeType.None, null, null, 6)]
	public Xbim.Ifc4x3.MeasureResource.IfcLabel? InternalLocation
	{
		get
		{
			if (_activated)
	...
	public IOptionalItemSet<Xbim.Ifc4x3.MeasureResource.IfcLabel> AddressLines
	{
		get
		{
			if (_activated)
	...
	public Xbim.Ifc4x3.MeasureResource.IfcLabel? PostalBox
	{
		get
		{
			if (_activated)
	...
	public Xbim.Ifc4x3.MeasureResource.IfcLabel? Town
	{
		get
		{
			if (_activated)
	...
	public Xbim.Ifc4x3.MeasureResource.IfcLabel? Region
	{
		get
		{
			if (_activated)
	...
	public Xbim.Ifc4x3.MeasureResource.IfcLabel? PostalCode
	{
		get
		{
			if (_activated)
	...
	public Xbim.Ifc4x3.MeasureResource.IfcLabel? Country
	{
		get
		{
			if (_activated)
	...
	Xbim.Ifc4.MeasureResource.IfcLabel? IIfcPostalAddress.InternalLocation
	{
		...
		set
		{
			InternalLocation = (value.HasValue ? new Xbim.Ifc4x3.MeasureResource.IfcLabel?(new Xbim.Ifc4x3.MeasureResource.IfcLabel(value.Value)) : ((Xbim.Ifc4x3.MeasureResource.IfcLabel?)null));
		}
	}

	[CrossSchemaAttribute(typeof(IIfcPostalAddress), 5)]
	IItemSet<Xbim.Ifc4.MeasureResource.IfcLabel> IIfcPostalAddress.AddressLines => new ProxyValueSet<Xbim.Ifc4x3.MeasureResource.IfcLabel, Xbim.Ifc4.MeasureResource.IfcLabel>(AddressLines, (Xbim.Ifc4x3.MeasureResource.IfcLabel s) => new Xbim.Ifc4.MeasureResource.IfcLabel(s), (Xbim.Ifc4.MeasureResource.IfcLabel t) => new Xbim.Ifc4x3.MeasureResource.IfcLabel(t));
	...
	Xbim.Ifc4.MeasureResource.IfcLabel? IIfcPostalAddress.PostalBox
	{
		...
		set
		{
			PostalBox = (value.HasValue ? new Xbim.Ifc4x3.MeasureResource.IfcLabel?(new Xbim.Ifc4x3.MeasureResource.IfcLabel(value.Value)) : ((Xbim.Ifc4x3.MeasureResource.IfcLabel?)null));
		}
	}
	...
	Xbim.Ifc4.MeasureResource.IfcLabel? IIfcPostalAddress.Town
	{
		...
		set
		{
			Town = (value.HasValue ? new Xbim.Ifc4x3.MeasureResource.IfcLabel?(new Xbim.Ifc4x3.MeasureResource.IfcLabel(value.Value)) : ((Xbim.Ifc4x3.MeasureResource.IfcLabel?)null));
		}
	}
	...
	Xbim.Ifc4.MeasureResource.IfcLabel? IIfcPostalAddress.Region
	{
		...
		set
		{
			Region = (value.HasValue ? new Xbim.Ifc4x3.MeasureResource.IfcLabel?(new Xbim.Ifc4x3.MeasureResource.IfcLabel(value.Value)) : ((Xbim.Ifc4x3.MeasureResource.IfcLabel?)null));
		}
	}
	...
	Xbim.Ifc4.MeasureResource.IfcLabel? IIfcPostalAddress.PostalCode
	{
		...
		set
		{
			PostalCode = (value.HasValue ? new Xbim.Ifc4x3.MeasureResource.IfcLabel?(new Xbim.Ifc4x3.MeasureResource.IfcLabel(value.Value)) : ((Xbim.Ifc4x3.MeasureResource.IfcLabel?)null));
		}
	}
	...
	Xbim.Ifc4.MeasureResource.IfcLabel? IIfcPostalAddress.Country
	{
		...
		set
		{
			Country = (value.HasValue ? new Xbim.Ifc4x3.MeasureResource.IfcLabel?(new Xbim.Ifc4x3.MeasureResource.IfcLabel(value.Value)) : ((Xbim.Ifc4x3.MeasureResource.IfcLabel?)null));
		}
	}
	...
	{
		_addressLines = new OptionalItemSet<Xbim.Ifc4x3.MeasureResource.IfcLabel>(this, 0, 5);
	}
