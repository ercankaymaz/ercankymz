...
{
	IIfcRelProjectsElement IIfcFeatureElementAddition.ProjectsElements => base.Model.Instances.FirstOrDefault((IIfcRelProjectsElement e) => e.RelatedFeatureElement as IfcFeatureElementAddition == this, "RelatedFeatureElement", this);
