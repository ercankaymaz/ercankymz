...
public class IfcRelSpaceBoundary2ndLevel : IfcRelSpaceBoundary1stLevel, IIfcRelSpaceBoundary2ndLevel, IIfcRelSpaceBoundary1stLevel, IIfcRelSpaceBoundary, IIfcRelConnects, IIfcRelationship, IIfcRoot, IPersistEntity, IPersist, IInstantiableEntity, IContainsEntityReferences, IContainsIndexedReferences, IEquatable<IfcRelSpaceBoundary2ndLevel>
{
	...
	IEnumerable<IIfcRelSpaceBoundary2ndLevel> IIfcRelSpaceBoundary2ndLevel.Corresponds => base.Model.Instances.Where((IIfcRelSpaceBoundary2ndLevel e) => e.CorrespondingBoundary as IfcRelSpaceBoundary2ndLevel == this, "CorrespondingBoundary", this);
