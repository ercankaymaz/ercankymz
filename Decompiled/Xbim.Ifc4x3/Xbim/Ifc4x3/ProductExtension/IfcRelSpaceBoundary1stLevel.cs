...
public class IfcRelSpaceBoundary1stLevel : IfcRelSpaceBoundary, IIfcRelSpaceBoundary1stLevel, IIfcRelSpaceBoundary, IIfcRelConnects, IIfcRelationship, IIfcRoot, IPersistEntity, IPersist, IInstantiableEntity, IContainsEntityReferences, IContainsIndexedReferences, IEquatable<IfcRelSpaceBoundary1stLevel>
{
	...
	IEnumerable<IIfcRelSpaceBoundary1stLevel> IIfcRelSpaceBoundary1stLevel.InnerBoundaries => base.Model.Instances.Where((IIfcRelSpaceBoundary1stLevel e) => e.ParentBoundary as IfcRelSpaceBoundary1stLevel == this, "ParentBoundary", this);
