...
[ExpressType("IfcSignType", 1489)]
public class IfcSignType : IfcElementComponentType, IInstantiableEntity, IPersistEntity, IPersist, IContainsEntityReferences, IContainsIndexedReferences, IEquatable<IfcSignType>
{
	...
	internal IfcSignType(IModel model, int label, bool activated)
	...
	public bool Equals(IfcSignType other)
	{
		return this == other;
	}
}
