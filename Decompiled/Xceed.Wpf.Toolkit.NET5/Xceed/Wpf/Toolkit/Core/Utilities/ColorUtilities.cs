...
internal static class ColorUtilities
{
	...
	{
		return typeof(Colors).GetProperties(BindingFlags.Static | BindingFlags.Public).ToDictionary((PropertyInfo p) => p.Name, (PropertyInfo p) => (Color)p.GetValue(null, null));
	}
