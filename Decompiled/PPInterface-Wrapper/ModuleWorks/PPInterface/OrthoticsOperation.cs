...
public class OrthoticsOperation : Operation
{
	internal unsafe OrthoticsOperation(shared_ptr_003Cppinterface_003A_003AOperationNode_003E* ptr)
	{
	...
	internal unsafe shared_ptr_003Cppinterface_003A_003AOrthoticsOperation_003E* GetNativePtr(shared_ptr_003Cppinterface_003A_003AOrthoticsOperation_003E* P_0)
	{
		uint num = 0u;
		global::_003CModule_003E.std_002Estatic_pointer_cast_003Cclass_0020ppinterface_003A_003AOrthoticsOperation_002Cclass_0020ppinterface_003A_003AOperationNode_003E(P_0, m_native.GetPtr());
		try
		{
			num = 1u;
			GC.KeepAlive(this);
		...
		catch
		{
			...
			{
				num &= 0xFFFFFFFEu;
				global::_003CModule_003E.___CxxCallUnwindDtor((delegate*<void*, void>)(delegate*<shared_ptr_003Cppinterface_003A_003AOrthoticsOperation_003E*, void>)(&global::_003CModule_003E.std_002Eshared_ptr_003Cppinterface_003A_003AOrthoticsOperation_003E_002E_007Bdtor_007D), P_0);
			}
			throw;
		}
	}
