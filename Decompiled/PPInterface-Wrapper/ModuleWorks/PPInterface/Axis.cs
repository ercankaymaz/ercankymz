...
{
	private protected readonly SharedPointer_003Cppinterface_003A_003AAxis_003E m_native;

	public unsafe virtual double HardMax
	{
		set
		{
			uint num = 0u;
			...
			try
			{
				...
				shared_ptr_003Cppinterface_003A_003AAxis_003E* nativePtr = GetNativePtr(&shared_ptr_003Cppinterface_003A_003AAxis_003E2);
				shared_ptr_003Cppinterface_003A_003AAxis_003E* ptr = nativePtr;
				try
				{
					global::_003CModule_003E.ppinterface_002EAxis_002ESetHardMax((ppinterface.Axis*)(int)(*(uint*)nativePtr), value);
				}
				catch
				{
					//try-fault
	...
	public unsafe virtual double HardMin
	{
		set
		{
			uint num = 0u;
			...
			try
			{
				...
				try
				{
					global::_003CModule_003E.ppinterface_002EAxis_002ESetHardMin((ppinterface.Axis*)(int)(*(uint*)nativePtr), value);
				}
				catch
				{
					//try-fault
	...
	public unsafe virtual Vectord Orientation
	{
		set
		{
			uint num = 0u;
			...
			try
			{
				...
				try
				{
					ppinterface.Axis* ptr2 = (ppinterface.Axis*)(int)(*(uint*)nativePtr);
					...
					try
					{
						...
						global::_003CModule_003E.ppinterface_002EAxis_002ESetOrientation(ptr2, ptr4);
					}
					catch
					{
						//try-fault
	...
	public unsafe virtual string Uid
	{
		get
		{
			...
			try
			{
				...
				try
				{
					basic_string_003Cchar_002Cstd_003A_003Achar_traits_003Cchar_003E_002Cstd_003A_003Aallocator_003Cchar_003E_0020_003E* right = global::_003CModule_003E.ppinterface_002EAxis_002EGetUid((ppinterface.Axis*)(int)(*(uint*)nativePtr));
		...
		set
		{
			...
			try
			{
				...
				try
				{
					...
					try
					{
						global::_003CModule_003E.ppinterface_002EAxis_002ESetUid(ptr2, ptr3);
					}
					catch
					{
						//try-fault
	...
	internal unsafe Axis(shared_ptr_003Cppinterface_003A_003AAxis_003E* ptr)
	{
		...
		try
		{
			SharedPointer_003Cppinterface_003A_003AAxis_003E native = new SharedPointer_003Cppinterface_003A_003AAxis_003E(ptr);
			try
			{
				m_native = native;
				base._002Ector();
	...
	internal unsafe shared_ptr_003Cppinterface_003A_003AAxis_003E* GetNativePtr(shared_ptr_003Cppinterface_003A_003AAxis_003E* P_0)
	{
		uint num = 0u;
		shared_ptr_003Cppinterface_003A_003AAxis_003E* ptr = m_native.GetPtr();
		*(int*)P_0 = 0;
		shared_ptr_003Cppinterface_003A_003AAxis_003E* ptr2 = (shared_ptr_003Cppinterface_003A_003AAxis_003E*)((byte*)P_0 + 4);
		*(int*)ptr2 = 0;
		...
		*(int*)ptr2 = ((int*)ptr)[1];
		...
		catch
		{
			...
			{
				num &= 0xFFFFFFFEu;
				global::_003CModule_003E.___CxxCallUnwindDtor((delegate*<void*, void>)(delegate*<shared_ptr_003Cppinterface_003A_003AAxis_003E*, void>)(&global::_003CModule_003E.std_002Eshared_ptr_003Cppinterface_003A_003AAxis_003E_002E_007Bdtor_007D), P_0);
			}
			throw;
		}
	}

	public void _007EAxis()
	{
	}
