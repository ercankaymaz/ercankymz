...
internal class ViewRibbonMinimizedManager : ViewManager
{
	...
	public ViewRibbonMinimizedManager(KryptonRibbon control, ViewDrawRibbonGroupsBorderSynch viewGroups, ViewBase root, bool minimizedMode, NeedPaintHandler needPaintDelegate)
		: base(control, root)
	{
	...
	public override void MouseMove(MouseEventArgs e, Point rawPt)
	{
		...
		if (_active && _minimizedMode == _ribbon.RealMinimizedMode)
		{
