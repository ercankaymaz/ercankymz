...
internal class ViewDrawRibbonGroupRadioButtonText : ViewLeaf, IContentValues
{
	...
	public ViewDrawRibbonGroupRadioButtonText(KryptonRibbon ribbon, KryptonRibbonGroupRadioButton ribbonRadioButton, bool firstText)
	{
		...
		_contentProvider = new RibbonGroupNormalDisabledTextToContent(ribbon.StateCommon.RibbonGeneral, ribbon.StateNormal.RibbonGroupRadioButtonText, ribbon.StateDisabled.RibbonGroupRadioButtonText);
	}

	public override string ToString()
	{
		return "ViewDrawRibbonGroupRadioButtonText:" + base.Id;
	}
	...
	public override Size GetPreferredSize(ViewLayoutContext context)
	{
		...
		if (_ribbon.DirtyPaletteCounter != _dirtyPaletteSize)
		{
			...
			if ((_firstText && string.IsNullOrEmpty(_ribbonRadioButton.TextLine1)) || (!_firstText && string.IsNullOrEmpty(_ribbonRadioButton.TextLine2)))
			{
	...
	public string GetShortText()
	{
		...
		if (!string.IsNullOrEmpty(_ribbonRadioButton.TextLine2))
		{
