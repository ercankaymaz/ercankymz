...
internal class AppTabController : GlobalId, IMouseController, ISourceController, IKeyController, IRibbonKeyTipTarget
{
	...
	protected void UpdateTargetState()
	{
		...
		if (_ribbon.Enabled)
		{
			...
			{
				paletteState = PaletteState.FocusOverride | PaletteState.Tracking;
			}
		}
		bool flag = false;
