...
internal class ViewDrawRibbonGroupText : ViewLeaf, IContentValues
{
	...
	public ViewDrawRibbonGroupText(KryptonRibbon ribbon, KryptonRibbonGroup ribbonGroup, bool firstText)
	{
		...
		_contentProvider = new RibbonGroupTextToContent(ribbon.StateCommon.RibbonGeneral, ribbon.StateNormal.RibbonGroupCollapsedText);
	}

	public override string ToString()
	{
		return "ViewDrawRibbonGroupText:" + base.Id;
	}
	...
	public override Size GetPreferredSize(ViewLayoutContext context)
	{
		...
		{
			_preferredSize = context.Renderer.RenderStandardContent.GetContentPreferredSize(context, _contentProvider, this, VisualOrientation.Top, PaletteState.Normal, composition: false);
