...
internal class DateTimePickerController : GlobalId, ISourceController, IKeyController, IRibbonKeyTipTarget
{
	...
	public DateTimePickerController(KryptonRibbon ribbon, KryptonRibbonGroupDateTimePicker dateTimePicker, ViewDrawRibbonGroupDateTimePicker target)
	{
	...
	{
		if (_dateTimePicker.LastDateTimePicker != null && _dateTimePicker.LastDateTimePicker.CanFocus)
		{
	...
	public void KeyTipSelect(KryptonRibbon ribbon)
	{
		if (_dateTimePicker.LastDateTimePicker.CanFocus)
		{
			...
			{
				VisualPopupGroup visualPopupGroup = (VisualPopupGroup)_dateTimePicker.LastParentControl;
