...
public class PaletteRibbonGroupTab : PaletteRibbonJustTab
{
	...
	[Browsable(false)]
	public override bool IsDefault => base.IsDefault && RibbonGroupNormalBorder.IsDefault && RibbonGroupNormalTitle.IsDefault && RibbonGroupCollapsedBorder.IsDefault && RibbonGroupCollapsedBack.IsDefault && RibbonGroupCollapsedFrameBorder.IsDefault && RibbonGroupCollapsedFrameBack.IsDefault && RibbonGroupCollapsedText.IsDefault;
	...
	public PaletteRibbonGroupTab(PaletteRibbonRedirect inherit, NeedPaintHandler needPaint)
