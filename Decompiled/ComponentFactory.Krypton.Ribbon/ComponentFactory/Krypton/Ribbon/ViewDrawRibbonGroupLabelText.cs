...
internal class ViewDrawRibbonGroupLabelText : ViewLeaf, IContentValues
{
	...
	public ViewDrawRibbonGroupLabelText(KryptonRibbon ribbon, KryptonRibbonGroupLabel ribbonLabel, bool firstText)
	{
		...
		_contentProvider = new RibbonGroupLabelTextToContent(ribbon.StateCommon.RibbonGeneral, ribbon.StateNormal.RibbonGroupLabelText, ribbon.StateDisabled.RibbonGroupLabelText, ribbonLabel.StateNormal, ribbonLabel.StateDisabled);
	}

	public override string ToString()
	{
		return "ViewDrawRibbonGroupLabelText:" + base.Id;
	}
	...
	public string GetShortText()
	{
		if (_ribbonLabel.KryptonCommand != null)
		{
			...
			if (!string.IsNullOrEmpty(_ribbonLabel.KryptonCommand.TextLine2))
			{
		...
		if (!string.IsNullOrEmpty(_ribbonLabel.TextLine2))
		{
