...
public class PaletteRibbonAppGroupTab : PaletteRibbonJustTab
{
	...
	[Browsable(false)]
	public override bool IsDefault => base.IsDefault && RibbonAppButton.IsDefault && RibbonGroupNormalBorder.IsDefault && RibbonGroupNormalTitle.IsDefault && RibbonGroupCollapsedBorder.IsDefault && RibbonGroupCollapsedBack.IsDefault && RibbonGroupCollapsedFrameBorder.IsDefault && RibbonGroupCollapsedFrameBack.IsDefault && RibbonGroupCollapsedText.IsDefault;
	...
	public PaletteRibbonAppGroupTab(PaletteRibbonRedirect inherit, NeedPaintHandler needPaint)
