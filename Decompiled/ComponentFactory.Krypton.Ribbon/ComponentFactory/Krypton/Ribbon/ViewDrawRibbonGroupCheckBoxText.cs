...
internal class ViewDrawRibbonGroupCheckBoxText : ViewLeaf, IContentValues
{
	...
	public ViewDrawRibbonGroupCheckBoxText(KryptonRibbon ribbon, KryptonRibbonGroupCheckBox ribbonCheckBox, bool firstText)
	{
		...
		_contentProvider = new RibbonGroupNormalDisabledTextToContent(ribbon.StateCommon.RibbonGeneral, ribbon.StateNormal.RibbonGroupCheckBoxText, ribbon.StateDisabled.RibbonGroupCheckBoxText);
	}

	public override string ToString()
	{
		return "ViewDrawRibbonGroupCheckBoxText:" + base.Id;
	}
	...
	public string GetShortText()
	{
		if (_ribbonCheckBox.KryptonCommand != null)
		{
			...
			if (!string.IsNullOrEmpty(_ribbonCheckBox.KryptonCommand.TextLine2))
			{
		...
		if (!string.IsNullOrEmpty(_ribbonCheckBox.TextLine2))
		{
