...
internal class CustomControlController : GlobalId, ISourceController, IKeyController, IRibbonKeyTipTarget
{
	...
	public CustomControlController(KryptonRibbon ribbon, KryptonRibbonGroupCustomControl customControl, ViewDrawRibbonGroupCustomControl target)
	{
	...
	{
		if (_customControl.LastCustomControl != null && _customControl.LastCustomControl.CanFocus)
		{
	...
	public void KeyTipSelect(KryptonRibbon ribbon)
	{
		if (_customControl.LastCustomControl.CanFocus)
		{
			...
			{
				VisualPopupGroup visualPopupGroup = (VisualPopupGroup)_customControl.LastParentControl;
