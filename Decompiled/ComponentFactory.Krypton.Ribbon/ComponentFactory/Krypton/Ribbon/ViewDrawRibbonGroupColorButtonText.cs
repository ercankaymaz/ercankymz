...
internal class ViewDrawRibbonGroupColorButtonText : ViewLeaf, IContentValues
{
	...
	public ViewDrawRibbonGroupColorButtonText(KryptonRibbon ribbon, KryptonRibbonGroupColorButton ribbonColorButton, bool firstText)
	{
	...
	{
		return "ViewDrawRibbonGroupColorButtonText:" + base.Id;
	}
	...
	public string GetShortText()
	{
		if (_ribbonColorButton.KryptonCommand != null)
		{
			...
			if (!string.IsNullOrEmpty(_ribbonColorButton.KryptonCommand.TextLine2))
			{
		...
		if (!string.IsNullOrEmpty(_ribbonColorButton.TextLine2))
		{
