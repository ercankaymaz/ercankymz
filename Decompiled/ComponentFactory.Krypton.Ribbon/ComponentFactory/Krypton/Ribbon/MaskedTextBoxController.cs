...
internal class MaskedTextBoxController : GlobalId, ISourceController, IKeyController, IRibbonKeyTipTarget
{
	...
	public MaskedTextBoxController(KryptonRibbon ribbon, KryptonRibbonGroupMaskedTextBox maskedTextBox, ViewDrawRibbonGroupMaskedTextBox target)
	{
	...
	{
		if (_maskedTextBox.LastMaskedTextBox != null && _maskedTextBox.LastMaskedTextBox.MaskedTextBox != null && _maskedTextBox.LastMaskedTextBox.MaskedTextBox.CanFocus)
		{
	...
	public void KeyTipSelect(KryptonRibbon ribbon)
	{
		if (_maskedTextBox.LastMaskedTextBox.CanFocus)
		{
			...
			{
				VisualPopupGroup visualPopupGroup = (VisualPopupGroup)_maskedTextBox.LastParentControl;
