...
internal class TextBoxController : GlobalId, ISourceController, IKeyController, IRibbonKeyTipTarget
{
	...
	public TextBoxController(KryptonRibbon ribbon, KryptonRibbonGroupTextBox textBox, ViewDrawRibbonGroupTextBox target)
	{
	...
	{
		if (_textBox.LastTextBox != null && _textBox.LastTextBox.TextBox != null && _textBox.LastTextBox.TextBox.CanFocus)
		{
	...
	public void KeyTipSelect(KryptonRibbon ribbon)
	{
		if (_textBox.LastTextBox.CanFocus)
		{
			...
			{
				VisualPopupGroup visualPopupGroup = (VisualPopupGroup)_textBox.LastParentControl;
