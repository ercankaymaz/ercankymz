...
internal class KryptonRibbonGroupClusterColorButtonDesigner : ComponentDesigner
{
	...
	private void UpdateVerbStatus()
	{
		...
		{
			KryptonRibbonGroupCluster kryptonRibbonGroupCluster = (KryptonRibbonGroupCluster)_ribbonColorButton.RibbonContainer;
			enabled = kryptonRibbonGroupCluster.Items.IndexOf(_ribbonColorButton) > 0;
			enabled2 = kryptonRibbonGroupCluster.Items.IndexOf(_ribbonColorButton) > 0;
			enabled3 = kryptonRibbonGroupCluster.Items.IndexOf(_ribbonColorButton) < kryptonRibbonGroupCluster.Items.Count - 1;
			enabled4 = kryptonRibbonGroupCluster.Items.IndexOf(_ribbonColorButton) < kryptonRibbonGroupCluster.Items.Count - 1;
		}
	...
	private void OnMoveFirst(object sender, EventArgs e)
	{
		...
		{
			KryptonRibbonGroupCluster kryptonRibbonGroupCluster = (KryptonRibbonGroupCluster)_ribbonColorButton.RibbonContainer;
			DesignerTransaction designerTransaction = _designerHost.CreateTransaction("KryptonRibbonGroupColorClusterButton MoveFirst");
			try
			{
				MemberDescriptor member = TypeDescriptor.GetProperties(kryptonRibbonGroupCluster)["Items"];
				RaiseComponentChanging(member);
				kryptonRibbonGroupCluster.Items.Remove(_ribbonColorButton);
				kryptonRibbonGroupCluster.Items.Insert(0, _ribbonColorButton);
				UpdateVerbStatus();
	...
	private void OnMovePrevious(object sender, EventArgs e)
	{
		...
		{
			KryptonRibbonGroupCluster kryptonRibbonGroupCluster = (KryptonRibbonGroupCluster)_ribbonColorButton.RibbonContainer;
			DesignerTransaction designerTransaction = _designerHost.CreateTransaction("KryptonRibbonGroupColorClusterButton MovePrevious");
			try
			{
				MemberDescriptor member = TypeDescriptor.GetProperties(kryptonRibbonGroupCluster)["Items"];
				RaiseComponentChanging(member);
				int val = kryptonRibbonGroupCluster.Items.IndexOf(_ribbonColorButton) - 1;
				val = Math.Max(val, 0);
				kryptonRibbonGroupCluster.Items.Remove(_ribbonColorButton);
				kryptonRibbonGroupCluster.Items.Insert(val, _ribbonColorButton);
				UpdateVerbStatus();
				RaiseComponentChanged(member, null, null);
			}
			finally
	...
	private void OnMoveNext(object sender, EventArgs e)
	{
		...
		{
			KryptonRibbonGroupCluster kryptonRibbonGroupCluster = (KryptonRibbonGroupCluster)_ribbonColorButton.RibbonContainer;
			DesignerTransaction designerTransaction = _designerHost.CreateTransaction("KryptonRibbonGroupColorClusterButton MoveNext");
			try
			{
				MemberDescriptor member = TypeDescriptor.GetProperties(kryptonRibbonGroupCluster)["Items"];
				RaiseComponentChanging(member);
	...
	private void OnMoveLast(object sender, EventArgs e)
	{
		...
		{
			KryptonRibbonGroupCluster kryptonRibbonGroupCluster = (KryptonRibbonGroupCluster)_ribbonColorButton.RibbonContainer;
			DesignerTransaction designerTransaction = _designerHost.CreateTransaction("KryptonRibbonGroupColorClusterButton MoveLast");
			try
			{
				MemberDescriptor member = TypeDescriptor.GetProperties(kryptonRibbonGroupCluster)["Items"];
				RaiseComponentChanging(member);
				kryptonRibbonGroupCluster.Items.Remove(_ribbonColorButton);
				kryptonRibbonGroupCluster.Items.Insert(kryptonRibbonGroupCluster.Items.Count, _ribbonColorButton);
				UpdateVerbStatus();
				RaiseComponentChanged(member, null, null);
			}
			finally
	...
	private void OnDeleteButton(object sender, EventArgs e)
	{
		...
		{
			KryptonRibbonGroupCluster kryptonRibbonGroupCluster = (KryptonRibbonGroupCluster)_ribbonColorButton.RibbonContainer;
			DesignerTransaction designerTransaction = _designerHost.CreateTransaction("KryptonRibbonGroupColorClusterButton DeleteButton");
			try
			{
				MemberDescriptor member = TypeDescriptor.GetProperties(kryptonRibbonGroupCluster)["Items"];
