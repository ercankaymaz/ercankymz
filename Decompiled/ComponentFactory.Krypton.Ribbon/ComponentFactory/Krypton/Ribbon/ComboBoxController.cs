...
internal class ComboBoxController : GlobalId, ISourceController, IKeyController, IRibbonKeyTipTarget
{
	...
	public ComboBoxController(KryptonRibbon ribbon, KryptonRibbonGroupComboBox comboBox, ViewDrawRibbonGroupComboBox target)
	{
	...
	{
		if (_comboBox.LastComboBox != null && _comboBox.LastComboBox.ComboBox != null && _comboBox.LastComboBox.ComboBox.CanFocus)
		{
	...
	public void KeyTipSelect(KryptonRibbon ribbon)
	{
		if (_comboBox.LastComboBox.CanFocus)
		{
			...
			{
				VisualPopupGroup visualPopupGroup = (VisualPopupGroup)_comboBox.LastParentControl;
