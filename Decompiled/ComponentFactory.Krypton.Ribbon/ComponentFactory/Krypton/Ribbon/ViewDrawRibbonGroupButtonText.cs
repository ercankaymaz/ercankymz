...
internal class ViewDrawRibbonGroupButtonText : ViewLeaf, IContentValues
{
	...
	public ViewDrawRibbonGroupButtonText(KryptonRibbon ribbon, KryptonRibbonGroupButton ribbonButton, bool firstText)
	{
	...
	{
		return "ViewDrawRibbonGroupButtonText:" + base.Id;
	}
	...
	public string GetShortText()
	{
		if (_ribbonButton.KryptonCommand != null)
		{
			...
			if (!string.IsNullOrEmpty(_ribbonButton.KryptonCommand.TextLine2))
			{
		...
		if (!string.IsNullOrEmpty(_ribbonButton.TextLine2))
		{
