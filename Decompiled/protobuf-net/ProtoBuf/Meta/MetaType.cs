	...
	internal void ApplyDefaultBehaviourImpl()
	{
		...
		foreach (MemberInfo memberInfo in array3)
		{
			...
			else if (memberInfo is FieldInfo { FieldType: var effectiveType2, IsPublic: var isPublic2 } fieldInfo)
			{
				...
				{
					ApplyDefaultBehaviour_AddMembers(model, attributeFamily, flag, basicList2, dataMemberOffset, flag3, implicitFields, basicList3, memberInfo, ref forced, isPublic2, isField, ref effectiveType2, ref hasConflictingEnumValue);
				}
			}
