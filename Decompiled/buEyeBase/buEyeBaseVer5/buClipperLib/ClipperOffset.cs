...
public class ClipperOffset
{
	...
	public void AddPath(List<IntPoint> path, JoinType joinType, EndType endType)
	{
		...
		Class186.smethod_532(polyNode_0, polyNode);
	...
	{
		solution.Clear();
		Class186.smethod_439(this);
		Class186.smethod_150(this, delta);
	...
	public void Execute(ref PolyTree solution, double delta)
	{
		...
		if (!(delta > 0.0))
		{
			...
			{
				Class186.smethod_532((PolyNode)solution, polyNode.Childs[i]);
			}
		}
		else
		{
