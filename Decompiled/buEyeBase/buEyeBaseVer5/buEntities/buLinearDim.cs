...
public class buLinearDim : buEntity
{
	...
	public buLinearDim(Plane dimPlane, Point3D extLine1, Point3D extLine2, Point3D dimLinePos, double textHeight)
	{
		...
		Update(buEntityUpdateType.LinearDim, 0.01, dimPlane);
	}

	public buLinearDim(Plane sketchPlane, Point2D extLine1, Point2D extLine2, Point2D dimLinePos, double textHeight)
	{
		...
		Update(buEntityUpdateType.LinearDim, 0.01, sketchPlane);
	}

	public buLinearDim(buLinearDim another)
	{
	...
	public buLinearDim(LinearDim another)
	{
		ExtLine1 = new Point3D(another.ExtLine1.X, another.ExtLine1.Y, another.ExtLine1.Z);
		ExtLine2 = new Point3D(another.ExtLine2.X, another.ExtLine2.Y, another.ExtLine2.Z);
		DimLinePosition = new Point3D(another.DimLinePosition.X, another.DimLinePosition.Y, another.DimLinePosition.Z);
	...
	{
		return "LinarDim - ExtLine1 : " + ExtLine1.ToString() + " - ExtLine2 : " + ExtLine2.ToString();
	}
}
