...
public class SortbuOptions : buSerilization5
{
	...
	public bool FindUntilToEnd = false;

	public double AngleMinLimit = -360.0;

	public double AngleMaxLimit = 360.0;

	public double FirstCatchResolution = 0.0;

	public List<Point3D> ClickList = new List<Point3D>();

	public Plane refPlane = new Plane();

	public SortbuOptions()
	{
	}

	public SortbuOptions(SortbuOptions data)
	{
