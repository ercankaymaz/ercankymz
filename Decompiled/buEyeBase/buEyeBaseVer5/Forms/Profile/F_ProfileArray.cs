...
public class F_ProfileArray : Form
{
	...
	public F_ProfileArray()
	{
		Class186.smethod_743(this);
	}
	...
	public void Init()
	{
		...
		spn_linearYcount.Value = OperationData.Array.LineerYCount;
		spn_linearYlen.Value = (decimal)OperationData.Array.LineerYDistance;
		spn_linearXcount.Value = OperationData.Array.LineerXCount;
		spn_linearXlen.Value = (decimal)OperationData.Array.LineerXDistance;
