...
{
	private string string_0 = "F_MarbleEventScale";
	...
	public void Init()
	{
		...
		try
		{
			...
			LoadLanguage();
			spn_width.Value = buMarbleCalc.varMarbleRunSettings.ScaleWidth;
			spn_height.Value = buMarbleCalc.varMarbleRunSettings.ScaleHeight;
	...
	public void LoadLanguage()
	{
		...
		try
		{
			ground_base.Text = buLangTranslate.preDef.Scale;
			chk_keepratio.Text = buLangTranslate.preDef.KeepRatio;
			spn_width.Caption.Caption = buLangTranslate.preDef.Width;
			spn_height.Caption.Caption = buLangTranslate.preDef.Height;
	...
	public void Apply()
	{
		...
		try
		{
			buMarbleCalc.varMarbleRunSettings.ScaleKeepRatio = chk_keepratio.Check;
			buMarbleCalc.varMarbleRunSettings.ScaleWidth = spn_width.Value;
			buMarbleCalc.varMarbleRunSettings.ScaleHeight = spn_height.Value;
		}
		catch (Exception ex)
		{
			buLogVer5.addToLog(string_0, text, "Exception", ex.Message, ex.Data.ToString(), 0.0, 0.0, AddException: true);
