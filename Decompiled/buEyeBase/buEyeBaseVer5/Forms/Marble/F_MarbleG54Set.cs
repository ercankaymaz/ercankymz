...
public class F_MarbleG54Set : Form
{
	...
	public void LoadLanguage()
	{
		try
		{
			buGround_0.Text = "G54 " + buLangTranslate.preDef.Set;
			btn_xG54set.Text = buLangTranslate.preDef.Position + " " + buLangTranslate.preDef.Set;
			btn_yG54set.Text = buLangTranslate.preDef.Position + " " + buLangTranslate.preDef.Set;
			btn_zG54set.Text = buLangTranslate.preDef.Position + " " + buLangTranslate.preDef.Set;
		}
		catch (Exception)
		{
		}
