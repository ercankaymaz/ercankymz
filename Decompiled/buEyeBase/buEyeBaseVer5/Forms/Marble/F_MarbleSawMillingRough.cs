...
public class F_MarbleSawMillingRough : Form
{
	...
	public F_MarbleSawMillingRough()
	{
		Class186.smethod_586(this);
	}
	...
	public void Init()
	{
		...
		spn_safedis.Value = varSawMilling.SawMillingSafeDistance;
		spn_rapiddis.Value = varSawMilling.SawMillingRapidDistance;
		spn_stepdistance.Value = varSawMilling.SawMillingZStepDown;
		spn_plunfefeed.Value = varSawMilling.SawMillingPlungeFeed;
		spn_xyoffset.Value = varSawMilling.SawMillingXYOffset;
		chk_zigzag.Check = varSawMilling.SawMillingZigzag;
		PropertiesForm.Result = DialogResult.None;
		PropertiesForm.Inited = true;
		Class186.smethod_737(this);
	}
