...
{
	private string string_0 = "F_MarbleEventCopy";
	...
	public void Init()
	{
		...
		try
		{
			...
			if (buMarbleCalc.varMarbleRunSettings.CopyType != MarbleCopyType.XDirection)
			{
				if (buMarbleCalc.varMarbleRunSettings.CopyType != MarbleCopyType.YDirection)
				{
	...
	public void LoadLanguage()
	{
		...
		try
		{
			...
			radioButton_2.Text = buLangTranslate.preChar.X + " " + buLangTranslate.preDef.Direction;
			radioButton_1.Text = buLangTranslate.preChar.Y + " " + buLangTranslate.preDef.Direction;
			radioButton_0.Text = buLangTranslate.preChar.X + buLangTranslate.preChar.Y + " " + buLangTranslate.preDef.Direction;
	...
	public void Apply()
	{
		...
		try
		{
			...
			if (!radioButton_2.Checked)
			{
				...
				{
					buMarbleCalc.varMarbleRunSettings.CopyType = MarbleCopyType.XYDirction;
				}
				else
				{
					buMarbleCalc.varMarbleRunSettings.CopyType = MarbleCopyType.YDirection;
				}
			}
			else
			{
				buMarbleCalc.varMarbleRunSettings.CopyType = MarbleCopyType.XDirection;
			}
		}
		catch (Exception ex)
		{
