...
public class F_MarbleSawMillingVertical : Form
{
	...
	public void Init()
	{
		...
		{
			spn_startzoffset.Value = buMarbleCalc.varOperation.settingSawMilling.SawMillingFinishVerTopOffset;
			spn_endzoffset.Value = buMarbleCalc.varOperation.settingSawMilling.SawMillingFinishVerBottomOffset;
			spn_minz.Value = buMarbleCalc.varOperation.settingSawMilling.SawMillingFinishVerMinZValue;
		}
		else
		{
			spn_startzoffset.Value = buMarbleCalc.varOperation.settingSawMilling.SawMillingRoughVerTopOffset;
			spn_endzoffset.Value = buMarbleCalc.varOperation.settingSawMilling.SawMillingRoughVerBottomOffset;
			spn_minz.Value = buMarbleCalc.varOperation.settingSawMilling.SawMillingRoughVerMinZValue;
		}
		Class186.smethod_744(this);
	}
