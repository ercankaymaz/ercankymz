...
public class F_MarbleToolMenu : Form
{
	...
	public F_MarbleToolMenu()
	{
		Class186.smethod_284(this);
	}
	...
	public void LoadLanguage()
	{
		try
		{
			...
			chk_toolwaterjet.Text = buLangTranslate.preDef.WaterJet + " " + buLangTranslate.preDef.Tool;
	...
	internal void method_2(object object_0, bool bool_0)
	{
		if (PropertiesForm.Inited)
		{
			...
			if (control.Name == chk_toolwaterjet.Name)
			{
				chk_toolsaw.Check = false;
				chk_toolmilling.Check = false;
				chk_toolwaterjet.Check = true;
				chk_toolmillinghead.Check = false;
				ToolType = MarbleToolType.WaterJet;
			}
