...
{
	private string string_0 = "F_MarbleEventExtend";
	...
	public void Init()
	{
		...
		try
		{
			...
			LoadLanguage();
			spn_extend.Value = buMarbleCalc.varMarbleRunSettings.ExtendLength;
	...
	public void LoadLanguage()
	{
		...
		try
		{
			ground_base.Text = buLangTranslate.preDef.Extend;
			spn_extend.Caption.Caption = buLangTranslate.preDef.Length;
	...
	public void Apply()
	{
		...
		try
		{
			buMarbleCalc.varMarbleRunSettings.ExtendLength = spn_extend.Value;
		}
		catch (Exception ex)
		{
			buLogVer5.addToLog(string_0, text, "Exception", ex.Message, ex.Data.ToString(), 0.0, 0.0, AddException: true);
