...
public class F_MarbleEditBaseHAndOffsetXY : Form
{
	...
	public void Init()
	{
		...
		spn_offsetY.Value = varRuntime.Shape3DOffsetY;
		spn_offsetX.Value = varRuntime.Shape3DOffsetX;
		spn_baseheight.Value = varRuntime.Shape3DHeight;
		Class186.smethod_263(this);
	}
