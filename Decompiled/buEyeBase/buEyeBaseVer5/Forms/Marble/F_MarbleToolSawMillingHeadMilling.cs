...
public class F_MarbleToolSawMillingHeadMilling : Form
{
	...
	public ToolBase5 ToolMillingHead = new ToolBase5();
	...
	public void Init()
	{
		...
		spn_millinghead_diameter.Value = ToolMillingHead.Geometry.Diameter;
		spn_millinghead_length.Value = ToolMillingHead.Geometry.Length;
		spn_millinghead_speed.Value = ToolMillingHead.CamData.SpindleSpeed;
		LoadLanguage();
	...
	public void LoadLanguage()
	{
		try
		{
			...
			tabPage_0.Text = buLangTranslate.preDef.MillingHead;
			...
			btn_millinghead_limitdisable.Text = buLangTranslate.preDef.Limit + " " + buLangTranslate.preDef.Disable;
			btn_millinghead_activate.Text = buLangTranslate.preDef.MillingHead + " " + buLangTranslate.preDef.Activate;
			btn_millinghead_measure.Text = buLangTranslate.preDef.MillingHead + " " + buLangTranslate.preDef.Measure;
			btn_millinghead_zeroposition.Text = buLangTranslate.preDef.MillingHead + " " + buLangTranslate.preDef.Zero;
			...
			spn_millinghead_diameter.Caption.Caption = buLangTranslate.preDef.MillingHead + " " + buLangTranslate.preDef.Diameter;
			spn_millinghead_length.Caption.Caption = buLangTranslate.preDef.MillingHead + " " + buLangTranslate.preDef.Length;
			spn_millinghead_speed.Caption.Caption = buLangTranslate.preDef.MillingHead + " " + buLangTranslate.preDef.Speed;
		}
		catch (Exception)
		{
		}
	...
	public void Apply()
	{
		...
		ToolMillingHead.Geometry.Diameter = spn_millinghead_diameter.Value;
		ToolMillingHead.Geometry.Length = spn_millinghead_length.Value;
		ToolMillingHead.CamData.SpindleSpeed = spn_millinghead_speed.Value;
	}
