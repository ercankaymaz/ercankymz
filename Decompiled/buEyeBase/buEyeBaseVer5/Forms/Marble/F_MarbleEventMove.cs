...
public class F_MarbleEventMove : Form
{
	...
	public void LoadLanguage()
	{
		try
		{
			ground_base.Text = buLangTranslate.preDef.Move;
			spn_eventmovevalue.Caption.Caption = buLangTranslate.preDef.Move;
		}
		catch (Exception)
		{
		}
	...
	internal void method_2(object sender, EventArgs e)
	{
		...
		spn_eventmovevalue.Value = buButton2.Aux.ValDouble;
	}
