...
public class F_Scale : Form
{
	...
	public ScaleEventFormVars Settings = new ScaleEventFormVars();
	...
	public void Init()
	{
		...
		Class186.smethod_168(this);
		numericUpDown_0.Value = (decimal)Settings.Ratio.X;
		numericUpDown_1.Value = (decimal)Settings.Ratio.Y;
		btn_aligment.Visible = Settings.ShowAligment;
		checkBox_1.Checked = Settings.KeepRatio;
		checkBox_0.Checked = Settings.isLengthMode;
	...
	internal void method_0(object sender, EventArgs e)
	{
		...
		if (control.Name == btn_ok.Name)
		{
			...
			{
				okCommandWithDataEventHandler_0(new Pnt3D((double)numericUpDown_0.Value, (double)numericUpDown_1.Value, 1.0));
			}
		}
