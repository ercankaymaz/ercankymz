...
public class F_SewingRotate : Form
{
	...
	public F_SewingRotate()
	{
		Class186.smethod_612(this);
	}
	...
	public void Init()
	{
		...
		numericUpDown_0.Value = (decimal)RotateDegree;
	...
	internal void method_1(object sender, EventArgs e)
	{
		...
		{
			RotateDegree = (double)numericUpDown_0.Value;
			okCommandWithTwoDataEventHandler_0("Plus", RotateDegree);
		}
		if (control.Name == btn_rotateminus.Name && okCommandWithTwoDataEventHandler_0 != null)
		{
			RotateDegree = (double)numericUpDown_0.Value;
			okCommandWithTwoDataEventHandler_0("Minus", 0.0 - RotateDegree);
		}
	}
