...
public class F_NestPartAddV2 : Form
{
	...
	public F_NestPartAddV2()
	{
		buFunctions.CultureSettings();
		Class186.smethod_287(this);
	...
	public void Init()
	{
		...
		numericUpDown_3.Value = (decimal)Settings.AddPart.PartDistance;
		txt_name.Text = Settings.AddPart.Name;
		checkBox_3.Checked = Settings.AddPart.MirrorEnable;
	...
	public void LoadLanguage()
	{
		...
		try
		{
			if (Captions.Count >= 9)
			{
				...
				label_7.Text = buLangTranslate.preDef.Mirror;
	...
	internal void method_1(object sender, EventArgs e)
	{
		...
		if (control.Name == button_0.Name)
		{
			...
			Settings.AddPart.MirrorEnable = checkBox_3.Checked;
			Settings.AddPart.PartDistance = (double)numericUpDown_3.Value;
			...
			Part.PartDistance = (int)numericUpDown_3.Value;
