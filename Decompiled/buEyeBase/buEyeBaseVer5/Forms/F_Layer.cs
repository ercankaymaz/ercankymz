...
public class F_Layer : Form
{
	...
	public LayerBase5 Value = new LayerBase5();
	...
	public F_Layer()
	{
		Class186.smethod_571(this);
	}

	public void Init(List<drawingPattern> pattern, List<ToolBase5> tool)
	{
		label_10.BackColor = Value.LayerColor;
		label_10.Text = buImage5.GetColorKnownName(Value.LayerColor);
		label_10.ForeColor = buImage5.InvertColorNoGray(Value.LayerColor);
		...
		{
			Tools.Add(new ToolBase5(tool[j]));
		}
	...
	internal void method_2(object sender, EventArgs e)
	{
		...
		if (ColorDialogBox.Result == DialogResult.OK)
		{
			...
			label_10.ForeColor = buImage5.InvertColorNoGray(label_10.BackColor);
			label_10.Text = buImage5.GetColorKnownName(label_10.BackColor);
		}
	}
