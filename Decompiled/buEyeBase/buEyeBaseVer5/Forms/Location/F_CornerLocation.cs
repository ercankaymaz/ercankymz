...
public class F_CornerLocation : Form
{
	...
	public CornerLocation Corner = CornerLocation.BottomCenter;
	...
	public F_CornerLocation()
	{
		Class186.smethod_770(this);
	}
	...
	internal void method_0(object sender, EventArgs e)
	{
		...
		{
			Corner = CornerLocation.TopCenter;
			Class186.smethod_59(this);
			Properties.Result = DialogResult.OK;
		}
		...
		{
			Corner = CornerLocation.BottomCenter;
			Class186.smethod_59(this);
			Properties.Result = DialogResult.OK;
		}
