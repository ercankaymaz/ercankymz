...
public class F_KeyPadNumV1 : Form
{
	...
	public void ShowDialog(string Value)
	{
		...
		if (Caption.Length <= 0)
		{
			buGround_0.Text = buLangTranslate.preDef.Value;
			if (ShowInitValue)
			{
	...
	internal void method_0(object sender, EventArgs e)
	{
		if (!(((buButton)sender).Tag.ToString() == "esc"))
		{
			...
			string text2 = text;
			uint num = Class186.smethod_578(text2);
			if (num > 3272340793u)
			{
				if (num > 3507227459u)
				{
							...
							else if (num == 3724402957u && text2 == "enter")
							{
								if (CheckNumeric)
								{
									if (!buNumeric.IsNumeric(textCtrl1.Text))
									{
										...
										textCtrl1.Text = buLangTranslate.preDef.NotNumeric + "!!";
									...
									{
										double num2 = double.Parse(textCtrl1.Text);
										if (num2 < MinValue)
										{
											string_1 = textCtrl1.Text;
											textCtrl1.Text = buLangTranslate.preDef.LowerThenLimit + "!!";
											timer_0.Enabled = true;
											return;
										}
										if (num2 > MaxValue)
										{
											string_1 = textCtrl1.Text;
											textCtrl1.Text = buLangTranslate.preDef.HigherThenLimit + "!!";
											timer_0.Enabled = true;
											return;
										}
										Value = textCtrl1.Text;
