...
public class F_TextWireframe : Form
{
	...
	public double TextHeight = 50.0;

	public string TextString = "ABC";
	...
	public void Init()
	{
		...
		buTextBox_0.Text = TextString;
		spn_textheight.Value = TextHeight;
		Class186.smethod_259(this);
	}
