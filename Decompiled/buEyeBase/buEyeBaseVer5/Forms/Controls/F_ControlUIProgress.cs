...
public class F_ControlUIProgress : Form
{
	...
	public void Init()
	{
		...
		Progress_Ref.ProgressLineer.ShowPercentage = Settings.Parameters.ShowPersentage;
		Progress_Ref.Geometry.ShapeMode = Settings.Parameters.GeometryType;
		Progress_Ref.Geometry.ArcDiameter = Settings.Parameters.GeometryArcDiameer;
		Progress_Ref.ImageAlign = Settings.Parameters.ImageAlignment;
		Progress_Ref.Display = buControlDisplaySet_1.Display;
		Progress_Ref.ProgressLineer.DoneDisplay = buControlDisplaySet_0.Display;
		buControlDisplaySet_0.UpdateControl();
		buControlDisplaySet_1.UpdateControl();
		PropertiesForm.Result = DialogResult.None;
		PropertiesForm.Inited = true;
		Class186.smethod_364(this);
	}
	...
	internal void method_3(object object_0, double double_0)
	{
		...
		{
			Progress_Ref.Geometry.ArcDiameter = (int)spn_geometryrad.Value;
	...
	internal void method_4(object sender, EventArgs e)
	{
		...
		if (control.Name == buComboBox_1.Name)
		{
			...
			Progress_Ref.Geometry.ShapeMode = result;
		...
		if (control.Name == buComboBox_0.Name)
		{
			...
			Progress_Ref.ImageAlign = result2;
	...
	internal void method_5(object object_0, bool bool_0)
	{
		...
		if (control.Name == buCheckBox_0.Name)
		{
			...
			Progress_Ref.ProgressLineer.ShowPercentage = buCheckBox_0.Check;
