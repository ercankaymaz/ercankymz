...
public class F_ControlUIText : Form
{
	...
	public void Init()
	{
		...
		if (refText != null)
		{
			buControlDisplaySet_0.Display = refText.Caption.Display;
			buControlDisplaySet_1.Display = refText.Display;
			spn_geometryrad.Value = refText.Geometry.ArcDiameter;
			buComboBox_1.SelectedItem = refText.Geometry.ShapeMode;
			buComboBox_0.SelectedItem = refText.ImageAlign;
			buTextBox_0.Display = buControlDisplaySet_1.Display;
			buTextBox_0.Caption.Display = buControlDisplaySet_0.Display;
			buControlDisplaySet_0.UpdateControl();
			buControlDisplaySet_1.UpdateControl();
		}
		PropertiesForm.Result = DialogResult.None;
		PropertiesForm.Inited = true;
		Class186.smethod_394(this);
	}
	...
	internal void method_3(object object_0, double double_0)
	{
		...
		{
			buTextBox_0.Geometry.ArcDiameter = (int)spn_geometryrad.Value;
			refText.Geometry.ArcDiameter = (int)spn_geometryrad.Value;
		}
	}
	...
	internal void method_4(object sender, EventArgs e)
	{
		...
		if (control.Name == buComboBox_1.Name)
		{
			...
			buTextBox_0.Geometry.ShapeMode = result;
			refText.Geometry.ShapeMode = result;
		}
		if (control.Name == buComboBox_0.Name)
		{
			Enum.TryParse<ContentAlignment>(buComboBox_0.SelectedItem.ToString(), out var result2);
			buTextBox_0.ImageAlign = result2;
			refText.ImageAlign = result2;
		}
	}
