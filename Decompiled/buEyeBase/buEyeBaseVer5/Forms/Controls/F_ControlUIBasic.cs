...
public class F_ControlUIBasic : Form
{
	...
	public hmiUIBasicSettings Settings = new hmiUIBasicSettings();
	...
	public F_ControlUIBasic()
	{
		Class186.smethod_194(this);
	}
	...
	public void Init()
	{
		...
		buLabel_0.Geometry.ShapeMode = Settings.Parameters.GeometryType;
		buLabel_0.Geometry.ArcDiameter = Settings.Parameters.GeometryArcDiameer;
		buLabel_0.ImageAlign = Settings.Parameters.ImageAlignment;
		buLabel_0.Display = buControlDisplaySet_0.Display;
		buControlDisplaySet_0.UpdateControl();
		PropertiesForm.Result = DialogResult.None;
		PropertiesForm.Inited = true;
		Class186.smethod_87(this);
	}
