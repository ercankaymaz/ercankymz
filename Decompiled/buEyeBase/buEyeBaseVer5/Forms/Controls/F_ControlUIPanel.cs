...
public class F_ControlUIPanel : Form
{
	...
	public void Init()
	{
		...
		buControlDisplaySet_0.Display = Settings.Display;
		...
		pnl_ref.Geometry.ArcDiameter = Settings.Parameters.GeometryArcDiameer;
		pnl_ref.Geometry.ShapeMode = Settings.Parameters.GeometryType;
		pnl_ref.ImageAlign = Settings.Parameters.ImageAlignment;
		pnl_ref.Display = buControlDisplaySet_0.Display;
		buControlDisplaySet_0.UpdateControl();
		PropertiesForm.Result = DialogResult.None;
		PropertiesForm.Inited = true;
		Class186.smethod_764(this);
	}
	...
	internal void method_3(object object_0, double double_0)
	{
		...
		{
			pnl_ref.Geometry.ArcDiameter = (int)spn_geometryrad.Value;
	...
	internal void method_4(object sender, EventArgs e)
	{
		...
		if (control.Name == buComboBox_1.Name)
		{
			...
			pnl_ref.Geometry.ShapeMode = result;
