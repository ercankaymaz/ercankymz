...
public class F_ControlUICoordinate : Form
{
	...
	public void Init()
	{
		...
		lbl_caption.Display = buControlDisplaySet_1.Display;
		lbl_val.Display = buControlDisplaySet_0.Display;
		lbl_title.Display.BackColor = Color.Linen;
		lbl_title.Display.Fonts.ForeColor = buControlDisplaySet_0.Display.TitleForeColor;
	...
	internal void method_3(object object_0, double double_0)
	{
		...
		{
			lbl_val.Geometry.ArcDiameter = (int)spn_geometryrad.Value;
	...
	internal void method_4(object sender, EventArgs e)
	{
		...
		if (control.Name == buComboBox_1.Name)
		{
			...
			lbl_val.Geometry.ShapeMode = result;
