...
public class F_ShapeAll : Form
{
	...
	public void Init()
	{
		...
		spn_arcbigradius.Value = Data.ArcBigRadius;
		spn_arcsmallradius.Value = Data.ArcSmallRadius;
		spn_arcsweeoangle.Value = Data.ArcSweepAngle;
	...
	public void LoadLanguage()
	{
		try
		{
			...
			tabPage_keyhole.Text = buLangTranslate.preDef.KeyHole;
			tabPage_polygon.Text = buLangTranslate.preDef.Polygon;
			tabPage_rectangle.Text = buLangTranslate.preDef.Rectangle;
			...
			spn_ellipseheight.Caption.Caption = buLangTranslate.preDef.DiamaterX;
			spn_ellipsewidth.Caption.Caption = buLangTranslate.preDef.DiameterY;
			spn_keyholediameter.Caption.Caption = buLangTranslate.preDef.Diameter;
			spn_keyholelength.Caption.Caption = buLangTranslate.preDef.Length;
			spn_keyholewidth.Caption.Caption = buLangTranslate.preDef.Width;
			...
			spn_arcbigradius.Caption.Caption = buLangTranslate.preDef.Big + " " + buLangTranslate.preDef.Radius;
			spn_arcsmallradius.Caption.Caption = buLangTranslate.preDef.Small + " " + buLangTranslate.preDef.Radius;
			spn_arcsweeoangle.Caption.Caption = buLangTranslate.preDef.SweepAngle;
		}
		catch (Exception)
		{
		}
	...
	public void Apply()
	{
		...
		Data.ArcBigRadius = spn_arcbigradius.Value;
		Data.ArcSmallRadius = spn_arcsmallradius.Value;
		Data.ArcSweepAngle = spn_arcsweeoangle.Value;
	}
