...
public class F_CutList : Form
{
	...
	public void Init()
	{
		...
		listView_0.Items.Add(buLangTranslate.preDef.Horizontal + " " + buLangTranslate.preDef.Slot, 0);
		listView_0.Items.Add(buLangTranslate.preDef.Horizontal + " " + buLangTranslate.preDef.Line + " " + buLangTranslate.preDef.Slot, 1);
		listView_0.Items.Add(buLangTranslate.preDef.Vertical + " " + buLangTranslate.preDef.Slot, 2);
		listView_0.Items.Add(buLangTranslate.preDef.Vertical + " " + buLangTranslate.preDef.Line + " " + buLangTranslate.preDef.Slot, 3);
		listView_0.Items.Add(buLangTranslate.preDef.Free + " " + buLangTranslate.preDef.Slot, 4);
		...
		if (parShape.CutType != CutTypes.CutHorizontal)
		{
			if (parShape.CutType != CutTypes.CutHorizontalLine)
			{
				if (parShape.CutType != CutTypes.CutVertical)
				{
					if (parShape.CutType != CutTypes.CutVerticalLine)
					{
						if (parShape.CutType == CutTypes.CutFree)
						{
	...
	public void LoadLanguage()
	{
		...
		try
		{
			Text = buLangTranslate.preDef.Cut;
	...
	public void DataGridValuesToShape(int ColumnIndex, int RowIndex)
	{
		...
		if (!((parShape.CutType == CutTypes.CutHorizontal) | (parShape.CutType == CutTypes.CutVertical)))
		{
			if (!((parShape.CutType == CutTypes.CutHorizontalLine) | (parShape.CutType == CutTypes.CutVerticalLine)))
			{
				if (parShape.CutType == CutTypes.CutFree)
				{
					((buShapeCut)selectedShape).Diameter = Convert.ToDouble(dataGridView_0.Rows[2].Cells[1].Value);
					((buShapeCut)selectedShape).Depth = Convert.ToDouble(dataGridView_0.Rows[3].Cells[1].Value);
					((buShapeCut)selectedShape).Length = Convert.ToDouble(dataGridView_0.Rows[4].Cells[1].Value);
					((buShapeCut)selectedShape).Angle = Convert.ToDouble(dataGridView_0.Rows[5].Cells[1].Value);
					((buShapeCut)selectedShape).CutType = parShape.CutType;
					parShape.CutDiameter = ((buShapeCut)selectedShape).Diameter;
					parShape.CutLength = ((buShapeCut)selectedShape).Length;
					parShape.CutAngle = ((buShapeCut)selectedShape).Angle;
					parShape.CutDepth = ((buShapeCut)selectedShape).Depth;
				}
			}
			else
			{
				((buShapeCut)selectedShape).Diameter = Convert.ToDouble(dataGridView_0.Rows[1].Cells[1].Value);
				((buShapeCut)selectedShape).Depth = Convert.ToDouble(dataGridView_0.Rows[2].Cells[1].Value);
				((buShapeCut)selectedShape).StartDistance = Convert.ToInt32(dataGridView_0.Rows[3].Cells[1].Value);
				((buShapeCut)selectedShape).EndDistance = Convert.ToInt32(dataGridView_0.Rows[4].Cells[1].Value);
				((buShapeCut)selectedShape).CutType = parShape.CutType;
				parShape.CutDiameter = ((buShapeCut)selectedShape).Diameter;
				parShape.CutLength = ((buShapeCut)selectedShape).Length;
				parShape.CutStartDistance = ((buShapeCut)selectedShape).StartDistance;
				parShape.CutEndDistance = ((buShapeCut)selectedShape).EndDistance;
				parShape.CutDepth = ((buShapeCut)selectedShape).Depth;
			}
		}
		else
		...
		if (selectedShape is buShapeCut)
		{
			buShapeCut buShapeCut2 = selectedShape as buShapeCut;
			buShapeCut2.isMilling = checkBox_0.Checked;
		}
	...
	public void ShapeToDataGrid(int Index)
	{
		...
		if (Index != 1)
		{
			if (Index != 3)
			{
				if ((parShape.selectedPlane == planeBoxNames.Top) | (parShape.selectedPlane == planeBoxNames.Bottom))
				{
					...
					rows.Add(Class186.smethod_597(string_, this, double_));
					DataGridViewRowCollection rows2 = dataGridView_0.Rows;
					string_ = "Y";
					double_ = parShape.pntBase.Y;
					rows2.Add(Class186.smethod_597(string_, this, double_));
				}
				if ((parShape.selectedPlane == planeBoxNames.Left) | (parShape.selectedPlane == planeBoxNames.Right))
				{
					...
					rows3.Add(Class186.smethod_597(string_, this, double_));
					DataGridViewRowCollection rows4 = dataGridView_0.Rows;
					string_ = "Z";
					double_ = parShape.pntBase.Z;
					rows4.Add(Class186.smethod_597(string_, this, double_));
				}
				if ((parShape.selectedPlane == planeBoxNames.Front) | (parShape.selectedPlane == planeBoxNames.Back))
				{
					...
					string string_ = "X";
					double double_ = parShape.pntBase.X;
					rows5.Add(Class186.smethod_597(string_, this, double_));
					DataGridViewRowCollection rows6 = dataGridView_0.Rows;
					string_ = "Z";
					double_ = parShape.pntBase.Z;
					rows6.Add(Class186.smethod_597(string_, this, double_));
				}
			}
			else
			{
				if ((parShape.selectedPlane == planeBoxNames.Top) | (parShape.selectedPlane == planeBoxNames.Bottom))
				{
					...
					string string_ = "X";
					double double_ = parShape.pntBase.X;
					rows7.Add(Class186.smethod_597(string_, this, double_));
				}
				if ((parShape.selectedPlane == planeBoxNames.Left) | (parShape.selectedPlane == planeBoxNames.Right))
				{
					...
					string string_ = "Y";
					double double_ = parShape.pntBase.Y;
					rows8.Add(Class186.smethod_597(string_, this, double_));
				}
				if ((parShape.selectedPlane == planeBoxNames.Front) | (parShape.selectedPlane == planeBoxNames.Back))
				{
					...
					string string_ = "X";
					double double_ = parShape.pntBase.X;
					rows9.Add(Class186.smethod_597(string_, this, double_));
				}
			}
		}
		else
		{
			if ((parShape.selectedPlane == planeBoxNames.Top) | (parShape.selectedPlane == planeBoxNames.Bottom))
			{
				...
				string string_ = "Y";
				double double_ = parShape.pntBase.Y;
				rows10.Add(Class186.smethod_597(string_, this, double_));
			}
			if ((parShape.selectedPlane == planeBoxNames.Left) | (parShape.selectedPlane == planeBoxNames.Right))
			{
				...
				rows11.Add(Class186.smethod_597(string_, this, double_));
			}
			if ((parShape.selectedPlane == planeBoxNames.Front) | (parShape.selectedPlane == planeBoxNames.Back))
			{
				...
				string string_ = "Z";
				double double_ = parShape.pntBase.Z;
				rows12.Add(Class186.smethod_597(string_, this, double_));
			}
		}
		if (!(Index == 0 || Index == 2))
		{
			if (!(Index == 1 || Index == 3))
			{
				if (Index == 4)
				{
					parShape.CutType = CutTypes.CutFree;
					selectedShape = new buShapeCut(CutTypes.CutFree, parShape.CutDiameter, parShape.CutDepth, parShape.CutLength, parShape.CutStartDistance, parShape.CutEndDistance, parShape.CutAngle);
					((buShapeCut)selectedShape).CutType = CutTypes.CutFree;
					((buShapeCut)selectedShape).isMilling = parShape.isMillingCut;
					parShape.CutType = CutTypes.CutFree;
					...
					double double_ = ((buShapeCut)selectedShape).Diameter;
					rows13.Add(Class186.smethod_597(string_, this, double_));
					DataGridViewRowCollection rows14 = dataGridView_0.Rows;
					string_ = buLangTranslate.preDef.Depth;
					double_ = ((buShapeCut)selectedShape).Depth;
					rows14.Add(Class186.smethod_597(string_, this, double_));
					DataGridViewRowCollection rows15 = dataGridView_0.Rows;
					string_ = buLangTranslate.preDef.Length;
					double_ = ((buShapeCut)selectedShape).Length;
					rows15.Add(Class186.smethod_597(string_, this, double_));
					DataGridViewRowCollection rows16 = dataGridView_0.Rows;
					string_ = buLangTranslate.preDef.Angle;
					double_ = ((buShapeCut)selectedShape).Angle;
					rows16.Add(Class186.smethod_597(string_, this, double_));
				}
			}
			else
			{
				CutTypes cutTypes = CutTypes.CutHorizontalLine;
				if (Index == 1)
				{
					parShape.CutType = CutTypes.CutHorizontalLine;
					cutTypes = CutTypes.CutHorizontalLine;
				}
				if (Index == 3)
				{
					parShape.CutType = CutTypes.CutVerticalLine;
					cutTypes = CutTypes.CutVerticalLine;
				}
				selectedShape = new buShapeCut(cutTypes, parShape.CutDiameter, parShape.CutDepth, parShape.CutLength, parShape.CutStartDistance, parShape.CutEndDistance, parShape.CutAngle);
				((buShapeCut)selectedShape).CutType = cutTypes;
				((buShapeCut)selectedShape).isMilling = parShape.isMillingCut;
				parShape.CutType = cutTypes;
				selectedShape.BasePoint = new Point3D(parShape.pntBase.X, parShape.pntBase.Y, parShape.pntBase.Z);
				selectedShape.planeName = parShape.selectedPlane;
				selectedShape.planeOperation = buCall.buVector5_0.PlaneNameToPlane(selectedShape.planeName);
				selectedShape.Corner = parShape.selectedCorner;
				...
				string string_ = buLangTranslate.preDef.Diameter;
				double double_ = ((buShapeCut)selectedShape).Diameter;
				rows17.Add(Class186.smethod_597(string_, this, double_));
				DataGridViewRowCollection rows18 = dataGridView_0.Rows;
				string_ = buLangTranslate.preDef.Depth;
				double_ = ((buShapeCut)selectedShape).Depth;
				rows18.Add(Class186.smethod_597(string_, this, double_));
				DataGridViewRowCollection rows19 = dataGridView_0.Rows;
				string_ = buLangTranslate.preDef.Start + " " + buLangTranslate.preDef.Distance;
				double_ = ((buShapeCut)selectedShape).StartDistance;
				rows19.Add(Class186.smethod_597(string_, this, double_));
				DataGridViewRowCollection rows20 = dataGridView_0.Rows;
				string_ = buLangTranslate.preDef.End + " " + buLangTranslate.preDef.Distance;
				double_ = ((buShapeCut)selectedShape).EndDistance;
				rows20.Add(Class186.smethod_597(string_, this, double_));
			}
		}
		else
		{
			CutTypes cutTypes2 = CutTypes.CutHorizontal;
			if (Index == 0)
			{
				parShape.CutType = CutTypes.CutHorizontal;
				cutTypes2 = CutTypes.CutHorizontal;
			}
			if (Index == 2)
			{
				parShape.CutType = CutTypes.CutVertical;
				cutTypes2 = CutTypes.CutVertical;
			}
			selectedShape = new buShapeCut(cutTypes2, parShape.CutDiameter, parShape.CutDepth, parShape.CutLength, parShape.CutStartDistance, parShape.CutEndDistance, parShape.CutAngle);
			((buShapeCut)selectedShape).CutType = cutTypes2;
			((buShapeCut)selectedShape).isMilling = parShape.isMillingCut;
			parShape.CutType = cutTypes2;
			selectedShape.BasePoint = new Point3D(parShape.pntBase.X, parShape.pntBase.Y, parShape.pntBase.Z);
			selectedShape.planeName = parShape.selectedPlane;
			selectedShape.planeOperation = buCall.buVector5_0.PlaneNameToPlane(selectedShape.planeName);
			selectedShape.Corner = parShape.selectedCorner;
			...
			string string_ = buLangTranslate.preDef.Diameter;
			double double_ = ((buShapeCut)selectedShape).Diameter;
			rows21.Add(Class186.smethod_597(string_, this, double_));
			DataGridViewRowCollection rows22 = dataGridView_0.Rows;
			string_ = buLangTranslate.preDef.Depth;
			double_ = ((buShapeCut)selectedShape).Depth;
			rows22.Add(Class186.smethod_597(string_, this, double_));
			DataGridViewRowCollection rows23 = dataGridView_0.Rows;
			string_ = buLangTranslate.preDef.Length;
			double_ = ((buShapeCut)selectedShape).Length;
			rows23.Add(Class186.smethod_597(string_, this, double_));
		}
		checkBox_0.Checked = parShape.isMillingCut;
	...
	internal void method_1(object sender, EventArgs e)
	{
		...
		if (control.Name == button_2.Name && selectedShape is buShapeCut)
		{
			buShapeCut buShapeCut2 = selectedShape as buShapeCut;
			if (buShapeCut2.isMilling)
			{
				buShapeCut2.isMilling = false;
			}
			else
			{
				buShapeCut2.isMilling = true;
			}
			checkBox_0.Checked = buShapeCut2.isMilling;
			parShape.isMillingCut = buShapeCut2.isMilling;
			ShapeToDataGrid(int_0);
			if (okCommandWithTwoDataEventHandler_0 != null)
			{
	...
	internal void method_2(object sender, EventArgs e)
	{
		...
		if (control.Name == checkBox_0.Name && selectedShape is buShapeCut)
		{
			buShapeCut buShapeCut2 = selectedShape as buShapeCut;
			buShapeCut2.isMilling = checkBox_0.Checked;
			parShape.isMillingCut = buShapeCut2.isMilling;
		...
		Apply();
		PropertiesForm.Inited = true;
		Class186.smethod_197((EventArgs)null, sender, this);
	}
