...
public class F_ProfilingList : Form
{
	...
	public void Init()
	{
		...
		listView_0.Items.Add(buLangTranslate.preDef.Rect + " " + buLangTranslate.preDef.Corner, 0);
		listView_0.Items.Add(buLangTranslate.preDef.Round + " " + buLangTranslate.preDef.Corner, 1);
		listView_0.Items.Add(buLangTranslate.preDef.Chamfer + " " + buLangTranslate.preDef.Corner, 2);
		listView_0.Items.Add(buLangTranslate.preDef.Concave + " " + buLangTranslate.preDef.Corner, 3);
		...
		if (parShape.ProfilingType != ProfilingTypes.ProfilingRectangle)
		{
			if (parShape.ProfilingType != ProfilingTypes.ProfilingRound)
			{
				if (parShape.ProfilingType != ProfilingTypes.ProfilingChamfer)
				{
					if (parShape.ProfilingType == ProfilingTypes.ProfilingRoundConcave)
					{
	...
	public void LoadLanguage()
	{
		...
		try
		{
			Text = buLangTranslate.preDef.Profile;
	...
	public void DataGridValuesToShape(int ColumnIndex, int RowIndex)
	{
		...
		if (parShape.ProfilingType != ProfilingTypes.ProfilingRectangle)
		{
			if (parShape.ProfilingType != ProfilingTypes.ProfilingRound)
			{
				if (parShape.ProfilingType != ProfilingTypes.ProfilingChamfer)
				{
					if (parShape.ProfilingType == ProfilingTypes.ProfilingRoundConcave)
					{
						((buShapeProfiling)selectedShape).Radius = Convert.ToDouble(dataGridView_0.Rows[0].Cells[1].Value);
						((buShapeProfiling)selectedShape).Depth = Convert.ToDouble(dataGridView_0.Rows[1].Cells[1].Value);
						((buShapeProfiling)selectedShape).ProfilingType = parShape.ProfilingType;
						parShape.ProfilingRadius = ((buShapeProfiling)selectedShape).Radius;
						parShape.ProfilingDepth = ((buShapeProfiling)selectedShape).Depth;
					}
				}
				else
				{
					((buShapeProfiling)selectedShape).Length = Convert.ToDouble(dataGridView_0.Rows[0].Cells[1].Value);
					((buShapeProfiling)selectedShape).Depth = Convert.ToDouble(dataGridView_0.Rows[1].Cells[1].Value);
					((buShapeProfiling)selectedShape).ProfilingType = parShape.ProfilingType;
					parShape.ProfilingLength = ((buShapeProfiling)selectedShape).Length;
					parShape.ProfilingDepth = ((buShapeProfiling)selectedShape).Depth;
				}
			}
			else
		...
		{
			((buShapeProfiling)selectedShape).Width = Convert.ToDouble(dataGridView_0.Rows[0].Cells[1].Value);
			((buShapeProfiling)selectedShape).Height = Convert.ToDouble(dataGridView_0.Rows[1].Cells[1].Value);
			((buShapeProfiling)selectedShape).Depth = Convert.ToDouble(dataGridView_0.Rows[2].Cells[1].Value);
			((buShapeProfiling)selectedShape).ProfilingType = parShape.ProfilingType;
			parShape.ProfilingWidth = ((buShapeProfiling)selectedShape).Width;
			parShape.ProfilingHeight = ((buShapeProfiling)selectedShape).Height;
			parShape.ProfilingDepth = ((buShapeProfiling)selectedShape).Depth;
		}
		if (selectedShape is buShapeProfiling)
		{
			buShapeProfiling buShapeProfiling2 = selectedShape as buShapeProfiling;
			buShapeProfiling2.isPocket = checkBox_0.Checked;
		}
	...
	public void ShapeToDataGrid(int Index)
	{
		...
		if (Index > 3)
		{
			if ((parShape.selectedPlane == planeBoxNames.Top) | (parShape.selectedPlane == planeBoxNames.Bottom))
			{
				...
				rows.Add(Class186.smethod_387(double_, this, string_));
				DataGridViewRowCollection rows2 = dataGridView_0.Rows;
				string_ = "Y";
				double_ = parShape.pntBase.Y;
				rows2.Add(Class186.smethod_387(double_, this, string_));
			}
			if ((parShape.selectedPlane == planeBoxNames.Left) | (parShape.selectedPlane == planeBoxNames.Right))
			{
				...
				rows3.Add(Class186.smethod_387(double_, this, string_));
				DataGridViewRowCollection rows4 = dataGridView_0.Rows;
				string_ = "Z";
				double_ = parShape.pntBase.Z;
				rows4.Add(Class186.smethod_387(double_, this, string_));
			}
			if ((parShape.selectedPlane == planeBoxNames.Front) | (parShape.selectedPlane == planeBoxNames.Back))
			{
				...
				string string_ = "X";
				double double_ = parShape.pntBase.X;
				rows5.Add(Class186.smethod_387(double_, this, string_));
				DataGridViewRowCollection rows6 = dataGridView_0.Rows;
				string_ = "Z";
				double_ = parShape.pntBase.Z;
				rows6.Add(Class186.smethod_387(double_, this, string_));
			}
		}
		switch (Index)
		{
		case 0:
		{
			selectedShape = new buShapeProfiling(ProfilingTypes.ProfilingRectangle, parShape.ProfilingRadius, parShape.ProfilingDepth, parShape.ProfilingLength, parShape.ProfilingWidth, parShape.ProfilingHeight);
			selectedShape.isPocket = parShape.isProfilingPocket;
			((buShapeProfiling)selectedShape).ProfilingType = ProfilingTypes.ProfilingRectangle;
			parShape.ProfilingType = ProfilingTypes.ProfilingRectangle;
			...
			double double_ = ((buShapeProfiling)selectedShape).Width;
			rows13.Add(Class186.smethod_387(double_, this, string_));
			DataGridViewRowCollection rows14 = dataGridView_0.Rows;
			string_ = buLangTranslate.preDef.Height;
			double_ = ((buShapeProfiling)selectedShape).Height;
			rows14.Add(Class186.smethod_387(double_, this, string_));
			DataGridViewRowCollection rows15 = dataGridView_0.Rows;
			string_ = buLangTranslate.preDef.Depth;
			double_ = ((buShapeProfiling)selectedShape).Depth;
			rows15.Add(Class186.smethod_387(double_, this, string_));
			break;
		}
		case 1:
		{
			selectedShape = new buShapeProfiling(ProfilingTypes.ProfilingRound, parShape.ProfilingRadius, parShape.ProfilingDepth, parShape.ProfilingLength, parShape.ProfilingWidth, parShape.ProfilingHeight);
			selectedShape.isPocket = parShape.isProfilingPocket;
			((buShapeProfiling)selectedShape).ProfilingType = ProfilingTypes.ProfilingRound;
			parShape.ProfilingType = ProfilingTypes.ProfilingRound;
			selectedShape.BasePoint = new Point3D(parShape.pntBase.X, parShape.pntBase.Y, parShape.pntBase.Z);
			selectedShape.planeName = parShape.selectedPlane;
			selectedShape.planeOperation = buCall.buVector5_0.PlaneNameToPlane(selectedShape.planeName);
			selectedShape.Corner = parShape.selectedCorner;
			...
			string string_ = buLangTranslate.preDef.Radius;
			double double_ = ((buShapeProfiling)selectedShape).Radius;
			rows11.Add(Class186.smethod_387(double_, this, string_));
			DataGridViewRowCollection rows12 = dataGridView_0.Rows;
			string_ = buLangTranslate.preDef.Depth;
			double_ = ((buShapeProfiling)selectedShape).Depth;
			rows12.Add(Class186.smethod_387(double_, this, string_));
			break;
		}
		case 2:
		{
			selectedShape = new buShapeProfiling(ProfilingTypes.ProfilingChamfer, parShape.ProfilingRadius, parShape.ProfilingDepth, parShape.ProfilingLength, parShape.ProfilingWidth, parShape.ProfilingHeight);
			selectedShape.isPocket = parShape.isProfilingPocket;
			((buShapeProfiling)selectedShape).ProfilingType = ProfilingTypes.ProfilingChamfer;
			parShape.ProfilingType = ProfilingTypes.ProfilingChamfer;
			selectedShape.BasePoint = new Point3D(parShape.pntBase.X, parShape.pntBase.Y, parShape.pntBase.Z);
			selectedShape.planeName = parShape.selectedPlane;
			selectedShape.planeOperation = buCall.buVector5_0.PlaneNameToPlane(selectedShape.planeName);
			selectedShape.Corner = parShape.selectedCorner;
			...
			string string_ = buLangTranslate.preDef.Length;
			double double_ = ((buShapeProfiling)selectedShape).Length;
			rows9.Add(Class186.smethod_387(double_, this, string_));
			DataGridViewRowCollection rows10 = dataGridView_0.Rows;
			string_ = buLangTranslate.preDef.Depth;
			double_ = ((buShapeProfiling)selectedShape).Depth;
			rows10.Add(Class186.smethod_387(double_, this, string_));
			break;
		}
		case 3:
		{
			selectedShape = new buShapeProfiling(ProfilingTypes.ProfilingRoundConcave, parShape.ProfilingRadius, parShape.ProfilingDepth, parShape.ProfilingLength, parShape.ProfilingWidth, parShape.ProfilingHeight);
			selectedShape.isPocket = parShape.isProfilingPocket;
			((buShapeProfiling)selectedShape).ProfilingType = ProfilingTypes.ProfilingRoundConcave;
			parShape.ProfilingType = ProfilingTypes.ProfilingRoundConcave;
			selectedShape.BasePoint = new Point3D(parShape.pntBase.X, parShape.pntBase.Y, parShape.pntBase.Z);
			selectedShape.planeName = parShape.selectedPlane;
			selectedShape.planeOperation = buCall.buVector5_0.PlaneNameToPlane(selectedShape.planeName);
			selectedShape.Corner = parShape.selectedCorner;
			...
			string string_ = buLangTranslate.preDef.Radius;
			double double_ = ((buShapeProfiling)selectedShape).Radius;
			rows7.Add(Class186.smethod_387(double_, this, string_));
			DataGridViewRowCollection rows8 = dataGridView_0.Rows;
			string_ = buLangTranslate.preDef.Depth;
			double_ = ((buShapeProfiling)selectedShape).Depth;
			rows8.Add(Class186.smethod_387(double_, this, string_));
			break;
		}
		}
	...
	internal void method_1(object sender, EventArgs e)
	{
		...
		{
			buShapeProfiling buShapeProfiling2 = selectedShape as buShapeProfiling;
			if (buShapeProfiling2.isPocket)
			{
				buShapeProfiling2.isPocket = false;
			}
			else
			{
				buShapeProfiling2.isPocket = true;
			}
			checkBox_0.Checked = buShapeProfiling2.isPocket;
			parShape.isProfilingPocket = buShapeProfiling2.isPocket;
			ShapeToDataGrid(int_0);
			if (okCommandWithTwoDataEventHandler_0 != null)
			{
	...
	internal void method_2(object sender, EventArgs e)
	{
		...
		if (control.Name == checkBox_0.Name && selectedShape is buShapeProfiling)
		{
			buShapeProfiling buShapeProfiling2 = selectedShape as buShapeProfiling;
			buShapeProfiling2.isPocket = checkBox_0.Checked;
			parShape.isProfilingPocket = buShapeProfiling2.isPocket;
		...
		Apply();
		PropertiesForm.Inited = true;
		Class186.smethod_485((EventArgs)null, sender, this);
	}
