...
public class F_DrillList : Form
{
	...
	public void Init()
	{
		...
		listView_0.Items.Add(buLangTranslate.preDef.Single + " " + buLangTranslate.preDef.Hole, 0);
		listView_0.Items.Add(buLangTranslate.preDef.Horizontal + " " + buLangTranslate.preDef.Hole, 1);
		listView_0.Items.Add(buLangTranslate.preDef.Horizontal + " " + buLangTranslate.preDef.Line + " " + buLangTranslate.preDef.Hole, 2);
		listView_0.Items.Add(buLangTranslate.preDef.Vertical + " " + buLangTranslate.preDef.Hole, 3);
		listView_0.Items.Add(buLangTranslate.preDef.Vertical + " " + buLangTranslate.preDef.Line + " " + buLangTranslate.preDef.Hole, 4);
		listView_0.Items.Add(buLangTranslate.preDef.Slope + " " + buLangTranslate.preDef.Hole, 5);
		listView_0.Items.Add("3 " + buLangTranslate.preDef.Hole, 6);
		...
		if (parShape.DrillType != drillTypes.SingleHole)
		{
			if (parShape.DrillType != drillTypes.HorizontalHoles)
			{
				if (parShape.DrillType != drillTypes.HorizontalLineHoles)
				{
					if (parShape.DrillType != drillTypes.VerticalHoles)
					{
						if (parShape.DrillType != drillTypes.VerticalLineHoles)
						{
							if (parShape.DrillType != drillTypes.InclineHoles)
							{
								if (parShape.DrillType == drillTypes.ThreeHole)
								{
	...
	public void DataGridValuesToShape(int ColumnIndex, int RowIndex)
	{
		...
		else
		{
			...
			if ((parShape.selectedPlane == planeBoxNames.Front) | (parShape.selectedPlane == planeBoxNames.Back))
			{
				selectedShape.BasePoint.Z = Convert.ToDouble(dataGridView_0.Rows[0].Cells[1].Value);
			}
			if ((parShape.selectedPlane == planeBoxNames.Left) | (parShape.selectedPlane == planeBoxNames.Right))
			{
				selectedShape.BasePoint.Z = Convert.ToDouble(dataGridView_0.Rows[0].Cells[1].Value);
		...
		if (parShape.DrillType != drillTypes.SingleHole)
		{
			if (!((parShape.DrillType == drillTypes.HorizontalHoles) | (parShape.DrillType == drillTypes.VerticalHoles)))
			{
				if (!((parShape.DrillType == drillTypes.HorizontalLineHoles) | (parShape.DrillType == drillTypes.VerticalLineHoles)))
				{
					if (parShape.DrillType != drillTypes.ThreeHole)
					{
						if (parShape.DrillType == drillTypes.InclineHoles)
						{
							((buShapeHoleMulti)selectedShape).Diameter = Convert.ToDouble(dataGridView_0.Rows[2].Cells[1].Value);
							((buShapeHoleMulti)selectedShape).Depth = Convert.ToDouble(dataGridView_0.Rows[3].Cells[1].Value);
							((buShapeHoleMulti)selectedShape).Distance = Convert.ToDouble(dataGridView_0.Rows[4].Cells[1].Value);
							((buShapeHoleMulti)selectedShape).Count = Convert.ToInt32(dataGridView_0.Rows[5].Cells[1].Value);
							((buShapeHoleMulti)selectedShape).Angle = Convert.ToDouble(dataGridView_0.Rows[6].Cells[1].Value);
							((buShapeHoleMulti)selectedShape).DrillType = parShape.DrillType;
							parShape.HoleDiameter = ((buShapeHoleMulti)selectedShape).Diameter;
							parShape.HoleDistance = ((buShapeHoleMulti)selectedShape).Distance;
							parShape.HoleCount = ((buShapeHoleMulti)selectedShape).Count;
							parShape.HoleAngle = ((buShapeHoleMulti)selectedShape).Angle;
							parShape.HoleDepth = ((buShapeHoleMulti)selectedShape).Depth;
						}
					}
					else
					{
						((buShapeHole3)selectedShape).Diameter = Convert.ToDouble(dataGridView_0.Rows[2].Cells[1].Value);
						((buShapeHole3)selectedShape).Depth = Convert.ToDouble(dataGridView_0.Rows[3].Cells[1].Value);
						((buShapeHole3)selectedShape).DiameterOutside = Convert.ToDouble(dataGridView_0.Rows[4].Cells[1].Value);
						((buShapeHole3)selectedShape).DistanceX = Convert.ToInt32(dataGridView_0.Rows[5].Cells[1].Value);
						((buShapeHole3)selectedShape).DistanceY = Convert.ToInt32(dataGridView_0.Rows[6].Cells[1].Value);
						((buShapeHole3)selectedShape).Hole3Angle = Convert.ToDouble(dataGridView_0.Rows[7].Cells[1].Value);
						((buShapeHole3)selectedShape).DrillType = parShape.DrillType;
						parShape.HoleDiameter = ((buShapeHole3)selectedShape).Diameter;
						parShape.HoleDiameterOutside = ((buShapeHole3)selectedShape).DiameterOutside;
						parShape.HoleOutsideDisX = ((buShapeHole3)selectedShape).DistanceX;
						parShape.HoleOutsideDisY = ((buShapeHole3)selectedShape).DistanceY;
						parShape.HoleAngle3Point = ((buShapeHole3)selectedShape).Hole3Angle;
						parShape.HoleDepth = ((buShapeHole3)selectedShape).Depth;
					}
				}
				else
				{
					((buShapeHoleMulti)selectedShape).Diameter = Convert.ToDouble(dataGridView_0.Rows[1].Cells[1].Value);
					((buShapeHoleMulti)selectedShape).Depth = Convert.ToDouble(dataGridView_0.Rows[2].Cells[1].Value);
					((buShapeHoleMulti)selectedShape).Distance = Convert.ToDouble(dataGridView_0.Rows[3].Cells[1].Value);
					((buShapeHoleMulti)selectedShape).StartDistance = Convert.ToInt32(dataGridView_0.Rows[4].Cells[1].Value);
					((buShapeHoleMulti)selectedShape).EndDistance = Convert.ToInt32(dataGridView_0.Rows[5].Cells[1].Value);
					((buShapeHoleMulti)selectedShape).DrillType = parShape.DrillType;
					parShape.HoleDiameter = ((buShapeHoleMulti)selectedShape).Diameter;
					parShape.HoleDistance = ((buShapeHoleMulti)selectedShape).Distance;
					parShape.HoleStartDistance = ((buShapeHoleMulti)selectedShape).StartDistance;
					parShape.HoleEndDistance = ((buShapeHoleMulti)selectedShape).EndDistance;
					parShape.HoleDepth = ((buShapeHoleMulti)selectedShape).Depth;
				}
			}
			else
		...
		{
			((buShapeHole)selectedShape).Diameter = Convert.ToDouble(dataGridView_0.Rows[2].Cells[1].Value);
			((buShapeHole)selectedShape).Depth = Convert.ToDouble(dataGridView_0.Rows[3].Cells[1].Value);
			((buShapeHole)selectedShape).DrillType = drillTypes.SingleHole;
			parShape.HoleDiameter = ((buShapeHole)selectedShape).Diameter;
			parShape.HoleDepth = ((buShapeHole)selectedShape).Depth;
		}
		if (selectedShape is buShapeHole)
		{
			buShapeHole buShapeHole4 = selectedShape as buShapeHole;
			buShapeHole4.isMilling = checkBox_0.Checked;
		}
	...
	public void ShapeToDataGrid(int Index)
	{
		...
		if (Index != 2)
		{
			if (Index != 4)
			{
				if ((parShape.selectedPlane == planeBoxNames.Top) | (parShape.selectedPlane == planeBoxNames.Bottom))
				{
					...
					rows.Add(Class186.smethod_171(string_, this, double_));
					DataGridViewRowCollection rows2 = dataGridView_0.Rows;
					string_ = "Y";
					double_ = parShape.pntBase.Y;
					rows2.Add(Class186.smethod_171(string_, this, double_));
				}
				if ((parShape.selectedPlane == planeBoxNames.Left) | (parShape.selectedPlane == planeBoxNames.Right))
				{
					...
					rows3.Add(Class186.smethod_171(string_, this, double_));
					DataGridViewRowCollection rows4 = dataGridView_0.Rows;
					string_ = "Z";
					double_ = parShape.pntBase.Z;
					rows4.Add(Class186.smethod_171(string_, this, double_));
				}
				if ((parShape.selectedPlane == planeBoxNames.Front) | (parShape.selectedPlane == planeBoxNames.Back))
				{
					...
					string string_ = "X";
					double double_ = parShape.pntBase.X;
					rows5.Add(Class186.smethod_171(string_, this, double_));
					DataGridViewRowCollection rows6 = dataGridView_0.Rows;
					string_ = "Z";
					double_ = parShape.pntBase.Z;
					rows6.Add(Class186.smethod_171(string_, this, double_));
				}
			}
			else
			{
				if ((parShape.selectedPlane == planeBoxNames.Top) | (parShape.selectedPlane == planeBoxNames.Bottom))
				{
					...
					string string_ = "X";
					double double_ = parShape.pntBase.X;
					rows7.Add(Class186.smethod_171(string_, this, double_));
				}
				if ((parShape.selectedPlane == planeBoxNames.Left) | (parShape.selectedPlane == planeBoxNames.Right))
				{
					...
					string string_ = "Y";
					double double_ = parShape.pntBase.Y;
					rows8.Add(Class186.smethod_171(string_, this, double_));
				}
				if ((parShape.selectedPlane == planeBoxNames.Front) | (parShape.selectedPlane == planeBoxNames.Back))
				{
					...
					string string_ = "X";
					double double_ = parShape.pntBase.X;
					rows9.Add(Class186.smethod_171(string_, this, double_));
				}
			}
		}
		else
		{
			if ((parShape.selectedPlane == planeBoxNames.Top) | (parShape.selectedPlane == planeBoxNames.Bottom))
			{
				...
				string string_ = "Y";
				double double_ = parShape.pntBase.Y;
				rows10.Add(Class186.smethod_171(string_, this, double_));
			}
			if ((parShape.selectedPlane == planeBoxNames.Left) | (parShape.selectedPlane == planeBoxNames.Right))
			{
				DataGridViewRowCollection rows11 = dataGridView_0.Rows;
				string string_ = "Z";
				double double_ = parShape.pntBase.Z;
				rows11.Add(Class186.smethod_171(string_, this, double_));
			}
			if ((parShape.selectedPlane == planeBoxNames.Front) | (parShape.selectedPlane == planeBoxNames.Back))
			{
				...
				string string_ = "Z";
				double double_ = parShape.pntBase.Z;
				rows12.Add(Class186.smethod_171(string_, this, double_));
			}
		}
		if (Index != 0)
		{
			if (!(Index == 1 || Index == 3))
			{
				if (!(Index == 2 || Index == 4))
				{
					...
					case 5:
					{
						parShape.DrillType = drillTypes.InclineHoles;
						selectedShape = new buShapeHoleMulti(drillTypes.InclineHoles, parShape.HoleDiameter, parShape.HoleCount, parShape.HoleDistance, parShape.HoleStartDistance, parShape.HoleEndDistance, parShape.HoleDepth, parShape.HoleAngle);
						((buShapeHoleMulti)selectedShape).DrillType = drillTypes.InclineHoles;
						((buShapeHoleMulti)selectedShape).isMilling = parShape.isMillingHole;
						parShape.DrillType = drillTypes.InclineHoles;
						...
						double double_ = ((buShapeHoleMulti)selectedShape).Diameter;
						rows19.Add(Class186.smethod_171(string_, this, double_));
						DataGridViewRowCollection rows20 = dataGridView_0.Rows;
						string_ = buLangTranslate.preDef.Depth;
						double_ = ((buShapeHoleMulti)selectedShape).Depth;
						rows20.Add(Class186.smethod_171(string_, this, double_));
						DataGridViewRowCollection rows21 = dataGridView_0.Rows;
						string_ = buLangTranslate.preDef.Distance;
						double_ = ((buShapeHoleMulti)selectedShape).Distance;
						rows21.Add(Class186.smethod_171(string_, this, double_));
						DataGridViewRowCollection rows22 = dataGridView_0.Rows;
						string_ = buLangTranslate.preDef.Count;
						double_ = ((buShapeHoleMulti)selectedShape).Count;
						rows22.Add(Class186.smethod_171(string_, this, double_));
						DataGridViewRowCollection rows23 = dataGridView_0.Rows;
						string_ = buLangTranslate.preDef.Angle;
						double_ = ((buShapeHoleMulti)selectedShape).Angle;
						rows23.Add(Class186.smethod_171(string_, this, double_));
						break;
					}
					case 6:
					{
						parShape.DrillType = drillTypes.ThreeHole;
						selectedShape = new buShapeHole3(parShape.HoleDiameter, parShape.HoleDepth, parShape.HoleDiameterOutside, parShape.HoleOutsideDisX, parShape.HoleOutsideDisY, parShape.HoleAngle3Point);
						((buShapeHole3)selectedShape).DrillType = drillTypes.ThreeHole;
						((buShapeHole3)selectedShape).isMilling = parShape.isMillingHole;
						parShape.DrillType = drillTypes.ThreeHole;
						selectedShape.BasePoint = new Point3D(parShape.pntBase.X, parShape.pntBase.Y, parShape.pntBase.Z);
						selectedShape.planeName = parShape.selectedPlane;
						selectedShape.planeOperation = buCall.buVector5_0.PlaneNameToPlane(selectedShape.planeName);
						...
						string string_ = buLangTranslate.preDef.Diameter;
						double double_ = ((buShapeHole3)selectedShape).Diameter;
						rows13.Add(Class186.smethod_171(string_, this, double_));
						DataGridViewRowCollection rows14 = dataGridView_0.Rows;
						string_ = buLangTranslate.preDef.Depth;
						double_ = ((buShapeHole3)selectedShape).Depth;
						rows14.Add(Class186.smethod_171(string_, this, double_));
						DataGridViewRowCollection rows15 = dataGridView_0.Rows;
						string_ = buLangTranslate.preDef.Diameter + " " + buLangTranslate.preDef.Outside;
						double_ = ((buShapeHole3)selectedShape).DiameterOutside;
						rows15.Add(Class186.smethod_171(string_, this, double_));
						DataGridViewRowCollection rows16 = dataGridView_0.Rows;
						string_ = buLangTranslate.preDef.Outside + " " + buLangTranslate.preDef.Distance + " X";
						double_ = ((buShapeHole3)selectedShape).DistanceX;
						rows16.Add(Class186.smethod_171(string_, this, double_));
						DataGridViewRowCollection rows17 = dataGridView_0.Rows;
						string_ = buLangTranslate.preDef.Outside + " " + buLangTranslate.preDef.Distance + " Y";
						double_ = ((buShapeHole3)selectedShape).DistanceY;
						rows17.Add(Class186.smethod_171(string_, this, double_));
						DataGridViewRowCollection rows18 = dataGridView_0.Rows;
						string_ = buLangTranslate.preDef.Angle;
						double_ = ((buShapeHole3)selectedShape).Hole3Angle;
						rows18.Add(Class186.smethod_171(string_, this, double_));
						break;
					}
					}
				}
				...
				{
					drillTypes drillTypes2 = drillTypes.HorizontalLineHoles;
					if (Index == 2)
					{
						parShape.DrillType = drillTypes.HorizontalLineHoles;
						drillTypes2 = drillTypes.HorizontalLineHoles;
					}
					if (Index == 4)
					{
						parShape.DrillType = drillTypes.VerticalLineHoles;
						drillTypes2 = drillTypes.VerticalLineHoles;
					}
					selectedShape = new buShapeHoleMulti(drillTypes2, parShape.HoleDiameter, parShape.HoleCount, parShape.HoleDistance, parShape.HoleStartDistance, parShape.HoleEndDistance, parShape.HoleDepth, 0.0);
					((buShapeHoleMulti)selectedShape).DrillType = drillTypes2;
					((buShapeHoleMulti)selectedShape).isMilling = parShape.isMillingHole;
					parShape.DrillType = drillTypes2;
					selectedShape.BasePoint = new Point3D(parShape.pntBase.X, parShape.pntBase.Y, parShape.pntBase.Z);
					selectedShape.planeName = parShape.selectedPlane;
					selectedShape.planeOperation = buCall.buVector5_0.PlaneNameToPlane(selectedShape.planeName);
					selectedShape.Corner = parShape.selectedCorner;
					...
					string string_ = buLangTranslate.preDef.Diameter;
					double double_ = ((buShapeHoleMulti)selectedShape).Diameter;
					rows24.Add(Class186.smethod_171(string_, this, double_));
					DataGridViewRowCollection rows25 = dataGridView_0.Rows;
					string_ = buLangTranslate.preDef.Depth;
					double_ = ((buShapeHoleMulti)selectedShape).Depth;
					rows25.Add(Class186.smethod_171(string_, this, double_));
					DataGridViewRowCollection rows26 = dataGridView_0.Rows;
					string_ = buLangTranslate.preDef.Distance;
					double_ = ((buShapeHoleMulti)selectedShape).Distance;
					rows26.Add(Class186.smethod_171(string_, this, double_));
					DataGridViewRowCollection rows27 = dataGridView_0.Rows;
					string_ = buLangTranslate.preDef.Start + " " + buLangTranslate.preDef.Distance;
					double_ = ((buShapeHoleMulti)selectedShape).StartDistance;
					rows27.Add(Class186.smethod_171(string_, this, double_));
					DataGridViewRowCollection rows28 = dataGridView_0.Rows;
					string_ = buLangTranslate.preDef.End + " " + buLangTranslate.preDef.Distance;
					double_ = ((buShapeHoleMulti)selectedShape).EndDistance;
					rows28.Add(Class186.smethod_171(string_, this, double_));
				}
			}
			else
			{
				drillTypes drillTypes3 = drillTypes.HorizontalHoles;
				if (Index == 1)
				{
					parShape.DrillType = drillTypes.HorizontalHoles;
					drillTypes3 = drillTypes.HorizontalHoles;
				}
				if (Index == 3)
				{
					parShape.DrillType = drillTypes.VerticalHoles;
					drillTypes3 = drillTypes.VerticalHoles;
				}
				selectedShape = new buShapeHoleMulti(drillTypes3, parShape.HoleDiameter, parShape.HoleCount, parShape.HoleDistance, parShape.HoleStartDistance, parShape.HoleEndDistance, parShape.HoleDepth, 0.0);
				((buShapeHoleMulti)selectedShape).DrillType = drillTypes3;
				((buShapeHoleMulti)selectedShape).isMilling = parShape.isMillingHole;
				parShape.DrillType = drillTypes3;
				selectedShape.BasePoint = new Point3D(parShape.pntBase.X, parShape.pntBase.Y, parShape.pntBase.Z);
				selectedShape.planeName = parShape.selectedPlane;
				selectedShape.planeOperation = buCall.buVector5_0.PlaneNameToPlane(selectedShape.planeName);
				selectedShape.Corner = parShape.selectedCorner;
				...
				string string_ = buLangTranslate.preDef.Diameter;
				double double_ = ((buShapeHoleMulti)selectedShape).Diameter;
				rows29.Add(Class186.smethod_171(string_, this, double_));
				DataGridViewRowCollection rows30 = dataGridView_0.Rows;
				string_ = buLangTranslate.preDef.Depth;
				double_ = ((buShapeHoleMulti)selectedShape).Depth;
				rows30.Add(Class186.smethod_171(string_, this, double_));
				DataGridViewRowCollection rows31 = dataGridView_0.Rows;
				string_ = buLangTranslate.preDef.Distance;
				double_ = ((buShapeHoleMulti)selectedShape).Distance;
				rows31.Add(Class186.smethod_171(string_, this, double_));
				DataGridViewRowCollection rows32 = dataGridView_0.Rows;
				string_ = buLangTranslate.preDef.Count;
				double_ = ((buShapeHoleMulti)selectedShape).Count;
				rows32.Add(Class186.smethod_171(string_, this, double_));
			}
		}
		else
		{
			selectedShape = new buShapeHole(parShape.HoleDiameter, parShape.HoleDepth);
			parShape.DrillType = drillTypes.SingleHole;
			((buShapeHole)selectedShape).DrillType = drillTypes.SingleHole;
			((buShapeHole)selectedShape).isMilling = parShape.isMillingHole;
			selectedShape.BasePoint = new Point3D(parShape.pntBase.X, parShape.pntBase.Y, parShape.pntBase.Z);
			selectedShape.planeName = parShape.selectedPlane;
			selectedShape.planeOperation = buCall.buVector5_0.PlaneNameToPlane(selectedShape.planeName);
			selectedShape.Corner = parShape.selectedCorner;
			selectedShape.Alignment = parShape.objectAlignment;
			DataGridViewRowCollection rows33 = dataGridView_0.Rows;
			string string_ = buLangTranslate.preDef.Diameter;
			double double_ = ((buShapeHole)selectedShape).Diameter;
			rows33.Add(Class186.smethod_171(string_, this, double_));
			DataGridViewRowCollection rows34 = dataGridView_0.Rows;
			string_ = buLangTranslate.preDef.Depth;
			double_ = ((buShapeHole)selectedShape).Depth;
			rows34.Add(Class186.smethod_171(string_, this, double_));
		}
		checkBox_0.Checked = parShape.isMillingHole;
	...
	internal void method_1(object sender, EventArgs e)
	{
		...
		if (control.Name == button_2.Name && selectedShape is buShapeHole)
		{
			buShapeHole buShapeHole4 = selectedShape as buShapeHole;
			...
			checkBox_0.Checked = buShapeHole4.isMilling;
			parShape.isMillingHole = buShapeHole4.isMilling;
			ShapeToDataGrid(int_0);
			if (okCommandWithTwoDataEventHandler_0 != null)
			{
	...
	internal void method_2(object sender, EventArgs e)
	{
		...
		if (control.Name == checkBox_0.Name && selectedShape is buShapeHole)
		{
			buShapeHole buShapeHole4 = selectedShape as buShapeHole;
			buShapeHole4.isMilling = checkBox_0.Checked;
			parShape.isMillingHole = buShapeHole4.isMilling;
		...
		Apply();
		PropertiesForm.Inited = true;
		Class186.smethod_135(sender, (EventArgs)null, this);
	}

	internal void method_3(object sender, ListViewItemSelectionChangedEventArgs e)
	{
