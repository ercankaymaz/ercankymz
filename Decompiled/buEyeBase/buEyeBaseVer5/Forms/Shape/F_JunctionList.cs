...
public class F_JunctionList : Form
{
	...
	public void Init()
	{
		...
		listView_0.Items.Add(buLangTranslate.preDef.Horizontal + " 3 " + buLangTranslate.preDef.Hole + buLangTranslate.preDef.Junction, 0);
		listView_0.Items.Add(buLangTranslate.preDef.Vertical + " 3 " + buLangTranslate.preDef.Hole + buLangTranslate.preDef.Junction, 1);
		listView_0.Items.Add(buLangTranslate.preDef.Horizontal + " 2 " + buLangTranslate.preDef.Hole + buLangTranslate.preDef.Junction, 2);
		listView_0.Items.Add(buLangTranslate.preDef.Vertical + " 2 " + buLangTranslate.preDef.Hole + buLangTranslate.preDef.Junction, 3);
		...
		if (parShape.JunctionType != JunctionTypes.Junction3HoleIntersectHorizontal)
		{
			if (parShape.JunctionType != JunctionTypes.Junction3HoleIntersectVertical)
			{
				if (parShape.JunctionType != JunctionTypes.Junction2HoleNearByHorizontal)
				{
					if (parShape.JunctionType == JunctionTypes.Junction2HoleNearByVertical)
					{
	...
	public void LoadLanguage()
	{
		...
		try
		{
			Text = buLangTranslate.preDef.Junction;
	...
	public void DataGridValuesToShape(int ColumnIndex, int RowIndex)
	{
		...
		if (!((parShape.JunctionType == JunctionTypes.Junction3HoleIntersectHorizontal) | (parShape.JunctionType == JunctionTypes.Junction3HoleIntersectVertical)))
		{
			if ((parShape.JunctionType == JunctionTypes.Junction2HoleNearByHorizontal) | (parShape.JunctionType == JunctionTypes.Junction2HoleNearByVertical))
			{
				((buShapeJunction)selectedShape).Diameter = Convert.ToDouble(dataGridView_0.Rows[2].Cells[1].Value);
				((buShapeJunction)selectedShape).DiameterOutside = Convert.ToDouble(dataGridView_0.Rows[3].Cells[1].Value);
				((buShapeJunction)selectedShape).Distance = Convert.ToDouble(dataGridView_0.Rows[4].Cells[1].Value);
				((buShapeJunction)selectedShape).Depth = Convert.ToDouble(dataGridView_0.Rows[5].Cells[1].Value);
				((buShapeJunction)selectedShape).JunctionType = parShape.JunctionType;
				parShape.JunctionDiameter = ((buShapeJunction)selectedShape).Diameter;
				parShape.JunctionDiameterOutside = ((buShapeJunction)selectedShape).DiameterOutside;
				parShape.JunctionDistance = ((buShapeJunction)selectedShape).Distance;
				parShape.JunctionDepth = ((buShapeJunction)selectedShape).Depth;
			}
		}
		else
		{
			((buShapeJunction)selectedShape).Diameter = Convert.ToDouble(dataGridView_0.Rows[2].Cells[1].Value);
			((buShapeJunction)selectedShape).Distance = Convert.ToDouble(dataGridView_0.Rows[3].Cells[1].Value);
			((buShapeJunction)selectedShape).Depth = Convert.ToDouble(dataGridView_0.Rows[4].Cells[1].Value);
			((buShapeJunction)selectedShape).JunctionType = parShape.JunctionType;
			parShape.JunctionDiameter = ((buShapeJunction)selectedShape).Diameter;
			parShape.JunctionDistance = ((buShapeJunction)selectedShape).Distance;
			parShape.JunctionDepth = ((buShapeJunction)selectedShape).Depth;
		}
		((buShapeJunction)selectedShape).isMilling = checkBox_0.Checked;
		parShape.isMillingJunction = checkBox_0.Checked;
	...
	public void ShapeToDataGrid(int Index)
	{
		...
		if ((parShape.selectedPlane == planeBoxNames.Top) | (parShape.selectedPlane == planeBoxNames.Bottom))
		{
			...
			rows.Add(Class186.smethod_372(double_, this, string_));
			DataGridViewRowCollection rows2 = dataGridView_0.Rows;
			string_ = "Y";
			double_ = parShape.pntBase.Y;
			rows2.Add(Class186.smethod_372(double_, this, string_));
		}
		if ((parShape.selectedPlane == planeBoxNames.Left) | (parShape.selectedPlane == planeBoxNames.Right))
		{
			...
			rows3.Add(Class186.smethod_372(double_, this, string_));
			DataGridViewRowCollection rows4 = dataGridView_0.Rows;
			string_ = "Z";
			double_ = parShape.pntBase.Z;
			rows4.Add(Class186.smethod_372(double_, this, string_));
		}
		if ((parShape.selectedPlane == planeBoxNames.Front) | (parShape.selectedPlane == planeBoxNames.Back))
		{
			...
			string string_ = "X";
			double double_ = parShape.pntBase.X;
			rows5.Add(Class186.smethod_372(double_, this, string_));
			DataGridViewRowCollection rows6 = dataGridView_0.Rows;
			string_ = "Z";
			double_ = parShape.pntBase.Z;
			rows6.Add(Class186.smethod_372(double_, this, string_));
		}
		if (!(Index == 0 || Index == 1))
		{
			if (Index == 2 || Index == 3)
			{
				...
				if (Index == 2)
				{
					parShape.JunctionType = JunctionTypes.Junction2HoleNearByHorizontal;
					junctionType = JunctionTypes.Junction2HoleNearByHorizontal;
				}
				if (Index == 3)
				{
					parShape.JunctionType = JunctionTypes.Junction2HoleNearByVertical;
					junctionType = JunctionTypes.Junction2HoleNearByVertical;
				}
				selectedShape = new buShapeJunction(junctionType, parShape.JunctionDiameter, parShape.JunctionDepth, parShape.JunctionDiameterOutside, parShape.JunctionDistance, parShape.isMillingJunction);
				((buShapeJunction)selectedShape).JunctionType = junctionType;
				((buShapeJunction)selectedShape).isMilling = parShape.isMillingCut;
				parShape.JunctionType = junctionType;
				...
				double double_ = ((buShapeJunction)selectedShape).Diameter;
				rows7.Add(Class186.smethod_372(double_, this, string_));
				...
				double_ = ((buShapeJunction)selectedShape).DiameterOutside;
				rows8.Add(Class186.smethod_372(double_, this, string_));
				DataGridViewRowCollection rows9 = dataGridView_0.Rows;
				string_ = buLangTranslate.preDef.Distance;
				double_ = ((buShapeJunction)selectedShape).Distance;
				rows9.Add(Class186.smethod_372(double_, this, string_));
				DataGridViewRowCollection rows10 = dataGridView_0.Rows;
				string_ = buLangTranslate.preDef.Depth;
				double_ = ((buShapeJunction)selectedShape).Depth;
				rows10.Add(Class186.smethod_372(double_, this, string_));
			}
		}
		else
		{
			JunctionTypes junctionType2 = JunctionTypes.Junction3HoleIntersectHorizontal;
			if (Index == 0)
			{
				parShape.JunctionType = JunctionTypes.Junction3HoleIntersectHorizontal;
				junctionType2 = JunctionTypes.Junction3HoleIntersectHorizontal;
			}
			if (Index == 1)
			{
				parShape.JunctionType = JunctionTypes.Junction3HoleIntersectVertical;
				junctionType2 = JunctionTypes.Junction3HoleIntersectVertical;
			}
			selectedShape = new buShapeJunction(junctionType2, parShape.JunctionDiameter, parShape.JunctionDepth, parShape.JunctionDiameterOutside, parShape.JunctionDistance, parShape.isMillingJunction);
			((buShapeJunction)selectedShape).JunctionType = junctionType2;
			((buShapeJunction)selectedShape).isMilling = parShape.isMillingCut;
			parShape.JunctionType = junctionType2;
			selectedShape.BasePoint = new Point3D(parShape.pntBase.X, parShape.pntBase.Y, parShape.pntBase.Z);
			selectedShape.planeName = parShape.selectedPlane;
			selectedShape.planeOperation = buCall.buVector5_0.PlaneNameToPlane(selectedShape.planeName);
			selectedShape.Corner = parShape.selectedCorner;
			...
			string string_ = buLangTranslate.preDef.Diameter;
			double double_ = ((buShapeJunction)selectedShape).Diameter;
			rows11.Add(Class186.smethod_372(double_, this, string_));
			DataGridViewRowCollection rows12 = dataGridView_0.Rows;
			string_ = buLangTranslate.preDef.Distance;
			double_ = ((buShapeJunction)selectedShape).Distance;
			rows12.Add(Class186.smethod_372(double_, this, string_));
			DataGridViewRowCollection rows13 = dataGridView_0.Rows;
			string_ = buLangTranslate.preDef.Depth;
			double_ = ((buShapeJunction)selectedShape).Depth;
			rows13.Add(Class186.smethod_372(double_, this, string_));
		}
		checkBox_0.Checked = parShape.isMillingJunction;
	...
	internal void method_1(object sender, EventArgs e)
	{
		...
		if (control.Name == button_2.Name && selectedShape is buShapeJunction)
		{
			buShapeJunction buShapeJunction2 = selectedShape as buShapeJunction;
			if (buShapeJunction2.isMilling)
			{
				buShapeJunction2.isMilling = false;
			}
			else
			{
				buShapeJunction2.isMilling = true;
			}
			checkBox_0.Checked = buShapeJunction2.isMilling;
			parShape.isMillingJunction = buShapeJunction2.isMilling;
			ShapeToDataGrid(int_0);
			if (okCommandWithTwoDataEventHandler_0 != null)
			{
	...
	internal void method_2(object sender, EventArgs e)
	{
		...
		if (control.Name == checkBox_0.Name && selectedShape is buShapeJunction)
		{
			buShapeJunction buShapeJunction2 = selectedShape as buShapeJunction;
			buShapeJunction2.isMilling = checkBox_0.Checked;
			parShape.isMillingJunction = buShapeJunction2.isMilling;
			ShapeToDataGrid(int_0);
			if (okCommandWithTwoDataEventHandler_0 != null)
			{
		...
		Apply();
		PropertiesForm.Inited = true;
		Class186.smethod_45(sender, this, (EventArgs)null);
	}
