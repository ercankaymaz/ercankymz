...
internal sealed class DefaultUrlEncoder : UrlEncoder
{
	...
	internal DefaultUrlEncoder(TextEncoderSettings settings)
	{
		...
		object obj = global::_003CPrivateImplementationDetails_003E._40DFDA6D4ED43D4879E2A200D2471641FC15E1C25DAB5D4D491BD811F7727FCC_A1;
		if (obj == null)
		{
			obj = new char[31]
			{
			...
			global::_003CPrivateImplementationDetails_003E._40DFDA6D4ED43D4879E2A200D2471641FC15E1C25DAB5D4D491BD811F7727FCC_A1 = (char[])obj;
		}
		_innerEncoder = new OptimizedInboxTextEncoder(singleton, in allowedCodePointsBitmap, forbidHtmlSensitiveCharacters: true, new ReadOnlySpan<char>((char[])obj));
	}
