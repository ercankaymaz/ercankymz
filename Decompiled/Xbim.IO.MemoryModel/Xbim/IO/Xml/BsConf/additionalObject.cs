...
public class additionalObject
{
	...
	private static XmlSerializer Serializer
	{
		get
		{
			if (serializer == null)
			{
				serializer = new XmlSerializer(typeof(additionalObject));
			}
			return serializer;
		}
	}
	...
	public static bool Deserialize(string xml, out additionalObject obj, out Exception exception)
	{
		exception = null;
		obj = null;
		try
	...
	public static additionalObject Deserialize(string xml)
	{
		...
		try
		{
			...
			return (additionalObject)Serializer.Deserialize(XmlReader.Create(stringReader));
		}
		finally
		{
	...
	public static bool LoadFromFile(string fileName, out additionalObject obj, out Exception exception)
	{
		exception = null;
		obj = null;
		try
