...
public class include
{
	...
	private static XmlSerializer Serializer
	{
		get
		{
			if (serializer == null)
			{
				serializer = new XmlSerializer(typeof(include));
			}
			return serializer;
		}
	}
	...
	public static bool Deserialize(string xml, out include obj, out Exception exception)
	{
		exception = null;
		obj = null;
		try
	...
	public static include Deserialize(string xml)
	{
		...
		try
		{
			...
			return (include)Serializer.Deserialize(XmlReader.Create(stringReader));
		}
		finally
		{
	...
	public static bool LoadFromFile(string fileName, out include obj, out Exception exception)
	{
		exception = null;
		obj = null;
		try
