...
public class containerObject
{
	...
	private static XmlSerializer Serializer
	{
		get
		{
			if (serializer == null)
			{
				serializer = new XmlSerializer(typeof(containerObject));
			}
			return serializer;
		}
	}
	...
	public static bool Deserialize(string xml, out containerObject obj, out Exception exception)
	{
		exception = null;
		obj = null;
		try
	...
	public static containerObject Deserialize(string xml)
	{
		...
		try
		{
			...
			return (containerObject)Serializer.Deserialize(XmlReader.Create(stringReader));
		}
		finally
		{
	...
	public static bool LoadFromFile(string fileName, out containerObject obj, out Exception exception)
	{
		exception = null;
		obj = null;
		try
