...
public class configurationInclude
{
	...
	private static XmlSerializer Serializer
	{
		get
		{
			if (serializer == null)
			{
				serializer = new XmlSerializer(typeof(configurationInclude));
			}
			return serializer;
		}
	}
	...
	public static bool Deserialize(string xml, out configurationInclude obj, out Exception exception)
	{
		exception = null;
		obj = null;
		try
	...
	public static configurationInclude Deserialize(string xml)
	{
		...
		try
		{
			...
			return (configurationInclude)Serializer.Deserialize(XmlReader.Create(stringReader));
		}
		finally
		{
	...
	public static bool LoadFromFile(string fileName, out configurationInclude obj, out Exception exception)
	{
		exception = null;
		obj = null;
		try
