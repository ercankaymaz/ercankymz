...
public class rootEntity
{
	...
	private static XmlSerializer Serializer
	{
		get
		{
			if (serializer == null)
			{
				serializer = new XmlSerializer(typeof(rootEntity));
			}
			return serializer;
		}
	}
	...
	public static bool Deserialize(string xml, out rootEntity obj, out Exception exception)
	{
		exception = null;
		obj = null;
		try
	...
	public static rootEntity Deserialize(string xml)
	{
		...
		try
		{
			...
			return (rootEntity)Serializer.Deserialize(XmlReader.Create(stringReader));
		}
		finally
		{
	...
	public static bool LoadFromFile(string fileName, out rootEntity obj, out Exception exception)
	{
		exception = null;
		obj = null;
		try
