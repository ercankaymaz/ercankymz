...
[TypeConverter(typeof(DefaultToolBarButtonConverter<BeginningToolBarButton>))]
public sealed class BeginningToolBarButton : DefaultToolBarButton
{
	public BeginningToolBarButton()
	...
	public BeginningToolBarButton(string toolTipText, styleType style, bool visible, bool enabled)
		: base(_0023_003DznYWOeKNePhve(), _0023_003DzMqaGBuFvboj9(), toolTipText, style, visible, enabled)
	{
	}

	private BeginningToolBarButton(BeginningToolBarButton _0023_003DzsmgIqeCnnRrL)
	...
	{
		return _0023_003Dz_0024SkdLWSMgmT4iXdAgakTAp3wstK4._0023_003DzDw__wI8_003D(348651468);
	}

	private new static string _0023_003DzMaRWbtcDrjE7JsYNuA_003D_003D()
	{
		return _0023_003Dz_0024SkdLWSMgmT4iXdAgakTAp3wstK4._0023_003DzDw__wI8_003D(348651484);
	}
	...
	{
		return new BeginningToolBarButton(this);
	}
	...
	protected override void DrawImage(System.Drawing.Graphics g, Workspace workspace, int x, int y, int width, int height)
	{
		...
		case colorThemeType.Light:
			DrawImage(g, _0023_003DzuFB8tZJm0S0gGof5g000kq4FhI0ejaxNgA_003D_003D._0023_003DzABo4jfVs_qZhGCk17ImGKrs_003D(), x, y, width, height);
			return;
		case colorThemeType.Dark:
			DrawImage(g, _0023_003DzuFB8tZJm0S0gGof5g000kq4FhI0ejaxNgA_003D_003D._0023_003Dzi7H7o5bZgh8C1XzndWSkcRgd77yu(), x, y, width, height);
			return;
		}
		if (isDark)
		{
