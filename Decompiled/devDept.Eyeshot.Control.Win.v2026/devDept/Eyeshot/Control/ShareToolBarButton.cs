...
[TypeConverter(typeof(DefaultToolBarButtonConverter<ShareToolBarButton>))]
public sealed class ShareToolBarButton : DefaultToolBarButton
{
	...
	public ShareToolBarButton(string toolTipText, styleType style, bool visible, bool enabled)
		: base(null, _0023_003DzMqaGBuFvboj9(), toolTipText, style, visible, enabled)
	{
	}

	private ShareToolBarButton(ShareToolBarButton _0023_003DzsmgIqeCnnRrL)
	...
	{
		return _0023_003Dz_0024SkdLWSMgmT4iXdAgakTAp3wstK4._0023_003DzDw__wI8_003D(348593964);
	}
	...
	{
		return new ShareToolBarButton(this);
	}
	...
	protected override void DrawImage(System.Drawing.Graphics g, Workspace workspace, int x, int y, int width, int height)
	{
		...
		case colorThemeType.Light:
			DrawImage(g, _0023_003DzuFB8tZJm0S0gGof5g000kq4FhI0ejaxNgA_003D_003D._0023_003DzVa5MfFgIFPjS(), x, y, width, height);
			return;
		case colorThemeType.Dark:
			DrawImage(g, _0023_003DzuFB8tZJm0S0gGof5g000kq4FhI0ejaxNgA_003D_003D._0023_003Dz9Vkr9BsZXONc(), x, y, width, height);
			return;
		}
		if (isDark)
		{
