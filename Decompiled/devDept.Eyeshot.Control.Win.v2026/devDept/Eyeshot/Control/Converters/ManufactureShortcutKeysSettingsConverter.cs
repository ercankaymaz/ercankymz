...
public class ManufactureShortcutKeysSettingsConverter : ShortcutKeysSettingsConverter
{
	...
	{
		if (value is ManufactureShortcutKeysSettings && destinationType == typeof(InstanceDescriptor))
		{
			ManufactureShortcutKeysSettings manufactureShortcutKeysSettings = (ManufactureShortcutKeysSettings)value;
			object[] array = new object[30];
			Type[] array2 = new Type[30];
			ShortcutKeysSettingsConverter.GetTypesAndProperties(manufactureShortcutKeysSettings, 0, array2, array);
			int num = 26;
			array2[num] = typeof(Keys);
			array[num++] = manufactureShortcutKeysSettings.Start;
			array2[num] = typeof(Keys);
			array[num++] = manufactureShortcutKeysSettings.Pause;
			array2[num] = typeof(Keys);
			array[num++] = manufactureShortcutKeysSettings.Next;
			array2[num] = typeof(Keys);
			array[num++] = manufactureShortcutKeysSettings.Previous;
			return new InstanceDescriptor(typeof(ManufactureShortcutKeysSettings).GetConstructor(array2), array, isComplete: false);
		}
