...
public class HullShaderStage : CommonShaderStage<HullShader>
{
	...
	{
		((delegate* unmanaged[Stdcall]<void*, int, int, void*, void>)(*(IntPtr*)((nint)(*(IntPtr*)_nativePointer) + (nint)59 * (nint)sizeof(void*))))(_nativePointer, startSlot, numViews, (void*)shaderResourceViewsOut);
	}
	...
	internal unsafe override void SetShader(HullShader hullShaderRef, ClassInstance[] classInstancesOut, int numClassInstances)
	{
		...
		zero = CppObject.ToCallbackPtr<HullShader>(hullShaderRef);
		if (classInstancesOut != null)
		{
		...
		((delegate* unmanaged[Stdcall]<void*, void*, void*, int, void>)(*(IntPtr*)((nint)(*(IntPtr*)_nativePointer) + (nint)60 * (nint)sizeof(void*))))(_nativePointer, (void*)zero, ptr, numClassInstances);
	}

	internal unsafe override void SetSamplers(int startSlot, int numSamplers, IntPtr samplersOut)
	{
		((delegate* unmanaged[Stdcall]<void*, int, int, void*, void>)(*(IntPtr*)((nint)(*(IntPtr*)_nativePointer) + (nint)61 * (nint)sizeof(void*))))(_nativePointer, startSlot, numSamplers, (void*)samplersOut);
	}

	internal unsafe override void SetConstantBuffers(int startSlot, int numBuffers, IntPtr constantBuffersOut)
	{
		((delegate* unmanaged[Stdcall]<void*, int, int, void*, void>)(*(IntPtr*)((nint)(*(IntPtr*)_nativePointer) + (nint)62 * (nint)sizeof(void*))))(_nativePointer, startSlot, numBuffers, (void*)constantBuffersOut);
	}
	...
	internal unsafe override void GetShaderResources(int startSlot, int numViews, ShaderResourceView[] shaderResourceViewsOut)
	{
		...
		((delegate* unmanaged[Stdcall]<void*, int, int, void*, void>)(*(IntPtr*)((nint)(*(IntPtr*)_nativePointer) + (nint)97 * (nint)sizeof(void*))))(_nativePointer, startSlot, numViews, ptr);
		if (shaderResourceViewsOut == null)
		{
			return;
		}
	...
	internal unsafe override void GetShader(out HullShader hullShaderOut, ClassInstance[] classInstancesOut, ref int numClassInstancesRef)
	{
		...
		{
			void* ptr3 = ptr2;
			((delegate* unmanaged[Stdcall]<void*, void*, void*, void*, void>)(*(IntPtr*)((nint)(*(IntPtr*)_nativePointer) + (nint)98 * (nint)sizeof(void*))))(_nativePointer, &zero, ptr, ptr3);
		}
		if (zero != IntPtr.Zero)
		{
	...
	internal unsafe override void GetSamplers(int startSlot, int numSamplers, SamplerState[] samplersOut)
	{
		...
		((delegate* unmanaged[Stdcall]<void*, int, int, void*, void>)(*(IntPtr*)((nint)(*(IntPtr*)_nativePointer) + (nint)99 * (nint)sizeof(void*))))(_nativePointer, startSlot, numSamplers, ptr);
		if (samplersOut == null)
		{
			return;
		}
	...
	internal unsafe override void GetConstantBuffers(int startSlot, int numBuffers, Buffer[] constantBuffersOut)
	{
		...
		((delegate* unmanaged[Stdcall]<void*, int, int, void*, void>)(*(IntPtr*)((nint)(*(IntPtr*)_nativePointer) + (nint)100 * (nint)sizeof(void*))))(_nativePointer, startSlot, numBuffers, ptr);
		if (constantBuffersOut == null)
		{
			return;
		}
	...
	internal unsafe override void SetShader(HullShader hullShaderRef, ComArray<ClassInstance> classInstancesOut, int numClassInstances)
	{
		...
		((delegate* unmanaged[Stdcall]<void*, void*, void*, int, void>)(*(IntPtr*)((nint)(*(IntPtr*)_nativePointer) + (nint)60 * (nint)sizeof(void*))))(nativePointer, intPtr, (void*)intPtr2, numClassInstances);
	}

	private unsafe void SetShader(IntPtr hullShaderRef, IntPtr classInstancesOut, int numClassInstances)
	{
		((delegate* unmanaged[Stdcall]<void*, void*, void*, int, void>)(*(IntPtr*)((nint)(*(IntPtr*)_nativePointer) + (nint)60 * (nint)sizeof(void*))))(_nativePointer, (void*)hullShaderRef, (void*)classInstancesOut, numClassInstances);
	}
}
