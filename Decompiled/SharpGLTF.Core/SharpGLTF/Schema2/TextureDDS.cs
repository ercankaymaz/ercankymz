...
internal class TextureDDS : ExtraProperties
{
	...
	public Image Image
	{
		...
		set
		{
			if (value != null)
			{
				...
				Guard.IsTrue(value.Content.IsDds, "value");
			}
	...
	protected override bool TryReflectField(string name, out FieldInfo value)
	{
		if (name == "source")
		{
			value = FieldInfo.From("source", this, (TextureDDS instance) => instance._source);
			return true;
		}
	...
	protected override void DeserializeProperty(string jsonPropertyName, ref Utf8JsonReader reader)
	{
		...
		{
			JsonSerializable.DeserializePropertyValue<TextureDDS, int?>(ref reader, this, out _source);
		}
		else
		{
