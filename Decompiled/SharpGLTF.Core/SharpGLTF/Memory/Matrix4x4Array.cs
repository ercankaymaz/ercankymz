...
public readonly struct Matrix4x4Array : IAccessorArray<Matrix4x4>, IReadOnlyList<Matrix4x4>, IEnumerable<Matrix4x4>, IEnumerable, IReadOnlyCollection<Matrix4x4>, IList<Matrix4x4>, ICollection<Matrix4x4>
{
	...
	public Matrix4x4 this[int index]
	{
		get
		{
			...
			return new Matrix4x4(_Accessor[index, 0], _Accessor[index, 1], _Accessor[index, 2], _Accessor[index, 3], _Accessor[index, 4], _Accessor[index, 5], _Accessor[index, 6], _Accessor[index, 7], _Accessor[index, 8], _Accessor[index, 9], _Accessor[index, 10], _Accessor[index, 11], _Accessor[index, 12], _Accessor[index, 13], _Accessor[index, 14], _Accessor[index, 15]);
		}
		set
		{
