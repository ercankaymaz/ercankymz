...
public class marbleOperation : buSerilization
{
	...
	public double WaterJet5AxisARatioCornerAngle170 = 1.003;
	...
	public marbleOperation(marbleOperation data)
	{
		...
		CamParameters = new marbleCamParameters(data.CamParameters);
	}
	...
	{
		return "CutLength : " + CutLength + " , MaterialThickness : " + MaterialThickness;
	}
}
