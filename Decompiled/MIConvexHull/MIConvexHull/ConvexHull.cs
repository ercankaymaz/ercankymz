...
{
	public static ConvexHullCreationResult<TVertex, TFace> Create<TVertex, TFace>(IList<TVertex> data, double PlaneDistanceTolerance = 1E-10) where TVertex : IVertex where TFace : ConvexFace<TVertex, TFace>, new()
	{
		return ConvexHull<TVertex, TFace>.Create(data, PlaneDistanceTolerance);
	}

	public static ConvexHullCreationResult<TVertex, DefaultConvexFace<TVertex>> Create<TVertex>(IList<TVertex> data, double PlaneDistanceTolerance = 1E-10) where TVertex : IVertex
	{
		return ConvexHull<TVertex, DefaultConvexFace<TVertex>>.Create(data, PlaneDistanceTolerance);
	}

	public static ConvexHullCreationResult<DefaultVertex, DefaultConvexFace<DefaultVertex>> Create(IList<double[]> data, double PlaneDistanceTolerance = 1E-10)
	{
	...
	public static List<TVertex> Create<TVertex>(IList<TVertex> data) where TVertex : IVertex2D, new()
	{
		return ConvexHull2DAlgorithm.Create(data);
	}
}
public class ConvexHull<TVertex, TFace> where TVertex : IVertex where TFace : ConvexFace<TVertex, TFace>, new()
{
	...
	public static ConvexHullCreationResult<TVertex, TFace> Create(IList<TVertex> data, double PlaneDistanceTolerance)
	{
		...
		try
		{
			return new ConvexHullCreationResult<TVertex, TFace>(ConvexHullAlgorithm.GetConvexHull<TVertex, TFace>(data, PlaneDistanceTolerance), ConvexHullCreationResultOutcome.Success);
		}
