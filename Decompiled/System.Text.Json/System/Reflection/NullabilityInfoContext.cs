...
internal sealed class NullabilityInfoContext
{
	...
	private readonly struct NullableAttributeStateParser(object nullableAttributeArgument)
	{
		private static readonly object UnknownByte = (byte)0;

		private readonly object _nullableAttributeArgument = nullableAttributeArgument;
