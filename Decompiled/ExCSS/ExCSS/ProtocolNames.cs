...
public static class ProtocolNames
{
	...
	private static readonly string[] RelativeProtocols = new string[7] { Http, Https, Ftp, File, Ws, Wss, Gopher };

	private static readonly string[] OriginalableProtocols = new string[6] { Http, Https, Ftp, Ws, Wss, Gopher };
