...
public struct Short4 : IPixel<Short4>, IPixel, IEquatable<Short4>, IPackedVector<ulong>
{
	...
	public readonly Vector4 ToVector4()
	{
		...
		return new Vector4((float)(short)(PackedValue & 0xFFFF), (float)(short)((PackedValue >> 16) & 0xFFFF), (float)(short)((PackedValue >> 32) & 0xFFFF), (float)(short)((PackedValue >> 48) & 0xFFFF));
	}
	...
	public override readonly string ToString()
	{
		...
		return FormattableString.Invariant($"Short4({val.X:#0.##}, {val.Y:#0.##}, {val.Z:#0.##}, {val.W:#0.##})");
	}
