...
public struct Short2 : IPixel<Short2>, IPixel, IEquatable<Short2>, IPackedVector<uint>
{
	...
	public void FromScaledVector4(Vector4 vector)
	{
		...
		Vector2 val = new Vector2(vector.X, vector.Y) * 65534f;
		val -= new Vector2(32767f);
	...
	public readonly Vector4 ToVector4()
	{
		...
		return new Vector4((float)(short)(PackedValue & 0xFFFF), (float)(short)(PackedValue >> 16), 0f, 1f);
	}
	...
	public readonly Vector2 ToVector2()
	{
		...
		return new Vector2((float)(short)(PackedValue & 0xFFFF), (float)(short)(PackedValue >> 16));
	}
	...
	public override readonly string ToString()
	{
		...
		return FormattableString.Invariant($"Short2({val.X:#0.##}, {val.Y:#0.##})");
	}
