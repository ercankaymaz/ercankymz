...
public struct Rgba1010102 : IPixel<Rgba1010102>, IPixel, IEquatable<Rgba1010102>, IPackedVector<uint>
{
	...
	public readonly Vector4 ToVector4()
	{
		...
		return new Vector4((float)(PackedValue & 0x3FF), (float)((PackedValue >> 10) & 0x3FF), (float)((PackedValue >> 20) & 0x3FF), (float)((PackedValue >> 30) & 3)) / Multiplier;
	}
	...
	public override readonly string ToString()
	{
		...
		return FormattableString.Invariant($"Rgba1010102({val.X:#0.##}, {val.Y:#0.##}, {val.Z:#0.##}, {val.W:#0.##})");
	}
