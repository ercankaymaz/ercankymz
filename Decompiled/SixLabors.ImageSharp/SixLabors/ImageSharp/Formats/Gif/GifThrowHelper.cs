...
internal static class GifThrowHelper
{
	...
	{
		throw new InvalidImageContentException("Gif image does not contain a Logical Screen Descriptor.");
	}

	[DoesNotReturn]
	public static void ThrowNoData()
	{
		throw new InvalidImageContentException("Unable to read Gif image data");
	}
}
