	...
	public override void Decode(ReadOnlySpan<byte> data, Buffer2D<TPixel> pixels, int left, int top, int width, int height)
	{
		...
		for (nuint num2 = (uint)top; num2 < (uint)(top + height); num2++)
		{
			...
			for (nuint num3 = (uint)left; num3 < (uint)(left + width); num3 += 8)
			{
				...
				{
					int num4 = (b >> 7) & 1;
					Unsafe.Add(ref reference2, num3) = ((num4 == 0) ? val2 : val);
					num4 = (b >> 6) & 1;
					Unsafe.Add(ref reference2, num3 + 1) = ((num4 == 0) ? val2 : val);
					num4 = (b >> 5) & 1;
					Unsafe.Add(ref reference2, num3 + 2) = ((num4 == 0) ? val2 : val);
					num4 = (b >> 4) & 1;
					Unsafe.Add(ref reference2, num3 + 3) = ((num4 == 0) ? val2 : val);
					num4 = (b >> 3) & 1;
					Unsafe.Add(ref reference2, num3 + 4) = ((num4 == 0) ? val2 : val);
					num4 = (b >> 2) & 1;
					Unsafe.Add(ref reference2, num3 + 5) = ((num4 == 0) ? val2 : val);
					num4 = (b >> 1) & 1;
					Unsafe.Add(ref reference2, num3 + 6) = ((num4 == 0) ? val2 : val);
					num4 = b & 1;
					Unsafe.Add(ref reference2, num3 + 7) = ((num4 == 0) ? val2 : val);
				}
				else
				{
					for (nuint num5 = 0u; num5 < (nuint)uIntPtr; num5++)
					{
						...
						Unsafe.Add(ref reference2, num3 + num5) = ((num6 == 0) ? val2 : val);
					}
				}
			}
		}
