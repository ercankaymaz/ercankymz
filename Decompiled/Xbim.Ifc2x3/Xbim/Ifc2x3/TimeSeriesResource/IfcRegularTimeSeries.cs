...
public class IfcRegularTimeSeries : IfcTimeSeries, IIfcRegularTimeSeries, IIfcTimeSeries, IPersistEntity, IPersist, IfcMetricValueSelect, IIfcMetricValueSelect, IExpressSelectType, IfcObjectReferenceSelect, IIfcObjectReferenceSelect, IfcResourceObjectSelect, IIfcResourceObjectSelect, IInstantiableEntity, IContainsEntityReferences, IEquatable<IfcRegularTimeSeries>
{
	private Xbim.Ifc2x3.MeasureResource.IfcTimeMeasure _timeStep;
	...
	Xbim.Ifc4.MeasureResource.IfcTimeMeasure IIfcRegularTimeSeries.TimeStep
	{
		...
		set
		{
			TimeStep = new Xbim.Ifc2x3.MeasureResource.IfcTimeMeasure(value);
		}
	}
	...
	public Xbim.Ifc2x3.MeasureResource.IfcTimeMeasure TimeStep
	{
		get
		{
			if (_activated)
