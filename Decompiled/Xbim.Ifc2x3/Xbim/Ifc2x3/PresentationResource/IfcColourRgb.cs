...
public class IfcColourRgb : IfcColourSpecification, IIfcColourRgb, IIfcColourSpecification, IIfcPresentationItem, IPersistEntity, IPersist, Xbim.Ifc4.PresentationAppearanceResource.IfcColour, Xbim.Ifc4.PresentationAppearanceResource.IfcFillStyleSelect, IIfcFillStyleSelect, IExpressSelectType, IIfcColour, Xbim.Ifc4.PresentationAppearanceResource.IfcColourOrFactor, IIfcColourOrFactor, IInstantiableEntity, Xbim.Ifc2x3.PresentationAppearanceResource.IfcColourOrFactor, IEquatable<IfcColourRgb>
{
	private Xbim.Ifc2x3.MeasureResource.IfcNormalisedRatioMeasure _red;

	private Xbim.Ifc2x3.MeasureResource.IfcNormalisedRatioMeasure _green;

	private Xbim.Ifc2x3.MeasureResource.IfcNormalisedRatioMeasure _blue;
	...
	Xbim.Ifc4.MeasureResource.IfcNormalisedRatioMeasure IIfcColourRgb.Red
	{
		...
		set
		{
			Red = new Xbim.Ifc2x3.MeasureResource.IfcNormalisedRatioMeasure(value);
		}
	}
	...
	Xbim.Ifc4.MeasureResource.IfcNormalisedRatioMeasure IIfcColourRgb.Green
	{
		...
		set
		{
			Green = new Xbim.Ifc2x3.MeasureResource.IfcNormalisedRatioMeasure(value);
		}
	}
	...
	Xbim.Ifc4.MeasureResource.IfcNormalisedRatioMeasure IIfcColourRgb.Blue
	{
		...
		set
		{
			Blue = new Xbim.Ifc2x3.MeasureResource.IfcNormalisedRatioMeasure(value);
		}
	}

	[EntityAttribute(2, EntityAttributeState.Mandatory, EntityAttributeType.None, EntityAttributeType.None, null, null, 2)]
	public Xbim.Ifc2x3.MeasureResource.IfcNormalisedRatioMeasure Red
	{
		get
		{
			if (_activated)
	...
	public Xbim.Ifc2x3.MeasureResource.IfcNormalisedRatioMeasure Green
	{
		get
		{
			if (_activated)
	...
	public Xbim.Ifc2x3.MeasureResource.IfcNormalisedRatioMeasure Blue
	{
		get
		{
			if (_activated)
