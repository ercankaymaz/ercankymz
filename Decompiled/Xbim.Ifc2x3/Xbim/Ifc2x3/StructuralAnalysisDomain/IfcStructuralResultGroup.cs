...
public class IfcStructuralResultGroup : Xbim.Ifc2x3.Kernel.IfcGroup, IIfcStructuralResultGroup, IIfcGroup, IIfcObject, IIfcObjectDefinition, IIfcRoot, IPersistEntity, IPersist, IfcDefinitionSelect, IIfcDefinitionSelect, IExpressSelectType, IInstantiableEntity, IContainsEntityReferences, IContainsIndexedReferences, IEquatable<IfcStructuralResultGroup>
{
	...
	IfcBoolean IIfcStructuralResultGroup.IsLinear
	{
		get
		{
			return new IfcBoolean(IsLinear);
		}
		set
		{
			IsLinear = value;
