...
public abstract class IfcStructuralActivity : Xbim.Ifc2x3.Kernel.IfcProduct, IIfcStructuralActivity, IIfcProduct, IIfcObject, IIfcObjectDefinition, IIfcRoot, IPersistEntity, IPersist, IfcDefinitionSelect, IIfcDefinitionSelect, IExpressSelectType, IfcProductSelect, IIfcProductSelect, IEquatable<IfcStructuralActivity>
{
	private IfcStructuralLoad _appliedLoad;

	private Xbim.Ifc2x3.RepresentationResource.IfcGlobalOrLocalEnum _globalOrLocal;
	...
	Xbim.Ifc4.Interfaces.IfcGlobalOrLocalEnum IIfcStructuralActivity.GlobalOrLocal
	{
		get
		{
			...
			{
				Xbim.Ifc2x3.RepresentationResource.IfcGlobalOrLocalEnum.GLOBAL_COORDS => Xbim.Ifc4.Interfaces.IfcGlobalOrLocalEnum.GLOBAL_COORDS, 
				Xbim.Ifc2x3.RepresentationResource.IfcGlobalOrLocalEnum.LOCAL_COORDS => Xbim.Ifc4.Interfaces.IfcGlobalOrLocalEnum.LOCAL_COORDS, 
		...
		set
		{
			...
			case Xbim.Ifc4.Interfaces.IfcGlobalOrLocalEnum.GLOBAL_COORDS:
				GlobalOrLocal = Xbim.Ifc2x3.RepresentationResource.IfcGlobalOrLocalEnum.GLOBAL_COORDS;
				break;
			case Xbim.Ifc4.Interfaces.IfcGlobalOrLocalEnum.LOCAL_COORDS:
				GlobalOrLocal = Xbim.Ifc2x3.RepresentationResource.IfcGlobalOrLocalEnum.LOCAL_COORDS;
				break;
			default:
	...
	public Xbim.Ifc2x3.RepresentationResource.IfcGlobalOrLocalEnum GlobalOrLocal
	{
		get
		{
			if (_activated)
		...
		set
		{
			SetValue(delegate(Xbim.Ifc2x3.RepresentationResource.IfcGlobalOrLocalEnum v)
			{
				_globalOrLocal = v;
	...
	public IfcRelConnectsStructuralActivity AssignedToStructuralItem => base.Model.Instances.FirstOrDefault((IfcRelConnectsStructuralActivity e) => Equals(e.RelatedStructuralActivity), "RelatedStructuralActivity", this);
	...
	public override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
	{
		...
		case 7:
			...
			break;
		case 8:
			_globalOrLocal = (Xbim.Ifc2x3.RepresentationResource.IfcGlobalOrLocalEnum)Enum.Parse(typeof(Xbim.Ifc2x3.RepresentationResource.IfcGlobalOrLocalEnum), value.EnumVal, ignoreCase: true);
			break;
		default:
