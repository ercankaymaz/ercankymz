...
public class IfcLightSourcePositional : IfcLightSource, IIfcLightSourcePositional, IIfcLightSource, IIfcGeometricRepresentationItem, IIfcRepresentationItem, IPersistEntity, IPersist, Xbim.Ifc4.PresentationOrganizationResource.IfcLayeredItem, IIfcLayeredItem, IExpressSelectType, IInstantiableEntity, IContainsEntityReferences, IEquatable<IfcLightSourcePositional>
{
	...
	private Xbim.Ifc2x3.MeasureResource.IfcReal _constantAttenuation;

	private Xbim.Ifc2x3.MeasureResource.IfcReal _distanceAttenuation;

	private Xbim.Ifc2x3.MeasureResource.IfcReal _quadricAttenuation;
	...
	Xbim.Ifc4.MeasureResource.IfcReal IIfcLightSourcePositional.ConstantAttenuation
	{
		...
		set
		{
			ConstantAttenuation = new Xbim.Ifc2x3.MeasureResource.IfcReal(value);
		}
	}
	...
	Xbim.Ifc4.MeasureResource.IfcReal IIfcLightSourcePositional.DistanceAttenuation
	{
		...
		set
		{
			DistanceAttenuation = new Xbim.Ifc2x3.MeasureResource.IfcReal(value);
		}
	}
	...
	Xbim.Ifc4.MeasureResource.IfcReal IIfcLightSourcePositional.QuadricAttenuation
	{
		...
		set
		{
			QuadricAttenuation = new Xbim.Ifc2x3.MeasureResource.IfcReal(value);
		}
	}
	...
	public Xbim.Ifc2x3.MeasureResource.IfcReal ConstantAttenuation
	{
		get
		{
			if (_activated)
	...
	public Xbim.Ifc2x3.MeasureResource.IfcReal DistanceAttenuation
	{
		get
		{
			if (_activated)
	...
	public Xbim.Ifc2x3.MeasureResource.IfcReal QuadricAttenuation
	{
		get
		{
			if (_activated)
