...
public class IfcArbitraryOpenProfileDef : IfcProfileDef, IIfcArbitraryOpenProfileDef, IIfcProfileDef, IPersistEntity, IPersist, IfcResourceObjectSelect, IIfcResourceObjectSelect, IExpressSelectType, IInstantiableEntity, IContainsEntityReferences, IEquatable<IfcArbitraryOpenProfileDef>, IExpressValidatable
{
	...
	public bool ValidateClause(IfcArbitraryOpenProfileDefClause clause)
	{
		...
		try
		{
			...
			case IfcArbitraryOpenProfileDefClause.WR11:
				result = Functions.TYPEOF(this).Contains("IFC2X3.IFCCENTERLINEPROFILEDEF") || base.ProfileType == IfcProfileTypeEnum.CURVE;
				break;
