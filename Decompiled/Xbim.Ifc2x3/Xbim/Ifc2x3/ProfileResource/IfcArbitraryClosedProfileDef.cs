...
public class IfcArbitraryClosedProfileDef : IfcProfileDef, IIfcArbitraryClosedProfileDef, IIfcProfileDef, IPersistEntity, IPersist, IfcResourceObjectSelect, IIfcResourceObjectSelect, IExpressSelectType, IInstantiableEntity, IContainsEntityReferences, IEquatable<IfcArbitraryClosedProfileDef>, IExpressValidatable
{
	...
	public bool ValidateClause(IfcArbitraryClosedProfileDefClause clause)
	{
		...
		try
		{
			...
			case IfcArbitraryClosedProfileDefClause.WR2:
				result = !Functions.TYPEOF(OuterCurve).Contains("IFC2X3.IFCLINE");
				break;
			case IfcArbitraryClosedProfileDefClause.WR3:
				result = !Functions.TYPEOF(OuterCurve).Contains("IFC2X3.IFCOFFSETCURVE2D");
				break;
			}
		}
		catch (Exception ex)
