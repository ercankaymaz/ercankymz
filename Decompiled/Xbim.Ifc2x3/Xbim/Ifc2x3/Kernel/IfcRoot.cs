...
{
	private Xbim.Ifc2x3.UtilityResource.IfcGloballyUniqueId _globalId;

	private Xbim.Ifc2x3.UtilityResource.IfcOwnerHistory _ownerHistory;
	...
	Xbim.Ifc4.UtilityResource.IfcGloballyUniqueId IIfcRoot.GlobalId
	{
		...
		set
		{
			GlobalId = new Xbim.Ifc2x3.UtilityResource.IfcGloballyUniqueId(value);
		}
	}
	...
	IIfcOwnerHistory IIfcRoot.OwnerHistory
	{
		...
		set
		{
			OwnerHistory = value as Xbim.Ifc2x3.UtilityResource.IfcOwnerHistory;
		}
	}
	...
	public Xbim.Ifc2x3.UtilityResource.IfcGloballyUniqueId GlobalId
	{
		get
		{
			if (_activated)
		...
		set
		{
			SetValue(delegate(Xbim.Ifc2x3.UtilityResource.IfcGloballyUniqueId v)
			{
				_globalId = v;
	...
	public Xbim.Ifc2x3.UtilityResource.IfcOwnerHistory OwnerHistory
	{
		get
		{
			if (_activated)
		...
		set
		{
			...
			SetValue(delegate(Xbim.Ifc2x3.UtilityResource.IfcOwnerHistory v)
			{
				_ownerHistory = v;
	...
	public string FriendlyName
	{
		get
		{
			IfcRelDecomposes ifcRelDecomposes = this as IfcRelDecomposes;
			string text;
			if (ifcRelDecomposes != null)
			{
				text = ifcRelDecomposes.RelatingObject.FriendlyName;
			}
			else
			{
				Xbim.Ifc2x3.MeasureResource.IfcLabel? name = Name;
				text = (name.HasValue ? ((string)name.GetValueOrDefault()) : null);
			}
	...
	public override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
	{
		...
		case 0:
			...
			break;
		case 1:
			_ownerHistory = (Xbim.Ifc2x3.UtilityResource.IfcOwnerHistory)value.EntityVal;
			break;
		case 2:
