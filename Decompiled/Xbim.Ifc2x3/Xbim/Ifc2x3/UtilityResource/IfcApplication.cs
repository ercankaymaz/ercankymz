...
public class IfcApplication : PersistEntity, IIfcApplication, IPersistEntity, IPersist, IInstantiableEntity, IContainsEntityReferences, IEquatable<IfcApplication>
{
	...
	private Xbim.Ifc2x3.MeasureResource.IfcLabel _applicationFullName;

	private Xbim.Ifc2x3.MeasureResource.IfcIdentifier _applicationIdentifier;
	...
	Xbim.Ifc4.MeasureResource.IfcLabel IIfcApplication.Version
	{
		...
		set
		{
			Version = new Xbim.Ifc2x3.MeasureResource.IfcLabel(value);
		}
	}
	...
	Xbim.Ifc4.MeasureResource.IfcLabel IIfcApplication.ApplicationFullName
	{
		...
		set
		{
			ApplicationFullName = new Xbim.Ifc2x3.MeasureResource.IfcLabel(value);
		}
	}
	...
	Xbim.Ifc4.MeasureResource.IfcIdentifier IIfcApplication.ApplicationIdentifier
	{
		...
		set
		{
			ApplicationIdentifier = new Xbim.Ifc2x3.MeasureResource.IfcIdentifier(value);
		}
	}
	...
	public Xbim.Ifc2x3.MeasureResource.IfcLabel ApplicationFullName
	{
		get
		{
			if (_activated)
	...
	public Xbim.Ifc2x3.MeasureResource.IfcIdentifier ApplicationIdentifier
	{
		get
		{
			if (_activated)
