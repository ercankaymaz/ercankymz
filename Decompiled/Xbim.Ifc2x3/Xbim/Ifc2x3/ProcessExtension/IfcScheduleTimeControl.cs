...
public class IfcScheduleTimeControl : IfcControl, IInstantiableEntity, IPersistEntity, IPersist, IContainsEntityReferences, IEquatable<IfcScheduleTimeControl>
{
	...
	public IfcDateTimeSelect ActualStart
	{
		...
		set
		{
			...
			{
				_actualStart = v;
			}, _actualStart, value, "ActualStart", 6);
		}
	}
	...
	public IfcDateTimeSelect EarlyStart
	{
		...
		set
		{
			...
			{
				_earlyStart = v;
			}, _earlyStart, value, "EarlyStart", 7);
		}
	}
	...
	public IfcDateTimeSelect ScheduleStart
	{
		...
		set
		{
			...
			{
				_scheduleStart = v;
			}, _scheduleStart, value, "ScheduleStart", 9);
		}
	}
	...
	public IfcDateTimeSelect ActualFinish
	{
		...
		set
		{
			...
			{
				_actualFinish = v;
			}, _actualFinish, value, "ActualFinish", 10);
		}
	}
	...
	public IfcDateTimeSelect EarlyFinish
	{
		...
		set
		{
			...
			{
				_earlyFinish = v;
			}, _earlyFinish, value, "EarlyFinish", 11);
		}
	}
	...
	public IfcDateTimeSelect LateFinish
	{
		...
		set
		{
			...
			{
				_lateFinish = v;
			}, _lateFinish, value, "LateFinish", 12);
		}
	}
	...
	public IfcDateTimeSelect ScheduleFinish
	{
		...
		set
		{
			...
			{
				_scheduleFinish = v;
			}, _scheduleFinish, value, "ScheduleFinish", 13);
		}
	}
	...
	public IfcTimeMeasure? ScheduleDuration
	{
		...
		set
		{
			...
			{
				_scheduleDuration = v;
			}, _scheduleDuration, value, "ScheduleDuration", 14);
		}
	}
	...
	public IfcTimeMeasure? ActualDuration
	{
		...
		set
		{
			...
			{
				_actualDuration = v;
			}, _actualDuration, value, "ActualDuration", 15);
		}
	}
	...
	public IfcTimeMeasure? RemainingTime
	{
		...
		set
		{
			...
			{
				_remainingTime = v;
			}, _remainingTime, value, "RemainingTime", 16);
		}
	}
	...
	public IfcTimeMeasure? TotalFloat
	{
		...
		set
		{
			...
			{
				_totalFloat = v;
			}, _totalFloat, value, "TotalFloat", 18);
		}
	}
	...
	public bool? IsCritical
	{
		...
		set
		{
			...
			{
				_isCritical = v;
			}, _isCritical, value, "IsCritical", 19);
		}
	}
	...
	public IfcDateTimeSelect StatusTime
	{
		...
		set
		{
			...
			{
				_statusTime = v;
			}, _statusTime, value, "StatusTime", 20);
		}
	}
	...
	public IfcTimeMeasure? StartFloat
	{
		...
		set
		{
			...
			{
				_startFloat = v;
			}, _startFloat, value, "StartFloat", 21);
		}
	}
	...
	public IfcTimeMeasure? FinishFloat
	{
		...
		set
		{
			...
			{
				_finishFloat = v;
			}, _finishFloat, value, "FinishFloat", 22);
		}
	}
	...
	public IfcPositiveRatioMeasure? Completion
	{
		...
		set
		{
			...
			{
				_completion = v;
			}, _completion, value, "Completion", 23);
		}
	}
	...
	public IfcRelAssignsTasks ScheduleTimeControlAssigned => base.Model.Instances.FirstOrDefault((IfcRelAssignsTasks e) => Equals(e.TimeForTask), "TimeForTask", this);
	...
	internal IfcScheduleTimeControl(IModel model, int label, bool activated)
