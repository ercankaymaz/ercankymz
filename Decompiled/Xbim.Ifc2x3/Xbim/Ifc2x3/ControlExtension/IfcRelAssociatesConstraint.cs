...
{
	private Xbim.Ifc2x3.MeasureResource.IfcLabel _intent;
	...
	public Xbim.Ifc2x3.MeasureResource.IfcLabel Intent
	{
		get
		{
			if (_activated)
	...
	Xbim.Ifc4.MeasureResource.IfcLabel? IIfcRelAssociatesConstraint.Intent
	{
		get
		{
			return new Xbim.Ifc4.MeasureResource.IfcLabel(Intent);
		}
		set
		{
			Intent = (value.HasValue ? new Xbim.Ifc2x3.MeasureResource.IfcLabel(value.Value) : default(Xbim.Ifc2x3.MeasureResource.IfcLabel));
		}
	}
