...
public class IfcRepresentationContext : PersistEntity, IIfcRepresentationContext, IPersistEntity, IPersist, IInstantiableEntity, IEquatable<IfcRepresentationContext>
{
	private Xbim.Ifc2x3.MeasureResource.IfcLabel? _contextIdentifier;

	private Xbim.Ifc2x3.MeasureResource.IfcLabel? _contextType;
	...
	Xbim.Ifc4.MeasureResource.IfcLabel? IIfcRepresentationContext.ContextIdentifier
	{
		...
		set
		{
			ContextIdentifier = (value.HasValue ? new Xbim.Ifc2x3.MeasureResource.IfcLabel?(new Xbim.Ifc2x3.MeasureResource.IfcLabel(value.Value)) : ((Xbim.Ifc2x3.MeasureResource.IfcLabel?)null));
		}
	}
	...
	Xbim.Ifc4.MeasureResource.IfcLabel? IIfcRepresentationContext.ContextType
	{
		...
		set
		{
			ContextType = (value.HasValue ? new Xbim.Ifc2x3.MeasureResource.IfcLabel?(new Xbim.Ifc2x3.MeasureResource.IfcLabel(value.Value)) : ((Xbim.Ifc2x3.MeasureResource.IfcLabel?)null));
		}
	}
	...
	public Xbim.Ifc2x3.MeasureResource.IfcLabel? ContextIdentifier
	{
		get
		{
			if (_activated)
	...
	public Xbim.Ifc2x3.MeasureResource.IfcLabel? ContextType
	{
		get
		{
			if (_activated)
