...
public class IfcProductDefinitionShape : IfcProductRepresentation, IIfcProductDefinitionShape, IIfcProductRepresentation, IPersistEntity, IPersist, IfcProductRepresentationSelect, IIfcProductRepresentationSelect, IExpressSelectType, IInstantiableEntity, IContainsEntityReferences, IContainsIndexedReferences, IEquatable<IfcProductDefinitionShape>, IExpressValidatable
{
	...
	public bool ValidateClause(IfcProductDefinitionShapeClause clause)
	{
		...
		try
		{
			if (clause == IfcProductDefinitionShapeClause.WR11)
			{
				result = Functions.SIZEOF(Enumerable.Where(base.Representations, (IfcRepresentation temp) => !Functions.TYPEOF(temp).Contains("IFC2X3.IFCSHAPEMODEL"))) == 0;
			}
		}
		catch (Exception ex)
		{
	...
	public virtual IEnumerable<ValidationResult> Validate()
	{
		if (!ValidateClause(IfcProductDefinitionShapeClause.WR11))
		{
			...
			{
				Item = this,
				IssueSource = "IfcProductDefinitionShape.WR11",
