...
{
	private Xbim.Ifc2x3.MeasureResource.IfcCurvatureMeasure? _distortion;
	...
	Xbim.Ifc4.MeasureResource.IfcCurvatureMeasure? IIfcStructuralLoadSingleDisplacementDistortion.Distortion
	{
		...
		set
		{
			Distortion = (value.HasValue ? new Xbim.Ifc2x3.MeasureResource.IfcCurvatureMeasure?(new Xbim.Ifc2x3.MeasureResource.IfcCurvatureMeasure(value.Value)) : ((Xbim.Ifc2x3.MeasureResource.IfcCurvatureMeasure?)null));
		}
	}

	[EntityAttribute(8, EntityAttributeState.Optional, EntityAttributeType.None, EntityAttributeType.None, null, null, 8)]
	public Xbim.Ifc2x3.MeasureResource.IfcCurvatureMeasure? Distortion
	{
		get
		{
			if (_activated)
		...
		set
		{
			SetValue(delegate(Xbim.Ifc2x3.MeasureResource.IfcCurvatureMeasure? v)
			{
				_distortion = v;
