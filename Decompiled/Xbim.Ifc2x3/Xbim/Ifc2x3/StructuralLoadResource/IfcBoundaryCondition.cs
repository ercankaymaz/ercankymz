...
public abstract class IfcBoundaryCondition : PersistEntity, IIfcBoundaryCondition, IPersistEntity, IPersist, IEquatable<IfcBoundaryCondition>
{
	private Xbim.Ifc2x3.MeasureResource.IfcLabel? _name;

	[CrossSchemaAttribute(typeof(IIfcBoundaryCondition), 1)]
	Xbim.Ifc4.MeasureResource.IfcLabel? IIfcBoundaryCondition.Name
	{
		get
		{
			if (!Name.HasValue)
	...
	internal IfcBoundaryCondition(IModel model, int label, bool activated)
