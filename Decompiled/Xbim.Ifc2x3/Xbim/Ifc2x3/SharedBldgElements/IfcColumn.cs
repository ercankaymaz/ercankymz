...
public class IfcColumn : IfcBuildingElement, IIfcColumn, IIfcBuildingElement, IIfcElement, IIfcProduct, IIfcObject, IIfcObjectDefinition, IIfcRoot, IPersistEntity, IPersist, IfcDefinitionSelect, IIfcDefinitionSelect, IExpressSelectType, IfcProductSelect, IIfcProductSelect, IfcStructuralActivityAssignmentSelect, IIfcStructuralActivityAssignmentSelect, IInstantiableEntity, IContainsEntityReferences, IContainsIndexedReferences, IEquatable<IfcColumn>
{
	private Xbim.Ifc4.Interfaces.IfcColumnTypeEnum? _predefinedType;
	...
	Xbim.Ifc4.Interfaces.IfcColumnTypeEnum? IIfcColumn.PredefinedType
	{
		...
		set
		{
			SetValue(delegate(Xbim.Ifc4.Interfaces.IfcColumnTypeEnum? v)
			{
				_predefinedType = v;
