...
public class IfcElementAssembly : IfcElement, IIfcElementAssembly, IIfcElement, IIfcProduct, IIfcObject, IIfcObjectDefinition, IIfcRoot, IPersistEntity, IPersist, IfcDefinitionSelect, IIfcDefinitionSelect, IExpressSelectType, IfcProductSelect, IIfcProductSelect, IfcStructuralActivityAssignmentSelect, IIfcStructuralActivityAssignmentSelect, IInstantiableEntity, IContainsEntityReferences, IContainsIndexedReferences, IEquatable<IfcElementAssembly>, IExpressValidatable
{
	...
	public bool ValidateClause(IfcElementAssemblyClause clause)
	{
		...
		try
		{
			if (clause == IfcElementAssemblyClause.WR1)
			{
				result = PredefinedType != IfcElementAssemblyTypeEnum.USERDEFINED || (PredefinedType == IfcElementAssemblyTypeEnum.USERDEFINED && Functions.EXISTS(base.ObjectType));
			}
		}
		catch (Exception ex)
		{
	...
	public override IEnumerable<ValidationResult> Validate()
	{
		...
		if (!ValidateClause(IfcElementAssemblyClause.WR1))
		{
			...
			{
				Item = this,
				IssueSource = "IfcElementAssembly.WR1",
