...
public class IfcElementQuantity : Xbim.Ifc2x3.Kernel.IfcPropertySetDefinition, IIfcElementQuantity, IIfcQuantitySet, IIfcPropertySetDefinition, IIfcPropertyDefinition, IIfcRoot, IPersistEntity, IPersist, IfcDefinitionSelect, IIfcDefinitionSelect, IExpressSelectType, IfcPropertySetDefinitionSelect, IIfcPropertySetDefinitionSelect, IInstantiableEntity, IContainsEntityReferences, IEquatable<IfcElementQuantity>
{
	private Xbim.Ifc2x3.MeasureResource.IfcLabel? _methodOfMeasurement;
	...
	Xbim.Ifc4.MeasureResource.IfcLabel? IIfcElementQuantity.MethodOfMeasurement
	{
		...
		set
		{
			MethodOfMeasurement = (value.HasValue ? new Xbim.Ifc2x3.MeasureResource.IfcLabel?(new Xbim.Ifc2x3.MeasureResource.IfcLabel(value.Value)) : ((Xbim.Ifc2x3.MeasureResource.IfcLabel?)null));
		}
	}
	...
	public Xbim.Ifc2x3.MeasureResource.IfcLabel? MethodOfMeasurement
	{
		get
		{
			if (_activated)
