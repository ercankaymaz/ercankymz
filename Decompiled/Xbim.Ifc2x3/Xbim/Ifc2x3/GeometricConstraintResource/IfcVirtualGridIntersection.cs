...
public class IfcVirtualGridIntersection : PersistEntity, IInstantiableEntity, IPersistEntity, IPersist, IContainsEntityReferences, IContainsIndexedReferences, IEquatable<IfcVirtualGridIntersection>, IIfcVirtualGridIntersection, IfcGridPlacementDirectionSelect, IIfcGridPlacementDirectionSelect, IExpressSelectType
{
	private readonly ItemSet<IfcGridAxis> _intersectingAxes;

	private readonly ItemSet<Xbim.Ifc2x3.MeasureResource.IfcLengthMeasure> _offsetDistances;
	...
	public IItemSet<Xbim.Ifc2x3.MeasureResource.IfcLengthMeasure> OffsetDistances
	{
		get
		{
			if (_activated)
	...
	IItemSet<Xbim.Ifc4.MeasureResource.IfcLengthMeasure> IIfcVirtualGridIntersection.OffsetDistances => new ProxyValueSet<Xbim.Ifc2x3.MeasureResource.IfcLengthMeasure, Xbim.Ifc4.MeasureResource.IfcLengthMeasure>(OffsetDistances, (Xbim.Ifc2x3.MeasureResource.IfcLengthMeasure s) => new Xbim.Ifc4.MeasureResource.IfcLengthMeasure(s), (Xbim.Ifc4.MeasureResource.IfcLengthMeasure t) => new Xbim.Ifc2x3.MeasureResource.IfcLengthMeasure(t));
		...
		: base(model, label, activated)
	{
		...
		_offsetDistances = new ItemSet<Xbim.Ifc2x3.MeasureResource.IfcLengthMeasure>(this, 3, 2);
	}
