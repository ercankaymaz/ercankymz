...
public class IfcCartesianTransformationOperator2DnonUniform : IfcCartesianTransformationOperator2D, IInstantiableEntity, IPersistEntity, IPersist, IContainsEntityReferences, IEquatable<IfcCartesianTransformationOperator2DnonUniform>, IIfcCartesianTransformationOperator2DnonUniform, IIfcCartesianTransformationOperator2D, IIfcCartesianTransformationOperator, IIfcGeometricRepresentationItem, IIfcRepresentationItem, IfcLayeredItem, IIfcLayeredItem, IExpressSelectType, IExpressValidatable
{
	...
	IfcReal IIfcCartesianTransformationOperator2DnonUniform.Scl2 => new IfcReal(Scl2);
	...
	public bool ValidateClause(IfcCartesianTransformationOperator2DnonUniformClause clause)
	{
		...
		try
		{
			if (clause == IfcCartesianTransformationOperator2DnonUniformClause.WR1)
			{
				result = Scl2 > 0.0;
			}
		}
	...
	public override IEnumerable<ValidationResult> Validate()
	{
		...
		if (!ValidateClause(IfcCartesianTransformationOperator2DnonUniformClause.WR1))
		{
			...
			{
				Item = this,
				IssueSource = "IfcCartesianTransformationOperator2DnonUniform.WR1",
