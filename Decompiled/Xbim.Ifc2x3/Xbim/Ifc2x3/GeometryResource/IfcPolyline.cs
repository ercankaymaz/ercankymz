...
public class IfcPolyline : IfcBoundedCurve, IInstantiableEntity, IPersistEntity, IPersist, IContainsEntityReferences, IEquatable<IfcPolyline>, IIfcPolyline, IIfcBoundedCurve, IIfcCurve, IIfcGeometricRepresentationItem, IIfcRepresentationItem, IfcLayeredItem, IIfcLayeredItem, IExpressSelectType, IfcGeometricSetSelect, IIfcGeometricSetSelect, IfcCurveOrEdgeCurve, IIfcCurveOrEdgeCurve, IExpressValidatable
{
	...
	public bool ValidateClause(IfcPolylineClause clause)
	{
		...
		try
		{
			if (clause == IfcPolylineClause.WR41)
			{
