...
public class IfcVector : IfcGeometricRepresentationItem, IInstantiableEntity, IPersistEntity, IPersist, IfcVectorOrDirection, IExpressSelectType, IIfcVectorOrDirection, IContainsEntityReferences, IEquatable<IfcVector>, IIfcVector, IIfcGeometricRepresentationItem, IIfcRepresentationItem, IfcLayeredItem, IIfcLayeredItem, IfcHatchLineDistanceSelect, IIfcHatchLineDistanceSelect, Xbim.Ifc4.GeometryResource.IfcVectorOrDirection, IExpressValidatable
{
	...
	private Xbim.Ifc2x3.MeasureResource.IfcLengthMeasure _magnitude;
	...
	public Xbim.Ifc2x3.MeasureResource.IfcLengthMeasure Magnitude
	{
		get
		{
			if (_activated)
	...
	Xbim.Ifc4.MeasureResource.IfcLengthMeasure IIfcVector.Magnitude
	{
		...
		set
		{
			Magnitude = new Xbim.Ifc2x3.MeasureResource.IfcLengthMeasure(value);
		}
	}
