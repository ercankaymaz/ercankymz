...
public abstract class IfcCsgPrimitive3D : Xbim.Ifc2x3.GeometryResource.IfcGeometricRepresentationItem, IfcBooleanOperand, IExpressSelectType, IPersist, IPersistEntity, IIfcBooleanOperand, IfcCsgSelect, IIfcCsgSelect, IEquatable<IfcCsgPrimitive3D>, IIfcCsgPrimitive3D, IIfcGeometricRepresentationItem, IIfcRepresentationItem, IfcLayeredItem, IIfcLayeredItem, Xbim.Ifc4.GeometricModelResource.IfcBooleanOperand, Xbim.Ifc4.GeometricModelResource.IfcCsgSelect
{
	...
	public Xbim.Ifc2x3.GeometryResource.IfcAxis2Placement3D Position
	{
		...
		set
		{
			...
			SetValue(delegate(Xbim.Ifc2x3.GeometryResource.IfcAxis2Placement3D v)
			{
				_position = v;
	...
	IIfcAxis2Placement3D IIfcCsgPrimitive3D.Position
	{
		...
		set
		{
			Position = value as Xbim.Ifc2x3.GeometryResource.IfcAxis2Placement3D;
		}
	}
	...
	public override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
	{
		if (propIndex == 0)
		{
			_position = (Xbim.Ifc2x3.GeometryResource.IfcAxis2Placement3D)value.EntityVal;
			return;
		}
