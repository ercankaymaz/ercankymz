...
public class IfcSweptDiskSolid : IfcSolidModel, IInstantiableEntity, IPersistEntity, IPersist, IContainsEntityReferences, IEquatable<IfcSweptDiskSolid>, IIfcSweptDiskSolid, IIfcSolidModel, IIfcGeometricRepresentationItem, IIfcRepresentationItem, IfcLayeredItem, IIfcLayeredItem, IExpressSelectType, Xbim.Ifc4.GeometricModelResource.IfcBooleanOperand, IIfcBooleanOperand, IfcSolidOrShell, IIfcSolidOrShell, IExpressValidatable
{
	...
	private Xbim.Ifc2x3.MeasureResource.IfcPositiveLengthMeasure? _innerRadius;
	...
	public Xbim.Ifc2x3.MeasureResource.IfcPositiveLengthMeasure? InnerRadius
	{
		get
		{
			if (_activated)
	...
	Xbim.Ifc4.MeasureResource.IfcPositiveLengthMeasure? IIfcSweptDiskSolid.InnerRadius
	{
		...
		set
		{
			InnerRadius = (value.HasValue ? new Xbim.Ifc2x3.MeasureResource.IfcPositiveLengthMeasure?(new Xbim.Ifc2x3.MeasureResource.IfcPositiveLengthMeasure(value.Value)) : ((Xbim.Ifc2x3.MeasureResource.IfcPositiveLengthMeasure?)null));
		}
	}
	...
	public virtual IEnumerable<ValidationResult> Validate()
	{
		if (!ValidateClause(IfcSweptDiskSolidClause.WR1))
		{
			...
			{
				Item = this,
				IssueSource = "IfcSweptDiskSolid.WR1",
		...
		if (!ValidateClause(IfcSweptDiskSolidClause.WR2))
		{
			...
			{
				Item = this,
				IssueSource = "IfcSweptDiskSolid.WR2",
				IssueType = ValidationFlags.EntityWhereClauses
			};
		}
	}
