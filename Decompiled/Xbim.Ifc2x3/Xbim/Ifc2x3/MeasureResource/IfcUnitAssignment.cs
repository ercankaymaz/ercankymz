...
public class IfcUnitAssignment : PersistEntity, IIfcUnitAssignment, IPersistEntity, IPersist, IInstantiableEntity, IContainsEntityReferences, IEquatable<IfcUnitAssignment>, IExpressValidatable
{
	...
	public IfcNamedUnit AreaUnit
	{
		get
		{
			IfcNamedUnit ifcNamedUnit = Units.OfType<IfcSIUnit>().FirstOrDefault((IfcSIUnit u) => u.UnitType == IfcUnitEnum.AREAUNIT);
			if (ifcNamedUnit == null)
			{
				ifcNamedUnit = Units.OfType<IfcConversionBasedUnit>().FirstOrDefault((IfcConversionBasedUnit u) => u.UnitType == IfcUnitEnum.AREAUNIT);
			}
			return ifcNamedUnit;
		}
	}
	...
	public IfcNamedUnit LengthUnit
	{
		get
		{
			IfcNamedUnit ifcNamedUnit = Units.OfType<IfcSIUnit>().FirstOrDefault((IfcSIUnit u) => u.UnitType == IfcUnitEnum.LENGTHUNIT);
			if (ifcNamedUnit == null)
			{
				ifcNamedUnit = Units.OfType<IfcConversionBasedUnit>().FirstOrDefault((IfcConversionBasedUnit u) => u.UnitType == IfcUnitEnum.LENGTHUNIT);
			}
			return ifcNamedUnit;
		}
	}
	...
	public IfcNamedUnit VolumeUnit
	{
		get
		{
			IfcNamedUnit ifcNamedUnit = Units.OfType<IfcSIUnit>().FirstOrDefault((IfcSIUnit u) => u.UnitType == IfcUnitEnum.VOLUMEUNIT);
			if (ifcNamedUnit == null)
			{
				ifcNamedUnit = Units.OfType<IfcConversionBasedUnit>().FirstOrDefault((IfcConversionBasedUnit u) => u.UnitType == IfcUnitEnum.VOLUMEUNIT);
			}
			return ifcNamedUnit;
		}
	}
	...
	public IfcNamedUnit GetUnitFor(IfcPropertySingleValue property)
	{
		...
		IfcNamedUnit ifcNamedUnit = Units.OfType<IfcSIUnit>().FirstOrDefault((IfcSIUnit u) => u.UnitType == requiredUnit.Value);
		if (ifcNamedUnit == null)
		{
			ifcNamedUnit = Units.OfType<IfcConversionBasedUnit>().FirstOrDefault((IfcConversionBasedUnit u) => u.UnitType == requiredUnit.Value);
		}
		return ifcNamedUnit;
	}
	...
	public bool ValidateClause(IfcUnitAssignmentClause clause)
	{
		...
		try
		{
			if (clause == IfcUnitAssignmentClause.WR01)
			{
				result = Functions.IfcCorrectUnitAssignment(Units);
			}
		}
		catch (Exception ex)
		{
			ValidationLogging.CreateLogger<IfcUnitAssignment>()?.LogError($"Exception thrown evaluating where-clause 'IfcUnitAssignment.{clause}' for #{base.EntityLabel}.", ex);
		}
		return result;
	}
	...
	public virtual IEnumerable<ValidationResult> Validate()
	{
		if (!ValidateClause(IfcUnitAssignmentClause.WR01))
		{
			...
			{
				Item = this,
				IssueSource = "IfcUnitAssignment.WR01",
