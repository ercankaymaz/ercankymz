...
public struct IfcIntegerCountRateMeasure : IfcDerivedMeasureValue, IfcValue, IExpressSelectType, IPersist, IExpressValueType, IExpressIntegerType, IEquatable<long>
{
	private long _value;
