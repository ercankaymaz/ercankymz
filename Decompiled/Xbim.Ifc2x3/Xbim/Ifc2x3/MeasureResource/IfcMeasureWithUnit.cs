...
public class IfcMeasureWithUnit : PersistEntity, IIfcMeasureWithUnit, IPersistEntity, IPersist, Xbim.Ifc4.CostResource.IfcAppliedValueSelect, IIfcAppliedValueSelect, IExpressSelectType, Xbim.Ifc4.ConstraintResource.IfcMetricValueSelect, IIfcMetricValueSelect, IInstantiableEntity, Xbim.Ifc2x3.CostResource.IfcAppliedValueSelect, IfcConditionCriterionSelect, Xbim.Ifc2x3.ConstraintResource.IfcMetricValueSelect, IContainsEntityReferences, IEquatable<IfcMeasureWithUnit>
{
	...
	IIfcValue IIfcMeasureWithUnit.ValueComponent
	{
		get
		{
			...
			{
				return new Xbim.Ifc4.MeasureResource.IfcCountMeasure((IfcCountMeasure)(object)ValueComponent);
			}
			...
			{
				return new Xbim.Ifc4.DateTimeResource.IfcTimeStamp((IfcTimeStamp)(object)ValueComponent);
			}
		...
		set
		{
			...
			else if (value is IfcAreaDensityMeasure)
			{
				...
				{
					_valueComponent4 = v;
				}, _valueComponent4, value, "ValueComponent", -1);
			}
			...
			{
				ValueComponent = new IfcSoundPowerMeasure((IfcSoundPowerLevelMeasure)(object)value);
				if (_valueComponent4 != null)
				{
					SetValue(delegate(IIfcValue v)
					{
			...
			{
				ValueComponent = new IfcSoundPressureMeasure((IfcSoundPressureLevelMeasure)(object)value);
				if (_valueComponent4 != null)
				{
					SetValue(delegate(IIfcValue v)
					{
			...
			else
			{
				...
				ValueComponent = new IfcTimeStamp((Xbim.Ifc4.DateTimeResource.IfcTimeStamp)(object)value);
				if (_valueComponent4 != null)
				{
					SetValue(delegate(IIfcValue v)
					{
