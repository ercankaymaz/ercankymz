...
public class IfcSurfaceStyleRefraction : PersistEntity, IIfcSurfaceStyleRefraction, IIfcPresentationItem, IPersistEntity, IPersist, Xbim.Ifc4.PresentationAppearanceResource.IfcSurfaceStyleElementSelect, IIfcSurfaceStyleElementSelect, IExpressSelectType, IInstantiableEntity, IfcSurfaceStyleElementSelect, IEquatable<IfcSurfaceStyleRefraction>
{
	private Xbim.Ifc2x3.MeasureResource.IfcReal? _refractionIndex;

	private Xbim.Ifc2x3.MeasureResource.IfcReal? _dispersionFactor;
	...
	Xbim.Ifc4.MeasureResource.IfcReal? IIfcSurfaceStyleRefraction.RefractionIndex
	{
		...
		set
		{
			RefractionIndex = (value.HasValue ? new Xbim.Ifc2x3.MeasureResource.IfcReal?(new Xbim.Ifc2x3.MeasureResource.IfcReal(value.Value)) : ((Xbim.Ifc2x3.MeasureResource.IfcReal?)null));
		}
	}
	...
	Xbim.Ifc4.MeasureResource.IfcReal? IIfcSurfaceStyleRefraction.DispersionFactor
	{
		...
		set
		{
			DispersionFactor = (value.HasValue ? new Xbim.Ifc2x3.MeasureResource.IfcReal?(new Xbim.Ifc2x3.MeasureResource.IfcReal(value.Value)) : ((Xbim.Ifc2x3.MeasureResource.IfcReal?)null));
		}
	}

	[EntityAttribute(1, EntityAttributeState.Optional, EntityAttributeType.None, EntityAttributeType.None, null, null, 1)]
	public Xbim.Ifc2x3.MeasureResource.IfcReal? RefractionIndex
	{
		get
		{
			if (_activated)
	...
	public Xbim.Ifc2x3.MeasureResource.IfcReal? DispersionFactor
	{
		get
		{
			if (_activated)
