...
public class AllPalettes
{
	...
	private static uint[] CreateLightPalette()
	{
		...
		{
			ODPALENTRY(byte.MaxValue, byte.MaxValue, byte.MaxValue),
			ODPALENTRY(byte.MaxValue, 0, 0),
			ODPALENTRY(byte.MaxValue, byte.MaxValue, 0),
			ODPALENTRY(0, byte.MaxValue, 0),
			ODPALENTRY(0, byte.MaxValue, byte.MaxValue),
			ODPALENTRY(0, 0, byte.MaxValue),
			ODPALENTRY(byte.MaxValue, 0, byte.MaxValue),
			ODPALENTRY(0, 0, 0),
			ODPALENTRY(128, 128, 128),
			ODPALENTRY(192, 192, 192),
			ODPALENTRY(byte.MaxValue, 0, 0),
			ODPALENTRY(byte.MaxValue, 127, 127),
			ODPALENTRY(165, 0, 0),
			...
			ODPALENTRY(38, 0, 0),
			ODPALENTRY(38, 19, 19),
			ODPALENTRY(byte.MaxValue, 63, 0),
			ODPALENTRY(byte.MaxValue, 159, 127),
			ODPALENTRY(165, 41, 0),
			...
			ODPALENTRY(38, 9, 0),
			ODPALENTRY(38, 23, 19),
			ODPALENTRY(byte.MaxValue, 127, 0),
			ODPALENTRY(byte.MaxValue, 191, 127),
			ODPALENTRY(165, 82, 0),
			...
			ODPALENTRY(38, 19, 0),
			ODPALENTRY(38, 28, 19),
			ODPALENTRY(byte.MaxValue, 191, 0),
			ODPALENTRY(byte.MaxValue, 223, 127),
			...
			ODPALENTRY(38, 33, 19),
			ODPALENTRY(byte.MaxValue, byte.MaxValue, 0),
			ODPALENTRY(byte.MaxValue, byte.MaxValue, 127),
			...
			ODPALENTRY(38, 38, 0),
			ODPALENTRY(38, 38, 19),
			ODPALENTRY(191, byte.MaxValue, 0),
			ODPALENTRY(223, byte.MaxValue, 127),
			...
			ODPALENTRY(28, 38, 0),
			ODPALENTRY(33, 38, 19),
			ODPALENTRY(127, byte.MaxValue, 0),
			ODPALENTRY(191, byte.MaxValue, 127),
			ODPALENTRY(82, 165, 0),
			...
			ODPALENTRY(19, 38, 0),
			ODPALENTRY(28, 38, 19),
			ODPALENTRY(63, byte.MaxValue, 0),
			ODPALENTRY(159, byte.MaxValue, 127),
			ODPALENTRY(41, 165, 0),
			...
			ODPALENTRY(23, 38, 19),
			ODPALENTRY(0, byte.MaxValue, 0),
			ODPALENTRY(127, byte.MaxValue, 127),
			ODPALENTRY(0, 165, 0),
			...
			ODPALENTRY(0, 38, 0),
			ODPALENTRY(19, 38, 19),
			ODPALENTRY(0, byte.MaxValue, 63),
			ODPALENTRY(127, byte.MaxValue, 159),
			ODPALENTRY(0, 165, 41),
			...
			ODPALENTRY(0, 38, 9),
			ODPALENTRY(19, 38, 23),
			ODPALENTRY(0, byte.MaxValue, 127),
			ODPALENTRY(127, byte.MaxValue, 191),
			ODPALENTRY(0, 165, 82),
			...
			ODPALENTRY(0, 38, 19),
			ODPALENTRY(19, 38, 28),
			ODPALENTRY(0, byte.MaxValue, 191),
			ODPALENTRY(127, byte.MaxValue, 223),
			...
			ODPALENTRY(19, 38, 33),
			ODPALENTRY(0, byte.MaxValue, byte.MaxValue),
			ODPALENTRY(127, byte.MaxValue, byte.MaxValue),
			...
			ODPALENTRY(0, 38, 38),
			ODPALENTRY(19, 38, 38),
			ODPALENTRY(0, 191, byte.MaxValue),
			ODPALENTRY(127, 223, byte.MaxValue),
			...
			ODPALENTRY(0, 28, 38),
			ODPALENTRY(19, 33, 38),
			ODPALENTRY(0, 127, byte.MaxValue),
			ODPALENTRY(127, 191, byte.MaxValue),
			ODPALENTRY(0, 82, 165),
			...
			ODPALENTRY(0, 19, 38),
			ODPALENTRY(19, 28, 38),
			ODPALENTRY(0, 63, byte.MaxValue),
			ODPALENTRY(127, 159, byte.MaxValue),
			ODPALENTRY(0, 41, 165),
			...
			ODPALENTRY(19, 23, 38),
			ODPALENTRY(0, 0, byte.MaxValue),
			ODPALENTRY(127, 127, byte.MaxValue),
			ODPALENTRY(0, 0, 165),
			...
			ODPALENTRY(0, 0, 38),
			ODPALENTRY(19, 19, 38),
			ODPALENTRY(63, 0, byte.MaxValue),
			ODPALENTRY(159, 127, byte.MaxValue),
			ODPALENTRY(41, 0, 165),
			...
			ODPALENTRY(9, 0, 38),
			ODPALENTRY(23, 19, 38),
			ODPALENTRY(127, 0, byte.MaxValue),
			ODPALENTRY(191, 127, byte.MaxValue),
			ODPALENTRY(82, 0, 165),
			...
			ODPALENTRY(19, 0, 38),
			ODPALENTRY(28, 19, 38),
			ODPALENTRY(191, 0, byte.MaxValue),
			ODPALENTRY(223, 127, byte.MaxValue),
			...
			ODPALENTRY(33, 19, 38),
			ODPALENTRY(byte.MaxValue, 0, byte.MaxValue),
			ODPALENTRY(byte.MaxValue, 127, byte.MaxValue),
			...
			ODPALENTRY(38, 0, 38),
			ODPALENTRY(38, 19, 38),
			ODPALENTRY(byte.MaxValue, 0, 191),
			ODPALENTRY(byte.MaxValue, 127, 223),
			...
			ODPALENTRY(38, 0, 28),
			ODPALENTRY(38, 19, 33),
			ODPALENTRY(byte.MaxValue, 0, 127),
			ODPALENTRY(byte.MaxValue, 127, 191),
			ODPALENTRY(165, 0, 82),
			...
			ODPALENTRY(38, 0, 19),
			ODPALENTRY(38, 19, 28),
			ODPALENTRY(byte.MaxValue, 0, 63),
			ODPALENTRY(byte.MaxValue, 127, 159),
			ODPALENTRY(165, 0, 41),
