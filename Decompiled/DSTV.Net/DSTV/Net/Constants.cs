...
internal static class Constants
{
	...
	internal const string UnexpectedCharacterExceptionMessage = "Expected character '{1}' at lineNumber {0}, but retrieved character '{2}' instead.";

	internal const string UnexpectedEndExceptionMessage = "Unexpected end encountered. The file should end with 'EN'";
