...
internal class DynamicReflectionDelegateFactory : ReflectionDelegateFactory
{
	...
	private void GenerateCreateDefaultConstructorIL([DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors | DynamicallyAccessedMemberTypes.NonPublicConstructors)] Type type, ILGenerator generator, Type delegateType)
	{
		if (type.IsValueType())
		{
