...
{
	public ulong HeaderSize { get; set; } = 112uL;
	...
	public ulong Unknow0x20 { get; set; } = 32uL;

	public ulong Unknow0x40 { get; set; } = 64uL;

	public ulong PagesMapCrcUncompressed { get; set; }

	public ulong Unknown0xF800 { get; set; } = 63488uL;

	public ulong Unknown4 { get; set; } = 4uL;

	public ulong Unknown1 { get; set; } = 1uL;
	...
	public ulong StreamVersion { get; set; } = 393472uL;
