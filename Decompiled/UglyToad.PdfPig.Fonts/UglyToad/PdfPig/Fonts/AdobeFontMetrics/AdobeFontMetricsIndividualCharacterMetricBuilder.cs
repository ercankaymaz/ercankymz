...
internal class AdobeFontMetricsIndividualCharacterMetricBuilder
{
	...
	{
		return new AdobeFontMetricsIndividualCharacterMetric(CharacterCode, Name, new AdobeFontMetricsVector(WidthX, WidthY), new AdobeFontMetricsVector(WidthXDirection0, WidthYDirection0), new AdobeFontMetricsVector(WidthXDirection1, WidthYDirection1), VVector, BoundingBox, Ligature);
	}
}
