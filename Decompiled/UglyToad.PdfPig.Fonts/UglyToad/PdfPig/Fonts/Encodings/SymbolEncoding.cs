...
{
	private static readonly (int, string)[] EncodingTable = new(int, string)[189]
	{
		(65, "Alpha"),
		(66, "Beta"),
		(67, "Chi"),
	...
	private static readonly (int, int)[] UnicodeEquivilants = new(int, int)[1] { (913, 65) };
