...
public class buClipper : buClipperBase
{
	...
	internal List<Class154> list_3;

	internal List<Class154> list_4;
	...
	public buClipper(int InitOptions = 0)
	{
		...
		bool_3 = false;
		bool_4 = false;
		list_1 = new List<Class152>();
		list_3 = new List<Class154>();
		list_4 = new List<Class154>();
		...
		if (!bool_3)
		{
			if (!bool_1)
			{
				...
				try
				{
					if (result = method_0())
					{
						Class156.smethod_118(this, solution);
					}
				}
				finally
				{
					Class156.smethod_133(this);
					bool_3 = false;
				}
				return result;
			}
	...
	public bool Execute(ClipType clipType, PolyTree polytree, PolyFillType subjFillType, PolyFillType clipFillType)
	{
		if (!bool_3)
		{
			...
			try
			{
				if (result = method_0())
				{
					Class156.smethod_145(polytree, this);
				}
			}
			finally
			{
	...
	private bool method_0()
	{
		try
		{
			...
			if (Class156.smethod_54((buClipperBase)this, ref long_))
			{
				Class156.smethod_159(this, long_);
				long long_2 = default(long);
				while (Class156.smethod_54((buClipperBase)this, ref long_2) || Class156.smethod_17((buClipperBase)this))
				{
					Class156.smethod_163(this);
					list_4.Clear();
					if (Class156.smethod_203(long_2, this))
					{
						Class156.smethod_95(this, long_2);
						long_ = long_2;
						Class156.smethod_159(this, long_);
						continue;
					}
				...
				foreach (Class152 item in list_1)
				{
					if (item.class153_0 != null && !item.bool_1 && (item.bool_0 ^ ReverseSolution) == Class156.smethod_142(this, item) > 0.0)
					{
						Class156.smethod_242(item.class153_0, this);
					}
				}
				Class156.smethod_60(this);
				foreach (Class152 item2 in list_1)
				{
					if (item2.class153_0 != null)
					{
						if (!item2.bool_1)
						{
							Class156.smethod_90(this, item2);
						}
						else
						{
							Class156.smethod_2(this, item2);
						}
					}
				}
				if (StrictlySimple)
				{
					Class156.smethod_155(this);
				}
				return true;
			}
			return false;
	...
	internal void method_1(Class152 class152_0, Class152 class152_1)
	{
		foreach (Class152 item in list_1)
		{
			Class152 @class = Class156.smethod_281(item.class152_0);
			if (item.class153_0 != null && @class == class152_0 && Class156.smethod_167(item.class153_0, class152_1.class153_0))
			{
				item.class152_0 = class152_1;
			}
		}
	}

	internal void method_2(Class152 class152_0, Class152 class152_1)
	{
		Class152 class152_2 = class152_1.class152_0;
		foreach (Class152 item in list_1)
		{
			if (item.class153_0 == null || item == class152_1 || item == class152_0)
			{
				continue;
			}
			Class152 @class = Class156.smethod_281(item.class152_0);
			if (@class != class152_2 && @class != class152_0 && @class != class152_1)
			{
				continue;
			}
			if (!Class156.smethod_167(item.class153_0, class152_0.class153_0))
			{
				if (!Class156.smethod_167(item.class153_0, class152_1.class153_0))
				{
					if (item.class152_0 == class152_0 || item.class152_0 == class152_1)
					{
						item.class152_0 = class152_2;
					}
				}
				else
				{
			...
			{
				item.class152_0 = class152_0;
			}
		}
	}

	internal void method_3(Class152 class152_0, Class152 class152_1)
	{
		foreach (Class152 item in list_1)
		{
			Class152 @class = Class156.smethod_281(item.class152_0);
			if (item.class153_0 != null && @class == class152_0)
			{
				item.class152_0 = class152_1;
			}
		}
	...
	public static List<IntPoint> CleanPolygon(List<IntPoint> path, double distance = 1.415)
	{
		...
		if (num != 0)
		{
			Class153[] array = new Class153[num];
			for (int i = 0; i < num; i++)
			{
				array[i] = new Class153();
			}
			for (int j = 0; j < num; j++)
			{
				array[j].intPoint_0 = path[j];
				array[j].class153_0 = array[(j + 1) % num];
				array[j].class153_0.class153_1 = array[j];
				array[j].int_0 = 0;
			}
			double double_ = distance * distance;
			Class153 @class = array[0];
			while (@class.int_0 == 0 && @class.class153_0 != @class.class153_1)
			{
				if (!Class156.smethod_196(@class.intPoint_0, @class.class153_1.intPoint_0, double_))
				{
					if (!Class156.smethod_196(@class.class153_1.intPoint_0, @class.class153_0.intPoint_0, double_))
					{
						if (!Class156.smethod_23(@class.class153_1.intPoint_0, @class.intPoint_0, @class.class153_0.intPoint_0, double_))
						{
							@class.int_0 = 1;
						...
						{
							@class = Class156.smethod_247(@class);
							num--;
						}
					}
					else
					{
						Class156.smethod_247(@class.class153_0);
						@class = Class156.smethod_247(@class);
						num -= 2;
					}
				}
	...
	public static List<List<IntPoint>> MinkowskiSum(List<IntPoint> pattern, List<List<IntPoint>> paths, bool pathIsClosed)
	{
		...
		for (int i = 0; i < paths.Count; i++)
		{
			...
			if (pathIsClosed)
			{
				...
				List<IntPoint> pg = Class156.smethod_261(intPoint_, list2);
	...
	public static List<List<IntPoint>> PolyTreeToPaths(PolyTree polytree)
	{
		...
		smethod_1(polytree, Enum13.const_0, list);
		return list;
	}

	internal static void smethod_1(PolyNode polyNode_0, Enum13 enum13_0, List<List<IntPoint>> list_5)
	{
		bool flag = true;
		switch (enum13_0)
		{
		...
		{
			smethod_1(child, enum13_0, list_5);
		}
	}
	...
	public static List<List<IntPoint>> ClosedPathsFromPolyTree(PolyTree polytree)
	{
		List<List<IntPoint>> list = new List<List<IntPoint>>();
		list.Capacity = polytree.Total;
		smethod_1(polytree, Enum13.const_2, list);
		return list;
	}
}
