...
public class F_MarbleMDIV1 : Form
{
	...
	private string m__0001 = _008D(107376755);
	...
	public void UpdateVisuals()
	{
		...
		try
		{
			...
			{
				fileInfo = new FileInfo(global::_0002._0003(AppPath.MachineSettings, _008D(107373152)));
				goto IL_007c;
			}
			goto IL_00c5;
			IL_007c:
		...
		catch (Exception ex)
		{
			do
			{
				global::_0003_0003._0092_000E(this.m__0001, text, _008D(107372635), global::_0005._007E_001A(ex), global::_0005._007E_001C(_0096_0005._007E_0011_0012(ex)), 0.0, 0.0, true);
				if (uint.MaxValue != 0)
				{
					global::_0002_0002._001F_0008(ex, text, true, _008D(107397840));
				}
			}
			while (2 == 0);
		}
	...
	static F_MarbleMDIV1()
	{
		Strings.CreateGetStringDelegate(typeof(F_MarbleMDIV1));
