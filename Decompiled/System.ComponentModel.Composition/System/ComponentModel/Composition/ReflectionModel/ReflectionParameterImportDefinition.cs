...
internal class ReflectionParameterImportDefinition : ReflectionImportDefinition
{
	...
	{
		ArgumentNullException.ThrowIfNull(importingLazyParameter, "importingLazyParameter");
	...
	protected override string GetDisplayName()
	{
		...
		return $"{notNullValue.Member.GetDisplayName()} (Parameter=\"{notNullValue.Name}\", ContractName=\"{ContractName}\")";
	}
}
