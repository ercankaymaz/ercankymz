...
internal sealed class ComposablePartCatalogCollection : ICollection<ComposablePartCatalog>, IEnumerable<ComposablePartCatalog>, IEnumerable, INotifyComposablePartCatalogChanged, IDisposable
{
	...
	public IEnumerator<ComposablePartCatalog> GetEnumerator()
	{
		...
		using (new WriteLock(_lock))
		{
			IEnumerator<ComposablePartCatalog> result = _catalogs.GetEnumerator();
			_isCopyNeeded = true;
			return result;
		}
	}
