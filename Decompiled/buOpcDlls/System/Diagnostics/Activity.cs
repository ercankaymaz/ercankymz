...
public class Activity : IDisposable
{
	...
	public static ActivityIdFormat DefaultIdFormat
	{
		...
		set
		{
			...
			{
				throw new ArgumentException(System_002EDiagnostics_002EDiagnosticSource3462135_002ESR.ActivityIdFormatInvalid);
			}
	...
	public Activity SetStatus(ActivityStatusCode code, [System_002EDiagnostics_002EDiagnosticSource_002ENullable(2)] string description = null)
	{
		_statusCode = code;
	...
	public Activity(string operationName)
	{
		...
		{
			NotifyError(new ArgumentException(System_002EDiagnostics_002EDiagnosticSource3462135_002ESR.OperationNameInvalid));
		}
		OperationName = operationName;
	}

	public Activity AddTag(string key, [System_002EDiagnostics_002EDiagnosticSource_002ENullable(2)] string value)
	{
		return AddTag(key, (object)value);
	}

	public Activity AddTag(string key, [System_002EDiagnostics_002EDiagnosticSource_002ENullable(2)] object value)
	{
	...
	public Activity SetTag(string key, [System_002EDiagnostics_002EDiagnosticSource_002ENullable(2)] object value)
	{
		KeyValuePair<string, object> keyValuePair = new KeyValuePair<string, object>(key, value);
	...
	public Activity AddBaggage(string key, [System_002EDiagnostics_002EDiagnosticSource_002ENullable(2)] string value)
	{
	...
	public Activity SetBaggage(string key, [System_002EDiagnostics_002EDiagnosticSource_002ENullable(2)] string value)
	{
		KeyValuePair<string, string> keyValuePair = new KeyValuePair<string, string>(key, value);
	...
	public Activity SetParentId(string parentId)
	{
		if (Parent != null)
		{
			NotifyError(new InvalidOperationException(System_002EDiagnostics_002EDiagnosticSource3462135_002ESR.SetParentIdOnActivityWithParent));
		}
		else if (ParentId != null || _parentSpanId != null)
		{
			NotifyError(new InvalidOperationException(System_002EDiagnostics_002EDiagnosticSource3462135_002ESR.ParentIdAlreadySet));
		}
		else if (string.IsNullOrEmpty(parentId))
		{
			NotifyError(new ArgumentException(System_002EDiagnostics_002EDiagnosticSource3462135_002ESR.ParentIdInvalid));
		}
		else
		{
			_parentId = parentId;
	...
	public Activity SetStartTime(DateTime startTimeUtc)
	{
		...
		{
			NotifyError(new InvalidOperationException(System_002EDiagnostics_002EDiagnosticSource3462135_002ESR.StartTimeNotUtc));
		}
		else
		{
	...
	public Activity SetEndTime(DateTime endTimeUtc)
	{
		...
		{
			NotifyError(new InvalidOperationException(System_002EDiagnostics_002EDiagnosticSource3462135_002ESR.EndTimeNotUtc));
		}
		else
		{
	...
	public Activity Start()
	{
		if (_id != null || _spanId != null)
		{
			NotifyError(new InvalidOperationException(System_002EDiagnostics_002EDiagnosticSource3462135_002ESR.ActivityStartAlreadyStarted));
		}
		else
		{
	...
	public void Stop()
	{
		if (_id == null && _spanId == null)
		{
			NotifyError(new InvalidOperationException(System_002EDiagnostics_002EDiagnosticSource3462135_002ESR.ActivityNotStarted));
		}
		else if (!IsFinished)
		{
			IsFinished = true;
	...
	public Activity SetIdFormat(ActivityIdFormat format)
	{
		if (_id != null || _spanId != null)
		{
			NotifyError(new InvalidOperationException(System_002EDiagnostics_002EDiagnosticSource3462135_002ESR.SetFormatOnStartedActivity));
		}
		else
		{
			IdFormat = format;
	...
	public void SetCustomProperty(string propertyName, [System_002EDiagnostics_002EDiagnosticSource_002ENullable(2)] object propertyValue)
	{
	...
	private static bool ValidateSetCurrent(Activity activity)
	{
		...
		if (!flag)
		{
			NotifyError(new InvalidOperationException(System_002EDiagnostics_002EDiagnosticSource3462135_002ESR.ActivityNotRunning));
		}
		return flag;
	}
