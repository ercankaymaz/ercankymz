...
public class DiagnosticListener : DiagnosticSource, IObservable<KeyValuePair<string, object>>, IDisposable
{
	...
	public virtual IDisposable Subscribe([System_002EDiagnostics_002EDiagnosticSource_002ENullable(new byte[] { 1, 0, 1, 2 })] IObserver<KeyValuePair<string, object>> observer, [System_002EDiagnostics_002EDiagnosticSource_002ENullable(new byte[] { 2, 1 })] Predicate<string> isEnabled)
	{
		if (isEnabled == null)
		{
	...
	public virtual IDisposable Subscribe([System_002EDiagnostics_002EDiagnosticSource_002ENullable(new byte[] { 1, 0, 1, 2 })] IObserver<KeyValuePair<string, object>> observer, [System_002EDiagnostics_002EDiagnosticSource_002ENullable(new byte[] { 2, 1, 2, 2 })] Func<string, object, object, bool> isEnabled)
	{
		if (isEnabled != null)
		{
	...
	public virtual IDisposable Subscribe([System_002EDiagnostics_002EDiagnosticSource_002ENullable(new byte[] { 1, 0, 1, 2 })] IObserver<KeyValuePair<string, object>> observer)
	{
		return SubscribeInternal(observer, null, null, null, null);
	}
	...
	public override bool IsEnabled([System_002EDiagnostics_002EDiagnosticSource_002ENullable(1)] string name, object arg1, object arg2 = null)
	{
		for (DiagnosticSubscription diagnosticSubscription = _subscriptions; diagnosticSubscription != null; diagnosticSubscription = diagnosticSubscription.Next)
		{
	...
	public override void Write(string name, [System_002EDiagnostics_002EDiagnosticSource_002ENullable(2)] object value)
	{
		for (DiagnosticSubscription diagnosticSubscription = _subscriptions; diagnosticSubscription != null; diagnosticSubscription = diagnosticSubscription.Next)
		{
	...
	public override void OnActivityImport(Activity activity, [System_002EDiagnostics_002EDiagnosticSource_002ENullable(2)] object payload)
	{
		for (DiagnosticSubscription diagnosticSubscription = _subscriptions; diagnosticSubscription != null; diagnosticSubscription = diagnosticSubscription.Next)
		{
	...
	public override void OnActivityExport(Activity activity, [System_002EDiagnostics_002EDiagnosticSource_002ENullable(2)] object payload)
	{
		for (DiagnosticSubscription diagnosticSubscription = _subscriptions; diagnosticSubscription != null; diagnosticSubscription = diagnosticSubscription.Next)
		{
	...
	public virtual IDisposable Subscribe([System_002EDiagnostics_002EDiagnosticSource_002ENullable(new byte[] { 1, 0, 1, 2 })] IObserver<KeyValuePair<string, object>> observer, [System_002EDiagnostics_002EDiagnosticSource_002ENullable(new byte[] { 2, 1, 2, 2 })] Func<string, object, object, bool> isEnabled, [System_002EDiagnostics_002EDiagnosticSource_002ENullable(new byte[] { 2, 1, 2 })] Action<Activity, object> onActivityImport = null, [System_002EDiagnostics_002EDiagnosticSource_002ENullable(new byte[] { 2, 1, 2 })] Action<Activity, object> onActivityExport = null)
	{
		if (isEnabled != null)
		{
