...
public sealed class MeterListener : IDisposable
{
	...
	[System_002EDiagnostics_002EDiagnosticSource_002ENullable(new byte[] { 2, 1, 1 })]
	public Action<Instrument, MeterListener> InstrumentPublished
	{
		[return: System_002EDiagnostics_002EDiagnosticSource_002ENullable(new byte[] { 2, 1, 1 })]
		get;
		[param: System_002EDiagnostics_002EDiagnosticSource_002ENullable(new byte[] { 2, 1, 1 })]
		set;
	}

	[System_002EDiagnostics_002EDiagnosticSource_002ENullable(new byte[] { 2, 1, 2 })]
	public Action<Instrument, object> MeasurementsCompleted
	{
		[return: System_002EDiagnostics_002EDiagnosticSource_002ENullable(new byte[] { 2, 1, 2 })]
		get;
		[param: System_002EDiagnostics_002EDiagnosticSource_002ENullable(new byte[] { 2, 1, 2 })]
		set;
	}

	[System_002EDiagnostics_002EDiagnosticSource_002ENullableContext(1)]
	public void EnableMeasurementEvents(Instrument instrument, [System_002EDiagnostics_002EDiagnosticSource_002ENullable(2)] object state = null)
	{
	...
	public void SetMeasurementEventCallback<T>([System_002EDiagnostics_002EDiagnosticSource_002ENullable(new byte[] { 2, 0 })] MeasurementCallback<T> measurementCallback) where T : struct
	{
		...
		throw new InvalidOperationException(System_002EDiagnostics_002EDiagnosticSource3462135_002ESR.Format(System_002EDiagnostics_002EDiagnosticSource3462135_002ESR.UnsupportedType, typeof(T)));
	}
