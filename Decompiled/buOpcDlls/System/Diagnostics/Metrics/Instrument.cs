...
public abstract class Instrument
{
	...
	protected Instrument(Meter meter, string name, [System_002EDiagnostics_002EDiagnosticSource_002ENullable(2)] string unit, [System_002EDiagnostics_002EDiagnosticSource_002ENullable(2)] string description)
	{
		if (meter == null)
		{
	...
	internal static void ValidateTypeParameter<T>()
	{
		...
		{
			throw new InvalidOperationException(System_002EDiagnostics_002EDiagnosticSource3462135_002ESR.Format(System_002EDiagnostics_002EDiagnosticSource3462135_002ESR.UnsupportedType, typeFromHandle));
		}
	}
...
public abstract class Instrument<T> : Instrument where T : struct
{
	...
	protected void RecordMeasurement(T measurement, [System_002EDiagnostics_002EDiagnosticSource_002ENullable(new byte[] { 0, 0, 1, 2 })] ReadOnlySpan<KeyValuePair<string, object>> tags)
	{
		for (DiagNode<ListenerSubscription> diagNode = _subscriptions.First; diagNode != null; diagNode = diagNode.Next)
		{
	...
	protected void RecordMeasurement(T measurement, [System_002EDiagnostics_002EDiagnosticSource_002ENullable(new byte[] { 0, 1, 2 })] KeyValuePair<string, object> tag)
	{
		KeyValuePair<string, object>[] array = ts_tags ?? new KeyValuePair<string, object>[8];
		ts_tags = null;
		array[0] = tag;
		RecordMeasurement(measurement, array.AsSpan().Slice(0, 1));
		ts_tags = array;
	}

	protected void RecordMeasurement(T measurement, [System_002EDiagnostics_002EDiagnosticSource_002ENullable(new byte[] { 0, 1, 2 })] KeyValuePair<string, object> tag1, [System_002EDiagnostics_002EDiagnosticSource_002ENullable(new byte[] { 0, 1, 2 })] KeyValuePair<string, object> tag2)
	{
		KeyValuePair<string, object>[] array = ts_tags ?? new KeyValuePair<string, object>[8];
		ts_tags = null;
		array[0] = tag1;
		array[1] = tag2;
		RecordMeasurement(measurement, array.AsSpan().Slice(0, 2));
		ts_tags = array;
	}

	protected void RecordMeasurement(T measurement, [System_002EDiagnostics_002EDiagnosticSource_002ENullable(new byte[] { 0, 1, 2 })] KeyValuePair<string, object> tag1, [System_002EDiagnostics_002EDiagnosticSource_002ENullable(new byte[] { 0, 1, 2 })] KeyValuePair<string, object> tag2, [System_002EDiagnostics_002EDiagnosticSource_002ENullable(new byte[] { 0, 1, 2 })] KeyValuePair<string, object> tag3)
	{
		KeyValuePair<string, object>[] array = ts_tags ?? new KeyValuePair<string, object>[8];
		ts_tags = null;
		array[0] = tag1;
		array[1] = tag2;
		array[2] = tag3;
		RecordMeasurement(measurement, array.AsSpan().Slice(0, 3));
		ts_tags = array;
	}

	protected void RecordMeasurement(T measurement, [In][System_002EDiagnostics_002EDiagnosticSource_002EIsReadOnly] ref TagList tagList)
	{
