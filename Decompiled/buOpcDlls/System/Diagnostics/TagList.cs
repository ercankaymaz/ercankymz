...
public struct TagList : IList<KeyValuePair<string, object>>, ICollection<KeyValuePair<string, object>>, IEnumerable<KeyValuePair<string, object>>, IEnumerable, IReadOnlyList<KeyValuePair<string, object>>, IReadOnlyCollection<KeyValuePair<string, object>>
{
	public struct Enumerator : IEnumerator<KeyValuePair<string, object>>, IDisposable, IEnumerator
	{
		...
		internal Enumerator([In][System_002EDiagnostics_002EDiagnosticSource_002EIsReadOnly] ref TagList tagList)
		{
			_index = -1;
			_tagList = tagList;
		}
	...
	public KeyValuePair<string, object> this[int index]
	{
		...
		[param: System_002EDiagnostics_002EDiagnosticSource_002ENullable(new byte[] { 0, 1, 2 })]
		set
		{
			if ((uint)index >= (uint)_tagsCount)
			{
	...
	public TagList([System_002EDiagnostics_002EDiagnosticSource_002ENullable(new byte[] { 0, 0, 1, 2 })] ReadOnlySpan<KeyValuePair<string, object>> tagList)
	{
	...
	public void Add([System_002EDiagnostics_002EDiagnosticSource_002ENullable(new byte[] { 0, 1, 2 })] KeyValuePair<string, object> tag)
	{
		if (_overflowTags != null)
		{
	...
	[System_002EDiagnostics_002EDiagnosticSource_002EIsReadOnly]
	public void CopyTo([System_002EDiagnostics_002EDiagnosticSource_002ENullable(new byte[] { 0, 0, 1, 2 })] Span<KeyValuePair<string, object>> tags)
	{
		if (tags.Length < _tagsCount)
		{
			throw new ArgumentException(System_002EDiagnostics_002EDiagnosticSource3462135_002ESR.Arg_BufferTooSmall);
		}
		if (_overflowTags != null)
		{
	...
	public void Insert(int index, [System_002EDiagnostics_002EDiagnosticSource_002ENullable(new byte[] { 0, 1, 2 })] KeyValuePair<string, object> item)
	{
		if ((uint)index > (uint)_tagsCount)
		{
			throw new ArgumentOutOfRangeException("index");
	...
	[System_002EDiagnostics_002EDiagnosticSource_002EIsReadOnly]
	public int IndexOf([System_002EDiagnostics_002EDiagnosticSource_002ENullable(new byte[] { 0, 1, 2 })] KeyValuePair<string, object> item)
	{
		if (_overflowTags != null)
		{
