...
internal sealed class HttpHandlerDiagnosticListener : DiagnosticListener
{
	...
	private static void PrepareReflectionObjects()
	{
		...
		{
			throw new InvalidOperationException(System_002EDiagnostics_002EDiagnosticSource3462135_002ESR.UnableToInitialize);
		}
	}
	...
	private static void PerformInjection()
	{
		...
		if (field == null)
		{
			throw new InvalidOperationException(System_002EDiagnostics_002EDiagnosticSource3462135_002ESR.UnableAccessServicePointTable);
		}
