...
public static class AsnDecoder
{
	...
	private static ReadOnlySpan<byte> GetPrimitiveContentSpan(ReadOnlySpan<byte> source, AsnEncodingRules ruleSet, Asn1Tag expectedTag, UniversalTagNumber tagNumber, out int bytesConsumed)
	{
		...
		{
			throw new AsnContentException(System_002EFormats_002EAsn13538873_002ESR.Format(System_002EFormats_002EAsn13538873_002ESR.ContentException_PrimitiveEncodingRequired, tagNumber));
		}
		if (!num.HasValue)
		{
	...
	private static int? ReadLength(ReadOnlySpan<byte> source, AsnEncodingRules ruleSet, out int bytesConsumed)
	{
		...
		case LengthDecodeStatus.LengthTooBig:
			throw new AsnContentException(System_002EFormats_002EAsn13538873_002ESR.ContentException_LengthTooBig);
		case LengthDecodeStatus.DerIndefinite:
		case LengthDecodeStatus.LaxEncodingProhibited:
			throw new AsnContentException(System_002EFormats_002EAsn13538873_002ESR.ContentException_LengthRuleSetConstraint);
		default:
			throw new AsnContentException();
		}
	}
	...
	private static AsnContentException GetValidityException(LengthValidity validity)
	{
		...
		{
			LengthValidity.CerRequiresIndefinite => new AsnContentException(System_002EFormats_002EAsn13538873_002ESR.ContentException_CerRequiresIndefiniteLength), 
			LengthValidity.LengthExceedsInput => new AsnContentException(System_002EFormats_002EAsn13538873_002ESR.ContentException_LengthExceedsPayload), 
	...
	private static ReadOnlySpan<byte> Slice(ReadOnlySpan<byte> source, int offset, int length)
	{
		...
		{
			throw new AsnContentException(System_002EFormats_002EAsn13538873_002ESR.ContentException_LengthExceedsPayload);
		}
	...
	private static void CheckExpectedTag(Asn1Tag tag, Asn1Tag expectedTag, UniversalTagNumber tagNumber)
	{
		...
		{
			throw new ArgumentException(System_002EFormats_002EAsn13538873_002ESR.Argument_UniversalValueIsFixed, "expectedTag");
		}
		if (expectedTag.TagClass != tag.TagClass || expectedTag.TagValue != tag.TagValue)
		{
			throw new AsnContentException(System_002EFormats_002EAsn13538873_002ESR.Format(System_002EFormats_002EAsn13538873_002ESR.ContentException_WrongTag, tag.TagClass, tag.TagValue, expectedTag.TagClass, expectedTag.TagValue));
		}
	}
	...
	public static bool TryReadBitString(ReadOnlySpan<byte> source, Span<byte> destination, AsnEncodingRules ruleSet, out int unusedBitCount, out int bytesConsumed, out int bytesWritten, Asn1Tag? expectedTag = null)
	{
		...
		{
			throw new ArgumentException(System_002EFormats_002EAsn13538873_002ESR.Argument_SourceOverlapsDestination, "destination");
		}
	...
	[return: System_002EFormats_002EAsn1_002ENullable(1)]
	public static byte[] ReadBitString(ReadOnlySpan<byte> source, AsnEncodingRules ruleSet, out int unusedBitCount, out int bytesConsumed, Asn1Tag? expectedTag = null)
	{
		...
		byte[] array2 = CryptoPool.Rent(minimumLength);
	...
	private static void ParsePrimitiveBitStringContents(ReadOnlySpan<byte> source, AsnEncodingRules ruleSet, out int unusedBitCount, out ReadOnlySpan<byte> value, out byte normalizedLastByte)
	{
		...
		{
			throw new AsnContentException(System_002EFormats_002EAsn13538873_002ESR.ContentException_InvalidUnderCer_TryBerOrDer);
		}
		if (source.Length == 0)
		{
			throw new AsnContentException();
		...
		{
			throw new AsnContentException(System_002EFormats_002EAsn13538873_002ESR.ContentException_InvalidUnderCerOrDer_TryBer);
		}
	...
	private static bool TryReadPrimitiveBitStringCore(ReadOnlySpan<byte> source, AsnEncodingRules ruleSet, Asn1Tag expectedTag, out int? contentsLength, out int headerLength, out int unusedBitCount, out ReadOnlySpan<byte> value, out int bytesConsumed, out byte normalizedLastByte)
	{
		...
		if (tag.IsConstructed)
		{
			if (ruleSet == AsnEncodingRules.DER)
			{
				throw new AsnContentException(System_002EFormats_002EAsn13538873_002ESR.ContentException_InvalidUnderDer_TryBerOrCer);
			}
			unusedBitCount = 0;
			value = default(ReadOnlySpan<byte>);
			normalizedLastByte = 0;
	...
	public static Enum ReadEnumeratedValue([System_002EFormats_002EAsn1_002ENullable(0)] ReadOnlySpan<byte> source, AsnEncodingRules ruleSet, Type enumType, out int bytesConsumed, Asn1Tag? expectedTag = null)
	{
		if (enumType == null)
		{
		...
		{
			throw new ArgumentException(System_002EFormats_002EAsn13538873_002ESR.Argument_EnumeratedValueRequiresNonFlagsEnum, "enumType");
		}
		...
		if (enumUnderlyingType == typeof(int) || enumUnderlyingType == typeof(long) || enumUnderlyingType == typeof(short) || enumUnderlyingType == typeof(sbyte))
		{
			...
			{
				throw new AsnContentException(System_002EFormats_002EAsn13538873_002ESR.ContentException_EnumeratedValueTooBig);
			}
			bytesConsumed = bytesConsumed2;
		...
		throw new AsnContentException(System_002EFormats_002EAsn13538873_002ESR.Format(System_002EFormats_002EAsn13538873_002ESR.Argument_EnumeratedValueBackingTypeNotSupported, enumUnderlyingType.FullName));
	}
	...
	private static DateTimeOffset ParseGeneralizedTime(AsnEncodingRules ruleSet, ReadOnlySpan<byte> contentOctets)
	{
		...
		{
			throw new AsnContentException(System_002EFormats_002EAsn13538873_002ESR.ContentException_DefaultMessage, inner);
		}
	...
	public static BigInteger ReadInteger(ReadOnlySpan<byte> source, AsnEncodingRules ruleSet, out int bytesConsumed, Asn1Tag? expectedTag = null)
	{
		...
		byte[] array = CryptoPool.Rent(readOnlySpan.Length);
		BigInteger result;
		try
		{
			byte value = (byte)(((readOnlySpan[0] & 0x80) != 0) ? byte.MaxValue : 0);
	...
	[System_002EFormats_002EAsn1_002ENullableContext(1)]
	public static Enum ReadNamedBitListValue([System_002EFormats_002EAsn1_002ENullable(0)] ReadOnlySpan<byte> source, AsnEncodingRules ruleSet, Type flagsEnumType, out int bytesConsumed, Asn1Tag? expectedTag = null)
	{
		...
		{
			throw new ArgumentException(System_002EFormats_002EAsn13538873_002ESR.Argument_NamedBitListRequiresFlagsEnum, "flagsEnumType");
		}
		Span<byte> span = stackalloc byte[8];
		int primitiveIntegerSize = GetPrimitiveIntegerSize(enumUnderlyingType);
		span = span.Slice(0, primitiveIntegerSize);
		if (!TryReadBitString(source, span, ruleSet, out var unusedBitCount, out var bytesConsumed2, out var bytesWritten, expectedTag))
		{
			throw new AsnContentException(System_002EFormats_002EAsn13538873_002ESR.Format(System_002EFormats_002EAsn13538873_002ESR.ContentException_NamedBitListValueTooBig, flagsEnumType.Name));
		}
		Enum result;
		if (bytesWritten == 0)
		{
		...
		ReadOnlySpan<byte> valueSpan = span.Slice(0, bytesWritten);
		if (ruleSet == AsnEncodingRules.DER || ruleSet == AsnEncodingRules.CER)
		{
	...
	private static void ReadSubIdentifier(ReadOnlySpan<byte> source, out int bytesRead, out long? smallValue, out BigInteger? largeValue)
	{
		...
		byte[] array = CryptoPool.Rent(num3);
	...
	public static void ReadSequence(ReadOnlySpan<byte> source, AsnEncodingRules ruleSet, out int contentOffset, out int contentLength, out int bytesConsumed, Asn1Tag? expectedTag = null)
	{
		...
		if (!tag.IsConstructed)
		{
			throw new AsnContentException(System_002EFormats_002EAsn13538873_002ESR.Format(System_002EFormats_002EAsn13538873_002ESR.ContentException_ConstructedEncodingRequired, UniversalTagNumber.Sequence));
		}
		if (contentsLength.HasValue)
		{
	...
	public static void ReadSetOf(ReadOnlySpan<byte> source, AsnEncodingRules ruleSet, out int contentOffset, out int contentLength, out int bytesConsumed, bool skipSortOrderValidation = false, Asn1Tag? expectedTag = null)
	{
		...
		if (!tag.IsConstructed)
		{
			throw new AsnContentException(System_002EFormats_002EAsn13538873_002ESR.Format(System_002EFormats_002EAsn13538873_002ESR.ContentException_ConstructedEncodingRequired, UniversalTagNumber.Set));
		}
		int num;
		...
		if (!skipSortOrderValidation && (ruleSet == AsnEncodingRules.DER || ruleSet == AsnEncodingRules.CER))
		{
			...
			while (!source2.IsEmpty)
			{
				...
				{
					throw new AsnContentException(System_002EFormats_002EAsn13538873_002ESR.ContentException_SetOfNotSorted);
				}
				y = readOnlySpan2;
			}
		}
	...
	public static bool TryReadPrimitiveCharacterStringBytes(ReadOnlySpan<byte> source, AsnEncodingRules ruleSet, Asn1Tag expectedTag, out ReadOnlySpan<byte> value, out int bytesConsumed)
	{
		...
		if (expectedTag.TagClass == TagClass.Universal)
		{
			...
			{
				throw new ArgumentException(System_002EFormats_002EAsn13538873_002ESR.Argument_Tag_NotCharacterString, "expectedTag");
			}
		}
		int? contentLength;
		int headerLength;
	...
	private unsafe static bool TryReadCharacterStringCore(ReadOnlySpan<byte> source, Span<char> destination, Encoding encoding, out int charsWritten)
	{
		try
		{
			...
			fixed (byte* reference = &MemoryMarshal.GetReference(source))
			{
				...
				{
					int charCount = encoding.GetCharCount(reference, source.Length);
