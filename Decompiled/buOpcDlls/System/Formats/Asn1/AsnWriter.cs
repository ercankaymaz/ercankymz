...
public sealed class AsnWriter
{
	...
	private struct StackFrame : IEquatable<StackFrame>
	{
		...
		public override bool Equals([System_002EFormats_002EAsn13538873_002ENotNullWhen(true)] object obj)
		{
	...
	public struct Scope : IDisposable
	{
		...
		public void Dispose()
		{
			...
			{
				throw new InvalidOperationException(System_002EFormats_002EAsn13538873_002ESR.AsnWriter_PopWrongTag);
			}
		}
	}
		...
		: this(ruleSet)
	{
		...
		{
			throw new ArgumentOutOfRangeException("initialCapacity", System_002EFormats_002EAsn13538873_002ESR.ArgumentOutOfRange_NeedNonNegNum);
		}
		if (initialCapacity > 0)
		{
	...
	public int GetEncodedLength()
	{
		...
		{
			throw new InvalidOperationException(System_002EFormats_002EAsn13538873_002ESR.AsnWriter_EncodeUnbalancedStack);
		}
		return _offset;
	}
	...
	public int Encode(Span<byte> destination)
	{
		...
		{
			throw new ArgumentException(System_002EFormats_002EAsn13538873_002ESR.Argument_DestinationTooShort, "destination");
		}
		return bytesWritten;
	}
	...
	public void WriteEncodedValue(ReadOnlySpan<byte> value)
	{
		...
		{
			throw new ArgumentException(System_002EFormats_002EAsn13538873_002ESR.Argument_WriteEncodedValue_OneValueAtATime, "value");
		}
	...
	private static void SortContents(byte[] buffer, int start, int end)
	{
		...
		do
		{
			readOnlyMemory = asnReader.ReadEncodedValue();
			list.Add((num2, readOnlyMemory.Length));
			num2 += readOnlyMemory.Length;
		}
	...
	private static void CheckUniversalTag(Asn1Tag? tag, UniversalTagNumber universalTagNumber)
	{
		if (tag.HasValue)
		{
			...
			{
				throw new ArgumentException(System_002EFormats_002EAsn13538873_002ESR.Argument_UniversalValueIsFixed, "tag");
			}
		}
	}
	...
	private void WriteBitStringCore(Asn1Tag tag, ReadOnlySpan<byte> bitString, int unusedBitCount)
	{
		...
		{
			throw new ArgumentOutOfRangeException("unusedBitCount", unusedBitCount, System_002EFormats_002EAsn13538873_002ESR.Argument_UnusedBitCountRange);
		}
		if (bitString.Length == 0 && unusedBitCount != 0)
		{
			throw new ArgumentException(System_002EFormats_002EAsn13538873_002ESR.Argument_UnusedBitCountMustBeZero, "unusedBitCount");
		}
		byte lastByte = (byte)((!bitString.IsEmpty) ? bitString[bitString.Length - 1] : 0);
		if (!CheckValidLastByte(lastByte, unusedBitCount))
		{
			throw new ArgumentException(System_002EFormats_002EAsn13538873_002ESR.Argument_UnusedBitWasSet, "unusedBitCount");
		}
	...
	[System_002EFormats_002EAsn1_002ENullableContext(1)]
	public void WriteEnumeratedValue<[System_002EFormats_002EAsn1_002ENullable(0)] TEnum>(TEnum value, Asn1Tag? tag = null) where TEnum : Enum
	{
	...
	private void WriteEnumeratedValue(Asn1Tag tag, Type tEnum, object value)
	{
		...
		{
			throw new ArgumentException(System_002EFormats_002EAsn13538873_002ESR.Argument_EnumeratedValueRequiresNonFlagsEnum, "tEnum");
		}
	...
	private void WriteGeneralizedTimeCore(Asn1Tag tag, DateTimeOffset value, bool omitFractionalSeconds)
	{
		...
		if (!omitFractionalSeconds)
		{
			...
			if (num != 0L)
			{
				span = stackalloc byte[9];
				decimal value2 = num;
				value2 /= 10000000m;
				if (!Utf8Formatter.TryFormat(value2, span, out var bytesWritten, new StandardFormat('G')))
				{
					throw new InvalidOperationException();
				}
				span = span.Slice(1, bytesWritten - 1);
			}
		}
		int length = 15 + span.Length;
		WriteTag(tag);
		WriteLength(length);
		...
		Span<byte> span2 = _buffer.AsSpan(_offset);
		StandardFormat format = new StandardFormat('D', 4);
		StandardFormat format2 = new StandardFormat('D', 2);
		if (!Utf8Formatter.TryFormat(year, span2.Slice(0, 4), out var bytesWritten2, format) || !Utf8Formatter.TryFormat(month, span2.Slice(4, 2), out bytesWritten2, format2) || !Utf8Formatter.TryFormat(day, span2.Slice(6, 2), out bytesWritten2, format2) || !Utf8Formatter.TryFormat(hour, span2.Slice(8, 2), out bytesWritten2, format2) || !Utf8Formatter.TryFormat(minute, span2.Slice(10, 2), out bytesWritten2, format2) || !Utf8Formatter.TryFormat(second, span2.Slice(12, 2), out bytesWritten2, format2))
		{
			throw new InvalidOperationException();
		}
		_offset += 14;
	...
	private void WriteIntegerUnsignedCore(Asn1Tag tag, ReadOnlySpan<byte> value)
	{
		if (value.IsEmpty)
		{
			throw new ArgumentException(System_002EFormats_002EAsn13538873_002ESR.Argument_IntegerCannotBeEmpty, "value");
		}
		if (value.Length > 1 && value[0] == 0 && value[1] < 128)
		{
			throw new ArgumentException(System_002EFormats_002EAsn13538873_002ESR.Argument_IntegerRedundantByte, "value");
		}
		WriteTag(tag);
		if (value[0] >= 128)
		{
	...
	private void WriteIntegerCore(Asn1Tag tag, ReadOnlySpan<byte> value)
	{
		...
		if (BinaryPrimitives.TryReadUInt16BigEndian(value, out var value2))
		{
			ushort num = (ushort)(value2 & 0xFF80);
			if (num == 0 || num == 65408)
			{
				throw new ArgumentException(System_002EFormats_002EAsn13538873_002ESR.Argument_IntegerRedundantByte, "value");
			}
	...
	[System_002EFormats_002EAsn1_002ENullableContext(1)]
	public void WriteNamedBitList<[System_002EFormats_002EAsn1_002ENullable(0)] TEnum>(TEnum value, Asn1Tag? tag = null) where TEnum : Enum
	{
		CheckUniversalTag(tag, UniversalTagNumber.BitString);
	...
	private void WriteNamedBitList(Asn1Tag? tag, Type tEnum, Enum value)
	{
		...
		if (!tEnum.IsDefined(typeof(FlagsAttribute), inherit: false))
		{
			throw new ArgumentException(System_002EFormats_002EAsn13538873_002ESR.Argument_NamedBitListRequiresFlagsEnum, "tEnum");
		}
		ulong integralValue;
		if (enumUnderlyingType == typeof(ulong))
		{
	...
	private void WriteObjectIdentifierCore(Asn1Tag tag, ReadOnlySpan<char> oidValue)
	{
		...
		{
			throw new ArgumentException(System_002EFormats_002EAsn13538873_002ESR.Argument_InvalidOidValue, "oidValue");
		}
		if (oidValue[1] != '.')
		{
			throw new ArgumentException(System_002EFormats_002EAsn13538873_002ESR.Argument_InvalidOidValue, "oidValue");
		}
		byte[] array = CryptoPool.Rent(oidValue.Length / 2);
		int num = 0;
		try
		{
			int num2 = oidValue[0] switch
			{
				...
				'1' => 1, 
				'2' => 2, 
				_ => throw new ArgumentException(System_002EFormats_002EAsn13538873_002ESR.Argument_InvalidOidValue, "oidValue"), 
			};
	...
	{
		byte[] array = CryptoPool.Rent(size);
