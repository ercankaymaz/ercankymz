	...
	public static StandardFormat Parse(ReadOnlySpan<char> format)
	{
		...
		else
		{
			...
			for (int i = 1; i < format.Length; i++)
			{
				...
				if (num2 > 9)
				{
					throw new FormatException(System_002EMemory3568249_002ESR.Format(System_002EMemory3568249_002ESR.Argument_CannotParsePrecision, (byte)99));
				}
				num = num * 10 + num2;
				if (num > 99)
				{
					throw new FormatException(System_002EMemory3568249_002ESR.Format(System_002EMemory3568249_002ESR.Argument_PrecisionTooLarge, (byte)99));
				}
			}
			precision = (byte)num;
		}
