...
public class JsonTextWriter : JsonWriter
{
	...
	public override Task WriteRawAsync([Newtonsoft_002EJson_002ENullable(2)] string json, CancellationToken cancellationToken = default(CancellationToken))
	{
		if (!_safeAsync)
		{
	...
	internal Task DoWriteRawAsync([Newtonsoft_002EJson_002ENullable(2)] string json, CancellationToken cancellationToken)
	{
	...
	public override Task WriteValueAsync([Newtonsoft_002EJson_002ENullable(2)] byte[] value, CancellationToken cancellationToken = default(CancellationToken))
	{
		if (!_safeAsync)
		{
			return base.WriteValueAsync(value, cancellationToken);
	...
	public override Task WriteValueAsync([Newtonsoft_002EJson_002ENullable(2)] object value, CancellationToken cancellationToken = default(CancellationToken))
	{
		if (_safeAsync)
		{
			if (value == null)
	...
	public override Task WriteValueAsync([Newtonsoft_002EJson_002ENullable(2)] string value, CancellationToken cancellationToken = default(CancellationToken))
	{
		if (!_safeAsync)
		{
			return base.WriteValueAsync(value, cancellationToken);
	...
	internal Task DoWriteValueAsync([Newtonsoft_002EJson_002ENullable(2)] string value, CancellationToken cancellationToken)
	{
	...
	private async Task DoWriteValueAsync(Task task, [Newtonsoft_002EJson_002ENullable(2)] string value, CancellationToken cancellationToken)
	{
		await task.ConfigureAwait(continueOnCapturedContext: false);
	...
	public override Task WriteValueAsync([Newtonsoft_002EJson_002ENullable(2)] Uri value, CancellationToken cancellationToken = default(CancellationToken))
	{
		if (!_safeAsync)
		{
			return base.WriteValueAsync(value, cancellationToken);
	...
	public override Task WriteCommentAsync([Newtonsoft_002EJson_002ENullable(2)] string text, CancellationToken cancellationToken = default(CancellationToken))
	{
		if (!_safeAsync)
		{
	...
	internal async Task DoWriteCommentAsync([Newtonsoft_002EJson_002ENullable(2)] string text, CancellationToken cancellationToken)
	{
	...
	public override Task WriteRawValueAsync([Newtonsoft_002EJson_002ENullable(2)] string json, CancellationToken cancellationToken = default(CancellationToken))
	{
		if (!_safeAsync)
		{
	...
	internal Task DoWriteRawValueAsync([Newtonsoft_002EJson_002ENullable(2)] string json, CancellationToken cancellationToken)
	{
	...
	private async Task DoWriteRawValueAsync(Task task, [Newtonsoft_002EJson_002ENullable(2)] string json, CancellationToken cancellationToken)
	{
		await task.ConfigureAwait(continueOnCapturedContext: false);
