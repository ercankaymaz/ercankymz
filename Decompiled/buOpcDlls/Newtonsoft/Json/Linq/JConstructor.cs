...
public class JConstructor : JContainer
{
	...
	public new static async Task<JConstructor> LoadAsync(JsonReader reader, [Newtonsoft_002EJson_002ENullable(2)] JsonLoadSettings settings, CancellationToken cancellationToken = default(CancellationToken))
	{
	...
	internal JConstructor(JConstructor other, [Newtonsoft_002EJson_002ENullable(2)] JsonCloneSettings settings)
		: base(other, settings)
	{
		_name = other.Name;
	}
	...
	public new static JConstructor Load(JsonReader reader, [Newtonsoft_002EJson_002ENullable(2)] JsonLoadSettings settings)
	{
