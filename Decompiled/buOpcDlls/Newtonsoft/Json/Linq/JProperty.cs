...
public class JProperty : JContainer
{
	...
	public new static async Task<JProperty> LoadAsync(JsonReader reader, [Newtonsoft_002EJson_002ENullable(2)] JsonLoadSettings settings, CancellationToken cancellationToken = default(CancellationToken))
	{
	...
	internal JProperty(JProperty other, [Newtonsoft_002EJson_002ENullable(2)] JsonCloneSettings settings)
		: base(other, settings)
	{
		_name = other.Name;
	}
	...
	public JProperty(string name, [Newtonsoft_002EJson_002ENullable(2)] object content)
	{
		ValidationUtils.ArgumentNotNull(name, "name");
		_name = name;
	...
	public new static JProperty Load(JsonReader reader, [Newtonsoft_002EJson_002ENullable(2)] JsonLoadSettings settings)
	{
