...
public class JArray : JContainer, IList<JToken>, ICollection<JToken>, IEnumerable<JToken>, IEnumerable
{
	...
	public new static async Task<JArray> LoadAsync(JsonReader reader, [Newtonsoft_002EJson_002ENullable(2)] JsonLoadSettings settings, CancellationToken cancellationToken = default(CancellationToken))
	{
	...
	internal JArray(JArray other, [Newtonsoft_002EJson_002ENullable(2)] JsonCloneSettings settings)
		: base(other, settings)
	{
	}
	...
	internal override JToken CloneToken([Newtonsoft_002EJson_002ENullable(2)] JsonCloneSettings settings = null)
	{
	...
	public new static JArray Load(JsonReader reader, [Newtonsoft_002EJson_002ENullable(2)] JsonLoadSettings settings)
	{
	...
	public new static JArray Parse(string json, [Newtonsoft_002EJson_002ENullable(2)] JsonLoadSettings settings)
	{
