...
internal class JPath
{
	...
	private static PathFilter CreatePathFilter([Newtonsoft_002EJson_002ENullable(2)] string member, bool scan)
	{
		if (!scan)
		{
	...
	private bool TryParseExpression([Newtonsoft_002EJson_002ENullable(new byte[] { 2, 1 })] out List<PathFilter> expressionPath)
	{
		if (_expression[_currentIndex] == '$')
		{
	...
	internal IEnumerable<JToken> Evaluate(JToken root, JToken t, [Newtonsoft_002EJson_002ENullable(2)] JsonSelectSettings settings)
	{
		return Evaluate(Filters, root, t, settings);
	}

	internal static IEnumerable<JToken> Evaluate(List<PathFilter> filters, JToken root, JToken t, [Newtonsoft_002EJson_002ENullable(2)] JsonSelectSettings settings)
	{
