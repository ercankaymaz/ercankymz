...
public class DiscriminatedUnionConverter : JsonConverter
{
	...
	public override void WriteJson(JsonWriter writer, [Newtonsoft_002EJson_002ENullable(2)] object value, JsonSerializer serializer)
	{
		...
		UnionCase unionCase = union.Cases.Single([Newtonsoft_002EJson_002ENullableContext(0)] (UnionCase c) => c.Tag == tag);
	...
	public override object ReadJson(JsonReader reader, Type objectType, [Newtonsoft_002EJson_002ENullable(2)] object existingValue, JsonSerializer serializer)
	{
		...
		while (reader.TokenType == JsonToken.PropertyName)
		{
			...
			if (string.Equals(text, "Case", StringComparison.OrdinalIgnoreCase))
			{
				...
				unionCase = union.Cases.SingleOrDefault([Newtonsoft_002EJson_002ENullableContext(0)] (UnionCase c) => c.Name == caseName);
				if (unionCase == null)
				{
