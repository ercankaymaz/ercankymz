...
public class XmlNodeConverter : JsonConverter
{
	...
	private void CreateElement(JsonReader reader, IXmlDocument document, IXmlNode currentNode, string elementName, XmlNamespaceManager manager, [Newtonsoft_002EJson_002ENullable(2)] string elementPrefix, [Newtonsoft_002EJson_002ENullable(new byte[] { 2, 1, 2 })] Dictionary<string, string> attributeNameValues)
	{
	...
	private static void AddAttribute(JsonReader reader, IXmlDocument document, IXmlNode currentNode, string propertyName, string attributeName, XmlNamespaceManager manager, [Newtonsoft_002EJson_002ENullable(2)] string attributePrefix)
	{
	...
	private IXmlElement CreateElement(string elementName, IXmlDocument document, [Newtonsoft_002EJson_002ENullable(2)] string elementPrefix, XmlNamespaceManager manager)
	{
	...
	private bool IsNamespaceAttribute(string attributeName, [Newtonsoft_002EJson_002ENullable(2)][Newtonsoft_002EJson1494283_002ENotNullWhen(true)] out string prefix)
	{
