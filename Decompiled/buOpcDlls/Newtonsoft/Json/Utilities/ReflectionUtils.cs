...
internal static class ReflectionUtils
{
	...
	public static string GetTypeName(Type t, TypeNameAssemblyFormatHandling assemblyFormat, [Newtonsoft_002EJson_002ENullable(2)] ISerializationBinder binder)
	{
	...
	private static string GetFullyQualifiedTypeName(Type t, [Newtonsoft_002EJson_002ENullable(2)] ISerializationBinder binder)
	{
		if (binder != null)
		{
	...
	public static ConstructorInfo GetDefaultConstructor(Type t, bool nonPublic)
	{
		...
		return t.GetConstructors(bindingFlags).SingleOrDefault([Newtonsoft_002EJson_002ENullableContext(0)] (ConstructorInfo c) => !c.GetParameters().Any());
	}
	...
	public static bool ImplementsGenericDefinition(Type type, Type genericInterfaceDefinition, [Newtonsoft_002EJson_002ENullable(2)][Newtonsoft_002EJson1494283_002ENotNullWhen(true)] out Type implementingType)
	{
	...
	public static bool InheritsGenericDefinition(Type type, Type genericClassDefinition, [Newtonsoft_002EJson_002ENullable(2)] out Type implementingType)
	{
		ValidationUtils.ArgumentNotNull(type, "type");
	...
	private static bool InheritsGenericDefinitionInternal(Type type, Type genericClassDefinition, [Newtonsoft_002EJson_002ENullable(2)] out Type implementingType)
	{
		Type type2 = type;
		do
		{
	...
	[Newtonsoft_002EJson_002ENullableContext(2)]
	public static void GetDictionaryKeyValueTypes([Newtonsoft_002EJson_002ENullable(1)] Type dictionaryType, out Type keyType, out Type valueType)
	{
	...
	public static void SetMemberValue(MemberInfo member, object target, [Newtonsoft_002EJson_002ENullable(2)] object value)
	{
		ValidationUtils.ArgumentNotNull(member, "member");
		ValidationUtils.ArgumentNotNull(target, "target");
		switch (member.MemberType())
	...
	public static List<MemberInfo> GetFieldsAndProperties(Type type, BindingFlags bindingAttr)
	{
			...
			group m by m.Name)
		{
			...
			foreach (MemberInfo memberInfo in item)
			{
				...
				else if ((!IsOverridenGenericMember(memberInfo, bindingAttr) || memberInfo.Name == "Item") && !list3.Any([Newtonsoft_002EJson_002ENullableContext(0)] (MemberInfo m) => m.DeclaringType == memberInfo.DeclaringType))
				{
					list3.Add(memberInfo);
				}
			}
	...
	[return: Newtonsoft_002EJson_002ENullable(2)]
	public static T GetAttribute<[Newtonsoft_002EJson_002ENullable(0)] T>(object attributeProvider) where T : Attribute
	{
		return GetAttribute<T>(attributeProvider, inherit: true);
	}

	[return: Newtonsoft_002EJson_002ENullable(2)]
	public static T GetAttribute<[Newtonsoft_002EJson_002ENullable(0)] T>(object attributeProvider, bool inherit) where T : Attribute
	{
	...
	public static T[] GetAttributes<[Newtonsoft_002EJson_002ENullable(0)] T>(object attributeProvider, bool inherit) where T : Attribute
	{
	...
	public static Attribute[] GetAttributes(object attributeProvider, [Newtonsoft_002EJson_002ENullable(2)] Type attributeType, bool inherit)
	{
	...
	[return: Newtonsoft_002EJson_002ENullable(new byte[] { 0, 2, 1 })]
		...
		while ((type2 = type2.BaseType()) != null)
		{
			...
			foreach (PropertyInfo propertyInfo in properties)
			{
				...
				if (!subTypeProperty.IsVirtual())
				{
					...
					{
						int num = initialProperties.IndexOf([Newtonsoft_002EJson_002ENullableContext(0)] (PropertyInfo p) => p.Name == subTypeProperty.Name);
						if (num == -1)
						{
					...
					else if (initialProperties.IndexOf([Newtonsoft_002EJson_002ENullableContext(0)] (PropertyInfo p) => p.Name == subTypeProperty.Name && p.DeclaringType == subTypeProperty.DeclaringType) == -1)
					{
						initialProperties.Add(subTypeProperty);
					}
				}
				else
				{
					...
					if (initialProperties.IndexOf([Newtonsoft_002EJson_002ENullableContext(0)] (PropertyInfo p) => p.Name == subTypeProperty.Name && p.IsVirtual() && (p.GetBaseDefinition()?.DeclaringType ?? p.DeclaringType).IsAssignableFrom(subTypePropertyDeclaringType)) == -1)
					{
						initialProperties.Add(subTypeProperty);
					}
				}
	...
	{
		return currentType.GetMethods(BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic).Any([Newtonsoft_002EJson_002ENullableContext(0)] (MethodInfo info) => info.Name == method && info.DeclaringType != methodDeclaringType && info.GetBaseDefinition().DeclaringType == methodDeclaringType);
	}
