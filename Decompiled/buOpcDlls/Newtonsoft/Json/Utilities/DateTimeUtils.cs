...
internal static class DateTimeUtils
{
	...
	internal static bool TryParseDateTime(StringReference s, DateTimeZoneHandling dateTimeZoneHandling, [Newtonsoft_002EJson_002ENullable(2)] string dateFormatString, CultureInfo culture, out DateTime dt)
	{
		if (s.Length > 0)
		{
	...
	internal static bool TryParseDateTime(string s, DateTimeZoneHandling dateTimeZoneHandling, [Newtonsoft_002EJson_002ENullable(2)] string dateFormatString, CultureInfo culture, out DateTime dt)
	{
		if (s.Length > 0)
		{
			if (s[0] == '/')
	...
	internal static bool TryParseDateTimeOffset(StringReference s, [Newtonsoft_002EJson_002ENullable(2)] string dateFormatString, CultureInfo culture, out DateTimeOffset dt)
	{
		if (s.Length > 0)
		{
			int startIndex = s.StartIndex;
	...
	internal static bool TryParseDateTimeOffset(string s, [Newtonsoft_002EJson_002ENullable(2)] string dateFormatString, CultureInfo culture, out DateTimeOffset dt)
	{
		if (s.Length > 0)
		{
			if (s[0] == '/')
	...
	internal static void WriteDateTimeString(TextWriter writer, DateTime value, DateFormatHandling format, [Newtonsoft_002EJson_002ENullable(2)] string formatString, CultureInfo culture)
	{
	...
	internal static void WriteDateTimeOffsetString(TextWriter writer, DateTimeOffset value, DateFormatHandling format, [Newtonsoft_002EJson_002ENullable(2)] string formatString, CultureInfo culture)
	{
		if (StringUtils.IsNullOrEmpty(formatString))
		{
			char[] array = new char[64];
