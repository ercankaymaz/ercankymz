...
internal struct StructMultiKey<[Newtonsoft_002EJson_002ENullable(2)] T1, [Newtonsoft_002EJson_002ENullable(2)] T2>(T1 v1, T2 v2) : IEquatable<StructMultiKey<T1, T2>>
{
	...
	public bool Equals([Newtonsoft_002EJson_002ENullable(new byte[] { 0, 1, 1 })] StructMultiKey<T1, T2> other)
	{
