...
internal static class ImmutableCollectionsUtils
{
	...
	internal static bool TryBuildImmutableForArrayContract(Type underlyingType, Type collectionItemType, [Newtonsoft_002EJson_002ENullable(2)][Newtonsoft_002EJson1494283_002ENotNullWhen(true)] out Type createdType, [Newtonsoft_002EJson_002ENullable(new byte[] { 2, 1 })][Newtonsoft_002EJson1494283_002ENotNullWhen(true)] out ObjectConstructor<object> parameterizedCreator)
	{
		if (underlyingType.IsGenericType())
		{
			Type genericTypeDefinition = underlyingType.GetGenericTypeDefinition();
			string name = genericTypeDefinition.FullName;
			ImmutableCollectionTypeInfo immutableCollectionTypeInfo = ArrayContractImmutableCollectionDefinitions.FirstOrDefault([Newtonsoft_002EJson_002ENullableContext(0)] (ImmutableCollectionTypeInfo d) => d.ContractTypeName == name);
			if (immutableCollectionTypeInfo != null)
			{
				...
				{
					MethodInfo methodInfo = type2.GetMethods().FirstOrDefault([Newtonsoft_002EJson_002ENullableContext(0)] (MethodInfo m) => m.Name == "CreateRange" && m.GetParameters().Length == 1);
					if (methodInfo != null)
					{
	...
	internal static bool TryBuildImmutableForDictionaryContract(Type underlyingType, Type keyItemType, Type valueItemType, [Newtonsoft_002EJson_002ENullable(2)][Newtonsoft_002EJson1494283_002ENotNullWhen(true)] out Type createdType, [Newtonsoft_002EJson_002ENullable(new byte[] { 2, 1 })][Newtonsoft_002EJson1494283_002ENotNullWhen(true)] out ObjectConstructor<object> parameterizedCreator)
	{
		if (underlyingType.IsGenericType())
		{
			Type genericTypeDefinition = underlyingType.GetGenericTypeDefinition();
			string name = genericTypeDefinition.FullName;
			ImmutableCollectionTypeInfo immutableCollectionTypeInfo = DictionaryContractImmutableCollectionDefinitions.FirstOrDefault([Newtonsoft_002EJson_002ENullableContext(0)] (ImmutableCollectionTypeInfo d) => d.ContractTypeName == name);
			if (immutableCollectionTypeInfo != null)
			{
				Type type = genericTypeDefinition.Assembly().GetType(immutableCollectionTypeInfo.CreatedTypeName);
				Type type2 = genericTypeDefinition.Assembly().GetType(immutableCollectionTypeInfo.BuilderTypeName);
				if (type != null && type2 != null)
				{
					MethodInfo methodInfo = type2.GetMethods().FirstOrDefault([Newtonsoft_002EJson_002ENullableContext(0)] (MethodInfo m) =>
					{
