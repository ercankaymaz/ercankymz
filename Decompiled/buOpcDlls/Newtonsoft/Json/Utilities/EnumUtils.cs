...
internal static class EnumUtils
{
	...
	[Newtonsoft_002EJson_002ENullable(new byte[] { 1, 0, 1, 2, 1 })]
	...
	private static EnumInfo InitializeValuesAndNames([Newtonsoft_002EJson_002ENullable(new byte[] { 0, 1, 2 })] StructMultiKey<Type, NamingStrategy> key)
	{
	...
	[return: Newtonsoft_002EJson_002ENullable(new byte[] { 1, 0 })]
	...
	public static bool TryToString(Type enumType, object value, bool camelCase, [Newtonsoft_002EJson_002ENullable(2)][Newtonsoft_002EJson1494283_002ENotNullWhen(true)] out string name)
	{
		return TryToString(enumType, value, camelCase ? _camelCaseNamingStrategy : null, out name);
	}

	public static bool TryToString(Type enumType, object value, [Newtonsoft_002EJson_002ENullable(2)] NamingStrategy namingStrategy, [Newtonsoft_002EJson_002ENullable(2)][Newtonsoft_002EJson1494283_002ENotNullWhen(true)] out string name)
	{
	...
	public static object ParseEnum(Type enumType, [Newtonsoft_002EJson_002ENullable(2)] NamingStrategy namingStrategy, string value, bool disallowNumber)
	{
