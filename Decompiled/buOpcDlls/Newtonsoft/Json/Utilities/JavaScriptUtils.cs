...
internal static class JavaScriptUtils
{
	...
	public static bool ShouldEscapeJavaScriptString([Newtonsoft_002EJson_002ENullable(2)] string s, bool[] charEscapeFlags)
	{
		if (s == null)
		{
			return false;
	...
	public static void WriteEscapedJavaScriptString([Newtonsoft_002EJson_002ENullable(1)] TextWriter writer, string s, char delimiter, bool appendDelimiters, [Newtonsoft_002EJson_002ENullable(1)] bool[] charEscapeFlags, StringEscapeHandling stringEscapeHandling, IArrayPool<char> bufferPool, ref char[] writeBuffer)
	{
		if (appendDelimiters)
		{
	...
	public static string ToEscapedJavaScriptString([Newtonsoft_002EJson_002ENullable(2)] string value, char delimiter, bool appendDelimiters, StringEscapeHandling stringEscapeHandling)
	{
	...
	public static bool TryGetDateFromConstructorJson(JsonReader reader, out DateTime dateTime, [Newtonsoft_002EJson_002ENullable(2)][Newtonsoft_002EJson1494283_002ENotNullWhen(false)] out string errorMessage)
	{
	...
	private static bool TryGetDateConstructorValue(JsonReader reader, out long? integer, [Newtonsoft_002EJson_002ENullable(2)][Newtonsoft_002EJson1494283_002ENotNullWhen(false)] out string errorMessage)
	{
		integer = null;
		errorMessage = null;
		if (!reader.Read())
