...
internal class DynamicReflectionDelegateFactory : ReflectionDelegateFactory
{
	...
	private static DynamicMethod CreateDynamicMethod(string name, [Newtonsoft_002EJson_002ENullable(2)] Type returnType, Type[] parameterTypes, Type owner)
	{
	...
	public override Func<T, object> CreateGet<[Newtonsoft_002EJson_002ENullable(2)] T>(FieldInfo fieldInfo)
	{
		if (fieldInfo.IsLiteral)
		{
			...
			return [Newtonsoft_002EJson_002ENullableContext(0)] [return: Newtonsoft_002EJson_002ENullable(2)] (T o) => constantValue;
		}
