...
internal class DictionaryWrapper<[Newtonsoft_002EJson_002ENullable(2)] TKey, [Newtonsoft_002EJson_002ENullable(2)] TValue> : IDictionary<TKey, TValue>, ICollection<KeyValuePair<TKey, TValue>>, IEnumerable<KeyValuePair<TKey, TValue>>, IEnumerable, IWrappedDictionary, IDictionary, ICollection
{
	[Newtonsoft_002EJson_002ENullable(0)]
	[Newtonsoft_002EJson_002EIsReadOnly]
	private struct DictionaryEnumerator<[Newtonsoft_002EJson_002ENullable(2)] TEnumeratorKey, [Newtonsoft_002EJson_002ENullable(2)] TEnumeratorValue> : IDictionaryEnumerator, IEnumerator
	{
		...
		public DictionaryEnumerator([Newtonsoft_002EJson_002ENullable(new byte[] { 1, 0, 1, 1 })] IEnumerator<KeyValuePair<TEnumeratorKey, TEnumeratorValue>> e)
		{
	...
	public bool TryGetValue(TKey key, [Newtonsoft_002EJson_002ENullable(2)] out TValue value)
	{
		if (_dictionary != null)
		{
			if (!_dictionary.Contains(key))
	...
	public void Add([Newtonsoft_002EJson_002ENullable(new byte[] { 0, 1, 1 })] KeyValuePair<TKey, TValue> item)
	{
		if (_dictionary != null)
		{
	...
	public bool Contains([Newtonsoft_002EJson_002ENullable(new byte[] { 0, 1, 1 })] KeyValuePair<TKey, TValue> item)
	{
		if (_dictionary != null)
		{
	...
	public void CopyTo([Newtonsoft_002EJson_002ENullable(new byte[] { 1, 0, 1, 1 })] KeyValuePair<TKey, TValue>[] array, int arrayIndex)
	{
		if (_dictionary != null)
		{
	...
	public bool Remove([Newtonsoft_002EJson_002ENullable(new byte[] { 0, 1, 1 })] KeyValuePair<TKey, TValue> item)
	{
		if (_dictionary != null)
		{
	...
	void IDictionary.Add(object key, [Newtonsoft_002EJson_002ENullable(2)] object value)
	{
		if (_dictionary != null)
		{
			_dictionary.Add(key, value);
