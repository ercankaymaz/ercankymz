...
internal static class ConvertUtils
{
	...
	[Newtonsoft_002EJson_002ENullable(new byte[] { 1, 0, 1, 1, 2, 2, 2 })]
	...
	private static Func<object, object> CreateCastConverter([Newtonsoft_002EJson_002ENullable(new byte[] { 0, 1, 1 })] StructMultiKey<Type, Type> t)
	{
		Type value = t.Value1;
		...
		return [Newtonsoft_002EJson_002ENullableContext(2)] (object o) => call(null, o);
	}
	...
	private static bool TryConvert([Newtonsoft_002EJson_002ENullable(2)] object initialValue, CultureInfo culture, Type targetType, [Newtonsoft_002EJson_002ENullable(2)] out object value)
	{
		try
		{
	...
	private static ConvertResult TryConvertInternal([Newtonsoft_002EJson_002ENullable(2)] object initialValue, CultureInfo culture, Type targetType, [Newtonsoft_002EJson_002ENullable(2)] out object value)
	{
	...
	public static object ConvertOrCast([Newtonsoft_002EJson_002ENullable(2)] object initialValue, CultureInfo culture, Type targetType)
	{
	...
	[return: Newtonsoft_002EJson_002ENullable(2)]
	private static object EnsureTypeAssignable([Newtonsoft_002EJson_002ENullable(2)] object value, Type initialType, Type targetType)
	{
		if (value != null)
		{
	...
	public static bool VersionTryParse(string input, [Newtonsoft_002EJson_002ENullable(2)][Newtonsoft_002EJson1494283_002ENotNullWhen(true)] out Version result)
	{
