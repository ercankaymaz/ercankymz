...
internal class FSharpUtils
{
	...
	[field: Newtonsoft_002EJson_002ENullable(new byte[] { 1, 2, 1 })]
	public MethodCall<object, object> IsUnion
	{
		[return: Newtonsoft_002EJson_002ENullable(new byte[] { 1, 2, 1 })]
		get;
		[param: Newtonsoft_002EJson_002ENullable(new byte[] { 1, 2, 1 })]
		private set;
	}
	...
	private static MethodCall<object, object> CreateFSharpFuncCall(Type type, string methodName)
	{
		...
		return ([Newtonsoft_002EJson_002ENullable(2)] object target, [Newtonsoft_002EJson_002ENullable(new byte[] { 1, 2 })] object[] args) => new FSharpFunction(call(target, args), invoke);
	}
	...
	public ObjectConstructor<object> BuildMapCreator<TKey, TValue>()
	{
		...
		return ([Newtonsoft_002EJson_002ENullable(new byte[] { 1, 2 })] object[] args) =>
		{
			IEnumerable<Tuple<TKey, TValue>> enumerable = ((IEnumerable<KeyValuePair<TKey, TValue>>)args[0]).Select([Newtonsoft_002EJson_002ENullableContext(0)] (KeyValuePair<TKey, TValue> kv) => new Tuple<TKey, TValue>(kv.Key, kv.Value));
