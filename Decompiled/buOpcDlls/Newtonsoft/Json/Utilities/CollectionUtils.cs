...
internal static class CollectionUtils
{
	...
	private static class EmptyArrayContainer<[Newtonsoft_002EJson_002ENullable(2)] T>
	{
		[Newtonsoft_002EJson_002ENullable(1)]
		public static readonly T[] Empty = new T[0];
	}

	public static bool IsNullOrEmpty<[Newtonsoft_002EJson_002ENullable(2)] T>(ICollection<T> collection)
	{
		if (collection != null)
		{
	...
	public static void AddRange<[Newtonsoft_002EJson_002ENullable(2)] T>(this IList<T> initial, IEnumerable<T> collection)
	{
		if (initial == null)
		{
	...
	public static bool AddDistinct<[Newtonsoft_002EJson_002ENullable(2)] T>(this IList<T> list, T value)
	{
		return list.AddDistinct(value, EqualityComparer<T>.Default);
	}

	public static bool AddDistinct<[Newtonsoft_002EJson_002ENullable(2)] T>(this IList<T> list, T value, IEqualityComparer<T> comparer)
	{
	...
	public static bool ContainsValue<[Newtonsoft_002EJson_002ENullable(2)] TSource>(this IEnumerable<TSource> source, TSource value, IEqualityComparer<TSource> comparer)
	{
		if (comparer == null)
		{
	...
	public static bool AddRangeDistinct<[Newtonsoft_002EJson_002ENullable(2)] T>(this IList<T> list, IEnumerable<T> values, IEqualityComparer<T> comparer)
	{
		bool result = true;
	...
	public static int IndexOf<[Newtonsoft_002EJson_002ENullable(2)] T>(this IEnumerable<T> collection, Func<T, bool> predicate)
	{
		int num = 0;
		foreach (T item in collection)
		{
	...
	public static bool Contains<[Newtonsoft_002EJson_002ENullable(2)] T>(this List<T> list, T value, IEqualityComparer comparer)
	{
	...
	public static int IndexOfReference<[Newtonsoft_002EJson_002ENullable(2)] T>(this List<T> list, T item)
	{
		for (int i = 0; i < list.Count; i++)
		{
	...
	public static void FastReverse<[Newtonsoft_002EJson_002ENullable(2)] T>(this List<T> list)
	{
		int num = 0;
	...
	public static T[] ArrayEmpty<[Newtonsoft_002EJson_002ENullable(2)] T>()
	{
