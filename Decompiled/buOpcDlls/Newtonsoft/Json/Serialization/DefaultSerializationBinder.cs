...
public class DefaultSerializationBinder : SerializationBinder, ISerializationBinder
{
	...
	[Newtonsoft_002EJson_002ENullable(new byte[] { 1, 0, 2, 1, 1 })]
	...
	private Type GetTypeFromTypeNameKey([Newtonsoft_002EJson_002ENullable(new byte[] { 0, 2, 1 })] StructMultiKey<string, string> typeNameKey)
	{
	...
	private Type GetTypeByName([Newtonsoft_002EJson_002ENullable(new byte[] { 0, 2, 1 })] StructMultiKey<string, string> typeNameKey)
	{
		return _typeCache.Get(typeNameKey);
	}

	public override Type BindToType([Newtonsoft_002EJson_002ENullable(2)] string assemblyName, string typeName)
	{
		return GetTypeByName(new StructMultiKey<string, string>(assemblyName, typeName));
	}

	[Newtonsoft_002EJson_002ENullableContext(2)]
	public override void BindToName([Newtonsoft_002EJson_002ENullable(1)] Type serializedType, out string assemblyName, out string typeName)
	{
