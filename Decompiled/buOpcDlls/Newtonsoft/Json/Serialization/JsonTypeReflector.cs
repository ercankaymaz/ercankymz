...
internal static class JsonTypeReflector
{
	...
	[Newtonsoft_002EJson_002ENullable(new byte[] { 1, 1, 1, 2, 1, 1 })]
	...
	public static T GetCachedAttribute<[Newtonsoft_002EJson_002ENullable(0)] T>(object attributeProvider) where T : Attribute
	{
	...
	public static JsonConverter CreateJsonConverterInstance(Type converterType, [Newtonsoft_002EJson_002ENullable(new byte[] { 2, 1 })] object[] args)
	{
		return (JsonConverter)CreatorCache.Get(converterType)(args);
	}

	public static NamingStrategy CreateNamingStrategyInstance(Type namingStrategyType, [Newtonsoft_002EJson_002ENullable(new byte[] { 2, 1 })] object[] args)
	{
	...
	[return: Newtonsoft_002EJson_002ENullable(new byte[] { 1, 2, 1, 1 })]
	private static Func<object[], object> GetCreator(Type type)
	{
		...
		return ([Newtonsoft_002EJson_002ENullable(new byte[] { 2, 1 })] object[] parameters) =>
		{
			try
			{
				if (parameters != null)
				{
					Type[] types = parameters.Select([Newtonsoft_002EJson_002ENullableContext(0)] (object param) =>
					{
						if (param == null)
						{
	...
	[return: Newtonsoft_002EJson_002ENullable(2)]
	private static T GetAttribute<[Newtonsoft_002EJson_002ENullable(0)] T>(Type type) where T : Attribute
	{
	...
	[return: Newtonsoft_002EJson_002ENullable(2)]
	private static T GetAttribute<[Newtonsoft_002EJson_002ENullable(0)] T>(MemberInfo memberInfo) where T : Attribute
	{
	...
	[return: Newtonsoft_002EJson_002ENullable(2)]
	public static T GetAttribute<[Newtonsoft_002EJson_002ENullable(0)] T>(object provider) where T : Attribute
	{
