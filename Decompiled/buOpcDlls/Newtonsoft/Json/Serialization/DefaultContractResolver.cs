...
public class DefaultContractResolver : IContractResolver
{
	...
	internal class EnumerableDictionaryWrapper<[Newtonsoft_002EJson_002ENullable(2)] TEnumeratorKey, [Newtonsoft_002EJson_002ENullable(2)] TEnumeratorValue> : IEnumerable<KeyValuePair<object, object>>, IEnumerable
	{
		[Newtonsoft_002EJson_002ENullable(new byte[] { 1, 0, 1, 1 })]
		private readonly IEnumerable<KeyValuePair<TEnumeratorKey, TEnumeratorValue>> _e;

		public EnumerableDictionaryWrapper([Newtonsoft_002EJson_002ENullable(new byte[] { 1, 0, 1, 1 })] IEnumerable<KeyValuePair<TEnumeratorKey, TEnumeratorValue>> e)
		{
			ValidationUtils.ArgumentNotNull(e, "e");
			_e = e;
		}

		[return: Newtonsoft_002EJson_002ENullable(new byte[] { 1, 0, 1, 1 })]
	...
	protected virtual List<MemberInfo> GetSerializableMembers(Type objectType)
	{
		...
		if (objectMemberSerialization != MemberSerialization.Fields)
		{
			...
			{
				list = list.Where([Newtonsoft_002EJson_002ENullableContext(0)] (MemberInfo m) => !string.Equals(m.Name, "TargetSite", StringComparison.Ordinal)).ToList();
			}
		}
		else
		{
	...
	{
		return GetClassHierarchyForType(type).SelectMany([Newtonsoft_002EJson_002ENullableContext(0)] (Type baseType) =>
		{
			List<MemberInfo> list = new List<MemberInfo>();
			...
			return list;
		}).LastOrDefault([Newtonsoft_002EJson_002ENullableContext(0)] (MemberInfo m) =>
		{
	...
	private static void SetExtensionDataDelegates(JsonObjectContract contract, MemberInfo member)
	{
		...
		if (attribute.ReadData)
		{
			...
			ExtensionDataSetter extensionDataSetter = (object o, string key, [Newtonsoft_002EJson_002ENullable(2)] object value) =>
			{
		...
		if (attribute.WriteData)
		{
			...
			ExtensionDataGetter extensionDataGetter = [return: Newtonsoft_002EJson_002ENullable(new byte[] { 2, 0, 1, 1 })] (object o) =>
			{
				object obj = getExtensionDataDictionary(o);
	...
	protected virtual JsonProperty CreatePropertyFromConstructorParameter([Newtonsoft_002EJson_002ENullable(2)] JsonProperty matchingMemberProperty, ParameterInfo parameterInfo)
	{
	...
	private void GetCallbackMethodsForType(Type type, [Newtonsoft_002EJson_002ENullable(new byte[] { 2, 1 })] out List<SerializationCallback> onSerializing, [Newtonsoft_002EJson_002ENullable(new byte[] { 2, 1 })] out List<SerializationCallback> onSerialized, [Newtonsoft_002EJson_002ENullable(new byte[] { 2, 1 })] out List<SerializationCallback> onDeserializing, [Newtonsoft_002EJson_002ENullable(new byte[] { 2, 1 })] out List<SerializationCallback> onDeserialized, [Newtonsoft_002EJson_002ENullable(new byte[] { 2, 1 })] out List<SerializationErrorCallback> onError)
	{
		onSerializing = null;
		onSerialized = null;
	...
	private static bool IsValidCallback(MethodInfo method, ParameterInfo[] parameters, Type attributeType, [Newtonsoft_002EJson_002ENullable(2)] MethodInfo currentCallback, [Newtonsoft_002EJson_002ENullable(2)] ref Type prevAttributeType)
	{
	...
	protected virtual IList<JsonProperty> CreateProperties(Type type, MemberSerialization memberSerialization)
	{
		...
		return jsonPropertyCollection.OrderBy([Newtonsoft_002EJson_002ENullableContext(0)] (JsonProperty p) => p.Order ?? (-1)).ToList();
	}
