...
public abstract class JsonWriter : IDisposable
{
	...
	public virtual Task WriteRawAsync([Newtonsoft_002EJson_002ENullable(2)] string json, CancellationToken cancellationToken = default(CancellationToken))
	{
		if (cancellationToken.IsCancellationRequested)
		{
			return cancellationToken.FromCanceled();
	...
	public virtual Task WriteCommentAsync([Newtonsoft_002EJson_002ENullable(2)] string text, CancellationToken cancellationToken = default(CancellationToken))
	{
		if (cancellationToken.IsCancellationRequested)
		{
			return cancellationToken.FromCanceled();
	...
	public virtual Task WriteRawValueAsync([Newtonsoft_002EJson_002ENullable(2)] string json, CancellationToken cancellationToken = default(CancellationToken))
	{
		if (cancellationToken.IsCancellationRequested)
		{
			return cancellationToken.FromCanceled();
	...
	public Task WriteTokenAsync(JsonToken token, [Newtonsoft_002EJson_002ENullable(2)] object value, CancellationToken cancellationToken = default(CancellationToken))
	{
		if (cancellationToken.IsCancellationRequested)
		{
			return cancellationToken.FromCanceled();
	...
	public virtual Task WriteValueAsync([Newtonsoft_002EJson_002ENullable(2)] byte[] value, CancellationToken cancellationToken = default(CancellationToken))
	{
		if (cancellationToken.IsCancellationRequested)
		{
			return cancellationToken.FromCanceled();
	...
	public virtual Task WriteValueAsync([Newtonsoft_002EJson_002ENullable(2)] object value, CancellationToken cancellationToken = default(CancellationToken))
	{
		if (cancellationToken.IsCancellationRequested)
		{
			return cancellationToken.FromCanceled();
	...
	public virtual Task WriteValueAsync([Newtonsoft_002EJson_002ENullable(2)] string value, CancellationToken cancellationToken = default(CancellationToken))
	{
		if (cancellationToken.IsCancellationRequested)
		{
			return cancellationToken.FromCanceled();
	...
	public virtual Task WriteValueAsync([Newtonsoft_002EJson_002ENullable(2)] Uri value, CancellationToken cancellationToken = default(CancellationToken))
	{
		if (cancellationToken.IsCancellationRequested)
		{
			return cancellationToken.FromCanceled();
