...
internal struct JsonPosition(JsonContainerType type)
{
	...
	internal void WriteTo([Newtonsoft_002EJson_002ENullable(1)] StringBuilder sb, ref StringWriter writer, ref char[] buffer)
	{
		switch (Type)
		{
		case JsonContainerType.Object:
	...
	internal static string FormatMessage([Newtonsoft_002EJson_002ENullable(2)] IJsonLineInfo lineInfo, string path, string message)
	{
