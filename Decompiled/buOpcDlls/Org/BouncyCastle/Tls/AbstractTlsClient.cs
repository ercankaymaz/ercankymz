...
public abstract class AbstractTlsClient : AbstractTlsPeer, TlsClient, TlsPeer
{
	...
	public virtual IDictionary<int, byte[]> GetClientExtensions()
	{
		...
		if (allowedClientCertificateTypes != null && (allowedClientCertificateTypes.Length > 1 || allowedClientCertificateTypes[0] != 0))
		{
		...
		if (allowedServerCertificateTypes != null && (allowedServerCertificateTypes.Length > 1 || allowedServerCertificateTypes[0] != 0))
		{
