...
public static class SignerUtilities
{
	...
	static SignerUtilities()
	{
		...
		AlgorithmMap[RosstandartObjectIdentifiers.id_tc26_signwithdigest_gost_3410_12_256.Id] = "ECGOST3410-2012-256";
		...
		AlgorithmMap[RosstandartObjectIdentifiers.id_tc26_signwithdigest_gost_3410_12_512.Id] = "ECGOST3410-2012-512";
	...
	public static DerObjectIdentifier GetObjectIdentifier(string mechanism)
	{
		...
		string valueOrKey = CollectionUtilities.GetValueOrKey(AlgorithmMap, mechanism);
		return CollectionUtilities.GetValueOrNull(Oids, valueOrKey);
	}
	...
	public static Asn1Encodable GetDefaultX509Parameters(string algorithm)
	{
		...
		string valueOrKey = CollectionUtilities.GetValueOrKey(AlgorithmMap, algorithm);
		if (valueOrKey == "PSSwithRSA")
		{
			return GetPssX509Parameters("SHA-1");
		}
		if (Platform.EndsWith(valueOrKey, "withRSAandMGF1"))
		{
			return GetPssX509Parameters(valueOrKey.Substring(0, valueOrKey.Length - "withRSAandMGF1".Length));
		}
	...
	public static ISigner GetSigner(string algorithm)
	{
		...
		return GetSignerForMechanism(GetMechanism(algorithm)) ?? throw new SecurityUtilityException("Signer " + algorithm + " not recognised.");
	}
	...
	public static ISigner InitSigner(string algorithm, bool forSigning, AsymmetricKeyParameter privateKey, SecureRandom random)
	{
		...
		ISigner obj = GetSignerForMechanism(mechanism) ?? throw new SecurityUtilityException("Signer " + algorithm + " not recognised.");
		...
		obj.Init(forSigning, cipherParameters);
		return obj;
	}
}
