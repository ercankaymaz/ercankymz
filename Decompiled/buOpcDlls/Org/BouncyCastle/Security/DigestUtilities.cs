...
public static class DigestUtilities
{
	...
	public static IDigest GetDigest(string algorithm)
	{
		...
		string text = CollectionUtilities.GetValueOrKey(Aliases, algorithm).ToUpperInvariant();
		try
		{
			switch (Enums.GetEnumValue<DigestAlgorithm>(text))
			{
		...
		throw new SecurityUtilityException("Digest " + text + " not recognised.");
	}
