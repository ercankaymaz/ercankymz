...
public static class PublicKeyFactory
{
	...
	public static AsymmetricKeyParameter CreateKey(SubjectPublicKeyInfo keyInfo)
	{
		...
		{
			X962Parameters instance6 = X962Parameters.GetInstance(algorithmID.Parameters.ToAsn1Object());
		...
		{
			Gost3410PublicKeyAlgParameters instance7 = Gost3410PublicKeyAlgParameters.GetInstance(algorithmID.Parameters);
			...
			return new Gost3410PublicKeyParameters(new BigInteger(1, bytes2), instance7.PublicKeyParamSet);
		}
