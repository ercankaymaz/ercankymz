...
public class CertificateRequestMessageBuilder
{
	...
	public CertificateRequestMessage Build()
	{
		...
		if (_popSigner != null)
		{
			...
			{
				ProofOfPossessionSigningKeyBuilder proofOfPossessionSigningKeyBuilder = new ProofOfPossessionSigningKeyBuilder(instance.CertTemplate.PublicKey);
				if (_sender != null)
				{
		...
		{
			asn1EncodableVector.Add(new ProofOfPossession(3, new PopoPrivKey(_agreeMac)));
		}
