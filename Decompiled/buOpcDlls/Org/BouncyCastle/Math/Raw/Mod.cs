...
internal static class Mod
{
	...
	public static uint ModOddInverse(uint[] m, uint[] x, uint[] z)
	{
		...
		{
			delta = Divsteps30(delta, array3[0], array4[0], t);
	...
	public static bool ModOddInverseVar(uint[] m, uint[] x, uint[] z)
	{
		...
		int maximumDivsteps = GetMaximumDivsteps(num2);
		int num7 = 0;
		while (!EqualToZeroVar_Unlikely(num6, array4))
		{
			...
			if (((num6 - 2 >> 31) | (num8 ^ (num8 >> 31)) | (num9 ^ (num9 >> 31))) == 0)
			{
				array3[num6 - 2] |= num8 << 30;
				array4[num6 - 2] |= num9 << 30;
				num6--;
			}
		}
		int num10 = array3[num6 - 1] >> 31;
		int num11 = array[num5 - 1] >> 31;
		if (num11 < 0)
		{
			num11 = Add30(num5, array, array5);
		}
		if (num10 < 0)
		{
			num11 = Negate30(num5, array);
			Negate30(num6, array3);
		}
		if (!EqualToOneVar_Expected(num6, array3))
		{
			return false;
		}
		if (num11 < 0)
