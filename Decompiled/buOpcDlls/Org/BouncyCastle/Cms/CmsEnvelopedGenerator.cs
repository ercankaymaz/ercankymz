...
public abstract class CmsEnvelopedGenerator
{
	...
	public void AddKeyTransRecipient(X509Certificate cert)
	{
		...
		AddRecipientInfoGenerator(new KeyTransRecipientInfoGenerator(cert, new Asn1KeyWrapper(subjectPublicKeyInfo.AlgorithmID.Algorithm, subjectPublicKeyInfo.AlgorithmID.Parameters, cert)));
	}
	...
	public void AddKeyTransRecipient(AsymmetricKeyParameter pubKey, byte[] subKeyId)
	{
		...
		AddRecipientInfoGenerator(new KeyTransRecipientInfoGenerator(subKeyId, new Asn1KeyWrapper(subjectPublicKeyInfo.AlgorithmID.Algorithm, subjectPublicKeyInfo.AlgorithmID.Parameters, pubKey)));
	}
