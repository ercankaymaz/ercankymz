...
public class DefaultSignedAttributeTableGenerator : CmsAttributeTableGenerator
{
	...
	private void DoCreateStandardAttributeTable(IDictionary<CmsAttributeTableParameter, object> parameters, IDictionary<DerObjectIdentifier, object> std)
	{
		...
		{
			Org.BouncyCastle.Asn1.Cms.Attribute attribute = new Org.BouncyCastle.Asn1.Cms.Attribute(CmsAttributes.ContentType, new DerSet((DerObjectIdentifier)value));
		...
		if (!std.ContainsKey(CmsAttributes.MessageDigest))
		{
			...
			Org.BouncyCastle.Asn1.Cms.Attribute attribute3 = new Org.BouncyCastle.Asn1.Cms.Attribute(CmsAttributes.MessageDigest, new DerSet(new DerOctetString(contents)));
