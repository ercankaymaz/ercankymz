...
public class CmsCompressedDataStreamGenerator
{
	...
	public Stream Open(Stream outStream, string contentOid, string compressionOid)
	{
		...
		return new CmsCompressedOutputStream(Org.BouncyCastle.Utilities.IO.Compression.ZLib.CompressOutput(berOctetStringGenerator.GetOctetOutputStream(_bufferSize), -1), berSequenceGenerator, berSequenceGenerator2, berSequenceGenerator3, berOctetStringGenerator);
	}
}
