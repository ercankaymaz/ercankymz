...
public class Asn1UtcTime : Asn1Object
{
	...
	public DateTime ToDateTime(int twoDigitYearMax)
	{
		...
		return m_dateTime.AddYears(num4 - m_dateTime.Year);
	}
	...
	{
		if (encoding == 2 && m_timeString.Length != 13)
		{
	...
	{
		return new PrimitiveDerEncoding(0, 23, GetContents(2));
	}

	internal sealed override DerEncoding GetEncodingDerImplicit(int tagClass, int tagNo)
	{
		return new PrimitiveDerEncoding(tagClass, tagNo, GetContents(2));
	}
	...
	protected override bool Asn1Equals(Asn1Object asn1Object)
	{
		...
		return Arrays.AreEqual(GetContents(2), asn1UtcTime.GetContents(2));
	}

	protected override int Asn1GetHashCode()
	{
		return Arrays.GetHashCode(GetContents(2));
	}
