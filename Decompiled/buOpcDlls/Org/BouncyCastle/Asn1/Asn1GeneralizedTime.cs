...
public class Asn1GeneralizedTime : Asn1Object
{
	...
	{
		if (encoding == 2 && !m_timeStringCanonical)
		{
	...
	{
		return new PrimitiveDerEncoding(0, 24, GetContents(2));
	}
	...
	protected override bool Asn1Equals(Asn1Object asn1Object)
	{
		...
		return Arrays.AreEqual(GetContents(2), asn1GeneralizedTime.GetContents(2));
	}
