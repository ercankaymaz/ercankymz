...
public class BerTaggedObject : DerTaggedObject
{
	...
	internal override IAsn1Encoding GetEncoding(int encoding)
	{
		...
		return new ConstructedILEncoding(base.TagClass, base.TagNo, new IAsn1Encoding[1] { asn1Object.GetEncoding(encoding) });
	}
	...
	internal override IAsn1Encoding GetEncodingImplicit(int encoding, int tagClass, int tagNo)
	{
		...
		return new ConstructedILEncoding(tagClass, tagNo, new IAsn1Encoding[1] { asn1Object.GetEncoding(encoding) });
	}
