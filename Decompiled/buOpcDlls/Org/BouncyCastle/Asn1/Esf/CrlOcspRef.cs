...
public class CrlOcspRef : Asn1Encodable
{
	...
	public override Asn1Object ToAsn1Object()
	{
		...
		if (crlids != null)
		{
			asn1EncodableVector.Add(new DerTaggedObject(isExplicit: true, 0, crlids.ToAsn1Object()));
		}
		if (ocspids != null)
		{
			asn1EncodableVector.Add(new DerTaggedObject(isExplicit: true, 1, ocspids.ToAsn1Object()));
		}
		if (otherRev != null)
		{
			asn1EncodableVector.Add(new DerTaggedObject(isExplicit: true, 2, otherRev.ToAsn1Object()));
		}
