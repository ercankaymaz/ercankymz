...
public class DerExternal : Asn1Object
{
	...
	{
		return BuildSequence().GetEncodingImplicit(2, 0, 8);
	}
	...
	{
		return BuildSequence().GetEncodingDerImplicit(0, 8);
	}
	...
	private static Asn1Object GetExternalContent(Asn1TaggedObject encoding)
	{
		...
		return tagNo switch
		{
			...
			_ => throw new ArgumentException("invalid tag: " + Asn1Utilities.GetTagText(tagClass, tagNo), "encoding"), 
		};
	}
