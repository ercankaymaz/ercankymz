...
public class Asn1InputStream : FilterStream
{
	...
	internal static Asn1Object CreatePrimitiveDerObject(int tagNo, DefiniteLengthInputStream defIn, byte[][] tmpBuffers)
	{
		...
		case 1:
		{
			GetBuffer(defIn, tmpBuffers, out var contents4);
			return DerBoolean.CreatePrimitive(contents4);
		}
		case 10:
		{
			byte[] contents3;
			bool buffer2 = GetBuffer(defIn, tmpBuffers, out contents3);
			return DerEnumerated.CreatePrimitive(contents3, buffer2);
		}
		case 6:
		{
			byte[] contents2;
			bool buffer = GetBuffer(defIn, tmpBuffers, out contents2);
			return DerObjectIdentifier.CreatePrimitive(contents2, buffer);
		}
		default:
		{
			...
			case 13:
				return Asn1RelativeOid.CreatePrimitive(contents, clone: false);
			case 20:
