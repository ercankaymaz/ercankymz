...
public class Evidence : Asn1Encodable, IAsn1Choice
{
	...
	private Evidence(Asn1TaggedObject tagged)
	{
		...
		if (tagged.TagNo == 2)
		{
			otherEvidence = Asn1Sequence.GetInstance(tagged, declaredExplicit: false);
			return;
		}
	...
	public override Asn1Object ToAsn1Object()
	{
		if (tstEvidence != null)
		{
			return new DerTaggedObject(isExplicit: false, 0, tstEvidence);
		}
		return new DerTaggedObject(isExplicit: false, 2, otherEvidence);
	}
}
