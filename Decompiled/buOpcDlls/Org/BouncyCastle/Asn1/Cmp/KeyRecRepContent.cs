...
public class KeyRecRepContent : Asn1Encodable
{
	...
	private KeyRecRepContent(Asn1Sequence seq)
	{
		...
		for (int i = 1; i < seq.Count; i++)
		{
			...
			{
			case 0:
				m_newSigCert = CmpCertificate.GetInstance(instance.GetObject());
				break;
			case 1:
				m_caCerts = Asn1Sequence.GetInstance(instance.GetObject());
				break;
			case 2:
				m_keyPairHist = Asn1Sequence.GetInstance(instance.GetObject());
				break;
			default:
	...
	{
		Asn1EncodableVector asn1EncodableVector = new Asn1EncodableVector(m_status);
