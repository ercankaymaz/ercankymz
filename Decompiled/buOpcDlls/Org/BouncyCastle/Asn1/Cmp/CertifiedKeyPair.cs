...
public class CertifiedKeyPair : Asn1Encodable
{
	...
	private CertifiedKeyPair(Asn1Sequence seq)
	{
		...
		if (seq.Count == 2)
		{
			...
			if (instance.TagNo == 0)
			{
				m_privateKey = EncryptedKey.GetInstance(instance.GetObject());
			}
			else
			{
				m_publicationInfo = PkiPublicationInfo.GetInstance(instance.GetObject());
			}
		}
		else
		{
	...
	{
		Asn1EncodableVector asn1EncodableVector = new Asn1EncodableVector(m_certOrEncCert);
