...
public class TstInfo : Asn1Encodable
{
	...
	public Asn1GeneralizedTime GenTime => genTime;
	...
	private TstInfo(Asn1Sequence seq)
	{
		...
		enumerator.MoveNext();
		genTime = Asn1GeneralizedTime.GetInstance(enumerator.Current);
		...
		while (enumerator.MoveNext())
		{
			...
			if (asn1Object is Asn1TaggedObject { TagNo: var tagNo } asn1TaggedObject)
			{
				...
				{
				case 0:
					tsa = GeneralName.GetInstance(asn1TaggedObject, explicitly: true);
					break;
				case 1:
					extensions = X509Extensions.GetInstance(asn1TaggedObject, declaredExplicit: false);
					break;
				default:
