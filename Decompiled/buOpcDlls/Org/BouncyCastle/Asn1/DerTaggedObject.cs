...
public class DerTaggedObject : Asn1TaggedObject
{
	...
	internal sealed override DerEncoding GetEncodingDer()
	{
		...
		return new ConstructedDerEncoding(base.TagClass, base.TagNo, new DerEncoding[1] { asn1Object.GetEncodingDer() });
	}
	...
	internal sealed override DerEncoding GetEncodingDerImplicit(int tagClass, int tagNo)
	{
		...
		return new ConstructedDerEncoding(tagClass, tagNo, new DerEncoding[1] { asn1Object.GetEncodingDer() });
	}
