...
public class BerSequence : DerSequence
{
	...
	internal override IAsn1Encoding GetEncoding(int encoding)
	{
		...
		return new ConstructedILEncoding(0, 16, Asn1OutputStream.GetContentsEncodings(encoding, elements));
	}
	...
	internal override IAsn1Encoding GetEncodingImplicit(int encoding, int tagClass, int tagNo)
	{
		...
		return new ConstructedILEncoding(tagClass, tagNo, Asn1OutputStream.GetContentsEncodings(encoding, elements));
	}
	...
	{
		return new BerSet(isSorted: false, elements);
	}
}
