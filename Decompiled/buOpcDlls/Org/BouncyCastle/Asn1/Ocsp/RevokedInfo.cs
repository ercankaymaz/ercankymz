...
public class RevokedInfo : Asn1Encodable
{
	...
	public Asn1GeneralizedTime RevocationTime => revocationTime;
	...
	private RevokedInfo(Asn1Sequence seq)
	{
		...
		if (seq.Count > 1)
		{
			revocationReason = new CrlReason(DerEnumerated.GetInstance((Asn1TaggedObject)seq[1], declaredExplicit: true));
		}
	}
