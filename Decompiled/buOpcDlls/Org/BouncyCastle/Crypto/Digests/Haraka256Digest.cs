...
public sealed class Haraka256Digest : HarakaBase
{
	...
	private static int Haraka256256(byte[] msg, byte[] output, int outOff)
	{
		...
		Mix256(array, array2);
		array[0] = HarakaBase.Xor(array2[0], msg, 0);
		array[1] = HarakaBase.Xor(array2[1], msg, 16);
		Array.Copy(array[0], 0, output, outOff, 16);
		Array.Copy(array[1], 0, output, outOff + 16, 16);
