...
public class Pkcs10CertificationRequest : CertificationRequest
{
	...
	static Pkcs10CertificationRequest()
	{
		...
		m_oids = new Dictionary<DerObjectIdentifier, string>();
	...
	private void Init(ISignatureFactory signatureFactory, X509Name subject, AsymmetricKeyParameter publicKey, Asn1Set attributes)
	{
		...
		sigBits = Org.BouncyCastle.X509.X509Utilities.GenerateSignature(signatureFactory, reqInfo);
	}
	...
	public bool Verify(IVerifierFactory verifier)
	{
		try
		{
			return Org.BouncyCastle.X509.X509Utilities.VerifySignature(verifier, reqInfo, sigBits);
		}
