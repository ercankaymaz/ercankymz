...
public class PropertyTypeState : BaseVariableTypeState
{
	...
	protected override void Initialize(ISystemContext context)
	{
		...
		base.NodeId = NodeId.Create(68u, "http://opcfoundation.org/UA/", context.NamespaceUris);
		base.BrowseName = QualifiedName.Create("PropertyType", "http://opcfoundation.org/UA/", context.NamespaceUris);
		base.DisplayName = new LocalizedText("PropertyType", string.Empty, "PropertyType");
