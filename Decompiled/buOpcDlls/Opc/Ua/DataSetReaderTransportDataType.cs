...
public class DataSetReaderTransportDataType : IEncodeable, ICloneable, IJsonEncodeable
{
	...
	public virtual bool IsEqual(IEncodeable encodeable)
	{
		...
		if (!(encodeable is DataSetReaderTransportDataType))
		{
			return false;
		}
		return true;
	...
	{
		return (DataSetReaderTransportDataType)MemberwiseClone();
	}

	public new object MemberwiseClone()
	{
		return (DataSetReaderTransportDataType)base.MemberwiseClone();
	}
}
