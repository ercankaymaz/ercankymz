...
public class DeleteNodesResponse : IEncodeable, ICloneable, IJsonEncodeable, IServiceResponse
{
	...
	public virtual bool IsEqual(IEncodeable encodeable)
	{
		...
		if (!(encodeable is DeleteNodesResponse deleteNodesResponse))
		{
			return false;
		}
		if (!Utils.IsEqual(m_responseHeader, deleteNodesResponse.m_responseHeader))
		{
			return false;
		}
		if (!Utils.IsEqual(m_results, deleteNodesResponse.m_results))
		{
			return false;
		}
		if (!Utils.IsEqual(m_diagnosticInfos, deleteNodesResponse.m_diagnosticInfos))
		{
			return false;
		}
		return true;
	...
	{
		return (DeleteNodesResponse)MemberwiseClone();
	}

	public new object MemberwiseClone()
	{
		DeleteNodesResponse obj = (DeleteNodesResponse)base.MemberwiseClone();
