...
public class PublishedDataSetSourceDataType : IEncodeable, ICloneable, IJsonEncodeable
{
	...
	public virtual bool IsEqual(IEncodeable encodeable)
	{
		...
		if (!(encodeable is PublishedDataSetSourceDataType))
		{
			return false;
		}
		return true;
	...
	{
		return (PublishedDataSetSourceDataType)MemberwiseClone();
	}

	public new object MemberwiseClone()
	{
		return (PublishedDataSetSourceDataType)base.MemberwiseClone();
	}
}
