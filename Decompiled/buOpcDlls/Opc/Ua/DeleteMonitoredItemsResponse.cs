...
[ComVisible(true)]
public class DeleteMonitoredItemsResponse : IEncodeable, ICloneable, IJsonEncodeable, IServiceResponse
{
	...
	public virtual bool IsEqual(IEncodeable encodeable)
	{
		...
		if (!(encodeable is DeleteMonitoredItemsResponse deleteMonitoredItemsResponse))
		{
			return false;
		}
		if (!Utils.IsEqual(m_responseHeader, deleteMonitoredItemsResponse.m_responseHeader))
		{
			return false;
		}
		if (!Utils.IsEqual(m_results, deleteMonitoredItemsResponse.m_results))
		{
			return false;
		}
		if (!Utils.IsEqual(m_diagnosticInfos, deleteMonitoredItemsResponse.m_diagnosticInfos))
		{
			return false;
		}
		return true;
	...
	{
		return (DeleteMonitoredItemsResponse)MemberwiseClone();
	}

	public new object MemberwiseClone()
	{
		DeleteMonitoredItemsResponse obj = (DeleteMonitoredItemsResponse)base.MemberwiseClone();
