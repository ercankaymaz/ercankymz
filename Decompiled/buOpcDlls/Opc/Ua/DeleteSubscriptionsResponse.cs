...
public class DeleteSubscriptionsResponse : IEncodeable, ICloneable, IJsonEncodeable, IServiceResponse
{
	...
	public virtual bool IsEqual(IEncodeable encodeable)
	{
		...
		if (!(encodeable is DeleteSubscriptionsResponse deleteSubscriptionsResponse))
		{
			return false;
		}
		if (!Utils.IsEqual(m_responseHeader, deleteSubscriptionsResponse.m_responseHeader))
		{
			return false;
		}
		if (!Utils.IsEqual(m_results, deleteSubscriptionsResponse.m_results))
		{
			return false;
		}
		if (!Utils.IsEqual(m_diagnosticInfos, deleteSubscriptionsResponse.m_diagnosticInfos))
		{
			return false;
		}
		return true;
	...
	{
		return (DeleteSubscriptionsResponse)MemberwiseClone();
	}

	public new object MemberwiseClone()
	{
		DeleteSubscriptionsResponse obj = (DeleteSubscriptionsResponse)base.MemberwiseClone();
