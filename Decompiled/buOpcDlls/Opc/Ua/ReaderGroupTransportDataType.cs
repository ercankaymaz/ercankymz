...
public class ReaderGroupTransportDataType : IEncodeable, ICloneable, IJsonEncodeable
{
	...
	public virtual bool IsEqual(IEncodeable encodeable)
	{
		...
		if (!(encodeable is ReaderGroupTransportDataType))
		{
			return false;
		}
		return true;
	...
	{
		return (ReaderGroupTransportDataType)MemberwiseClone();
	}

	public new object MemberwiseClone()
	{
		return (ReaderGroupTransportDataType)base.MemberwiseClone();
	}
}
