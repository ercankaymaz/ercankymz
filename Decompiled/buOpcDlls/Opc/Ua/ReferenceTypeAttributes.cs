...
public class ReferenceTypeAttributes : NodeAttributes
{
	...
	public override bool IsEqual(IEncodeable encodeable)
	{
		...
		if (!(encodeable is ReferenceTypeAttributes referenceTypeAttributes))
		{
			return false;
		}
		...
		if (!Utils.IsEqual(m_isAbstract, referenceTypeAttributes.m_isAbstract))
		{
			return false;
		}
		if (!Utils.IsEqual(m_symmetric, referenceTypeAttributes.m_symmetric))
		{
			return false;
		}
		if (!Utils.IsEqual(m_inverseName, referenceTypeAttributes.m_inverseName))
		{
			return false;
		}
	...
	{
		return (ReferenceTypeAttributes)MemberwiseClone();
	}

	public new object MemberwiseClone()
	{
		ReferenceTypeAttributes obj = (ReferenceTypeAttributes)base.MemberwiseClone();
