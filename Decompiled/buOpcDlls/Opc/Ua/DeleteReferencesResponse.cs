...
public class DeleteReferencesResponse : IEncodeable, ICloneable, IJsonEncodeable, IServiceResponse
{
	...
	public virtual bool IsEqual(IEncodeable encodeable)
	{
		...
		if (!(encodeable is DeleteReferencesResponse deleteReferencesResponse))
		{
			return false;
		}
		if (!Utils.IsEqual(m_responseHeader, deleteReferencesResponse.m_responseHeader))
		{
			return false;
		}
		if (!Utils.IsEqual(m_results, deleteReferencesResponse.m_results))
		{
			return false;
		}
		if (!Utils.IsEqual(m_diagnosticInfos, deleteReferencesResponse.m_diagnosticInfos))
		{
			return false;
		}
		return true;
	...
	{
		return (DeleteReferencesResponse)MemberwiseClone();
	}

	public new object MemberwiseClone()
	{
		DeleteReferencesResponse obj = (DeleteReferencesResponse)base.MemberwiseClone();
