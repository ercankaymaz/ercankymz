...
[ComVisible(true)]
public class BrokerDataSetWriterTransportState : DataSetWriterTransportState
{
	...
	public BrokerDataSetWriterTransportState(NodeState parent)
		: base(parent)
	{
	}
	...
	{
		return NodeId.Create(21138u, "http://opcfoundation.org/UA/", namespaceUris);
	}

	protected override void Initialize(ISystemContext context)
	{
		base.Initialize(context);
		Initialize(context, "");
	...
	protected override BaseInstanceState FindChild(ISystemContext context, QualifiedName browseName, bool createOrReplace, BaseInstanceState replacement)
	{
		...
		case "MetaDataUpdateTime":
			if (createOrReplace && MetaDataUpdateTime == null)
			{
				if (replacement == null)
				{
			...
			baseInstanceState = MetaDataUpdateTime;
			break;
		}
