...
public class ThreeDVector : Vector
{
	...
	public override bool IsEqual(IEncodeable encodeable)
	{
		...
		if (!(encodeable is ThreeDVector threeDVector))
		{
			return false;
		}
		...
		if (!Utils.IsEqual(m_x, threeDVector.m_x))
		{
			return false;
		}
		if (!Utils.IsEqual(m_y, threeDVector.m_y))
		{
			return false;
		}
		if (!Utils.IsEqual(m_z, threeDVector.m_z))
		{
			return false;
		}
	...
	{
		return (ThreeDVector)MemberwiseClone();
	}

	public new object MemberwiseClone()
	{
		ThreeDVector obj = (ThreeDVector)base.MemberwiseClone();
