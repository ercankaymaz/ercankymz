...
public class SimpleAttributeOperandCollection : List<SimpleAttributeOperand>, ICloneable
{
	...
	{
		SimpleAttributeOperandCollection simpleAttributeOperandCollection = new SimpleAttributeOperandCollection(base.Count);
		for (int i = 0; i < base.Count; i++)
		{
			simpleAttributeOperandCollection.Add((SimpleAttributeOperand)Utils.Clone(base[i]));
		}
