...
public class SetPublishingModeResponse : IEncodeable, ICloneable, IJsonEncodeable, IServiceResponse
{
	...
	public virtual bool IsEqual(IEncodeable encodeable)
	{
		...
		if (!(encodeable is SetPublishingModeResponse setPublishingModeResponse))
		{
			return false;
		}
		if (!Utils.IsEqual(m_responseHeader, setPublishingModeResponse.m_responseHeader))
		{
			return false;
		}
		if (!Utils.IsEqual(m_results, setPublishingModeResponse.m_results))
		{
			return false;
		}
		if (!Utils.IsEqual(m_diagnosticInfos, setPublishingModeResponse.m_diagnosticInfos))
		{
			return false;
		}
		return true;
	...
	{
		return (SetPublishingModeResponse)MemberwiseClone();
	}

	public new object MemberwiseClone()
	{
		SetPublishingModeResponse obj = (SetPublishingModeResponse)base.MemberwiseClone();
