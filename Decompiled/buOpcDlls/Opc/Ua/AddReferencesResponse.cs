...
public class AddReferencesResponse : IEncodeable, ICloneable, IJsonEncodeable, IServiceResponse
{
	...
	public virtual bool IsEqual(IEncodeable encodeable)
	{
		...
		if (!(encodeable is AddReferencesResponse addReferencesResponse))
		{
			return false;
		}
		if (!Utils.IsEqual(m_responseHeader, addReferencesResponse.m_responseHeader))
		{
			return false;
		}
		if (!Utils.IsEqual(m_results, addReferencesResponse.m_results))
		{
			return false;
		}
		if (!Utils.IsEqual(m_diagnosticInfos, addReferencesResponse.m_diagnosticInfos))
		{
			return false;
		}
		return true;
	...
	{
		return (AddReferencesResponse)MemberwiseClone();
	}

	public new object MemberwiseClone()
	{
		AddReferencesResponse obj = (AddReferencesResponse)base.MemberwiseClone();
