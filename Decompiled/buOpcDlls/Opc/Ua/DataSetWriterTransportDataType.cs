...
public class DataSetWriterTransportDataType : IEncodeable, ICloneable, IJsonEncodeable
{
	...
	public virtual bool IsEqual(IEncodeable encodeable)
	{
		...
		if (!(encodeable is DataSetWriterTransportDataType))
		{
			return false;
		}
		return true;
	...
	{
		return (DataSetWriterTransportDataType)MemberwiseClone();
	}

	public new object MemberwiseClone()
	{
		return (DataSetWriterTransportDataType)base.MemberwiseClone();
	}
}
