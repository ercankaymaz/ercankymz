...
public class ThreeDCartesianCoordinatesValue : BaseVariableValue
{
	...
	public ThreeDCartesianCoordinatesState Variable => m_variable;
	...
	public ThreeDCartesianCoordinatesValue(ThreeDCartesianCoordinatesState variable, ThreeDCartesianCoordinates value, object dataLock)
		: base(dataLock)
	{
		m_value = value;
		if (m_value == null)
