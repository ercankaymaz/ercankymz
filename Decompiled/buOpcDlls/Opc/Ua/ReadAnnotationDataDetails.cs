...
public class ReadAnnotationDataDetails : HistoryReadDetails
{
	...
	public override bool IsEqual(IEncodeable encodeable)
	{
		...
		if (!(encodeable is ReadAnnotationDataDetails readAnnotationDataDetails))
		{
			return false;
		}
		...
		if (!Utils.IsEqual(m_reqTimes, readAnnotationDataDetails.m_reqTimes))
		{
			return false;
		}
	...
	{
		return (ReadAnnotationDataDetails)MemberwiseClone();
	}

	public new object MemberwiseClone()
	{
		ReadAnnotationDataDetails obj = (ReadAnnotationDataDetails)base.MemberwiseClone();
