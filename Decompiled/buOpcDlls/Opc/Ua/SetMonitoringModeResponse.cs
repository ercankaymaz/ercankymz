...
public class SetMonitoringModeResponse : IEncodeable, ICloneable, IJsonEncodeable, IServiceResponse
{
	...
	public virtual bool IsEqual(IEncodeable encodeable)
	{
		...
		if (!(encodeable is SetMonitoringModeResponse setMonitoringModeResponse))
		{
			return false;
		}
		if (!Utils.IsEqual(m_responseHeader, setMonitoringModeResponse.m_responseHeader))
		{
			return false;
		}
		if (!Utils.IsEqual(m_results, setMonitoringModeResponse.m_results))
		{
			return false;
		}
		if (!Utils.IsEqual(m_diagnosticInfos, setMonitoringModeResponse.m_diagnosticInfos))
		{
			return false;
		}
		return true;
	...
	{
		return (SetMonitoringModeResponse)MemberwiseClone();
	}

	public new object MemberwiseClone()
	{
		SetMonitoringModeResponse obj = (SetMonitoringModeResponse)base.MemberwiseClone();
