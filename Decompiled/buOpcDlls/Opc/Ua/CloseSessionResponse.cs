...
public class CloseSessionResponse : IEncodeable, ICloneable, IJsonEncodeable, IServiceResponse
{
	...
	public virtual bool IsEqual(IEncodeable encodeable)
	{
		...
		if (!(encodeable is CloseSessionResponse closeSessionResponse))
		{
			return false;
		}
		if (!Utils.IsEqual(m_responseHeader, closeSessionResponse.m_responseHeader))
		{
			return false;
		}
		return true;
	...
	{
		return (CloseSessionResponse)MemberwiseClone();
	}

	public new object MemberwiseClone()
	{
		CloseSessionResponse obj = (CloseSessionResponse)base.MemberwiseClone();
