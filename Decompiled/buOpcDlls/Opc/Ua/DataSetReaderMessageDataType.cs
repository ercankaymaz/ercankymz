...
public class DataSetReaderMessageDataType : IEncodeable, ICloneable, IJsonEncodeable
{
	...
	public virtual bool IsEqual(IEncodeable encodeable)
	{
		...
		if (!(encodeable is DataSetReaderMessageDataType))
		{
			return false;
		}
		return true;
	...
	{
		return (DataSetReaderMessageDataType)MemberwiseClone();
	}

	public new object MemberwiseClone()
	{
		return (DataSetReaderMessageDataType)base.MemberwiseClone();
	}
}
