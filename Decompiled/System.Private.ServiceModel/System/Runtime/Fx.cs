...
internal static class Fx
{
	...
	public static class Tag
	{
		...
		public sealed class CacheAttribute : Attribute
		{
			...
			public CacheAttribute(Type elementType, CacheAttrition cacheAttrition)
			{
				...
				SizeLimit = "unbounded";
				Timeout = "infinite";
				ElementType = elementType ?? throw Exception.ArgumentNull("elementType");
		...
		public class ThrowsAttribute : Attribute
		{
			...
			public ThrowsAttribute(Type exceptionType, string diagnosis)
			{
				...
				ExceptionType = exceptionType ?? throw Exception.ArgumentNull("exceptionType");
	...
	internal static ExceptionTrace Exception
	{
		get
		{
			...
			{
				s_exceptionTrace = new ExceptionTrace("System.Runtime", Trace);
			}
	...
	public static bool IsFatal(Exception exception)
	{
		...
		{
			if (exception is FatalException || (exception is OutOfMemoryException && !(exception is InsufficientMemoryException)) || exception is FatalInternalException)
			{
				return true;
			}
