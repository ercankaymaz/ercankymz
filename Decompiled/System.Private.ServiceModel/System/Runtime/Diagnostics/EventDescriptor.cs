...
internal struct EventDescriptor
{
	...
	public long Keywords => _keywords;
	...
	{
		if (_id != other._id || _version != other._version || _channel != other._channel || _level != other._level || _opcode != other._opcode || _task != other._task || _keywords != other._keywords)
		{
			return false;
		}
		return true;
