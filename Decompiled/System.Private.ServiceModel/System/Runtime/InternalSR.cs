...
internal class InternalSR
{
	...
	{
		return $"The argument {param0} is null or empty.";
	}

	internal static string AsyncResultCompletedTwice(object param0)
	{
		return $"The IAsyncResult implementation '{param0}' tried to complete a single operation multiple times. This could be caused by an incorrect application IAsyncResult implementation or other extensibility code, such as an IAsyncResult that returns incorrect CompletedSynchronously values or invokes the AsyncCallback multiple times.";
	}

	internal static string BufferedOutputStreamQuotaExceeded(object param0)
	{
		return $"The size quota for this stream ({param0}) has been exceeded.";
	}

	internal static string BufferAllocationFailed(int size)
	{
		return $"Failed to allocate a managed memory buffer of {size} bytes. The amount of available memory may be low.";
	}

	internal static string FailFastMessage(object param0)
	{
		return $"An unrecoverable error occurred. For diagnostic purposes, this English message is associated with the failure: '{param0}'.";
	}

	internal static string InvalidAsyncResultImplementation(object param0)
	{
		return $"An incorrect implementation of the IAsyncResult interface may be returning incorrect values from the CompletedSynchronously property or calling the AsyncCallback more than once. The type {param0} could be the incorrect implementation.";
	}

	internal static string ShipAssertExceptionMessage(object param0)
	{
		return $"An unexpected failure occurred. Applications should not attempt to handle this error. For diagnostic purposes, this English message is associated with the failure: '{param0}'.";
	}

	internal static string TaskTimedOutError(object param0)
	{
		return $"The task timed out after {param0}. The time allotted to this operation may have been a portion of a longer timeout.";
	}

	internal static string TimeoutInputQueueDequeue(object param0)
	{
		return $"A Dequeue operation timed out after {param0}. The time allotted to this operation may have been a portion of a longer timeout.";
	}

	internal static string TimeoutMustBeNonNegative(object param0, object param1)
	{
		return $"Argument {param0} must be a non-negative timeout value. Provided value was {param1}.";
	}

	internal static string TimeoutMustBePositive(object param0, object param1)
	{
		return $"Argument {param0} must be a positive timeout value. Provided value was {param1}.";
	}
}
