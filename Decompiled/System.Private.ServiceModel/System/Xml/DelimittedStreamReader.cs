...
internal class DelimittedStreamReader
{
	...
	private class DelimittedReadStream : Stream
	{
		...
		public override long Length
		{
			get
			{
				throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new NotSupportedException(System.SR.Format(System.SR.SeekNotSupportedOnStream, GetType().FullName)));
			}
		}
		...
		{
			throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new NotSupportedException(System.SR.Format(System.SR.WriteNotSupportedOnStream, GetType().FullName)));
		}
