...
internal class MimeWriter
{
	...
	internal void StartPreface()
	{
		...
		{
			throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(System.SR.Format(System.SR.MimeWriterInvalidStateForStartPreface, state.ToString())));
		}
	...
	internal void StartPart()
	{
		...
		{
			throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(System.SR.Format(System.SR.MimeWriterInvalidStateForStartPart, state.ToString())));
		}
	...
	internal void Close()
	{
		...
		{
			throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(System.SR.Format(System.SR.MimeWriterInvalidStateForClose, state.ToString())));
		}
	...
	internal void WriteHeader(string name, string value)
	{
		...
		{
			throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(System.SR.Format(System.SR.MimeWriterInvalidStateForHeader, state.ToString())));
		}
	...
	internal Stream GetContentStream()
	{
		...
		if (mimeWriterState == MimeWriterState.Start || (uint)(mimeWriterState - 4) <= 1u)
		{
			throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(System.SR.Format(System.SR.MimeWriterInvalidStateForContent, state.ToString())));
		}
