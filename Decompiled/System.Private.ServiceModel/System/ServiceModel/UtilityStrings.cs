...
internal static class UtilityStrings
{
	...
	public const string UniqueEndpointHeaderName = "ChannelInstance";

	public const string UniqueEndpointHeaderNamespace = "http://schemas.microsoft.com/ws/2005/02/duplex";
}
