...
public static class ServiceModelSecurityTokenTypes
{
	...
	public static string Spnego => "http://schemas.microsoft.com/ws/2006/05/servicemodel/tokens/Spnego";

	public static string MutualSslnego => "http://schemas.microsoft.com/ws/2006/05/servicemodel/tokens/MutualSslnego";

	public static string AnonymousSslnego => "http://schemas.microsoft.com/ws/2006/05/servicemodel/tokens/AnonymousSslnego";

	public static string SecurityContext => "http://schemas.microsoft.com/ws/2006/05/servicemodel/tokens/SecurityContextToken";

	public static string SecureConversation => "http://schemas.microsoft.com/ws/2006/05/servicemodel/tokens/SecureConversation";

	public static string SspiCredential => "http://schemas.microsoft.com/ws/2006/05/servicemodel/tokens/SspiCredential";
}
