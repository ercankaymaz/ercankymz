...
internal static class TrustFeb2005Strings
{
	...
	public const string BinarySecretClauseType = "http://schemas.xmlsoap.org/ws/2005/02/trust#BinarySecret";
	...
	public const string SpnegoValueTypeUri = "http://schemas.microsoft.com/net/2004/07/secext/WS-SPNego";

	public const string TlsnegoValueTypeUri = "http://schemas.microsoft.com/net/2004/07/secext/TLSNego";

	public const string Prefix = "t";

	public const string RequestSecurityTokenIssuance = "http://schemas.xmlsoap.org/ws/2005/02/trust/RST/Issue";

	public const string RequestSecurityTokenIssuanceResponse = "http://schemas.xmlsoap.org/ws/2005/02/trust/RSTR/Issue";

	public const string RequestTypeIssue = "http://schemas.xmlsoap.org/ws/2005/02/trust/Issue";

	public const string SymmetricKeyBinarySecret = "http://schemas.xmlsoap.org/ws/2005/02/trust/SymmetricKey";

	public const string Psha1ComputedKeyUri = "http://schemas.xmlsoap.org/ws/2005/02/trust/CK/PSHA1";

	public const string NonceBinarySecret = "http://schemas.xmlsoap.org/ws/2005/02/trust/Nonce";
	...
	public const string RequestTypeRenew = "http://schemas.xmlsoap.org/ws/2005/02/trust/Renew";

	public const string RequestTypeClose = "http://schemas.xmlsoap.org/ws/2005/02/trust/Cancel";

	public const string KeyType = "KeyType";

	public const string SymmetricKeyType = "http://schemas.xmlsoap.org/ws/2005/02/trust/SymmetricKey";

	public const string PublicKeyType = "http://schemas.xmlsoap.org/ws/2005/02/trust/PublicKey";
