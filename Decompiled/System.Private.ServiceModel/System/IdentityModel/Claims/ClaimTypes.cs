...
public static class ClaimTypes
{
	...
	public static string Anonymous => "http://schemas.xmlsoap.org/ws/2005/05/identity/claims/anonymous";

	public static string DenyOnlySid => "http://schemas.xmlsoap.org/ws/2005/05/identity/claims/denyonlysid";

	public static string Dns => "http://schemas.xmlsoap.org/ws/2005/05/identity/claims/dns";

	public static string Email => "http://schemas.xmlsoap.org/ws/2005/05/identity/claims/emailaddress";

	public static string Hash => "http://schemas.xmlsoap.org/ws/2005/05/identity/claims/hash";

	public static string Name => "http://schemas.xmlsoap.org/ws/2005/05/identity/claims/name";

	public static string Rsa => "http://schemas.xmlsoap.org/ws/2005/05/identity/claims/rsa";

	public static string Sid => "http://schemas.xmlsoap.org/ws/2005/05/identity/claims/sid";

	public static string Spn => "http://schemas.xmlsoap.org/ws/2005/05/identity/claims/spn";

	public static string System => "http://schemas.xmlsoap.org/ws/2005/05/identity/claims/system";

	public static string Thumbprint => "http://schemas.xmlsoap.org/ws/2005/05/identity/claims/thumbprint";

	public static string Upn => "http://schemas.xmlsoap.org/ws/2005/05/identity/claims/upn";

	public static string Uri => "http://schemas.xmlsoap.org/ws/2005/05/identity/claims/uri";

	public static string X500DistinguishedName => "http://schemas.xmlsoap.org/ws/2005/05/identity/claims/x500distinguishedname";

	public static string NameIdentifier => "http://schemas.xmlsoap.org/ws/2005/05/identity/claims/nameidentifier";

	public static string Authentication => "http://schemas.xmlsoap.org/ws/2005/05/identity/claims/authentication";

	public static string AuthorizationDecision => "http://schemas.xmlsoap.org/ws/2005/05/identity/claims/authorizationdecision";
	...
	public static string StreetAddress => "http://schemas.xmlsoap.org/ws/2005/05/identity/claims/streetaddress";

	public static string Locality => "http://schemas.xmlsoap.org/ws/2005/05/identity/claims/locality";

	public static string StateOrProvince => "http://schemas.xmlsoap.org/ws/2005/05/identity/claims/stateorprovince";

	public static string PostalCode => "http://schemas.xmlsoap.org/ws/2005/05/identity/claims/postalcode";

	public static string Country => "http://schemas.xmlsoap.org/ws/2005/05/identity/claims/country";

	public static string HomePhone => "http://schemas.xmlsoap.org/ws/2005/05/identity/claims/homephone";

	public static string OtherPhone => "http://schemas.xmlsoap.org/ws/2005/05/identity/claims/otherphone";

	public static string MobilePhone => "http://schemas.xmlsoap.org/ws/2005/05/identity/claims/mobilephone";

	public static string DateOfBirth => "http://schemas.xmlsoap.org/ws/2005/05/identity/claims/dateofbirth";

	public static string Gender => "http://schemas.xmlsoap.org/ws/2005/05/identity/claims/gender";

	public static string PPID => "http://schemas.xmlsoap.org/ws/2005/05/identity/claims/privatepersonalidentifier";

	public static string Webpage => "http://schemas.xmlsoap.org/ws/2005/05/identity/claims/webpage";
}
