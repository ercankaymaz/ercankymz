...
public abstract class SecurityToken
{
	...
	public virtual bool CanCreateKeyIdentifierClause<T>() where T : SecurityKeyIdentifierClause
	{
		...
		{
			return CanCreateLocalKeyIdentifierClause();
		}
		return false;
	}
	...
	public virtual T CreateKeyIdentifierClause<T>() where T : SecurityKeyIdentifierClause
	{
		...
		throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new NotSupportedException(System.SR.Format(System.SR.TokenDoesNotSupportKeyIdentifierClauseCreation, GetType().Name, typeof(T).Name)));
	}

	public virtual bool MatchesKeyIdentifierClause(SecurityKeyIdentifierClause keyIdentifierClause)
	{
		if (keyIdentifierClause is LocalIdKeyIdentifierClause localIdKeyIdentifierClause)
		{
			return localIdKeyIdentifierClause.Matches(Id, GetType());
		}
		return false;
	}
