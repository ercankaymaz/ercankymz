...
public class OdDbScale : OdDbObject
{
	public delegate IntPtr SwigDelegateOdDbScale_0(IntPtr protocolClass);

	public delegate IntPtr SwigDelegateOdDbScale_1();

	public delegate void SwigDelegateOdDbScale_2(IntPtr pSource);

	public delegate int SwigDelegateOdDbScale_3();

	public delegate bool SwigDelegateOdDbScale_4();

	public delegate IntPtr SwigDelegateOdDbScale_5();

	public delegate void SwigDelegateOdDbScale_6(IntPtr pNode);

	public delegate IntPtr SwigDelegateOdDbScale_7();

	public delegate uint SwigDelegateOdDbScale_8(IntPtr vd);

	public delegate uint SwigDelegateOdDbScale_9();

	public delegate void SwigDelegateOdDbScale_10(IntPtr ownerId);

	public delegate int SwigDelegateOdDbScale_11(int mode);

	public delegate void SwigDelegateOdDbScale_12();

	public delegate int SwigDelegateOdDbScale_13(bool erasing);

	public delegate void SwigDelegateOdDbScale_14(IntPtr pNewObject);

	public delegate void SwigDelegateOdDbScale_15(IntPtr otherId, bool swapXdata, bool swapExtDict);

	public delegate void SwigDelegateOdDbScale_16(IntPtr otherId, bool swapXdata);

	public delegate void SwigDelegateOdDbScale_17(IntPtr otherId);

	public delegate void SwigDelegateOdDbScale_18(IntPtr pAuditInfo);

	public delegate int SwigDelegateOdDbScale_19(IntPtr pFiler);

	public delegate void SwigDelegateOdDbScale_20(IntPtr pFiler);

	public delegate int SwigDelegateOdDbScale_21(IntPtr pFiler);

	public delegate void SwigDelegateOdDbScale_22(IntPtr pFiler);

	public delegate int SwigDelegateOdDbScale_23(IntPtr pFiler);

	public delegate void SwigDelegateOdDbScale_24(IntPtr pFiler);

	public delegate int SwigDelegateOdDbScale_25(IntPtr pFiler);

	public delegate void SwigDelegateOdDbScale_26(IntPtr pFiler);

	public delegate int SwigDelegateOdDbScale_27();

	public delegate IntPtr SwigDelegateOdDbScale_28([MarshalAs(UnmanagedType.LPWStr)] string regappName);

	public delegate void SwigDelegateOdDbScale_29(IntPtr pRb);

	public delegate void SwigDelegateOdDbScale_30(IntPtr pFiler, IntPtr pClass);

	public delegate void SwigDelegateOdDbScale_31(IntPtr objId);

	public delegate void SwigDelegateOdDbScale_32(IntPtr objId);

	public delegate void SwigDelegateOdDbScale_33(IntPtr pSubObj);

	public delegate void SwigDelegateOdDbScale_34();

	public delegate void SwigDelegateOdDbScale_35(IntPtr idPair, IntPtr pOwnerObject, IntPtr ownerIdMap);

	public delegate void SwigDelegateOdDbScale_36(IntPtr pObject, IntPtr pNewObject);

	public delegate void SwigDelegateOdDbScale_37(IntPtr pObject, bool erasing);

	public delegate void SwigDelegateOdDbScale_38(IntPtr pObject);

	public delegate void SwigDelegateOdDbScale_39(IntPtr pObject);

	public delegate void SwigDelegateOdDbScale_40(IntPtr pObject);

	public delegate void SwigDelegateOdDbScale_41(IntPtr pObject);

	public delegate void SwigDelegateOdDbScale_42(IntPtr pObject, IntPtr pSubObj);

	public delegate void SwigDelegateOdDbScale_43(IntPtr pObject);

	public delegate void SwigDelegateOdDbScale_44(IntPtr pObject);

	public delegate void SwigDelegateOdDbScale_45(IntPtr pObject);

	public delegate void SwigDelegateOdDbScale_46(IntPtr pObject);

	public delegate void SwigDelegateOdDbScale_47(IntPtr objectId);

	public delegate void SwigDelegateOdDbScale_48(IntPtr pObject);

	public delegate void SwigDelegateOdDbScale_49(IntPtr pSource);

	public delegate int SwigDelegateOdDbScale_50(IntPtr pFiler, MaintReleaseVer pMaintVer);

	public delegate int SwigDelegateOdDbScale_51(IntPtr pFiler);

	public delegate IntPtr SwigDelegateOdDbScale_52(int ver, IntPtr replaceId, bool exchangeXData);

	public delegate IntPtr SwigDelegateOdDbScale_53(int format, int ver, IntPtr replaceId, bool exchangeXData);

	public delegate void SwigDelegateOdDbScale_54(int format, int version, IntPtr pAuditInfo);

	public delegate IntPtr SwigDelegateOdDbScale_55();

	public delegate IntPtr SwigDelegateOdDbScale_56([MarshalAs(UnmanagedType.LPWStr)] string fieldName, IntPtr pField);

	public delegate int SwigDelegateOdDbScale_57(IntPtr fieldId);

	public delegate IntPtr SwigDelegateOdDbScale_58([MarshalAs(UnmanagedType.LPWStr)] string fieldName);

	public delegate IntPtr SwigDelegateOdDbScale_59(IntPtr pClass);

	public delegate int SwigDelegateOdDbScale_60(IntPtr pClsid);

	private object locker = new object();

	private HandleRef swigCPtr;

	private SwigDelegateOdDbScale_0 swigDelegate0;

	private SwigDelegateOdDbScale_1 swigDelegate1;

	private SwigDelegateOdDbScale_2 swigDelegate2;

	private SwigDelegateOdDbScale_3 swigDelegate3;

	private SwigDelegateOdDbScale_4 swigDelegate4;

	private SwigDelegateOdDbScale_5 swigDelegate5;

	private SwigDelegateOdDbScale_6 swigDelegate6;

	private SwigDelegateOdDbScale_7 swigDelegate7;

	private SwigDelegateOdDbScale_8 swigDelegate8;

	private SwigDelegateOdDbScale_9 swigDelegate9;

	private SwigDelegateOdDbScale_10 swigDelegate10;

	private SwigDelegateOdDbScale_11 swigDelegate11;

	private SwigDelegateOdDbScale_12 swigDelegate12;

	private SwigDelegateOdDbScale_13 swigDelegate13;

	private SwigDelegateOdDbScale_14 swigDelegate14;

	private SwigDelegateOdDbScale_15 swigDelegate15;

	private SwigDelegateOdDbScale_16 swigDelegate16;

	private SwigDelegateOdDbScale_17 swigDelegate17;

	private SwigDelegateOdDbScale_18 swigDelegate18;

	private SwigDelegateOdDbScale_19 swigDelegate19;

	private SwigDelegateOdDbScale_20 swigDelegate20;

	private SwigDelegateOdDbScale_21 swigDelegate21;

	private SwigDelegateOdDbScale_22 swigDelegate22;

	private SwigDelegateOdDbScale_23 swigDelegate23;

	private SwigDelegateOdDbScale_24 swigDelegate24;

	private SwigDelegateOdDbScale_25 swigDelegate25;

	private SwigDelegateOdDbScale_26 swigDelegate26;

	private SwigDelegateOdDbScale_27 swigDelegate27;

	private SwigDelegateOdDbScale_28 swigDelegate28;

	private SwigDelegateOdDbScale_29 swigDelegate29;

	private SwigDelegateOdDbScale_30 swigDelegate30;

	private SwigDelegateOdDbScale_31 swigDelegate31;

	private SwigDelegateOdDbScale_32 swigDelegate32;

	private SwigDelegateOdDbScale_33 swigDelegate33;

	private SwigDelegateOdDbScale_34 swigDelegate34;

	private SwigDelegateOdDbScale_35 swigDelegate35;

	private SwigDelegateOdDbScale_36 swigDelegate36;

	private SwigDelegateOdDbScale_37 swigDelegate37;

	private SwigDelegateOdDbScale_38 swigDelegate38;

	private SwigDelegateOdDbScale_39 swigDelegate39;

	private SwigDelegateOdDbScale_40 swigDelegate40;

	private SwigDelegateOdDbScale_41 swigDelegate41;

	private SwigDelegateOdDbScale_42 swigDelegate42;

	private SwigDelegateOdDbScale_43 swigDelegate43;

	private SwigDelegateOdDbScale_44 swigDelegate44;

	private SwigDelegateOdDbScale_45 swigDelegate45;

	private SwigDelegateOdDbScale_46 swigDelegate46;

	private SwigDelegateOdDbScale_47 swigDelegate47;

	private SwigDelegateOdDbScale_48 swigDelegate48;

	private SwigDelegateOdDbScale_49 swigDelegate49;

	private SwigDelegateOdDbScale_50 swigDelegate50;

	private SwigDelegateOdDbScale_51 swigDelegate51;

	private SwigDelegateOdDbScale_52 swigDelegate52;

	private SwigDelegateOdDbScale_53 swigDelegate53;

	private SwigDelegateOdDbScale_54 swigDelegate54;

	private SwigDelegateOdDbScale_55 swigDelegate55;

	private SwigDelegateOdDbScale_56 swigDelegate56;

	private SwigDelegateOdDbScale_57 swigDelegate57;

	private SwigDelegateOdDbScale_58 swigDelegate58;

	private SwigDelegateOdDbScale_59 swigDelegate59;

	private SwigDelegateOdDbScale_60 swigDelegate60;
	...
	public OdDbScale(IntPtr cPtr, bool cMemoryOwn)
		: base(TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbScale_SWIGUpcast(cPtr), cMemoryOwn)
	{
		swigCPtr = new HandleRef(this, cPtr);
	}

	[EditorBrowsable(EditorBrowsableState.Never)]
	public static HandleRef getCPtr(OdDbScale obj)
	{
	...
	protected override void Dispose(bool disposing)
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					TD_DbCoreIntegrated_GlobalsPINVOKE.delete_OdDbScale(swigCPtr);
				}
	...
	public new static OdDbScale cast(OdRxObject pObj)
	{
		OdDbScale rXObject = ODA.Kernel.TD_RootIntegrated.Helpers.GetRXObject<OdDbScale>(TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbScale_cast(OdRxObject.getCPtr(pObj)), bOwn: true, bTryAddToTransaction: true);
	...
	{
		OdRxClass rXObject = ODA.Kernel.TD_RootIntegrated.Helpers.GetRXObject<OdRxClass>(TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbScale_desc(), bOwn: false, bTryAddToTransaction: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		OdRxClass rXObject = ODA.Kernel.TD_RootIntegrated.Helpers.GetRXObject<OdRxClass>(SwigDerivedClassHasMethod("isA", swigMethodTypes1) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbScale_isASwigExplicitOdDbScale(swigCPtr) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbScale_isA(swigCPtr), bOwn: false, bTryAddToTransaction: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		OdRxObject rXObject = ODA.Kernel.TD_RootIntegrated.Helpers.GetRXObject<OdRxObject>(SwigDerivedClassHasMethod("queryX", swigMethodTypes0) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbScale_queryXSwigExplicitOdDbScale(swigCPtr, OdRxClass.getCPtr(protocolClass)) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbScale_queryX(swigCPtr, OdRxClass.getCPtr(protocolClass)), bOwn: false, bTryAddToTransaction: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		string result = TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbScale_scaleName(swigCPtr);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public void setScaleName(string sName)
	{
		TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbScale_setScaleName(swigCPtr, sName);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public double scale()
	{
		double result = TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbScale_scale(swigCPtr);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		double result = TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbScale_drawingUnits(swigCPtr);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public void setDrawingUnits(double vUnits)
	{
		TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbScale_setDrawingUnits(swigCPtr, vUnits);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		double result = TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbScale_paperUnits(swigCPtr);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public void setPaperUnits(double vUnits)
	{
		TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbScale_setPaperUnits(swigCPtr, vUnits);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		bool result = TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbScale_isTemporaryScale(swigCPtr);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public void setIsTemporaryScale(bool bStatus)
	{
		TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbScale_setIsTemporaryScale(swigCPtr, bStatus);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		bool result = TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbScale_isUnitScale(swigCPtr);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public void setIsUnitScale(bool bStatus)
	{
		TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbScale_setIsUnitScale(swigCPtr, bStatus);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public void getXRefMangledName(string arg0, ref string arg1, OdDbDatabase arg2)
	{
		IntPtr jarg = Marshal.StringToCoTaskMemUni(arg1);
		IntPtr intPtr = jarg;
		try
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbScale_getXRefMangledName(swigCPtr, arg0, ref jarg, OdDbDatabase.getCPtr(arg2));
			if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
			{
				throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
			}
	...
	{
		int result = (SwigDerivedClassHasMethod("dwgInFields", swigMethodTypes21) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbScale_dwgInFieldsSwigExplicitOdDbScale(swigCPtr, OdDbDwgFiler.getCPtr(pFiler)) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbScale_dwgInFields(swigCPtr, OdDbDwgFiler.getCPtr(pFiler)));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public override void dwgOutFields(OdDbDwgFiler pFiler)
	{
		...
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbScale_dwgOutFieldsSwigExplicitOdDbScale(swigCPtr, OdDbDwgFiler.getCPtr(pFiler));
		}
		else
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbScale_dwgOutFields(swigCPtr, OdDbDwgFiler.getCPtr(pFiler));
		}
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
	...
	{
		int result = (SwigDerivedClassHasMethod("dxfInFields", swigMethodTypes23) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbScale_dxfInFieldsSwigExplicitOdDbScale(swigCPtr, OdDbDxfFiler.getCPtr(pFiler)) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbScale_dxfInFields(swigCPtr, OdDbDxfFiler.getCPtr(pFiler)));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public override void dxfOutFields(OdDbDxfFiler pFiler)
	{
		...
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbScale_dxfOutFieldsSwigExplicitOdDbScale(swigCPtr, OdDbDxfFiler.getCPtr(pFiler));
		}
		else
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbScale_dxfOutFields(swigCPtr, OdDbDxfFiler.getCPtr(pFiler));
		}
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
	...
	public override void appendToOwner(OdDbIdPair idPair, OdDbObject pOwnerObject, ref OdDbIdMapping ownerIdMap)
	{
		...
		try
		{
			...
			{
				TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbScale_appendToOwnerSwigExplicitOdDbScale(swigCPtr, OdDbIdPair.getCPtr(idPair), OdDbObject.getCPtr(pOwnerObject), ref jarg);
			}
			else
			{
				TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbScale_appendToOwner(swigCPtr, OdDbIdPair.getCPtr(idPair), OdDbObject.getCPtr(pOwnerObject), ref jarg);
			}
			if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
			{
				throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
	...
	{
		int result = (SwigDerivedClassHasMethod("subErase", swigMethodTypes13) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbScale_subEraseSwigExplicitOdDbScale(swigCPtr, erasing) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbScale_subErase(swigCPtr, erasing));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public override void applyPartialUndo(OdDbDwgFiler pFiler, OdRxClass pClass)
	{
		...
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbScale_applyPartialUndoSwigExplicitOdDbScale(swigCPtr, OdDbDwgFiler.getCPtr(pFiler), OdRxClass.getCPtr(pClass));
		}
		else
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbScale_applyPartialUndo(swigCPtr, OdDbDwgFiler.getCPtr(pFiler), OdRxClass.getCPtr(pClass));
		}
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
	...
	{
		string result = TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbScale_getRealClassName(ptr);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public new static OdDbScale createObject()
	{
		OdDbScale rXObject = ODA.Kernel.TD_RootIntegrated.Helpers.GetRXObject<OdDbScale>(TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbScale_createObject(), bOwn: true, bTryAddToTransaction: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	private void SwigDirectorConnect()
	{
		...
		TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbScale_director_connect(swigCPtr, swigDelegate0, swigDelegate1, swigDelegate2, swigDelegate3, swigDelegate4, swigDelegate5, swigDelegate6, swigDelegate7, swigDelegate8, swigDelegate9, swigDelegate10, swigDelegate11, swigDelegate12, swigDelegate13, swigDelegate14, swigDelegate15, swigDelegate16, swigDelegate17, swigDelegate18, swigDelegate19, swigDelegate20, swigDelegate21, swigDelegate22, swigDelegate23, swigDelegate24, swigDelegate25, swigDelegate26, swigDelegate27, swigDelegate28, swigDelegate29, swigDelegate30, swigDelegate31, swigDelegate32, swigDelegate33, swigDelegate34, swigDelegate35, swigDelegate36, swigDelegate37, swigDelegate38, swigDelegate39, swigDelegate40, swigDelegate41, swigDelegate42, swigDelegate43, swigDelegate44, swigDelegate45, swigDelegate46, swigDelegate47, swigDelegate48, swigDelegate49, swigDelegate50, swigDelegate51, swigDelegate52, swigDelegate53, swigDelegate54, swigDelegate55, swigDelegate56, swigDelegate57, swigDelegate58, swigDelegate59, swigDelegate60);
	}

	private bool SwigDerivedClassHasMethod(string methodName, Type[] methodTypes)
	{
		return GetType().GetMethod(methodName, BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic, null, methodTypes, null).DeclaringType.IsSubclassOf(typeof(OdDbScale));
	}
