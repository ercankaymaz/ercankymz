...
public class OdDbFcf : OdDbEntity
{
	public delegate IntPtr SwigDelegateOdDbFcf_0(IntPtr protocolClass);

	public delegate IntPtr SwigDelegateOdDbFcf_1();

	public delegate void SwigDelegateOdDbFcf_2(IntPtr pSource);

	public delegate int SwigDelegateOdDbFcf_3();

	public delegate bool SwigDelegateOdDbFcf_4();

	public delegate IntPtr SwigDelegateOdDbFcf_5();

	public delegate void SwigDelegateOdDbFcf_6(IntPtr pNode);

	public delegate IntPtr SwigDelegateOdDbFcf_7();

	public delegate void SwigDelegateOdDbFcf_8(IntPtr ownerId);

	public delegate int SwigDelegateOdDbFcf_9(int mode);

	public delegate void SwigDelegateOdDbFcf_10();

	public delegate int SwigDelegateOdDbFcf_11(bool erasing);

	public delegate void SwigDelegateOdDbFcf_12(IntPtr pNewObject);

	public delegate void SwigDelegateOdDbFcf_13(IntPtr otherId, bool swapXdata, bool swapExtDict);

	public delegate void SwigDelegateOdDbFcf_14(IntPtr otherId, bool swapXdata);

	public delegate void SwigDelegateOdDbFcf_15(IntPtr otherId);

	public delegate void SwigDelegateOdDbFcf_16(IntPtr pAuditInfo);

	public delegate int SwigDelegateOdDbFcf_17(IntPtr pFiler);

	public delegate void SwigDelegateOdDbFcf_18(IntPtr pFiler);

	public delegate int SwigDelegateOdDbFcf_19(IntPtr pFiler);

	public delegate void SwigDelegateOdDbFcf_20(IntPtr pFiler);

	public delegate int SwigDelegateOdDbFcf_21(IntPtr pFiler);

	public delegate void SwigDelegateOdDbFcf_22(IntPtr pFiler);

	public delegate int SwigDelegateOdDbFcf_23(IntPtr pFiler);

	public delegate void SwigDelegateOdDbFcf_24(IntPtr pFiler);

	public delegate int SwigDelegateOdDbFcf_25();

	public delegate IntPtr SwigDelegateOdDbFcf_26([MarshalAs(UnmanagedType.LPWStr)] string regappName);

	public delegate void SwigDelegateOdDbFcf_27(IntPtr pRb);

	public delegate void SwigDelegateOdDbFcf_28(IntPtr pUndoFiler, IntPtr pClassObj);

	public delegate void SwigDelegateOdDbFcf_29(IntPtr objId);

	public delegate void SwigDelegateOdDbFcf_30(IntPtr objId);

	public delegate void SwigDelegateOdDbFcf_31(IntPtr pSubObj);

	public delegate void SwigDelegateOdDbFcf_32();

	public delegate void SwigDelegateOdDbFcf_33(IntPtr idPair, IntPtr pOwnerObject, IntPtr ownerIdMap);

	public delegate void SwigDelegateOdDbFcf_34(IntPtr pObject, IntPtr pNewObject);

	public delegate void SwigDelegateOdDbFcf_35(IntPtr pObject, bool erasing);

	public delegate void SwigDelegateOdDbFcf_36(IntPtr pObject);

	public delegate void SwigDelegateOdDbFcf_37(IntPtr pObject);

	public delegate void SwigDelegateOdDbFcf_38(IntPtr pObject);

	public delegate void SwigDelegateOdDbFcf_39(IntPtr pObject);

	public delegate void SwigDelegateOdDbFcf_40(IntPtr pObject, IntPtr pSubObj);

	public delegate void SwigDelegateOdDbFcf_41(IntPtr pObject);

	public delegate void SwigDelegateOdDbFcf_42(IntPtr pObject);

	public delegate void SwigDelegateOdDbFcf_43(IntPtr pObject);

	public delegate void SwigDelegateOdDbFcf_44(IntPtr pObject);

	public delegate void SwigDelegateOdDbFcf_45(IntPtr objectId);

	public delegate void SwigDelegateOdDbFcf_46(IntPtr pObject);

	public delegate void SwigDelegateOdDbFcf_47(IntPtr pSource);

	public delegate int SwigDelegateOdDbFcf_48(IntPtr pFiler, MaintReleaseVer pMaintVer);

	public delegate int SwigDelegateOdDbFcf_49(IntPtr pFiler);

	public delegate IntPtr SwigDelegateOdDbFcf_50(int ver, IntPtr replaceId, bool exchangeXData);

	public delegate IntPtr SwigDelegateOdDbFcf_51(int format, int ver, IntPtr replaceId, bool exchangeXData);

	public delegate void SwigDelegateOdDbFcf_52(int format, int version, IntPtr pAuditInfo);

	public delegate IntPtr SwigDelegateOdDbFcf_53();

	public delegate IntPtr SwigDelegateOdDbFcf_54([MarshalAs(UnmanagedType.LPWStr)] string fieldName, IntPtr pField);

	public delegate int SwigDelegateOdDbFcf_55(IntPtr fieldId);

	public delegate IntPtr SwigDelegateOdDbFcf_56([MarshalAs(UnmanagedType.LPWStr)] string fieldName);

	public delegate IntPtr SwigDelegateOdDbFcf_57(IntPtr pClass);

	public delegate int SwigDelegateOdDbFcf_58(IntPtr color, bool doSubents);

	public delegate int SwigDelegateOdDbFcf_59(IntPtr color);

	public delegate IntPtr SwigDelegateOdDbFcf_60();

	public delegate int SwigDelegateOdDbFcf_61(ushort colorIndex, bool doSubents);

	public delegate int SwigDelegateOdDbFcf_62(ushort colorIndex);

	public delegate int SwigDelegateOdDbFcf_63(IntPtr colorId, bool doSubents);

	public delegate int SwigDelegateOdDbFcf_64(IntPtr colorId);

	public delegate int SwigDelegateOdDbFcf_65(IntPtr transparency, bool doSubents);

	public delegate int SwigDelegateOdDbFcf_66(IntPtr transparency);

	public delegate int SwigDelegateOdDbFcf_67([MarshalAs(UnmanagedType.LPWStr)] string plotStyleName, bool doSubents);

	public delegate int SwigDelegateOdDbFcf_68([MarshalAs(UnmanagedType.LPWStr)] string plotStyleName);

	public delegate int SwigDelegateOdDbFcf_69(int plotStyleNameType, IntPtr plotStyleNameId, bool doSubents);

	public delegate int SwigDelegateOdDbFcf_70(int plotStyleNameType, IntPtr plotStyleNameId);

	public delegate int SwigDelegateOdDbFcf_71(int plotStyleNameType);

	public delegate int SwigDelegateOdDbFcf_72([MarshalAs(UnmanagedType.LPWStr)] string layerName, bool doSubents, bool allowHiddenLayer);

	public delegate int SwigDelegateOdDbFcf_73([MarshalAs(UnmanagedType.LPWStr)] string layerName, bool doSubents);

	public delegate int SwigDelegateOdDbFcf_74([MarshalAs(UnmanagedType.LPWStr)] string layerName);

	public delegate int SwigDelegateOdDbFcf_75(IntPtr layerId, bool doSubents, bool allowHiddenLayer);

	public delegate int SwigDelegateOdDbFcf_76(IntPtr layerId, bool doSubents);

	public delegate int SwigDelegateOdDbFcf_77(IntPtr layerId);

	public delegate int SwigDelegateOdDbFcf_78([MarshalAs(UnmanagedType.LPWStr)] string linetypeName, bool doSubents);

	public delegate int SwigDelegateOdDbFcf_79([MarshalAs(UnmanagedType.LPWStr)] string linetypeName);

	public delegate int SwigDelegateOdDbFcf_80(IntPtr linetypeID, bool doSubents);

	public delegate int SwigDelegateOdDbFcf_81(IntPtr linetypeID);

	public delegate int SwigDelegateOdDbFcf_82([MarshalAs(UnmanagedType.LPWStr)] string materialName, bool doSubents);

	public delegate int SwigDelegateOdDbFcf_83([MarshalAs(UnmanagedType.LPWStr)] string materialName);

	public delegate int SwigDelegateOdDbFcf_84(IntPtr materialID, bool doSubents);

	public delegate int SwigDelegateOdDbFcf_85(IntPtr materialID);

	public delegate int SwigDelegateOdDbFcf_86(IntPtr visualStyleId, int vstype, bool doSubents);

	public delegate IntPtr SwigDelegateOdDbFcf_87();

	public delegate void SwigDelegateOdDbFcf_88(IntPtr mapper, bool doSubents);

	public delegate void SwigDelegateOdDbFcf_89(IntPtr mapper);

	public delegate int SwigDelegateOdDbFcf_90(double linetypeScale, bool doSubents);

	public delegate int SwigDelegateOdDbFcf_91(double linetypeScale);

	public delegate int SwigDelegateOdDbFcf_92(int lineWeight, bool doSubents);

	public delegate int SwigDelegateOdDbFcf_93(int lineWeight);

	public delegate bool SwigDelegateOdDbFcf_94();

	public delegate void SwigDelegateOdDbFcf_95(bool castShadows);

	public delegate bool SwigDelegateOdDbFcf_96();

	public delegate void SwigDelegateOdDbFcf_97(bool receiveShadows);

	public delegate int SwigDelegateOdDbFcf_98();

	public delegate bool SwigDelegateOdDbFcf_99();

	public delegate int SwigDelegateOdDbFcf_100(IntPtr plane, OdDb_Planarity planarity);

	public delegate int SwigDelegateOdDbFcf_101(IntPtr pBlockRecord, IntPtr ids);

	public delegate int SwigDelegateOdDbFcf_102(IntPtr pBlockRecord);

	public delegate int SwigDelegateOdDbFcf_103(IntPtr entitySet);

	public delegate int SwigDelegateOdDbFcf_104(IntPtr pBlockRecord, IntPtr ids);

	public delegate int SwigDelegateOdDbFcf_105(IntPtr pBlockRecord);

	public delegate void SwigDelegateOdDbFcf_106(IntPtr pDb, bool doSubents);

	public delegate void SwigDelegateOdDbFcf_107();

	public delegate void SwigDelegateOdDbFcf_108(int status);

	public delegate void SwigDelegateOdDbFcf_109(IntPtr pWd, int ver);

	public delegate IntPtr SwigDelegateOdDbFcf_110();

	public delegate int SwigDelegateOdDbFcf_111(IntPtr xfm, IntPtr pCopy);

	public delegate int SwigDelegateOdDbFcf_112(IntPtr entitySet);

	public delegate int SwigDelegateOdDbFcf_113(IntPtr xM);

	public delegate bool SwigDelegateOdDbFcf_114();

	public delegate bool SwigDelegateOdDbFcf_115();

	public delegate void SwigDelegateOdDbFcf_116(int status);

	public delegate int SwigDelegateOdDbFcf_117(int osnapMode, IntPtr gsSelectionMark, IntPtr pickPoint, IntPtr lastPoint, IntPtr xWorldToEye, IntPtr snapPoints);

	public delegate int SwigDelegateOdDbFcf_118(int osnapMode, IntPtr gsSelectionMark, IntPtr pickPoint, IntPtr lastPoint, IntPtr xWorldToEye, IntPtr snapPoints, IntPtr insertionMat);

	public delegate bool SwigDelegateOdDbFcf_119();

	public delegate int SwigDelegateOdDbFcf_120(IntPtr gripPoints);

	public delegate int SwigDelegateOdDbFcf_121(IntPtr indices, IntPtr offset);

	public delegate int SwigDelegateOdDbFcf_122(IntPtr grips, double curViewUnitSize, int gripSize, IntPtr curViewDir, int bitFlags);

	public delegate int SwigDelegateOdDbFcf_123(IntPtr grips, IntPtr offset, int bitFlags);

	public delegate int SwigDelegateOdDbFcf_124(IntPtr stretchPoints);

	public delegate int SwigDelegateOdDbFcf_125(IntPtr indices, IntPtr offset);

	public delegate int SwigDelegateOdDbFcf_126(IntPtr pEnt, int intType, IntPtr points, IntPtr thisGsMarker, IntPtr otherGsMarker);

	public delegate int SwigDelegateOdDbFcf_127(IntPtr pEnt, int intType, IntPtr points, IntPtr thisGsMarker);

	public delegate int SwigDelegateOdDbFcf_128(IntPtr pEnt, int intType, IntPtr points);

	public delegate int SwigDelegateOdDbFcf_129(IntPtr pEnt, int intType, IntPtr projPlane, IntPtr points, IntPtr thisGsMarker, IntPtr otherGsMarker);

	public delegate int SwigDelegateOdDbFcf_130(IntPtr pEnt, int intType, IntPtr projPlane, IntPtr points, IntPtr thisGsMarker);

	public delegate int SwigDelegateOdDbFcf_131(IntPtr pEnt, int intType, IntPtr projPlane, IntPtr points);

	public delegate void SwigDelegateOdDbFcf_132(bool bDoIt, IntPtr pSubId, bool highlightAll);

	public delegate void SwigDelegateOdDbFcf_133(bool bDoIt, IntPtr pSubId);

	public delegate void SwigDelegateOdDbFcf_134(bool bDoIt);

	public delegate void SwigDelegateOdDbFcf_135();

	public delegate int SwigDelegateOdDbFcf_136();

	public delegate int SwigDelegateOdDbFcf_137(int visibility, bool doSubents);

	public delegate int SwigDelegateOdDbFcf_138(int visibility);

	public delegate int SwigDelegateOdDbFcf_139(IntPtr paths);

	public delegate int SwigDelegateOdDbFcf_140(IntPtr paths);

	public delegate int SwigDelegateOdDbFcf_141(IntPtr paths, IntPtr gripAppData, IntPtr offset, uint bitflags);

	public delegate int SwigDelegateOdDbFcf_142(IntPtr path, IntPtr grips, double curViewUnitSize, int gripSize, IntPtr curViewDir, uint bitflags);

	public delegate int SwigDelegateOdDbFcf_143(int type, IntPtr gsMark, IntPtr pickPoint, IntPtr xfm, IntPtr subentPaths, IntPtr pEntAndInsertStack);

	public delegate int SwigDelegateOdDbFcf_144(int type, IntPtr gsMark, IntPtr pickPoint, IntPtr xfm, IntPtr subentPaths);

	public delegate int SwigDelegateOdDbFcf_145(IntPtr subPath, IntPtr gsMarkers);

	public delegate IntPtr SwigDelegateOdDbFcf_146(IntPtr path);

	public delegate int SwigDelegateOdDbFcf_147(IntPtr paths, IntPtr xform);

	public delegate int SwigDelegateOdDbFcf_148(IntPtr path, IntPtr clsId);

	public delegate int SwigDelegateOdDbFcf_149(IntPtr path, IntPtr extents);

	public delegate void SwigDelegateOdDbFcf_150(int status, IntPtr subentity);

	public delegate void SwigDelegateOdDbFcf_151([MarshalAs(UnmanagedType.LPWStr)] string fcfText);

	[return: MarshalAs(UnmanagedType.LPWStr)]
	public delegate string SwigDelegateOdDbFcf_152(int lineNo);

	[return: MarshalAs(UnmanagedType.LPWStr)]
	public delegate string SwigDelegateOdDbFcf_153();

	public delegate void SwigDelegateOdDbFcf_154(IntPtr insPoint);

	public delegate IntPtr SwigDelegateOdDbFcf_155();

	public delegate void SwigDelegateOdDbFcf_156(IntPtr normal, IntPtr direction);

	public delegate IntPtr SwigDelegateOdDbFcf_157();

	public delegate IntPtr SwigDelegateOdDbFcf_158();

	public delegate void SwigDelegateOdDbFcf_159(IntPtr dimStyleId);

	public delegate IntPtr SwigDelegateOdDbFcf_160();

	public delegate void SwigDelegateOdDbFcf_161(IntPtr boundingPoints);

	public delegate void SwigDelegateOdDbFcf_162(IntPtr ptArray);

	private object locker = new object();

	private HandleRef swigCPtr;

	private SwigDelegateOdDbFcf_0 swigDelegate0;

	private SwigDelegateOdDbFcf_1 swigDelegate1;

	private SwigDelegateOdDbFcf_2 swigDelegate2;

	private SwigDelegateOdDbFcf_3 swigDelegate3;

	private SwigDelegateOdDbFcf_4 swigDelegate4;

	private SwigDelegateOdDbFcf_5 swigDelegate5;

	private SwigDelegateOdDbFcf_6 swigDelegate6;

	private SwigDelegateOdDbFcf_7 swigDelegate7;

	private SwigDelegateOdDbFcf_8 swigDelegate8;

	private SwigDelegateOdDbFcf_9 swigDelegate9;

	private SwigDelegateOdDbFcf_10 swigDelegate10;

	private SwigDelegateOdDbFcf_11 swigDelegate11;

	private SwigDelegateOdDbFcf_12 swigDelegate12;

	private SwigDelegateOdDbFcf_13 swigDelegate13;

	private SwigDelegateOdDbFcf_14 swigDelegate14;

	private SwigDelegateOdDbFcf_15 swigDelegate15;

	private SwigDelegateOdDbFcf_16 swigDelegate16;

	private SwigDelegateOdDbFcf_17 swigDelegate17;

	private SwigDelegateOdDbFcf_18 swigDelegate18;

	private SwigDelegateOdDbFcf_19 swigDelegate19;

	private SwigDelegateOdDbFcf_20 swigDelegate20;

	private SwigDelegateOdDbFcf_21 swigDelegate21;

	private SwigDelegateOdDbFcf_22 swigDelegate22;

	private SwigDelegateOdDbFcf_23 swigDelegate23;

	private SwigDelegateOdDbFcf_24 swigDelegate24;

	private SwigDelegateOdDbFcf_25 swigDelegate25;

	private SwigDelegateOdDbFcf_26 swigDelegate26;

	private SwigDelegateOdDbFcf_27 swigDelegate27;

	private SwigDelegateOdDbFcf_28 swigDelegate28;

	private SwigDelegateOdDbFcf_29 swigDelegate29;

	private SwigDelegateOdDbFcf_30 swigDelegate30;

	private SwigDelegateOdDbFcf_31 swigDelegate31;

	private SwigDelegateOdDbFcf_32 swigDelegate32;

	private SwigDelegateOdDbFcf_33 swigDelegate33;

	private SwigDelegateOdDbFcf_34 swigDelegate34;

	private SwigDelegateOdDbFcf_35 swigDelegate35;

	private SwigDelegateOdDbFcf_36 swigDelegate36;

	private SwigDelegateOdDbFcf_37 swigDelegate37;

	private SwigDelegateOdDbFcf_38 swigDelegate38;

	private SwigDelegateOdDbFcf_39 swigDelegate39;

	private SwigDelegateOdDbFcf_40 swigDelegate40;

	private SwigDelegateOdDbFcf_41 swigDelegate41;

	private SwigDelegateOdDbFcf_42 swigDelegate42;

	private SwigDelegateOdDbFcf_43 swigDelegate43;

	private SwigDelegateOdDbFcf_44 swigDelegate44;

	private SwigDelegateOdDbFcf_45 swigDelegate45;

	private SwigDelegateOdDbFcf_46 swigDelegate46;

	private SwigDelegateOdDbFcf_47 swigDelegate47;

	private SwigDelegateOdDbFcf_48 swigDelegate48;

	private SwigDelegateOdDbFcf_49 swigDelegate49;

	private SwigDelegateOdDbFcf_50 swigDelegate50;

	private SwigDelegateOdDbFcf_51 swigDelegate51;

	private SwigDelegateOdDbFcf_52 swigDelegate52;

	private SwigDelegateOdDbFcf_53 swigDelegate53;

	private SwigDelegateOdDbFcf_54 swigDelegate54;

	private SwigDelegateOdDbFcf_55 swigDelegate55;

	private SwigDelegateOdDbFcf_56 swigDelegate56;

	private SwigDelegateOdDbFcf_57 swigDelegate57;

	private SwigDelegateOdDbFcf_58 swigDelegate58;

	private SwigDelegateOdDbFcf_59 swigDelegate59;

	private SwigDelegateOdDbFcf_60 swigDelegate60;

	private SwigDelegateOdDbFcf_61 swigDelegate61;

	private SwigDelegateOdDbFcf_62 swigDelegate62;

	private SwigDelegateOdDbFcf_63 swigDelegate63;

	private SwigDelegateOdDbFcf_64 swigDelegate64;

	private SwigDelegateOdDbFcf_65 swigDelegate65;

	private SwigDelegateOdDbFcf_66 swigDelegate66;

	private SwigDelegateOdDbFcf_67 swigDelegate67;

	private SwigDelegateOdDbFcf_68 swigDelegate68;

	private SwigDelegateOdDbFcf_69 swigDelegate69;

	private SwigDelegateOdDbFcf_70 swigDelegate70;

	private SwigDelegateOdDbFcf_71 swigDelegate71;

	private SwigDelegateOdDbFcf_72 swigDelegate72;

	private SwigDelegateOdDbFcf_73 swigDelegate73;

	private SwigDelegateOdDbFcf_74 swigDelegate74;

	private SwigDelegateOdDbFcf_75 swigDelegate75;

	private SwigDelegateOdDbFcf_76 swigDelegate76;

	private SwigDelegateOdDbFcf_77 swigDelegate77;

	private SwigDelegateOdDbFcf_78 swigDelegate78;

	private SwigDelegateOdDbFcf_79 swigDelegate79;

	private SwigDelegateOdDbFcf_80 swigDelegate80;

	private SwigDelegateOdDbFcf_81 swigDelegate81;

	private SwigDelegateOdDbFcf_82 swigDelegate82;

	private SwigDelegateOdDbFcf_83 swigDelegate83;

	private SwigDelegateOdDbFcf_84 swigDelegate84;

	private SwigDelegateOdDbFcf_85 swigDelegate85;

	private SwigDelegateOdDbFcf_86 swigDelegate86;

	private SwigDelegateOdDbFcf_87 swigDelegate87;

	private SwigDelegateOdDbFcf_88 swigDelegate88;

	private SwigDelegateOdDbFcf_89 swigDelegate89;

	private SwigDelegateOdDbFcf_90 swigDelegate90;

	private SwigDelegateOdDbFcf_91 swigDelegate91;

	private SwigDelegateOdDbFcf_92 swigDelegate92;

	private SwigDelegateOdDbFcf_93 swigDelegate93;

	private SwigDelegateOdDbFcf_94 swigDelegate94;

	private SwigDelegateOdDbFcf_95 swigDelegate95;

	private SwigDelegateOdDbFcf_96 swigDelegate96;

	private SwigDelegateOdDbFcf_97 swigDelegate97;

	private SwigDelegateOdDbFcf_98 swigDelegate98;

	private SwigDelegateOdDbFcf_99 swigDelegate99;

	private SwigDelegateOdDbFcf_100 swigDelegate100;

	private SwigDelegateOdDbFcf_101 swigDelegate101;

	private SwigDelegateOdDbFcf_102 swigDelegate102;

	private SwigDelegateOdDbFcf_103 swigDelegate103;

	private SwigDelegateOdDbFcf_104 swigDelegate104;

	private SwigDelegateOdDbFcf_105 swigDelegate105;

	private SwigDelegateOdDbFcf_106 swigDelegate106;

	private SwigDelegateOdDbFcf_107 swigDelegate107;

	private SwigDelegateOdDbFcf_108 swigDelegate108;

	private SwigDelegateOdDbFcf_109 swigDelegate109;

	private SwigDelegateOdDbFcf_110 swigDelegate110;

	private SwigDelegateOdDbFcf_111 swigDelegate111;

	private SwigDelegateOdDbFcf_112 swigDelegate112;

	private SwigDelegateOdDbFcf_113 swigDelegate113;

	private SwigDelegateOdDbFcf_114 swigDelegate114;

	private SwigDelegateOdDbFcf_115 swigDelegate115;

	private SwigDelegateOdDbFcf_116 swigDelegate116;

	private SwigDelegateOdDbFcf_117 swigDelegate117;

	private SwigDelegateOdDbFcf_118 swigDelegate118;

	private SwigDelegateOdDbFcf_119 swigDelegate119;

	private SwigDelegateOdDbFcf_120 swigDelegate120;

	private SwigDelegateOdDbFcf_121 swigDelegate121;

	private SwigDelegateOdDbFcf_122 swigDelegate122;

	private SwigDelegateOdDbFcf_123 swigDelegate123;

	private SwigDelegateOdDbFcf_124 swigDelegate124;

	private SwigDelegateOdDbFcf_125 swigDelegate125;

	private SwigDelegateOdDbFcf_126 swigDelegate126;

	private SwigDelegateOdDbFcf_127 swigDelegate127;

	private SwigDelegateOdDbFcf_128 swigDelegate128;

	private SwigDelegateOdDbFcf_129 swigDelegate129;

	private SwigDelegateOdDbFcf_130 swigDelegate130;

	private SwigDelegateOdDbFcf_131 swigDelegate131;

	private SwigDelegateOdDbFcf_132 swigDelegate132;

	private SwigDelegateOdDbFcf_133 swigDelegate133;

	private SwigDelegateOdDbFcf_134 swigDelegate134;

	private SwigDelegateOdDbFcf_135 swigDelegate135;

	private SwigDelegateOdDbFcf_136 swigDelegate136;

	private SwigDelegateOdDbFcf_137 swigDelegate137;

	private SwigDelegateOdDbFcf_138 swigDelegate138;

	private SwigDelegateOdDbFcf_139 swigDelegate139;

	private SwigDelegateOdDbFcf_140 swigDelegate140;

	private SwigDelegateOdDbFcf_141 swigDelegate141;

	private SwigDelegateOdDbFcf_142 swigDelegate142;

	private SwigDelegateOdDbFcf_143 swigDelegate143;

	private SwigDelegateOdDbFcf_144 swigDelegate144;

	private SwigDelegateOdDbFcf_145 swigDelegate145;

	private SwigDelegateOdDbFcf_146 swigDelegate146;

	private SwigDelegateOdDbFcf_147 swigDelegate147;

	private SwigDelegateOdDbFcf_148 swigDelegate148;

	private SwigDelegateOdDbFcf_149 swigDelegate149;

	private SwigDelegateOdDbFcf_150 swigDelegate150;

	private SwigDelegateOdDbFcf_151 swigDelegate151;

	private SwigDelegateOdDbFcf_152 swigDelegate152;

	private SwigDelegateOdDbFcf_153 swigDelegate153;

	private SwigDelegateOdDbFcf_154 swigDelegate154;

	private SwigDelegateOdDbFcf_155 swigDelegate155;

	private SwigDelegateOdDbFcf_156 swigDelegate156;

	private SwigDelegateOdDbFcf_157 swigDelegate157;

	private SwigDelegateOdDbFcf_158 swigDelegate158;

	private SwigDelegateOdDbFcf_159 swigDelegate159;

	private SwigDelegateOdDbFcf_160 swigDelegate160;

	private SwigDelegateOdDbFcf_161 swigDelegate161;

	private SwigDelegateOdDbFcf_162 swigDelegate162;
	...
	private static Type[] swigMethodTypes151 = new Type[1] { typeof(string) };

	private static Type[] swigMethodTypes152 = new Type[1] { typeof(int) };
	...
	private static Type[] swigMethodTypes159 = new Type[1] { typeof(OdDbHardPointerId) };

	private static Type[] swigMethodTypes160 = new Type[0];

	private static Type[] swigMethodTypes161 = new Type[1] { typeof(OdGePoint3dArray) };

	private static Type[] swigMethodTypes162 = new Type[1] { typeof(OdGePoint3dArray) };

	[EditorBrowsable(EditorBrowsableState.Never)]
	public OdDbFcf(IntPtr cPtr, bool cMemoryOwn)
		: base(TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbFcf_SWIGUpcast(cPtr), cMemoryOwn)
	{
		swigCPtr = new HandleRef(this, cPtr);
	}

	[EditorBrowsable(EditorBrowsableState.Never)]
	public static HandleRef getCPtr(OdDbFcf obj)
	{
	...
	protected override void Dispose(bool disposing)
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					TD_DbCoreIntegrated_GlobalsPINVOKE.delete_OdDbFcf(swigCPtr);
				}
	...
	public new static OdDbFcf cast(OdRxObject pObj)
	{
		OdDbFcf rXObject = ODA.Kernel.TD_RootIntegrated.Helpers.GetRXObject<OdDbFcf>(TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbFcf_cast(OdRxObject.getCPtr(pObj)), bOwn: true, bTryAddToTransaction: true);
	...
	{
		OdRxClass rXObject = ODA.Kernel.TD_RootIntegrated.Helpers.GetRXObject<OdRxClass>(TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbFcf_desc(), bOwn: false, bTryAddToTransaction: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		OdRxClass rXObject = ODA.Kernel.TD_RootIntegrated.Helpers.GetRXObject<OdRxClass>(SwigDerivedClassHasMethod("isA", swigMethodTypes1) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbFcf_isASwigExplicitOdDbFcf(swigCPtr) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbFcf_isA(swigCPtr), bOwn: false, bTryAddToTransaction: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		OdRxObject rXObject = ODA.Kernel.TD_RootIntegrated.Helpers.GetRXObject<OdRxObject>(SwigDerivedClassHasMethod("queryX", swigMethodTypes0) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbFcf_queryXSwigExplicitOdDbFcf(swigCPtr, OdRxClass.getCPtr(protocolClass)) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbFcf_queryX(swigCPtr, OdRxClass.getCPtr(protocolClass)), bOwn: false, bTryAddToTransaction: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public virtual void setText(string fcfText)
	{
		if (SwigDerivedClassHasMethod("setText", swigMethodTypes151))
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbFcf_setTextSwigExplicitOdDbFcf(swigCPtr, fcfText);
		}
		else
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbFcf_setText(swigCPtr, fcfText);
		}
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
	...
	public virtual string text(int lineNo)
	{
		string result = (SwigDerivedClassHasMethod("text", swigMethodTypes152) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbFcf_textSwigExplicitOdDbFcf__SWIG_0(swigCPtr, lineNo) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbFcf_text__SWIG_0(swigCPtr, lineNo));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		string result = (SwigDerivedClassHasMethod("text", swigMethodTypes153) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbFcf_textSwigExplicitOdDbFcf__SWIG_1(swigCPtr) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbFcf_text__SWIG_1(swigCPtr));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public virtual void setLocation(OdGePoint3d insPoint)
	{
		if (SwigDerivedClassHasMethod("setLocation", swigMethodTypes154))
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbFcf_setLocationSwigExplicitOdDbFcf(swigCPtr, OdGePoint3d.getCPtr(insPoint));
		}
		else
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbFcf_setLocation(swigCPtr, OdGePoint3d.getCPtr(insPoint));
		}
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
	...
	public virtual OdGePoint3d location()
	{
		OdGePoint3d result = new OdGePoint3d(SwigDerivedClassHasMethod("location", swigMethodTypes155) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbFcf_locationSwigExplicitOdDbFcf(swigCPtr) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbFcf_location(swigCPtr), cMemoryOwn: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public virtual void setOrientation(OdGeVector3d normal, OdGeVector3d direction)
	{
		if (SwigDerivedClassHasMethod("setOrientation", swigMethodTypes156))
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbFcf_setOrientationSwigExplicitOdDbFcf(swigCPtr, OdGeVector3d.getCPtr(normal), OdGeVector3d.getCPtr(direction));
		}
		else
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbFcf_setOrientation(swigCPtr, OdGeVector3d.getCPtr(normal), OdGeVector3d.getCPtr(direction));
		}
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
	...
	{
		OdGeVector3d result = new OdGeVector3d(SwigDerivedClassHasMethod("normal", swigMethodTypes157) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbFcf_normalSwigExplicitOdDbFcf(swigCPtr) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbFcf_normal(swigCPtr), cMemoryOwn: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		OdGeVector3d result = new OdGeVector3d(SwigDerivedClassHasMethod("direction", swigMethodTypes158) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbFcf_directionSwigExplicitOdDbFcf(swigCPtr) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbFcf_direction(swigCPtr), cMemoryOwn: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		if (SwigDerivedClassHasMethod("setDimensionStyle", swigMethodTypes159))
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbFcf_setDimensionStyleSwigExplicitOdDbFcf(swigCPtr, OdDbHardPointerId.getCPtr(dimStyleId));
		}
		else
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbFcf_setDimensionStyle(swigCPtr, OdDbHardPointerId.getCPtr(dimStyleId));
		}
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
	...
	{
		OdDbHardPointerId result = new OdDbHardPointerId(SwigDerivedClassHasMethod("dimensionStyle", swigMethodTypes160) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbFcf_dimensionStyleSwigExplicitOdDbFcf(swigCPtr) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbFcf_dimensionStyle(swigCPtr), cMemoryOwn: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public OdCmColor dimclrd()
	{
		OdCmColor result = new OdCmColor(TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbFcf_dimclrd(swigCPtr), cMemoryOwn: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public OdCmColor dimclrt()
	{
		OdCmColor result = new OdCmColor(TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbFcf_dimclrt(swigCPtr), cMemoryOwn: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		double result = TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbFcf_dimgap(swigCPtr);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		double result = TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbFcf_dimscale(swigCPtr);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public OdDbObjectId dimtxsty()
	{
		OdDbObjectId result = new OdDbObjectId(TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbFcf_dimtxsty(swigCPtr), cMemoryOwn: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		double result = TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbFcf_dimtxt(swigCPtr);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public void setDimclrd(OdCmColor val)
	{
		TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbFcf_setDimclrd(swigCPtr, OdCmColor.getCPtr(val));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public void setDimclrt(OdCmColor val)
	{
		TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbFcf_setDimclrt(swigCPtr, OdCmColor.getCPtr(val));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public void setDimgap(double val)
	{
		TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbFcf_setDimgap(swigCPtr, val);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public void setDimscale(double val)
	{
		TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbFcf_setDimscale(swigCPtr, val);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public void setDimtxsty(OdDbObjectId val)
	{
		TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbFcf_setDimtxsty(swigCPtr, OdDbObjectId.getCPtr(val));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public void setDimtxt(double val)
	{
		TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbFcf_setDimtxt(swigCPtr, val);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		int result = (SwigDerivedClassHasMethod("dwgInFields", swigMethodTypes19) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbFcf_dwgInFieldsSwigExplicitOdDbFcf(swigCPtr, OdDbDwgFiler.getCPtr(pFiler)) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbFcf_dwgInFields(swigCPtr, OdDbDwgFiler.getCPtr(pFiler)));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public override void dwgOutFields(OdDbDwgFiler pFiler)
	{
		...
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbFcf_dwgOutFieldsSwigExplicitOdDbFcf(swigCPtr, OdDbDwgFiler.getCPtr(pFiler));
		}
		else
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbFcf_dwgOutFields(swigCPtr, OdDbDwgFiler.getCPtr(pFiler));
		}
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
	...
	{
		int result = (SwigDerivedClassHasMethod("dxfInFields", swigMethodTypes21) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbFcf_dxfInFieldsSwigExplicitOdDbFcf(swigCPtr, OdDbDxfFiler.getCPtr(pFiler)) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbFcf_dxfInFields(swigCPtr, OdDbDxfFiler.getCPtr(pFiler)));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public override void dxfOutFields(OdDbDxfFiler pFiler)
	{
		...
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbFcf_dxfOutFieldsSwigExplicitOdDbFcf(swigCPtr, OdDbDxfFiler.getCPtr(pFiler));
		}
		else
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbFcf_dxfOutFields(swigCPtr, OdDbDxfFiler.getCPtr(pFiler));
		}
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
	...
	public override void subSetDatabaseDefaults(OdDbDatabase pDb, bool doSubents)
	{
		...
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbFcf_subSetDatabaseDefaultsSwigExplicitOdDbFcf(swigCPtr, OdDbDatabase.getCPtr(pDb), doSubents);
		}
		else
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbFcf_subSetDatabaseDefaults(swigCPtr, OdDbDatabase.getCPtr(pDb), doSubents);
		}
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
	...
	public virtual void getBoundingPoints(OdGePoint3dArray boundingPoints)
	{
		if (SwigDerivedClassHasMethod("getBoundingPoints", swigMethodTypes161))
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbFcf_getBoundingPointsSwigExplicitOdDbFcf(swigCPtr, OdGePoint3dArray.getCPtr(boundingPoints).Handle);
		}
		else
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbFcf_getBoundingPoints(swigCPtr, OdGePoint3dArray.getCPtr(boundingPoints).Handle);
		}
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
	...
	public override void subClose()
	{
		...
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbFcf_subCloseSwigExplicitOdDbFcf(swigCPtr);
		}
		else
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbFcf_subClose(swigCPtr);
		}
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
	...
	public override void modified(OdDbObject pObject)
	{
		...
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbFcf_modifiedSwigExplicitOdDbFcf(swigCPtr, OdDbObject.getCPtr(pObject));
		}
		else
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbFcf_modified(swigCPtr, OdDbObject.getCPtr(pObject));
		}
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
	...
	{
		TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbFcf_getDimstyleData(swigCPtr, OdDbDimStyleTableRecord.getCPtr(pRecord));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbFcf_setDimstyleData__SWIG_0(swigCPtr, OdDbDimStyleTableRecord.getCPtr(pDimstyle));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbFcf_setDimstyleData__SWIG_1(swigCPtr, OdDbObjectId.getCPtr(dimstyleID));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public virtual void getBoundingPline(OdGePoint3dArray ptArray)
	{
		if (SwigDerivedClassHasMethod("getBoundingPline", swigMethodTypes162))
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbFcf_getBoundingPlineSwigExplicitOdDbFcf(swigCPtr, OdGePoint3dArray.getCPtr(ptArray).Handle);
		}
		else
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbFcf_getBoundingPline(swigCPtr, OdGePoint3dArray.getCPtr(ptArray).Handle);
		}
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
	...
	{
		OdDbObject rXObject = ODA.Kernel.TD_RootIntegrated.Helpers.GetRXObject<OdDbObject>(SwigDerivedClassHasMethod("decomposeForSave", swigMethodTypes50) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbFcf_decomposeForSaveSwigExplicitOdDbFcf(swigCPtr, (int)ver, OdDbObjectId.getCPtr(replaceId), out exchangeXData) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbFcf_decomposeForSave(swigCPtr, (int)ver, OdDbObjectId.getCPtr(replaceId), out exchangeXData), bOwn: true, bTryAddToTransaction: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		int result = TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbFcf_SubGetClassID(swigCPtr, pClsid);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		bool result = TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbFcf_SubWorldDraw(swigCPtr, OdGiWorldDraw.getCPtr(pWd));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbFcf_SubViewportDraw(swigCPtr, OdGiViewportDraw.getCPtr(pVd));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		int result = TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbFcf_SubTransformBy(swigCPtr, OdGeMatrix3d.getCPtr(xfm));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		int result = TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbFcf_SubGetGeomExtents(swigCPtr, OdGeExtents3d.getCPtr(extents));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public virtual OdDbObject SubWblockClone(ref OdDbIdMapping idMap, OdDbObject owner, bool bPrimary)
	{
		IntPtr jarg = ((idMap == null) ? IntPtr.Zero : OdDbIdMapping.getCPtr(idMap).Handle);
		IntPtr intPtr = jarg;
		try
		{
			OdDbObject rXObject = ODA.Kernel.TD_RootIntegrated.Helpers.GetRXObject<OdDbObject>(TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbFcf_SubWblockClone(swigCPtr, ref jarg, OdDbObject.getCPtr(owner), bPrimary), bOwn: true, bTryAddToTransaction: true);
			if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
			{
				throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
			}
	...
	{
		string result = TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbFcf_getRealClassName(ptr);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public new static OdDbFcf createObject()
	{
		OdDbFcf rXObject = ODA.Kernel.TD_RootIntegrated.Helpers.GetRXObject<OdDbFcf>(TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbFcf_createObject(), bOwn: true, bTryAddToTransaction: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	private void SwigDirectorMethodsetText([MarshalAs(UnmanagedType.LPWStr)] string fcfText)
	{
		try
		{
			setText(fcfText);
	...
	[return: MarshalAs(UnmanagedType.LPWStr)]
	private string SwigDirectorMethodtext__SWIG_0(int lineNo)
	{
		return text(lineNo);
	}

	[return: MarshalAs(UnmanagedType.LPWStr)]
	private string SwigDirectorMethodtext__SWIG_1()
	{
		return text();
	}

	private void SwigDirectorMethodsetLocation(IntPtr insPoint)
	{
		try
		{
			setLocation(new OdGePoint3d(insPoint, cMemoryOwn: false));
		}
		catch (OdEdEmptyInput err)
		{
			TD_DbCoreIntegrated_Globals.throw_native_OdError(err);
	...
	private IntPtr SwigDirectorMethodlocation()
	{
		return ((Func<IntPtr>)delegate
		{
			try
			{
				return OdGePoint3d.getCPtr(location()).Handle;
			}
			catch (OdEdEmptyInput odEdEmptyInput)
			{
				TD_DbCoreIntegrated_Globals.throw_native_OdError(odEdEmptyInput);
	...
	private void SwigDirectorMethodsetOrientation(IntPtr normal, IntPtr direction)
	{
		try
		{
			setOrientation(new OdGeVector3d(normal, cMemoryOwn: false), new OdGeVector3d(direction, cMemoryOwn: false));
		}
		catch (OdEdEmptyInput err)
		{
			TD_DbCoreIntegrated_Globals.throw_native_OdError(err);
	...
	private void SwigDirectorMethodsetDimensionStyle(IntPtr dimStyleId)
	{
		try
		{
			setDimensionStyle(new OdDbHardPointerId(dimStyleId, cMemoryOwn: true));
		}
		catch (OdEdEmptyInput err)
		{
			TD_DbCoreIntegrated_Globals.throw_native_OdError(err);
	...
	private void SwigDirectorMethodgetBoundingPoints(IntPtr boundingPoints)
	{
		try
		{
			getBoundingPoints(new OdGePoint3dArray(boundingPoints, cMemoryOwn: true));
		}
		catch (OdEdEmptyInput err)
		{
			TD_DbCoreIntegrated_Globals.throw_native_OdError(err);
	...
	private void SwigDirectorMethodgetBoundingPline(IntPtr ptArray)
	{
		try
		{
			getBoundingPline(new OdGePoint3dArray(ptArray, cMemoryOwn: true));
		}
		catch (OdEdEmptyInput err)
		{
			TD_DbCoreIntegrated_Globals.throw_native_OdError(err);
