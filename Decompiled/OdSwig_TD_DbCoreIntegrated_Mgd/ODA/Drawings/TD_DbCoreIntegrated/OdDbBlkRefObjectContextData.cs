...
public class OdDbBlkRefObjectContextData : OdDbAnnotScaleObjectContextData
{
	public delegate IntPtr SwigDelegateOdDbBlkRefObjectContextData_0(IntPtr protocolClass);

	public delegate IntPtr SwigDelegateOdDbBlkRefObjectContextData_1();

	public delegate void SwigDelegateOdDbBlkRefObjectContextData_2(IntPtr arg0);

	public delegate int SwigDelegateOdDbBlkRefObjectContextData_3();

	public delegate bool SwigDelegateOdDbBlkRefObjectContextData_4();

	public delegate IntPtr SwigDelegateOdDbBlkRefObjectContextData_5();

	public delegate void SwigDelegateOdDbBlkRefObjectContextData_6(IntPtr pNode);

	public delegate IntPtr SwigDelegateOdDbBlkRefObjectContextData_7();

	public delegate uint SwigDelegateOdDbBlkRefObjectContextData_8(IntPtr vd);

	public delegate uint SwigDelegateOdDbBlkRefObjectContextData_9();

	public delegate void SwigDelegateOdDbBlkRefObjectContextData_10(IntPtr ownerId);

	public delegate int SwigDelegateOdDbBlkRefObjectContextData_11(int mode);

	public delegate void SwigDelegateOdDbBlkRefObjectContextData_12();

	public delegate int SwigDelegateOdDbBlkRefObjectContextData_13(bool erasing);

	public delegate void SwigDelegateOdDbBlkRefObjectContextData_14(IntPtr pNewObject);

	public delegate void SwigDelegateOdDbBlkRefObjectContextData_15(IntPtr otherId, bool swapXdata, bool swapExtDict);

	public delegate void SwigDelegateOdDbBlkRefObjectContextData_16(IntPtr otherId, bool swapXdata);

	public delegate void SwigDelegateOdDbBlkRefObjectContextData_17(IntPtr otherId);

	public delegate void SwigDelegateOdDbBlkRefObjectContextData_18(IntPtr pAuditInfo);

	public delegate int SwigDelegateOdDbBlkRefObjectContextData_19(IntPtr pFiler);

	public delegate void SwigDelegateOdDbBlkRefObjectContextData_20(IntPtr pFiler);

	public delegate int SwigDelegateOdDbBlkRefObjectContextData_21(IntPtr pFiler);

	public delegate void SwigDelegateOdDbBlkRefObjectContextData_22(IntPtr pFiler);

	public delegate int SwigDelegateOdDbBlkRefObjectContextData_23(IntPtr pFiler);

	public delegate void SwigDelegateOdDbBlkRefObjectContextData_24(IntPtr pFiler);

	public delegate int SwigDelegateOdDbBlkRefObjectContextData_25(IntPtr pFiler);

	public delegate void SwigDelegateOdDbBlkRefObjectContextData_26(IntPtr pFiler);

	public delegate int SwigDelegateOdDbBlkRefObjectContextData_27();

	public delegate IntPtr SwigDelegateOdDbBlkRefObjectContextData_28([MarshalAs(UnmanagedType.LPWStr)] string regappName);

	public delegate void SwigDelegateOdDbBlkRefObjectContextData_29(IntPtr pRb);

	public delegate void SwigDelegateOdDbBlkRefObjectContextData_30(IntPtr pUndoFiler, IntPtr pClassObj);

	public delegate void SwigDelegateOdDbBlkRefObjectContextData_31(IntPtr objId);

	public delegate void SwigDelegateOdDbBlkRefObjectContextData_32(IntPtr objId);

	public delegate void SwigDelegateOdDbBlkRefObjectContextData_33(IntPtr pSubObj);

	public delegate void SwigDelegateOdDbBlkRefObjectContextData_34();

	public delegate void SwigDelegateOdDbBlkRefObjectContextData_35(IntPtr idPair, IntPtr pOwnerObject, IntPtr idMap);

	public delegate void SwigDelegateOdDbBlkRefObjectContextData_36(IntPtr pObject, IntPtr pNewObject);

	public delegate void SwigDelegateOdDbBlkRefObjectContextData_37(IntPtr pObject, bool erasing);

	public delegate void SwigDelegateOdDbBlkRefObjectContextData_38(IntPtr pObject);

	public delegate void SwigDelegateOdDbBlkRefObjectContextData_39(IntPtr pObject);

	public delegate void SwigDelegateOdDbBlkRefObjectContextData_40(IntPtr pObject);

	public delegate void SwigDelegateOdDbBlkRefObjectContextData_41(IntPtr pObject);

	public delegate void SwigDelegateOdDbBlkRefObjectContextData_42(IntPtr pObject, IntPtr pSubObj);

	public delegate void SwigDelegateOdDbBlkRefObjectContextData_43(IntPtr pObject);

	public delegate void SwigDelegateOdDbBlkRefObjectContextData_44(IntPtr pObject);

	public delegate void SwigDelegateOdDbBlkRefObjectContextData_45(IntPtr pObject);

	public delegate void SwigDelegateOdDbBlkRefObjectContextData_46(IntPtr pObject);

	public delegate void SwigDelegateOdDbBlkRefObjectContextData_47(IntPtr objectId);

	public delegate void SwigDelegateOdDbBlkRefObjectContextData_48(IntPtr pObject);

	public delegate void SwigDelegateOdDbBlkRefObjectContextData_49(IntPtr pSource);

	public delegate int SwigDelegateOdDbBlkRefObjectContextData_50(IntPtr pFiler, MaintReleaseVer pMaintVer);

	public delegate int SwigDelegateOdDbBlkRefObjectContextData_51(IntPtr pFiler);

	public delegate IntPtr SwigDelegateOdDbBlkRefObjectContextData_52(int ver, IntPtr replaceId, bool exchangeXData);

	public delegate IntPtr SwigDelegateOdDbBlkRefObjectContextData_53(int format, int ver, IntPtr replaceId, bool exchangeXData);

	public delegate void SwigDelegateOdDbBlkRefObjectContextData_54(int format, int version, IntPtr pAuditInfo);

	public delegate IntPtr SwigDelegateOdDbBlkRefObjectContextData_55();

	public delegate IntPtr SwigDelegateOdDbBlkRefObjectContextData_56([MarshalAs(UnmanagedType.LPWStr)] string fieldName, IntPtr pField);

	public delegate int SwigDelegateOdDbBlkRefObjectContextData_57(IntPtr fieldId);

	public delegate IntPtr SwigDelegateOdDbBlkRefObjectContextData_58([MarshalAs(UnmanagedType.LPWStr)] string fieldName);

	public delegate IntPtr SwigDelegateOdDbBlkRefObjectContextData_59(IntPtr pClass);

	public delegate int SwigDelegateOdDbBlkRefObjectContextData_60(IntPtr pClsid);

	public delegate int SwigDelegateOdDbBlkRefObjectContextData_61(IntPtr arg0);

	public delegate void SwigDelegateOdDbBlkRefObjectContextData_62(IntPtr arg0);

	public delegate IntPtr SwigDelegateOdDbBlkRefObjectContextData_63();

	public delegate bool SwigDelegateOdDbBlkRefObjectContextData_64(IntPtr arg0);

	public delegate void SwigDelegateOdDbBlkRefObjectContextData_65(IntPtr arg0);

	public delegate void SwigDelegateOdDbBlkRefObjectContextData_66();

	public delegate int SwigDelegateOdDbBlkRefObjectContextData_67(double arg0);

	public delegate IntPtr SwigDelegateOdDbBlkRefObjectContextData_68();

	public delegate double SwigDelegateOdDbBlkRefObjectContextData_69();

	public delegate IntPtr SwigDelegateOdDbBlkRefObjectContextData_70();

	public delegate void SwigDelegateOdDbBlkRefObjectContextData_71(IntPtr arg0);

	public delegate void SwigDelegateOdDbBlkRefObjectContextData_72(double arg0);

	public delegate void SwigDelegateOdDbBlkRefObjectContextData_73(IntPtr arg0);

	private object locker = new object();

	private HandleRef swigCPtr;

	private SwigDelegateOdDbBlkRefObjectContextData_0 swigDelegate0;

	private SwigDelegateOdDbBlkRefObjectContextData_1 swigDelegate1;

	private SwigDelegateOdDbBlkRefObjectContextData_2 swigDelegate2;

	private SwigDelegateOdDbBlkRefObjectContextData_3 swigDelegate3;

	private SwigDelegateOdDbBlkRefObjectContextData_4 swigDelegate4;

	private SwigDelegateOdDbBlkRefObjectContextData_5 swigDelegate5;

	private SwigDelegateOdDbBlkRefObjectContextData_6 swigDelegate6;

	private SwigDelegateOdDbBlkRefObjectContextData_7 swigDelegate7;

	private SwigDelegateOdDbBlkRefObjectContextData_8 swigDelegate8;

	private SwigDelegateOdDbBlkRefObjectContextData_9 swigDelegate9;

	private SwigDelegateOdDbBlkRefObjectContextData_10 swigDelegate10;

	private SwigDelegateOdDbBlkRefObjectContextData_11 swigDelegate11;

	private SwigDelegateOdDbBlkRefObjectContextData_12 swigDelegate12;

	private SwigDelegateOdDbBlkRefObjectContextData_13 swigDelegate13;

	private SwigDelegateOdDbBlkRefObjectContextData_14 swigDelegate14;

	private SwigDelegateOdDbBlkRefObjectContextData_15 swigDelegate15;

	private SwigDelegateOdDbBlkRefObjectContextData_16 swigDelegate16;

	private SwigDelegateOdDbBlkRefObjectContextData_17 swigDelegate17;

	private SwigDelegateOdDbBlkRefObjectContextData_18 swigDelegate18;

	private SwigDelegateOdDbBlkRefObjectContextData_19 swigDelegate19;

	private SwigDelegateOdDbBlkRefObjectContextData_20 swigDelegate20;

	private SwigDelegateOdDbBlkRefObjectContextData_21 swigDelegate21;

	private SwigDelegateOdDbBlkRefObjectContextData_22 swigDelegate22;

	private SwigDelegateOdDbBlkRefObjectContextData_23 swigDelegate23;

	private SwigDelegateOdDbBlkRefObjectContextData_24 swigDelegate24;

	private SwigDelegateOdDbBlkRefObjectContextData_25 swigDelegate25;

	private SwigDelegateOdDbBlkRefObjectContextData_26 swigDelegate26;

	private SwigDelegateOdDbBlkRefObjectContextData_27 swigDelegate27;

	private SwigDelegateOdDbBlkRefObjectContextData_28 swigDelegate28;

	private SwigDelegateOdDbBlkRefObjectContextData_29 swigDelegate29;

	private SwigDelegateOdDbBlkRefObjectContextData_30 swigDelegate30;

	private SwigDelegateOdDbBlkRefObjectContextData_31 swigDelegate31;

	private SwigDelegateOdDbBlkRefObjectContextData_32 swigDelegate32;

	private SwigDelegateOdDbBlkRefObjectContextData_33 swigDelegate33;

	private SwigDelegateOdDbBlkRefObjectContextData_34 swigDelegate34;

	private SwigDelegateOdDbBlkRefObjectContextData_35 swigDelegate35;

	private SwigDelegateOdDbBlkRefObjectContextData_36 swigDelegate36;

	private SwigDelegateOdDbBlkRefObjectContextData_37 swigDelegate37;

	private SwigDelegateOdDbBlkRefObjectContextData_38 swigDelegate38;

	private SwigDelegateOdDbBlkRefObjectContextData_39 swigDelegate39;

	private SwigDelegateOdDbBlkRefObjectContextData_40 swigDelegate40;

	private SwigDelegateOdDbBlkRefObjectContextData_41 swigDelegate41;

	private SwigDelegateOdDbBlkRefObjectContextData_42 swigDelegate42;

	private SwigDelegateOdDbBlkRefObjectContextData_43 swigDelegate43;

	private SwigDelegateOdDbBlkRefObjectContextData_44 swigDelegate44;

	private SwigDelegateOdDbBlkRefObjectContextData_45 swigDelegate45;

	private SwigDelegateOdDbBlkRefObjectContextData_46 swigDelegate46;

	private SwigDelegateOdDbBlkRefObjectContextData_47 swigDelegate47;

	private SwigDelegateOdDbBlkRefObjectContextData_48 swigDelegate48;

	private SwigDelegateOdDbBlkRefObjectContextData_49 swigDelegate49;

	private SwigDelegateOdDbBlkRefObjectContextData_50 swigDelegate50;

	private SwigDelegateOdDbBlkRefObjectContextData_51 swigDelegate51;

	private SwigDelegateOdDbBlkRefObjectContextData_52 swigDelegate52;

	private SwigDelegateOdDbBlkRefObjectContextData_53 swigDelegate53;

	private SwigDelegateOdDbBlkRefObjectContextData_54 swigDelegate54;

	private SwigDelegateOdDbBlkRefObjectContextData_55 swigDelegate55;

	private SwigDelegateOdDbBlkRefObjectContextData_56 swigDelegate56;

	private SwigDelegateOdDbBlkRefObjectContextData_57 swigDelegate57;

	private SwigDelegateOdDbBlkRefObjectContextData_58 swigDelegate58;

	private SwigDelegateOdDbBlkRefObjectContextData_59 swigDelegate59;

	private SwigDelegateOdDbBlkRefObjectContextData_60 swigDelegate60;

	private SwigDelegateOdDbBlkRefObjectContextData_61 swigDelegate61;

	private SwigDelegateOdDbBlkRefObjectContextData_62 swigDelegate62;

	private SwigDelegateOdDbBlkRefObjectContextData_63 swigDelegate63;

	private SwigDelegateOdDbBlkRefObjectContextData_64 swigDelegate64;

	private SwigDelegateOdDbBlkRefObjectContextData_65 swigDelegate65;

	private SwigDelegateOdDbBlkRefObjectContextData_66 swigDelegate66;

	private SwigDelegateOdDbBlkRefObjectContextData_67 swigDelegate67;

	private SwigDelegateOdDbBlkRefObjectContextData_68 swigDelegate68;

	private SwigDelegateOdDbBlkRefObjectContextData_69 swigDelegate69;

	private SwigDelegateOdDbBlkRefObjectContextData_70 swigDelegate70;

	private SwigDelegateOdDbBlkRefObjectContextData_71 swigDelegate71;

	private SwigDelegateOdDbBlkRefObjectContextData_72 swigDelegate72;

	private SwigDelegateOdDbBlkRefObjectContextData_73 swigDelegate73;
	...
	private static Type[] swigMethodTypes71 = new Type[1] { typeof(OdGePoint3d) };

	private static Type[] swigMethodTypes72 = new Type[1] { typeof(double) };

	private static Type[] swigMethodTypes73 = new Type[1] { typeof(OdGeScale3d) };

	[EditorBrowsable(EditorBrowsableState.Never)]
	public OdDbBlkRefObjectContextData(IntPtr cPtr, bool cMemoryOwn)
		: base(TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlkRefObjectContextData_SWIGUpcast(cPtr), cMemoryOwn)
	{
		swigCPtr = new HandleRef(this, cPtr);
	}

	[EditorBrowsable(EditorBrowsableState.Never)]
	public static HandleRef getCPtr(OdDbBlkRefObjectContextData obj)
	{
	...
	protected override void Dispose(bool disposing)
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					TD_DbCoreIntegrated_GlobalsPINVOKE.delete_OdDbBlkRefObjectContextData(swigCPtr);
				}
	...
	public new static OdDbBlkRefObjectContextData cast(OdRxObject pObj)
	{
		OdDbBlkRefObjectContextData rXObject = ODA.Kernel.TD_RootIntegrated.Helpers.GetRXObject<OdDbBlkRefObjectContextData>(TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlkRefObjectContextData_cast(OdRxObject.getCPtr(pObj)), bOwn: true, bTryAddToTransaction: true);
	...
	{
		OdRxClass rXObject = ODA.Kernel.TD_RootIntegrated.Helpers.GetRXObject<OdRxClass>(TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlkRefObjectContextData_desc(), bOwn: false, bTryAddToTransaction: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		OdRxClass rXObject = ODA.Kernel.TD_RootIntegrated.Helpers.GetRXObject<OdRxClass>(SwigDerivedClassHasMethod("isA", swigMethodTypes1) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlkRefObjectContextData_isASwigExplicitOdDbBlkRefObjectContextData(swigCPtr) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlkRefObjectContextData_isA(swigCPtr), bOwn: false, bTryAddToTransaction: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		OdRxObject rXObject = ODA.Kernel.TD_RootIntegrated.Helpers.GetRXObject<OdRxObject>(SwigDerivedClassHasMethod("queryX", swigMethodTypes0) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlkRefObjectContextData_queryXSwigExplicitOdDbBlkRefObjectContextData(swigCPtr, OdRxClass.getCPtr(protocolClass)) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlkRefObjectContextData_queryX(swigCPtr, OdRxClass.getCPtr(protocolClass)), bOwn: false, bTryAddToTransaction: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public virtual OdGePoint3d positionInEcs()
	{
		OdGePoint3d result = new OdGePoint3d(SwigDerivedClassHasMethod("positionInEcs", swigMethodTypes68) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlkRefObjectContextData_positionInEcsSwigExplicitOdDbBlkRefObjectContextData(swigCPtr) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlkRefObjectContextData_positionInEcs(swigCPtr), cMemoryOwn: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		double result = (SwigDerivedClassHasMethod("rotation", swigMethodTypes69) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlkRefObjectContextData_rotationSwigExplicitOdDbBlkRefObjectContextData(swigCPtr) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlkRefObjectContextData_rotation(swigCPtr));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public virtual OdGeScale3d scaleFactors()
	{
		OdGeScale3d result = new OdGeScale3d(SwigDerivedClassHasMethod("scaleFactors", swigMethodTypes70) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlkRefObjectContextData_scaleFactorsSwigExplicitOdDbBlkRefObjectContextData(swigCPtr) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlkRefObjectContextData_scaleFactors(swigCPtr), cMemoryOwn: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public virtual void setPositionInEcs(OdGePoint3d arg0)
	{
		if (SwigDerivedClassHasMethod("setPositionInEcs", swigMethodTypes71))
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlkRefObjectContextData_setPositionInEcsSwigExplicitOdDbBlkRefObjectContextData(swigCPtr, OdGePoint3d.getCPtr(arg0));
		}
		else
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlkRefObjectContextData_setPositionInEcs(swigCPtr, OdGePoint3d.getCPtr(arg0));
		}
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
	...
	{
		if (SwigDerivedClassHasMethod("setRotation", swigMethodTypes72))
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlkRefObjectContextData_setRotationSwigExplicitOdDbBlkRefObjectContextData(swigCPtr, arg0);
		}
		else
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlkRefObjectContextData_setRotation(swigCPtr, arg0);
		}
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
	...
	public virtual void setScaleFactors(OdGeScale3d arg0)
	{
		if (SwigDerivedClassHasMethod("setScaleFactors", swigMethodTypes73))
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlkRefObjectContextData_setScaleFactorsSwigExplicitOdDbBlkRefObjectContextData(swigCPtr, OdGeScale3d.getCPtr(arg0));
		}
		else
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlkRefObjectContextData_setScaleFactors(swigCPtr, OdGeScale3d.getCPtr(arg0));
		}
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
	...
	public override void copyFrom(OdRxObject arg0)
	{
		...
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlkRefObjectContextData_copyFromSwigExplicitOdDbBlkRefObjectContextData(swigCPtr, OdRxObject.getCPtr(arg0));
		}
		else
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlkRefObjectContextData_copyFrom(swigCPtr, OdRxObject.getCPtr(arg0));
		}
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
	...
	{
		int result = (SwigDerivedClassHasMethod("dxfInFields", swigMethodTypes23) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlkRefObjectContextData_dxfInFieldsSwigExplicitOdDbBlkRefObjectContextData(swigCPtr, OdDbDxfFiler.getCPtr(pFiler)) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlkRefObjectContextData_dxfInFields(swigCPtr, OdDbDxfFiler.getCPtr(pFiler)));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public override void dxfOutFields(OdDbDxfFiler pFiler)
	{
		...
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlkRefObjectContextData_dxfOutFieldsSwigExplicitOdDbBlkRefObjectContextData(swigCPtr, OdDbDxfFiler.getCPtr(pFiler));
		}
		else
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlkRefObjectContextData_dxfOutFields(swigCPtr, OdDbDxfFiler.getCPtr(pFiler));
		}
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
	...
	{
		string result = TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlkRefObjectContextData_getRealClassName(ptr);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public new static OdDbBlkRefObjectContextData createObject()
	{
		OdDbBlkRefObjectContextData rXObject = ODA.Kernel.TD_RootIntegrated.Helpers.GetRXObject<OdDbBlkRefObjectContextData>(TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlkRefObjectContextData_createObject(), bOwn: true, bTryAddToTransaction: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	private void SwigDirectorConnect()
	{
		...
		if (SwigDerivedClassHasMethod("positionInEcs", swigMethodTypes68))
		{
			swigDelegate68 = SwigDirectorMethodpositionInEcs;
		}
		if (SwigDerivedClassHasMethod("rotation", swigMethodTypes69))
		{
			swigDelegate69 = SwigDirectorMethodrotation;
		}
		if (SwigDerivedClassHasMethod("scaleFactors", swigMethodTypes70))
		{
			swigDelegate70 = SwigDirectorMethodscaleFactors;
		}
		if (SwigDerivedClassHasMethod("setPositionInEcs", swigMethodTypes71))
		{
			swigDelegate71 = SwigDirectorMethodsetPositionInEcs;
		}
		if (SwigDerivedClassHasMethod("setRotation", swigMethodTypes72))
		{
			swigDelegate72 = SwigDirectorMethodsetRotation;
		}
		if (SwigDerivedClassHasMethod("setScaleFactors", swigMethodTypes73))
		{
			swigDelegate73 = SwigDirectorMethodsetScaleFactors;
		}
		TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlkRefObjectContextData_director_connect(swigCPtr, swigDelegate0, swigDelegate1, swigDelegate2, swigDelegate3, swigDelegate4, swigDelegate5, swigDelegate6, swigDelegate7, swigDelegate8, swigDelegate9, swigDelegate10, swigDelegate11, swigDelegate12, swigDelegate13, swigDelegate14, swigDelegate15, swigDelegate16, swigDelegate17, swigDelegate18, swigDelegate19, swigDelegate20, swigDelegate21, swigDelegate22, swigDelegate23, swigDelegate24, swigDelegate25, swigDelegate26, swigDelegate27, swigDelegate28, swigDelegate29, swigDelegate30, swigDelegate31, swigDelegate32, swigDelegate33, swigDelegate34, swigDelegate35, swigDelegate36, swigDelegate37, swigDelegate38, swigDelegate39, swigDelegate40, swigDelegate41, swigDelegate42, swigDelegate43, swigDelegate44, swigDelegate45, swigDelegate46, swigDelegate47, swigDelegate48, swigDelegate49, swigDelegate50, swigDelegate51, swigDelegate52, swigDelegate53, swigDelegate54, swigDelegate55, swigDelegate56, swigDelegate57, swigDelegate58, swigDelegate59, swigDelegate60, swigDelegate61, swigDelegate62, swigDelegate63, swigDelegate64, swigDelegate65, swigDelegate66, swigDelegate67, swigDelegate68, swigDelegate69, swigDelegate70, swigDelegate71, swigDelegate72, swigDelegate73);
	}

	private bool SwigDerivedClassHasMethod(string methodName, Type[] methodTypes)
	{
		return GetType().GetMethod(methodName, BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic, null, methodTypes, null).DeclaringType.IsSubclassOf(typeof(OdDbBlkRefObjectContextData));
	}
	...
	private IntPtr SwigDirectorMethodpositionInEcs()
	{
		return ((Func<IntPtr>)delegate
		{
			try
			{
				return OdGePoint3d.getCPtr(positionInEcs()).Handle;
			}
			catch (OdEdEmptyInput odEdEmptyInput)
			{
				TD_DbCoreIntegrated_Globals.throw_native_OdError(odEdEmptyInput);
	...
	private IntPtr SwigDirectorMethodscaleFactors()
	{
		return ((Func<IntPtr>)delegate
		{
			try
			{
				return OdGeScale3d.getCPtr(scaleFactors()).Handle;
			}
			catch (OdEdEmptyInput odEdEmptyInput)
			{
				TD_DbCoreIntegrated_Globals.throw_native_OdError(odEdEmptyInput);
	...
	private void SwigDirectorMethodsetPositionInEcs(IntPtr arg0)
	{
		try
		{
			setPositionInEcs(new OdGePoint3d(arg0, cMemoryOwn: false));
		}
		catch (OdEdEmptyInput err)
		{
			TD_DbCoreIntegrated_Globals.throw_native_OdError(err);
	...
	private void SwigDirectorMethodsetScaleFactors(IntPtr arg0)
	{
		try
		{
			setScaleFactors(new OdGeScale3d(arg0, cMemoryOwn: false));
		}
		catch (OdEdEmptyInput err)
		{
			TD_DbCoreIntegrated_Globals.throw_native_OdError(err);
