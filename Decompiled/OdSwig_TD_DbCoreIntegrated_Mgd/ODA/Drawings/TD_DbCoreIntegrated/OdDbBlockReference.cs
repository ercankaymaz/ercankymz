...
public class OdDbBlockReference : OdDbEntity
{
	public delegate IntPtr SwigDelegateOdDbBlockReference_0(IntPtr protocolClass);

	public delegate IntPtr SwigDelegateOdDbBlockReference_1();

	public delegate void SwigDelegateOdDbBlockReference_2(IntPtr pSrc);

	public delegate int SwigDelegateOdDbBlockReference_3();

	public delegate bool SwigDelegateOdDbBlockReference_4();

	public delegate IntPtr SwigDelegateOdDbBlockReference_5();

	public delegate void SwigDelegateOdDbBlockReference_6(IntPtr pNode);

	public delegate IntPtr SwigDelegateOdDbBlockReference_7();

	public delegate void SwigDelegateOdDbBlockReference_8(IntPtr ownerId);

	public delegate int SwigDelegateOdDbBlockReference_9(int mode);

	public delegate void SwigDelegateOdDbBlockReference_10();

	public delegate int SwigDelegateOdDbBlockReference_11(bool erasing);

	public delegate void SwigDelegateOdDbBlockReference_12(IntPtr pNewObject);

	public delegate void SwigDelegateOdDbBlockReference_13(IntPtr otherId, bool swapXdata, bool swapExtDict);

	public delegate void SwigDelegateOdDbBlockReference_14(IntPtr otherId, bool swapXdata);

	public delegate void SwigDelegateOdDbBlockReference_15(IntPtr otherId);

	public delegate void SwigDelegateOdDbBlockReference_16(IntPtr pAuditInfo);

	public delegate int SwigDelegateOdDbBlockReference_17(IntPtr pFiler);

	public delegate void SwigDelegateOdDbBlockReference_18(IntPtr pFiler);

	public delegate int SwigDelegateOdDbBlockReference_19(IntPtr pFiler);

	public delegate void SwigDelegateOdDbBlockReference_20(IntPtr pFiler);

	public delegate int SwigDelegateOdDbBlockReference_21(IntPtr pFiler);

	public delegate void SwigDelegateOdDbBlockReference_22(IntPtr pFiler);

	public delegate int SwigDelegateOdDbBlockReference_23(IntPtr pFiler);

	public delegate void SwigDelegateOdDbBlockReference_24(IntPtr pFiler);

	public delegate int SwigDelegateOdDbBlockReference_25();

	public delegate IntPtr SwigDelegateOdDbBlockReference_26([MarshalAs(UnmanagedType.LPWStr)] string regappName);

	public delegate void SwigDelegateOdDbBlockReference_27(IntPtr pRb);

	public delegate void SwigDelegateOdDbBlockReference_28(IntPtr pUndoFiler, IntPtr pClassObj);

	public delegate void SwigDelegateOdDbBlockReference_29(IntPtr objId);

	public delegate void SwigDelegateOdDbBlockReference_30(IntPtr objId);

	public delegate void SwigDelegateOdDbBlockReference_31(IntPtr pSubObj);

	public delegate void SwigDelegateOdDbBlockReference_32();

	public delegate void SwigDelegateOdDbBlockReference_33(IntPtr idPair, IntPtr pOwnerObject, IntPtr ownerIdMap);

	public delegate void SwigDelegateOdDbBlockReference_34(IntPtr pObject, IntPtr pNewObject);

	public delegate void SwigDelegateOdDbBlockReference_35(IntPtr pObject, bool erasing);

	public delegate void SwigDelegateOdDbBlockReference_36(IntPtr pObject);

	public delegate void SwigDelegateOdDbBlockReference_37(IntPtr pObject);

	public delegate void SwigDelegateOdDbBlockReference_38(IntPtr pObject);

	public delegate void SwigDelegateOdDbBlockReference_39(IntPtr pObject);

	public delegate void SwigDelegateOdDbBlockReference_40(IntPtr pObject, IntPtr pSubObj);

	public delegate void SwigDelegateOdDbBlockReference_41(IntPtr pObject);

	public delegate void SwigDelegateOdDbBlockReference_42(IntPtr pObject);

	public delegate void SwigDelegateOdDbBlockReference_43(IntPtr pObject);

	public delegate void SwigDelegateOdDbBlockReference_44(IntPtr pObject);

	public delegate void SwigDelegateOdDbBlockReference_45(IntPtr objectId);

	public delegate void SwigDelegateOdDbBlockReference_46(IntPtr pObject);

	public delegate void SwigDelegateOdDbBlockReference_47(IntPtr pSource);

	public delegate int SwigDelegateOdDbBlockReference_48(IntPtr pFiler, MaintReleaseVer pMaintVer);

	public delegate int SwigDelegateOdDbBlockReference_49(IntPtr pFiler);

	public delegate IntPtr SwigDelegateOdDbBlockReference_50(int ver, IntPtr replaceId, bool exchangeXData);

	public delegate IntPtr SwigDelegateOdDbBlockReference_51(int format, int ver, IntPtr replaceId, bool exchangeXData);

	public delegate void SwigDelegateOdDbBlockReference_52(int format, int version, IntPtr pAuditInfo);

	public delegate IntPtr SwigDelegateOdDbBlockReference_53();

	public delegate IntPtr SwigDelegateOdDbBlockReference_54([MarshalAs(UnmanagedType.LPWStr)] string fieldName, IntPtr pField);

	public delegate int SwigDelegateOdDbBlockReference_55(IntPtr fieldId);

	public delegate IntPtr SwigDelegateOdDbBlockReference_56([MarshalAs(UnmanagedType.LPWStr)] string fieldName);

	public delegate IntPtr SwigDelegateOdDbBlockReference_57(IntPtr pClass);

	public delegate int SwigDelegateOdDbBlockReference_58(IntPtr color, bool doSubents);

	public delegate int SwigDelegateOdDbBlockReference_59(IntPtr color);

	public delegate IntPtr SwigDelegateOdDbBlockReference_60();

	public delegate int SwigDelegateOdDbBlockReference_61(ushort colorIndex, bool doSubents);

	public delegate int SwigDelegateOdDbBlockReference_62(ushort colorIndex);

	public delegate int SwigDelegateOdDbBlockReference_63(IntPtr colorId, bool doSubents);

	public delegate int SwigDelegateOdDbBlockReference_64(IntPtr colorId);

	public delegate int SwigDelegateOdDbBlockReference_65(IntPtr transparency, bool doSubents);

	public delegate int SwigDelegateOdDbBlockReference_66(IntPtr transparency);

	public delegate int SwigDelegateOdDbBlockReference_67([MarshalAs(UnmanagedType.LPWStr)] string plotStyleName, bool doSubents);

	public delegate int SwigDelegateOdDbBlockReference_68([MarshalAs(UnmanagedType.LPWStr)] string plotStyleName);

	public delegate int SwigDelegateOdDbBlockReference_69(int plotStyleNameType, IntPtr plotStyleNameId, bool doSubents);

	public delegate int SwigDelegateOdDbBlockReference_70(int plotStyleNameType, IntPtr plotStyleNameId);

	public delegate int SwigDelegateOdDbBlockReference_71(int plotStyleNameType);

	public delegate int SwigDelegateOdDbBlockReference_72([MarshalAs(UnmanagedType.LPWStr)] string layerName, bool doSubents, bool allowHiddenLayer);

	public delegate int SwigDelegateOdDbBlockReference_73([MarshalAs(UnmanagedType.LPWStr)] string layerName, bool doSubents);

	public delegate int SwigDelegateOdDbBlockReference_74([MarshalAs(UnmanagedType.LPWStr)] string layerName);

	public delegate int SwigDelegateOdDbBlockReference_75(IntPtr layerId, bool doSubents, bool allowHiddenLayer);

	public delegate int SwigDelegateOdDbBlockReference_76(IntPtr layerId, bool doSubents);

	public delegate int SwigDelegateOdDbBlockReference_77(IntPtr layerId);

	public delegate int SwigDelegateOdDbBlockReference_78([MarshalAs(UnmanagedType.LPWStr)] string linetypeName, bool doSubents);

	public delegate int SwigDelegateOdDbBlockReference_79([MarshalAs(UnmanagedType.LPWStr)] string linetypeName);

	public delegate int SwigDelegateOdDbBlockReference_80(IntPtr linetypeID, bool doSubents);

	public delegate int SwigDelegateOdDbBlockReference_81(IntPtr linetypeID);

	public delegate int SwigDelegateOdDbBlockReference_82([MarshalAs(UnmanagedType.LPWStr)] string materialName, bool doSubents);

	public delegate int SwigDelegateOdDbBlockReference_83([MarshalAs(UnmanagedType.LPWStr)] string materialName);

	public delegate int SwigDelegateOdDbBlockReference_84(IntPtr materialID, bool doSubents);

	public delegate int SwigDelegateOdDbBlockReference_85(IntPtr materialID);

	public delegate int SwigDelegateOdDbBlockReference_86(IntPtr visualStyleId, int vstype, bool doSubents);

	public delegate IntPtr SwigDelegateOdDbBlockReference_87();

	public delegate void SwigDelegateOdDbBlockReference_88(IntPtr mapper, bool doSubents);

	public delegate void SwigDelegateOdDbBlockReference_89(IntPtr mapper);

	public delegate int SwigDelegateOdDbBlockReference_90(double linetypeScale, bool doSubents);

	public delegate int SwigDelegateOdDbBlockReference_91(double linetypeScale);

	public delegate int SwigDelegateOdDbBlockReference_92(int lineWeight, bool doSubents);

	public delegate int SwigDelegateOdDbBlockReference_93(int lineWeight);

	public delegate bool SwigDelegateOdDbBlockReference_94();

	public delegate void SwigDelegateOdDbBlockReference_95(bool castShadows);

	public delegate bool SwigDelegateOdDbBlockReference_96();

	public delegate void SwigDelegateOdDbBlockReference_97(bool receiveShadows);

	public delegate int SwigDelegateOdDbBlockReference_98();

	public delegate bool SwigDelegateOdDbBlockReference_99();

	public delegate int SwigDelegateOdDbBlockReference_100(IntPtr plane, OdDb_Planarity planarity);

	public delegate int SwigDelegateOdDbBlockReference_101(IntPtr BlockRecord, IntPtr ids);

	public delegate int SwigDelegateOdDbBlockReference_102(IntPtr BlockRecord);

	public delegate int SwigDelegateOdDbBlockReference_103(IntPtr entitySet);

	public delegate int SwigDelegateOdDbBlockReference_104(IntPtr pBlockRecord, IntPtr ids);

	public delegate int SwigDelegateOdDbBlockReference_105(IntPtr pBlockRecord);

	public delegate void SwigDelegateOdDbBlockReference_106(IntPtr pDb, bool doSubents);

	public delegate void SwigDelegateOdDbBlockReference_107();

	public delegate void SwigDelegateOdDbBlockReference_108(int status);

	public delegate void SwigDelegateOdDbBlockReference_109(IntPtr pWd, int ver);

	public delegate IntPtr SwigDelegateOdDbBlockReference_110();

	public delegate bool SwigDelegateOdDbBlockReference_111();

	public delegate bool SwigDelegateOdDbBlockReference_112();

	public delegate void SwigDelegateOdDbBlockReference_113(int status);

	public delegate int SwigDelegateOdDbBlockReference_114(int osnapMode, IntPtr gsSelectionMark, IntPtr pickPoint, IntPtr lastPoint, IntPtr xWorldToEye, IntPtr snapPoints);

	public delegate int SwigDelegateOdDbBlockReference_115(int osnapMode, IntPtr gsSelectionMark, IntPtr pickPoint, IntPtr lastPoint, IntPtr xWorldToEye, IntPtr snapPoints, IntPtr insertionMat);

	public delegate bool SwigDelegateOdDbBlockReference_116();

	public delegate int SwigDelegateOdDbBlockReference_117(IntPtr gripPoints);

	public delegate int SwigDelegateOdDbBlockReference_118(IntPtr indices, IntPtr offset);

	public delegate int SwigDelegateOdDbBlockReference_119(IntPtr grips, double curViewUnitSize, int gripSize, IntPtr curViewDir, int bitFlags);

	public delegate int SwigDelegateOdDbBlockReference_120(IntPtr grips, IntPtr offset, int bitFlags);

	public delegate int SwigDelegateOdDbBlockReference_121(IntPtr stretchPoints);

	public delegate int SwigDelegateOdDbBlockReference_122(IntPtr indices, IntPtr offset);

	public delegate int SwigDelegateOdDbBlockReference_123(IntPtr pEnt, int intType, IntPtr points, IntPtr thisGsMarker, IntPtr otherGsMarker);

	public delegate int SwigDelegateOdDbBlockReference_124(IntPtr pEnt, int intType, IntPtr points, IntPtr thisGsMarker);

	public delegate int SwigDelegateOdDbBlockReference_125(IntPtr pEnt, int intType, IntPtr points);

	public delegate int SwigDelegateOdDbBlockReference_126(IntPtr pEnt, int intType, IntPtr projPlane, IntPtr points, IntPtr thisGsMarker, IntPtr otherGsMarker);

	public delegate int SwigDelegateOdDbBlockReference_127(IntPtr pEnt, int intType, IntPtr projPlane, IntPtr points, IntPtr thisGsMarker);

	public delegate int SwigDelegateOdDbBlockReference_128(IntPtr pEnt, int intType, IntPtr projPlane, IntPtr points);

	public delegate void SwigDelegateOdDbBlockReference_129(bool bDoIt, IntPtr pSubId, bool highlightAll);

	public delegate void SwigDelegateOdDbBlockReference_130(bool bDoIt, IntPtr pSubId);

	public delegate void SwigDelegateOdDbBlockReference_131(bool bDoIt);

	public delegate void SwigDelegateOdDbBlockReference_132();

	public delegate int SwigDelegateOdDbBlockReference_133();

	public delegate int SwigDelegateOdDbBlockReference_134(int visibility, bool doSubents);

	public delegate int SwigDelegateOdDbBlockReference_135(int visibility);

	public delegate int SwigDelegateOdDbBlockReference_136(IntPtr paths);

	public delegate int SwigDelegateOdDbBlockReference_137(IntPtr paths);

	public delegate int SwigDelegateOdDbBlockReference_138(IntPtr paths, IntPtr gripAppData, IntPtr offset, uint bitflags);

	public delegate int SwigDelegateOdDbBlockReference_139(IntPtr path, IntPtr grips, double curViewUnitSize, int gripSize, IntPtr curViewDir, uint bitflags);

	public delegate int SwigDelegateOdDbBlockReference_140(int type, IntPtr gsMark, IntPtr pickPoint, IntPtr xfm, IntPtr subentPaths);

	public delegate IntPtr SwigDelegateOdDbBlockReference_141(IntPtr path);

	public delegate int SwigDelegateOdDbBlockReference_142(IntPtr paths, IntPtr xform);

	public delegate int SwigDelegateOdDbBlockReference_143(IntPtr path, IntPtr clsId);

	public delegate int SwigDelegateOdDbBlockReference_144(IntPtr path, IntPtr extents);

	public delegate void SwigDelegateOdDbBlockReference_145(int status, IntPtr subentity);

	public delegate void SwigDelegateOdDbBlockReference_146(IntPtr objectId);

	public delegate IntPtr SwigDelegateOdDbBlockReference_147();

	public delegate void SwigDelegateOdDbBlockReference_148(IntPtr position);

	public delegate void SwigDelegateOdDbBlockReference_149(IntPtr scale);

	public delegate void SwigDelegateOdDbBlockReference_150(double angle);

	public delegate void SwigDelegateOdDbBlockReference_151(IntPtr normal);

	public delegate int SwigDelegateOdDbBlockReference_152(IntPtr xfm);

	public delegate bool SwigDelegateOdDbBlockReference_153();

	public delegate int SwigDelegateOdDbBlockReference_154();

	private object locker = new object();

	private HandleRef swigCPtr;

	private SwigDelegateOdDbBlockReference_0 swigDelegate0;

	private SwigDelegateOdDbBlockReference_1 swigDelegate1;

	private SwigDelegateOdDbBlockReference_2 swigDelegate2;

	private SwigDelegateOdDbBlockReference_3 swigDelegate3;

	private SwigDelegateOdDbBlockReference_4 swigDelegate4;

	private SwigDelegateOdDbBlockReference_5 swigDelegate5;

	private SwigDelegateOdDbBlockReference_6 swigDelegate6;

	private SwigDelegateOdDbBlockReference_7 swigDelegate7;

	private SwigDelegateOdDbBlockReference_8 swigDelegate8;

	private SwigDelegateOdDbBlockReference_9 swigDelegate9;

	private SwigDelegateOdDbBlockReference_10 swigDelegate10;

	private SwigDelegateOdDbBlockReference_11 swigDelegate11;

	private SwigDelegateOdDbBlockReference_12 swigDelegate12;

	private SwigDelegateOdDbBlockReference_13 swigDelegate13;

	private SwigDelegateOdDbBlockReference_14 swigDelegate14;

	private SwigDelegateOdDbBlockReference_15 swigDelegate15;

	private SwigDelegateOdDbBlockReference_16 swigDelegate16;

	private SwigDelegateOdDbBlockReference_17 swigDelegate17;

	private SwigDelegateOdDbBlockReference_18 swigDelegate18;

	private SwigDelegateOdDbBlockReference_19 swigDelegate19;

	private SwigDelegateOdDbBlockReference_20 swigDelegate20;

	private SwigDelegateOdDbBlockReference_21 swigDelegate21;

	private SwigDelegateOdDbBlockReference_22 swigDelegate22;

	private SwigDelegateOdDbBlockReference_23 swigDelegate23;

	private SwigDelegateOdDbBlockReference_24 swigDelegate24;

	private SwigDelegateOdDbBlockReference_25 swigDelegate25;

	private SwigDelegateOdDbBlockReference_26 swigDelegate26;

	private SwigDelegateOdDbBlockReference_27 swigDelegate27;

	private SwigDelegateOdDbBlockReference_28 swigDelegate28;

	private SwigDelegateOdDbBlockReference_29 swigDelegate29;

	private SwigDelegateOdDbBlockReference_30 swigDelegate30;

	private SwigDelegateOdDbBlockReference_31 swigDelegate31;

	private SwigDelegateOdDbBlockReference_32 swigDelegate32;

	private SwigDelegateOdDbBlockReference_33 swigDelegate33;

	private SwigDelegateOdDbBlockReference_34 swigDelegate34;

	private SwigDelegateOdDbBlockReference_35 swigDelegate35;

	private SwigDelegateOdDbBlockReference_36 swigDelegate36;

	private SwigDelegateOdDbBlockReference_37 swigDelegate37;

	private SwigDelegateOdDbBlockReference_38 swigDelegate38;

	private SwigDelegateOdDbBlockReference_39 swigDelegate39;

	private SwigDelegateOdDbBlockReference_40 swigDelegate40;

	private SwigDelegateOdDbBlockReference_41 swigDelegate41;

	private SwigDelegateOdDbBlockReference_42 swigDelegate42;

	private SwigDelegateOdDbBlockReference_43 swigDelegate43;

	private SwigDelegateOdDbBlockReference_44 swigDelegate44;

	private SwigDelegateOdDbBlockReference_45 swigDelegate45;

	private SwigDelegateOdDbBlockReference_46 swigDelegate46;

	private SwigDelegateOdDbBlockReference_47 swigDelegate47;

	private SwigDelegateOdDbBlockReference_48 swigDelegate48;

	private SwigDelegateOdDbBlockReference_49 swigDelegate49;

	private SwigDelegateOdDbBlockReference_50 swigDelegate50;

	private SwigDelegateOdDbBlockReference_51 swigDelegate51;

	private SwigDelegateOdDbBlockReference_52 swigDelegate52;

	private SwigDelegateOdDbBlockReference_53 swigDelegate53;

	private SwigDelegateOdDbBlockReference_54 swigDelegate54;

	private SwigDelegateOdDbBlockReference_55 swigDelegate55;

	private SwigDelegateOdDbBlockReference_56 swigDelegate56;

	private SwigDelegateOdDbBlockReference_57 swigDelegate57;

	private SwigDelegateOdDbBlockReference_58 swigDelegate58;

	private SwigDelegateOdDbBlockReference_59 swigDelegate59;

	private SwigDelegateOdDbBlockReference_60 swigDelegate60;

	private SwigDelegateOdDbBlockReference_61 swigDelegate61;

	private SwigDelegateOdDbBlockReference_62 swigDelegate62;

	private SwigDelegateOdDbBlockReference_63 swigDelegate63;

	private SwigDelegateOdDbBlockReference_64 swigDelegate64;

	private SwigDelegateOdDbBlockReference_65 swigDelegate65;

	private SwigDelegateOdDbBlockReference_66 swigDelegate66;

	private SwigDelegateOdDbBlockReference_67 swigDelegate67;

	private SwigDelegateOdDbBlockReference_68 swigDelegate68;

	private SwigDelegateOdDbBlockReference_69 swigDelegate69;

	private SwigDelegateOdDbBlockReference_70 swigDelegate70;

	private SwigDelegateOdDbBlockReference_71 swigDelegate71;

	private SwigDelegateOdDbBlockReference_72 swigDelegate72;

	private SwigDelegateOdDbBlockReference_73 swigDelegate73;

	private SwigDelegateOdDbBlockReference_74 swigDelegate74;

	private SwigDelegateOdDbBlockReference_75 swigDelegate75;

	private SwigDelegateOdDbBlockReference_76 swigDelegate76;

	private SwigDelegateOdDbBlockReference_77 swigDelegate77;

	private SwigDelegateOdDbBlockReference_78 swigDelegate78;

	private SwigDelegateOdDbBlockReference_79 swigDelegate79;

	private SwigDelegateOdDbBlockReference_80 swigDelegate80;

	private SwigDelegateOdDbBlockReference_81 swigDelegate81;

	private SwigDelegateOdDbBlockReference_82 swigDelegate82;

	private SwigDelegateOdDbBlockReference_83 swigDelegate83;

	private SwigDelegateOdDbBlockReference_84 swigDelegate84;

	private SwigDelegateOdDbBlockReference_85 swigDelegate85;

	private SwigDelegateOdDbBlockReference_86 swigDelegate86;

	private SwigDelegateOdDbBlockReference_87 swigDelegate87;

	private SwigDelegateOdDbBlockReference_88 swigDelegate88;

	private SwigDelegateOdDbBlockReference_89 swigDelegate89;

	private SwigDelegateOdDbBlockReference_90 swigDelegate90;

	private SwigDelegateOdDbBlockReference_91 swigDelegate91;

	private SwigDelegateOdDbBlockReference_92 swigDelegate92;

	private SwigDelegateOdDbBlockReference_93 swigDelegate93;

	private SwigDelegateOdDbBlockReference_94 swigDelegate94;

	private SwigDelegateOdDbBlockReference_95 swigDelegate95;

	private SwigDelegateOdDbBlockReference_96 swigDelegate96;

	private SwigDelegateOdDbBlockReference_97 swigDelegate97;

	private SwigDelegateOdDbBlockReference_98 swigDelegate98;

	private SwigDelegateOdDbBlockReference_99 swigDelegate99;

	private SwigDelegateOdDbBlockReference_100 swigDelegate100;

	private SwigDelegateOdDbBlockReference_101 swigDelegate101;

	private SwigDelegateOdDbBlockReference_102 swigDelegate102;

	private SwigDelegateOdDbBlockReference_103 swigDelegate103;

	private SwigDelegateOdDbBlockReference_104 swigDelegate104;

	private SwigDelegateOdDbBlockReference_105 swigDelegate105;

	private SwigDelegateOdDbBlockReference_106 swigDelegate106;

	private SwigDelegateOdDbBlockReference_107 swigDelegate107;

	private SwigDelegateOdDbBlockReference_108 swigDelegate108;

	private SwigDelegateOdDbBlockReference_109 swigDelegate109;

	private SwigDelegateOdDbBlockReference_110 swigDelegate110;

	private SwigDelegateOdDbBlockReference_111 swigDelegate111;

	private SwigDelegateOdDbBlockReference_112 swigDelegate112;

	private SwigDelegateOdDbBlockReference_113 swigDelegate113;

	private SwigDelegateOdDbBlockReference_114 swigDelegate114;

	private SwigDelegateOdDbBlockReference_115 swigDelegate115;

	private SwigDelegateOdDbBlockReference_116 swigDelegate116;

	private SwigDelegateOdDbBlockReference_117 swigDelegate117;

	private SwigDelegateOdDbBlockReference_118 swigDelegate118;

	private SwigDelegateOdDbBlockReference_119 swigDelegate119;

	private SwigDelegateOdDbBlockReference_120 swigDelegate120;

	private SwigDelegateOdDbBlockReference_121 swigDelegate121;

	private SwigDelegateOdDbBlockReference_122 swigDelegate122;

	private SwigDelegateOdDbBlockReference_123 swigDelegate123;

	private SwigDelegateOdDbBlockReference_124 swigDelegate124;

	private SwigDelegateOdDbBlockReference_125 swigDelegate125;

	private SwigDelegateOdDbBlockReference_126 swigDelegate126;

	private SwigDelegateOdDbBlockReference_127 swigDelegate127;

	private SwigDelegateOdDbBlockReference_128 swigDelegate128;

	private SwigDelegateOdDbBlockReference_129 swigDelegate129;

	private SwigDelegateOdDbBlockReference_130 swigDelegate130;

	private SwigDelegateOdDbBlockReference_131 swigDelegate131;

	private SwigDelegateOdDbBlockReference_132 swigDelegate132;

	private SwigDelegateOdDbBlockReference_133 swigDelegate133;

	private SwigDelegateOdDbBlockReference_134 swigDelegate134;

	private SwigDelegateOdDbBlockReference_135 swigDelegate135;

	private SwigDelegateOdDbBlockReference_136 swigDelegate136;

	private SwigDelegateOdDbBlockReference_137 swigDelegate137;

	private SwigDelegateOdDbBlockReference_138 swigDelegate138;

	private SwigDelegateOdDbBlockReference_139 swigDelegate139;

	private SwigDelegateOdDbBlockReference_140 swigDelegate140;

	private SwigDelegateOdDbBlockReference_141 swigDelegate141;

	private SwigDelegateOdDbBlockReference_142 swigDelegate142;

	private SwigDelegateOdDbBlockReference_143 swigDelegate143;

	private SwigDelegateOdDbBlockReference_144 swigDelegate144;

	private SwigDelegateOdDbBlockReference_145 swigDelegate145;

	private SwigDelegateOdDbBlockReference_146 swigDelegate146;

	private SwigDelegateOdDbBlockReference_147 swigDelegate147;

	private SwigDelegateOdDbBlockReference_148 swigDelegate148;

	private SwigDelegateOdDbBlockReference_149 swigDelegate149;

	private SwigDelegateOdDbBlockReference_150 swigDelegate150;

	private SwigDelegateOdDbBlockReference_151 swigDelegate151;

	private SwigDelegateOdDbBlockReference_152 swigDelegate152;

	private SwigDelegateOdDbBlockReference_153 swigDelegate153;

	private SwigDelegateOdDbBlockReference_154 swigDelegate154;
	...
	public OdDbBlockReference(IntPtr cPtr, bool cMemoryOwn)
		: base(TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_SWIGUpcast(cPtr), cMemoryOwn)
	{
		swigCPtr = new HandleRef(this, cPtr);
	}

	[EditorBrowsable(EditorBrowsableState.Never)]
	public static HandleRef getCPtr(OdDbBlockReference obj)
	{
	...
	protected override void Dispose(bool disposing)
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					TD_DbCoreIntegrated_GlobalsPINVOKE.delete_OdDbBlockReference(swigCPtr);
				}
	...
	public new static OdDbBlockReference cast(OdRxObject pObj)
	{
		OdDbBlockReference rXObject = ODA.Kernel.TD_RootIntegrated.Helpers.GetRXObject<OdDbBlockReference>(TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_cast(OdRxObject.getCPtr(pObj)), bOwn: true, bTryAddToTransaction: true);
	...
	{
		OdRxClass rXObject = ODA.Kernel.TD_RootIntegrated.Helpers.GetRXObject<OdRxClass>(TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_desc(), bOwn: false, bTryAddToTransaction: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		OdRxClass rXObject = ODA.Kernel.TD_RootIntegrated.Helpers.GetRXObject<OdRxClass>(SwigDerivedClassHasMethod("isA", swigMethodTypes1) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_isASwigExplicitOdDbBlockReference(swigCPtr) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_isA(swigCPtr), bOwn: false, bTryAddToTransaction: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		OdRxObject rXObject = ODA.Kernel.TD_RootIntegrated.Helpers.GetRXObject<OdRxObject>(SwigDerivedClassHasMethod("queryX", swigMethodTypes0) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_queryXSwigExplicitOdDbBlockReference(swigCPtr, OdRxClass.getCPtr(protocolClass)) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_queryX(swigCPtr, OdRxClass.getCPtr(protocolClass)), bOwn: false, bTryAddToTransaction: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public OdDbObjectId blockTableRecord()
	{
		OdDbObjectId result = new OdDbObjectId(TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_blockTableRecord(swigCPtr), cMemoryOwn: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public virtual void setBlockTableRecord(OdDbObjectId objectId)
	{
		if (SwigDerivedClassHasMethod("setBlockTableRecord", swigMethodTypes146))
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_setBlockTableRecordSwigExplicitOdDbBlockReference(swigCPtr, OdDbObjectId.getCPtr(objectId));
		}
		else
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_setBlockTableRecord(swigCPtr, OdDbObjectId.getCPtr(objectId));
		}
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
	...
	{
		OdGePoint3d result = new OdGePoint3d(SwigDerivedClassHasMethod("position", swigMethodTypes147) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_positionSwigExplicitOdDbBlockReference(swigCPtr) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_position(swigCPtr), cMemoryOwn: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public virtual void setPosition(OdGePoint3d position)
	{
		if (SwigDerivedClassHasMethod("setPosition", swigMethodTypes148))
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_setPositionSwigExplicitOdDbBlockReference(swigCPtr, OdGePoint3d.getCPtr(position).Handle);
		}
		else
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_setPosition(swigCPtr, OdGePoint3d.getCPtr(position).Handle);
		}
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
	...
	public OdGeScale3d scaleFactors()
	{
		OdGeScale3d result = new OdGeScale3d(TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_scaleFactors(swigCPtr), cMemoryOwn: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public virtual void setScaleFactors(OdGeScale3d scale)
	{
		if (SwigDerivedClassHasMethod("setScaleFactors", swigMethodTypes149))
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_setScaleFactorsSwigExplicitOdDbBlockReference(swigCPtr, OdGeScale3d.getCPtr(scale));
		}
		else
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_setScaleFactors(swigCPtr, OdGeScale3d.getCPtr(scale));
		}
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
	...
	{
		double result = TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_rotation(swigCPtr);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public virtual void setRotation(double angle)
	{
		...
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_setRotationSwigExplicitOdDbBlockReference(swigCPtr, angle);
		}
		else
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_setRotation(swigCPtr, angle);
		}
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
	...
	{
		OdGeVector3d result = new OdGeVector3d(TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_normal(swigCPtr), cMemoryOwn: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public virtual void setNormal(OdGeVector3d normal)
	{
		...
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_setNormalSwigExplicitOdDbBlockReference(swigCPtr, OdGeVector3d.getCPtr(normal));
		}
		else
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_setNormal(swigCPtr, OdGeVector3d.getCPtr(normal));
		}
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
	...
	{
		bool result = (SwigDerivedClassHasMethod("isPlanar", swigMethodTypes99) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_isPlanarSwigExplicitOdDbBlockReference(swigCPtr) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_isPlanar(swigCPtr));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		int result = (SwigDerivedClassHasMethod("getPlane", swigMethodTypes100) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_getPlaneSwigExplicitOdDbBlockReference(swigCPtr, OdGePlane.getCPtr(plane), out planarity) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_getPlane(swigCPtr, OdGePlane.getCPtr(plane), out planarity));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public OdGeMatrix3d blockTransform()
	{
		OdGeMatrix3d result = new OdGeMatrix3d(TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_blockTransform(swigCPtr), cMemoryOwn: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public virtual OdResult setBlockTransform(OdGeMatrix3d xfm)
	{
		int result = (SwigDerivedClassHasMethod("setBlockTransform", swigMethodTypes152) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_setBlockTransformSwigExplicitOdDbBlockReference(swigCPtr, OdGeMatrix3d.getCPtr(xfm)) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_setBlockTransform(swigCPtr, OdGeMatrix3d.getCPtr(xfm)));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public OdDbObjectId appendAttribute(OdDbAttribute pAttr)
	{
		OdDbObjectId result = new OdDbObjectId(TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_appendAttribute(swigCPtr, OdDbAttribute.getCPtr(pAttr)), cMemoryOwn: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public OdDbAttribute openAttribute(OdDbObjectId ObjId, OdDb_OpenMode mode, bool openErasedOne)
	{
		OdDbAttribute rXObject = ODA.Kernel.TD_RootIntegrated.Helpers.GetRXObject<OdDbAttribute>(TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_openAttribute__SWIG_0(swigCPtr, OdDbObjectId.getCPtr(ObjId), (int)mode, openErasedOne), bOwn: true, bTryAddToTransaction: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public OdDbAttribute openAttribute(OdDbObjectId ObjId, OdDb_OpenMode mode)
	{
		OdDbAttribute rXObject = ODA.Kernel.TD_RootIntegrated.Helpers.GetRXObject<OdDbAttribute>(TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_openAttribute__SWIG_1(swigCPtr, OdDbObjectId.getCPtr(ObjId), (int)mode), bOwn: true, bTryAddToTransaction: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		OdDbSequenceEnd rXObject = ODA.Kernel.TD_RootIntegrated.Helpers.GetRXObject<OdDbSequenceEnd>(TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_openSequenceEnd(swigCPtr, (int)mode), bOwn: true, bTryAddToTransaction: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public OdDbObjectIterator attributeIterator()
	{
		OdDbObjectIterator rXObject = ODA.Kernel.TD_RootIntegrated.Helpers.GetRXObject<OdDbObjectIterator>(TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_attributeIterator(swigCPtr), bOwn: true, bTryAddToTransaction: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public OdDbAttributeCollectionView attributes()
	{
		OdDbAttributeCollectionView result = new OdDbAttributeCollectionView(TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_attributes(swigCPtr), cMemoryOwn: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public OdDbIdCollectionView attributeIds()
	{
		OdDbIdCollectionView result = new OdDbIdCollectionView(TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_attributeIds(swigCPtr), cMemoryOwn: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public override OdResult explodeToBlock(OdDbBlockTableRecord BlockRecord, OdDbObjectIdArray ids)
	{
		int result = (SwigDerivedClassHasMethod("explodeToBlock", swigMethodTypes101) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_explodeToBlockSwigExplicitOdDbBlockReference__SWIG_0(swigCPtr, OdDbBlockTableRecord.getCPtr(BlockRecord), OdDbObjectIdArray.getCPtr(ids)) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_explodeToBlock__SWIG_0(swigCPtr, OdDbBlockTableRecord.getCPtr(BlockRecord), OdDbObjectIdArray.getCPtr(ids)));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public override OdResult explodeToBlock(OdDbBlockTableRecord BlockRecord)
	{
		int result = (SwigDerivedClassHasMethod("explodeToBlock", swigMethodTypes102) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_explodeToBlockSwigExplicitOdDbBlockReference__SWIG_1(swigCPtr, OdDbBlockTableRecord.getCPtr(BlockRecord)) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_explodeToBlock__SWIG_1(swigCPtr, OdDbBlockTableRecord.getCPtr(BlockRecord)));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		int result = (SwigDerivedClassHasMethod("dwgInFields", swigMethodTypes19) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_dwgInFieldsSwigExplicitOdDbBlockReference(swigCPtr, OdDbDwgFiler.getCPtr(pFiler)) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_dwgInFields(swigCPtr, OdDbDwgFiler.getCPtr(pFiler)));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public override void dwgOutFields(OdDbDwgFiler pFiler)
	{
		...
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_dwgOutFieldsSwigExplicitOdDbBlockReference(swigCPtr, OdDbDwgFiler.getCPtr(pFiler));
		}
		else
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_dwgOutFields(swigCPtr, OdDbDwgFiler.getCPtr(pFiler));
		}
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
	...
	{
		int result = (SwigDerivedClassHasMethod("dxfInFields", swigMethodTypes21) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_dxfInFieldsSwigExplicitOdDbBlockReference(swigCPtr, OdDbDxfFiler.getCPtr(pFiler)) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_dxfInFields(swigCPtr, OdDbDxfFiler.getCPtr(pFiler)));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public override void dxfOutFields(OdDbDxfFiler pFiler)
	{
		...
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_dxfOutFieldsSwigExplicitOdDbBlockReference(swigCPtr, OdDbDxfFiler.getCPtr(pFiler));
		}
		else
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_dxfOutFields(swigCPtr, OdDbDxfFiler.getCPtr(pFiler));
		}
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
	...
	{
		int result = (SwigDerivedClassHasMethod("dxfInFields_R12", swigMethodTypes23) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_dxfInFields_R12SwigExplicitOdDbBlockReference(swigCPtr, OdDbDxfFiler.getCPtr(pFiler)) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_dxfInFields_R12(swigCPtr, OdDbDxfFiler.getCPtr(pFiler)));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public override void dxfOutFields_R12(OdDbDxfFiler pFiler)
	{
		...
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_dxfOutFields_R12SwigExplicitOdDbBlockReference(swigCPtr, OdDbDxfFiler.getCPtr(pFiler));
		}
		else
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_dxfOutFields_R12(swigCPtr, OdDbDxfFiler.getCPtr(pFiler));
		}
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
	...
	{
		int result = (SwigDerivedClassHasMethod("dxfIn", swigMethodTypes17) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_dxfInSwigExplicitOdDbBlockReference(swigCPtr, OdDbDxfFiler.getCPtr(pFiler)) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_dxfIn(swigCPtr, OdDbDxfFiler.getCPtr(pFiler)));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public override void dxfOut(OdDbDxfFiler pFiler)
	{
		...
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_dxfOutSwigExplicitOdDbBlockReference(swigCPtr, OdDbDxfFiler.getCPtr(pFiler));
		}
		else
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_dxfOut(swigCPtr, OdDbDxfFiler.getCPtr(pFiler));
		}
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
	...
	public override void subClose()
	{
		...
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_subCloseSwigExplicitOdDbBlockReference(swigCPtr);
		}
		else
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_subClose(swigCPtr);
		}
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
	...
	public override void subHandOverTo(OdDbObject pNewObject)
	{
		...
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_subHandOverToSwigExplicitOdDbBlockReference(swigCPtr, OdDbObject.getCPtr(pNewObject));
		}
		else
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_subHandOverTo(swigCPtr, OdDbObject.getCPtr(pNewObject));
		}
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
	...
	{
		int result = (SwigDerivedClassHasMethod("explodeGeometry", swigMethodTypes103) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_explodeGeometrySwigExplicitOdDbBlockReference(swigCPtr, OdRxObjectPtrArray.getCPtr(entitySet).Handle) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_explodeGeometry(swigCPtr, OdRxObjectPtrArray.getCPtr(entitySet).Handle));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public virtual bool treatAsOdDbBlockRefForExplode()
	{
		bool result = (SwigDerivedClassHasMethod("treatAsOdDbBlockRefForExplode", swigMethodTypes153) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_treatAsOdDbBlockRefForExplodeSwigExplicitOdDbBlockReference(swigCPtr) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_treatAsOdDbBlockRefForExplode(swigCPtr));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public OdResult geomExtentsBestFit(OdGeExtents3d extents, OdGeMatrix3d parentXform)
	{
		int result = TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_geomExtentsBestFit__SWIG_0(swigCPtr, OdGeExtents3d.getCPtr(extents), OdGeMatrix3d.getCPtr(parentXform));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public OdResult geomExtentsBestFit(OdGeExtents3d extents)
	{
		int result = TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_geomExtentsBestFit__SWIG_1(swigCPtr, OdGeExtents3d.getCPtr(extents));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public virtual OdResult explodeToOwnerSpace()
	{
		int result = (SwigDerivedClassHasMethod("explodeToOwnerSpace", swigMethodTypes154) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_explodeToOwnerSpaceSwigExplicitOdDbBlockReference(swigCPtr) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_explodeToOwnerSpace(swigCPtr));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public override void copyFrom(OdRxObject pSrc)
	{
		if (SwigDerivedClassHasMethod("copyFrom", swigMethodTypes2))
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_copyFromSwigExplicitOdDbBlockReference(swigCPtr, OdRxObject.getCPtr(pSrc));
		}
		else
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_copyFrom(swigCPtr, OdRxObject.getCPtr(pSrc));
		}
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
	...
	{
		uint result = TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_SubSetAttributes(swigCPtr, OdGiDrawableTraits.getCPtr(pTraits));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		bool result = TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_SubWorldDraw(swigCPtr, OdGiWorldDraw.getCPtr(pWd));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_SubViewportDraw(swigCPtr, OdGiViewportDraw.getCPtr(pVd));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		int result = TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_SubGetClassID(swigCPtr, pClsid);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		int result = TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_SubTransformBy(swigCPtr, OdGeMatrix3d.getCPtr(xfm));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public virtual OdResult SubGetTransformedCopy(OdGeMatrix3d xfm, ref OdDbEntity pCopy)
	{
		...
		try
		{
			int result = TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_SubGetTransformedCopy(swigCPtr, OdGeMatrix3d.getCPtr(xfm), ref jarg);
			if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
			{
				throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
			}
	...
	{
		int result = TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_SubExplode(swigCPtr, OdRxObjectPtrArray.getCPtr(entitySet).Handle);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		int result = TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_SubGetGeomExtents(swigCPtr, OdGeExtents3d.getCPtr(extents));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		int result = TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_SubGetCompoundObjectTransform(swigCPtr, OdGeMatrix3d.getCPtr(xM));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		int result = TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_SubGetSubentPathsAtGsMarker(swigCPtr, (int)type, gsMark, OdGePoint3d.getCPtr(pickPoint), OdGeMatrix3d.getCPtr(viewXform), OdDbFullSubentPathArray.getCPtr(subentPaths), OdDbObjectIdArray.getCPtr(pEntAndInsertStack));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		int result = TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_SubGetGsMarkersAtSubentPath(swigCPtr, OdDbFullSubentPath.getCPtr(subPath), OdGsMarkerArray.getCPtr(gsMarkers));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		string result = TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_getRealClassName(ptr);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public new static OdDbBlockReference createObject()
	{
		OdDbBlockReference rXObject = ODA.Kernel.TD_RootIntegrated.Helpers.GetRXObject<OdDbBlockReference>(TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbBlockReference_createObject(), bOwn: true, bTryAddToTransaction: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	private int SwigDirectorMethodexplodeToBlock__SWIG_0(IntPtr BlockRecord, IntPtr ids)
	{
		return (int)explodeToBlock(ODA.Kernel.TD_RootIntegrated.Helpers.GetRXObject<OdDbBlockTableRecord>(BlockRecord, bOwn: false, bTryAddToTransaction: false), (ids == IntPtr.Zero) ? null : new OdDbObjectIdArray(ids, cMemoryOwn: false));
	}
