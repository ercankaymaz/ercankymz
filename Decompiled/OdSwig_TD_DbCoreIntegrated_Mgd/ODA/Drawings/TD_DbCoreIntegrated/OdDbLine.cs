...
public class OdDbLine : OdDbCurve
{
	public delegate IntPtr SwigDelegateOdDbLine_0(IntPtr protocolClass);

	public delegate IntPtr SwigDelegateOdDbLine_1();

	public delegate void SwigDelegateOdDbLine_2(IntPtr pSource);

	public delegate int SwigDelegateOdDbLine_3();

	public delegate bool SwigDelegateOdDbLine_4();

	public delegate IntPtr SwigDelegateOdDbLine_5();

	public delegate void SwigDelegateOdDbLine_6(IntPtr pNode);

	public delegate IntPtr SwigDelegateOdDbLine_7();

	public delegate void SwigDelegateOdDbLine_8(IntPtr ownerId);

	public delegate int SwigDelegateOdDbLine_9(int mode);

	public delegate void SwigDelegateOdDbLine_10();

	public delegate int SwigDelegateOdDbLine_11(bool erasing);

	public delegate void SwigDelegateOdDbLine_12(IntPtr pNewObject);

	public delegate void SwigDelegateOdDbLine_13(IntPtr otherId, bool swapXdata, bool swapExtDict);

	public delegate void SwigDelegateOdDbLine_14(IntPtr otherId, bool swapXdata);

	public delegate void SwigDelegateOdDbLine_15(IntPtr otherId);

	public delegate void SwigDelegateOdDbLine_16(IntPtr pAuditInfo);

	public delegate int SwigDelegateOdDbLine_17(IntPtr pFiler);

	public delegate void SwigDelegateOdDbLine_18(IntPtr pFiler);

	public delegate int SwigDelegateOdDbLine_19(IntPtr pFiler);

	public delegate void SwigDelegateOdDbLine_20(IntPtr pFiler);

	public delegate int SwigDelegateOdDbLine_21(IntPtr pFiler);

	public delegate void SwigDelegateOdDbLine_22(IntPtr pFiler);

	public delegate int SwigDelegateOdDbLine_23(IntPtr pFiler);

	public delegate void SwigDelegateOdDbLine_24(IntPtr pFiler);

	public delegate int SwigDelegateOdDbLine_25();

	public delegate IntPtr SwigDelegateOdDbLine_26([MarshalAs(UnmanagedType.LPWStr)] string regappName);

	public delegate void SwigDelegateOdDbLine_27(IntPtr pRb);

	public delegate void SwigDelegateOdDbLine_28(IntPtr pUndoFiler, IntPtr pClassObj);

	public delegate void SwigDelegateOdDbLine_29(IntPtr objId);

	public delegate void SwigDelegateOdDbLine_30(IntPtr objId);

	public delegate void SwigDelegateOdDbLine_31(IntPtr pSubObj);

	public delegate void SwigDelegateOdDbLine_32();

	public delegate void SwigDelegateOdDbLine_33(IntPtr idPair, IntPtr pOwnerObject, IntPtr ownerIdMap);

	public delegate void SwigDelegateOdDbLine_34(IntPtr pObject, IntPtr pNewObject);

	public delegate void SwigDelegateOdDbLine_35(IntPtr pObject, bool erasing);

	public delegate void SwigDelegateOdDbLine_36(IntPtr pObject);

	public delegate void SwigDelegateOdDbLine_37(IntPtr pObject);

	public delegate void SwigDelegateOdDbLine_38(IntPtr pObject);

	public delegate void SwigDelegateOdDbLine_39(IntPtr pObject);

	public delegate void SwigDelegateOdDbLine_40(IntPtr pObject, IntPtr pSubObj);

	public delegate void SwigDelegateOdDbLine_41(IntPtr pObject);

	public delegate void SwigDelegateOdDbLine_42(IntPtr pObject);

	public delegate void SwigDelegateOdDbLine_43(IntPtr pObject);

	public delegate void SwigDelegateOdDbLine_44(IntPtr pObject);

	public delegate void SwigDelegateOdDbLine_45(IntPtr objectId);

	public delegate void SwigDelegateOdDbLine_46(IntPtr pObject);

	public delegate void SwigDelegateOdDbLine_47(IntPtr pSource);

	public delegate int SwigDelegateOdDbLine_48(IntPtr pFiler, MaintReleaseVer pMaintVer);

	public delegate int SwigDelegateOdDbLine_49(IntPtr pFiler);

	public delegate IntPtr SwigDelegateOdDbLine_50(int ver, IntPtr replaceId, bool exchangeXData);

	public delegate IntPtr SwigDelegateOdDbLine_51(int format, int ver, IntPtr replaceId, bool exchangeXData);

	public delegate void SwigDelegateOdDbLine_52(int format, int version, IntPtr pAuditInfo);

	public delegate IntPtr SwigDelegateOdDbLine_53();

	public delegate IntPtr SwigDelegateOdDbLine_54([MarshalAs(UnmanagedType.LPWStr)] string fieldName, IntPtr pField);

	public delegate int SwigDelegateOdDbLine_55(IntPtr fieldId);

	public delegate IntPtr SwigDelegateOdDbLine_56([MarshalAs(UnmanagedType.LPWStr)] string fieldName);

	public delegate IntPtr SwigDelegateOdDbLine_57(IntPtr pClass);

	public delegate int SwigDelegateOdDbLine_58(IntPtr color, bool doSubents);

	public delegate int SwigDelegateOdDbLine_59(IntPtr color);

	public delegate IntPtr SwigDelegateOdDbLine_60();

	public delegate int SwigDelegateOdDbLine_61(ushort colorIndex, bool doSubents);

	public delegate int SwigDelegateOdDbLine_62(ushort colorIndex);

	public delegate int SwigDelegateOdDbLine_63(IntPtr colorId, bool doSubents);

	public delegate int SwigDelegateOdDbLine_64(IntPtr colorId);

	public delegate int SwigDelegateOdDbLine_65(IntPtr transparency, bool doSubents);

	public delegate int SwigDelegateOdDbLine_66(IntPtr transparency);

	public delegate int SwigDelegateOdDbLine_67([MarshalAs(UnmanagedType.LPWStr)] string plotStyleName, bool doSubents);

	public delegate int SwigDelegateOdDbLine_68([MarshalAs(UnmanagedType.LPWStr)] string plotStyleName);

	public delegate int SwigDelegateOdDbLine_69(int plotStyleNameType, IntPtr plotStyleNameId, bool doSubents);

	public delegate int SwigDelegateOdDbLine_70(int plotStyleNameType, IntPtr plotStyleNameId);

	public delegate int SwigDelegateOdDbLine_71(int plotStyleNameType);

	public delegate int SwigDelegateOdDbLine_72([MarshalAs(UnmanagedType.LPWStr)] string layerName, bool doSubents, bool allowHiddenLayer);

	public delegate int SwigDelegateOdDbLine_73([MarshalAs(UnmanagedType.LPWStr)] string layerName, bool doSubents);

	public delegate int SwigDelegateOdDbLine_74([MarshalAs(UnmanagedType.LPWStr)] string layerName);

	public delegate int SwigDelegateOdDbLine_75(IntPtr layerId, bool doSubents, bool allowHiddenLayer);

	public delegate int SwigDelegateOdDbLine_76(IntPtr layerId, bool doSubents);

	public delegate int SwigDelegateOdDbLine_77(IntPtr layerId);

	public delegate int SwigDelegateOdDbLine_78([MarshalAs(UnmanagedType.LPWStr)] string linetypeName, bool doSubents);

	public delegate int SwigDelegateOdDbLine_79([MarshalAs(UnmanagedType.LPWStr)] string linetypeName);

	public delegate int SwigDelegateOdDbLine_80(IntPtr linetypeID, bool doSubents);

	public delegate int SwigDelegateOdDbLine_81(IntPtr linetypeID);

	public delegate int SwigDelegateOdDbLine_82([MarshalAs(UnmanagedType.LPWStr)] string materialName, bool doSubents);

	public delegate int SwigDelegateOdDbLine_83([MarshalAs(UnmanagedType.LPWStr)] string materialName);

	public delegate int SwigDelegateOdDbLine_84(IntPtr materialID, bool doSubents);

	public delegate int SwigDelegateOdDbLine_85(IntPtr materialID);

	public delegate int SwigDelegateOdDbLine_86(IntPtr visualStyleId, int vstype, bool doSubents);

	public delegate IntPtr SwigDelegateOdDbLine_87();

	public delegate void SwigDelegateOdDbLine_88(IntPtr mapper, bool doSubents);

	public delegate void SwigDelegateOdDbLine_89(IntPtr mapper);

	public delegate int SwigDelegateOdDbLine_90(double linetypeScale, bool doSubents);

	public delegate int SwigDelegateOdDbLine_91(double linetypeScale);

	public delegate int SwigDelegateOdDbLine_92(int lineWeight, bool doSubents);

	public delegate int SwigDelegateOdDbLine_93(int lineWeight);

	public delegate bool SwigDelegateOdDbLine_94();

	public delegate void SwigDelegateOdDbLine_95(bool castShadows);

	public delegate bool SwigDelegateOdDbLine_96();

	public delegate void SwigDelegateOdDbLine_97(bool receiveShadows);

	public delegate int SwigDelegateOdDbLine_98();

	public delegate bool SwigDelegateOdDbLine_99();

	public delegate int SwigDelegateOdDbLine_100(IntPtr gePlane, OdDb_Planarity gePlanarity);

	public delegate int SwigDelegateOdDbLine_101(IntPtr pBlockRecord, IntPtr ids);

	public delegate int SwigDelegateOdDbLine_102(IntPtr pBlockRecord);

	public delegate int SwigDelegateOdDbLine_103(IntPtr entitySet);

	public delegate int SwigDelegateOdDbLine_104(IntPtr pBlockRecord, IntPtr ids);

	public delegate int SwigDelegateOdDbLine_105(IntPtr pBlockRecord);

	public delegate void SwigDelegateOdDbLine_106(IntPtr pDb, bool doSubents);

	public delegate void SwigDelegateOdDbLine_107();

	public delegate void SwigDelegateOdDbLine_108(int status);

	public delegate void SwigDelegateOdDbLine_109(IntPtr pWd, int ver);

	public delegate IntPtr SwigDelegateOdDbLine_110();

	public delegate int SwigDelegateOdDbLine_111(IntPtr xfm, IntPtr pCopy);

	public delegate int SwigDelegateOdDbLine_112(IntPtr entitySet);

	public delegate int SwigDelegateOdDbLine_113(IntPtr xM);

	public delegate bool SwigDelegateOdDbLine_114();

	public delegate bool SwigDelegateOdDbLine_115();

	public delegate void SwigDelegateOdDbLine_116(int status);

	public delegate int SwigDelegateOdDbLine_117(int osnapMode, IntPtr gsSelectionMark, IntPtr pickPoint, IntPtr lastPoint, IntPtr xWorldToEye, IntPtr snapPoints);

	public delegate int SwigDelegateOdDbLine_118(int osnapMode, IntPtr gsSelectionMark, IntPtr pickPoint, IntPtr lastPoint, IntPtr xWorldToEye, IntPtr snapPoints, IntPtr insertionMat);

	public delegate bool SwigDelegateOdDbLine_119();

	public delegate int SwigDelegateOdDbLine_120(IntPtr gripPoints);

	public delegate int SwigDelegateOdDbLine_121(IntPtr indices, IntPtr offset);

	public delegate int SwigDelegateOdDbLine_122(IntPtr grips, double curViewUnitSize, int gripSize, IntPtr curViewDir, int bitFlags);

	public delegate int SwigDelegateOdDbLine_123(IntPtr grips, IntPtr offset, int bitFlags);

	public delegate int SwigDelegateOdDbLine_124(IntPtr stretchPoints);

	public delegate int SwigDelegateOdDbLine_125(IntPtr indices, IntPtr offset);

	public delegate int SwigDelegateOdDbLine_126(IntPtr pEnt, int intType, IntPtr points, IntPtr thisGsMarker, IntPtr otherGsMarker);

	public delegate int SwigDelegateOdDbLine_127(IntPtr pEnt, int intType, IntPtr points, IntPtr thisGsMarker);

	public delegate int SwigDelegateOdDbLine_128(IntPtr pEnt, int intType, IntPtr points);

	public delegate int SwigDelegateOdDbLine_129(IntPtr pEnt, int intType, IntPtr projPlane, IntPtr points, IntPtr thisGsMarker, IntPtr otherGsMarker);

	public delegate int SwigDelegateOdDbLine_130(IntPtr pEnt, int intType, IntPtr projPlane, IntPtr points, IntPtr thisGsMarker);

	public delegate int SwigDelegateOdDbLine_131(IntPtr pEnt, int intType, IntPtr projPlane, IntPtr points);

	public delegate void SwigDelegateOdDbLine_132(bool bDoIt, IntPtr pSubId, bool highlightAll);

	public delegate void SwigDelegateOdDbLine_133(bool bDoIt, IntPtr pSubId);

	public delegate void SwigDelegateOdDbLine_134(bool bDoIt);

	public delegate void SwigDelegateOdDbLine_135();

	public delegate int SwigDelegateOdDbLine_136();

	public delegate int SwigDelegateOdDbLine_137(int visibility, bool doSubents);

	public delegate int SwigDelegateOdDbLine_138(int visibility);

	public delegate int SwigDelegateOdDbLine_139(IntPtr paths);

	public delegate int SwigDelegateOdDbLine_140(IntPtr paths);

	public delegate int SwigDelegateOdDbLine_141(IntPtr paths, IntPtr gripAppData, IntPtr offset, uint bitflags);

	public delegate int SwigDelegateOdDbLine_142(IntPtr path, IntPtr grips, double curViewUnitSize, int gripSize, IntPtr curViewDir, uint bitflags);

	public delegate int SwigDelegateOdDbLine_143(int type, IntPtr gsMark, IntPtr pickPoint, IntPtr xfm, IntPtr subentPaths, IntPtr pEntAndInsertStack);

	public delegate int SwigDelegateOdDbLine_144(int type, IntPtr gsMark, IntPtr pickPoint, IntPtr xfm, IntPtr subentPaths);

	public delegate int SwigDelegateOdDbLine_145(IntPtr subPath, IntPtr gsMarkers);

	public delegate IntPtr SwigDelegateOdDbLine_146(IntPtr path);

	public delegate int SwigDelegateOdDbLine_147(IntPtr paths, IntPtr xform);

	public delegate int SwigDelegateOdDbLine_148(IntPtr path, IntPtr clsId);

	public delegate int SwigDelegateOdDbLine_149(IntPtr path, IntPtr extents);

	public delegate void SwigDelegateOdDbLine_150(int status, IntPtr subentity);

	public delegate bool SwigDelegateOdDbLine_151();

	public delegate bool SwigDelegateOdDbLine_152();

	public delegate int SwigDelegateOdDbLine_153(double startParam);

	public delegate int SwigDelegateOdDbLine_154(double endParam);

	public delegate int SwigDelegateOdDbLine_155(IntPtr startPoint);

	public delegate int SwigDelegateOdDbLine_156(IntPtr endPoint);

	public delegate int SwigDelegateOdDbLine_157(double param, IntPtr pointOnCurve);

	public delegate int SwigDelegateOdDbLine_158(IntPtr pointOnCurve, double param);

	public delegate int SwigDelegateOdDbLine_159(double param, double dist);

	public delegate int SwigDelegateOdDbLine_160(double dist, double param);

	public delegate int SwigDelegateOdDbLine_161(IntPtr pointOnCurve, double dist);

	public delegate int SwigDelegateOdDbLine_162(double dist, IntPtr pointOnCurve);

	public delegate int SwigDelegateOdDbLine_163(double param, IntPtr firstDeriv);

	public delegate int SwigDelegateOdDbLine_164(IntPtr pointOnCurve, IntPtr firstDeriv);

	public delegate int SwigDelegateOdDbLine_165(double param, IntPtr secondDeriv);

	public delegate int SwigDelegateOdDbLine_166(IntPtr pointOnCurve, IntPtr secondDeriv);

	public delegate int SwigDelegateOdDbLine_167(IntPtr givenPoint, IntPtr pointOnCurve, bool extend);

	public delegate int SwigDelegateOdDbLine_168(IntPtr givenPoint, IntPtr pointOnCurve);

	public delegate int SwigDelegateOdDbLine_169(IntPtr givenPoint, IntPtr normal, IntPtr pointOnCurve, bool extend);

	public delegate int SwigDelegateOdDbLine_170(IntPtr givenPoint, IntPtr normal, IntPtr pointOnCurve);

	public delegate int SwigDelegateOdDbLine_171(IntPtr spline);

	public delegate int SwigDelegateOdDbLine_172(double param);

	public delegate int SwigDelegateOdDbLine_173(bool extendStart, IntPtr toPoint);

	public delegate int SwigDelegateOdDbLine_174(double area);

	public delegate int SwigDelegateOdDbLine_175(IntPtr projPlane, IntPtr pProjCurve);

	public delegate int SwigDelegateOdDbLine_176(IntPtr projPlane, IntPtr projDirection, IntPtr pProjCurve);

	public delegate int SwigDelegateOdDbLine_177(double offsetDist, IntPtr offsetCurves);

	public delegate int SwigDelegateOdDbLine_178(IntPtr normal, double offsetDist, IntPtr offsetCurves);

	public delegate int SwigDelegateOdDbLine_179(IntPtr params_, IntPtr curveSegments);

	public delegate int SwigDelegateOdDbLine_180(IntPtr points, IntPtr curveSegments);

	public delegate int SwigDelegateOdDbLine_181();

	public delegate int SwigDelegateOdDbLine_182(IntPtr pGeCurve, IntPtr tol);

	public delegate int SwigDelegateOdDbLine_183(IntPtr pGeCurve);

	public delegate int SwigDelegateOdDbLine_184(IntPtr geCurve, IntPtr normal, IntPtr tol);

	public delegate int SwigDelegateOdDbLine_185(IntPtr geCurve, IntPtr normal);

	public delegate int SwigDelegateOdDbLine_186(IntPtr geCurve);

	public delegate int SwigDelegateOdDbLine_187(IntPtr arg0);

	public delegate IntPtr SwigDelegateOdDbLine_188();

	public delegate IntPtr SwigDelegateOdDbLine_189();

	public delegate double SwigDelegateOdDbLine_190();

	public delegate IntPtr SwigDelegateOdDbLine_191();

	private object locker = new object();

	private HandleRef swigCPtr;

	private SwigDelegateOdDbLine_0 swigDelegate0;

	private SwigDelegateOdDbLine_1 swigDelegate1;

	private SwigDelegateOdDbLine_2 swigDelegate2;

	private SwigDelegateOdDbLine_3 swigDelegate3;

	private SwigDelegateOdDbLine_4 swigDelegate4;

	private SwigDelegateOdDbLine_5 swigDelegate5;

	private SwigDelegateOdDbLine_6 swigDelegate6;

	private SwigDelegateOdDbLine_7 swigDelegate7;

	private SwigDelegateOdDbLine_8 swigDelegate8;

	private SwigDelegateOdDbLine_9 swigDelegate9;

	private SwigDelegateOdDbLine_10 swigDelegate10;

	private SwigDelegateOdDbLine_11 swigDelegate11;

	private SwigDelegateOdDbLine_12 swigDelegate12;

	private SwigDelegateOdDbLine_13 swigDelegate13;

	private SwigDelegateOdDbLine_14 swigDelegate14;

	private SwigDelegateOdDbLine_15 swigDelegate15;

	private SwigDelegateOdDbLine_16 swigDelegate16;

	private SwigDelegateOdDbLine_17 swigDelegate17;

	private SwigDelegateOdDbLine_18 swigDelegate18;

	private SwigDelegateOdDbLine_19 swigDelegate19;

	private SwigDelegateOdDbLine_20 swigDelegate20;

	private SwigDelegateOdDbLine_21 swigDelegate21;

	private SwigDelegateOdDbLine_22 swigDelegate22;

	private SwigDelegateOdDbLine_23 swigDelegate23;

	private SwigDelegateOdDbLine_24 swigDelegate24;

	private SwigDelegateOdDbLine_25 swigDelegate25;

	private SwigDelegateOdDbLine_26 swigDelegate26;

	private SwigDelegateOdDbLine_27 swigDelegate27;

	private SwigDelegateOdDbLine_28 swigDelegate28;

	private SwigDelegateOdDbLine_29 swigDelegate29;

	private SwigDelegateOdDbLine_30 swigDelegate30;

	private SwigDelegateOdDbLine_31 swigDelegate31;

	private SwigDelegateOdDbLine_32 swigDelegate32;

	private SwigDelegateOdDbLine_33 swigDelegate33;

	private SwigDelegateOdDbLine_34 swigDelegate34;

	private SwigDelegateOdDbLine_35 swigDelegate35;

	private SwigDelegateOdDbLine_36 swigDelegate36;

	private SwigDelegateOdDbLine_37 swigDelegate37;

	private SwigDelegateOdDbLine_38 swigDelegate38;

	private SwigDelegateOdDbLine_39 swigDelegate39;

	private SwigDelegateOdDbLine_40 swigDelegate40;

	private SwigDelegateOdDbLine_41 swigDelegate41;

	private SwigDelegateOdDbLine_42 swigDelegate42;

	private SwigDelegateOdDbLine_43 swigDelegate43;

	private SwigDelegateOdDbLine_44 swigDelegate44;

	private SwigDelegateOdDbLine_45 swigDelegate45;

	private SwigDelegateOdDbLine_46 swigDelegate46;

	private SwigDelegateOdDbLine_47 swigDelegate47;

	private SwigDelegateOdDbLine_48 swigDelegate48;

	private SwigDelegateOdDbLine_49 swigDelegate49;

	private SwigDelegateOdDbLine_50 swigDelegate50;

	private SwigDelegateOdDbLine_51 swigDelegate51;

	private SwigDelegateOdDbLine_52 swigDelegate52;

	private SwigDelegateOdDbLine_53 swigDelegate53;

	private SwigDelegateOdDbLine_54 swigDelegate54;

	private SwigDelegateOdDbLine_55 swigDelegate55;

	private SwigDelegateOdDbLine_56 swigDelegate56;

	private SwigDelegateOdDbLine_57 swigDelegate57;

	private SwigDelegateOdDbLine_58 swigDelegate58;

	private SwigDelegateOdDbLine_59 swigDelegate59;

	private SwigDelegateOdDbLine_60 swigDelegate60;

	private SwigDelegateOdDbLine_61 swigDelegate61;

	private SwigDelegateOdDbLine_62 swigDelegate62;

	private SwigDelegateOdDbLine_63 swigDelegate63;

	private SwigDelegateOdDbLine_64 swigDelegate64;

	private SwigDelegateOdDbLine_65 swigDelegate65;

	private SwigDelegateOdDbLine_66 swigDelegate66;

	private SwigDelegateOdDbLine_67 swigDelegate67;

	private SwigDelegateOdDbLine_68 swigDelegate68;

	private SwigDelegateOdDbLine_69 swigDelegate69;

	private SwigDelegateOdDbLine_70 swigDelegate70;

	private SwigDelegateOdDbLine_71 swigDelegate71;

	private SwigDelegateOdDbLine_72 swigDelegate72;

	private SwigDelegateOdDbLine_73 swigDelegate73;

	private SwigDelegateOdDbLine_74 swigDelegate74;

	private SwigDelegateOdDbLine_75 swigDelegate75;

	private SwigDelegateOdDbLine_76 swigDelegate76;

	private SwigDelegateOdDbLine_77 swigDelegate77;

	private SwigDelegateOdDbLine_78 swigDelegate78;

	private SwigDelegateOdDbLine_79 swigDelegate79;

	private SwigDelegateOdDbLine_80 swigDelegate80;

	private SwigDelegateOdDbLine_81 swigDelegate81;

	private SwigDelegateOdDbLine_82 swigDelegate82;

	private SwigDelegateOdDbLine_83 swigDelegate83;

	private SwigDelegateOdDbLine_84 swigDelegate84;

	private SwigDelegateOdDbLine_85 swigDelegate85;

	private SwigDelegateOdDbLine_86 swigDelegate86;

	private SwigDelegateOdDbLine_87 swigDelegate87;

	private SwigDelegateOdDbLine_88 swigDelegate88;

	private SwigDelegateOdDbLine_89 swigDelegate89;

	private SwigDelegateOdDbLine_90 swigDelegate90;

	private SwigDelegateOdDbLine_91 swigDelegate91;

	private SwigDelegateOdDbLine_92 swigDelegate92;

	private SwigDelegateOdDbLine_93 swigDelegate93;

	private SwigDelegateOdDbLine_94 swigDelegate94;

	private SwigDelegateOdDbLine_95 swigDelegate95;

	private SwigDelegateOdDbLine_96 swigDelegate96;

	private SwigDelegateOdDbLine_97 swigDelegate97;

	private SwigDelegateOdDbLine_98 swigDelegate98;

	private SwigDelegateOdDbLine_99 swigDelegate99;

	private SwigDelegateOdDbLine_100 swigDelegate100;

	private SwigDelegateOdDbLine_101 swigDelegate101;

	private SwigDelegateOdDbLine_102 swigDelegate102;

	private SwigDelegateOdDbLine_103 swigDelegate103;

	private SwigDelegateOdDbLine_104 swigDelegate104;

	private SwigDelegateOdDbLine_105 swigDelegate105;

	private SwigDelegateOdDbLine_106 swigDelegate106;

	private SwigDelegateOdDbLine_107 swigDelegate107;

	private SwigDelegateOdDbLine_108 swigDelegate108;

	private SwigDelegateOdDbLine_109 swigDelegate109;

	private SwigDelegateOdDbLine_110 swigDelegate110;

	private SwigDelegateOdDbLine_111 swigDelegate111;

	private SwigDelegateOdDbLine_112 swigDelegate112;

	private SwigDelegateOdDbLine_113 swigDelegate113;

	private SwigDelegateOdDbLine_114 swigDelegate114;

	private SwigDelegateOdDbLine_115 swigDelegate115;

	private SwigDelegateOdDbLine_116 swigDelegate116;

	private SwigDelegateOdDbLine_117 swigDelegate117;

	private SwigDelegateOdDbLine_118 swigDelegate118;

	private SwigDelegateOdDbLine_119 swigDelegate119;

	private SwigDelegateOdDbLine_120 swigDelegate120;

	private SwigDelegateOdDbLine_121 swigDelegate121;

	private SwigDelegateOdDbLine_122 swigDelegate122;

	private SwigDelegateOdDbLine_123 swigDelegate123;

	private SwigDelegateOdDbLine_124 swigDelegate124;

	private SwigDelegateOdDbLine_125 swigDelegate125;

	private SwigDelegateOdDbLine_126 swigDelegate126;

	private SwigDelegateOdDbLine_127 swigDelegate127;

	private SwigDelegateOdDbLine_128 swigDelegate128;

	private SwigDelegateOdDbLine_129 swigDelegate129;

	private SwigDelegateOdDbLine_130 swigDelegate130;

	private SwigDelegateOdDbLine_131 swigDelegate131;

	private SwigDelegateOdDbLine_132 swigDelegate132;

	private SwigDelegateOdDbLine_133 swigDelegate133;

	private SwigDelegateOdDbLine_134 swigDelegate134;

	private SwigDelegateOdDbLine_135 swigDelegate135;

	private SwigDelegateOdDbLine_136 swigDelegate136;

	private SwigDelegateOdDbLine_137 swigDelegate137;

	private SwigDelegateOdDbLine_138 swigDelegate138;

	private SwigDelegateOdDbLine_139 swigDelegate139;

	private SwigDelegateOdDbLine_140 swigDelegate140;

	private SwigDelegateOdDbLine_141 swigDelegate141;

	private SwigDelegateOdDbLine_142 swigDelegate142;

	private SwigDelegateOdDbLine_143 swigDelegate143;

	private SwigDelegateOdDbLine_144 swigDelegate144;

	private SwigDelegateOdDbLine_145 swigDelegate145;

	private SwigDelegateOdDbLine_146 swigDelegate146;

	private SwigDelegateOdDbLine_147 swigDelegate147;

	private SwigDelegateOdDbLine_148 swigDelegate148;

	private SwigDelegateOdDbLine_149 swigDelegate149;

	private SwigDelegateOdDbLine_150 swigDelegate150;

	private SwigDelegateOdDbLine_151 swigDelegate151;

	private SwigDelegateOdDbLine_152 swigDelegate152;

	private SwigDelegateOdDbLine_153 swigDelegate153;

	private SwigDelegateOdDbLine_154 swigDelegate154;

	private SwigDelegateOdDbLine_155 swigDelegate155;

	private SwigDelegateOdDbLine_156 swigDelegate156;

	private SwigDelegateOdDbLine_157 swigDelegate157;

	private SwigDelegateOdDbLine_158 swigDelegate158;

	private SwigDelegateOdDbLine_159 swigDelegate159;

	private SwigDelegateOdDbLine_160 swigDelegate160;

	private SwigDelegateOdDbLine_161 swigDelegate161;

	private SwigDelegateOdDbLine_162 swigDelegate162;

	private SwigDelegateOdDbLine_163 swigDelegate163;

	private SwigDelegateOdDbLine_164 swigDelegate164;

	private SwigDelegateOdDbLine_165 swigDelegate165;

	private SwigDelegateOdDbLine_166 swigDelegate166;

	private SwigDelegateOdDbLine_167 swigDelegate167;

	private SwigDelegateOdDbLine_168 swigDelegate168;

	private SwigDelegateOdDbLine_169 swigDelegate169;

	private SwigDelegateOdDbLine_170 swigDelegate170;

	private SwigDelegateOdDbLine_171 swigDelegate171;

	private SwigDelegateOdDbLine_172 swigDelegate172;

	private SwigDelegateOdDbLine_173 swigDelegate173;

	private SwigDelegateOdDbLine_174 swigDelegate174;

	private SwigDelegateOdDbLine_175 swigDelegate175;

	private SwigDelegateOdDbLine_176 swigDelegate176;

	private SwigDelegateOdDbLine_177 swigDelegate177;

	private SwigDelegateOdDbLine_178 swigDelegate178;

	private SwigDelegateOdDbLine_179 swigDelegate179;

	private SwigDelegateOdDbLine_180 swigDelegate180;

	private SwigDelegateOdDbLine_181 swigDelegate181;

	private SwigDelegateOdDbLine_182 swigDelegate182;

	private SwigDelegateOdDbLine_183 swigDelegate183;

	private SwigDelegateOdDbLine_184 swigDelegate184;

	private SwigDelegateOdDbLine_185 swigDelegate185;

	private SwigDelegateOdDbLine_186 swigDelegate186;

	private SwigDelegateOdDbLine_187 swigDelegate187;

	private SwigDelegateOdDbLine_188 swigDelegate188;

	private SwigDelegateOdDbLine_189 swigDelegate189;

	private SwigDelegateOdDbLine_190 swigDelegate190;

	private SwigDelegateOdDbLine_191 swigDelegate191;
	...
	private static Type[] swigMethodTypes189 = new Type[0];
	...
	public OdDbLine(IntPtr cPtr, bool cMemoryOwn)
		: base(TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_SWIGUpcast(cPtr), cMemoryOwn)
	{
		swigCPtr = new HandleRef(this, cPtr);
	}

	[EditorBrowsable(EditorBrowsableState.Never)]
	public static HandleRef getCPtr(OdDbLine obj)
	{
	...
	protected override void Dispose(bool disposing)
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					TD_DbCoreIntegrated_GlobalsPINVOKE.delete_OdDbLine(swigCPtr);
				}
	...
	public new static OdDbLine cast(OdRxObject pObj)
	{
		OdDbLine rXObject = ODA.Kernel.TD_RootIntegrated.Helpers.GetRXObject<OdDbLine>(TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_cast(OdRxObject.getCPtr(pObj)), bOwn: true, bTryAddToTransaction: true);
	...
	{
		OdRxClass rXObject = ODA.Kernel.TD_RootIntegrated.Helpers.GetRXObject<OdRxClass>(TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_desc(), bOwn: false, bTryAddToTransaction: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		OdRxClass rXObject = ODA.Kernel.TD_RootIntegrated.Helpers.GetRXObject<OdRxClass>(SwigDerivedClassHasMethod("isA", swigMethodTypes1) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_isASwigExplicitOdDbLine(swigCPtr) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_isA(swigCPtr), bOwn: false, bTryAddToTransaction: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		OdRxObject rXObject = ODA.Kernel.TD_RootIntegrated.Helpers.GetRXObject<OdRxObject>(SwigDerivedClassHasMethod("queryX", swigMethodTypes0) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_queryXSwigExplicitOdDbLine(swigCPtr, OdRxClass.getCPtr(protocolClass)) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_queryX(swigCPtr, OdRxClass.getCPtr(protocolClass)), bOwn: false, bTryAddToTransaction: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public virtual OdGePoint3d startPoint()
	{
		OdGePoint3d result = new OdGePoint3d(SwigDerivedClassHasMethod("startPoint", swigMethodTypes188) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_startPointSwigExplicitOdDbLine(swigCPtr) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_startPoint(swigCPtr), cMemoryOwn: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public void setStartPoint(OdGePoint3d geStartPoint)
	{
		TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_setStartPoint(swigCPtr, OdGePoint3d.getCPtr(geStartPoint));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public virtual OdGePoint3d endPoint()
	{
		OdGePoint3d result = new OdGePoint3d(SwigDerivedClassHasMethod("endPoint", swigMethodTypes189) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_endPointSwigExplicitOdDbLine(swigCPtr) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_endPoint(swigCPtr), cMemoryOwn: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public void setEndPoint(OdGePoint3d geEndPoint)
	{
		TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_setEndPoint(swigCPtr, OdGePoint3d.getCPtr(geEndPoint));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		double result = (SwigDerivedClassHasMethod("thickness", swigMethodTypes190) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_thicknessSwigExplicitOdDbLine(swigCPtr) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_thickness(swigCPtr));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_setThickness(swigCPtr, vThickness);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		OdGeVector3d result = new OdGeVector3d(SwigDerivedClassHasMethod("normal", swigMethodTypes191) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_normalSwigExplicitOdDbLine(swigCPtr) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_normal(swigCPtr), cMemoryOwn: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_setNormal(swigCPtr, OdGeVector3d.getCPtr(geVector));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		int result = (SwigDerivedClassHasMethod("dwgInFields", swigMethodTypes19) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_dwgInFieldsSwigExplicitOdDbLine(swigCPtr, OdDbDwgFiler.getCPtr(pFiler)) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_dwgInFields(swigCPtr, OdDbDwgFiler.getCPtr(pFiler)));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public override void dwgOutFields(OdDbDwgFiler pFiler)
	{
		...
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_dwgOutFieldsSwigExplicitOdDbLine(swigCPtr, OdDbDwgFiler.getCPtr(pFiler));
		}
		else
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_dwgOutFields(swigCPtr, OdDbDwgFiler.getCPtr(pFiler));
		}
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
	...
	{
		int result = (SwigDerivedClassHasMethod("dxfInFields", swigMethodTypes21) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_dxfInFieldsSwigExplicitOdDbLine(swigCPtr, OdDbDxfFiler.getCPtr(pFiler)) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_dxfInFields(swigCPtr, OdDbDxfFiler.getCPtr(pFiler)));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public override void dxfOutFields(OdDbDxfFiler pFiler)
	{
		...
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_dxfOutFieldsSwigExplicitOdDbLine(swigCPtr, OdDbDxfFiler.getCPtr(pFiler));
		}
		else
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_dxfOutFields(swigCPtr, OdDbDxfFiler.getCPtr(pFiler));
		}
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
	...
	{
		int result = (SwigDerivedClassHasMethod("dxfInFields_R12", swigMethodTypes23) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_dxfInFields_R12SwigExplicitOdDbLine(swigCPtr, OdDbDxfFiler.getCPtr(pFiler)) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_dxfInFields_R12(swigCPtr, OdDbDxfFiler.getCPtr(pFiler)));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public override void dxfOutFields_R12(OdDbDxfFiler pFiler)
	{
		...
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_dxfOutFields_R12SwigExplicitOdDbLine(swigCPtr, OdDbDxfFiler.getCPtr(pFiler));
		}
		else
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_dxfOutFields_R12(swigCPtr, OdDbDxfFiler.getCPtr(pFiler));
		}
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
	...
	{
		bool result = (SwigDerivedClassHasMethod("isClosed", swigMethodTypes151) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_isClosedSwigExplicitOdDbLine(swigCPtr) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_isClosed(swigCPtr));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		bool result = (SwigDerivedClassHasMethod("isPeriodic", swigMethodTypes152) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_isPeriodicSwigExplicitOdDbLine(swigCPtr) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_isPeriodic(swigCPtr));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		bool result = (SwigDerivedClassHasMethod("isPlanar", swigMethodTypes99) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_isPlanarSwigExplicitOdDbLine(swigCPtr) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_isPlanar(swigCPtr));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		int result = (SwigDerivedClassHasMethod("getPlane", swigMethodTypes100) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_getPlaneSwigExplicitOdDbLine(swigCPtr, OdGePlane.getCPtr(gePlane), out gePlanarity) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_getPlane(swigCPtr, OdGePlane.getCPtr(gePlane), out gePlanarity));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		int result = (SwigDerivedClassHasMethod("getStartParam", swigMethodTypes153) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_getStartParamSwigExplicitOdDbLine(swigCPtr, out startParam) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_getStartParam(swigCPtr, out startParam));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		int result = (SwigDerivedClassHasMethod("getEndParam", swigMethodTypes154) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_getEndParamSwigExplicitOdDbLine(swigCPtr, out endParam) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_getEndParam(swigCPtr, out endParam));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		int result = (SwigDerivedClassHasMethod("getStartPoint", swigMethodTypes155) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_getStartPointSwigExplicitOdDbLine(swigCPtr, OdGePoint3d.getCPtr(startPoint)) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_getStartPoint(swigCPtr, OdGePoint3d.getCPtr(startPoint)));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		int result = (SwigDerivedClassHasMethod("getEndPoint", swigMethodTypes156) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_getEndPointSwigExplicitOdDbLine(swigCPtr, OdGePoint3d.getCPtr(endPoint)) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_getEndPoint(swigCPtr, OdGePoint3d.getCPtr(endPoint)));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		int result = (SwigDerivedClassHasMethod("getPointAtParam", swigMethodTypes157) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_getPointAtParamSwigExplicitOdDbLine(swigCPtr, param, OdGePoint3d.getCPtr(pointOnCurve)) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_getPointAtParam(swigCPtr, param, OdGePoint3d.getCPtr(pointOnCurve)));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		int result = (SwigDerivedClassHasMethod("getParamAtPoint", swigMethodTypes158) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_getParamAtPointSwigExplicitOdDbLine(swigCPtr, OdGePoint3d.getCPtr(pointOnCurve), out param) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_getParamAtPoint(swigCPtr, OdGePoint3d.getCPtr(pointOnCurve), out param));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		int result = (SwigDerivedClassHasMethod("getDistAtParam", swigMethodTypes159) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_getDistAtParamSwigExplicitOdDbLine(swigCPtr, param, out dist) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_getDistAtParam(swigCPtr, param, out dist));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		int result = (SwigDerivedClassHasMethod("getParamAtDist", swigMethodTypes160) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_getParamAtDistSwigExplicitOdDbLine(swigCPtr, dist, out param) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_getParamAtDist(swigCPtr, dist, out param));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		int result = (SwigDerivedClassHasMethod("getFirstDeriv", swigMethodTypes163) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_getFirstDerivSwigExplicitOdDbLine(swigCPtr, param, OdGeVector3d.getCPtr(firstDeriv)) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_getFirstDeriv(swigCPtr, param, OdGeVector3d.getCPtr(firstDeriv)));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		int result = (SwigDerivedClassHasMethod("getSecondDeriv", swigMethodTypes165) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_getSecondDerivSwigExplicitOdDbLine(swigCPtr, param, OdGeVector3d.getCPtr(secondDeriv)) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_getSecondDeriv(swigCPtr, param, OdGeVector3d.getCPtr(secondDeriv)));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		int result = (SwigDerivedClassHasMethod("getArea", swigMethodTypes174) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_getAreaSwigExplicitOdDbLine(swigCPtr, out area) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_getArea(swigCPtr, out area));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		int result = (SwigDerivedClassHasMethod("getOffsetCurves", swigMethodTypes177) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_getOffsetCurvesSwigExplicitOdDbLine(swigCPtr, offsetDist, OdRxObjectPtrArray.getCPtr(offsetCurves).Handle) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_getOffsetCurves(swigCPtr, offsetDist, OdRxObjectPtrArray.getCPtr(offsetCurves).Handle));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		int result = (SwigDerivedClassHasMethod("getOffsetCurvesGivenPlaneNormal", swigMethodTypes178) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_getOffsetCurvesGivenPlaneNormalSwigExplicitOdDbLine(swigCPtr, OdGeVector3d.getCPtr(normal), offsetDist, OdRxObjectPtrArray.getCPtr(offsetCurves).Handle) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_getOffsetCurvesGivenPlaneNormal(swigCPtr, OdGeVector3d.getCPtr(normal), offsetDist, OdRxObjectPtrArray.getCPtr(offsetCurves).Handle));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		int result = (SwigDerivedClassHasMethod("getSplitCurves", swigMethodTypes180) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_getSplitCurvesSwigExplicitOdDbLine__SWIG_0(swigCPtr, OdGePoint3dArray.getCPtr(points).Handle, OdRxObjectPtrArray.getCPtr(curveSegments).Handle) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_getSplitCurves__SWIG_0(swigCPtr, OdGePoint3dArray.getCPtr(points).Handle, OdRxObjectPtrArray.getCPtr(curveSegments).Handle));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		int result = (SwigDerivedClassHasMethod("getSplitCurves", swigMethodTypes179) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_getSplitCurvesSwigExplicitOdDbLine__SWIG_1(swigCPtr, OdDoubleArray.getCPtr(params_).Handle, OdRxObjectPtrArray.getCPtr(curveSegments).Handle) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_getSplitCurves__SWIG_1(swigCPtr, OdDoubleArray.getCPtr(params_).Handle, OdRxObjectPtrArray.getCPtr(curveSegments).Handle));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		OdGeMatrix3d result = new OdGeMatrix3d(SwigDerivedClassHasMethod("getEcs", swigMethodTypes110) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_getEcsSwigExplicitOdDbLine(swigCPtr) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_getEcs(swigCPtr), cMemoryOwn: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public override OdResult getOdGeCurve(out OdGeCurve3d pGeCurve, OdGeTol tol)
	{
		...
		try
		{
			int result = (SwigDerivedClassHasMethod("getOdGeCurve", swigMethodTypes182) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_getOdGeCurveSwigExplicitOdDbLine__SWIG_0(swigCPtr, out jarg, OdGeTol.getCPtr(tol)) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_getOdGeCurve__SWIG_0(swigCPtr, out jarg, OdGeTol.getCPtr(tol)));
			if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
			{
				throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
			}
	...
	public override OdResult getOdGeCurve(out OdGeCurve3d pGeCurve)
	{
		...
		try
		{
			int result = (SwigDerivedClassHasMethod("getOdGeCurve", swigMethodTypes183) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_getOdGeCurveSwigExplicitOdDbLine__SWIG_1(swigCPtr, out jarg) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_getOdGeCurve__SWIG_1(swigCPtr, out jarg));
			if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
			{
				throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
			}
	...
	{
		int result = (SwigDerivedClassHasMethod("setFromOdGeCurve", swigMethodTypes185) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_setFromOdGeCurveSwigExplicitOdDbLine__SWIG_1(swigCPtr, OdGeCurve3d.getCPtr(geCurve), OdGeVector3d.getCPtr(normal)) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_setFromOdGeCurve__SWIG_1(swigCPtr, OdGeCurve3d.getCPtr(geCurve), OdGeVector3d.getCPtr(normal)));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		int result = (SwigDerivedClassHasMethod("setFromOdGeCurve", swigMethodTypes186) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_setFromOdGeCurveSwigExplicitOdDbLine__SWIG_2(swigCPtr, OdGeCurve3d.getCPtr(geCurve)) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_setFromOdGeCurve__SWIG_2(swigCPtr, OdGeCurve3d.getCPtr(geCurve)));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		int result = (SwigDerivedClassHasMethod("reverseCurve", swigMethodTypes181) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_reverseCurveSwigExplicitOdDbLine(swigCPtr) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_reverseCurve(swigCPtr));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		bool result = TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_SubWorldDraw(swigCPtr, OdGiWorldDraw.getCPtr(pWd));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		int result = TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_SubGetGeomExtents(swigCPtr, OdGeExtents3d.getCPtr(extents));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		int result = TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_SubGetClassID(swigCPtr, pClsid);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		int result = TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_SubTransformBy(swigCPtr, OdGeMatrix3d.getCPtr(xfm));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		string result = TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_getRealClassName(ptr);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public new static OdDbLine createObject()
	{
		OdDbLine rXObject = ODA.Kernel.TD_RootIntegrated.Helpers.GetRXObject<OdDbLine>(TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbLine_createObject(), bOwn: true, bTryAddToTransaction: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	private IntPtr SwigDirectorMethodstartPoint()
	{
		return ((Func<IntPtr>)delegate
		{
			try
			{
				return OdGePoint3d.getCPtr(startPoint()).Handle;
			}
			catch (OdEdEmptyInput odEdEmptyInput)
			{
				TD_DbCoreIntegrated_Globals.throw_native_OdError(odEdEmptyInput);
	...
	private IntPtr SwigDirectorMethodendPoint()
	{
		return ((Func<IntPtr>)delegate
		{
			try
			{
				return OdGePoint3d.getCPtr(endPoint()).Handle;
			}
			catch (OdEdEmptyInput odEdEmptyInput)
			{
				TD_DbCoreIntegrated_Globals.throw_native_OdError(odEdEmptyInput);
