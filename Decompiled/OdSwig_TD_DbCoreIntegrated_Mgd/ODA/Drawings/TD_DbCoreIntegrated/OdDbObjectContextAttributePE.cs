...
public class OdDbObjectContextAttributePE : OdDbObjectContextTextPE
{
	public delegate IntPtr SwigDelegateOdDbObjectContextAttributePE_0(IntPtr protocolClass);

	public delegate IntPtr SwigDelegateOdDbObjectContextAttributePE_1();

	public delegate void SwigDelegateOdDbObjectContextAttributePE_2(IntPtr pSource);

	public delegate bool SwigDelegateOdDbObjectContextAttributePE_3(IntPtr arg0, [MarshalAs(UnmanagedType.LPWStr)] string arg1);

	public delegate bool SwigDelegateOdDbObjectContextAttributePE_4(IntPtr arg0, IntPtr arg1);

	public delegate int SwigDelegateOdDbObjectContextAttributePE_5(IntPtr pObject, IntPtr ctx);

	public delegate int SwigDelegateOdDbObjectContextAttributePE_6(IntPtr arg0, IntPtr arg1);

	public delegate int SwigDelegateOdDbObjectContextAttributePE_7(IntPtr arg0, IntPtr arg1);

	public delegate IntPtr SwigDelegateOdDbObjectContextAttributePE_8(IntPtr arg0, [MarshalAs(UnmanagedType.LPWStr)] string arg1);

	public delegate IntPtr SwigDelegateOdDbObjectContextAttributePE_9(IntPtr arg0, IntPtr arg1, IntPtr def);

	public delegate IntPtr SwigDelegateOdDbObjectContextAttributePE_10(IntPtr arg0, IntPtr arg1);

	public delegate void SwigDelegateOdDbObjectContextAttributePE_11(IntPtr pObj);

	public delegate void SwigDelegateOdDbObjectContextAttributePE_12(IntPtr arg0, [MarshalAs(UnmanagedType.LPWStr)] string arg1);

	public delegate bool SwigDelegateOdDbObjectContextAttributePE_13(IntPtr arg0, IntPtr arg1);

	private object locker = new object();

	private HandleRef swigCPtr;

	private SwigDelegateOdDbObjectContextAttributePE_0 swigDelegate0;

	private SwigDelegateOdDbObjectContextAttributePE_1 swigDelegate1;

	private SwigDelegateOdDbObjectContextAttributePE_2 swigDelegate2;

	private SwigDelegateOdDbObjectContextAttributePE_3 swigDelegate3;

	private SwigDelegateOdDbObjectContextAttributePE_4 swigDelegate4;

	private SwigDelegateOdDbObjectContextAttributePE_5 swigDelegate5;

	private SwigDelegateOdDbObjectContextAttributePE_6 swigDelegate6;

	private SwigDelegateOdDbObjectContextAttributePE_7 swigDelegate7;

	private SwigDelegateOdDbObjectContextAttributePE_8 swigDelegate8;

	private SwigDelegateOdDbObjectContextAttributePE_9 swigDelegate9;

	private SwigDelegateOdDbObjectContextAttributePE_10 swigDelegate10;

	private SwigDelegateOdDbObjectContextAttributePE_11 swigDelegate11;

	private SwigDelegateOdDbObjectContextAttributePE_12 swigDelegate12;

	private SwigDelegateOdDbObjectContextAttributePE_13 swigDelegate13;
	...
	public OdDbObjectContextAttributePE(IntPtr cPtr, bool cMemoryOwn)
		: base(TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbObjectContextAttributePE_SWIGUpcast(cPtr), cMemoryOwn)
	{
		swigCPtr = new HandleRef(this, cPtr);
	}

	[EditorBrowsable(EditorBrowsableState.Never)]
	public static HandleRef getCPtr(OdDbObjectContextAttributePE obj)
	{
	...
	protected override void Dispose(bool disposing)
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					TD_DbCoreIntegrated_GlobalsPINVOKE.delete_OdDbObjectContextAttributePE(swigCPtr);
				}
	...
	public new static OdDbObjectContextAttributePE cast(OdRxObject pObj)
	{
		OdDbObjectContextAttributePE rXObject = ODA.Kernel.TD_RootIntegrated.Helpers.GetRXObject<OdDbObjectContextAttributePE>(TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbObjectContextAttributePE_cast(OdRxObject.getCPtr(pObj)), bOwn: true, bTryAddToTransaction: true);
	...
	{
		OdRxClass rXObject = ODA.Kernel.TD_RootIntegrated.Helpers.GetRXObject<OdRxClass>(TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbObjectContextAttributePE_desc(), bOwn: false, bTryAddToTransaction: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		OdRxClass rXObject = ODA.Kernel.TD_RootIntegrated.Helpers.GetRXObject<OdRxClass>(SwigDerivedClassHasMethod("isA", swigMethodTypes1) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbObjectContextAttributePE_isASwigExplicitOdDbObjectContextAttributePE(swigCPtr) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbObjectContextAttributePE_isA(swigCPtr), bOwn: false, bTryAddToTransaction: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		OdRxObject rXObject = ODA.Kernel.TD_RootIntegrated.Helpers.GetRXObject<OdRxObject>(SwigDerivedClassHasMethod("queryX", swigMethodTypes0) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbObjectContextAttributePE_queryXSwigExplicitOdDbObjectContextAttributePE(swigCPtr, OdRxClass.getCPtr(protocolClass)) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbObjectContextAttributePE_queryX(swigCPtr, OdRxClass.getCPtr(protocolClass)), bOwn: false, bTryAddToTransaction: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		int result = (SwigDerivedClassHasMethod("addContext", swigMethodTypes5) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbObjectContextAttributePE_addContextSwigExplicitOdDbObjectContextAttributePE(swigCPtr, OdDbObject.getCPtr(pObject), OdDbObjectContext.getCPtr(ctx)) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbObjectContextAttributePE_addContext(swigCPtr, OdDbObject.getCPtr(pObject), OdDbObjectContext.getCPtr(ctx)));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		string result = TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbObjectContextAttributePE_getRealClassName(ptr);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public new static OdDbObjectContextAttributePE createObject()
	{
		OdDbObjectContextAttributePE rXObject = ODA.Kernel.TD_RootIntegrated.Helpers.GetRXObject<OdDbObjectContextAttributePE>(TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbObjectContextAttributePE_createObject(), bOwn: true, bTryAddToTransaction: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	private void SwigDirectorConnect()
	{
		...
		TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbObjectContextAttributePE_director_connect(swigCPtr, swigDelegate0, swigDelegate1, swigDelegate2, swigDelegate3, swigDelegate4, swigDelegate5, swigDelegate6, swigDelegate7, swigDelegate8, swigDelegate9, swigDelegate10, swigDelegate11, swigDelegate12, swigDelegate13);
	}

	private bool SwigDerivedClassHasMethod(string methodName, Type[] methodTypes)
	{
		return GetType().GetMethod(methodName, BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic, null, methodTypes, null).DeclaringType.IsSubclassOf(typeof(OdDbObjectContextAttributePE));
	}
