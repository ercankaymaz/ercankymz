...
public class OdDbPolygonMesh : OdDbEntity
{
	public delegate IntPtr SwigDelegateOdDbPolygonMesh_0(IntPtr protocolClass);

	public delegate IntPtr SwigDelegateOdDbPolygonMesh_1();

	public delegate void SwigDelegateOdDbPolygonMesh_2(IntPtr pSource);

	public delegate int SwigDelegateOdDbPolygonMesh_3();

	public delegate bool SwigDelegateOdDbPolygonMesh_4();

	public delegate IntPtr SwigDelegateOdDbPolygonMesh_5();

	public delegate void SwigDelegateOdDbPolygonMesh_6(IntPtr pNode);

	public delegate IntPtr SwigDelegateOdDbPolygonMesh_7();

	public delegate void SwigDelegateOdDbPolygonMesh_8(IntPtr ownerId);

	public delegate int SwigDelegateOdDbPolygonMesh_9(int mode);

	public delegate void SwigDelegateOdDbPolygonMesh_10();

	public delegate int SwigDelegateOdDbPolygonMesh_11(bool erasing);

	public delegate void SwigDelegateOdDbPolygonMesh_12(IntPtr pNewObject);

	public delegate void SwigDelegateOdDbPolygonMesh_13(IntPtr otherId, bool swapXdata, bool swapExtDict);

	public delegate void SwigDelegateOdDbPolygonMesh_14(IntPtr otherId, bool swapXdata);

	public delegate void SwigDelegateOdDbPolygonMesh_15(IntPtr otherId);

	public delegate void SwigDelegateOdDbPolygonMesh_16(IntPtr pAuditInfo);

	public delegate int SwigDelegateOdDbPolygonMesh_17(IntPtr pFiler);

	public delegate void SwigDelegateOdDbPolygonMesh_18(IntPtr pFiler);

	public delegate int SwigDelegateOdDbPolygonMesh_19(IntPtr pFiler);

	public delegate void SwigDelegateOdDbPolygonMesh_20(IntPtr pFiler);

	public delegate int SwigDelegateOdDbPolygonMesh_21(IntPtr pFiler);

	public delegate void SwigDelegateOdDbPolygonMesh_22(IntPtr pFiler);

	public delegate int SwigDelegateOdDbPolygonMesh_23(IntPtr pFiler);

	public delegate void SwigDelegateOdDbPolygonMesh_24(IntPtr pFiler);

	public delegate int SwigDelegateOdDbPolygonMesh_25();

	public delegate IntPtr SwigDelegateOdDbPolygonMesh_26([MarshalAs(UnmanagedType.LPWStr)] string regappName);

	public delegate void SwigDelegateOdDbPolygonMesh_27(IntPtr pRb);

	public delegate void SwigDelegateOdDbPolygonMesh_28(IntPtr pUndoFiler, IntPtr pClassObj);

	public delegate void SwigDelegateOdDbPolygonMesh_29(IntPtr objId);

	public delegate void SwigDelegateOdDbPolygonMesh_30(IntPtr objId);

	public delegate void SwigDelegateOdDbPolygonMesh_31(IntPtr pSubObj);

	public delegate void SwigDelegateOdDbPolygonMesh_32();

	public delegate void SwigDelegateOdDbPolygonMesh_33(IntPtr idPair, IntPtr pOwnerObject, IntPtr ownerIdMap);

	public delegate void SwigDelegateOdDbPolygonMesh_34(IntPtr pObject, IntPtr pNewObject);

	public delegate void SwigDelegateOdDbPolygonMesh_35(IntPtr pObject, bool erasing);

	public delegate void SwigDelegateOdDbPolygonMesh_36(IntPtr pObject);

	public delegate void SwigDelegateOdDbPolygonMesh_37(IntPtr pObject);

	public delegate void SwigDelegateOdDbPolygonMesh_38(IntPtr pObject);

	public delegate void SwigDelegateOdDbPolygonMesh_39(IntPtr pObject);

	public delegate void SwigDelegateOdDbPolygonMesh_40(IntPtr pObject, IntPtr pSubObj);

	public delegate void SwigDelegateOdDbPolygonMesh_41(IntPtr pObject);

	public delegate void SwigDelegateOdDbPolygonMesh_42(IntPtr pObject);

	public delegate void SwigDelegateOdDbPolygonMesh_43(IntPtr pObject);

	public delegate void SwigDelegateOdDbPolygonMesh_44(IntPtr pObject);

	public delegate void SwigDelegateOdDbPolygonMesh_45(IntPtr objectId);

	public delegate void SwigDelegateOdDbPolygonMesh_46(IntPtr pObject);

	public delegate void SwigDelegateOdDbPolygonMesh_47(IntPtr pSource);

	public delegate int SwigDelegateOdDbPolygonMesh_48(IntPtr pFiler, MaintReleaseVer pMaintVer);

	public delegate int SwigDelegateOdDbPolygonMesh_49(IntPtr pFiler);

	public delegate IntPtr SwigDelegateOdDbPolygonMesh_50(int ver, IntPtr replaceId, bool exchangeXData);

	public delegate IntPtr SwigDelegateOdDbPolygonMesh_51(int format, int ver, IntPtr replaceId, bool exchangeXData);

	public delegate void SwigDelegateOdDbPolygonMesh_52(int format, int version, IntPtr pAuditInfo);

	public delegate IntPtr SwigDelegateOdDbPolygonMesh_53();

	public delegate IntPtr SwigDelegateOdDbPolygonMesh_54([MarshalAs(UnmanagedType.LPWStr)] string fieldName, IntPtr pField);

	public delegate int SwigDelegateOdDbPolygonMesh_55(IntPtr fieldId);

	public delegate IntPtr SwigDelegateOdDbPolygonMesh_56([MarshalAs(UnmanagedType.LPWStr)] string fieldName);

	public delegate IntPtr SwigDelegateOdDbPolygonMesh_57(IntPtr pClass);

	public delegate int SwigDelegateOdDbPolygonMesh_58(IntPtr color, bool doSubents);

	public delegate int SwigDelegateOdDbPolygonMesh_59(IntPtr color);

	public delegate IntPtr SwigDelegateOdDbPolygonMesh_60();

	public delegate int SwigDelegateOdDbPolygonMesh_61(ushort colorIndex, bool doSubents);

	public delegate int SwigDelegateOdDbPolygonMesh_62(ushort colorIndex);

	public delegate int SwigDelegateOdDbPolygonMesh_63(IntPtr colorId, bool doSubents);

	public delegate int SwigDelegateOdDbPolygonMesh_64(IntPtr colorId);

	public delegate int SwigDelegateOdDbPolygonMesh_65(IntPtr transparency, bool doSubents);

	public delegate int SwigDelegateOdDbPolygonMesh_66(IntPtr transparency);

	public delegate int SwigDelegateOdDbPolygonMesh_67([MarshalAs(UnmanagedType.LPWStr)] string plotStyleName, bool doSubents);

	public delegate int SwigDelegateOdDbPolygonMesh_68([MarshalAs(UnmanagedType.LPWStr)] string plotStyleName);

	public delegate int SwigDelegateOdDbPolygonMesh_69(int plotStyleNameType, IntPtr plotStyleNameId, bool doSubents);

	public delegate int SwigDelegateOdDbPolygonMesh_70(int plotStyleNameType, IntPtr plotStyleNameId);

	public delegate int SwigDelegateOdDbPolygonMesh_71(int plotStyleNameType);

	public delegate int SwigDelegateOdDbPolygonMesh_72([MarshalAs(UnmanagedType.LPWStr)] string layerName, bool doSubents, bool allowHiddenLayer);

	public delegate int SwigDelegateOdDbPolygonMesh_73([MarshalAs(UnmanagedType.LPWStr)] string layerName, bool doSubents);

	public delegate int SwigDelegateOdDbPolygonMesh_74([MarshalAs(UnmanagedType.LPWStr)] string layerName);

	public delegate int SwigDelegateOdDbPolygonMesh_75(IntPtr layerId, bool doSubents, bool allowHiddenLayer);

	public delegate int SwigDelegateOdDbPolygonMesh_76(IntPtr layerId, bool doSubents);

	public delegate int SwigDelegateOdDbPolygonMesh_77(IntPtr layerId);

	public delegate int SwigDelegateOdDbPolygonMesh_78([MarshalAs(UnmanagedType.LPWStr)] string linetypeName, bool doSubents);

	public delegate int SwigDelegateOdDbPolygonMesh_79([MarshalAs(UnmanagedType.LPWStr)] string linetypeName);

	public delegate int SwigDelegateOdDbPolygonMesh_80(IntPtr linetypeID, bool doSubents);

	public delegate int SwigDelegateOdDbPolygonMesh_81(IntPtr linetypeID);

	public delegate int SwigDelegateOdDbPolygonMesh_82([MarshalAs(UnmanagedType.LPWStr)] string materialName, bool doSubents);

	public delegate int SwigDelegateOdDbPolygonMesh_83([MarshalAs(UnmanagedType.LPWStr)] string materialName);

	public delegate int SwigDelegateOdDbPolygonMesh_84(IntPtr materialID, bool doSubents);

	public delegate int SwigDelegateOdDbPolygonMesh_85(IntPtr materialID);

	public delegate int SwigDelegateOdDbPolygonMesh_86(IntPtr visualStyleId, int vstype, bool doSubents);

	public delegate IntPtr SwigDelegateOdDbPolygonMesh_87();

	public delegate void SwigDelegateOdDbPolygonMesh_88(IntPtr mapper, bool doSubents);

	public delegate void SwigDelegateOdDbPolygonMesh_89(IntPtr mapper);

	public delegate int SwigDelegateOdDbPolygonMesh_90(double linetypeScale, bool doSubents);

	public delegate int SwigDelegateOdDbPolygonMesh_91(double linetypeScale);

	public delegate int SwigDelegateOdDbPolygonMesh_92(int lineWeight, bool doSubents);

	public delegate int SwigDelegateOdDbPolygonMesh_93(int lineWeight);

	public delegate bool SwigDelegateOdDbPolygonMesh_94();

	public delegate void SwigDelegateOdDbPolygonMesh_95(bool castShadows);

	public delegate bool SwigDelegateOdDbPolygonMesh_96();

	public delegate void SwigDelegateOdDbPolygonMesh_97(bool receiveShadows);

	public delegate int SwigDelegateOdDbPolygonMesh_98();

	public delegate bool SwigDelegateOdDbPolygonMesh_99();

	public delegate int SwigDelegateOdDbPolygonMesh_100(IntPtr plane, OdDb_Planarity planarity);

	public delegate int SwigDelegateOdDbPolygonMesh_101(IntPtr pBlockRecord, IntPtr ids);

	public delegate int SwigDelegateOdDbPolygonMesh_102(IntPtr pBlockRecord);

	public delegate int SwigDelegateOdDbPolygonMesh_103(IntPtr entitySet);

	public delegate int SwigDelegateOdDbPolygonMesh_104(IntPtr pBlockRecord, IntPtr ids);

	public delegate int SwigDelegateOdDbPolygonMesh_105(IntPtr pBlockRecord);

	public delegate void SwigDelegateOdDbPolygonMesh_106(IntPtr pDb, bool doSubents);

	public delegate void SwigDelegateOdDbPolygonMesh_107();

	public delegate void SwigDelegateOdDbPolygonMesh_108(int status);

	public delegate void SwigDelegateOdDbPolygonMesh_109(IntPtr pWd, int ver);

	public delegate IntPtr SwigDelegateOdDbPolygonMesh_110();

	public delegate int SwigDelegateOdDbPolygonMesh_111(IntPtr xfm, IntPtr pCopy);

	public delegate int SwigDelegateOdDbPolygonMesh_112(IntPtr xM);

	public delegate bool SwigDelegateOdDbPolygonMesh_113();

	public delegate bool SwigDelegateOdDbPolygonMesh_114();

	public delegate void SwigDelegateOdDbPolygonMesh_115(int status);

	public delegate int SwigDelegateOdDbPolygonMesh_116(int osnapMode, IntPtr gsSelectionMark, IntPtr pickPoint, IntPtr lastPoint, IntPtr xWorldToEye, IntPtr snapPoints);

	public delegate int SwigDelegateOdDbPolygonMesh_117(int osnapMode, IntPtr gsSelectionMark, IntPtr pickPoint, IntPtr lastPoint, IntPtr xWorldToEye, IntPtr snapPoints, IntPtr insertionMat);

	public delegate bool SwigDelegateOdDbPolygonMesh_118();

	public delegate int SwigDelegateOdDbPolygonMesh_119(IntPtr gripPoints);

	public delegate int SwigDelegateOdDbPolygonMesh_120(IntPtr indices, IntPtr offset);

	public delegate int SwigDelegateOdDbPolygonMesh_121(IntPtr grips, double curViewUnitSize, int gripSize, IntPtr curViewDir, int bitFlags);

	public delegate int SwigDelegateOdDbPolygonMesh_122(IntPtr grips, IntPtr offset, int bitFlags);

	public delegate int SwigDelegateOdDbPolygonMesh_123(IntPtr stretchPoints);

	public delegate int SwigDelegateOdDbPolygonMesh_124(IntPtr indices, IntPtr offset);

	public delegate int SwigDelegateOdDbPolygonMesh_125(IntPtr pEnt, int intType, IntPtr points, IntPtr thisGsMarker, IntPtr otherGsMarker);

	public delegate int SwigDelegateOdDbPolygonMesh_126(IntPtr pEnt, int intType, IntPtr points, IntPtr thisGsMarker);

	public delegate int SwigDelegateOdDbPolygonMesh_127(IntPtr pEnt, int intType, IntPtr points);

	public delegate int SwigDelegateOdDbPolygonMesh_128(IntPtr pEnt, int intType, IntPtr projPlane, IntPtr points, IntPtr thisGsMarker, IntPtr otherGsMarker);

	public delegate int SwigDelegateOdDbPolygonMesh_129(IntPtr pEnt, int intType, IntPtr projPlane, IntPtr points, IntPtr thisGsMarker);

	public delegate int SwigDelegateOdDbPolygonMesh_130(IntPtr pEnt, int intType, IntPtr projPlane, IntPtr points);

	public delegate void SwigDelegateOdDbPolygonMesh_131(bool bDoIt, IntPtr pSubId, bool highlightAll);

	public delegate void SwigDelegateOdDbPolygonMesh_132(bool bDoIt, IntPtr pSubId);

	public delegate void SwigDelegateOdDbPolygonMesh_133(bool bDoIt);

	public delegate void SwigDelegateOdDbPolygonMesh_134();

	public delegate int SwigDelegateOdDbPolygonMesh_135();

	public delegate int SwigDelegateOdDbPolygonMesh_136(int visibility, bool doSubents);

	public delegate int SwigDelegateOdDbPolygonMesh_137(int visibility);

	public delegate int SwigDelegateOdDbPolygonMesh_138(IntPtr extents);

	public delegate int SwigDelegateOdDbPolygonMesh_139(IntPtr paths);

	public delegate int SwigDelegateOdDbPolygonMesh_140(IntPtr paths);

	public delegate int SwigDelegateOdDbPolygonMesh_141(IntPtr paths, IntPtr gripAppData, IntPtr offset, uint bitflags);

	public delegate int SwigDelegateOdDbPolygonMesh_142(IntPtr path, IntPtr grips, double curViewUnitSize, int gripSize, IntPtr curViewDir, uint bitflags);

	public delegate int SwigDelegateOdDbPolygonMesh_143(int type, IntPtr gsMark, IntPtr pickPoint, IntPtr xfm, IntPtr subentPaths);

	public delegate IntPtr SwigDelegateOdDbPolygonMesh_144(IntPtr path);

	public delegate int SwigDelegateOdDbPolygonMesh_145(IntPtr paths, IntPtr xform);

	public delegate int SwigDelegateOdDbPolygonMesh_146(IntPtr path, IntPtr clsId);

	public delegate int SwigDelegateOdDbPolygonMesh_147(IntPtr path, IntPtr extents);

	public delegate void SwigDelegateOdDbPolygonMesh_148(int status, IntPtr subentity);

	private object locker = new object();

	private HandleRef swigCPtr;

	private SwigDelegateOdDbPolygonMesh_0 swigDelegate0;

	private SwigDelegateOdDbPolygonMesh_1 swigDelegate1;

	private SwigDelegateOdDbPolygonMesh_2 swigDelegate2;

	private SwigDelegateOdDbPolygonMesh_3 swigDelegate3;

	private SwigDelegateOdDbPolygonMesh_4 swigDelegate4;

	private SwigDelegateOdDbPolygonMesh_5 swigDelegate5;

	private SwigDelegateOdDbPolygonMesh_6 swigDelegate6;

	private SwigDelegateOdDbPolygonMesh_7 swigDelegate7;

	private SwigDelegateOdDbPolygonMesh_8 swigDelegate8;

	private SwigDelegateOdDbPolygonMesh_9 swigDelegate9;

	private SwigDelegateOdDbPolygonMesh_10 swigDelegate10;

	private SwigDelegateOdDbPolygonMesh_11 swigDelegate11;

	private SwigDelegateOdDbPolygonMesh_12 swigDelegate12;

	private SwigDelegateOdDbPolygonMesh_13 swigDelegate13;

	private SwigDelegateOdDbPolygonMesh_14 swigDelegate14;

	private SwigDelegateOdDbPolygonMesh_15 swigDelegate15;

	private SwigDelegateOdDbPolygonMesh_16 swigDelegate16;

	private SwigDelegateOdDbPolygonMesh_17 swigDelegate17;

	private SwigDelegateOdDbPolygonMesh_18 swigDelegate18;

	private SwigDelegateOdDbPolygonMesh_19 swigDelegate19;

	private SwigDelegateOdDbPolygonMesh_20 swigDelegate20;

	private SwigDelegateOdDbPolygonMesh_21 swigDelegate21;

	private SwigDelegateOdDbPolygonMesh_22 swigDelegate22;

	private SwigDelegateOdDbPolygonMesh_23 swigDelegate23;

	private SwigDelegateOdDbPolygonMesh_24 swigDelegate24;

	private SwigDelegateOdDbPolygonMesh_25 swigDelegate25;

	private SwigDelegateOdDbPolygonMesh_26 swigDelegate26;

	private SwigDelegateOdDbPolygonMesh_27 swigDelegate27;

	private SwigDelegateOdDbPolygonMesh_28 swigDelegate28;

	private SwigDelegateOdDbPolygonMesh_29 swigDelegate29;

	private SwigDelegateOdDbPolygonMesh_30 swigDelegate30;

	private SwigDelegateOdDbPolygonMesh_31 swigDelegate31;

	private SwigDelegateOdDbPolygonMesh_32 swigDelegate32;

	private SwigDelegateOdDbPolygonMesh_33 swigDelegate33;

	private SwigDelegateOdDbPolygonMesh_34 swigDelegate34;

	private SwigDelegateOdDbPolygonMesh_35 swigDelegate35;

	private SwigDelegateOdDbPolygonMesh_36 swigDelegate36;

	private SwigDelegateOdDbPolygonMesh_37 swigDelegate37;

	private SwigDelegateOdDbPolygonMesh_38 swigDelegate38;

	private SwigDelegateOdDbPolygonMesh_39 swigDelegate39;

	private SwigDelegateOdDbPolygonMesh_40 swigDelegate40;

	private SwigDelegateOdDbPolygonMesh_41 swigDelegate41;

	private SwigDelegateOdDbPolygonMesh_42 swigDelegate42;

	private SwigDelegateOdDbPolygonMesh_43 swigDelegate43;

	private SwigDelegateOdDbPolygonMesh_44 swigDelegate44;

	private SwigDelegateOdDbPolygonMesh_45 swigDelegate45;

	private SwigDelegateOdDbPolygonMesh_46 swigDelegate46;

	private SwigDelegateOdDbPolygonMesh_47 swigDelegate47;

	private SwigDelegateOdDbPolygonMesh_48 swigDelegate48;

	private SwigDelegateOdDbPolygonMesh_49 swigDelegate49;

	private SwigDelegateOdDbPolygonMesh_50 swigDelegate50;

	private SwigDelegateOdDbPolygonMesh_51 swigDelegate51;

	private SwigDelegateOdDbPolygonMesh_52 swigDelegate52;

	private SwigDelegateOdDbPolygonMesh_53 swigDelegate53;

	private SwigDelegateOdDbPolygonMesh_54 swigDelegate54;

	private SwigDelegateOdDbPolygonMesh_55 swigDelegate55;

	private SwigDelegateOdDbPolygonMesh_56 swigDelegate56;

	private SwigDelegateOdDbPolygonMesh_57 swigDelegate57;

	private SwigDelegateOdDbPolygonMesh_58 swigDelegate58;

	private SwigDelegateOdDbPolygonMesh_59 swigDelegate59;

	private SwigDelegateOdDbPolygonMesh_60 swigDelegate60;

	private SwigDelegateOdDbPolygonMesh_61 swigDelegate61;

	private SwigDelegateOdDbPolygonMesh_62 swigDelegate62;

	private SwigDelegateOdDbPolygonMesh_63 swigDelegate63;

	private SwigDelegateOdDbPolygonMesh_64 swigDelegate64;

	private SwigDelegateOdDbPolygonMesh_65 swigDelegate65;

	private SwigDelegateOdDbPolygonMesh_66 swigDelegate66;

	private SwigDelegateOdDbPolygonMesh_67 swigDelegate67;

	private SwigDelegateOdDbPolygonMesh_68 swigDelegate68;

	private SwigDelegateOdDbPolygonMesh_69 swigDelegate69;

	private SwigDelegateOdDbPolygonMesh_70 swigDelegate70;

	private SwigDelegateOdDbPolygonMesh_71 swigDelegate71;

	private SwigDelegateOdDbPolygonMesh_72 swigDelegate72;

	private SwigDelegateOdDbPolygonMesh_73 swigDelegate73;

	private SwigDelegateOdDbPolygonMesh_74 swigDelegate74;

	private SwigDelegateOdDbPolygonMesh_75 swigDelegate75;

	private SwigDelegateOdDbPolygonMesh_76 swigDelegate76;

	private SwigDelegateOdDbPolygonMesh_77 swigDelegate77;

	private SwigDelegateOdDbPolygonMesh_78 swigDelegate78;

	private SwigDelegateOdDbPolygonMesh_79 swigDelegate79;

	private SwigDelegateOdDbPolygonMesh_80 swigDelegate80;

	private SwigDelegateOdDbPolygonMesh_81 swigDelegate81;

	private SwigDelegateOdDbPolygonMesh_82 swigDelegate82;

	private SwigDelegateOdDbPolygonMesh_83 swigDelegate83;

	private SwigDelegateOdDbPolygonMesh_84 swigDelegate84;

	private SwigDelegateOdDbPolygonMesh_85 swigDelegate85;

	private SwigDelegateOdDbPolygonMesh_86 swigDelegate86;

	private SwigDelegateOdDbPolygonMesh_87 swigDelegate87;

	private SwigDelegateOdDbPolygonMesh_88 swigDelegate88;

	private SwigDelegateOdDbPolygonMesh_89 swigDelegate89;

	private SwigDelegateOdDbPolygonMesh_90 swigDelegate90;

	private SwigDelegateOdDbPolygonMesh_91 swigDelegate91;

	private SwigDelegateOdDbPolygonMesh_92 swigDelegate92;

	private SwigDelegateOdDbPolygonMesh_93 swigDelegate93;

	private SwigDelegateOdDbPolygonMesh_94 swigDelegate94;

	private SwigDelegateOdDbPolygonMesh_95 swigDelegate95;

	private SwigDelegateOdDbPolygonMesh_96 swigDelegate96;

	private SwigDelegateOdDbPolygonMesh_97 swigDelegate97;

	private SwigDelegateOdDbPolygonMesh_98 swigDelegate98;

	private SwigDelegateOdDbPolygonMesh_99 swigDelegate99;

	private SwigDelegateOdDbPolygonMesh_100 swigDelegate100;

	private SwigDelegateOdDbPolygonMesh_101 swigDelegate101;

	private SwigDelegateOdDbPolygonMesh_102 swigDelegate102;

	private SwigDelegateOdDbPolygonMesh_103 swigDelegate103;

	private SwigDelegateOdDbPolygonMesh_104 swigDelegate104;

	private SwigDelegateOdDbPolygonMesh_105 swigDelegate105;

	private SwigDelegateOdDbPolygonMesh_106 swigDelegate106;

	private SwigDelegateOdDbPolygonMesh_107 swigDelegate107;

	private SwigDelegateOdDbPolygonMesh_108 swigDelegate108;

	private SwigDelegateOdDbPolygonMesh_109 swigDelegate109;

	private SwigDelegateOdDbPolygonMesh_110 swigDelegate110;

	private SwigDelegateOdDbPolygonMesh_111 swigDelegate111;

	private SwigDelegateOdDbPolygonMesh_112 swigDelegate112;

	private SwigDelegateOdDbPolygonMesh_113 swigDelegate113;

	private SwigDelegateOdDbPolygonMesh_114 swigDelegate114;

	private SwigDelegateOdDbPolygonMesh_115 swigDelegate115;

	private SwigDelegateOdDbPolygonMesh_116 swigDelegate116;

	private SwigDelegateOdDbPolygonMesh_117 swigDelegate117;

	private SwigDelegateOdDbPolygonMesh_118 swigDelegate118;

	private SwigDelegateOdDbPolygonMesh_119 swigDelegate119;

	private SwigDelegateOdDbPolygonMesh_120 swigDelegate120;

	private SwigDelegateOdDbPolygonMesh_121 swigDelegate121;

	private SwigDelegateOdDbPolygonMesh_122 swigDelegate122;

	private SwigDelegateOdDbPolygonMesh_123 swigDelegate123;

	private SwigDelegateOdDbPolygonMesh_124 swigDelegate124;

	private SwigDelegateOdDbPolygonMesh_125 swigDelegate125;

	private SwigDelegateOdDbPolygonMesh_126 swigDelegate126;

	private SwigDelegateOdDbPolygonMesh_127 swigDelegate127;

	private SwigDelegateOdDbPolygonMesh_128 swigDelegate128;

	private SwigDelegateOdDbPolygonMesh_129 swigDelegate129;

	private SwigDelegateOdDbPolygonMesh_130 swigDelegate130;

	private SwigDelegateOdDbPolygonMesh_131 swigDelegate131;

	private SwigDelegateOdDbPolygonMesh_132 swigDelegate132;

	private SwigDelegateOdDbPolygonMesh_133 swigDelegate133;

	private SwigDelegateOdDbPolygonMesh_134 swigDelegate134;

	private SwigDelegateOdDbPolygonMesh_135 swigDelegate135;

	private SwigDelegateOdDbPolygonMesh_136 swigDelegate136;

	private SwigDelegateOdDbPolygonMesh_137 swigDelegate137;

	private SwigDelegateOdDbPolygonMesh_138 swigDelegate138;

	private SwigDelegateOdDbPolygonMesh_139 swigDelegate139;

	private SwigDelegateOdDbPolygonMesh_140 swigDelegate140;

	private SwigDelegateOdDbPolygonMesh_141 swigDelegate141;

	private SwigDelegateOdDbPolygonMesh_142 swigDelegate142;

	private SwigDelegateOdDbPolygonMesh_143 swigDelegate143;

	private SwigDelegateOdDbPolygonMesh_144 swigDelegate144;

	private SwigDelegateOdDbPolygonMesh_145 swigDelegate145;

	private SwigDelegateOdDbPolygonMesh_146 swigDelegate146;

	private SwigDelegateOdDbPolygonMesh_147 swigDelegate147;

	private SwigDelegateOdDbPolygonMesh_148 swigDelegate148;
	...
	public OdDbPolygonMesh(IntPtr cPtr, bool cMemoryOwn)
		: base(TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbPolygonMesh_SWIGUpcast(cPtr), cMemoryOwn)
	{
		swigCPtr = new HandleRef(this, cPtr);
	}

	[EditorBrowsable(EditorBrowsableState.Never)]
	public static HandleRef getCPtr(OdDbPolygonMesh obj)
	{
	...
	protected override void Dispose(bool disposing)
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					TD_DbCoreIntegrated_GlobalsPINVOKE.delete_OdDbPolygonMesh(swigCPtr);
				}
	...
	public new static OdDbPolygonMesh cast(OdRxObject pObj)
	{
		OdDbPolygonMesh rXObject = ODA.Kernel.TD_RootIntegrated.Helpers.GetRXObject<OdDbPolygonMesh>(TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbPolygonMesh_cast(OdRxObject.getCPtr(pObj)), bOwn: true, bTryAddToTransaction: true);
	...
	{
		OdRxClass rXObject = ODA.Kernel.TD_RootIntegrated.Helpers.GetRXObject<OdRxClass>(TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbPolygonMesh_desc(), bOwn: false, bTryAddToTransaction: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		OdRxClass rXObject = ODA.Kernel.TD_RootIntegrated.Helpers.GetRXObject<OdRxClass>(SwigDerivedClassHasMethod("isA", swigMethodTypes1) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbPolygonMesh_isASwigExplicitOdDbPolygonMesh(swigCPtr) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbPolygonMesh_isA(swigCPtr), bOwn: false, bTryAddToTransaction: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		OdRxObject rXObject = ODA.Kernel.TD_RootIntegrated.Helpers.GetRXObject<OdRxObject>(SwigDerivedClassHasMethod("queryX", swigMethodTypes0) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbPolygonMesh_queryXSwigExplicitOdDbPolygonMesh(swigCPtr, OdRxClass.getCPtr(protocolClass)) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbPolygonMesh_queryX(swigCPtr, OdRxClass.getCPtr(protocolClass)), bOwn: false, bTryAddToTransaction: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public OdDb_PolyMeshType polyMeshType()
	{
		int result = TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbPolygonMesh_polyMeshType(swigCPtr);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public void setPolyMeshType(OdDb_PolyMeshType polyMeshType)
	{
		TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbPolygonMesh_setPolyMeshType(swigCPtr, (int)polyMeshType);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public OdResult convertToPolyMeshType(OdDb_PolyMeshType polyMeshType)
	{
		int result = TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbPolygonMesh_convertToPolyMeshType(swigCPtr, (int)polyMeshType);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public short mSize()
	{
		short result = TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbPolygonMesh_mSize(swigCPtr);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public void setMSize(short mSize)
	{
		TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbPolygonMesh_setMSize(swigCPtr, mSize);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public short nSize()
	{
		short result = TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbPolygonMesh_nSize(swigCPtr);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public void setNSize(short nSize)
	{
		TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbPolygonMesh_setNSize(swigCPtr, nSize);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		bool result = TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbPolygonMesh_isMClosed(swigCPtr);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbPolygonMesh_makeMClosed(swigCPtr);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbPolygonMesh_makeMOpen(swigCPtr);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		bool result = TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbPolygonMesh_isNClosed(swigCPtr);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbPolygonMesh_makeNClosed(swigCPtr);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbPolygonMesh_makeNOpen(swigCPtr);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		short result = TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbPolygonMesh_mSurfaceDensity(swigCPtr);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public void setMSurfaceDensity(short mSurfaceDensity)
	{
		TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbPolygonMesh_setMSurfaceDensity(swigCPtr, mSurfaceDensity);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		short result = TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbPolygonMesh_nSurfaceDensity(swigCPtr);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public void setNSurfaceDensity(short nSurfaceDensity)
	{
		TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbPolygonMesh_setNSurfaceDensity(swigCPtr, nSurfaceDensity);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbPolygonMesh_straighten(swigCPtr);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public OdResult surfaceFit()
	{
		int result = TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbPolygonMesh_surfaceFit__SWIG_0(swigCPtr);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public OdResult surfaceFit(OdDb_PolyMeshType surfType, short surfU, short surfV)
	{
		int result = TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbPolygonMesh_surfaceFit__SWIG_1(swigCPtr, (int)surfType, surfU, surfV);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public OdDbObjectId appendVertex(OdDbPolygonMeshVertex pVertex, OdDb_Vertex3dType vType)
	{
		OdDbObjectId result = new OdDbObjectId(TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbPolygonMesh_appendVertex__SWIG_0(swigCPtr, OdDbPolygonMeshVertex.getCPtr(pVertex), (int)vType), cMemoryOwn: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public OdDbObjectId appendVertex(OdDbPolygonMeshVertex pVertex)
	{
		OdDbObjectId result = new OdDbObjectId(TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbPolygonMesh_appendVertex__SWIG_1(swigCPtr, OdDbPolygonMeshVertex.getCPtr(pVertex)), cMemoryOwn: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public OdDbPolygonMeshVertex openVertex(OdDbObjectId vertId, OdDb_OpenMode mode, bool openErasedOne)
	{
		OdDbPolygonMeshVertex rXObject = ODA.Kernel.TD_RootIntegrated.Helpers.GetRXObject<OdDbPolygonMeshVertex>(TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbPolygonMesh_openVertex__SWIG_0(swigCPtr, OdDbObjectId.getCPtr(vertId), (int)mode, openErasedOne), bOwn: true, bTryAddToTransaction: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public OdDbPolygonMeshVertex openVertex(OdDbObjectId vertId, OdDb_OpenMode mode)
	{
		OdDbPolygonMeshVertex rXObject = ODA.Kernel.TD_RootIntegrated.Helpers.GetRXObject<OdDbPolygonMeshVertex>(TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbPolygonMesh_openVertex__SWIG_1(swigCPtr, OdDbObjectId.getCPtr(vertId), (int)mode), bOwn: true, bTryAddToTransaction: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		OdDbSequenceEnd rXObject = ODA.Kernel.TD_RootIntegrated.Helpers.GetRXObject<OdDbSequenceEnd>(TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbPolygonMesh_openSequenceEnd(swigCPtr, (int)mode), bOwn: true, bTryAddToTransaction: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		OdDbObjectIterator rXObject = ODA.Kernel.TD_RootIntegrated.Helpers.GetRXObject<OdDbObjectIterator>(TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbPolygonMesh_vertexIterator(swigCPtr), bOwn: true, bTryAddToTransaction: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		int result = (SwigDerivedClassHasMethod("dwgInFields", swigMethodTypes19) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbPolygonMesh_dwgInFieldsSwigExplicitOdDbPolygonMesh(swigCPtr, OdDbDwgFiler.getCPtr(pFiler)) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbPolygonMesh_dwgInFields(swigCPtr, OdDbDwgFiler.getCPtr(pFiler)));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public override void dwgOutFields(OdDbDwgFiler pFiler)
	{
		...
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbPolygonMesh_dwgOutFieldsSwigExplicitOdDbPolygonMesh(swigCPtr, OdDbDwgFiler.getCPtr(pFiler));
		}
		else
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbPolygonMesh_dwgOutFields(swigCPtr, OdDbDwgFiler.getCPtr(pFiler));
		}
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
	...
	{
		int result = (SwigDerivedClassHasMethod("dxfInFields", swigMethodTypes21) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbPolygonMesh_dxfInFieldsSwigExplicitOdDbPolygonMesh(swigCPtr, OdDbDxfFiler.getCPtr(pFiler)) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbPolygonMesh_dxfInFields(swigCPtr, OdDbDxfFiler.getCPtr(pFiler)));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public override void dxfOutFields(OdDbDxfFiler pFiler)
	{
		...
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbPolygonMesh_dxfOutFieldsSwigExplicitOdDbPolygonMesh(swigCPtr, OdDbDxfFiler.getCPtr(pFiler));
		}
		else
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbPolygonMesh_dxfOutFields(swigCPtr, OdDbDxfFiler.getCPtr(pFiler));
		}
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
	...
	public override void dxfOut(OdDbDxfFiler pFiler)
	{
		...
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbPolygonMesh_dxfOutSwigExplicitOdDbPolygonMesh(swigCPtr, OdDbDxfFiler.getCPtr(pFiler));
		}
		else
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbPolygonMesh_dxfOut(swigCPtr, OdDbDxfFiler.getCPtr(pFiler));
		}
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
	...
	{
		int result = (SwigDerivedClassHasMethod("dxfIn", swigMethodTypes17) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbPolygonMesh_dxfInSwigExplicitOdDbPolygonMesh(swigCPtr, OdDbDxfFiler.getCPtr(pFiler)) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbPolygonMesh_dxfIn(swigCPtr, OdDbDxfFiler.getCPtr(pFiler)));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		int result = (SwigDerivedClassHasMethod("dxfInFields_R12", swigMethodTypes23) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbPolygonMesh_dxfInFields_R12SwigExplicitOdDbPolygonMesh(swigCPtr, OdDbDxfFiler.getCPtr(pFiler)) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbPolygonMesh_dxfInFields_R12(swigCPtr, OdDbDxfFiler.getCPtr(pFiler)));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public override void dxfOutFields_R12(OdDbDxfFiler pFiler)
	{
		...
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbPolygonMesh_dxfOutFields_R12SwigExplicitOdDbPolygonMesh(swigCPtr, OdDbDxfFiler.getCPtr(pFiler));
		}
		else
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbPolygonMesh_dxfOutFields_R12(swigCPtr, OdDbDxfFiler.getCPtr(pFiler));
		}
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
	...
	public override void subClose()
	{
		...
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbPolygonMesh_subCloseSwigExplicitOdDbPolygonMesh(swigCPtr);
		}
		else
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbPolygonMesh_subClose(swigCPtr);
		}
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
	...
	{
		bool result = (SwigDerivedClassHasMethod("isPlanar", swigMethodTypes99) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbPolygonMesh_isPlanarSwigExplicitOdDbPolygonMesh(swigCPtr) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbPolygonMesh_isPlanar(swigCPtr));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		int result = (SwigDerivedClassHasMethod("getPlane", swigMethodTypes100) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbPolygonMesh_getPlaneSwigExplicitOdDbPolygonMesh(swigCPtr, OdGePlane.getCPtr(plane), out planarity) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbPolygonMesh_getPlane(swigCPtr, OdGePlane.getCPtr(plane), out planarity));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		int result = (SwigDerivedClassHasMethod("explodeGeometry", swigMethodTypes103) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbPolygonMesh_explodeGeometrySwigExplicitOdDbPolygonMesh(swigCPtr, OdRxObjectPtrArray.getCPtr(entitySet).Handle) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbPolygonMesh_explodeGeometry(swigCPtr, OdRxObjectPtrArray.getCPtr(entitySet).Handle));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		bool result = TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbPolygonMesh_SubWorldDraw(swigCPtr, OdGiWorldDraw.getCPtr(pWd));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		int result = TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbPolygonMesh_SubGetClassID(swigCPtr, pClsid);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		int result = TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbPolygonMesh_SubTransformBy(swigCPtr, OdGeMatrix3d.getCPtr(xfm));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		int result = TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbPolygonMesh_SubExplode(swigCPtr, OdRxObjectPtrArray.getCPtr(entitySet).Handle);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		int result = TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbPolygonMesh_SubGetSubentPathsAtGsMarker(swigCPtr, (int)type, gsMark, OdGePoint3d.getCPtr(arg0), OdGeMatrix3d.getCPtr(arg1), OdDbFullSubentPathArray.getCPtr(subentPaths), OdDbObjectIdArray.getCPtr(pEntAndInsertStack));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		int result = TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbPolygonMesh_SubGetGsMarkersAtSubentPath(swigCPtr, OdDbFullSubentPath.getCPtr(subPath), OdGsMarkerArray.getCPtr(gsMarkers));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		string result = TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbPolygonMesh_getRealClassName(ptr);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public new static OdDbPolygonMesh createObject()
	{
		OdDbPolygonMesh rXObject = ODA.Kernel.TD_RootIntegrated.Helpers.GetRXObject<OdDbPolygonMesh>(TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbPolygonMesh_createObject(), bOwn: true, bTryAddToTransaction: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
