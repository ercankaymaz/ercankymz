...
public class OdDbObjectContextOrdDimPE : OdDbObjectContextDimPE
{
	public delegate IntPtr SwigDelegateOdDbObjectContextOrdDimPE_0(IntPtr protocolClass);

	public delegate IntPtr SwigDelegateOdDbObjectContextOrdDimPE_1();

	public delegate void SwigDelegateOdDbObjectContextOrdDimPE_2(IntPtr pSource);

	public delegate bool SwigDelegateOdDbObjectContextOrdDimPE_3(IntPtr arg0, [MarshalAs(UnmanagedType.LPWStr)] string arg1);

	public delegate bool SwigDelegateOdDbObjectContextOrdDimPE_4(IntPtr arg0, IntPtr arg1);

	public delegate int SwigDelegateOdDbObjectContextOrdDimPE_5(IntPtr pObject, IntPtr ctx);

	public delegate int SwigDelegateOdDbObjectContextOrdDimPE_6(IntPtr arg0, IntPtr arg1);

	public delegate int SwigDelegateOdDbObjectContextOrdDimPE_7(IntPtr arg0, IntPtr arg1);

	public delegate IntPtr SwigDelegateOdDbObjectContextOrdDimPE_8(IntPtr arg0, [MarshalAs(UnmanagedType.LPWStr)] string arg1);

	public delegate IntPtr SwigDelegateOdDbObjectContextOrdDimPE_9(IntPtr arg0, IntPtr arg1, IntPtr def);

	public delegate IntPtr SwigDelegateOdDbObjectContextOrdDimPE_10(IntPtr arg0, IntPtr arg1);

	public delegate void SwigDelegateOdDbObjectContextOrdDimPE_11(IntPtr pObj);

	public delegate void SwigDelegateOdDbObjectContextOrdDimPE_12(IntPtr arg0, [MarshalAs(UnmanagedType.LPWStr)] string arg1);

	public delegate bool SwigDelegateOdDbObjectContextOrdDimPE_13(IntPtr arg0, IntPtr arg1);

	private object locker = new object();

	private HandleRef swigCPtr;

	private SwigDelegateOdDbObjectContextOrdDimPE_0 swigDelegate0;

	private SwigDelegateOdDbObjectContextOrdDimPE_1 swigDelegate1;

	private SwigDelegateOdDbObjectContextOrdDimPE_2 swigDelegate2;

	private SwigDelegateOdDbObjectContextOrdDimPE_3 swigDelegate3;

	private SwigDelegateOdDbObjectContextOrdDimPE_4 swigDelegate4;

	private SwigDelegateOdDbObjectContextOrdDimPE_5 swigDelegate5;

	private SwigDelegateOdDbObjectContextOrdDimPE_6 swigDelegate6;

	private SwigDelegateOdDbObjectContextOrdDimPE_7 swigDelegate7;

	private SwigDelegateOdDbObjectContextOrdDimPE_8 swigDelegate8;

	private SwigDelegateOdDbObjectContextOrdDimPE_9 swigDelegate9;

	private SwigDelegateOdDbObjectContextOrdDimPE_10 swigDelegate10;

	private SwigDelegateOdDbObjectContextOrdDimPE_11 swigDelegate11;

	private SwigDelegateOdDbObjectContextOrdDimPE_12 swigDelegate12;

	private SwigDelegateOdDbObjectContextOrdDimPE_13 swigDelegate13;
	...
	public OdDbObjectContextOrdDimPE(IntPtr cPtr, bool cMemoryOwn)
		: base(TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbObjectContextOrdDimPE_SWIGUpcast(cPtr), cMemoryOwn)
	{
		swigCPtr = new HandleRef(this, cPtr);
	}

	[EditorBrowsable(EditorBrowsableState.Never)]
	public static HandleRef getCPtr(OdDbObjectContextOrdDimPE obj)
	{
	...
	protected override void Dispose(bool disposing)
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					TD_DbCoreIntegrated_GlobalsPINVOKE.delete_OdDbObjectContextOrdDimPE(swigCPtr);
				}
	...
	public new static OdDbObjectContextOrdDimPE cast(OdRxObject pObj)
	{
		OdDbObjectContextOrdDimPE rXObject = ODA.Kernel.TD_RootIntegrated.Helpers.GetRXObject<OdDbObjectContextOrdDimPE>(TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbObjectContextOrdDimPE_cast(OdRxObject.getCPtr(pObj)), bOwn: true, bTryAddToTransaction: true);
	...
	{
		OdRxClass rXObject = ODA.Kernel.TD_RootIntegrated.Helpers.GetRXObject<OdRxClass>(TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbObjectContextOrdDimPE_desc(), bOwn: false, bTryAddToTransaction: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		OdRxClass rXObject = ODA.Kernel.TD_RootIntegrated.Helpers.GetRXObject<OdRxClass>(SwigDerivedClassHasMethod("isA", swigMethodTypes1) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbObjectContextOrdDimPE_isASwigExplicitOdDbObjectContextOrdDimPE(swigCPtr) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbObjectContextOrdDimPE_isA(swigCPtr), bOwn: false, bTryAddToTransaction: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		OdRxObject rXObject = ODA.Kernel.TD_RootIntegrated.Helpers.GetRXObject<OdRxObject>(SwigDerivedClassHasMethod("queryX", swigMethodTypes0) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbObjectContextOrdDimPE_queryXSwigExplicitOdDbObjectContextOrdDimPE(swigCPtr, OdRxClass.getCPtr(protocolClass)) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbObjectContextOrdDimPE_queryX(swigCPtr, OdRxClass.getCPtr(protocolClass)), bOwn: false, bTryAddToTransaction: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		OdDbObjectContextData rXObject = ODA.Kernel.TD_RootIntegrated.Helpers.GetRXObject<OdDbObjectContextData>(SwigDerivedClassHasMethod("createContextData", swigMethodTypes9) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbObjectContextOrdDimPE_createContextDataSwigExplicitOdDbObjectContextOrdDimPE(swigCPtr, OdDbObject.getCPtr(arg0), OdDbObjectContext.getCPtr(arg1), OdDbObjectContext.getCPtr(def)) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbObjectContextOrdDimPE_createContextData(swigCPtr, OdDbObject.getCPtr(arg0), OdDbObjectContext.getCPtr(arg1), OdDbObjectContext.getCPtr(def)), bOwn: true, bTryAddToTransaction: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		bool result = (SwigDerivedClassHasMethod("isValidContextData", swigMethodTypes13) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbObjectContextOrdDimPE_isValidContextDataSwigExplicitOdDbObjectContextOrdDimPE(swigCPtr, OdDbObject.getCPtr(arg0), OdDbObjectContextData.getCPtr(arg1)) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbObjectContextOrdDimPE_isValidContextData(swigCPtr, OdDbObject.getCPtr(arg0), OdDbObjectContextData.getCPtr(arg1)));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		string result = TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbObjectContextOrdDimPE_getRealClassName(ptr);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public new static OdDbObjectContextOrdDimPE createObject()
	{
		OdDbObjectContextOrdDimPE rXObject = ODA.Kernel.TD_RootIntegrated.Helpers.GetRXObject<OdDbObjectContextOrdDimPE>(TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbObjectContextOrdDimPE_createObject(), bOwn: true, bTryAddToTransaction: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	private void SwigDirectorConnect()
	{
		...
		TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbObjectContextOrdDimPE_director_connect(swigCPtr, swigDelegate0, swigDelegate1, swigDelegate2, swigDelegate3, swigDelegate4, swigDelegate5, swigDelegate6, swigDelegate7, swigDelegate8, swigDelegate9, swigDelegate10, swigDelegate11, swigDelegate12, swigDelegate13);
	}

	private bool SwigDerivedClassHasMethod(string methodName, Type[] methodTypes)
	{
		return GetType().GetMethod(methodName, BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic, null, methodTypes, null).DeclaringType.IsSubclassOf(typeof(OdDbObjectContextOrdDimPE));
	}
