...
public class OdDbMInsertBlock : OdDbBlockReference
{
	public delegate IntPtr SwigDelegateOdDbMInsertBlock_0(IntPtr protocolClass);

	public delegate IntPtr SwigDelegateOdDbMInsertBlock_1();

	public delegate void SwigDelegateOdDbMInsertBlock_2(IntPtr pSrc);

	public delegate int SwigDelegateOdDbMInsertBlock_3();

	public delegate bool SwigDelegateOdDbMInsertBlock_4();

	public delegate IntPtr SwigDelegateOdDbMInsertBlock_5();

	public delegate void SwigDelegateOdDbMInsertBlock_6(IntPtr pNode);

	public delegate IntPtr SwigDelegateOdDbMInsertBlock_7();

	public delegate void SwigDelegateOdDbMInsertBlock_8(IntPtr ownerId);

	public delegate int SwigDelegateOdDbMInsertBlock_9(int mode);

	public delegate void SwigDelegateOdDbMInsertBlock_10();

	public delegate int SwigDelegateOdDbMInsertBlock_11(bool erasing);

	public delegate void SwigDelegateOdDbMInsertBlock_12(IntPtr pNewObject);

	public delegate void SwigDelegateOdDbMInsertBlock_13(IntPtr otherId, bool swapXdata, bool swapExtDict);

	public delegate void SwigDelegateOdDbMInsertBlock_14(IntPtr otherId, bool swapXdata);

	public delegate void SwigDelegateOdDbMInsertBlock_15(IntPtr otherId);

	public delegate void SwigDelegateOdDbMInsertBlock_16(IntPtr pAuditInfo);

	public delegate int SwigDelegateOdDbMInsertBlock_17(IntPtr pFiler);

	public delegate void SwigDelegateOdDbMInsertBlock_18(IntPtr pFiler);

	public delegate int SwigDelegateOdDbMInsertBlock_19(IntPtr pFiler);

	public delegate void SwigDelegateOdDbMInsertBlock_20(IntPtr pFiler);

	public delegate int SwigDelegateOdDbMInsertBlock_21(IntPtr pFiler);

	public delegate void SwigDelegateOdDbMInsertBlock_22(IntPtr pFiler);

	public delegate int SwigDelegateOdDbMInsertBlock_23(IntPtr pFiler);

	public delegate void SwigDelegateOdDbMInsertBlock_24(IntPtr pFiler);

	public delegate int SwigDelegateOdDbMInsertBlock_25();

	public delegate IntPtr SwigDelegateOdDbMInsertBlock_26([MarshalAs(UnmanagedType.LPWStr)] string regappName);

	public delegate void SwigDelegateOdDbMInsertBlock_27(IntPtr pRb);

	public delegate void SwigDelegateOdDbMInsertBlock_28(IntPtr pUndoFiler, IntPtr pClassObj);

	public delegate void SwigDelegateOdDbMInsertBlock_29(IntPtr objId);

	public delegate void SwigDelegateOdDbMInsertBlock_30(IntPtr objId);

	public delegate void SwigDelegateOdDbMInsertBlock_31(IntPtr pSubObj);

	public delegate void SwigDelegateOdDbMInsertBlock_32();

	public delegate void SwigDelegateOdDbMInsertBlock_33(IntPtr idPair, IntPtr pOwnerObject, IntPtr ownerIdMap);

	public delegate void SwigDelegateOdDbMInsertBlock_34(IntPtr pObject, IntPtr pNewObject);

	public delegate void SwigDelegateOdDbMInsertBlock_35(IntPtr pObject, bool erasing);

	public delegate void SwigDelegateOdDbMInsertBlock_36(IntPtr pObject);

	public delegate void SwigDelegateOdDbMInsertBlock_37(IntPtr pObject);

	public delegate void SwigDelegateOdDbMInsertBlock_38(IntPtr pObject);

	public delegate void SwigDelegateOdDbMInsertBlock_39(IntPtr pObject);

	public delegate void SwigDelegateOdDbMInsertBlock_40(IntPtr pObject, IntPtr pSubObj);

	public delegate void SwigDelegateOdDbMInsertBlock_41(IntPtr pObject);

	public delegate void SwigDelegateOdDbMInsertBlock_42(IntPtr pObject);

	public delegate void SwigDelegateOdDbMInsertBlock_43(IntPtr pObject);

	public delegate void SwigDelegateOdDbMInsertBlock_44(IntPtr pObject);

	public delegate void SwigDelegateOdDbMInsertBlock_45(IntPtr objectId);

	public delegate void SwigDelegateOdDbMInsertBlock_46(IntPtr pObject);

	public delegate void SwigDelegateOdDbMInsertBlock_47(IntPtr pSource);

	public delegate int SwigDelegateOdDbMInsertBlock_48(IntPtr pFiler, MaintReleaseVer pMaintVer);

	public delegate int SwigDelegateOdDbMInsertBlock_49(IntPtr pFiler);

	public delegate IntPtr SwigDelegateOdDbMInsertBlock_50(int ver, IntPtr replaceId, bool exchangeXData);

	public delegate IntPtr SwigDelegateOdDbMInsertBlock_51(int format, int ver, IntPtr replaceId, bool exchangeXData);

	public delegate void SwigDelegateOdDbMInsertBlock_52(int format, int version, IntPtr pAuditInfo);

	public delegate IntPtr SwigDelegateOdDbMInsertBlock_53();

	public delegate IntPtr SwigDelegateOdDbMInsertBlock_54([MarshalAs(UnmanagedType.LPWStr)] string fieldName, IntPtr pField);

	public delegate int SwigDelegateOdDbMInsertBlock_55(IntPtr fieldId);

	public delegate IntPtr SwigDelegateOdDbMInsertBlock_56([MarshalAs(UnmanagedType.LPWStr)] string fieldName);

	public delegate IntPtr SwigDelegateOdDbMInsertBlock_57(IntPtr pClass);

	public delegate int SwigDelegateOdDbMInsertBlock_58(IntPtr color, bool doSubents);

	public delegate int SwigDelegateOdDbMInsertBlock_59(IntPtr color);

	public delegate IntPtr SwigDelegateOdDbMInsertBlock_60();

	public delegate int SwigDelegateOdDbMInsertBlock_61(ushort colorIndex, bool doSubents);

	public delegate int SwigDelegateOdDbMInsertBlock_62(ushort colorIndex);

	public delegate int SwigDelegateOdDbMInsertBlock_63(IntPtr colorId, bool doSubents);

	public delegate int SwigDelegateOdDbMInsertBlock_64(IntPtr colorId);

	public delegate int SwigDelegateOdDbMInsertBlock_65(IntPtr transparency, bool doSubents);

	public delegate int SwigDelegateOdDbMInsertBlock_66(IntPtr transparency);

	public delegate int SwigDelegateOdDbMInsertBlock_67([MarshalAs(UnmanagedType.LPWStr)] string plotStyleName, bool doSubents);

	public delegate int SwigDelegateOdDbMInsertBlock_68([MarshalAs(UnmanagedType.LPWStr)] string plotStyleName);

	public delegate int SwigDelegateOdDbMInsertBlock_69(int plotStyleNameType, IntPtr plotStyleNameId, bool doSubents);

	public delegate int SwigDelegateOdDbMInsertBlock_70(int plotStyleNameType, IntPtr plotStyleNameId);

	public delegate int SwigDelegateOdDbMInsertBlock_71(int plotStyleNameType);

	public delegate int SwigDelegateOdDbMInsertBlock_72([MarshalAs(UnmanagedType.LPWStr)] string layerName, bool doSubents, bool allowHiddenLayer);

	public delegate int SwigDelegateOdDbMInsertBlock_73([MarshalAs(UnmanagedType.LPWStr)] string layerName, bool doSubents);

	public delegate int SwigDelegateOdDbMInsertBlock_74([MarshalAs(UnmanagedType.LPWStr)] string layerName);

	public delegate int SwigDelegateOdDbMInsertBlock_75(IntPtr layerId, bool doSubents, bool allowHiddenLayer);

	public delegate int SwigDelegateOdDbMInsertBlock_76(IntPtr layerId, bool doSubents);

	public delegate int SwigDelegateOdDbMInsertBlock_77(IntPtr layerId);

	public delegate int SwigDelegateOdDbMInsertBlock_78([MarshalAs(UnmanagedType.LPWStr)] string linetypeName, bool doSubents);

	public delegate int SwigDelegateOdDbMInsertBlock_79([MarshalAs(UnmanagedType.LPWStr)] string linetypeName);

	public delegate int SwigDelegateOdDbMInsertBlock_80(IntPtr linetypeID, bool doSubents);

	public delegate int SwigDelegateOdDbMInsertBlock_81(IntPtr linetypeID);

	public delegate int SwigDelegateOdDbMInsertBlock_82([MarshalAs(UnmanagedType.LPWStr)] string materialName, bool doSubents);

	public delegate int SwigDelegateOdDbMInsertBlock_83([MarshalAs(UnmanagedType.LPWStr)] string materialName);

	public delegate int SwigDelegateOdDbMInsertBlock_84(IntPtr materialID, bool doSubents);

	public delegate int SwigDelegateOdDbMInsertBlock_85(IntPtr materialID);

	public delegate int SwigDelegateOdDbMInsertBlock_86(IntPtr visualStyleId, int vstype, bool doSubents);

	public delegate IntPtr SwigDelegateOdDbMInsertBlock_87();

	public delegate void SwigDelegateOdDbMInsertBlock_88(IntPtr mapper, bool doSubents);

	public delegate void SwigDelegateOdDbMInsertBlock_89(IntPtr mapper);

	public delegate int SwigDelegateOdDbMInsertBlock_90(double linetypeScale, bool doSubents);

	public delegate int SwigDelegateOdDbMInsertBlock_91(double linetypeScale);

	public delegate int SwigDelegateOdDbMInsertBlock_92(int lineWeight, bool doSubents);

	public delegate int SwigDelegateOdDbMInsertBlock_93(int lineWeight);

	public delegate bool SwigDelegateOdDbMInsertBlock_94();

	public delegate void SwigDelegateOdDbMInsertBlock_95(bool castShadows);

	public delegate bool SwigDelegateOdDbMInsertBlock_96();

	public delegate void SwigDelegateOdDbMInsertBlock_97(bool receiveShadows);

	public delegate int SwigDelegateOdDbMInsertBlock_98();

	public delegate bool SwigDelegateOdDbMInsertBlock_99();

	public delegate int SwigDelegateOdDbMInsertBlock_100(IntPtr plane, OdDb_Planarity planarity);

	public delegate int SwigDelegateOdDbMInsertBlock_101(IntPtr pTargetBlkRec, IntPtr pResIdArray);

	public delegate int SwigDelegateOdDbMInsertBlock_102(IntPtr BlockRecord);

	public delegate int SwigDelegateOdDbMInsertBlock_103(IntPtr entitySet);

	public delegate int SwigDelegateOdDbMInsertBlock_104(IntPtr pBlockRecord, IntPtr ids);

	public delegate int SwigDelegateOdDbMInsertBlock_105(IntPtr pBlockRecord);

	public delegate void SwigDelegateOdDbMInsertBlock_106(IntPtr pDb, bool doSubents);

	public delegate void SwigDelegateOdDbMInsertBlock_107();

	public delegate void SwigDelegateOdDbMInsertBlock_108(int status);

	public delegate void SwigDelegateOdDbMInsertBlock_109(IntPtr pWd, int ver);

	public delegate IntPtr SwigDelegateOdDbMInsertBlock_110();

	public delegate bool SwigDelegateOdDbMInsertBlock_111();

	public delegate bool SwigDelegateOdDbMInsertBlock_112();

	public delegate void SwigDelegateOdDbMInsertBlock_113(int status);

	public delegate int SwigDelegateOdDbMInsertBlock_114(int osnapMode, IntPtr gsSelectionMark, IntPtr pickPoint, IntPtr lastPoint, IntPtr xWorldToEye, IntPtr snapPoints);

	public delegate int SwigDelegateOdDbMInsertBlock_115(int osnapMode, IntPtr gsSelectionMark, IntPtr pickPoint, IntPtr lastPoint, IntPtr xWorldToEye, IntPtr snapPoints, IntPtr insertionMat);

	public delegate bool SwigDelegateOdDbMInsertBlock_116();

	public delegate int SwigDelegateOdDbMInsertBlock_117(IntPtr gripPoints);

	public delegate int SwigDelegateOdDbMInsertBlock_118(IntPtr indices, IntPtr offset);

	public delegate int SwigDelegateOdDbMInsertBlock_119(IntPtr grips, double curViewUnitSize, int gripSize, IntPtr curViewDir, int bitFlags);

	public delegate int SwigDelegateOdDbMInsertBlock_120(IntPtr grips, IntPtr offset, int bitFlags);

	public delegate int SwigDelegateOdDbMInsertBlock_121(IntPtr stretchPoints);

	public delegate int SwigDelegateOdDbMInsertBlock_122(IntPtr indices, IntPtr offset);

	public delegate int SwigDelegateOdDbMInsertBlock_123(IntPtr pEnt, int intType, IntPtr points, IntPtr thisGsMarker, IntPtr otherGsMarker);

	public delegate int SwigDelegateOdDbMInsertBlock_124(IntPtr pEnt, int intType, IntPtr points, IntPtr thisGsMarker);

	public delegate int SwigDelegateOdDbMInsertBlock_125(IntPtr pEnt, int intType, IntPtr points);

	public delegate int SwigDelegateOdDbMInsertBlock_126(IntPtr pEnt, int intType, IntPtr projPlane, IntPtr points, IntPtr thisGsMarker, IntPtr otherGsMarker);

	public delegate int SwigDelegateOdDbMInsertBlock_127(IntPtr pEnt, int intType, IntPtr projPlane, IntPtr points, IntPtr thisGsMarker);

	public delegate int SwigDelegateOdDbMInsertBlock_128(IntPtr pEnt, int intType, IntPtr projPlane, IntPtr points);

	public delegate void SwigDelegateOdDbMInsertBlock_129(bool bDoIt, IntPtr pSubId, bool highlightAll);

	public delegate void SwigDelegateOdDbMInsertBlock_130(bool bDoIt, IntPtr pSubId);

	public delegate void SwigDelegateOdDbMInsertBlock_131(bool bDoIt);

	public delegate void SwigDelegateOdDbMInsertBlock_132();

	public delegate int SwigDelegateOdDbMInsertBlock_133();

	public delegate int SwigDelegateOdDbMInsertBlock_134(int visibility, bool doSubents);

	public delegate int SwigDelegateOdDbMInsertBlock_135(int visibility);

	public delegate int SwigDelegateOdDbMInsertBlock_136(IntPtr paths);

	public delegate int SwigDelegateOdDbMInsertBlock_137(IntPtr paths);

	public delegate int SwigDelegateOdDbMInsertBlock_138(IntPtr paths, IntPtr gripAppData, IntPtr offset, uint bitflags);

	public delegate int SwigDelegateOdDbMInsertBlock_139(IntPtr path, IntPtr grips, double curViewUnitSize, int gripSize, IntPtr curViewDir, uint bitflags);

	public delegate int SwigDelegateOdDbMInsertBlock_140(int type, IntPtr gsMark, IntPtr pickPoint, IntPtr xfm, IntPtr subentPaths);

	public delegate IntPtr SwigDelegateOdDbMInsertBlock_141(IntPtr path);

	public delegate int SwigDelegateOdDbMInsertBlock_142(IntPtr paths, IntPtr xform);

	public delegate int SwigDelegateOdDbMInsertBlock_143(IntPtr path, IntPtr clsId);

	public delegate int SwigDelegateOdDbMInsertBlock_144(IntPtr path, IntPtr extents);

	public delegate void SwigDelegateOdDbMInsertBlock_145(int status, IntPtr subentity);

	public delegate void SwigDelegateOdDbMInsertBlock_146(IntPtr objectId);

	public delegate IntPtr SwigDelegateOdDbMInsertBlock_147();

	public delegate void SwigDelegateOdDbMInsertBlock_148(IntPtr position);

	public delegate void SwigDelegateOdDbMInsertBlock_149(IntPtr scale);

	public delegate void SwigDelegateOdDbMInsertBlock_150(double angle);

	public delegate void SwigDelegateOdDbMInsertBlock_151(IntPtr normal);

	public delegate int SwigDelegateOdDbMInsertBlock_152(IntPtr xfm);

	public delegate bool SwigDelegateOdDbMInsertBlock_153();

	public delegate int SwigDelegateOdDbMInsertBlock_154();

	private object locker = new object();

	private HandleRef swigCPtr;

	private SwigDelegateOdDbMInsertBlock_0 swigDelegate0;

	private SwigDelegateOdDbMInsertBlock_1 swigDelegate1;

	private SwigDelegateOdDbMInsertBlock_2 swigDelegate2;

	private SwigDelegateOdDbMInsertBlock_3 swigDelegate3;

	private SwigDelegateOdDbMInsertBlock_4 swigDelegate4;

	private SwigDelegateOdDbMInsertBlock_5 swigDelegate5;

	private SwigDelegateOdDbMInsertBlock_6 swigDelegate6;

	private SwigDelegateOdDbMInsertBlock_7 swigDelegate7;

	private SwigDelegateOdDbMInsertBlock_8 swigDelegate8;

	private SwigDelegateOdDbMInsertBlock_9 swigDelegate9;

	private SwigDelegateOdDbMInsertBlock_10 swigDelegate10;

	private SwigDelegateOdDbMInsertBlock_11 swigDelegate11;

	private SwigDelegateOdDbMInsertBlock_12 swigDelegate12;

	private SwigDelegateOdDbMInsertBlock_13 swigDelegate13;

	private SwigDelegateOdDbMInsertBlock_14 swigDelegate14;

	private SwigDelegateOdDbMInsertBlock_15 swigDelegate15;

	private SwigDelegateOdDbMInsertBlock_16 swigDelegate16;

	private SwigDelegateOdDbMInsertBlock_17 swigDelegate17;

	private SwigDelegateOdDbMInsertBlock_18 swigDelegate18;

	private SwigDelegateOdDbMInsertBlock_19 swigDelegate19;

	private SwigDelegateOdDbMInsertBlock_20 swigDelegate20;

	private SwigDelegateOdDbMInsertBlock_21 swigDelegate21;

	private SwigDelegateOdDbMInsertBlock_22 swigDelegate22;

	private SwigDelegateOdDbMInsertBlock_23 swigDelegate23;

	private SwigDelegateOdDbMInsertBlock_24 swigDelegate24;

	private SwigDelegateOdDbMInsertBlock_25 swigDelegate25;

	private SwigDelegateOdDbMInsertBlock_26 swigDelegate26;

	private SwigDelegateOdDbMInsertBlock_27 swigDelegate27;

	private SwigDelegateOdDbMInsertBlock_28 swigDelegate28;

	private SwigDelegateOdDbMInsertBlock_29 swigDelegate29;

	private SwigDelegateOdDbMInsertBlock_30 swigDelegate30;

	private SwigDelegateOdDbMInsertBlock_31 swigDelegate31;

	private SwigDelegateOdDbMInsertBlock_32 swigDelegate32;

	private SwigDelegateOdDbMInsertBlock_33 swigDelegate33;

	private SwigDelegateOdDbMInsertBlock_34 swigDelegate34;

	private SwigDelegateOdDbMInsertBlock_35 swigDelegate35;

	private SwigDelegateOdDbMInsertBlock_36 swigDelegate36;

	private SwigDelegateOdDbMInsertBlock_37 swigDelegate37;

	private SwigDelegateOdDbMInsertBlock_38 swigDelegate38;

	private SwigDelegateOdDbMInsertBlock_39 swigDelegate39;

	private SwigDelegateOdDbMInsertBlock_40 swigDelegate40;

	private SwigDelegateOdDbMInsertBlock_41 swigDelegate41;

	private SwigDelegateOdDbMInsertBlock_42 swigDelegate42;

	private SwigDelegateOdDbMInsertBlock_43 swigDelegate43;

	private SwigDelegateOdDbMInsertBlock_44 swigDelegate44;

	private SwigDelegateOdDbMInsertBlock_45 swigDelegate45;

	private SwigDelegateOdDbMInsertBlock_46 swigDelegate46;

	private SwigDelegateOdDbMInsertBlock_47 swigDelegate47;

	private SwigDelegateOdDbMInsertBlock_48 swigDelegate48;

	private SwigDelegateOdDbMInsertBlock_49 swigDelegate49;

	private SwigDelegateOdDbMInsertBlock_50 swigDelegate50;

	private SwigDelegateOdDbMInsertBlock_51 swigDelegate51;

	private SwigDelegateOdDbMInsertBlock_52 swigDelegate52;

	private SwigDelegateOdDbMInsertBlock_53 swigDelegate53;

	private SwigDelegateOdDbMInsertBlock_54 swigDelegate54;

	private SwigDelegateOdDbMInsertBlock_55 swigDelegate55;

	private SwigDelegateOdDbMInsertBlock_56 swigDelegate56;

	private SwigDelegateOdDbMInsertBlock_57 swigDelegate57;

	private SwigDelegateOdDbMInsertBlock_58 swigDelegate58;

	private SwigDelegateOdDbMInsertBlock_59 swigDelegate59;

	private SwigDelegateOdDbMInsertBlock_60 swigDelegate60;

	private SwigDelegateOdDbMInsertBlock_61 swigDelegate61;

	private SwigDelegateOdDbMInsertBlock_62 swigDelegate62;

	private SwigDelegateOdDbMInsertBlock_63 swigDelegate63;

	private SwigDelegateOdDbMInsertBlock_64 swigDelegate64;

	private SwigDelegateOdDbMInsertBlock_65 swigDelegate65;

	private SwigDelegateOdDbMInsertBlock_66 swigDelegate66;

	private SwigDelegateOdDbMInsertBlock_67 swigDelegate67;

	private SwigDelegateOdDbMInsertBlock_68 swigDelegate68;

	private SwigDelegateOdDbMInsertBlock_69 swigDelegate69;

	private SwigDelegateOdDbMInsertBlock_70 swigDelegate70;

	private SwigDelegateOdDbMInsertBlock_71 swigDelegate71;

	private SwigDelegateOdDbMInsertBlock_72 swigDelegate72;

	private SwigDelegateOdDbMInsertBlock_73 swigDelegate73;

	private SwigDelegateOdDbMInsertBlock_74 swigDelegate74;

	private SwigDelegateOdDbMInsertBlock_75 swigDelegate75;

	private SwigDelegateOdDbMInsertBlock_76 swigDelegate76;

	private SwigDelegateOdDbMInsertBlock_77 swigDelegate77;

	private SwigDelegateOdDbMInsertBlock_78 swigDelegate78;

	private SwigDelegateOdDbMInsertBlock_79 swigDelegate79;

	private SwigDelegateOdDbMInsertBlock_80 swigDelegate80;

	private SwigDelegateOdDbMInsertBlock_81 swigDelegate81;

	private SwigDelegateOdDbMInsertBlock_82 swigDelegate82;

	private SwigDelegateOdDbMInsertBlock_83 swigDelegate83;

	private SwigDelegateOdDbMInsertBlock_84 swigDelegate84;

	private SwigDelegateOdDbMInsertBlock_85 swigDelegate85;

	private SwigDelegateOdDbMInsertBlock_86 swigDelegate86;

	private SwigDelegateOdDbMInsertBlock_87 swigDelegate87;

	private SwigDelegateOdDbMInsertBlock_88 swigDelegate88;

	private SwigDelegateOdDbMInsertBlock_89 swigDelegate89;

	private SwigDelegateOdDbMInsertBlock_90 swigDelegate90;

	private SwigDelegateOdDbMInsertBlock_91 swigDelegate91;

	private SwigDelegateOdDbMInsertBlock_92 swigDelegate92;

	private SwigDelegateOdDbMInsertBlock_93 swigDelegate93;

	private SwigDelegateOdDbMInsertBlock_94 swigDelegate94;

	private SwigDelegateOdDbMInsertBlock_95 swigDelegate95;

	private SwigDelegateOdDbMInsertBlock_96 swigDelegate96;

	private SwigDelegateOdDbMInsertBlock_97 swigDelegate97;

	private SwigDelegateOdDbMInsertBlock_98 swigDelegate98;

	private SwigDelegateOdDbMInsertBlock_99 swigDelegate99;

	private SwigDelegateOdDbMInsertBlock_100 swigDelegate100;

	private SwigDelegateOdDbMInsertBlock_101 swigDelegate101;

	private SwigDelegateOdDbMInsertBlock_102 swigDelegate102;

	private SwigDelegateOdDbMInsertBlock_103 swigDelegate103;

	private SwigDelegateOdDbMInsertBlock_104 swigDelegate104;

	private SwigDelegateOdDbMInsertBlock_105 swigDelegate105;

	private SwigDelegateOdDbMInsertBlock_106 swigDelegate106;

	private SwigDelegateOdDbMInsertBlock_107 swigDelegate107;

	private SwigDelegateOdDbMInsertBlock_108 swigDelegate108;

	private SwigDelegateOdDbMInsertBlock_109 swigDelegate109;

	private SwigDelegateOdDbMInsertBlock_110 swigDelegate110;

	private SwigDelegateOdDbMInsertBlock_111 swigDelegate111;

	private SwigDelegateOdDbMInsertBlock_112 swigDelegate112;

	private SwigDelegateOdDbMInsertBlock_113 swigDelegate113;

	private SwigDelegateOdDbMInsertBlock_114 swigDelegate114;

	private SwigDelegateOdDbMInsertBlock_115 swigDelegate115;

	private SwigDelegateOdDbMInsertBlock_116 swigDelegate116;

	private SwigDelegateOdDbMInsertBlock_117 swigDelegate117;

	private SwigDelegateOdDbMInsertBlock_118 swigDelegate118;

	private SwigDelegateOdDbMInsertBlock_119 swigDelegate119;

	private SwigDelegateOdDbMInsertBlock_120 swigDelegate120;

	private SwigDelegateOdDbMInsertBlock_121 swigDelegate121;

	private SwigDelegateOdDbMInsertBlock_122 swigDelegate122;

	private SwigDelegateOdDbMInsertBlock_123 swigDelegate123;

	private SwigDelegateOdDbMInsertBlock_124 swigDelegate124;

	private SwigDelegateOdDbMInsertBlock_125 swigDelegate125;

	private SwigDelegateOdDbMInsertBlock_126 swigDelegate126;

	private SwigDelegateOdDbMInsertBlock_127 swigDelegate127;

	private SwigDelegateOdDbMInsertBlock_128 swigDelegate128;

	private SwigDelegateOdDbMInsertBlock_129 swigDelegate129;

	private SwigDelegateOdDbMInsertBlock_130 swigDelegate130;

	private SwigDelegateOdDbMInsertBlock_131 swigDelegate131;

	private SwigDelegateOdDbMInsertBlock_132 swigDelegate132;

	private SwigDelegateOdDbMInsertBlock_133 swigDelegate133;

	private SwigDelegateOdDbMInsertBlock_134 swigDelegate134;

	private SwigDelegateOdDbMInsertBlock_135 swigDelegate135;

	private SwigDelegateOdDbMInsertBlock_136 swigDelegate136;

	private SwigDelegateOdDbMInsertBlock_137 swigDelegate137;

	private SwigDelegateOdDbMInsertBlock_138 swigDelegate138;

	private SwigDelegateOdDbMInsertBlock_139 swigDelegate139;

	private SwigDelegateOdDbMInsertBlock_140 swigDelegate140;

	private SwigDelegateOdDbMInsertBlock_141 swigDelegate141;

	private SwigDelegateOdDbMInsertBlock_142 swigDelegate142;

	private SwigDelegateOdDbMInsertBlock_143 swigDelegate143;

	private SwigDelegateOdDbMInsertBlock_144 swigDelegate144;

	private SwigDelegateOdDbMInsertBlock_145 swigDelegate145;

	private SwigDelegateOdDbMInsertBlock_146 swigDelegate146;

	private SwigDelegateOdDbMInsertBlock_147 swigDelegate147;

	private SwigDelegateOdDbMInsertBlock_148 swigDelegate148;

	private SwigDelegateOdDbMInsertBlock_149 swigDelegate149;

	private SwigDelegateOdDbMInsertBlock_150 swigDelegate150;

	private SwigDelegateOdDbMInsertBlock_151 swigDelegate151;

	private SwigDelegateOdDbMInsertBlock_152 swigDelegate152;

	private SwigDelegateOdDbMInsertBlock_153 swigDelegate153;

	private SwigDelegateOdDbMInsertBlock_154 swigDelegate154;
	...
	private static Type[] swigMethodTypes140 = new Type[5]
	{
	...
	private static Type[] swigMethodTypes141 = new Type[1] { typeof(OdDbFullSubentPath) };
	...
	private static Type[] swigMethodTypes146 = new Type[1] { typeof(OdDbObjectId) };

	private static Type[] swigMethodTypes147 = new Type[0];

	private static Type[] swigMethodTypes148 = new Type[1] { typeof(OdGePoint3d) };

	private static Type[] swigMethodTypes149 = new Type[1] { typeof(OdGeScale3d) };

	private static Type[] swigMethodTypes150 = new Type[1] { typeof(double) };

	private static Type[] swigMethodTypes151 = new Type[1] { typeof(OdGeVector3d) };

	private static Type[] swigMethodTypes152 = new Type[1] { typeof(OdGeMatrix3d) };
	...
	public OdDbMInsertBlock(IntPtr cPtr, bool cMemoryOwn)
		: base(TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbMInsertBlock_SWIGUpcast(cPtr), cMemoryOwn)
	{
		swigCPtr = new HandleRef(this, cPtr);
	}

	[EditorBrowsable(EditorBrowsableState.Never)]
	public static HandleRef getCPtr(OdDbMInsertBlock obj)
	{
	...
	protected override void Dispose(bool disposing)
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					TD_DbCoreIntegrated_GlobalsPINVOKE.delete_OdDbMInsertBlock(swigCPtr);
				}
	...
	public new static OdDbMInsertBlock cast(OdRxObject pObj)
	{
		OdDbMInsertBlock rXObject = ODA.Kernel.TD_RootIntegrated.Helpers.GetRXObject<OdDbMInsertBlock>(TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbMInsertBlock_cast(OdRxObject.getCPtr(pObj)), bOwn: true, bTryAddToTransaction: true);
	...
	{
		OdRxClass rXObject = ODA.Kernel.TD_RootIntegrated.Helpers.GetRXObject<OdRxClass>(TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbMInsertBlock_desc(), bOwn: false, bTryAddToTransaction: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		OdRxClass rXObject = ODA.Kernel.TD_RootIntegrated.Helpers.GetRXObject<OdRxClass>(SwigDerivedClassHasMethod("isA", swigMethodTypes1) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbMInsertBlock_isASwigExplicitOdDbMInsertBlock(swigCPtr) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbMInsertBlock_isA(swigCPtr), bOwn: false, bTryAddToTransaction: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		OdRxObject rXObject = ODA.Kernel.TD_RootIntegrated.Helpers.GetRXObject<OdRxObject>(SwigDerivedClassHasMethod("queryX", swigMethodTypes0) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbMInsertBlock_queryXSwigExplicitOdDbMInsertBlock(swigCPtr, OdRxClass.getCPtr(protocolClass)) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbMInsertBlock_queryX(swigCPtr, OdRxClass.getCPtr(protocolClass)), bOwn: false, bTryAddToTransaction: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		ushort result = TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbMInsertBlock_columns(swigCPtr);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public void setColumns(ushort numColumns)
	{
		TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbMInsertBlock_setColumns(swigCPtr, numColumns);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public ushort rows()
	{
		ushort result = TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbMInsertBlock_rows(swigCPtr);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public void setRows(ushort numRows)
	{
		TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbMInsertBlock_setRows(swigCPtr, numRows);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		double result = TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbMInsertBlock_columnSpacing(swigCPtr);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public void setColumnSpacing(double colSpacing)
	{
		TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbMInsertBlock_setColumnSpacing(swigCPtr, colSpacing);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		double result = TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbMInsertBlock_rowSpacing(swigCPtr);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbMInsertBlock_setRowSpacing(swigCPtr, rowSpacing);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		int result = (SwigDerivedClassHasMethod("dwgInFields", swigMethodTypes19) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbMInsertBlock_dwgInFieldsSwigExplicitOdDbMInsertBlock(swigCPtr, OdDbDwgFiler.getCPtr(pFiler)) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbMInsertBlock_dwgInFields(swigCPtr, OdDbDwgFiler.getCPtr(pFiler)));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public override void dwgOutFields(OdDbDwgFiler pFiler)
	{
		...
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbMInsertBlock_dwgOutFieldsSwigExplicitOdDbMInsertBlock(swigCPtr, OdDbDwgFiler.getCPtr(pFiler));
		}
		else
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbMInsertBlock_dwgOutFields(swigCPtr, OdDbDwgFiler.getCPtr(pFiler));
		}
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
	...
	{
		int result = (SwigDerivedClassHasMethod("dxfInFields", swigMethodTypes21) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbMInsertBlock_dxfInFieldsSwigExplicitOdDbMInsertBlock(swigCPtr, OdDbDxfFiler.getCPtr(pFiler)) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbMInsertBlock_dxfInFields(swigCPtr, OdDbDxfFiler.getCPtr(pFiler)));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public override void dxfOutFields(OdDbDxfFiler pFiler)
	{
		...
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbMInsertBlock_dxfOutFieldsSwigExplicitOdDbMInsertBlock(swigCPtr, OdDbDxfFiler.getCPtr(pFiler));
		}
		else
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbMInsertBlock_dxfOutFields(swigCPtr, OdDbDxfFiler.getCPtr(pFiler));
		}
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
	...
	public override OdResult explodeToBlock(OdDbBlockTableRecord pTargetBlkRec, OdDbObjectIdArray pResIdArray)
	{
		int result = (SwigDerivedClassHasMethod("explodeToBlock", swigMethodTypes101) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbMInsertBlock_explodeToBlockSwigExplicitOdDbMInsertBlock(swigCPtr, OdDbBlockTableRecord.getCPtr(pTargetBlkRec), OdDbObjectIdArray.getCPtr(pResIdArray)) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbMInsertBlock_explodeToBlock(swigCPtr, OdDbBlockTableRecord.getCPtr(pTargetBlkRec), OdDbObjectIdArray.getCPtr(pResIdArray)));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		int result = TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbMInsertBlock_SubGetClassID(swigCPtr, pClsid);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		int result = TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbMInsertBlock_SubTransformBy(swigCPtr, OdGeMatrix3d.getCPtr(xfm));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public new OdResult SubGetGeomExtents(OdGeExtents3d extents)
	{
		int result = TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbMInsertBlock_SubGetGeomExtents(swigCPtr, OdGeExtents3d.getCPtr(extents));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		bool result = TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbMInsertBlock_SubWorldDraw(swigCPtr, OdGiWorldDraw.getCPtr(pWd));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		int result = TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbMInsertBlock_SubExplode(swigCPtr, OdRxObjectPtrArray.getCPtr(entitySet).Handle);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		string result = TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbMInsertBlock_getRealClassName(ptr);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public new static OdDbMInsertBlock createObject()
	{
		OdDbMInsertBlock rXObject = ODA.Kernel.TD_RootIntegrated.Helpers.GetRXObject<OdDbMInsertBlock>(TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbMInsertBlock_createObject(), bOwn: true, bTryAddToTransaction: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	private void SwigDirectorConnect()
	{
		...
		{
			swigDelegate101 = SwigDirectorMethodexplodeToBlock;
		}
		...
		{
			swigDelegate140 = SwigDirectorMethodsubGetSubentPathsAtGsMarker__SWIG_1;
		}
		if (SwigDerivedClassHasMethod("subSubentPtr", swigMethodTypes141))
		{
			swigDelegate141 = SwigDirectorMethodsubSubentPtr;
		}
	...
	private void SwigDirectorMethodcopyFrom(IntPtr pSrc)
	{
		try
		{
			copyFrom(ODA.Kernel.TD_RootIntegrated.Helpers.GetRXObject<OdRxObject>(pSrc, bOwn: false, bTryAddToTransaction: false));
		}
	...
	private int SwigDirectorMethodexplodeToBlock(IntPtr pTargetBlkRec, IntPtr pResIdArray)
	{
		return (int)explodeToBlock(ODA.Kernel.TD_RootIntegrated.Helpers.GetRXObject<OdDbBlockTableRecord>(pTargetBlkRec, bOwn: false, bTryAddToTransaction: false), (pResIdArray == IntPtr.Zero) ? null : new OdDbObjectIdArray(pResIdArray, cMemoryOwn: false));
	}

	private int SwigDirectorMethodexplodeToBlock__SWIG_1(IntPtr BlockRecord)
	{
		return (int)explodeToBlock(ODA.Kernel.TD_RootIntegrated.Helpers.GetRXObject<OdDbBlockTableRecord>(BlockRecord, bOwn: false, bTryAddToTransaction: false));
	}
	...
	private void SwigDirectorMethodsetBlockTableRecord(IntPtr objectId)
	{
		try
		{
			setBlockTableRecord(new OdDbObjectId(objectId, cMemoryOwn: true));
		}
		catch (OdEdEmptyInput err)
		{
			TD_DbCoreIntegrated_Globals.throw_native_OdError(err);
	...
	private void SwigDirectorMethodsetPosition(IntPtr position)
	{
		try
		{
			setPosition(new OdGePoint3d(position, cMemoryOwn: true));
		}
		catch (OdEdEmptyInput err)
		{
			TD_DbCoreIntegrated_Globals.throw_native_OdError(err);
	...
	private void SwigDirectorMethodsetScaleFactors(IntPtr scale)
	{
		try
		{
			setScaleFactors(new OdGeScale3d(scale, cMemoryOwn: false));
		}
		catch (OdEdEmptyInput err)
		{
			TD_DbCoreIntegrated_Globals.throw_native_OdError(err);
	...
	private void SwigDirectorMethodsetRotation(double angle)
	{
		try
		{
			setRotation(angle);
	...
	private int SwigDirectorMethodsetBlockTransform(IntPtr xfm)
	{
		return (int)setBlockTransform(new OdGeMatrix3d(xfm, cMemoryOwn: false));
	}

	private bool SwigDirectorMethodtreatAsOdDbBlockRefForExplode()
	{
		return treatAsOdDbBlockRefForExplode();
	}

	private int SwigDirectorMethodexplodeToOwnerSpace()
	{
		return (int)explodeToOwnerSpace();
	}
}
