...
public class OdDbMTextAttributeObjectContextData : OdDbTextObjectContextData
{
	public delegate IntPtr SwigDelegateOdDbMTextAttributeObjectContextData_0(IntPtr protocolClass);

	public delegate IntPtr SwigDelegateOdDbMTextAttributeObjectContextData_1();

	public delegate void SwigDelegateOdDbMTextAttributeObjectContextData_2(IntPtr arg0);

	public delegate int SwigDelegateOdDbMTextAttributeObjectContextData_3();

	public delegate bool SwigDelegateOdDbMTextAttributeObjectContextData_4();

	public delegate IntPtr SwigDelegateOdDbMTextAttributeObjectContextData_5();

	public delegate void SwigDelegateOdDbMTextAttributeObjectContextData_6(IntPtr pNode);

	public delegate IntPtr SwigDelegateOdDbMTextAttributeObjectContextData_7();

	public delegate uint SwigDelegateOdDbMTextAttributeObjectContextData_8(IntPtr vd);

	public delegate uint SwigDelegateOdDbMTextAttributeObjectContextData_9();

	public delegate void SwigDelegateOdDbMTextAttributeObjectContextData_10(IntPtr ownerId);

	public delegate int SwigDelegateOdDbMTextAttributeObjectContextData_11(int mode);

	public delegate void SwigDelegateOdDbMTextAttributeObjectContextData_12();

	public delegate int SwigDelegateOdDbMTextAttributeObjectContextData_13(bool erasing);

	public delegate void SwigDelegateOdDbMTextAttributeObjectContextData_14(IntPtr pNewObject);

	public delegate void SwigDelegateOdDbMTextAttributeObjectContextData_15(IntPtr otherId, bool swapXdata, bool swapExtDict);

	public delegate void SwigDelegateOdDbMTextAttributeObjectContextData_16(IntPtr otherId, bool swapXdata);

	public delegate void SwigDelegateOdDbMTextAttributeObjectContextData_17(IntPtr otherId);

	public delegate void SwigDelegateOdDbMTextAttributeObjectContextData_18(IntPtr pAuditInfo);

	public delegate int SwigDelegateOdDbMTextAttributeObjectContextData_19(IntPtr pFiler);

	public delegate void SwigDelegateOdDbMTextAttributeObjectContextData_20(IntPtr pFiler);

	public delegate int SwigDelegateOdDbMTextAttributeObjectContextData_21(IntPtr pFiler);

	public delegate void SwigDelegateOdDbMTextAttributeObjectContextData_22(IntPtr pFiler);

	public delegate int SwigDelegateOdDbMTextAttributeObjectContextData_23(IntPtr pFiler);

	public delegate void SwigDelegateOdDbMTextAttributeObjectContextData_24(IntPtr pFiler);

	public delegate int SwigDelegateOdDbMTextAttributeObjectContextData_25(IntPtr pFiler);

	public delegate void SwigDelegateOdDbMTextAttributeObjectContextData_26(IntPtr pFiler);

	public delegate int SwigDelegateOdDbMTextAttributeObjectContextData_27();

	public delegate IntPtr SwigDelegateOdDbMTextAttributeObjectContextData_28([MarshalAs(UnmanagedType.LPWStr)] string regappName);

	public delegate void SwigDelegateOdDbMTextAttributeObjectContextData_29(IntPtr pRb);

	public delegate void SwigDelegateOdDbMTextAttributeObjectContextData_30(IntPtr pUndoFiler, IntPtr pClassObj);

	public delegate void SwigDelegateOdDbMTextAttributeObjectContextData_31(IntPtr objId);

	public delegate void SwigDelegateOdDbMTextAttributeObjectContextData_32(IntPtr objId);

	public delegate void SwigDelegateOdDbMTextAttributeObjectContextData_33(IntPtr pSubObj);

	public delegate void SwigDelegateOdDbMTextAttributeObjectContextData_34();

	public delegate void SwigDelegateOdDbMTextAttributeObjectContextData_35(IntPtr idPair, IntPtr pOwnerObject, IntPtr idMap);

	public delegate void SwigDelegateOdDbMTextAttributeObjectContextData_36(IntPtr pObject, IntPtr pNewObject);

	public delegate void SwigDelegateOdDbMTextAttributeObjectContextData_37(IntPtr pObject, bool erasing);

	public delegate void SwigDelegateOdDbMTextAttributeObjectContextData_38(IntPtr pObject);

	public delegate void SwigDelegateOdDbMTextAttributeObjectContextData_39(IntPtr pObject);

	public delegate void SwigDelegateOdDbMTextAttributeObjectContextData_40(IntPtr pObject);

	public delegate void SwigDelegateOdDbMTextAttributeObjectContextData_41(IntPtr pObject);

	public delegate void SwigDelegateOdDbMTextAttributeObjectContextData_42(IntPtr pObject, IntPtr pSubObj);

	public delegate void SwigDelegateOdDbMTextAttributeObjectContextData_43(IntPtr pObject);

	public delegate void SwigDelegateOdDbMTextAttributeObjectContextData_44(IntPtr pObject);

	public delegate void SwigDelegateOdDbMTextAttributeObjectContextData_45(IntPtr pObject);

	public delegate void SwigDelegateOdDbMTextAttributeObjectContextData_46(IntPtr pObject);

	public delegate void SwigDelegateOdDbMTextAttributeObjectContextData_47(IntPtr objectId);

	public delegate void SwigDelegateOdDbMTextAttributeObjectContextData_48(IntPtr pObject);

	public delegate void SwigDelegateOdDbMTextAttributeObjectContextData_49(IntPtr pSource);

	public delegate int SwigDelegateOdDbMTextAttributeObjectContextData_50(IntPtr pFiler, MaintReleaseVer pMaintVer);

	public delegate int SwigDelegateOdDbMTextAttributeObjectContextData_51(IntPtr pFiler);

	public delegate IntPtr SwigDelegateOdDbMTextAttributeObjectContextData_52(int ver, IntPtr replaceId, bool exchangeXData);

	public delegate IntPtr SwigDelegateOdDbMTextAttributeObjectContextData_53(int format, int ver, IntPtr replaceId, bool exchangeXData);

	public delegate void SwigDelegateOdDbMTextAttributeObjectContextData_54(int format, int version, IntPtr pAuditInfo);

	public delegate IntPtr SwigDelegateOdDbMTextAttributeObjectContextData_55();

	public delegate IntPtr SwigDelegateOdDbMTextAttributeObjectContextData_56([MarshalAs(UnmanagedType.LPWStr)] string fieldName, IntPtr pField);

	public delegate int SwigDelegateOdDbMTextAttributeObjectContextData_57(IntPtr fieldId);

	public delegate IntPtr SwigDelegateOdDbMTextAttributeObjectContextData_58([MarshalAs(UnmanagedType.LPWStr)] string fieldName);

	public delegate IntPtr SwigDelegateOdDbMTextAttributeObjectContextData_59(IntPtr pClass);

	public delegate int SwigDelegateOdDbMTextAttributeObjectContextData_60(IntPtr pClsid);

	public delegate int SwigDelegateOdDbMTextAttributeObjectContextData_61(IntPtr arg0);

	public delegate void SwigDelegateOdDbMTextAttributeObjectContextData_62(IntPtr arg0);

	public delegate IntPtr SwigDelegateOdDbMTextAttributeObjectContextData_63();

	public delegate bool SwigDelegateOdDbMTextAttributeObjectContextData_64(IntPtr arg0);

	public delegate void SwigDelegateOdDbMTextAttributeObjectContextData_65(IntPtr arg0);

	public delegate void SwigDelegateOdDbMTextAttributeObjectContextData_66();

	public delegate int SwigDelegateOdDbMTextAttributeObjectContextData_67(double arg0);

	public delegate IntPtr SwigDelegateOdDbMTextAttributeObjectContextData_68();

	public delegate int SwigDelegateOdDbMTextAttributeObjectContextData_69();

	public delegate IntPtr SwigDelegateOdDbMTextAttributeObjectContextData_70();

	public delegate double SwigDelegateOdDbMTextAttributeObjectContextData_71();

	public delegate void SwigDelegateOdDbMTextAttributeObjectContextData_72(IntPtr arg0);

	public delegate void SwigDelegateOdDbMTextAttributeObjectContextData_73(int arg0);

	public delegate void SwigDelegateOdDbMTextAttributeObjectContextData_74(IntPtr arg0);

	public delegate void SwigDelegateOdDbMTextAttributeObjectContextData_75(double arg0);

	public delegate IntPtr SwigDelegateOdDbMTextAttributeObjectContextData_76();

	public delegate void SwigDelegateOdDbMTextAttributeObjectContextData_77(IntPtr arg0);

	private object locker = new object();

	private HandleRef swigCPtr;

	private SwigDelegateOdDbMTextAttributeObjectContextData_0 swigDelegate0;

	private SwigDelegateOdDbMTextAttributeObjectContextData_1 swigDelegate1;

	private SwigDelegateOdDbMTextAttributeObjectContextData_2 swigDelegate2;

	private SwigDelegateOdDbMTextAttributeObjectContextData_3 swigDelegate3;

	private SwigDelegateOdDbMTextAttributeObjectContextData_4 swigDelegate4;

	private SwigDelegateOdDbMTextAttributeObjectContextData_5 swigDelegate5;

	private SwigDelegateOdDbMTextAttributeObjectContextData_6 swigDelegate6;

	private SwigDelegateOdDbMTextAttributeObjectContextData_7 swigDelegate7;

	private SwigDelegateOdDbMTextAttributeObjectContextData_8 swigDelegate8;

	private SwigDelegateOdDbMTextAttributeObjectContextData_9 swigDelegate9;

	private SwigDelegateOdDbMTextAttributeObjectContextData_10 swigDelegate10;

	private SwigDelegateOdDbMTextAttributeObjectContextData_11 swigDelegate11;

	private SwigDelegateOdDbMTextAttributeObjectContextData_12 swigDelegate12;

	private SwigDelegateOdDbMTextAttributeObjectContextData_13 swigDelegate13;

	private SwigDelegateOdDbMTextAttributeObjectContextData_14 swigDelegate14;

	private SwigDelegateOdDbMTextAttributeObjectContextData_15 swigDelegate15;

	private SwigDelegateOdDbMTextAttributeObjectContextData_16 swigDelegate16;

	private SwigDelegateOdDbMTextAttributeObjectContextData_17 swigDelegate17;

	private SwigDelegateOdDbMTextAttributeObjectContextData_18 swigDelegate18;

	private SwigDelegateOdDbMTextAttributeObjectContextData_19 swigDelegate19;

	private SwigDelegateOdDbMTextAttributeObjectContextData_20 swigDelegate20;

	private SwigDelegateOdDbMTextAttributeObjectContextData_21 swigDelegate21;

	private SwigDelegateOdDbMTextAttributeObjectContextData_22 swigDelegate22;

	private SwigDelegateOdDbMTextAttributeObjectContextData_23 swigDelegate23;

	private SwigDelegateOdDbMTextAttributeObjectContextData_24 swigDelegate24;

	private SwigDelegateOdDbMTextAttributeObjectContextData_25 swigDelegate25;

	private SwigDelegateOdDbMTextAttributeObjectContextData_26 swigDelegate26;

	private SwigDelegateOdDbMTextAttributeObjectContextData_27 swigDelegate27;

	private SwigDelegateOdDbMTextAttributeObjectContextData_28 swigDelegate28;

	private SwigDelegateOdDbMTextAttributeObjectContextData_29 swigDelegate29;

	private SwigDelegateOdDbMTextAttributeObjectContextData_30 swigDelegate30;

	private SwigDelegateOdDbMTextAttributeObjectContextData_31 swigDelegate31;

	private SwigDelegateOdDbMTextAttributeObjectContextData_32 swigDelegate32;

	private SwigDelegateOdDbMTextAttributeObjectContextData_33 swigDelegate33;

	private SwigDelegateOdDbMTextAttributeObjectContextData_34 swigDelegate34;

	private SwigDelegateOdDbMTextAttributeObjectContextData_35 swigDelegate35;

	private SwigDelegateOdDbMTextAttributeObjectContextData_36 swigDelegate36;

	private SwigDelegateOdDbMTextAttributeObjectContextData_37 swigDelegate37;

	private SwigDelegateOdDbMTextAttributeObjectContextData_38 swigDelegate38;

	private SwigDelegateOdDbMTextAttributeObjectContextData_39 swigDelegate39;

	private SwigDelegateOdDbMTextAttributeObjectContextData_40 swigDelegate40;

	private SwigDelegateOdDbMTextAttributeObjectContextData_41 swigDelegate41;

	private SwigDelegateOdDbMTextAttributeObjectContextData_42 swigDelegate42;

	private SwigDelegateOdDbMTextAttributeObjectContextData_43 swigDelegate43;

	private SwigDelegateOdDbMTextAttributeObjectContextData_44 swigDelegate44;

	private SwigDelegateOdDbMTextAttributeObjectContextData_45 swigDelegate45;

	private SwigDelegateOdDbMTextAttributeObjectContextData_46 swigDelegate46;

	private SwigDelegateOdDbMTextAttributeObjectContextData_47 swigDelegate47;

	private SwigDelegateOdDbMTextAttributeObjectContextData_48 swigDelegate48;

	private SwigDelegateOdDbMTextAttributeObjectContextData_49 swigDelegate49;

	private SwigDelegateOdDbMTextAttributeObjectContextData_50 swigDelegate50;

	private SwigDelegateOdDbMTextAttributeObjectContextData_51 swigDelegate51;

	private SwigDelegateOdDbMTextAttributeObjectContextData_52 swigDelegate52;

	private SwigDelegateOdDbMTextAttributeObjectContextData_53 swigDelegate53;

	private SwigDelegateOdDbMTextAttributeObjectContextData_54 swigDelegate54;

	private SwigDelegateOdDbMTextAttributeObjectContextData_55 swigDelegate55;

	private SwigDelegateOdDbMTextAttributeObjectContextData_56 swigDelegate56;

	private SwigDelegateOdDbMTextAttributeObjectContextData_57 swigDelegate57;

	private SwigDelegateOdDbMTextAttributeObjectContextData_58 swigDelegate58;

	private SwigDelegateOdDbMTextAttributeObjectContextData_59 swigDelegate59;

	private SwigDelegateOdDbMTextAttributeObjectContextData_60 swigDelegate60;

	private SwigDelegateOdDbMTextAttributeObjectContextData_61 swigDelegate61;

	private SwigDelegateOdDbMTextAttributeObjectContextData_62 swigDelegate62;

	private SwigDelegateOdDbMTextAttributeObjectContextData_63 swigDelegate63;

	private SwigDelegateOdDbMTextAttributeObjectContextData_64 swigDelegate64;

	private SwigDelegateOdDbMTextAttributeObjectContextData_65 swigDelegate65;

	private SwigDelegateOdDbMTextAttributeObjectContextData_66 swigDelegate66;

	private SwigDelegateOdDbMTextAttributeObjectContextData_67 swigDelegate67;

	private SwigDelegateOdDbMTextAttributeObjectContextData_68 swigDelegate68;

	private SwigDelegateOdDbMTextAttributeObjectContextData_69 swigDelegate69;

	private SwigDelegateOdDbMTextAttributeObjectContextData_70 swigDelegate70;

	private SwigDelegateOdDbMTextAttributeObjectContextData_71 swigDelegate71;

	private SwigDelegateOdDbMTextAttributeObjectContextData_72 swigDelegate72;

	private SwigDelegateOdDbMTextAttributeObjectContextData_73 swigDelegate73;

	private SwigDelegateOdDbMTextAttributeObjectContextData_74 swigDelegate74;

	private SwigDelegateOdDbMTextAttributeObjectContextData_75 swigDelegate75;

	private SwigDelegateOdDbMTextAttributeObjectContextData_76 swigDelegate76;

	private SwigDelegateOdDbMTextAttributeObjectContextData_77 swigDelegate77;
	...
	private static Type[] swigMethodTypes72 = new Type[1] { typeof(OdGePoint2d) };

	private static Type[] swigMethodTypes73 = new Type[1] { typeof(OdDb_TextHorzMode) };

	private static Type[] swigMethodTypes74 = new Type[1] { typeof(OdGePoint2d) };

	private static Type[] swigMethodTypes75 = new Type[1] { typeof(double) };

	private static Type[] swigMethodTypes76 = new Type[0];

	private static Type[] swigMethodTypes77 = new Type[1] { typeof(OdDbMTextObjectContextData) };

	[EditorBrowsable(EditorBrowsableState.Never)]
	public OdDbMTextAttributeObjectContextData(IntPtr cPtr, bool cMemoryOwn)
		: base(TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbMTextAttributeObjectContextData_SWIGUpcast(cPtr), cMemoryOwn)
	{
		swigCPtr = new HandleRef(this, cPtr);
	}

	[EditorBrowsable(EditorBrowsableState.Never)]
	public static HandleRef getCPtr(OdDbMTextAttributeObjectContextData obj)
	{
	...
	protected override void Dispose(bool disposing)
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					TD_DbCoreIntegrated_GlobalsPINVOKE.delete_OdDbMTextAttributeObjectContextData(swigCPtr);
				}
	...
	public new static OdDbMTextAttributeObjectContextData cast(OdRxObject pObj)
	{
		OdDbMTextAttributeObjectContextData rXObject = ODA.Kernel.TD_RootIntegrated.Helpers.GetRXObject<OdDbMTextAttributeObjectContextData>(TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbMTextAttributeObjectContextData_cast(OdRxObject.getCPtr(pObj)), bOwn: true, bTryAddToTransaction: true);
	...
	{
		OdRxClass rXObject = ODA.Kernel.TD_RootIntegrated.Helpers.GetRXObject<OdRxClass>(TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbMTextAttributeObjectContextData_desc(), bOwn: false, bTryAddToTransaction: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		OdRxClass rXObject = ODA.Kernel.TD_RootIntegrated.Helpers.GetRXObject<OdRxClass>(SwigDerivedClassHasMethod("isA", swigMethodTypes1) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbMTextAttributeObjectContextData_isASwigExplicitOdDbMTextAttributeObjectContextData(swigCPtr) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbMTextAttributeObjectContextData_isA(swigCPtr), bOwn: false, bTryAddToTransaction: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		OdRxObject rXObject = ODA.Kernel.TD_RootIntegrated.Helpers.GetRXObject<OdRxObject>(SwigDerivedClassHasMethod("queryX", swigMethodTypes0) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbMTextAttributeObjectContextData_queryXSwigExplicitOdDbMTextAttributeObjectContextData(swigCPtr, OdRxClass.getCPtr(protocolClass)) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbMTextAttributeObjectContextData_queryX(swigCPtr, OdRxClass.getCPtr(protocolClass)), bOwn: false, bTryAddToTransaction: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public override void setContext(OdDbObjectContext arg0)
	{
		if (SwigDerivedClassHasMethod("setContext", swigMethodTypes65))
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbMTextAttributeObjectContextData_setContextSwigExplicitOdDbMTextAttributeObjectContextData(swigCPtr, OdDbObjectContext.getCPtr(arg0));
		}
		else
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbMTextAttributeObjectContextData_setContext(swigCPtr, OdDbObjectContext.getCPtr(arg0));
		}
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
	...
	public virtual OdDbMTextObjectContextData getMTextObjectContextData()
	{
		OdDbMTextObjectContextData rXObject = ODA.Kernel.TD_RootIntegrated.Helpers.GetRXObject<OdDbMTextObjectContextData>(SwigDerivedClassHasMethod("getMTextObjectContextData", swigMethodTypes76) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbMTextAttributeObjectContextData_getMTextObjectContextDataSwigExplicitOdDbMTextAttributeObjectContextData(swigCPtr) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbMTextAttributeObjectContextData_getMTextObjectContextData(swigCPtr), bOwn: true, bTryAddToTransaction: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public virtual void setMTextObjectContextData(OdDbMTextObjectContextData arg0)
	{
		if (SwigDerivedClassHasMethod("setMTextObjectContextData", swigMethodTypes77))
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbMTextAttributeObjectContextData_setMTextObjectContextDataSwigExplicitOdDbMTextAttributeObjectContextData(swigCPtr, OdDbMTextObjectContextData.getCPtr(arg0));
		}
		else
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbMTextAttributeObjectContextData_setMTextObjectContextData(swigCPtr, OdDbMTextObjectContextData.getCPtr(arg0));
		}
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
	...
	public override void copyFrom(OdRxObject arg0)
	{
		...
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbMTextAttributeObjectContextData_copyFromSwigExplicitOdDbMTextAttributeObjectContextData(swigCPtr, OdRxObject.getCPtr(arg0));
		}
		else
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbMTextAttributeObjectContextData_copyFrom(swigCPtr, OdRxObject.getCPtr(arg0));
		}
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
	...
	{
		int result = (SwigDerivedClassHasMethod("dxfInFields", swigMethodTypes23) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbMTextAttributeObjectContextData_dxfInFieldsSwigExplicitOdDbMTextAttributeObjectContextData(swigCPtr, OdDbDxfFiler.getCPtr(pFiler)) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbMTextAttributeObjectContextData_dxfInFields(swigCPtr, OdDbDxfFiler.getCPtr(pFiler)));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public override void dxfOutFields(OdDbDxfFiler pFiler)
	{
		...
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbMTextAttributeObjectContextData_dxfOutFieldsSwigExplicitOdDbMTextAttributeObjectContextData(swigCPtr, OdDbDxfFiler.getCPtr(pFiler));
		}
		else
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbMTextAttributeObjectContextData_dxfOutFields(swigCPtr, OdDbDxfFiler.getCPtr(pFiler));
		}
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
	...
	{
		string result = TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbMTextAttributeObjectContextData_getRealClassName(ptr);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public new static OdDbMTextAttributeObjectContextData createObject()
	{
		OdDbMTextAttributeObjectContextData rXObject = ODA.Kernel.TD_RootIntegrated.Helpers.GetRXObject<OdDbMTextAttributeObjectContextData>(TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbMTextAttributeObjectContextData_createObject(), bOwn: true, bTryAddToTransaction: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	private void SwigDirectorConnect()
	{
		...
		if (SwigDerivedClassHasMethod("alignmentPointInEcs", swigMethodTypes68))
		{
			swigDelegate68 = SwigDirectorMethodalignmentPointInEcs;
		}
		if (SwigDerivedClassHasMethod("horizontalMode", swigMethodTypes69))
		{
			swigDelegate69 = SwigDirectorMethodhorizontalMode;
		}
		if (SwigDerivedClassHasMethod("positionInEcs", swigMethodTypes70))
		{
			swigDelegate70 = SwigDirectorMethodpositionInEcs;
		}
		if (SwigDerivedClassHasMethod("rotation", swigMethodTypes71))
		{
			swigDelegate71 = SwigDirectorMethodrotation;
		}
		if (SwigDerivedClassHasMethod("setAlignmentPointInEcs", swigMethodTypes72))
		{
			swigDelegate72 = SwigDirectorMethodsetAlignmentPointInEcs;
		}
		if (SwigDerivedClassHasMethod("setHorizontalMode", swigMethodTypes73))
		{
			swigDelegate73 = SwigDirectorMethodsetHorizontalMode;
		}
		if (SwigDerivedClassHasMethod("setPositionInEcs", swigMethodTypes74))
		{
			swigDelegate74 = SwigDirectorMethodsetPositionInEcs;
		}
		if (SwigDerivedClassHasMethod("setRotation", swigMethodTypes75))
		{
			swigDelegate75 = SwigDirectorMethodsetRotation;
		}
		if (SwigDerivedClassHasMethod("getMTextObjectContextData", swigMethodTypes76))
		{
			swigDelegate76 = SwigDirectorMethodgetMTextObjectContextData;
		}
		if (SwigDerivedClassHasMethod("setMTextObjectContextData", swigMethodTypes77))
		{
			swigDelegate77 = SwigDirectorMethodsetMTextObjectContextData;
		}
		TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbMTextAttributeObjectContextData_director_connect(swigCPtr, swigDelegate0, swigDelegate1, swigDelegate2, swigDelegate3, swigDelegate4, swigDelegate5, swigDelegate6, swigDelegate7, swigDelegate8, swigDelegate9, swigDelegate10, swigDelegate11, swigDelegate12, swigDelegate13, swigDelegate14, swigDelegate15, swigDelegate16, swigDelegate17, swigDelegate18, swigDelegate19, swigDelegate20, swigDelegate21, swigDelegate22, swigDelegate23, swigDelegate24, swigDelegate25, swigDelegate26, swigDelegate27, swigDelegate28, swigDelegate29, swigDelegate30, swigDelegate31, swigDelegate32, swigDelegate33, swigDelegate34, swigDelegate35, swigDelegate36, swigDelegate37, swigDelegate38, swigDelegate39, swigDelegate40, swigDelegate41, swigDelegate42, swigDelegate43, swigDelegate44, swigDelegate45, swigDelegate46, swigDelegate47, swigDelegate48, swigDelegate49, swigDelegate50, swigDelegate51, swigDelegate52, swigDelegate53, swigDelegate54, swigDelegate55, swigDelegate56, swigDelegate57, swigDelegate58, swigDelegate59, swigDelegate60, swigDelegate61, swigDelegate62, swigDelegate63, swigDelegate64, swigDelegate65, swigDelegate66, swigDelegate67, swigDelegate68, swigDelegate69, swigDelegate70, swigDelegate71, swigDelegate72, swigDelegate73, swigDelegate74, swigDelegate75, swigDelegate76, swigDelegate77);
	}

	private bool SwigDerivedClassHasMethod(string methodName, Type[] methodTypes)
	{
		return GetType().GetMethod(methodName, BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic, null, methodTypes, null).DeclaringType.IsSubclassOf(typeof(OdDbMTextAttributeObjectContextData));
	}
	...
	private IntPtr SwigDirectorMethodalignmentPointInEcs()
	{
		return ((Func<IntPtr>)delegate
		{
			try
			{
				return OdGePoint2d.getCPtr(alignmentPointInEcs()).Handle;
			}
			catch (OdEdEmptyInput odEdEmptyInput)
			{
				TD_DbCoreIntegrated_Globals.throw_native_OdError(odEdEmptyInput);
	...
	private int SwigDirectorMethodhorizontalMode()
	{
		return (int)horizontalMode();
	}

	private IntPtr SwigDirectorMethodpositionInEcs()
	{
		return ((Func<IntPtr>)delegate
		{
			try
			{
				return OdGePoint2d.getCPtr(positionInEcs()).Handle;
			}
			catch (OdEdEmptyInput odEdEmptyInput)
			{
				TD_DbCoreIntegrated_Globals.throw_native_OdError(odEdEmptyInput);
	...
	private void SwigDirectorMethodsetAlignmentPointInEcs(IntPtr arg0)
	{
		try
		{
			setAlignmentPointInEcs(new OdGePoint2d(arg0, cMemoryOwn: false));
		}
		catch (OdEdEmptyInput err)
		{
			TD_DbCoreIntegrated_Globals.throw_native_OdError(err);
	...
	private void SwigDirectorMethodsetHorizontalMode(int arg0)
	{
		try
		{
			setHorizontalMode((OdDb_TextHorzMode)arg0);
		}
		catch (OdEdEmptyInput err)
		{
			TD_DbCoreIntegrated_Globals.throw_native_OdError(err);
	...
	private void SwigDirectorMethodsetPositionInEcs(IntPtr arg0)
	{
		try
		{
			setPositionInEcs(new OdGePoint2d(arg0, cMemoryOwn: false));
		}
		catch (OdEdEmptyInput err)
		{
			TD_DbCoreIntegrated_Globals.throw_native_OdError(err);
	...
	private void SwigDirectorMethodsetRotation(double arg0)
	{
		try
		{
			setRotation(arg0);
	...
	private IntPtr SwigDirectorMethodgetMTextObjectContextData()
	{
		return OdDbMTextObjectContextData.getCPtr(getMTextObjectContextData()).Handle;
	}

	private void SwigDirectorMethodsetMTextObjectContextData(IntPtr arg0)
	{
		try
		{
			setMTextObjectContextData(ODA.Kernel.TD_RootIntegrated.Helpers.GetRXObject<OdDbMTextObjectContextData>(arg0, bOwn: false, bTryAddToTransaction: false));
		}
		catch (OdEdEmptyInput err)
		{
			TD_DbCoreIntegrated_Globals.throw_native_OdError(err);
