...
public class OdDbSpatialIndex : OdDbIndex
{
	public delegate IntPtr SwigDelegateOdDbSpatialIndex_0(IntPtr protocolClass);

	public delegate IntPtr SwigDelegateOdDbSpatialIndex_1();

	public delegate void SwigDelegateOdDbSpatialIndex_2(IntPtr pSource);

	public delegate int SwigDelegateOdDbSpatialIndex_3();

	public delegate bool SwigDelegateOdDbSpatialIndex_4();

	public delegate IntPtr SwigDelegateOdDbSpatialIndex_5();

	public delegate void SwigDelegateOdDbSpatialIndex_6(IntPtr pNode);

	public delegate IntPtr SwigDelegateOdDbSpatialIndex_7();

	public delegate uint SwigDelegateOdDbSpatialIndex_8(IntPtr vd);

	public delegate uint SwigDelegateOdDbSpatialIndex_9();

	public delegate void SwigDelegateOdDbSpatialIndex_10(IntPtr ownerId);

	public delegate int SwigDelegateOdDbSpatialIndex_11(int mode);

	public delegate void SwigDelegateOdDbSpatialIndex_12();

	public delegate int SwigDelegateOdDbSpatialIndex_13(bool erasing);

	public delegate void SwigDelegateOdDbSpatialIndex_14(IntPtr pNewObject);

	public delegate void SwigDelegateOdDbSpatialIndex_15(IntPtr otherId, bool swapXdata, bool swapExtDict);

	public delegate void SwigDelegateOdDbSpatialIndex_16(IntPtr otherId, bool swapXdata);

	public delegate void SwigDelegateOdDbSpatialIndex_17(IntPtr otherId);

	public delegate void SwigDelegateOdDbSpatialIndex_18(IntPtr pAuditInfo);

	public delegate int SwigDelegateOdDbSpatialIndex_19(IntPtr pFiler);

	public delegate void SwigDelegateOdDbSpatialIndex_20(IntPtr pFiler);

	public delegate int SwigDelegateOdDbSpatialIndex_21(IntPtr pFiler);

	public delegate void SwigDelegateOdDbSpatialIndex_22(IntPtr pFiler);

	public delegate int SwigDelegateOdDbSpatialIndex_23(IntPtr pFiler);

	public delegate void SwigDelegateOdDbSpatialIndex_24(IntPtr pFiler);

	public delegate int SwigDelegateOdDbSpatialIndex_25(IntPtr pFiler);

	public delegate void SwigDelegateOdDbSpatialIndex_26(IntPtr pFiler);

	public delegate int SwigDelegateOdDbSpatialIndex_27();

	public delegate IntPtr SwigDelegateOdDbSpatialIndex_28([MarshalAs(UnmanagedType.LPWStr)] string regappName);

	public delegate void SwigDelegateOdDbSpatialIndex_29(IntPtr pRb);

	public delegate void SwigDelegateOdDbSpatialIndex_30(IntPtr pUndoFiler, IntPtr pClassObj);

	public delegate void SwigDelegateOdDbSpatialIndex_31(IntPtr objId);

	public delegate void SwigDelegateOdDbSpatialIndex_32(IntPtr objId);

	public delegate void SwigDelegateOdDbSpatialIndex_33(IntPtr pSubObj);

	public delegate void SwigDelegateOdDbSpatialIndex_34();

	public delegate void SwigDelegateOdDbSpatialIndex_35(IntPtr idPair, IntPtr pOwnerObject, IntPtr idMap);

	public delegate void SwigDelegateOdDbSpatialIndex_36(IntPtr pObject, IntPtr pNewObject);

	public delegate void SwigDelegateOdDbSpatialIndex_37(IntPtr pObject, bool erasing);

	public delegate void SwigDelegateOdDbSpatialIndex_38(IntPtr pObject);

	public delegate void SwigDelegateOdDbSpatialIndex_39(IntPtr pObject);

	public delegate void SwigDelegateOdDbSpatialIndex_40(IntPtr pObject);

	public delegate void SwigDelegateOdDbSpatialIndex_41(IntPtr pObject);

	public delegate void SwigDelegateOdDbSpatialIndex_42(IntPtr pObject, IntPtr pSubObj);

	public delegate void SwigDelegateOdDbSpatialIndex_43(IntPtr pObject);

	public delegate void SwigDelegateOdDbSpatialIndex_44(IntPtr pObject);

	public delegate void SwigDelegateOdDbSpatialIndex_45(IntPtr pObject);

	public delegate void SwigDelegateOdDbSpatialIndex_46(IntPtr pObject);

	public delegate void SwigDelegateOdDbSpatialIndex_47(IntPtr objectId);

	public delegate void SwigDelegateOdDbSpatialIndex_48(IntPtr pObject);

	public delegate void SwigDelegateOdDbSpatialIndex_49(IntPtr pSource);

	public delegate int SwigDelegateOdDbSpatialIndex_50(IntPtr pFiler, MaintReleaseVer pMaintVer);

	public delegate int SwigDelegateOdDbSpatialIndex_51(IntPtr pFiler);

	public delegate IntPtr SwigDelegateOdDbSpatialIndex_52(int ver, IntPtr replaceId, bool exchangeXData);

	public delegate IntPtr SwigDelegateOdDbSpatialIndex_53(int format, int ver, IntPtr replaceId, bool exchangeXData);

	public delegate void SwigDelegateOdDbSpatialIndex_54(int format, int version, IntPtr pAuditInfo);

	public delegate IntPtr SwigDelegateOdDbSpatialIndex_55();

	public delegate IntPtr SwigDelegateOdDbSpatialIndex_56([MarshalAs(UnmanagedType.LPWStr)] string fieldName, IntPtr pField);

	public delegate int SwigDelegateOdDbSpatialIndex_57(IntPtr fieldId);

	public delegate IntPtr SwigDelegateOdDbSpatialIndex_58([MarshalAs(UnmanagedType.LPWStr)] string fieldName);

	public delegate IntPtr SwigDelegateOdDbSpatialIndex_59(IntPtr pClass);

	public delegate int SwigDelegateOdDbSpatialIndex_60(IntPtr pClsid);

	public delegate IntPtr SwigDelegateOdDbSpatialIndex_61(IntPtr pFilter);

	public delegate void SwigDelegateOdDbSpatialIndex_62(IntPtr pIdxData);

	public delegate void SwigDelegateOdDbSpatialIndex_63(IntPtr iterator);

	private object locker = new object();

	private HandleRef swigCPtr;

	private SwigDelegateOdDbSpatialIndex_0 swigDelegate0;

	private SwigDelegateOdDbSpatialIndex_1 swigDelegate1;

	private SwigDelegateOdDbSpatialIndex_2 swigDelegate2;

	private SwigDelegateOdDbSpatialIndex_3 swigDelegate3;

	private SwigDelegateOdDbSpatialIndex_4 swigDelegate4;

	private SwigDelegateOdDbSpatialIndex_5 swigDelegate5;

	private SwigDelegateOdDbSpatialIndex_6 swigDelegate6;

	private SwigDelegateOdDbSpatialIndex_7 swigDelegate7;

	private SwigDelegateOdDbSpatialIndex_8 swigDelegate8;

	private SwigDelegateOdDbSpatialIndex_9 swigDelegate9;

	private SwigDelegateOdDbSpatialIndex_10 swigDelegate10;

	private SwigDelegateOdDbSpatialIndex_11 swigDelegate11;

	private SwigDelegateOdDbSpatialIndex_12 swigDelegate12;

	private SwigDelegateOdDbSpatialIndex_13 swigDelegate13;

	private SwigDelegateOdDbSpatialIndex_14 swigDelegate14;

	private SwigDelegateOdDbSpatialIndex_15 swigDelegate15;

	private SwigDelegateOdDbSpatialIndex_16 swigDelegate16;

	private SwigDelegateOdDbSpatialIndex_17 swigDelegate17;

	private SwigDelegateOdDbSpatialIndex_18 swigDelegate18;

	private SwigDelegateOdDbSpatialIndex_19 swigDelegate19;

	private SwigDelegateOdDbSpatialIndex_20 swigDelegate20;

	private SwigDelegateOdDbSpatialIndex_21 swigDelegate21;

	private SwigDelegateOdDbSpatialIndex_22 swigDelegate22;

	private SwigDelegateOdDbSpatialIndex_23 swigDelegate23;

	private SwigDelegateOdDbSpatialIndex_24 swigDelegate24;

	private SwigDelegateOdDbSpatialIndex_25 swigDelegate25;

	private SwigDelegateOdDbSpatialIndex_26 swigDelegate26;

	private SwigDelegateOdDbSpatialIndex_27 swigDelegate27;

	private SwigDelegateOdDbSpatialIndex_28 swigDelegate28;

	private SwigDelegateOdDbSpatialIndex_29 swigDelegate29;

	private SwigDelegateOdDbSpatialIndex_30 swigDelegate30;

	private SwigDelegateOdDbSpatialIndex_31 swigDelegate31;

	private SwigDelegateOdDbSpatialIndex_32 swigDelegate32;

	private SwigDelegateOdDbSpatialIndex_33 swigDelegate33;

	private SwigDelegateOdDbSpatialIndex_34 swigDelegate34;

	private SwigDelegateOdDbSpatialIndex_35 swigDelegate35;

	private SwigDelegateOdDbSpatialIndex_36 swigDelegate36;

	private SwigDelegateOdDbSpatialIndex_37 swigDelegate37;

	private SwigDelegateOdDbSpatialIndex_38 swigDelegate38;

	private SwigDelegateOdDbSpatialIndex_39 swigDelegate39;

	private SwigDelegateOdDbSpatialIndex_40 swigDelegate40;

	private SwigDelegateOdDbSpatialIndex_41 swigDelegate41;

	private SwigDelegateOdDbSpatialIndex_42 swigDelegate42;

	private SwigDelegateOdDbSpatialIndex_43 swigDelegate43;

	private SwigDelegateOdDbSpatialIndex_44 swigDelegate44;

	private SwigDelegateOdDbSpatialIndex_45 swigDelegate45;

	private SwigDelegateOdDbSpatialIndex_46 swigDelegate46;

	private SwigDelegateOdDbSpatialIndex_47 swigDelegate47;

	private SwigDelegateOdDbSpatialIndex_48 swigDelegate48;

	private SwigDelegateOdDbSpatialIndex_49 swigDelegate49;

	private SwigDelegateOdDbSpatialIndex_50 swigDelegate50;

	private SwigDelegateOdDbSpatialIndex_51 swigDelegate51;

	private SwigDelegateOdDbSpatialIndex_52 swigDelegate52;

	private SwigDelegateOdDbSpatialIndex_53 swigDelegate53;

	private SwigDelegateOdDbSpatialIndex_54 swigDelegate54;

	private SwigDelegateOdDbSpatialIndex_55 swigDelegate55;

	private SwigDelegateOdDbSpatialIndex_56 swigDelegate56;

	private SwigDelegateOdDbSpatialIndex_57 swigDelegate57;

	private SwigDelegateOdDbSpatialIndex_58 swigDelegate58;

	private SwigDelegateOdDbSpatialIndex_59 swigDelegate59;

	private SwigDelegateOdDbSpatialIndex_60 swigDelegate60;

	private SwigDelegateOdDbSpatialIndex_61 swigDelegate61;

	private SwigDelegateOdDbSpatialIndex_62 swigDelegate62;

	private SwigDelegateOdDbSpatialIndex_63 swigDelegate63;
	...
	private static Type[] swigMethodTypes61 = new Type[1] { typeof(OdDbFilter) };

	private static Type[] swigMethodTypes62 = new Type[1] { typeof(OdDbIndexUpdateData) };

	private static Type[] swigMethodTypes63 = new Type[1] { typeof(OdDbBlockChangeIterator) };

	[EditorBrowsable(EditorBrowsableState.Never)]
	public OdDbSpatialIndex(IntPtr cPtr, bool cMemoryOwn)
		: base(TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbSpatialIndex_SWIGUpcast(cPtr), cMemoryOwn)
	{
		swigCPtr = new HandleRef(this, cPtr);
	}

	[EditorBrowsable(EditorBrowsableState.Never)]
	public static HandleRef getCPtr(OdDbSpatialIndex obj)
	{
	...
	protected override void Dispose(bool disposing)
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					TD_DbCoreIntegrated_GlobalsPINVOKE.delete_OdDbSpatialIndex(swigCPtr);
				}
	...
	public new static OdDbSpatialIndex cast(OdRxObject pObj)
	{
		OdDbSpatialIndex rXObject = ODA.Kernel.TD_RootIntegrated.Helpers.GetRXObject<OdDbSpatialIndex>(TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbSpatialIndex_cast(OdRxObject.getCPtr(pObj)), bOwn: true, bTryAddToTransaction: true);
	...
	{
		OdRxClass rXObject = ODA.Kernel.TD_RootIntegrated.Helpers.GetRXObject<OdRxClass>(TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbSpatialIndex_desc(), bOwn: false, bTryAddToTransaction: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		OdRxClass rXObject = ODA.Kernel.TD_RootIntegrated.Helpers.GetRXObject<OdRxClass>(SwigDerivedClassHasMethod("isA", swigMethodTypes1) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbSpatialIndex_isASwigExplicitOdDbSpatialIndex(swigCPtr) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbSpatialIndex_isA(swigCPtr), bOwn: false, bTryAddToTransaction: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		OdRxObject rXObject = ODA.Kernel.TD_RootIntegrated.Helpers.GetRXObject<OdRxObject>(SwigDerivedClassHasMethod("queryX", swigMethodTypes0) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbSpatialIndex_queryXSwigExplicitOdDbSpatialIndex(swigCPtr, OdRxClass.getCPtr(protocolClass)) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbSpatialIndex_queryX(swigCPtr, OdRxClass.getCPtr(protocolClass)), bOwn: false, bTryAddToTransaction: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public override OdDbFilteredBlockIterator newIterator(OdDbFilter pFilter)
	{
		OdDbFilteredBlockIterator rXObject = ODA.Kernel.TD_RootIntegrated.Helpers.GetRXObject<OdDbFilteredBlockIterator>(SwigDerivedClassHasMethod("newIterator", swigMethodTypes61) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbSpatialIndex_newIteratorSwigExplicitOdDbSpatialIndex(swigCPtr, OdDbFilter.getCPtr(pFilter)) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbSpatialIndex_newIterator(swigCPtr, OdDbFilter.getCPtr(pFilter)), bOwn: true, bTryAddToTransaction: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public override void rebuildFull(OdDbIndexUpdateData pIdxData)
	{
		if (SwigDerivedClassHasMethod("rebuildFull", swigMethodTypes62))
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbSpatialIndex_rebuildFullSwigExplicitOdDbSpatialIndex(swigCPtr, OdDbIndexUpdateData.getCPtr(pIdxData));
		}
		else
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbSpatialIndex_rebuildFull(swigCPtr, OdDbIndexUpdateData.getCPtr(pIdxData));
		}
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
	...
	{
		int result = (SwigDerivedClassHasMethod("dwgInFields", swigMethodTypes21) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbSpatialIndex_dwgInFieldsSwigExplicitOdDbSpatialIndex(swigCPtr, OdDbDwgFiler.getCPtr(pFiler)) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbSpatialIndex_dwgInFields(swigCPtr, OdDbDwgFiler.getCPtr(pFiler)));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public override void dwgOutFields(OdDbDwgFiler pFiler)
	{
		...
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbSpatialIndex_dwgOutFieldsSwigExplicitOdDbSpatialIndex(swigCPtr, OdDbDwgFiler.getCPtr(pFiler));
		}
		else
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbSpatialIndex_dwgOutFields(swigCPtr, OdDbDwgFiler.getCPtr(pFiler));
		}
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
	...
	{
		int result = (SwigDerivedClassHasMethod("dxfInFields", swigMethodTypes23) ? TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbSpatialIndex_dxfInFieldsSwigExplicitOdDbSpatialIndex(swigCPtr, OdDbDxfFiler.getCPtr(pFiler)) : TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbSpatialIndex_dxfInFields(swigCPtr, OdDbDxfFiler.getCPtr(pFiler)));
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public override void dxfOutFields(OdDbDxfFiler pFiler)
	{
		...
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbSpatialIndex_dxfOutFieldsSwigExplicitOdDbSpatialIndex(swigCPtr, OdDbDxfFiler.getCPtr(pFiler));
		}
		else
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbSpatialIndex_dxfOutFields(swigCPtr, OdDbDxfFiler.getCPtr(pFiler));
		}
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
	...
	protected override void rebuildModified(OdDbBlockChangeIterator iterator)
	{
		if (SwigDerivedClassHasMethod("rebuildModified", swigMethodTypes63))
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbSpatialIndex_rebuildModifiedSwigExplicitOdDbSpatialIndex(swigCPtr, OdDbBlockChangeIterator.getCPtr(iterator));
		}
		else
		{
			TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbSpatialIndex_rebuildModified(swigCPtr, OdDbBlockChangeIterator.getCPtr(iterator));
		}
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
	...
	{
		string result = TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbSpatialIndex_getRealClassName(ptr);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public new static OdDbSpatialIndex createObject()
	{
		OdDbSpatialIndex rXObject = ODA.Kernel.TD_RootIntegrated.Helpers.GetRXObject<OdDbSpatialIndex>(TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbSpatialIndex_createObject(), bOwn: true, bTryAddToTransaction: true);
		if (TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Pending)
		{
			throw TD_DbCoreIntegrated_GlobalsPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	private void SwigDirectorConnect()
	{
		...
		if (SwigDerivedClassHasMethod("newIterator", swigMethodTypes61))
		{
			swigDelegate61 = SwigDirectorMethodnewIterator;
		}
		if (SwigDerivedClassHasMethod("rebuildFull", swigMethodTypes62))
		{
			swigDelegate62 = SwigDirectorMethodrebuildFull;
		}
		if (SwigDerivedClassHasMethod("rebuildModified", swigMethodTypes63))
		{
			swigDelegate63 = SwigDirectorMethodrebuildModified;
		}
		TD_DbCoreIntegrated_GlobalsPINVOKE.OdDbSpatialIndex_director_connect(swigCPtr, swigDelegate0, swigDelegate1, swigDelegate2, swigDelegate3, swigDelegate4, swigDelegate5, swigDelegate6, swigDelegate7, swigDelegate8, swigDelegate9, swigDelegate10, swigDelegate11, swigDelegate12, swigDelegate13, swigDelegate14, swigDelegate15, swigDelegate16, swigDelegate17, swigDelegate18, swigDelegate19, swigDelegate20, swigDelegate21, swigDelegate22, swigDelegate23, swigDelegate24, swigDelegate25, swigDelegate26, swigDelegate27, swigDelegate28, swigDelegate29, swigDelegate30, swigDelegate31, swigDelegate32, swigDelegate33, swigDelegate34, swigDelegate35, swigDelegate36, swigDelegate37, swigDelegate38, swigDelegate39, swigDelegate40, swigDelegate41, swigDelegate42, swigDelegate43, swigDelegate44, swigDelegate45, swigDelegate46, swigDelegate47, swigDelegate48, swigDelegate49, swigDelegate50, swigDelegate51, swigDelegate52, swigDelegate53, swigDelegate54, swigDelegate55, swigDelegate56, swigDelegate57, swigDelegate58, swigDelegate59, swigDelegate60, swigDelegate61, swigDelegate62, swigDelegate63);
	}

	private bool SwigDerivedClassHasMethod(string methodName, Type[] methodTypes)
	{
		return GetType().GetMethod(methodName, BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic, null, methodTypes, null).DeclaringType.IsSubclassOf(typeof(OdDbSpatialIndex));
	}
	...
	private IntPtr SwigDirectorMethodnewIterator(IntPtr pFilter)
	{
		return OdDbFilteredBlockIterator.getCPtr(newIterator(ODA.Kernel.TD_RootIntegrated.Helpers.GetRXObject<OdDbFilter>(pFilter, bOwn: false, bTryAddToTransaction: false))).Handle;
	}

	private void SwigDirectorMethodrebuildFull(IntPtr pIdxData)
	{
		try
		{
			rebuildFull((pIdxData == IntPtr.Zero) ? null : new OdDbIndexUpdateData(pIdxData, cMemoryOwn: false));
		}
		catch (OdEdEmptyInput err)
		{
			TD_DbCoreIntegrated_Globals.throw_native_OdError(err);
	...
	private void SwigDirectorMethodrebuildModified(IntPtr iterator)
	{
		try
		{
			rebuildModified((iterator == IntPtr.Zero) ? null : new OdDbBlockChangeIterator(iterator, cMemoryOwn: false));
		}
		catch (OdEdEmptyInput err)
		{
			TD_DbCoreIntegrated_Globals.throw_native_OdError(err);
