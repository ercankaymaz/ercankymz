...
public static class ProductVersionInfo
{
	...
	public const string Producer = "PDFsharp 1.50.4740 (www.pdfsharp.com)";

	public const string Producer2 = "PDFsharp 1.50.4740.0 (www.pdfsharp.com)";

	public const string Version = "1.50.4740.0";

	public const string Version2 = "1.50.4740.0";
	...
	public const string VersionBuild = "4740";

	public const string VersionPatch = "0";

	public const string VersionPrerelease = "beta5";
