...
public class F_MultiCutInch : Form
{
	...
	{
		Class76.smethod_584(this);
		textBox_1.Click += textBox_0_Click;
		spn_itemcount1.Click += textBox_0_Click;
		spn_itemcount2.Click += textBox_0_Click;
		spn_itemcount3.Click += textBox_0_Click;
		spn_itemcount4.Click += textBox_0_Click;
		spn_itemcount5.Click += textBox_0_Click;
		spn_itemEA1.Click += textBox_0_Click;
		spn_itemEA2.Click += textBox_0_Click;
		spn_itemEA3.Click += textBox_0_Click;
		spn_itemEA4.Click += textBox_0_Click;
		spn_itemEA5.Click += textBox_0_Click;
		buTextBox_0.Click += textBox_0_Click;
		buTextBox_4.Click += textBox_0_Click;
		buTextBox_3.Click += textBox_0_Click;
		buTextBox_2.Click += textBox_0_Click;
		buTextBox_1.Click += textBox_0_Click;
		spn_itemSA1.Click += textBox_0_Click;
		spn_itemSA2.Click += textBox_0_Click;
		spn_itemSA3.Click += textBox_0_Click;
		spn_itemSA4.Click += textBox_0_Click;
		spn_itemSA5.Click += textBox_0_Click;
