...
public class F_PerpendicularCut : Form
{
	...
	{
		Class76.smethod_187(this);
		spn_depth.Click += spn_lengthver_Click;
		spn_itemcount1_hor.Click += spn_lengthver_Click;
		spn_itemcount2_hor.Click += spn_lengthver_Click;
		spn_itemcount3_hor.Click += spn_lengthver_Click;
		spn_itemcount4_hor.Click += spn_lengthver_Click;
		spn_itemcount5_hor.Click += spn_lengthver_Click;
		spn_itemcount1_ver.Click += spn_lengthver_Click;
		spn_itemcount2_ver.Click += spn_lengthver_Click;
		spn_itemcount3_ver.Click += spn_lengthver_Click;
		spn_itemcount4_ver.Click += spn_lengthver_Click;
		spn_itemcount5_ver.Click += spn_lengthver_Click;
		spn_itemEA1_hor.Click += spn_lengthver_Click;
		spn_itemEA2_hor.Click += spn_lengthver_Click;
		spn_itemEA3_hor.Click += spn_lengthver_Click;
		spn_itemEA4_hor.Click += spn_lengthver_Click;
		spn_itemEA5_hor.Click += spn_lengthver_Click;
		spn_itemEA1_ver.Click += spn_lengthver_Click;
		spn_itemEA2_ver.Click += spn_lengthver_Click;
		spn_itemEA3_ver.Click += spn_lengthver_Click;
		spn_itemEA4_ver.Click += spn_lengthver_Click;
		spn_itemEA5_ver.Click += spn_lengthver_Click;
		spn_itemlen1_hor.Click += spn_lengthver_Click;
		spn_itemlen2_hor.Click += spn_lengthver_Click;
		spn_itemlen3_hor.Click += spn_lengthver_Click;
		spn_itemlen4_hor.Click += spn_lengthver_Click;
		spn_itemlen5_hor.Click += spn_lengthver_Click;
		spn_itemlen1_ver.Click += spn_lengthver_Click;
		spn_itemlen2_ver.Click += spn_lengthver_Click;
		spn_itemlen3_ver.Click += spn_lengthver_Click;
		spn_itemlen4_ver.Click += spn_lengthver_Click;
		spn_itemlen5_ver.Click += spn_lengthver_Click;
		spn_itemSA1_hor.Click += spn_lengthver_Click;
		spn_itemSA2_hor.Click += spn_lengthver_Click;
		spn_itemSA3_hor.Click += spn_lengthver_Click;
		spn_itemSA4_hor.Click += spn_lengthver_Click;
		spn_itemSA5_hor.Click += spn_lengthver_Click;
		spn_itemSA1_ver.Click += spn_lengthver_Click;
		spn_itemSA2_ver.Click += spn_lengthver_Click;
		spn_itemSA3_ver.Click += spn_lengthver_Click;
		spn_itemSA4_ver.Click += spn_lengthver_Click;
		spn_itemSA5_ver.Click += spn_lengthver_Click;
		spn_lengthhor.Click += spn_lengthver_Click;
		spn_lengthver.Click += spn_lengthver_Click;
	}
	...
	public void Init()
	{
		try
		{
			...
			spn_lengthhor.Value = varPerpendicularCut.CutHorizontalLength;
			spn_lengthver.Value = varPerpendicularCut.CutVerticalLength;
			...
			Class76.smethod_331(this);
			Class76.smethod_482(this);
			LoadLanguage();
			bool_1 = true;
		}
	...
	public void LoadLanguage()
	{
		try
		{
			if (Captions.Count > 20)
			{
				...
				spn_lengthhor.Caption.Caption = Captions[3];
				spn_lengthver.Caption.Caption = Captions[3];
	...
	internal void method_2(object sender, EventArgs e)
	{
		...
		if (control.Name == buButton_16.Name)
		{
			...
			if (saveFileDialog.ShowDialog() == DialogResult.OK)
			{
				...
				Class76.smethod_632(this);
				Class76.smethod_635(this);
		...
		if (control.Name == buButton_18.Name)
		{
		...
		if (control.Name == buButton_11.Name && bool_3)
		{
			...
			spn_lengthhor.Value = buControlCoreClass.cVector.Length3D(StartPosHor, EndPosHor);
		...
		if (control.Name == buButton_13.Name && bool_2)
		{
			...
			spn_lengthver.Value = buControlCoreClass.cVector.Length3D(StartPosVer, EndPosVer);
			if (marbleSetStartPositionHandler_1 != null)
			{
