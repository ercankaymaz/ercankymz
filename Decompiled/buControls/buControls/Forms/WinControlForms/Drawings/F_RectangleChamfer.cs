...
public class F_RectangleChamfer : Form
{
	...
	public F_RectangleChamfer()
	{
		Class76.smethod_787(this);
	}

	public void Init()
	{
		bool_0 = false;
		numericUpDown_2.Value = (decimal)Rect.Height;
		numericUpDown_3.Value = (decimal)Rect.Width;
		numericUpDown_5.Value = (decimal)Rect.Chamfer;
		numericUpDown_1.Value = (decimal)Rect.CornerPoint.X;
		numericUpDown_0.Value = (decimal)Rect.CornerPoint.Y;
	...
	public void Init(ShapeData rect)
	{
		...
		{
			Rect = new RectangleCornerChamferData((RectangleCornerChamferData)rect);
		}
		numericUpDown_2.Value = (decimal)Rect.Height;
		numericUpDown_3.Value = (decimal)Rect.Width;
		numericUpDown_5.Value = (decimal)Rect.Chamfer;
	...
	public void Apply()
	{
		Rect.Height = (double)numericUpDown_2.Value;
		Rect.Width = (double)numericUpDown_3.Value;
		Rect.Rotation = (double)numericUpDown_4.Value;
		Rect.Chamfer = (double)numericUpDown_5.Value;
		Rect.CornerPoint = new Pnt3D((double)numericUpDown_1.Value, (double)numericUpDown_0.Value, 0.0);
	}
