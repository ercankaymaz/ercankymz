...
public class F_Triangle : Form
{
	...
	public F_Triangle()
	{
		Class76.smethod_592(this);
	}

	public void Init()
	{
		bool_0 = false;
		numericUpDown_3.Value = (decimal)Triangle.Width;
		numericUpDown_2.Value = (decimal)Triangle.Height;
		numericUpDown_4.Value = (decimal)Triangle.Rotation;
		numericUpDown_1.Value = (decimal)Triangle.CenterPoint.X;
		numericUpDown_0.Value = (decimal)Triangle.CenterPoint.Y;
		Result = DialogResult.None;
		bool_0 = true;
		Class76.smethod_305(this);
	}
	...
	public void Init(ShapeData triangle)
	{
		...
		{
			Triangle = new TriangleTwinData((TriangleTwinData)triangle);
		}
		numericUpDown_3.Value = (decimal)Triangle.Width;
		numericUpDown_2.Value = (decimal)Triangle.Height;
		numericUpDown_4.Value = (decimal)Triangle.Rotation;
	...
	public void Apply()
	{
		Triangle.Width = (double)numericUpDown_3.Value;
		Triangle.Height = (double)numericUpDown_2.Value;
		Triangle.Rotation = (double)numericUpDown_4.Value;
		Triangle.CenterPoint = new Pnt3D((double)numericUpDown_1.Value, (double)numericUpDown_0.Value, 0.0);
	}
