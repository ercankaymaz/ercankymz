...
public class F_Cf2PropertiesList : Form
{
	...
	public F_Cf2PropertiesList()
	{
		Class76.smethod_1(this);
	}
	...
	public void Init()
	{
		...
		Class76.smethod_233(this);
		Class76.smethod_769(this);
	...
	internal void method_0(object sender, EventArgs e)
	{
		...
		if (control.Name == btn_add.Name)
		{
			...
			Class76.smethod_757(this, ref cf2FileProperties_);
		...
		if (control.Name == btn_update.Name && PropertiesForm.Inited && ((listBox_0.SelectedIndex >= 0) & (listBox_0.SelectedIndex <= Cf2Properties.Count - 1)))
		{
			...
			Class76.smethod_757(this, ref cf2FileProperties_2);
	...
	{
		numericUpDown_5.Value = props.ToolNo;
		numericUpDown_2.Value = (decimal)props.PtIndex;
		numericUpDown_1.Value = (decimal)props.PtRealValue;
		numericUpDown_0.Value = (decimal)props.Cf2CodeMatchType;
		label_16.BackColor = props.MatchColor;
		numericUpDown_3.Value = (decimal)props.SelectedThickness;
		numericUpDown_4.Value = (decimal)props.Thickness;
		textBox_0.Text = props.Explanation;
		checkBox_0.Checked = props.Selectable;
		checkBox_1.Checked = props.Visible;
		label_9.BackColor = props.Color;
		label_8.BackColor = props.SelectedColor;
	...
	internal void method_3(object sender, EventArgs e)
	{
		...
		if (control.Name == label_9.Name)
		{
			...
			if (ColorDialogBox.Result == DialogResult.OK)
			{
				...
				label_9.ForeColor = buImage.InvertColorNoGray(label_9.BackColor);
				label_9.Text = buImage.GetColorKnownName(label_9.BackColor);
			}
		}
		if (control.Name == label_8.Name)
		{
			...
			if (ColorDialogBox.Result == DialogResult.OK)
			{
				label_8.BackColor = ColorDialogBox.Color;
				label_8.ForeColor = buImage.InvertColorNoGray(label_8.BackColor);
				label_8.Text = buImage.GetColorKnownName(label_8.BackColor);
			}
		}
		if (control.Name == label_16.Name)
		{
			ColorDialogBox.ShowDialog(label_16.BackColor);
			if (ColorDialogBox.Result == DialogResult.OK)
			{
				label_16.BackColor = ColorDialogBox.Color;
				label_16.ForeColor = buImage.InvertColorNoGray(label_16.BackColor);
				label_16.Text = buImage.GetColorKnownName(label_16.BackColor);
			}
		}
	}
