...
public class F_CamGrindingContourSawOpen : Form
{
	...
	public F_CamGrindingContourSawOpen()
	{
		Class76.smethod_672(this);
	}
	...
	public void Init()
	{
		...
		buControlCommands.ComboboxAddItem(arrayList, Convert.ToInt32(camPars.Offsets.OpenContourOld), ref comboBox_2);
		comboBox_2.Items.RemoveAt(4);
		comboBox_2.Items.RemoveAt(3);
		numericUpDown_0.Value = (decimal)camPars.Operations.TargetZ;
		numericUpDown_5.Value = (decimal)camPars.Offsets.Offset;
		numericUpDown_19.Value = (decimal)Operation.GlassThickness;
		checkBox_4.Checked = Operation.UseGeometryCalculation;
		...
		buControlCommands.ComboboxAddItem(arrayList, Convert.ToInt32(Operation.SawRampType), ref comboBox_3);
		numericUpDown_16.Value = (decimal)Operation.SawRampHeight;
		numericUpDown_17.Value = (decimal)Operation.SawRampLenght;
		checkBox_2.Checked = Operation.SawRampEnable;
		numericUpDown_18.Value = (decimal)camPars.Strategy.AngleLimit;
		checkBox_3.Checked = camPars.Strategy.UseTangentLimit;
		Refresh();
		Properties.Result = DialogResult.None;
		Properties.Inited = true;
		Class76.smethod_409(this);
	}
	...
	internal void method_1(object sender, EventArgs e)
	{
		...
		if (control.Name == btn_cancelsettings.Name)
		{
			panel_9.Visible = false;
		}
		if (control.Name == btn_oksetting.Name)
		{
			camPars.Strategy.AngleLimit = (double)numericUpDown_18.Value;
			camPars.Strategy.UseTangentLimit = checkBox_3.Checked;
			panel_9.Visible = false;
		}
		...
		{
			Operation.SawRampHeight = (double)numericUpDown_16.Value;
			Operation.SawRampLenght = (double)numericUpDown_17.Value;
			Operation.SawRampEnable = checkBox_2.Checked;
			Operation.SawRampType = (CamZRampType)buGeneral.EnumValueFromInt(Operation.SawRampType, comboBox_3.SelectedIndex);
			panel_7.Visible = false;
		}
	}
	...
	internal void method_5(object sender, EventArgs e)
	{
		if (Properties.Inited)
		{
			btn_rampsetshow.Enabled = checkBox_2.Checked;
