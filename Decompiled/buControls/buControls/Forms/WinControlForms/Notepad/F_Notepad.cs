...
public class F_Notepad : Form
{
	...
	internal void method_0(object sender, TextChangedEventArgs e)
	{
		...
		{
			Class76.smethod_437(this, e);
		}
	}

	internal void method_1(object sender, EventArgs e)
	{
		buMultiTextBox1.ShowFindDialog();
	}

	internal void method_2(object sender, EventArgs e)
	{
		buMultiTextBox1.ShowReplaceDialog();
	}
	...
	internal void method_4(object sender, EventArgs e)
	{
		...
		buMultiTextBox1.ClearStylesBuffer();
		buMultiTextBox1.Range.ClearStyle(StyleIndex.All);
		Class76.smethod_364(this);
		buMultiTextBox1.AutoIndentNeeded -= method_17;
		string text = string_0;
		string text2 = text;
		...
		case 3845047600u:
			...
			{
				buMultiTextBox1.Language = Language.CSharp;
			}
			break;
		case 1039209162u:
			if (text2 == "JS")
			{
				buMultiTextBox1.Language = Language.JS;
			}
			break;
		case 18818719u:
			if (text2 == "SQL")
			{
				buMultiTextBox1.Language = Language.SQL;
			}
			break;
		case 348642512u:
			if (text2 == "HTML")
			{
				buMultiTextBox1.Language = Language.HTML;
			}
			break;
		case 1727679921u:
			if (text2 == "VB")
			{
				buMultiTextBox1.Language = Language.VB;
			}
			break;
		case 2683950351u:
			if (text2 == "PHP")
			{
				buMultiTextBox1.Language = Language.PHP;
			}
			break;
		case 3223109505u:
			if (text2 == "Lua")
			{
				buMultiTextBox1.Language = Language.Lua;
			}
			break;
		case 3877699969u:
			if (text2 == "CSharp (custom highlighter)")
			{
				buMultiTextBox1.Language = Language.Custom;
				buMultiTextBox1.CommentPrefix = "//";
				buMultiTextBox1.AutoIndentNeeded += method_17;
				buMultiTextBox1.OnTextChanged();
			}
			break;
		}
		buMultiTextBox1.OnSyntaxHighlight(new TextChangedEventArgs(buMultiTextBox1.Range));
		toolStripMenuItem_12.Enabled = string_0 != "CSharp (custom highlighter)";
	}

	internal void method_5(object sender, EventArgs e)
	{
		buMultiTextBox1.CollapseBlock(buMultiTextBox1.Selection.Start.iLine, buMultiTextBox1.Selection.End.iLine);
	}
	...
	internal void method_6(object sender, EventArgs e)
	{
		...
		for (int i = 0; i < buMultiTextBox1.LinesCount; i++)
		{
			if (buMultiTextBox1[i].FoldingStartMarker == "#region\\b")
			{
				buMultiTextBox1.CollapseFoldingBlock(i);
			}
		}
	}
	...
	internal void method_7(object sender, EventArgs e)
	{
		...
		for (int i = 0; i < buMultiTextBox1.LinesCount; i++)
		{
			if (buMultiTextBox1[i].FoldingStartMarker == "#region\\b")
			{
				buMultiTextBox1.ExpandFoldedBlock(i);
			}
		}
	}
	...
	{
		buMultiTextBox1.IncreaseIndent();
	}

	internal void method_9(object sender, EventArgs e)
	{
		buMultiTextBox1.DecreaseIndent();
	}
	...
	internal void method_10(object sender, EventArgs e)
	{
		...
		if (saveFileDialog.ShowDialog() == DialogResult.OK)
		{
			...
			if (saveFileDialog.FilterIndex == 2)
			{
				...
				contents = exportToHTML.GetHtml(buMultiTextBox1);
			}
	...
	{
		buMultiTextBox1.VisibleRange.ClearStyle(markerStyle_0);
		if (!buMultiTextBox1.Selection.IsEmpty)
		{
			return;
		}
		Range fragment = buMultiTextBox1.Selection.GetFragment("\\w");
		string text = fragment.Text;
		if (text.Length == 0)
		{
			return;
		}
		Range[] array = buMultiTextBox1.VisibleRange.GetRanges("\\b" + text + "\\b").ToArray();
		if (array.Length > 1)
		{
			Range[] array2 = array;
	...
	{
		buMultiTextBox1.Print(new PrintDialogSettings
		{
	...
	internal void method_19(object sender, EventArgs e)
	{
		...
		{
			buMultiTextBox1.SyntaxHighlighter.BlueBoldStyle,
			buMultiTextBox1.SyntaxHighlighter.BlueStyle,
			buMultiTextBox1.SyntaxHighlighter.BoldStyle,
			buMultiTextBox1.SyntaxHighlighter.BrownStyle,
			buMultiTextBox1.SyntaxHighlighter.GrayStyle,
			buMultiTextBox1.SyntaxHighlighter.GreenStyle,
			buMultiTextBox1.SyntaxHighlighter.MagentaStyle,
			buMultiTextBox1.SyntaxHighlighter.MaroonStyle,
			buMultiTextBox1.SyntaxHighlighter.RedStyle
		};
		buMultiTextBox1.SyntaxHighlighter.AttributeStyle = array[random_0.Next(9)];
		buMultiTextBox1.SyntaxHighlighter.ClassNameStyle = array[random_0.Next(9)];
		buMultiTextBox1.SyntaxHighlighter.CommentStyle = array[random_0.Next(9)];
		buMultiTextBox1.SyntaxHighlighter.CommentTagStyle = array[random_0.Next(9)];
		buMultiTextBox1.SyntaxHighlighter.KeywordStyle = array[random_0.Next(9)];
		buMultiTextBox1.SyntaxHighlighter.NumberStyle = array[random_0.Next(9)];
		buMultiTextBox1.SyntaxHighlighter.StringStyle = array[random_0.Next(9)];
		buMultiTextBox1.OnSyntaxHighlight(new TextChangedEventArgs(buMultiTextBox1.Range));
	}

	internal void method_20(object sender, EventArgs e)
	{
		buMultiTextBox1.Selection.ReadOnly = true;
	}

	internal void method_21(object sender, EventArgs e)
	{
		buMultiTextBox1.Selection.ReadOnly = false;
	}

	internal void method_22(object sender, EventArgs e)
	{
		buMultiTextBox1.MacrosManager.IsRecording = !buMultiTextBox1.MacrosManager.IsRecording;
	}

	internal void method_23(object sender, EventArgs e)
	{
		buMultiTextBox1.MacrosManager.ExecuteMacros();
	}

	internal void method_24(object sender, EventArgs e)
	{
		HotkeysEditorForm hotkeysEditorForm = new HotkeysEditorForm(buMultiTextBox1.HotkeysMapping);
		if (hotkeysEditorForm.ShowDialog() == DialogResult.OK)
		{
			buMultiTextBox1.HotkeysMapping = hotkeysEditorForm.GetHotkeys();
		}
	}
	...
	internal void method_25(object sender, EventArgs e)
	{
		...
		if (saveFileDialog.ShowDialog() == DialogResult.OK)
		{
			string rtf = buMultiTextBox1.Rtf;
			System.IO.File.WriteAllText(saveFileDialog.FileName, rtf);
		}
	}
	...
	{
		buMultiTextBox1.InsertLinePrefix(buMultiTextBox1.CommentPrefix);
	}

	internal void method_28(object sender, EventArgs e)
	{
		buMultiTextBox1.RemoveLinePrefix(buMultiTextBox1.CommentPrefix);
	}
	...
	{
		buMultiTextBox1.WordWrap = true;
		buMultiTextBox1.Language = Language.HTML;
		buMultiTextBox1.Text = text;
		LoadLanguage();
		base.TopMost = FormTopMost;
		if (ScreenCenter)
		{
	...
	public void Init(ArrayList text)
	{
		...
		string text2 = "";
		new StringBuilder();
		text2 = buString.ArrayListToString(text, NewLineEnable: true);
		buMultiTextBox1.Text = text2;
		LoadLanguage();
		base.TopMost = FormTopMost;
		if (ScreenCenter)
	...
	public void LoadLanguage()
	{
		...
		try
		{
			if (Captions.Count >= 45)
			{
				...
				toolStripMenuItem_13.Text = Captions[40];
				toolStripMenuItem_7.Text = Captions[41];
				toolStripMenuItem_12.Text = Captions[42];
				toolStripMenuItem_16.Text = Captions[43];
			}
		}
	...
	{
		TextValue = buMultiTextBox1.Text;
		e.Cancel = true;
		base.Visible = false;
	}
	...
	internal void method_37(object sender, EventArgs e)
	{
		if (bool_0)
		{
			...
			if (dialogResult != DialogResult.Cancel)
			{
				...
				{
					buMultiTextBox1.Text = "";
					bool_0 = false;
					string_1 = "";
				}
				if (dialogResult == DialogResult.Yes)
				{
					Class76.smethod_440(this);
					buMultiTextBox1.Text = "";
					bool_0 = false;
					string_1 = "";
				}
	...
	{
		buMultiTextBox1.ShowGoToDialog();
	}
	...
	internal void method_44(object sender, EventArgs e)
	{
		...
		printDocument.PrintPage += method_45;
	...
	{
		e.Graphics.DrawString(buMultiTextBox1.Text, buMultiTextBox1.Font, Brushes.Black, 10f, 10f);
	}
