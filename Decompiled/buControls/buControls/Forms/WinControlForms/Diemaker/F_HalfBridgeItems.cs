...
public class F_HalfBridgeItems : Form
{
	...
	public F_HalfBridgeItems()
	{
		Class76.smethod_92(this);
	}

	public void Init()
	{
		Result = DialogResult.Cancel;
		numericUpDown_2.Value = (decimal)HalfBridge.LeftHeight;
		numericUpDown_3.Value = (decimal)HalfBridge.LeftWidth;
		numericUpDown_0.Value = (decimal)HalfBridge.RightHeight;
		numericUpDown_1.Value = (decimal)HalfBridge.RightWidth;
		checkBox_1.Checked = HalfBridge.LeftEnable;
		checkBox_0.Checked = HalfBridge.RightEnable;
		Class76.smethod_51(this);
	}
	...
	internal void method_2(object sender, EventArgs e)
	{
		...
		HalfBridge.LeftHeight = (double)numericUpDown_2.Value;
		HalfBridge.LeftWidth = (double)numericUpDown_3.Value;
		HalfBridge.RightHeight = (double)numericUpDown_0.Value;
		HalfBridge.RightWidth = (double)numericUpDown_1.Value;
		HalfBridge.LeftEnable = checkBox_1.Checked;
		HalfBridge.RightEnable = checkBox_0.Checked;
