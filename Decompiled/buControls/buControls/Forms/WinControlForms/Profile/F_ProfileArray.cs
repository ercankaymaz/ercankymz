...
public class F_ProfileArray : Form
{
	...
	public void Init()
	{
		...
		spn_linearcount.Value = OperationData.Array.LineerCount;
		spn_linearlen.Value = (decimal)OperationData.Array.LineerDistance;
