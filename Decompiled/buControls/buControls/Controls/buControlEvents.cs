...
public class buControlEvents
{
	...
	public delegate void buButtonPlusMinusMouseEventHandler(object sender, MouseEventArgs e, int Sing);
	...
	public delegate void buLayerChangedEventHandler(object sender, Color color, bool Visible, bool Lock, string Name, int Index);

	public delegate void buLayerDoubleClickEventHandler(object sender, Color color, bool Visible, bool Lock, string Name, int Index);

	public delegate void buColorChangedEventHandler(object sender, Color color, double Thickness, int Transparency);

	public delegate void buListValueChangedEventHandler(object sender, buListValueChangedEventArg e);

	public delegate void buListEnableTwoValueChangedEventHandler(object sender, List<ValuesItem> Items, int IndexItem, ValuesItem Value);
}
