...
public class IfcControllerType : IfcDistributionControlElementType, IInstantiableEntity, IPersistEntity, IPersist, IIfcControllerType, IIfcDistributionControlElementType, IIfcDistributionElementType, IIfcElementType, IIfcTypeProduct, IIfcTypeObject, IIfcObjectDefinition, IIfcRoot, IfcDefinitionSelect, IIfcDefinitionSelect, IExpressSelectType, IfcProductSelect, IIfcProductSelect, IContainsEntityReferences, IContainsIndexedReferences, IEquatable<IfcControllerType>, IExpressValidatable
{
	...
	public bool ValidateClause(IfcControllerTypeClause clause)
	{
		...
		try
		{
			if (clause == IfcControllerTypeClause.CorrectPredefinedType)
			{
				result = PredefinedType != IfcControllerTypeEnum.USERDEFINED || (PredefinedType == IfcControllerTypeEnum.USERDEFINED && Functions.EXISTS(base.ElementType));
			}
		}
		catch (Exception ex)
		{
			ValidationLogging.CreateLogger<IfcControllerType>()?.LogError($"Exception thrown evaluating where-clause 'IfcControllerType.{clause}' for #{base.EntityLabel}.", ex);
		}
		return result;
	}
	...
	public override IEnumerable<ValidationResult> Validate()
	{
		...
		if (!ValidateClause(IfcControllerTypeClause.CorrectPredefinedType))
		{
			...
			{
				Item = this,
				IssueSource = "IfcControllerType.CorrectPredefinedType",
