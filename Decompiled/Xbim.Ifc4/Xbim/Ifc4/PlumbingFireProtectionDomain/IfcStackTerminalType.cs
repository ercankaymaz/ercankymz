...
public class IfcStackTerminalType : IfcFlowTerminalType, IInstantiableEntity, IPersistEntity, IPersist, IIfcStackTerminalType, IIfcFlowTerminalType, IIfcDistributionFlowElementType, IIfcDistributionElementType, IIfcElementType, IIfcTypeProduct, IIfcTypeObject, IIfcObjectDefinition, IIfcRoot, IfcDefinitionSelect, IIfcDefinitionSelect, IExpressSelectType, IfcProductSelect, IIfcProductSelect, IContainsEntityReferences, IContainsIndexedReferences, IEquatable<IfcStackTerminalType>, IExpressValidatable
{
	...
	public bool ValidateClause(IfcStackTerminalTypeClause clause)
	{
		...
		try
		{
			if (clause == IfcStackTerminalTypeClause.CorrectPredefinedType)
			{
				result = PredefinedType != IfcStackTerminalTypeEnum.USERDEFINED || (PredefinedType == IfcStackTerminalTypeEnum.USERDEFINED && Functions.EXISTS(base.ElementType));
			}
		}
		catch (Exception ex)
		{
			ValidationLogging.CreateLogger<IfcStackTerminalType>()?.LogError($"Exception thrown evaluating where-clause 'IfcStackTerminalType.{clause}' for #{base.EntityLabel}.", ex);
		}
		return result;
	}
	...
	public override IEnumerable<ValidationResult> Validate()
	{
		...
		if (!ValidateClause(IfcStackTerminalTypeClause.CorrectPredefinedType))
		{
			...
			{
				Item = this,
				IssueSource = "IfcStackTerminalType.CorrectPredefinedType",
