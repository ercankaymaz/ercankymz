...
public class IfcWasteTerminalType : IfcFlowTerminalType, IInstantiableEntity, IPersistEntity, IPersist, IIfcWasteTerminalType, IIfcFlowTerminalType, IIfcDistributionFlowElementType, IIfcDistributionElementType, IIfcElementType, IIfcTypeProduct, IIfcTypeObject, IIfcObjectDefinition, IIfcRoot, IfcDefinitionSelect, IIfcDefinitionSelect, IExpressSelectType, IfcProductSelect, IIfcProductSelect, IContainsEntityReferences, IContainsIndexedReferences, IEquatable<IfcWasteTerminalType>, IExpressValidatable
{
	...
	public bool ValidateClause(IfcWasteTerminalTypeClause clause)
	{
		...
		try
		{
			if (clause == IfcWasteTerminalTypeClause.CorrectPredefinedType)
			{
				result = PredefinedType != IfcWasteTerminalTypeEnum.USERDEFINED || (PredefinedType == IfcWasteTerminalTypeEnum.USERDEFINED && Functions.EXISTS(base.ElementType));
			}
		}
		catch (Exception ex)
		{
			ValidationLogging.CreateLogger<IfcWasteTerminalType>()?.LogError($"Exception thrown evaluating where-clause 'IfcWasteTerminalType.{clause}' for #{base.EntityLabel}.", ex);
		}
		return result;
	}
	...
	public override IEnumerable<ValidationResult> Validate()
	{
		...
		if (!ValidateClause(IfcWasteTerminalTypeClause.CorrectPredefinedType))
		{
			...
			{
				Item = this,
				IssueSource = "IfcWasteTerminalType.CorrectPredefinedType",
