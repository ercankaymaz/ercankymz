...
public class IfcBuildingElementProxyType : IfcBuildingElementType, IInstantiableEntity, IPersistEntity, IPersist, IIfcBuildingElementProxyType, IIfcBuildingElementType, IIfcElementType, IIfcTypeProduct, IIfcTypeObject, IIfcObjectDefinition, IIfcRoot, IfcDefinitionSelect, IIfcDefinitionSelect, IExpressSelectType, IfcProductSelect, IIfcProductSelect, IContainsEntityReferences, IContainsIndexedReferences, IEquatable<IfcBuildingElementProxyType>, IExpressValidatable
{
	...
	public bool ValidateClause(IfcBuildingElementProxyTypeClause clause)
	{
		...
		try
		{
			if (clause == IfcBuildingElementProxyTypeClause.CorrectPredefinedType)
			{
				result = PredefinedType != IfcBuildingElementProxyTypeEnum.USERDEFINED || (PredefinedType == IfcBuildingElementProxyTypeEnum.USERDEFINED && Functions.EXISTS(base.ElementType));
			}
		}
		catch (Exception ex)
		{
			ValidationLogging.CreateLogger<IfcBuildingElementProxyType>()?.LogError($"Exception thrown evaluating where-clause 'IfcBuildingElementProxyType.{clause}' for #{base.EntityLabel}.", ex);
		}
		return result;
	}
	...
	public override IEnumerable<ValidationResult> Validate()
	{
		...
		if (!ValidateClause(IfcBuildingElementProxyTypeClause.CorrectPredefinedType))
		{
			...
			{
				Item = this,
				IssueSource = "IfcBuildingElementProxyType.CorrectPredefinedType",
