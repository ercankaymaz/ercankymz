...
public class IfcBuildingElementProxy : IfcBuildingElement, IInstantiableEntity, IPersistEntity, IPersist, IIfcBuildingElementProxy, IIfcBuildingElement, IIfcElement, IIfcProduct, IIfcObject, IIfcObjectDefinition, IIfcRoot, IfcDefinitionSelect, IIfcDefinitionSelect, IExpressSelectType, IfcProductSelect, IIfcProductSelect, IfcStructuralActivityAssignmentSelect, IIfcStructuralActivityAssignmentSelect, IContainsEntityReferences, IContainsIndexedReferences, IEquatable<IfcBuildingElementProxy>, IExpressValidatable
{
	...
	public bool ValidateClause(IfcBuildingElementProxyClause clause)
	{
		...
		try
		{
			...
			case IfcBuildingElementProxyClause.CorrectPredefinedType:
				result = !Functions.EXISTS(PredefinedType) || PredefinedType != IfcBuildingElementProxyTypeEnum.USERDEFINED || (PredefinedType == IfcBuildingElementProxyTypeEnum.USERDEFINED && Functions.EXISTS(base.ObjectType));
				break;
			case IfcBuildingElementProxyClause.CorrectTypeAssigned:
				result = Functions.SIZEOF(base.IsTypedBy) == 0 || Functions.TYPEOF(base.IsTypedBy.ItemAt(0L).RelatingType).Contains("IFC4.IFCBUILDINGELEMENTPROXYTYPE");
				break;
			}
		}
		catch (Exception ex)
	...
	public override IEnumerable<ValidationResult> Validate()
	{
		...
		if (!ValidateClause(IfcBuildingElementProxyClause.HasObjectName))
		{
			...
			{
				Item = this,
				IssueSource = "IfcBuildingElementProxy.HasObjectName",
		...
		if (!ValidateClause(IfcBuildingElementProxyClause.CorrectPredefinedType))
		{
			...
			{
				Item = this,
				IssueSource = "IfcBuildingElementProxy.CorrectPredefinedType",
				IssueType = ValidationFlags.EntityWhereClauses
			};
		}
		if (!ValidateClause(IfcBuildingElementProxyClause.CorrectTypeAssigned))
		{
			...
			{
				Item = this,
				IssueSource = "IfcBuildingElementProxy.CorrectTypeAssigned",
				IssueType = ValidationFlags.EntityWhereClauses
			};
		}
	}
