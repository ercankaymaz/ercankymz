...
public class IfcRoof : IfcBuildingElement, IInstantiableEntity, IPersistEntity, IPersist, IIfcRoof, IIfcBuildingElement, IIfcElement, IIfcProduct, IIfcObject, IIfcObjectDefinition, IIfcRoot, IfcDefinitionSelect, IIfcDefinitionSelect, IExpressSelectType, IfcProductSelect, IIfcProductSelect, IfcStructuralActivityAssignmentSelect, IIfcStructuralActivityAssignmentSelect, IContainsEntityReferences, IContainsIndexedReferences, IEquatable<IfcRoof>, IExpressValidatable
{
	...
	public bool ValidateClause(IfcRoofClause clause)
	{
		...
		try
		{
			...
			case IfcRoofClause.CorrectPredefinedType:
				result = !Functions.EXISTS(PredefinedType) || PredefinedType != IfcRoofTypeEnum.USERDEFINED || (PredefinedType == IfcRoofTypeEnum.USERDEFINED && Functions.EXISTS(base.ObjectType));
				break;
			case IfcRoofClause.CorrectTypeAssigned:
				result = Functions.SIZEOF(base.IsTypedBy) == 0 || Functions.TYPEOF(base.IsTypedBy.ItemAt(0L).RelatingType).Contains("IFC4.IFCROOFTYPE");
				break;
			}
		}
		catch (Exception ex)
	...
	public override IEnumerable<ValidationResult> Validate()
	{
		...
		if (!ValidateClause(IfcRoofClause.CorrectPredefinedType))
		{
			...
			{
				Item = this,
				IssueSource = "IfcRoof.CorrectPredefinedType",
		...
		if (!ValidateClause(IfcRoofClause.CorrectTypeAssigned))
		{
			...
			{
				Item = this,
				IssueSource = "IfcRoof.CorrectTypeAssigned",
				IssueType = ValidationFlags.EntityWhereClauses
			};
		}
	}
