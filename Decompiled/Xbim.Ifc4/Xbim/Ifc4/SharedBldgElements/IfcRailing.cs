...
public class IfcRailing : IfcBuildingElement, IInstantiableEntity, IPersistEntity, IPersist, IIfcRailing, IIfcBuildingElement, IIfcElement, IIfcProduct, IIfcObject, IIfcObjectDefinition, IIfcRoot, IfcDefinitionSelect, IIfcDefinitionSelect, IExpressSelectType, IfcProductSelect, IIfcProductSelect, IfcStructuralActivityAssignmentSelect, IIfcStructuralActivityAssignmentSelect, IContainsEntityReferences, IContainsIndexedReferences, IEquatable<IfcRailing>, IExpressValidatable
{
	...
	public bool ValidateClause(IfcRailingClause clause)
	{
		...
		try
		{
			...
			case IfcRailingClause.CorrectTypeAssigned:
				result = Functions.SIZEOF(base.IsTypedBy) == 0 || Functions.TYPEOF(base.IsTypedBy.ItemAt(0L).RelatingType).Contains("IFC4.IFCRAILINGTYPE");
				break;
			}
		}
		catch (Exception ex)
	...
	public override IEnumerable<ValidationResult> Validate()
	{
		...
		if (!ValidateClause(IfcRailingClause.CorrectPredefinedType))
		{
			...
			{
				Item = this,
				IssueSource = "IfcRailing.CorrectPredefinedType",
		...
		if (!ValidateClause(IfcRailingClause.CorrectTypeAssigned))
		{
			...
			{
				Item = this,
				IssueSource = "IfcRailing.CorrectTypeAssigned",
				IssueType = ValidationFlags.EntityWhereClauses
			};
		}
	}
