...
public class IfcSlab : IfcBuildingElement, IInstantiableEntity, IPersistEntity, IPersist, IIfcSlab, IIfcBuildingElement, IIfcElement, IIfcProduct, IIfcObject, IIfcObjectDefinition, IIfcRoot, IfcDefinitionSelect, IIfcDefinitionSelect, IExpressSelectType, IfcProductSelect, IIfcProductSelect, IfcStructuralActivityAssignmentSelect, IIfcStructuralActivityAssignmentSelect, IContainsEntityReferences, IContainsIndexedReferences, IEquatable<IfcSlab>, IExpressValidatable
{
	...
	public bool ValidateClause(IfcSlabClause clause)
	{
		...
		try
		{
			...
			case IfcSlabClause.CorrectTypeAssigned:
				result = Functions.SIZEOF(base.IsTypedBy) == 0 || Functions.TYPEOF(base.IsTypedBy.ItemAt(0L).RelatingType).Contains("IFC4.IFCSLABTYPE");
				break;
			}
		}
		catch (Exception ex)
	...
	public override IEnumerable<ValidationResult> Validate()
	{
		...
		if (!ValidateClause(IfcSlabClause.CorrectPredefinedType))
		{
			...
			{
				Item = this,
				IssueSource = "IfcSlab.CorrectPredefinedType",
		...
		if (!ValidateClause(IfcSlabClause.CorrectTypeAssigned))
		{
			...
			{
				Item = this,
				IssueSource = "IfcSlab.CorrectTypeAssigned",
				IssueType = ValidationFlags.EntityWhereClauses
			};
		}
	}
