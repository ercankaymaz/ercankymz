...
public class IfcFanType : IfcFlowMovingDeviceType, IInstantiableEntity, IPersistEntity, IPersist, IIfcFanType, IIfcFlowMovingDeviceType, IIfcDistributionFlowElementType, IIfcDistributionElementType, IIfcElementType, IIfcTypeProduct, IIfcTypeObject, IIfcObjectDefinition, IIfcRoot, IfcDefinitionSelect, IIfcDefinitionSelect, IExpressSelectType, IfcProductSelect, IIfcProductSelect, IContainsEntityReferences, IContainsIndexedReferences, IEquatable<IfcFanType>, IExpressValidatable
{
	...
	public bool ValidateClause(IfcFanTypeClause clause)
	{
		...
		try
		{
			if (clause == IfcFanTypeClause.CorrectPredefinedType)
			{
	...
	public override IEnumerable<ValidationResult> Validate()
	{
		...
		if (!ValidateClause(IfcFanTypeClause.CorrectPredefinedType))
		{
			...
			{
				Item = this,
				IssueSource = "IfcFanType.CorrectPredefinedType",
