...
public class IfcFlowMeterType : IfcFlowControllerType, IInstantiableEntity, IPersistEntity, IPersist, IIfcFlowMeterType, IIfcFlowControllerType, IIfcDistributionFlowElementType, IIfcDistributionElementType, IIfcElementType, IIfcTypeProduct, IIfcTypeObject, IIfcObjectDefinition, IIfcRoot, IfcDefinitionSelect, IIfcDefinitionSelect, IExpressSelectType, IfcProductSelect, IIfcProductSelect, IContainsEntityReferences, IContainsIndexedReferences, IEquatable<IfcFlowMeterType>, IExpressValidatable
{
	...
	public bool ValidateClause(IfcFlowMeterTypeClause clause)
	{
		...
		try
		{
			if (clause == IfcFlowMeterTypeClause.CorrectPredefinedType)
			{
	...
	public override IEnumerable<ValidationResult> Validate()
	{
		...
		if (!ValidateClause(IfcFlowMeterTypeClause.CorrectPredefinedType))
		{
			...
			{
				Item = this,
				IssueSource = "IfcFlowMeterType.CorrectPredefinedType",
