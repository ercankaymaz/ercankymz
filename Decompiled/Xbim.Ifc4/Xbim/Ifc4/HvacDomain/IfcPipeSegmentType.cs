...
public class IfcPipeSegmentType : IfcFlowSegmentType, IInstantiableEntity, IPersistEntity, IPersist, IIfcPipeSegmentType, IIfcFlowSegmentType, IIfcDistributionFlowElementType, IIfcDistributionElementType, IIfcElementType, IIfcTypeProduct, IIfcTypeObject, IIfcObjectDefinition, IIfcRoot, IfcDefinitionSelect, IIfcDefinitionSelect, IExpressSelectType, IfcProductSelect, IIfcProductSelect, IContainsEntityReferences, IContainsIndexedReferences, IEquatable<IfcPipeSegmentType>, IExpressValidatable
{
	...
	public bool ValidateClause(IfcPipeSegmentTypeClause clause)
	{
		...
		try
		{
			if (clause == IfcPipeSegmentTypeClause.CorrectPredefinedType)
			{
	...
	public override IEnumerable<ValidationResult> Validate()
	{
		...
		if (!ValidateClause(IfcPipeSegmentTypeClause.CorrectPredefinedType))
		{
			...
			{
				Item = this,
				IssueSource = "IfcPipeSegmentType.CorrectPredefinedType",
