...
public class IfcValveType : IfcFlowControllerType, IInstantiableEntity, IPersistEntity, IPersist, IIfcValveType, IIfcFlowControllerType, IIfcDistributionFlowElementType, IIfcDistributionElementType, IIfcElementType, IIfcTypeProduct, IIfcTypeObject, IIfcObjectDefinition, IIfcRoot, IfcDefinitionSelect, IIfcDefinitionSelect, IExpressSelectType, IfcProductSelect, IIfcProductSelect, IContainsEntityReferences, IContainsIndexedReferences, IEquatable<IfcValveType>, IExpressValidatable
{
	...
	public bool ValidateClause(IfcValveTypeClause clause)
	{
		...
		try
		{
			if (clause == IfcValveTypeClause.CorrectPredefinedType)
			{
	...
	public override IEnumerable<ValidationResult> Validate()
	{
		...
		if (!ValidateClause(IfcValveTypeClause.CorrectPredefinedType))
		{
			...
			{
				Item = this,
				IssueSource = "IfcValveType.CorrectPredefinedType",
