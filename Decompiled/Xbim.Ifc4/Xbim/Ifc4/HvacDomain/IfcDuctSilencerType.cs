...
public class IfcDuctSilencerType : IfcFlowTreatmentDeviceType, IInstantiableEntity, IPersistEntity, IPersist, IIfcDuctSilencerType, IIfcFlowTreatmentDeviceType, IIfcDistributionFlowElementType, IIfcDistributionElementType, IIfcElementType, IIfcTypeProduct, IIfcTypeObject, IIfcObjectDefinition, IIfcRoot, IfcDefinitionSelect, IIfcDefinitionSelect, IExpressSelectType, IfcProductSelect, IIfcProductSelect, IContainsEntityReferences, IContainsIndexedReferences, IEquatable<IfcDuctSilencerType>, IExpressValidatable
{
	...
	public bool ValidateClause(IfcDuctSilencerTypeClause clause)
	{
		...
		try
		{
			if (clause == IfcDuctSilencerTypeClause.CorrectPredefinedType)
			{
	...
	public override IEnumerable<ValidationResult> Validate()
	{
		...
		if (!ValidateClause(IfcDuctSilencerTypeClause.CorrectPredefinedType))
		{
			...
			{
				Item = this,
				IssueSource = "IfcDuctSilencerType.CorrectPredefinedType",
