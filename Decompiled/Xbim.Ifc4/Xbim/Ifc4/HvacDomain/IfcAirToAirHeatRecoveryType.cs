...
public class IfcAirToAirHeatRecoveryType : IfcEnergyConversionDeviceType, IInstantiableEntity, IPersistEntity, IPersist, IIfcAirToAirHeatRecoveryType, IIfcEnergyConversionDeviceType, IIfcDistributionFlowElementType, IIfcDistributionElementType, IIfcElementType, IIfcTypeProduct, IIfcTypeObject, IIfcObjectDefinition, IIfcRoot, IfcDefinitionSelect, IIfcDefinitionSelect, IExpressSelectType, IfcProductSelect, IIfcProductSelect, IContainsEntityReferences, IContainsIndexedReferences, IEquatable<IfcAirToAirHeatRecoveryType>, IExpressValidatable
{
	...
	public bool ValidateClause(IfcAirToAirHeatRecoveryTypeClause clause)
	{
		...
		try
		{
			if (clause == IfcAirToAirHeatRecoveryTypeClause.CorrectPredefinedType)
			{
	...
	public override IEnumerable<ValidationResult> Validate()
	{
		...
		if (!ValidateClause(IfcAirToAirHeatRecoveryTypeClause.CorrectPredefinedType))
		{
			...
			{
				Item = this,
				IssueSource = "IfcAirToAirHeatRecoveryType.CorrectPredefinedType",
