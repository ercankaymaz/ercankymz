...
public class IfcFilterType : IfcFlowTreatmentDeviceType, IInstantiableEntity, IPersistEntity, IPersist, IIfcFilterType, IIfcFlowTreatmentDeviceType, IIfcDistributionFlowElementType, IIfcDistributionElementType, IIfcElementType, IIfcTypeProduct, IIfcTypeObject, IIfcObjectDefinition, IIfcRoot, IfcDefinitionSelect, IIfcDefinitionSelect, IExpressSelectType, IfcProductSelect, IIfcProductSelect, IContainsEntityReferences, IContainsIndexedReferences, IEquatable<IfcFilterType>, IExpressValidatable
{
	...
	public bool ValidateClause(IfcFilterTypeClause clause)
	{
		...
		try
		{
			if (clause == IfcFilterTypeClause.CorrectPredefinedType)
			{
	...
	public override IEnumerable<ValidationResult> Validate()
	{
		...
		if (!ValidateClause(IfcFilterTypeClause.CorrectPredefinedType))
		{
			...
			{
				Item = this,
				IssueSource = "IfcFilterType.CorrectPredefinedType",
