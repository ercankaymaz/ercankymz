...
public class IfcPumpType : IfcFlowMovingDeviceType, IInstantiableEntity, IPersistEntity, IPersist, IIfcPumpType, IIfcFlowMovingDeviceType, IIfcDistributionFlowElementType, IIfcDistributionElementType, IIfcElementType, IIfcTypeProduct, IIfcTypeObject, IIfcObjectDefinition, IIfcRoot, IfcDefinitionSelect, IIfcDefinitionSelect, IExpressSelectType, IfcProductSelect, IIfcProductSelect, IContainsEntityReferences, IContainsIndexedReferences, IEquatable<IfcPumpType>, IExpressValidatable
{
	...
	public bool ValidateClause(IfcPumpTypeClause clause)
	{
		...
		try
		{
			if (clause == IfcPumpTypeClause.CorrectPredefinedType)
			{
	...
	public override IEnumerable<ValidationResult> Validate()
	{
		...
		if (!ValidateClause(IfcPumpTypeClause.CorrectPredefinedType))
		{
			...
			{
				Item = this,
				IssueSource = "IfcPumpType.CorrectPredefinedType",
