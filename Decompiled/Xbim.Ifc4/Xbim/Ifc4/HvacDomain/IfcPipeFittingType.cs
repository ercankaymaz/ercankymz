...
public class IfcPipeFittingType : IfcFlowFittingType, IInstantiableEntity, IPersistEntity, IPersist, IIfcPipeFittingType, IIfcFlowFittingType, IIfcDistributionFlowElementType, IIfcDistributionElementType, IIfcElementType, IIfcTypeProduct, IIfcTypeObject, IIfcObjectDefinition, IIfcRoot, IfcDefinitionSelect, IIfcDefinitionSelect, IExpressSelectType, IfcProductSelect, IIfcProductSelect, IContainsEntityReferences, IContainsIndexedReferences, IEquatable<IfcPipeFittingType>, IExpressValidatable
{
	...
	public bool ValidateClause(IfcPipeFittingTypeClause clause)
	{
		...
		try
		{
			if (clause == IfcPipeFittingTypeClause.CorrectPredefinedType)
			{
	...
	public override IEnumerable<ValidationResult> Validate()
	{
		...
		if (!ValidateClause(IfcPipeFittingTypeClause.CorrectPredefinedType))
		{
			...
			{
				Item = this,
				IssueSource = "IfcPipeFittingType.CorrectPredefinedType",
