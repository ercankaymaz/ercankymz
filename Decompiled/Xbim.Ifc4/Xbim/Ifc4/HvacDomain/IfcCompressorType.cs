...
public class IfcCompressorType : IfcFlowMovingDeviceType, IInstantiableEntity, IPersistEntity, IPersist, IIfcCompressorType, IIfcFlowMovingDeviceType, IIfcDistributionFlowElementType, IIfcDistributionElementType, IIfcElementType, IIfcTypeProduct, IIfcTypeObject, IIfcObjectDefinition, IIfcRoot, IfcDefinitionSelect, IIfcDefinitionSelect, IExpressSelectType, IfcProductSelect, IIfcProductSelect, IContainsEntityReferences, IContainsIndexedReferences, IEquatable<IfcCompressorType>, IExpressValidatable
{
	...
	public bool ValidateClause(IfcCompressorTypeClause clause)
	{
		...
		try
		{
			if (clause == IfcCompressorTypeClause.CorrectPredefinedType)
			{
	...
	public override IEnumerable<ValidationResult> Validate()
	{
		...
		if (!ValidateClause(IfcCompressorTypeClause.CorrectPredefinedType))
		{
			...
			{
				Item = this,
				IssueSource = "IfcCompressorType.CorrectPredefinedType",
