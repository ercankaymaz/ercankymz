...
public struct IfcBoolean : IfcModulusOfRotationalSubgradeReactionSelect, IIfcModulusOfRotationalSubgradeReactionSelect, IExpressSelectType, IPersist, IExpressValueType, IfcModulusOfSubgradeReactionSelect, IIfcModulusOfSubgradeReactionSelect, IfcModulusOfTranslationalSubgradeReactionSelect, IIfcModulusOfTranslationalSubgradeReactionSelect, IfcRotationalStiffnessSelect, IIfcRotationalStiffnessSelect, IfcSimpleValue, IfcValue, IfcAppliedValueSelect, IIfcAppliedValueSelect, IfcMetricValueSelect, IIfcMetricValueSelect, IIfcValue, IIfcSimpleValue, IfcTranslationalStiffnessSelect, IIfcTranslationalStiffnessSelect, IfcWarpingStiffnessSelect, IIfcWarpingStiffnessSelect, IExpressBooleanType, IEquatable<bool>
{
	private bool _value;
