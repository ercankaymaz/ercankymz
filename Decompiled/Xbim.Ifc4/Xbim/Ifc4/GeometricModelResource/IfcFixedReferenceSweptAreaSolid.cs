...
public class IfcFixedReferenceSweptAreaSolid : IfcSweptAreaSolid, IInstantiableEntity, IPersistEntity, IPersist, IIfcFixedReferenceSweptAreaSolid, IIfcSweptAreaSolid, IIfcSolidModel, IIfcGeometricRepresentationItem, IIfcRepresentationItem, IfcLayeredItem, IIfcLayeredItem, IExpressSelectType, IfcBooleanOperand, IIfcBooleanOperand, IfcSolidOrShell, IIfcSolidOrShell, IContainsEntityReferences, IEquatable<IfcFixedReferenceSweptAreaSolid>, IExpressValidatable
{
	...
	public bool ValidateClause(IfcFixedReferenceSweptAreaSolidClause clause)
	{
		...
		try
		{
			if (clause == IfcFixedReferenceSweptAreaSolidClause.DirectrixBounded)
			{
		...
		{
			ValidationLogging.CreateLogger<IfcFixedReferenceSweptAreaSolid>()?.LogError($"Exception thrown evaluating where-clause 'IfcFixedReferenceSweptAreaSolid.{clause}' for #{base.EntityLabel}.", ex);
		}
		return result;
	}
	...
	public override IEnumerable<ValidationResult> Validate()
	{
		...
		if (!ValidateClause(IfcFixedReferenceSweptAreaSolidClause.DirectrixBounded))
		{
			...
			{
				Item = this,
				IssueSource = "IfcFixedReferenceSweptAreaSolid.DirectrixBounded",
