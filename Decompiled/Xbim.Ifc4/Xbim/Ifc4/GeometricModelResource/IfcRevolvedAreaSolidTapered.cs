...
public class IfcRevolvedAreaSolidTapered : IfcRevolvedAreaSolid, IInstantiableEntity, IPersistEntity, IPersist, IIfcRevolvedAreaSolidTapered, IIfcRevolvedAreaSolid, IIfcSweptAreaSolid, IIfcSolidModel, IIfcGeometricRepresentationItem, IIfcRepresentationItem, IfcLayeredItem, IIfcLayeredItem, IExpressSelectType, IfcBooleanOperand, IIfcBooleanOperand, IfcSolidOrShell, IIfcSolidOrShell, IContainsEntityReferences, IEquatable<IfcRevolvedAreaSolidTapered>, IExpressValidatable
{
	...
	public bool ValidateClause(IfcRevolvedAreaSolidTaperedClause clause)
	{
		...
		try
		{
			if (clause == IfcRevolvedAreaSolidTaperedClause.CorrectProfileAssignment)
			{
		...
		{
			ValidationLogging.CreateLogger<IfcRevolvedAreaSolidTapered>()?.LogError($"Exception thrown evaluating where-clause 'IfcRevolvedAreaSolidTapered.{clause}' for #{base.EntityLabel}.", ex);
		}
		return result;
	}
	...
	public override IEnumerable<ValidationResult> Validate()
	{
		...
		if (!ValidateClause(IfcRevolvedAreaSolidTaperedClause.CorrectProfileAssignment))
		{
			...
			{
				Item = this,
				IssueSource = "IfcRevolvedAreaSolidTapered.CorrectProfileAssignment",
