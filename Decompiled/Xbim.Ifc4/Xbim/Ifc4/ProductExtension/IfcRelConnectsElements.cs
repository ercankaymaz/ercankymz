...
public class IfcRelConnectsElements : IfcRelConnects, IInstantiableEntity, IPersistEntity, IPersist, IIfcRelConnectsElements, IIfcRelConnects, IIfcRelationship, IIfcRoot, IContainsEntityReferences, IContainsIndexedReferences, IEquatable<IfcRelConnectsElements>, IExpressValidatable
{
	...
	public bool ValidateClause(IfcRelConnectsElementsClause clause)
	{
		...
		try
		{
			if (clause == IfcRelConnectsElementsClause.NoSelfReference)
			{
	...
	public virtual IEnumerable<ValidationResult> Validate()
	{
		if (!ValidateClause(IfcRelConnectsElementsClause.NoSelfReference))
		{
			...
			{
				Item = this,
				IssueSource = "IfcRelConnectsElements.NoSelfReference",
