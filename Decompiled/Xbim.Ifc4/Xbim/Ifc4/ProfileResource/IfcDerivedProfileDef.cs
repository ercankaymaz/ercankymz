...
public class IfcDerivedProfileDef : IfcProfileDef, IInstantiableEntity, IPersistEntity, IPersist, IIfcDerivedProfileDef, IIfcProfileDef, IfcResourceObjectSelect, IIfcResourceObjectSelect, IExpressSelectType, IContainsEntityReferences, IEquatable<IfcDerivedProfileDef>, IExpressValidatable
{
	...
	public bool ValidateClause(IfcDerivedProfileDefClause clause)
	{
		...
		try
		{
			if (clause == IfcDerivedProfileDefClause.InvariantProfileType)
			{
	...
	public virtual IEnumerable<ValidationResult> Validate()
	{
		if (!ValidateClause(IfcDerivedProfileDefClause.InvariantProfileType))
		{
			...
			{
				Item = this,
				IssueSource = "IfcDerivedProfileDef.InvariantProfileType",
