...
public class IfcLightFixtureType : IfcFlowTerminalType, IInstantiableEntity, IPersistEntity, IPersist, IIfcLightFixtureType, IIfcFlowTerminalType, IIfcDistributionFlowElementType, IIfcDistributionElementType, IIfcElementType, IIfcTypeProduct, IIfcTypeObject, IIfcObjectDefinition, IIfcRoot, IfcDefinitionSelect, IIfcDefinitionSelect, IExpressSelectType, IfcProductSelect, IIfcProductSelect, IContainsEntityReferences, IContainsIndexedReferences, IEquatable<IfcLightFixtureType>, IExpressValidatable
{
	...
	public bool ValidateClause(IfcLightFixtureTypeClause clause)
	{
		...
		try
		{
			if (clause == IfcLightFixtureTypeClause.CorrectPredefinedType)
			{
				result = PredefinedType != IfcLightFixtureTypeEnum.USERDEFINED || (PredefinedType == IfcLightFixtureTypeEnum.USERDEFINED && Functions.EXISTS(base.ElementType));
			}
		}
		catch (Exception ex)
		{
			ValidationLogging.CreateLogger<IfcLightFixtureType>()?.LogError($"Exception thrown evaluating where-clause 'IfcLightFixtureType.{clause}' for #{base.EntityLabel}.", ex);
		}
		return result;
	}
	...
	public override IEnumerable<ValidationResult> Validate()
	{
		...
		if (!ValidateClause(IfcLightFixtureTypeClause.CorrectPredefinedType))
		{
			...
			{
				Item = this,
				IssueSource = "IfcLightFixtureType.CorrectPredefinedType",
