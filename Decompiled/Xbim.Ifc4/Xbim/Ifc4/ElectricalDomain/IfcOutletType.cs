...
public class IfcOutletType : IfcFlowTerminalType, IInstantiableEntity, IPersistEntity, IPersist, IIfcOutletType, IIfcFlowTerminalType, IIfcDistributionFlowElementType, IIfcDistributionElementType, IIfcElementType, IIfcTypeProduct, IIfcTypeObject, IIfcObjectDefinition, IIfcRoot, IfcDefinitionSelect, IIfcDefinitionSelect, IExpressSelectType, IfcProductSelect, IIfcProductSelect, IContainsEntityReferences, IContainsIndexedReferences, IEquatable<IfcOutletType>, IExpressValidatable
{
	...
	public bool ValidateClause(IfcOutletTypeClause clause)
	{
		...
		try
		{
			if (clause == IfcOutletTypeClause.CorrectPredefinedType)
			{
				result = PredefinedType != IfcOutletTypeEnum.USERDEFINED || (PredefinedType == IfcOutletTypeEnum.USERDEFINED && Functions.EXISTS(base.ElementType));
			}
		}
		catch (Exception ex)
		{
			ValidationLogging.CreateLogger<IfcOutletType>()?.LogError($"Exception thrown evaluating where-clause 'IfcOutletType.{clause}' for #{base.EntityLabel}.", ex);
		}
		return result;
	}
	...
	public override IEnumerable<ValidationResult> Validate()
	{
		...
		if (!ValidateClause(IfcOutletTypeClause.CorrectPredefinedType))
		{
			...
			{
				Item = this,
				IssueSource = "IfcOutletType.CorrectPredefinedType",
