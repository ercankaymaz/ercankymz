...
public class IfcJunctionBoxType : IfcFlowFittingType, IInstantiableEntity, IPersistEntity, IPersist, IIfcJunctionBoxType, IIfcFlowFittingType, IIfcDistributionFlowElementType, IIfcDistributionElementType, IIfcElementType, IIfcTypeProduct, IIfcTypeObject, IIfcObjectDefinition, IIfcRoot, IfcDefinitionSelect, IIfcDefinitionSelect, IExpressSelectType, IfcProductSelect, IIfcProductSelect, IContainsEntityReferences, IContainsIndexedReferences, IEquatable<IfcJunctionBoxType>, IExpressValidatable
{
	...
	public bool ValidateClause(IfcJunctionBoxTypeClause clause)
	{
		...
		try
		{
			if (clause == IfcJunctionBoxTypeClause.CorrectPredefinedType)
			{
				result = PredefinedType != IfcJunctionBoxTypeEnum.USERDEFINED || (PredefinedType == IfcJunctionBoxTypeEnum.USERDEFINED && Functions.EXISTS(base.ElementType));
			}
		}
		catch (Exception ex)
		{
			ValidationLogging.CreateLogger<IfcJunctionBoxType>()?.LogError($"Exception thrown evaluating where-clause 'IfcJunctionBoxType.{clause}' for #{base.EntityLabel}.", ex);
		}
		return result;
	}
	...
	public override IEnumerable<ValidationResult> Validate()
	{
		...
		if (!ValidateClause(IfcJunctionBoxTypeClause.CorrectPredefinedType))
		{
			...
			{
				Item = this,
				IssueSource = "IfcJunctionBoxType.CorrectPredefinedType",
