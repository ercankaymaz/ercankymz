...
public class IfcElectricGeneratorType : IfcEnergyConversionDeviceType, IInstantiableEntity, IPersistEntity, IPersist, IIfcElectricGeneratorType, IIfcEnergyConversionDeviceType, IIfcDistributionFlowElementType, IIfcDistributionElementType, IIfcElementType, IIfcTypeProduct, IIfcTypeObject, IIfcObjectDefinition, IIfcRoot, IfcDefinitionSelect, IIfcDefinitionSelect, IExpressSelectType, IfcProductSelect, IIfcProductSelect, IContainsEntityReferences, IContainsIndexedReferences, IEquatable<IfcElectricGeneratorType>, IExpressValidatable
{
	...
	public bool ValidateClause(IfcElectricGeneratorTypeClause clause)
	{
		...
		try
		{
			if (clause == IfcElectricGeneratorTypeClause.CorrectPredefinedType)
			{
				result = PredefinedType != IfcElectricGeneratorTypeEnum.USERDEFINED || (PredefinedType == IfcElectricGeneratorTypeEnum.USERDEFINED && Functions.EXISTS(base.ElementType));
			}
		}
		catch (Exception ex)
		{
			ValidationLogging.CreateLogger<IfcElectricGeneratorType>()?.LogError($"Exception thrown evaluating where-clause 'IfcElectricGeneratorType.{clause}' for #{base.EntityLabel}.", ex);
		}
		return result;
	}
	...
	public override IEnumerable<ValidationResult> Validate()
	{
		...
		if (!ValidateClause(IfcElectricGeneratorTypeClause.CorrectPredefinedType))
		{
			...
			{
				Item = this,
				IssueSource = "IfcElectricGeneratorType.CorrectPredefinedType",
