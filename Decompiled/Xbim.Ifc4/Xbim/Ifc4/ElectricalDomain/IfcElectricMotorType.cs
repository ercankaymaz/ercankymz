...
public class IfcElectricMotorType : IfcEnergyConversionDeviceType, IInstantiableEntity, IPersistEntity, IPersist, IIfcElectricMotorType, IIfcEnergyConversionDeviceType, IIfcDistributionFlowElementType, IIfcDistributionElementType, IIfcElementType, IIfcTypeProduct, IIfcTypeObject, IIfcObjectDefinition, IIfcRoot, IfcDefinitionSelect, IIfcDefinitionSelect, IExpressSelectType, IfcProductSelect, IIfcProductSelect, IContainsEntityReferences, IContainsIndexedReferences, IEquatable<IfcElectricMotorType>, IExpressValidatable
{
	...
	public bool ValidateClause(IfcElectricMotorTypeClause clause)
	{
		...
		try
		{
			if (clause == IfcElectricMotorTypeClause.CorrectPredefinedType)
			{
				result = PredefinedType != IfcElectricMotorTypeEnum.USERDEFINED || (PredefinedType == IfcElectricMotorTypeEnum.USERDEFINED && Functions.EXISTS(base.ElementType));
			}
		}
		catch (Exception ex)
		{
			ValidationLogging.CreateLogger<IfcElectricMotorType>()?.LogError($"Exception thrown evaluating where-clause 'IfcElectricMotorType.{clause}' for #{base.EntityLabel}.", ex);
		}
		return result;
	}
	...
	public override IEnumerable<ValidationResult> Validate()
	{
		...
		if (!ValidateClause(IfcElectricMotorTypeClause.CorrectPredefinedType))
		{
			...
			{
				Item = this,
				IssueSource = "IfcElectricMotorType.CorrectPredefinedType",
