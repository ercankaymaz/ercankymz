...
public class IfcElectricDistributionBoard : IfcFlowController, IInstantiableEntity, IPersistEntity, IPersist, IIfcElectricDistributionBoard, IIfcFlowController, IIfcDistributionFlowElement, IIfcDistributionElement, IIfcElement, IIfcProduct, IIfcObject, IIfcObjectDefinition, IIfcRoot, IfcDefinitionSelect, IIfcDefinitionSelect, IExpressSelectType, IfcProductSelect, IIfcProductSelect, IfcStructuralActivityAssignmentSelect, IIfcStructuralActivityAssignmentSelect, IContainsEntityReferences, IContainsIndexedReferences, IEquatable<IfcElectricDistributionBoard>, IExpressValidatable
{
	...
	public bool ValidateClause(IfcElectricDistributionBoardClause clause)
	{
		...
		try
		{
			...
			case IfcElectricDistributionBoardClause.CorrectPredefinedType:
				result = !Functions.EXISTS(PredefinedType) || PredefinedType != IfcElectricDistributionBoardTypeEnum.USERDEFINED || (PredefinedType == IfcElectricDistributionBoardTypeEnum.USERDEFINED && Functions.EXISTS(base.ObjectType));
				break;
			case IfcElectricDistributionBoardClause.CorrectTypeAssigned:
				result = Functions.SIZEOF(base.IsTypedBy) == 0 || Functions.TYPEOF(base.IsTypedBy.ItemAt(0L).RelatingType).Contains("IFC4.IFCELECTRICDISTRIBUTIONBOARDTYPE");
				break;
			}
		}
		catch (Exception ex)
		{
			ValidationLogging.CreateLogger<IfcElectricDistributionBoard>()?.LogError($"Exception thrown evaluating where-clause 'IfcElectricDistributionBoard.{clause}' for #{base.EntityLabel}.", ex);
		}
		return result;
	}
	...
	public override IEnumerable<ValidationResult> Validate()
	{
		...
		if (!ValidateClause(IfcElectricDistributionBoardClause.CorrectPredefinedType))
		{
			...
			{
				Item = this,
				IssueSource = "IfcElectricDistributionBoard.CorrectPredefinedType",
		...
		if (!ValidateClause(IfcElectricDistributionBoardClause.CorrectTypeAssigned))
		{
			...
			{
				Item = this,
				IssueSource = "IfcElectricDistributionBoard.CorrectTypeAssigned",
				IssueType = ValidationFlags.EntityWhereClauses
			};
		}
	}
