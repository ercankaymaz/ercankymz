...
public class IfcCableCarrierFittingType : IfcFlowFittingType, IInstantiableEntity, IPersistEntity, IPersist, IIfcCableCarrierFittingType, IIfcFlowFittingType, IIfcDistributionFlowElementType, IIfcDistributionElementType, IIfcElementType, IIfcTypeProduct, IIfcTypeObject, IIfcObjectDefinition, IIfcRoot, IfcDefinitionSelect, IIfcDefinitionSelect, IExpressSelectType, IfcProductSelect, IIfcProductSelect, IContainsEntityReferences, IContainsIndexedReferences, IEquatable<IfcCableCarrierFittingType>, IExpressValidatable
{
	...
	public bool ValidateClause(IfcCableCarrierFittingTypeClause clause)
	{
		...
		try
		{
			if (clause == IfcCableCarrierFittingTypeClause.CorrectPredefinedType)
			{
	...
	public override IEnumerable<ValidationResult> Validate()
	{
		...
		if (!ValidateClause(IfcCableCarrierFittingTypeClause.CorrectPredefinedType))
		{
			...
			{
				Item = this,
				IssueSource = "IfcCableCarrierFittingType.CorrectPredefinedType",
