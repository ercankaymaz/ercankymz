...
public class IfcStructuralPointReaction : IfcStructuralReaction, IInstantiableEntity, IPersistEntity, IPersist, IIfcStructuralPointReaction, IIfcStructuralReaction, IIfcStructuralActivity, IIfcProduct, IIfcObject, IIfcObjectDefinition, IIfcRoot, IfcDefinitionSelect, IIfcDefinitionSelect, IExpressSelectType, IfcProductSelect, IIfcProductSelect, IContainsEntityReferences, IContainsIndexedReferences, IEquatable<IfcStructuralPointReaction>, IExpressValidatable
{
	...
	public bool ValidateClause(IfcStructuralPointReactionClause clause)
	{
		...
		try
		{
			if (clause == IfcStructuralPointReactionClause.SuitableLoadType)
			{
	...
	public override IEnumerable<ValidationResult> Validate()
	{
		...
		if (!ValidateClause(IfcStructuralPointReactionClause.SuitableLoadType))
		{
			...
			{
				Item = this,
				IssueSource = "IfcStructuralPointReaction.SuitableLoadType",
