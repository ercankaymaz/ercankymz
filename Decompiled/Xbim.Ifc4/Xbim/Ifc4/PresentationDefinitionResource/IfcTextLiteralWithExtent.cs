...
public class IfcTextLiteralWithExtent : IfcTextLiteral, IInstantiableEntity, IPersistEntity, IPersist, IIfcTextLiteralWithExtent, IIfcTextLiteral, IIfcGeometricRepresentationItem, IIfcRepresentationItem, IfcLayeredItem, IIfcLayeredItem, IExpressSelectType, IContainsEntityReferences, IEquatable<IfcTextLiteralWithExtent>, IExpressValidatable
{
	...
	public bool ValidateClause(IfcTextLiteralWithExtentClause clause)
	{
		...
		try
		{
			...
			{
				result = !Functions.TYPEOF(Extent).Contains("IFC4.IFCPLANARBOX");
			}
		}
		catch (Exception ex)
		{
