...
public class IfcDistributionFlowElement : IfcDistributionElement, IInstantiableEntity, IPersistEntity, IPersist, IIfcDistributionFlowElement, IIfcDistributionElement, IIfcElement, IIfcProduct, IIfcObject, IIfcObjectDefinition, IIfcRoot, IfcDefinitionSelect, IIfcDefinitionSelect, IExpressSelectType, IfcProductSelect, IIfcProductSelect, IfcStructuralActivityAssignmentSelect, IIfcStructuralActivityAssignmentSelect, IContainsEntityReferences, IContainsIndexedReferences, IEquatable<IfcDistributionFlowElement>
{
	IEnumerable<IIfcRelFlowControlElements> IIfcDistributionFlowElement.HasControlElements => HasControlElements;
