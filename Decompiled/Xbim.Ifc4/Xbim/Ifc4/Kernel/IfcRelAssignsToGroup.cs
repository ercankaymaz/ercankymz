...
public class IfcRelAssignsToGroup : IfcRelAssigns, IInstantiableEntity, IPersistEntity, IPersist, IIfcRelAssignsToGroup, IIfcRelAssigns, IIfcRelationship, IIfcRoot, IContainsEntityReferences, IContainsIndexedReferences, IEquatable<IfcRelAssignsToGroup>, IExpressValidatable
{
	...
	public bool ValidateClause(IfcRelAssignsToGroupClause clause)
	{
		...
		try
		{
			if (clause == IfcRelAssignsToGroupClause.NoSelfReference)
			{
	...
	public override IEnumerable<ValidationResult> Validate()
	{
		...
		if (!ValidateClause(IfcRelAssignsToGroupClause.NoSelfReference))
		{
			...
			{
				Item = this,
				IssueSource = "IfcRelAssignsToGroup.NoSelfReference",
