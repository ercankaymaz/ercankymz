...
public class IfcGroup : IfcObject, IInstantiableEntity, IPersistEntity, IPersist, IIfcGroup, IIfcObject, IIfcObjectDefinition, IIfcRoot, IfcDefinitionSelect, IIfcDefinitionSelect, IExpressSelectType, IContainsEntityReferences, IEquatable<IfcGroup>
{
	IEnumerable<IIfcRelAssignsToGroup> IIfcGroup.IsGroupedBy => IsGroupedBy;
