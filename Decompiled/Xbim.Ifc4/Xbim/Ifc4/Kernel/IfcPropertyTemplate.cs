...
public abstract class IfcPropertyTemplate : IfcPropertyTemplateDefinition, IIfcPropertyTemplate, IIfcPropertyTemplateDefinition, IIfcPropertyDefinition, IIfcRoot, IPersistEntity, IPersist, IfcDefinitionSelect, IIfcDefinitionSelect, IExpressSelectType, IEquatable<IfcPropertyTemplate>
{
	IEnumerable<IIfcComplexPropertyTemplate> IIfcPropertyTemplate.PartOfComplexTemplate => PartOfComplexTemplate;

	IEnumerable<IIfcPropertySetTemplate> IIfcPropertyTemplate.PartOfPsetTemplate => PartOfPsetTemplate;
