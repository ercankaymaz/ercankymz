...
public class IfcRelAssignsToActor : IfcRelAssigns, IInstantiableEntity, IPersistEntity, IPersist, IIfcRelAssignsToActor, IIfcRelAssigns, IIfcRelationship, IIfcRoot, IContainsEntityReferences, IContainsIndexedReferences, IEquatable<IfcRelAssignsToActor>, IExpressValidatable
{
	...
	public bool ValidateClause(IfcRelAssignsToActorClause clause)
	{
		...
		try
		{
			if (clause == IfcRelAssignsToActorClause.NoSelfReference)
			{
	...
	public override IEnumerable<ValidationResult> Validate()
	{
		...
		if (!ValidateClause(IfcRelAssignsToActorClause.NoSelfReference))
		{
			...
			{
				Item = this,
				IssueSource = "IfcRelAssignsToActor.NoSelfReference",
