...
public class IfcPolyLoop : IfcLoop, IInstantiableEntity, IPersistEntity, IPersist, IIfcPolyLoop, IIfcLoop, IIfcTopologicalRepresentationItem, IIfcRepresentationItem, IfcLayeredItem, IIfcLayeredItem, IExpressSelectType, IContainsEntityReferences, IEquatable<IfcPolyLoop>, IExpressValidatable
{
	...
	public bool ValidateClause(IfcPolyLoopClause clause)
	{
		...
		try
		{
			if (clause == IfcPolyLoopClause.AllPointsSameDim)
			{
	...
	public virtual IEnumerable<ValidationResult> Validate()
	{
		if (!ValidateClause(IfcPolyLoopClause.AllPointsSameDim))
		{
			...
			{
				Item = this,
				IssueSource = "IfcPolyLoop.AllPointsSameDim",
