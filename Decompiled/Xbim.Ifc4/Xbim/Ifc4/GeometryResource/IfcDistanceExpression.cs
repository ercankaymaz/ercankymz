...
public class IfcDistanceExpression : IfcGeometricRepresentationItem, IInstantiableEntity, IPersistEntity, IPersist, IIfcDistanceExpression, IIfcGeometricRepresentationItem, IIfcRepresentationItem, IfcLayeredItem, IIfcLayeredItem, IExpressSelectType, IEquatable<IfcDistanceExpression>
{
	...
	IfcLengthMeasure? IIfcDistanceExpression.OffsetLongitudinal
	{
		get
		{
			return OffsetLongitudinal;
		}
		set
		{
			OffsetLongitudinal = value;
		}
	}
	...
	IfcBoolean? IIfcDistanceExpression.AlongHorizontal
	{
		get
		{
			return AlongHorizontal;
		}
		set
		{
			AlongHorizontal = value;
		}
	}
	...
	public IfcBoolean? AlongHorizontal
	{
		...
		set
		{
			...
			{
				_alongHorizontal = v;
			}, _alongHorizontal, value, "AlongHorizontal", 5);
		}
	}

	internal IfcDistanceExpression(IModel model, int label, bool activated)
