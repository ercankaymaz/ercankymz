...
[ToolboxItem(false)]
public class KryptonDataGridViewDomainUpDownEditingControl : KryptonDomainUpDown, IDataGridViewEditingControl
{
	...
	public virtual bool EditingControlWantsInputKey(Keys keyData, bool dataGridViewWantsInputKey)
	{
		...
		{
		case Keys.Right:
			if (base.Controls[0].Controls[1] is TextBox textBox3 && ((RightToLeft == RightToLeft.No && (textBox3.SelectionLength != 0 || textBox3.SelectionStart != textBox3.Text.Length)) || (RightToLeft == RightToLeft.Yes && (textBox3.SelectionLength != 0 || textBox3.SelectionStart != 0))))
			{
				return true;
			}
			break;
		case Keys.Left:
			if (base.Controls[0].Controls[1] is TextBox textBox2 && ((RightToLeft == RightToLeft.No && (textBox2.SelectionLength != 0 || textBox2.SelectionStart != 0)) || (RightToLeft == RightToLeft.Yes && (textBox2.SelectionLength != 0 || textBox2.SelectionStart != textBox2.Text.Length))))
			{
				return true;
			}
			break;
