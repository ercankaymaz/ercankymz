...
public abstract class PaletteOffice2007Base : PaletteBase
{
	...
	private static readonly Color[] _ribbonGroupCollapsedBorderContextTracking = new Color[4]
	{
	...
	private static readonly Color[] _buttonBorderColors = new Color[7]
	{
		...
		Color.FromArgb(221, 207, 155),
		Color.FromArgb(192, 167, 119),
		Color.FromArgb(147, 125, 90),
		Color.FromArgb(255, 196, 68),
		Color.FromArgb(158, 130, 85),
		Color.FromArgb(254, 218, 144)
	};
	...
	private static readonly Color[] _buttonBackColors = new Color[10]
	{
		...
		Color.FromArgb(255, 213, 77),
		Color.FromArgb(255, 239, 177),
		Color.FromArgb(235, 122, 5),
		Color.FromArgb(254, 195, 108),
		Color.FromArgb(254, 175, 77),
		Color.FromArgb(254, 230, 136),
		Color.FromArgb(232, 142, 49),
		Color.FromArgb(252, 207, 100)
	};
	...
	public PaletteOffice2007Base(Color[] schemeColors, ImageList checkBoxList, ImageList galleryButtonList, Image[] radioButtonArray, Color[] trackBarColors)
	{
	...
	public override Color GetBackColor1(PaletteBackStyle style, PaletteState state)
	{
		...
		case PaletteBackStyle.ContextMenuItemHighlight:
			...
			case PaletteState.Normal:
				return style switch
				{
					PaletteBackStyle.ButtonNavigatorStack => _ribbonColors[9], 
					PaletteBackStyle.ButtonNavigatorMini => _ribbonColors[159], 
					PaletteBackStyle.ButtonCluster => _ribbonColors[155], 
					_ => _ribbonColors[5], 
				};
			case PaletteState.NormalDefaultOverride:
	...
	public override Color GetBackColor2(PaletteBackStyle style, PaletteState state)
	{
		...
		case PaletteBackStyle.ContextMenuItemHighlight:
			...
			case PaletteState.Normal:
				return style switch
				{
					PaletteBackStyle.ButtonNavigatorStack => _ribbonColors[10], 
					PaletteBackStyle.ButtonNavigatorMini => _ribbonColors[159], 
					PaletteBackStyle.ButtonCluster => _ribbonColors[156], 
					_ => _ribbonColors[6], 
				};
			case PaletteState.NormalDefaultOverride:
	...
	public override Color GetElementColor2(PaletteElement element, PaletteState state)
	{
		...
		case PaletteElement.TrackBarPosition:
			return state switch
			{
				PaletteState.Disabled => ControlPaint.Light(_ribbonColors[3]), 
				PaletteState.Normal => _ribbonColors[3], 
				PaletteState.Tracking => _buttonBorderColors[1], 
