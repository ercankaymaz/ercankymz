...
public class CheckBoxController : GlobalId, IMouseController, IKeyController
{
	...
	public CheckBoxController(ViewDrawCheckBox target, ViewBase top, NeedPaintHandler needPaint)
	{
