...
public class PaletteTripleRedirect : Storage, IPaletteTriple
{
	...
	public PaletteTripleRedirect(PaletteBackStyle backStyle, PaletteBorderStyle borderStyle, PaletteContentStyle contentStyle)
		: this(null, backStyle, borderStyle, contentStyle, null)
	{
	}

	public PaletteTripleRedirect(PaletteRedirect redirect, PaletteBackStyle backStyle, PaletteBorderStyle borderStyle, PaletteContentStyle contentStyle)
		: this(redirect, backStyle, borderStyle, contentStyle, null)
	{
	}

	public PaletteTripleRedirect(PaletteRedirect redirect, PaletteBackStyle backStyle, PaletteBorderStyle borderStyle, PaletteContentStyle contentStyle, NeedPaintHandler needPaint)
	{
		NeedPaint = needPaint;
