...
public class PaletteRibbonBackRedirect : Storage, IPaletteRibbonBack
{
	...
	public PaletteRibbonBackRedirect(PaletteRedirect redirect, PaletteRibbonBackStyle backStyle, NeedPaintHandler needPaint)
	{
