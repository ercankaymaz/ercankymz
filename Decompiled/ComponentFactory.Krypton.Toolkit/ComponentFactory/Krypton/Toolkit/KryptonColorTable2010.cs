...
public class KryptonColorTable2010 : KryptonColorTable
{
	...
	public override Color MenuStripText => _colors[21];

	public override Color ToolStripText => _colors[21];
	...
	{
		_contextMenuBackground = Color.White;
		_menuBorder = Color.FromArgb(167, 171, 176);
		_checkBackground = Color.FromArgb(252, 241, 194);
		_buttonSelectedBegin = Color.FromArgb(251, 242, 215);
		_buttonSelectedEnd = Color.FromArgb(247, 224, 135);
		_buttonPressedBegin = Color.FromArgb(255, 228, 138);
		_buttonPressedEnd = Color.FromArgb(255, 228, 138);
		_buttonCheckedBegin = Color.FromArgb(255, 216, 107);
		_buttonCheckedEnd = Color.FromArgb(255, 216, 107);
		_menuItemSelectedBegin = Color.FromArgb(251, 242, 215);
		_menuItemSelectedEnd = Color.FromArgb(247, 224, 135);
		DefineFonts();
		SystemEvents.UserPreferenceChanged += OnUserPreferenceChanged;
	}

	public KryptonColorTable2010(Color[] colors, InheritBool roundedEdges, IPalette palette)
		: base(palette)
	{
