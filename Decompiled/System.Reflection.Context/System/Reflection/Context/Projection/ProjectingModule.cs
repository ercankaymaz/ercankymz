...
internal class ProjectingModule : DelegatingModule, IProjectable
{
	...
	{
		if (o is ProjectingModule projectingModule && Projector == projectingModule.Projector)
		{
			return base.UnderlyingModule.Equals(projectingModule.UnderlyingModule);
		}
		return false;
	}
	...
	{
		return Projector.GetHashCode() ^ base.UnderlyingModule.GetHashCode();
	}
}
