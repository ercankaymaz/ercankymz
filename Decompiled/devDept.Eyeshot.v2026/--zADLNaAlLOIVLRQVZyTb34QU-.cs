...
internal sealed class _0023_003DzADLNaAlLOIVLRQVZyTb34QU_003D : _0023_003DzyJOsF5kmoztS1I0Xzw_003D_003D
{
	private List<int> _0023_003DzefSRPfQB4pcq;

	private bool _0023_003Dzx3pYiE0_003D;

	internal List<_0023_003Dz0PtOsx4SvG1pVHiJnQ_003D_003D> _0023_003DzKlDKzzmmmACL;

	internal _0023_003DzADLNaAlLOIVLRQVZyTb34QU_003D(int _0023_003DzkXQ_IWk_003D, string _0023_003DzY4oh8qo_003D, string _0023_003DzPzO_0024GUk_003D, Dictionary<int, _0023_003DzyJOsF5kmoztS1I0Xzw_003D_003D> _0023_003Dz9UNAzE0_003D, ref int _0023_003DzJjVQTzpKI4Ni, bool _0023_003Dzm4CSmX5Y3o6Q)
	...
	{
		_0023_003DzefSRPfQB4pcq = null;
		_0023_003DzKlDKzzmmmACL = null;
	...
	internal override void _0023_003Dz9GKXKtrg_0024MPY(Dictionary<int, _0023_003DzyJOsF5kmoztS1I0Xzw_003D_003D> _0023_003Dz9UNAzE0_003D, bool _0023_003Dzm4CSmX5Y3o6Q)
	{
		...
		case (_0023_003DzyPjMV3hYmPOOmhGI9w_003D_003D)0:
		{
			...
			_0023_003DzefSRPfQB4pcq = new List<int>();
			...
			while (_0023_003DzgPsOl1A_003D.Length > 0)
			{
				...
				_0023_003DzefSRPfQB4pcq.Add(item2);
			}
			text = text.Remove(0, num2 + 1);
			text = text.Remove(0, 1);
			text = text.Trim();
			if (text == _0023_003DzUEQYRfd1JtmmO3VsmaV_0024uUiBTuoh._0023_003DzE8QrneA_003D(-302920778))
			{
		...
		{
			_0023_003DzKlDKzzmmmACL = new List<_0023_003Dz0PtOsx4SvG1pVHiJnQ_003D_003D>();
			for (int i = 0; i < _0023_003DzefSRPfQB4pcq.Count; i++)
			{
				int _0023_003DzoiYtBx0_003D = _0023_003DzefSRPfQB4pcq[i];
				...
				_0023_003DzKlDKzzmmmACL.Add(item);
			}
			if (_0023_003DzefSRPfQB4pcq.Count > 0)
			{
