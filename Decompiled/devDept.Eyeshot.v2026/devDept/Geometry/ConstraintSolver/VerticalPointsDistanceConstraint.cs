...
[Serializable]
public class VerticalPointsDistanceConstraint : PointsDistanceConstraint
{
	private sealed class _0023_003DzWenArCRVJfIBcd_l2LPmAyR41pQy : IEnumerable<Exp>, IEnumerable, IEnumerator<Exp>, IDisposable, IEnumerator
	{
		...
		[DebuggerBrowsable(DebuggerBrowsableState.Never)]
		public VerticalPointsDistanceConstraint _0023_003DzopRx0_MBcTQs;
		...
		private bool MoveNext()
		{
			...
			VerticalPointsDistanceConstraint verticalPointsDistanceConstraint = _0023_003DzopRx0_MBcTQs;
			switch (num)
			{
			default:
				return false;
			case 0:
				...
				_0023_003DzezVIuujSK1H9 = Exp._0023_003Dz0v89Hn0_003D(verticalPointsDistanceConstraint._0023_003DzMz6jweqqHEoi().y - verticalPointsDistanceConstraint._0023_003DzDO1A1VPzNcGH().y) - verticalPointsDistanceConstraint.value;
				_0023_003DzU7pGb3X7Zp4G = 1;
				return true;
			case 1:
				_0023_003DzU7pGb3X7Zp4G = -1;
	...
	protected VerticalPointsDistanceConstraint(VerticalPointsDistanceConstraint another)
		: base(another)
	{
	}

	internal VerticalPointsDistanceConstraint(SketchInternal _0023_003DzjCETKTg_003D)
		: base(_0023_003DzjCETKTg_003D)
	{
	}

	internal VerticalPointsDistanceConstraint(SketchInternal _0023_003DzjCETKTg_003D, SketchCurve _0023_003DzDVubtvo_003D, SketchCurve _0023_003DzFj_0024IqDQ_003D)
		: base(_0023_003DzjCETKTg_003D)
	{
	...
	protected VerticalPointsDistanceConstraint(SerializationInfo info, StreamingContext context)
		: base(info, context)
	{
	}
	...
	{
		return new VerticalPointsDistanceConstraint(this);
	}

	public override SketchItemSurrogate ConvertToSurrogate()
	{
		return new VerticalPointsDistanceConstraintSurrogate(this);
	}
}
