...
[Serializable]
public class PointsDistanceConstraint : ValueConstraint
{
	private sealed class _0023_003DzVyY8axO2M0gfjoHHUy_0024FgrPhY2e7 : IEnumerable<Exp>, IEnumerable, IEnumerator<Exp>, IDisposable, IEnumerator
	{
		...
		[DebuggerBrowsable(DebuggerBrowsableState.Never)]
		public PointsDistanceConstraint _0023_003DzopRx0_MBcTQs;
		...
		private bool MoveNext()
		{
			...
			PointsDistanceConstraint pointsDistanceConstraint = _0023_003DzopRx0_MBcTQs;
			switch (num)
			{
			default:
				return false;
			case 0:
				...
				_0023_003DzezVIuujSK1H9 = (pointsDistanceConstraint._0023_003DzDO1A1VPzNcGH() - pointsDistanceConstraint._0023_003DzMz6jweqqHEoi())._0023_003Dz9AfN_TRv_0024HgPy9WmXQ_003D_003D() - pointsDistanceConstraint.value;
				_0023_003DzU7pGb3X7Zp4G = 1;
				return true;
			case 1:
				_0023_003DzU7pGb3X7Zp4G = -1;
	...
	protected PointsDistanceConstraint(PointsDistanceConstraint another)
		: base(another)
	{
	}

	internal PointsDistanceConstraint(SketchInternal _0023_003DzjCETKTg_003D)
		: base(_0023_003DzjCETKTg_003D)
	{
	}

	internal PointsDistanceConstraint(SketchInternal _0023_003DzjCETKTg_003D, SketchCurve _0023_003DzDVubtvo_003D, SketchCurve _0023_003DzFj_0024IqDQ_003D)
		: base(_0023_003DzjCETKTg_003D)
	{
	...
	internal PointsDistanceConstraint(SketchInternal _0023_003DzjCETKTg_003D, SketchCurve _0023_003DzQ9zpGF0_003D)
		: base(_0023_003DzjCETKTg_003D)
	{
	...
	protected PointsDistanceConstraint(SerializationInfo info, StreamingContext context)
		: base(info, context)
	{
	}
	...
	{
		return new PointsDistanceConstraintSurrogate(this);
	}

	public override object Clone()
	{
		return new PointsDistanceConstraint(this);
	}
}
