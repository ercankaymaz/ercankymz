...
[Serializable]
public class RadiusConstraint : ValueConstraint
{
	private sealed class _0023_003DzWenArCRVJfIBcd_l2LPmAyR41pQy : IEnumerable<Exp>, IEnumerable, IEnumerator<Exp>, IDisposable, IEnumerator
	{
		...
		[DebuggerBrowsable(DebuggerBrowsableState.Never)]
		public RadiusConstraint _0023_003DzopRx0_MBcTQs;
		...
		private bool MoveNext()
		{
			...
			RadiusConstraint radiusConstraint = _0023_003DzopRx0_MBcTQs;
			switch (num)
			{
			default:
				return false;
			case 0:
				...
				_0023_003DzezVIuujSK1H9 = radiusConstraint._0023_003DzoPb07OyIaX8qIXzNOg_003D_003D() - radiusConstraint.value._0023_003Dzuc1z_scDJBr3();
				_0023_003DzU7pGb3X7Zp4G = 1;
				return true;
			case 1:
				_0023_003DzU7pGb3X7Zp4G = -1;
	...
	protected RadiusConstraint(RadiusConstraint another)
		: base(another)
	{
	}

	internal RadiusConstraint(SketchInternal _0023_003DzjCETKTg_003D)
		: base(_0023_003DzjCETKTg_003D)
	{
	}

	internal RadiusConstraint(SketchInternal _0023_003DzjCETKTg_003D, SketchCurve _0023_003Dzt_m8zV0_003D)
		: base(_0023_003DzjCETKTg_003D)
	{
		_0023_003DzRCrpdGA_003D(_0023_003Dzt_m8zV0_003D);
		_0023_003Dz_09KxNE_003D();
	}

	protected RadiusConstraint(SerializationInfo info, StreamingContext context)
		: base(info, context)
	{
	}

	internal Exp _0023_003DzoPb07OyIaX8qIXzNOg_003D_003D()
	{
		return _0023_003Dzjrbkyo8_003D(0)._0023_003DzQoC8eSxbb9t_BV2MfA_003D_003D();
	}

	private ExpVector _0023_003DzsGjVyiMm6GGV()
	{
		return _0023_003Dzjrbkyo8_003D(0)._0023_003DzvZpvBdFc_0024vJr0ob44g_003D_003D(null);
	}
	...
	{
		return _0023_003DzCJa3xJlr6RLsK4xYxg_003D_003D().plane._0023_003Dz7d5lgPw_003D() * new Translation(_0023_003Dzjrbkyo8_003D(0)._0023_003DzvZpvBdFc_0024vJr0ob44g_003D_003D(_0023_003DzCJa3xJlr6RLsK4xYxg_003D_003D().plane)._0023_003DzBUjqlpM_003D());
	}

	public override SketchItemSurrogate ConvertToSurrogate()
	{
		return new RadiusConstraintSurrogate(this);
	}

	public override object Clone()
	{
		return new RadiusConstraint(this);
	}
	...
	{
		RadiusConstraint radiusConstraint = new RadiusConstraint(_0023_003DzCJa3xJlr6RLsK4xYxg_003D_003D(), _0023_003Dz8y2RdxeriOVAZjAcCg_003D_003D);
		radiusConstraint.SetValue(value._0023_003DzV29zQ3g_003D());
