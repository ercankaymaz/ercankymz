	...
	public override object ConvertTo(ITypeDescriptorContext context, CultureInfo culture, object value, Type destinationType)
	{
		if (value is Point2D)
		{
			if (destinationType == typeof(string))
			{
				...
				return string.Format(_0023_003DzUEQYRfd1JtmmO3VsmaV_0024uUiBTuoh._0023_003DzE8QrneA_003D(-302982525), point2D.X, point2D.Y);
			}
			if (destinationType == typeof(InstanceDescriptor))
			{
				Point2D point2D2 = (Point2D)value;
				...
				array[1] = point2D2.Y;
				return new InstanceDescriptor(typeof(Point2D).GetConstructor(array2), array);
			}
		}
