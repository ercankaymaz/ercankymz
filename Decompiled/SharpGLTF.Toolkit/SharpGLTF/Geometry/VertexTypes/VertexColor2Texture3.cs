...
public struct VertexColor2Texture3 : IVertexMaterial, IVertexReflection, IEquatable<VertexColor2Texture3>
{
	...
	public override readonly int GetHashCode()
	{
		...
		return ((object)Color0/*cast due to constrained. prefix*/).GetHashCode() + ((object)Color1/*cast due to constrained. prefix*/).GetHashCode() + ((object)TexCoord0/*cast due to constrained. prefix*/).GetHashCode() + ((object)TexCoord1/*cast due to constrained. prefix*/).GetHashCode() + ((object)TexCoord2/*cast due to constrained. prefix*/).GetHashCode();
	}

	public override readonly bool Equals(object obj)
	{
		if (!(obj is VertexColor2Texture3 other))
		{
			return false;
		}
		return Equals(other);
	...
	{
		return new VertexMaterialDelta((VertexColor2Texture3)(object)baseValue, this);
	}
