...
public struct VertexColor1Texture4 : IVertexMaterial, IVertexReflection, IEquatable<VertexColor1Texture4>
{
	...
	public override readonly int GetHashCode()
	{
		...
		return ((object)Color/*cast due to constrained. prefix*/).GetHashCode() + ((object)TexCoord0/*cast due to constrained. prefix*/).GetHashCode() + ((object)TexCoord1/*cast due to constrained. prefix*/).GetHashCode() + ((object)TexCoord2/*cast due to constrained. prefix*/).GetHashCode() + ((object)TexCoord3/*cast due to constrained. prefix*/).GetHashCode();
	}

	public override readonly bool Equals(object obj)
	{
		if (!(obj is VertexColor1Texture4 other))
		{
			return false;
		}
		return Equals(other);
	...
	{
		return new VertexMaterialDelta((VertexColor1Texture4)(object)baseValue, this);
	}
