...
public struct VertexTexture2 : IVertexMaterial, IVertexReflection, IEquatable<VertexTexture2>
{
	...
	public override readonly int GetHashCode()
	{
		...
		return ((object)TexCoord0/*cast due to constrained. prefix*/).GetHashCode() + ((object)TexCoord1/*cast due to constrained. prefix*/).GetHashCode();
	}

	public override readonly bool Equals(object obj)
	{
		if (!(obj is VertexTexture2 other))
		{
			return false;
		}
		return Equals(other);
	...
	{
		return new VertexMaterialDelta((VertexTexture2)(object)baseValue, this);
	}
