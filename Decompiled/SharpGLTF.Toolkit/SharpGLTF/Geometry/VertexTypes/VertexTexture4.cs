...
public struct VertexTexture4 : IVertexMaterial, IVertexReflection, IEquatable<VertexTexture4>
{
	...
	public override readonly int GetHashCode()
	{
		...
		return ((object)TexCoord0/*cast due to constrained. prefix*/).GetHashCode() + ((object)TexCoord1/*cast due to constrained. prefix*/).GetHashCode() + ((object)TexCoord2/*cast due to constrained. prefix*/).GetHashCode() + ((object)TexCoord3/*cast due to constrained. prefix*/).GetHashCode();
	}

	public override readonly bool Equals(object obj)
	{
		if (!(obj is VertexTexture4 other))
		{
			return false;
		}
		return Equals(other);
	...
	{
		return new VertexMaterialDelta((VertexTexture4)(object)baseValue, this);
	}
