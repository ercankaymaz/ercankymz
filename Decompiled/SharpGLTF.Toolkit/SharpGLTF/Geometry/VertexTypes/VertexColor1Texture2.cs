...
public struct VertexColor1Texture2 : IVertexMaterial, IVertexReflection, IEquatable<VertexColor1Texture2>
{
	...
	public override readonly int GetHashCode()
	{
		...
		return ((object)Color/*cast due to constrained. prefix*/).GetHashCode() + ((object)TexCoord0/*cast due to constrained. prefix*/).GetHashCode() + ((object)TexCoord1/*cast due to constrained. prefix*/).GetHashCode();
	}

	public override readonly bool Equals(object obj)
	{
		if (!(obj is VertexColor1Texture2 other))
		{
			return false;
		}
		return Equals(other);
	...
	{
		return new VertexMaterialDelta((VertexColor1Texture2)(object)baseValue, this);
	}
