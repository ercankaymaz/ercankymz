...
internal interface IJetApi
{
	...
	int JetGetIndexInfo(JET_SESID sesid, JET_DBID dbid, string tablename, string indexname, out JET_INDEXCREATE result, JET_IdxInfo infoLevel);
	...
	int JetGetTableIndexInfo(JET_SESID sesid, JET_TABLEID tableid, string indexname, out JET_INDEXCREATE result, JET_IdxInfo infoLevel);
	...
	int JetEnumerateColumns(JET_SESID sesid, JET_TABLEID tableid, EnumerateColumnsGrbit grbit, out IEnumerable<EnumeratedColumn> enumeratedColumns);
	...
	int Defragment(JET_SESID sesid, JET_DBID dbid, string tableName, DefragGrbit grbit);
	...
	int JetGetSessionParameter(JET_SESID sesid, JET_sesparam sesparamid, out JET_OPERATIONCONTEXT operationContext);
	...
	int JetGetSessionParameter(JET_SESID sesid, JET_sesparam sesparamid, byte[] data, int length, out int actualDataSize);
