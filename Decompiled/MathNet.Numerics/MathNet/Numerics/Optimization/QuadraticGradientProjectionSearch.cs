...
{
	public readonly struct GradientProjectionResult(Vector<double> cauchyPoint, int fixedCount, List<bool> isFixed)
	{
		public Vector<double> CauchyPoint { get; } = cauchyPoint;

		public int FixedCount { get; } = fixedCount;

		public List<bool> IsFixed { get; } = isFixed;
	}
