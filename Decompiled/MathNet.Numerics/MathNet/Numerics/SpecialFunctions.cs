...
public static class SpecialFunctions
{
	...
	public static double BetaRegularized(double a, double b, double x)
	{
		...
		double num7 = a - 1.0;
		double num8 = 1.0;
		double num9 = 1.0 - num5 * x / num6;
		if (Math.Abs(num9) < num2)
		{
			num9 = num2;
		}
		num9 = 1.0 / num9;
		...
		while (num11 <= 50000)
		{
			double num13 = (double)num11 * (b - (double)num11) * x / ((num7 + (double)num12) * (a + (double)num12));
			num9 = 1.0 + num13 * num9;
			if (Math.Abs(num9) < num2)
			{
				num9 = num2;
			...
			num9 = 1.0 / num9;
			num10 *= num9 * num8;
			num13 = (0.0 - (a + (double)num11)) * (num5 + (double)num11) * x / ((a + (double)num12) * (num6 + (double)num12));
			num9 = 1.0 + num13 * num9;
			if (Math.Abs(num9) < num2)
			{
				num9 = num2;
			...
			num10 *= num14;
			if (Math.Abs(num14 - 1.0) <= doublePrecision)
			{
				if (!flag)
				{
					return num * num10 / a;
				}
				return 1.0 - num * num10 / a;
			}
			num11++;
			num12 += 2;
		}
