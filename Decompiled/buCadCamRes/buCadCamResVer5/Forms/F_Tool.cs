...
public class F_Tool : Form
{
  ...
  private void SaveMachineLimitsClick(object sender, EventArgs e)
  {
    ...
    try
    {
      ...
      buLogVer5.addToList(nameof (F_Tool), nameof (SaveMachineLimitsClick), "FiveAxisSafety", "Saved", FiveAxisPathSafety.ConfigurationRevision.ToString());
  ...
  private void LoadMachineLimitsClick(object sender, EventArgs e)
  {
    try
    {
      ...
      FiveAxisPathSafety.Configure(profile);
      buLogVer5.addToList(nameof (F_Tool), nameof (LoadMachineLimitsClick), "FiveAxisSafety", "Loaded", FiveAxisPathSafety.ConfigurationRevision.ToString());
