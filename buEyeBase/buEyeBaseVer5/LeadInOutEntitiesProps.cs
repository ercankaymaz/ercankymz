...
// Type: buEyeBaseVer5.LeadInOutEntitiesProps
...
public class LeadInOutEntitiesProps : buSerilization5
{
  ...
  public LeadInOutEntitiesProps(MWCalculationOptions data)
  {
    ...
    ((CamEntitiesTobuEntities) data).DevideData = new EntityDevideData(((CamEntitiesTobuEntities) data).DevideData);
    ((CamEntitiesTobuEntities) data).SortingSettings = (SortSettings) new ShapeRuntimeData(((CamEntitiesTobuEntities) data).SortingSettings);
  }

  public abstract void m000156();
