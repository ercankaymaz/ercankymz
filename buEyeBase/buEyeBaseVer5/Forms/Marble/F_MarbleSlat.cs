...
// Type: buEyeBaseVer5.Forms.Marble.F_MarbleSlat
...
public class F_MarbleSlat : Form
{
  ...
  {
    if (((F_MarbleCountertopEdge) this).Properties.Result == DialogResult.OK)
      return;
    obj1.Cancel = true;
    ((F_MarbleCountertopEdge) this).Properties.Result = DialogResult.Cancel;
    if (((F_MarbleCountertopEdge) this).Properties.FormCloseMode == FormCloseModeType.Dispose)
      this.Dispose();
    if (((F_MarbleCountertopEdge) this).Properties.FormCloseMode != FormCloseModeType.Invisible)
      return;
    this.Visible = false;
  }
  ...
  internal void \u0001([In] object obj0, [In] EventArgs obj1)
  {
    try
    {
      ...
      if (control2.Name == ((F_MarbleCountertopEdge) this).btn_ok.Name)
      {
        \u007B0e48b843\u002Dfb72\u002D498c\u002D834d\u002Dfc743ba0facc\u007D.\u0001((F_MarbleEditLength) this);
        ((F_MarbleCountertopEdge) this).Properties.Result = DialogResult.OK;
        if (((F_MarbleCountertopEdge) this).Properties.FormCloseMode == FormCloseModeType.Dispose)
          this.Dispose();
        if (((F_MarbleCountertopEdge) this).Properties.FormCloseMode == FormCloseModeType.Invisible)
          this.Visible = false;
      }
      if (!(control2.Name == ((F_MarbleCountertopEdge) this).btn_cancel.Name | control2.Name == ((F_MarbleCountertopEdge) this).\u0001.Name))
        return;
      ((F_MarbleCountertopEdge) this).Properties.Result = DialogResult.Cancel;
      if (((F_MarbleCountertopEdge) this).Properties.FormCloseMode == FormCloseModeType.Dispose)
        this.Dispose();
  ...
  static F_MarbleSlat() => F_MarbleCountertopEdge.Captions = new List<string>();
  ...
  public F_MarbleSlat()
  {
    ...
    base.\u002Ector();
    \u007B0e48b843\u002Dfb72\u002D498c\u002D834d\u002Dfc743ba0facc\u007D.\u0001((F_MarbleEditBaseH) this);
  }
  ...
  public void Init()
  {
    ...
    ((F_MarbleCountertopEdge) this).spn_baseheight.Value = ((marbleCamPars) ((F_MarbleCountertopEdge) this).varRuntime).ScaleBaseHeight;
    \u007B0e48b843\u002Dfb72\u002D498c\u002D834d\u002Dfc743ba0facc\u007D.\u0001((F_MarbleEditBaseH) this);
  }
