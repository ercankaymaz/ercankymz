...
// Type: buMarble.Forms.F_MarbleCounters
...
public class F_MarbleCounters : Form
{
  ...
  static F_MarbleCounters() => F_MarbleMachineDef.Captions = new List<string>();

  public F_MarbleCounters() => \u0007.\u0001.\u0001(this);
