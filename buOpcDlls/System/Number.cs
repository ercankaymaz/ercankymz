...
internal static class Number
{
  ...
  public static void RoundNumber(ref NumberBuffer number, int pos)
  {
    ...
    {
      while (index > 0 && digits[index - 1] == (byte) 48 /*0x30*/)
        --index;
    }
    if (index == 0)
    {
  ...
  public static unsafe bool NumberBufferToDecimal(ref NumberBuffer number, ref Decimal value)
  {
    ...
    else
    {
      if (num1 > 29)
        return false;
      for (; (num1 > 0 || *unsafeDigits != (byte) 0 && num1 > -28) && (source.High < 429496729U || source.High == 429496729U && (source.Mid < 2576980377U /*0x99999999*/ || source.Mid == 2576980377U /*0x99999999*/ && (source.Low < 2576980377U /*0x99999999*/ || source.Low == 2576980377U /*0x99999999*/ && *unsafeDigits <= (byte) 53))); --num1)
      {
        DecimalDecCalc.DecMul10(ref source);
        if (*unsafeDigits != (byte) 0)
          DecimalDecCalc.DecAddInt32(ref source, (uint) *unsafeDigits++ - 48U /*0x30*/);
      }
      ...
      if (*numPtr1 >= (byte) 53)
      {
        ...
        {
          int num2;
          for (num2 = 20; *numPtr2 == (byte) 48 /*0x30*/ && num2 != 0; --num2)
            ++numPtr2;
        ...
        if (flag)
        {
          ...
          if (((int) source.High | (int) source.Mid | (int) source.Low) == 0)
          {
            ...
            source.Mid = 2576980377U /*0x99999999*/;
  ...
  public static void DecimalToNumber(Decimal value, ref NumberBuffer number)
  {
    ...
    while (local.Mid > 0U | local.High > 0U)
    {
      ...
      {
        digits1[--num1] = (byte) (num2 % 10U + 48U /*0x30*/);
        num2 /= 10U;
      }
    }
    for (uint low = local.Low; low != 0U; low /= 10U)
      digits1[--num1] = (byte) (low % 10U + 48U /*0x30*/);
    int num3 = 29 - num1;
  ...
  {
    ulong num = Number.Mul32x32To64((uint) (a >> 32 /*0x20*/), (uint) (b >> 32 /*0x20*/)) + (Number.Mul32x32To64((uint) (a >> 32 /*0x20*/), (uint) b) >> 32 /*0x20*/) + (Number.Mul32x32To64((uint) a, (uint) (b >> 32 /*0x20*/)) >> 32 /*0x20*/);
  ...
  private static unsafe double NumberToDouble(ref NumberBuffer number)
  {
    ...
    for (; digits[index] == (byte) 48 /*0x30*/; ++index)
      --val1_1;
    if (val1_1 == 0)
      return 0.0;
    ...
    if (val1_2 > 0)
    {
      ...
      val1_2 -= count2;
      uint b = (uint) (Number.s_rgval64Power10[count2 - 1] >> 64 /*0x40*/ - (int) Number.s_rgexp64Power10[count2 - 1]);
    ...
    if (num2 >= 352)
    {
      ulong num3 = num1 > 0 ? 9218868437227405312UL /*0x7FF0000000000000*/ : 0UL;
      if (number.IsNegative)
        num3 |= 9223372036854775808UL /*0x8000000000000000*/;
      return *(double*) &num3;
    }
    int pexp = 64 /*0x40*/;
    ...
    if (((int) a & 1024 /*0x0400*/) != 0)
    {
      ulong num8 = a + 1023UL /*0x03FF*/ + (ulong) ((int) a >> 11 & 1);
      if (num8 < a)
      {
        num8 = num8 >> 1 | 9223372036854775808UL /*0x8000000000000000*/;
        ++pexp;
      }
      a = num8;
    }
    int num9 = pexp + 1022;
    ulong num10 = num9 > 0 ? (num9 < 2047 /*0x07FF*/ ? (ulong) (((long) num9 << 52) + ((long) (a >> 11) & 4503599627370495L /*0x0FFFFFFFFFFFFF*/)) : 9218868437227405312UL /*0x7FF0000000000000*/) : (num9 != -52 || a < 9223372036854775896UL /*0x8000000000000058*/ ? (num9 > -52 ? a >> -num9 + 11 + 1 : 0UL) : 1UL);
    if (number.IsNegative)
      num10 |= 9223372036854775808UL /*0x8000000000000000*/;
    return *(double*) &num10;
  }
  ...
  private static class DoubleHelper
  {
    ...
    {
      return *(uint*) ((byte*) &d + 4) >> 20 & 2047U /*0x07FF*/;
    }

    public static unsafe ulong Mantissa(double d)
    {
      return (ulong) *(uint*) &d | (ulong) (*(uint*) ((byte*) &d + 4) & 1048575U /*0x0FFFFF*/) << 32 /*0x20*/;
    }

    public static unsafe bool Sign(double d) => *(uint*) ((byte*) &d + 4) >> 31 /*0x1F*/ > 0U;
  }
}
