...
label_8:
  ...
  public static int IndexOf<T>(this Span<T> span, T value) where T : object, IEquatable<T>
  {
  ...
  {
    return typeof (T) == typeof (byte) ? SpanHelpers.IndexOf(ref Unsafe.As<T, byte>(ref MemoryMarshal.GetReference<T>(span)), span.Length, ref Unsafe.As<T, byte>(ref MemoryMarshal.GetReference<T>(value)), value.Length) : SpanHelpers.IndexOf<T>(ref MemoryMarshal.GetReference<T>(span), span.Length, ref MemoryMarshal.GetReference<T>(value), value.Length);
  }

  [MethodImpl(MethodImplOptions.AggressiveInlining)]
  public static int LastIndexOf<T>(this Span<T> span, T value) where T : object, IEquatable<T>
  {
    if (typeof (T) == typeof (byte))
  ...
  {
    return typeof (T) == typeof (byte) ? SpanHelpers.LastIndexOf(ref Unsafe.As<T, byte>(ref MemoryMarshal.GetReference<T>(span)), span.Length, ref Unsafe.As<T, byte>(ref MemoryMarshal.GetReference<T>(value)), value.Length) : SpanHelpers.LastIndexOf<T>(ref MemoryMarshal.GetReference<T>(span), span.Length, ref MemoryMarshal.GetReference<T>(value), value.Length);
  }
  ...
  [MethodImpl(MethodImplOptions.AggressiveInlining)]
  public static int IndexOf<T>(this ReadOnlySpan<T> span, T value) where T : object, IEquatable<T>
  {
    if (typeof (T) == typeof (byte))
      return SpanHelpers.IndexOf(ref Unsafe.As<T, byte>(ref MemoryMarshal.GetReference<T>(span)), Unsafe.As<T, byte>(ref value), span.Length);
    return typeof (T) == typeof (char) ? SpanHelpers.IndexOf(ref Unsafe.As<T, char>(ref MemoryMarshal.GetReference<T>(span)), Unsafe.As<T, char>(ref value), span.Length) : SpanHelpers.IndexOf<T>(ref MemoryMarshal.GetReference<T>(span), value, span.Length);
  ...
  [MethodImpl(MethodImplOptions.AggressiveInlining)]
  public static int LastIndexOf<T>(this ReadOnlySpan<T> span, T value) where T : object, IEquatable<T>
  {
    if (typeof (T) == typeof (byte))
      return SpanHelpers.LastIndexOf(ref Unsafe.As<T, byte>(ref MemoryMarshal.GetReference<T>(span)), Unsafe.As<T, byte>(ref value), span.Length);
    return typeof (T) == typeof (char) ? SpanHelpers.LastIndexOf(ref Unsafe.As<T, char>(ref MemoryMarshal.GetReference<T>(span)), Unsafe.As<T, char>(ref value), span.Length) : SpanHelpers.LastIndexOf<T>(ref MemoryMarshal.GetReference<T>(span), value, span.Length);
  ...
  [MethodImpl(MethodImplOptions.AggressiveInlining)]
  public static int IndexOfAny<T>(this Span<T> span, T value0, T value1) where T : object, IEquatable<T>
  {
    return typeof (T) == typeof (byte) ? SpanHelpers.IndexOfAny(ref Unsafe.As<T, byte>(ref MemoryMarshal.GetReference<T>(span)), Unsafe.As<T, byte>(ref value0), Unsafe.As<T, byte>(ref value1), span.Length) : SpanHelpers.IndexOfAny<T>(ref MemoryMarshal.GetReference<T>(span), value0, value1, span.Length);
  }

  [MethodImpl(MethodImplOptions.AggressiveInlining)]
  public static int IndexOfAny<T>(this Span<T> span, T value0, T value1, T value2) where T : object, IEquatable<T>
  {
    return typeof (T) == typeof (byte) ? SpanHelpers.IndexOfAny(ref Unsafe.As<T, byte>(ref MemoryMarshal.GetReference<T>(span)), Unsafe.As<T, byte>(ref value0), Unsafe.As<T, byte>(ref value1), Unsafe.As<T, byte>(ref value2), span.Length) : SpanHelpers.IndexOfAny<T>(ref MemoryMarshal.GetReference<T>(span), value0, value1, value2, span.Length);
  }

  [MethodImpl(MethodImplOptions.AggressiveInlining)]
  public static int IndexOfAny<T>(this Span<T> span, ReadOnlySpan<T> values) where T : object, IEquatable<T>
  {
    return typeof (T) == typeof (byte) ? SpanHelpers.IndexOfAny(ref Unsafe.As<T, byte>(ref MemoryMarshal.GetReference<T>(span)), span.Length, ref Unsafe.As<T, byte>(ref MemoryMarshal.GetReference<T>(values)), values.Length) : SpanHelpers.IndexOfAny<T>(ref MemoryMarshal.GetReference<T>(span), span.Length, ref MemoryMarshal.GetReference<T>(values), values.Length);
  }

  [MethodImpl(MethodImplOptions.AggressiveInlining)]
  public static int IndexOfAny<T>(this ReadOnlySpan<T> span, T value0, T value1) where T : object, IEquatable<T>
  {
    return typeof (T) == typeof (byte) ? SpanHelpers.IndexOfAny(ref Unsafe.As<T, byte>(ref MemoryMarshal.GetReference<T>(span)), Unsafe.As<T, byte>(ref value0), Unsafe.As<T, byte>(ref value1), span.Length) : SpanHelpers.IndexOfAny<T>(ref MemoryMarshal.GetReference<T>(span), value0, value1, span.Length);
  }

  [MethodImpl(MethodImplOptions.AggressiveInlining)]
  public static int IndexOfAny<T>(this ReadOnlySpan<T> span, T value0, T value1, T value2) where T : object, IEquatable<T>
  {
    return typeof (T) == typeof (byte) ? SpanHelpers.IndexOfAny(ref Unsafe.As<T, byte>(ref MemoryMarshal.GetReference<T>(span)), Unsafe.As<T, byte>(ref value0), Unsafe.As<T, byte>(ref value1), Unsafe.As<T, byte>(ref value2), span.Length) : SpanHelpers.IndexOfAny<T>(ref MemoryMarshal.GetReference<T>(span), value0, value1, value2, span.Length);
  }
  ...
  [MethodImpl(MethodImplOptions.AggressiveInlining)]
  public static int LastIndexOfAny<T>(this Span<T> span, T value0, T value1) where T : object, IEquatable<T>
  {
    return typeof (T) == typeof (byte) ? SpanHelpers.LastIndexOfAny(ref Unsafe.As<T, byte>(ref MemoryMarshal.GetReference<T>(span)), Unsafe.As<T, byte>(ref value0), Unsafe.As<T, byte>(ref value1), span.Length) : SpanHelpers.LastIndexOfAny<T>(ref MemoryMarshal.GetReference<T>(span), value0, value1, span.Length);
  }

  [MethodImpl(MethodImplOptions.AggressiveInlining)]
  public static int LastIndexOfAny<T>(this Span<T> span, T value0, T value1, T value2) where T : object, IEquatable<T>
  {
    return typeof (T) == typeof (byte) ? SpanHelpers.LastIndexOfAny(ref Unsafe.As<T, byte>(ref MemoryMarshal.GetReference<T>(span)), Unsafe.As<T, byte>(ref value0), Unsafe.As<T, byte>(ref value1), Unsafe.As<T, byte>(ref value2), span.Length) : SpanHelpers.LastIndexOfAny<T>(ref MemoryMarshal.GetReference<T>(span), value0, value1, value2, span.Length);
  }
  ...
  [MethodImpl(MethodImplOptions.AggressiveInlining)]
  public static int LastIndexOfAny<T>(this ReadOnlySpan<T> span, T value0, T value1) where T : object, IEquatable<T>
  {
    return typeof (T) == typeof (byte) ? SpanHelpers.LastIndexOfAny(ref Unsafe.As<T, byte>(ref MemoryMarshal.GetReference<T>(span)), Unsafe.As<T, byte>(ref value0), Unsafe.As<T, byte>(ref value1), span.Length) : SpanHelpers.LastIndexOfAny<T>(ref MemoryMarshal.GetReference<T>(span), value0, value1, span.Length);
  }

  [MethodImpl(MethodImplOptions.AggressiveInlining)]
  public static int LastIndexOfAny<T>(this ReadOnlySpan<T> span, T value0, T value1, T value2) where T : object, IEquatable<T>
  {
    return typeof (T) == typeof (byte) ? SpanHelpers.LastIndexOfAny(ref Unsafe.As<T, byte>(ref MemoryMarshal.GetReference<T>(span)), Unsafe.As<T, byte>(ref value0), Unsafe.As<T, byte>(ref value1), Unsafe.As<T, byte>(ref value2), span.Length) : SpanHelpers.LastIndexOfAny<T>(ref MemoryMarshal.GetReference<T>(span), value0, value1, value2, span.Length);
  }
  ...
  public static bool StartsWith<T>(this Span<T> span, ReadOnlySpan<T> value) where T : object, IEquatable<T>
  {
    ...
    NUInt size;
    return (object) default (T) != null && MemoryExtensions.IsTypeComparableAsBytes<T>(out size) ? length <= span.Length && SpanHelpers.SequenceEqual(ref Unsafe.As<T, byte>(ref MemoryMarshal.GetReference<T>(span)), ref Unsafe.As<T, byte>(ref MemoryMarshal.GetReference<T>(value)), (NUInt) length * size) : length <= span.Length && SpanHelpers.SequenceEqual<T>(ref MemoryMarshal.GetReference<T>(span), ref MemoryMarshal.GetReference<T>(value), length);
  }
  ...
  public static bool EndsWith<T>(this Span<T> span, ReadOnlySpan<T> value) where T : object, IEquatable<T>
  {
    ...
    NUInt size;
    return (object) default (T) != null && MemoryExtensions.IsTypeComparableAsBytes<T>(out size) ? length2 <= length1 && SpanHelpers.SequenceEqual(ref Unsafe.As<T, byte>(ref Unsafe.Add<T>(ref MemoryMarshal.GetReference<T>(span), length1 - length2)), ref Unsafe.As<T, byte>(ref MemoryMarshal.GetReference<T>(value)), (NUInt) length2 * size) : length2 <= length1 && SpanHelpers.SequenceEqual<T>(ref Unsafe.Add<T>(ref MemoryMarshal.GetReference<T>(span), length1 - length2), ref MemoryMarshal.GetReference<T>(value), length2);
  }
  ...
  {
    return ((ReadOnlySpan<T>) span).Overlaps<T>(other);
  }

  [MethodImpl(MethodImplOptions.AggressiveInlining)]
  public static bool Overlaps<T>(this Span<T> span, ReadOnlySpan<T> other, out int elementOffset)
  {
    return ((ReadOnlySpan<T>) span).Overlaps<T>(other, out elementOffset);
  }
  ...
  {
    return MemoryExtensions.BinarySearch<T, TComparable>((ReadOnlySpan<T>) span, comparable);
  }
  ...
  {
    return ((ReadOnlySpan<T>) span).BinarySearch<T, TComparer>(value, comparer);
  }
  ...
  public static int BinarySearch<T, TComparer>(
    ...
    T value,
    TComparer comparer)
    where TComparer : object, IComparer<T>
  {
  ...
  {
    return text == null ? new ReadOnlySpan<char>() : new ReadOnlySpan<char>(Unsafe.As<Pinnable<char>>((object) text), MemoryExtensions.StringAdjustment, text.Length);
  }
  ...
  {
    return text == null ? new ReadOnlyMemory<char>() : new ReadOnlyMemory<char>((object) text, 0, text.Length);
  }
