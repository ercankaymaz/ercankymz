...
internal static class SpanHelpers
{
  ...
  private const ulong XorPowerOfTwoToHighChar = 4295098372 /*0x0100020004*/;
  ...
  public static int BinarySearch<T, TComparable>(
    ...
    where TComparable : object, IComparable<T>
  {
    int num1 = 0;
    int num2 = length - 1;
    while (num1 <= num2)
  ...
  public static unsafe int IndexOf(ref byte searchSpace, byte value, int length)
  {
    ...
    while (true)
    {
      ...
      if (Vector.IsHardwareAccelerated && (int) (void*) byteOffset < length)
      {
        ...
        Vector<byte> vector1 = SpanHelpers.GetVector(value);
        while ((void*) num3 > (void*) byteOffset)
        {
          Vector<byte> vector2 = Vector.Equals<byte>(vector1, Unsafe.ReadUnaligned<Vector<byte>>(ref Unsafe.AddByteOffset<byte>(ref searchSpace, byteOffset)));
          if (!Vector<byte>.Zero.Equals(vector2))
            return (int) (void*) byteOffset + SpanHelpers.LocateFirstFoundByte(vector2);
  ...
  public static unsafe int LastIndexOf(ref byte searchSpace, byte value, int length)
  {
    ...
    while (true)
    {
      ...
      if (Vector.IsHardwareAccelerated && (UIntPtr) (void*) byteOffset > UIntPtr.Zero)
      {
        ...
        {
          Vector<byte> vector2 = Vector.Equals<byte>(vector1, Unsafe.ReadUnaligned<Vector<byte>>(ref Unsafe.AddByteOffset<byte>(ref searchSpace, byteOffset - Vector<byte>.Count)));
          if (!Vector<byte>.Zero.Equals(vector2))
            return (int) byteOffset - Vector<byte>.Count + SpanHelpers.LocateLastFoundByte(vector2);
          byteOffset -= Vector<byte>.Count;
  ...
  public static unsafe int IndexOfAny(ref byte searchSpace, byte value0, byte value1, int length)
  {
    ...
    while (true)
    {
      ...
      if (Vector.IsHardwareAccelerated && (int) (void*) byteOffset < length)
      {
        ...
        {
          Vector<byte> left = Unsafe.ReadUnaligned<Vector<byte>>(ref Unsafe.AddByteOffset<byte>(ref searchSpace, byteOffset));
          Vector<byte> vector3 = Vector.BitwiseOr<byte>(Vector.Equals<byte>(left, vector1), Vector.Equals<byte>(left, vector2));
          if (!Vector<byte>.Zero.Equals(vector3))
            return (int) (void*) byteOffset + SpanHelpers.LocateFirstFoundByte(vector3);
          byteOffset += Vector<byte>.Count;
        }
        if ((int) (void*) byteOffset < length)
    ...
    int length)
  {
    ...
    while (true)
    {
      ...
      if (Vector.IsHardwareAccelerated && (int) (void*) byteOffset < length)
      {
        ...
        {
          Vector<byte> left = Unsafe.ReadUnaligned<Vector<byte>>(ref Unsafe.AddByteOffset<byte>(ref searchSpace, byteOffset));
          Vector<byte> vector4 = Vector.BitwiseOr<byte>(Vector.BitwiseOr<byte>(Vector.Equals<byte>(left, vector1), Vector.Equals<byte>(left, vector2)), Vector.Equals<byte>(left, vector3));
          if (!Vector<byte>.Zero.Equals(vector4))
            return (int) (void*) byteOffset + SpanHelpers.LocateFirstFoundByte(vector4);
          byteOffset += Vector<byte>.Count;
        }
        if ((int) (void*) byteOffset < length)
    ...
    int length)
  {
    ...
    while (true)
    {
      ...
      if (Vector.IsHardwareAccelerated && (UIntPtr) (void*) byteOffset > UIntPtr.Zero)
      {
        ...
        {
          Vector<byte> left = Unsafe.ReadUnaligned<Vector<byte>>(ref Unsafe.AddByteOffset<byte>(ref searchSpace, byteOffset - Vector<byte>.Count));
          Vector<byte> vector3 = Vector.BitwiseOr<byte>(Vector.Equals<byte>(left, vector1), Vector.Equals<byte>(left, vector2));
          if (!Vector<byte>.Zero.Equals(vector3))
            return (int) byteOffset - Vector<byte>.Count + SpanHelpers.LocateLastFoundByte(vector3);
          byteOffset -= Vector<byte>.Count;
    ...
    while (true)
    {
      ...
      if (Vector.IsHardwareAccelerated && (UIntPtr) (void*) byteOffset > UIntPtr.Zero)
      {
        ...
        while ((UIntPtr) (void*) num19 > (UIntPtr) (Vector<byte>.Count - 1))
        {
          ...
          Vector<byte> vector4 = Vector.BitwiseOr<byte>(Vector.BitwiseOr<byte>(Vector.Equals<byte>(left, vector1), Vector.Equals<byte>(left, vector2)), Vector.Equals<byte>(left, vector3));
          if (!Vector<byte>.Zero.Equals(vector4))
            return (int) byteOffset - Vector<byte>.Count + SpanHelpers.LocateLastFoundByte(vector4);
          byteOffset -= Vector<byte>.Count;
  ...
  public static unsafe bool SequenceEqual(ref byte first, ref byte second, NUInt length)
  {
    if (!Unsafe.AreSame<byte>(ref first, ref second))
    {
      ...
      if (Vector.IsHardwareAccelerated && (UIntPtr) (void*) num >= (UIntPtr) Vector<byte>.Count)
      {
        ...
        {
          if (!(Unsafe.ReadUnaligned<Vector<byte>>(ref Unsafe.AddByteOffset<byte>(ref first, byteOffset1)) != Unsafe.ReadUnaligned<Vector<byte>>(ref Unsafe.AddByteOffset<byte>(ref second, byteOffset1))))
            byteOffset1 += Vector<byte>.Count;
          else
            goto label_16;
        }
        return Unsafe.ReadUnaligned<Vector<byte>>(ref Unsafe.AddByteOffset<byte>(ref first, byteOffset2)) == Unsafe.ReadUnaligned<Vector<byte>>(ref Unsafe.AddByteOffset<byte>(ref second, byteOffset2));
      }
...
label_17:
    ...
    int secondLength)
  {
    if (!Unsafe.AreSame<byte>(ref first, ref second))
    {
      ...
      if (Vector.IsHardwareAccelerated && (UIntPtr) (void*) num2 > (UIntPtr) Vector<byte>.Count)
      {
        ...
        while ((void*) num3 > (void*) byteOffset && !(Unsafe.ReadUnaligned<Vector<byte>>(ref Unsafe.AddByteOffset<byte>(ref first, byteOffset)) != Unsafe.ReadUnaligned<Vector<byte>>(ref Unsafe.AddByteOffset<byte>(ref second, byteOffset))))
          byteOffset += Vector<byte>.Count;
      }
  ...
  {
    return (int) ((match ^ match - 1UL) * 283686952306184UL >> 57);
  }
    ...
    fixed (char* chPtr1 = &searchSpace)
    {
      ...
      while (true)
      {
        ...
        if (Vector.IsHardwareAccelerated && source < chPtr2)
        {
          ...
          {
            Vector<ushort> vector = Vector.Equals<ushort>(left, Unsafe.Read<Vector<ushort>>((void*) source));
            if (!Vector<ushort>.Zero.Equals(vector))
              return (int) (source - chPtr1) + SpanHelpers.LocateFirstFoundChar(vector);
      ...
      while (true)
      {
        ...
        if (Vector.IsHardwareAccelerated && chPtr2 > chPtr3)
        {
          ...
          for (; length > 0; length -= Vector<ushort>.Count)
          {
            ...
            Vector<ushort> vector = Vector.Equals<ushort>(left, Unsafe.Read<Vector<ushort>>((void*) source));
            if (!Vector<ushort>.Zero.Equals(vector))
              return (int) (source - chPtr3) + SpanHelpers.LocateLastFoundChar(vector);
...
label_18:
  ...
  {
    return (int) ((match ^ match - 1UL) * 4295098372UL /*0x0100020004*/ >> 49);
  }
...
label_8:
  ...
  public static unsafe int IndexOf<T>(ref T searchSpace, T value, int length) where T : object, IEquatable<T>
  {
    IntPtr elementOffset = (IntPtr) 0;
    while (length >= 8)
    {
...
label_28:
  ...
  public static int IndexOfAny<T>(ref T searchSpace, T value0, T value1, int length) where T : object, IEquatable<T>
  {
    int elementOffset;
...
label_28:
  ...
  public static int IndexOfAny<T>(ref T searchSpace, T value0, T value1, T value2, int length) where T : object, IEquatable<T>
  {
    int elementOffset;
    for (elementOffset = 0; length - elementOffset >= 8; elementOffset += 8)
    {
...
label_8:
  ...
  public static int LastIndexOf<T>(ref T searchSpace, T value, int length) where T : object, IEquatable<T>
  {
    while (length >= 8)
    {
      length -= 8;
...
label_21:
  ...
  public static int LastIndexOfAny<T>(ref T searchSpace, T value0, T value1, int length) where T : object, IEquatable<T>
  {
    while (length >= 8)
    {
      length -= 8;
...
label_21:
  ...
  public static bool SequenceEqual<T>(ref T first, ref T second, int length) where T : object, IEquatable<T>
  {
...
label_12:
  ...
  public static void CopyTo<T>(ref T dst, int dstLength, ref T src, int srcLength)
  {
    ...
    if ((sizeof (IntPtr) == 4 ? ((uint) (int) num3 < (uint) (int) num1 ? 1 : ((uint) (int) num3 > (uint) -(int) num2 ? 1 : 0)) : ((ulong) (long) num3 < (ulong) (long) num1 ? 1 : ((ulong) (long) num3 > (ulong) -(long) num2 ? 1 : 0))) == 0 && !SpanHelpers.IsReferenceOrContainsReferences<T>())
    {
    ...
    {
      bool flag;
      int num5 = (flag = sizeof (IntPtr) == 4 ? (uint) (int) num3 > (uint) -(int) num2 : (ulong) (long) num3 > (ulong) -(long) num2) ? 1 : -1;
  ...
  internal struct ComparerComparable<T, TComparer>(T value, TComparer comparer) : IComparable<T> where TComparer : object, IComparer<T>
  {
