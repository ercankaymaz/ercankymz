...
{
  private static readonly sbyte[] s_decodingMap = new sbyte[256 /*0x0100*/]
  {
    (sbyte) -1,
    (sbyte) -1,
    (sbyte) -1,
  ...
  private static readonly byte[] s_encodingMap = new byte[64 /*0x40*/]
  {
    (byte) 65,
    (byte) 66,
    (byte) 67,
      ...
      if (num2 == length1 - num1)
      {
        ...
        else if (elementOffset5 != 61)
        {
          ...
          if (num10 >= 0)
          {
            ...
            {
              Unsafe.Add<byte>(ref local2, elementOffset2) = (byte) (num10 >> 16 /*0x10*/);
        ...
        else if (num4 >= 0)
        {
          ...
          {
            Unsafe.Add<byte>(ref local2, elementOffset2) = (byte) (num4 >> 16 /*0x10*/);
            ++elementOffset2;
          }
          else
            goto label_21;
    ...
    if (length == (length >> 2) * 4)
    {
      if (length != 0)
      {
        ...
        else if (elementOffset5 != 61)
        {
          ...
          if (num7 >= 0)
          {
            Unsafe.Add<byte>(ref local1, elementOffset2) = (byte) (num7 >> 16 /*0x10*/);
        ...
        {
          Unsafe.Add<byte>(ref local1, elementOffset2) = (byte) (num1 >> 16 /*0x10*/);
          ++elementOffset2;
        }
        else
          goto label_15;
...
label_15:
  ...
  {
    destination = (byte) (value >> 16 /*0x10*/);
  ...
  {
    int num = (int) threeBytes << 16 /*0x10*/ | (int) Unsafe.Add<byte>(ref threeBytes, 1) << 8 | (int) Unsafe.Add<byte>(ref threeBytes, 2);
    return (int) Unsafe.Add<byte>(ref encodingMap, num >> 18) | (int) Unsafe.Add<byte>(ref encodingMap, num >> 12 & 63 /*0x3F*/) << 8 | (int) Unsafe.Add<byte>(ref encodingMap, num >> 6 & 63 /*0x3F*/) << 16 /*0x10*/ | (int) Unsafe.Add<byte>(ref encodingMap, num & 63 /*0x3F*/) << 24;
  }

  [MethodImpl(MethodImplOptions.AggressiveInlining)]
  private static int EncodeAndPadOne(ref byte twoBytes, ref byte encodingMap)
  {
    int num = (int) twoBytes << 16 /*0x10*/ | (int) Unsafe.Add<byte>(ref twoBytes, 1) << 8;
    return (int) Unsafe.Add<byte>(ref encodingMap, num >> 18) | (int) Unsafe.Add<byte>(ref encodingMap, num >> 12 & 63 /*0x3F*/) << 8 | (int) Unsafe.Add<byte>(ref encodingMap, num >> 6 & 63 /*0x3F*/) << 16 /*0x10*/ | 1023410176 /*0x3D000000*/;
  }
  ...
  private static int EncodeAndPadTwo(ref byte oneByte, ref byte encodingMap)
  {
    ...
    return (int) Unsafe.Add<byte>(ref encodingMap, num >> 10) | (int) Unsafe.Add<byte>(ref encodingMap, num >> 4 & 63 /*0x3F*/) << 8 | 3997696 /*0x3D0000*/ | 1023410176 /*0x3D000000*/;
  }
}
