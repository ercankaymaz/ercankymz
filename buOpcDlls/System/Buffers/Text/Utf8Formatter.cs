...
label_12:
  ...
  public static bool TryFormat(
    ...
    StandardFormat format = default (StandardFormat))
  {
    switch (FormattingHelpers.GetSymbolOrDefault(ref format, 'G'))
    {
      case 'G':
    ...
    switch (dateTimeKind)
    {
      ...
      case DateTimeKind.Local:
        ...
        if (offset < new TimeSpan())
        {
          ...
          num3 = (byte) 43;
        FormattingHelpers.WriteTwoDecimalDigits((uint) offset.Minutes, destination, 31 /*0x1F*/);
    ...
    switch (format.Symbol)
    {
      ...
      case 'g':
        if (format.Precision != byte.MaxValue)
          throw new NotSupportedException(System.System.Memory3568249.SR.Argument_GWithPrecisionNotSupported);
    ...
    byte exponentSymbol)
  {
    ...
    int index8 = num8;
    int num9 = index8 + 1;
    local4[index8] = (byte) 48 /*0x30*/;
    ref Span<byte> local5 = ref destination;
    int index9 = num9;
    int num10 = index9 + 1;
    local5[index9] = (byte) (num5 / 10 + 48 /*0x30*/);
    ref Span<byte> local6 = ref destination;
    int index10 = num10;
    int num11 = index10 + 1;
    local6[index10] = (byte) (num5 % 10 + 48 /*0x30*/);
    bytesWritten = num1;
    return true;
  }
  ...
  private static bool TryFormatInt64MoreThanNegativeBillionMaxUInt(
    ...
    out int bytesWritten)
  {
    uint num1 = (uint) (value / 1000000000L);
    ...
    out int bytesWritten)
  {
    ...
    destination[0] = (byte) (48U /*0x30*/ + value);
    bytesWritten = 1;
    return true;
  }
    ...
    out int bytesWritten)
  {
    ...
    destination[0] = (byte) (48UL /*0x30*/ + value);
    bytesWritten = 1;
    return true;
  }
  ...
  public static bool TryFormat(
    ...
    StandardFormat format = default (StandardFormat))
  {
    char ch = FormattingHelpers.GetSymbolOrDefault(ref format, 'c');
    switch (ch)
    {
      case 'G':
      case 'c':
