...
public struct ReadOnlyMemory<T>
{
  ...
  internal const int RemoveFlagsBitMask = 2147483647 /*0x7FFFFFFF*/;
  ...
  public unsafe ReadOnlyMemory(T[] array)
  {
    if (array == null)
    {
      *(ReadOnlyMemory<T>*) ref this = new ReadOnlyMemory<T>();
    }
    else
    {
  ...
  public override string ToString()
  {
    if (!(typeof (T) == typeof (char)))
      return $"System.ReadOnlyMemory<{typeof (T).Name}>[{this._length & int.MaxValue}]";
