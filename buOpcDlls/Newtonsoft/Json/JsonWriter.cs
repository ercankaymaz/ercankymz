...
public abstract class JsonWriter : IDisposable
{
  ...
  public virtual Task WriteRawAsync([System.Runtime.CompilerServices.Newtonsoft.Json.Nullable(2)] string json, CancellationToken cancellationToken = default (CancellationToken))
  {
    if (cancellationToken.IsCancellationRequested)
      return cancellationToken.FromCanceled();
    this.WriteRaw(json);
      ...
      while (LevelsToComplete-- > 0)
      {
        ...
        if (this._currentState == JsonWriter.State.Property)
        {
          ...
          else
          {
            ...
            // ISSUE: explicit reference operation
            // ISSUE: reference to a compiler-generated field
            (^this).\u003C\u003Et__builder.AwaitUnsafeOnCompleted<ConfiguredTaskAwaitable.ConfiguredTaskAwaiter, JsonWriter.\u003C\u003CInternalWriteEndAsync\u003Eg__AwaitRemaining\u007C11_3\u003Ed>(ref awaiter, this);
            break;
          }
        }
        if (this._formatting == Formatting.Indented && this._currentState != JsonWriter.State.ObjectStart && this._currentState != JsonWriter.State.ArrayStart)
  ...
  public virtual Task WriteCommentAsync([System.Runtime.CompilerServices.Newtonsoft.Json.Nullable(2)] string text, CancellationToken cancellationToken = default (CancellationToken))
  {
    if (cancellationToken.IsCancellationRequested)
      return cancellationToken.FromCanceled();
  ...
  public virtual Task WriteRawValueAsync([System.Runtime.CompilerServices.Newtonsoft.Json.Nullable(2)] string json, CancellationToken cancellationToken = default (CancellationToken))
  {
    if (cancellationToken.IsCancellationRequested)
      return cancellationToken.FromCanceled();
  ...
  public Task WriteTokenAsync(JsonToken token, [System.Runtime.CompilerServices.Newtonsoft.Json.Nullable(2)] object value, CancellationToken cancellationToken = default (CancellationToken))
  {
    if (cancellationToken.IsCancellationRequested)
      return cancellationToken.FromCanceled();
    switch (token)
    ...
    CancellationToken cancellationToken)
  {
    ...
    do
    {
      ...
      int num1 = initialDepth - 1;
      int num2 = reader.Depth - (JsonTokenUtils.IsEndToken(reader.TokenType) ? 1 : 0);
      if (flag = num1 < num2 & writeChildren)
        goto label_9;
label_8:
      continue;
label_9:
      awaiter2 = reader.ReadAsync(cancellationToken).ConfigureAwait(false).GetAwaiter();
...
label_13:
    ...
    // ISSUE: explicit reference operation
    // ISSUE: reference to a compiler-generated field
    (^this).\u003C\u003Et__builder.AwaitUnsafeOnCompleted<ConfiguredTaskAwaitable.ConfiguredTaskAwaiter, JsonWriter.\u003CWriteTokenAsync\u003Ed__30>(ref awaiter1, this);
    return;
label_14:
    num = 1;
    // ISSUE: explicit reference operation
...
label_15:
    ...
    // ISSUE: explicit reference operation
    // ISSUE: reference to a compiler-generated field
    (^this).\u003C\u003Et__builder.AwaitUnsafeOnCompleted<ConfiguredTaskAwaitable<bool>.ConfiguredTaskAwaiter, JsonWriter.\u003CWriteTokenAsync\u003Ed__30>(ref awaiter2, this);
  }
...
label_5:
      continue;
label_6:
      awaiter = reader.ReadAsync(cancellationToken).ConfigureAwait(false).GetAwaiter();
      if (awaiter.IsCompleted)
      {
...
label_10:
    ...
    // ISSUE: explicit reference operation
    // ISSUE: reference to a compiler-generated field
    (^this).\u003C\u003Et__builder.AwaitUnsafeOnCompleted<ConfiguredTaskAwaitable<bool>.ConfiguredTaskAwaiter, JsonWriter.\u003CWriteTokenSyncReadingAsync\u003Ed__31>(ref awaiter, this);
  }
  ...
  public virtual Task WriteValueAsync([System.Runtime.CompilerServices.Newtonsoft.Json.Nullable(2)] byte[] value, CancellationToken cancellationToken = default (CancellationToken))
  {
    if (cancellationToken.IsCancellationRequested)
      return cancellationToken.FromCanceled();
    this.WriteValue(value);
  ...
  public virtual Task WriteValueAsync([System.Runtime.CompilerServices.Newtonsoft.Json.Nullable(2)] object value, CancellationToken cancellationToken = default (CancellationToken))
  {
    if (cancellationToken.IsCancellationRequested)
      return cancellationToken.FromCanceled();
    this.WriteValue(value);
  ...
  public virtual Task WriteValueAsync([System.Runtime.CompilerServices.Newtonsoft.Json.Nullable(2)] string value, CancellationToken cancellationToken = default (CancellationToken))
  {
    if (cancellationToken.IsCancellationRequested)
      return cancellationToken.FromCanceled();
    this.WriteValue(value);
  ...
  public virtual Task WriteValueAsync([System.Runtime.CompilerServices.Newtonsoft.Json.Nullable(2)] Uri value, CancellationToken cancellationToken = default (CancellationToken))
  {
    if (cancellationToken.IsCancellationRequested)
      return cancellationToken.FromCanceled();
    this.WriteValue(value);
...
label_45:
  ...
  internal string ContainerPath
  {
    get
    {
      return this._currentPosition.Type != JsonContainerType.None && this._stack != null ? JsonPosition.BuildPath(this._stack, new JsonPosition?()) : string.Empty;
    }
  }
