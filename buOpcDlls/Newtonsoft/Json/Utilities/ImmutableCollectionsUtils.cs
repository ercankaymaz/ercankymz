    ...
    [Nullable(new byte[] {2, 1}), NotNullWhen(true)] out ObjectConstructor<object> parameterizedCreator)
  {
    if (underlyingType.IsGenericType())
    {
      ...
      if (collectionTypeInfo != null)
      {
        ...
        {
          MethodInfo methodInfo = ((IEnumerable<MethodInfo>) type2.GetMethods()).FirstOrDefault<MethodInfo>((Func<MethodInfo, bool>) ([NullableContext(0)] (m) => m.Name == "CreateRange" && m.GetParameters().Length == 1));
    ...
    [Nullable(new byte[] {2, 1}), NotNullWhen(true)] out ObjectConstructor<object> parameterizedCreator)
  {
    if (underlyingType.IsGenericType())
    {
      ...
      if (collectionTypeInfo != null)
      {
        ...
        if (type1 != (Type) null && type2 != (Type) null)
        {
          MethodInfo methodInfo = ((IEnumerable<MethodInfo>) type2.GetMethods()).FirstOrDefault<MethodInfo>((Func<MethodInfo, bool>) ([NullableContext(0)] (m) =>
          {
