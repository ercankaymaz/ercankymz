...
public class DiscriminatedUnionConverter : JsonConverter
{
  ...
  public override void WriteJson(JsonWriter writer, [Nullable(2)] object value, JsonSerializer serializer)
  {
    ...
    else
    {
      ...
      DiscriminatedUnionConverter.UnionCase unionCase = union.Cases.Single<DiscriminatedUnionConverter.UnionCase>((Func<DiscriminatedUnionConverter.UnionCase, bool>) ([NullableContext(0)] (c) => c.Tag == tag));
    ...
    JsonSerializer serializer)
  {
    ...
    while (reader.TokenType == JsonToken.PropertyName)
    {
      ...
      if (string.Equals(a, "Case", StringComparison.OrdinalIgnoreCase))
      {
        ...
        unionCase = union.Cases.SingleOrDefault<DiscriminatedUnionConverter.UnionCase>((Func<DiscriminatedUnionConverter.UnionCase, bool>) ([NullableContext(0)] (c) => c.Name == caseName));
        if (unionCase == null)
