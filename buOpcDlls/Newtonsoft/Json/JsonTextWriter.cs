...
public class JsonTextWriter : JsonWriter
{
  ...
  internal async Task DoCloseAsync(CancellationToken cancellationToken)
  {
    ...
    {
      configuredTaskAwaitable = jsonTextWriter.WriteEndAsync(cancellationToken).ConfigureAwait(false);
      await configuredTaskAwaitable;
    }
    configuredTaskAwaitable = jsonTextWriter.CloseBufferAndWriterAsync().ConfigureAwait(false);
    await configuredTaskAwaitable;
  }
  ...
  {
    JsonTextWriter jsonTextWriter = this;
    if (jsonTextWriter._writeBuffer != null)
    {
      BufferUtils.ReturnBuffer(jsonTextWriter._arrayPool, jsonTextWriter._writeBuffer);
      jsonTextWriter._writeBuffer = (char[]) null;
    }
    if (!jsonTextWriter.CloseOutput || jsonTextWriter._writer == null)
      return;
    await jsonTextWriter._writer.FlushAsync().ConfigureAwait(false);
    jsonTextWriter._writer.Close();
  }
    ...
    CancellationToken cancellationToken)
  {
    ...
    {
      ConfiguredTaskAwaitable.ConfiguredTaskAwaiter awaiter = this._writer.WriteAsync(this._indentChars, newLineLen, Math.Min(currentIndentCount, 12), cancellationToken).ConfigureAwait(false).GetAwaiter();
      ...
      else
      {
        ...
        // ISSUE: explicit reference operation
        // ISSUE: reference to a compiler-generated field
        (^this).\u003C\u003Et__builder.AwaitUnsafeOnCompleted<ConfiguredTaskAwaitable.ConfiguredTaskAwaiter, JsonTextWriter.\u003CWriteIndentAsync\u003Ed__13>(ref awaiter, this);
        break;
      }
    }
  }
    ...
    CancellationToken cancellationToken)
  {
    ...
    return task.IsCompletedSuccessfully() ? this._writer.WriteAsync(value, cancellationToken) : this.WriteValueInternalAsync(task, value, cancellationToken);
  }
  ...
  public override Task WriteRawAsync([System.Runtime.CompilerServices.Newtonsoft.Json.Nullable(2)] string json, CancellationToken cancellationToken = default (CancellationToken))
  {
    return !this._safeAsync ? base.WriteRawAsync(json, cancellationToken) : this.DoWriteRawAsync(json, cancellationToken);
  }

  internal Task DoWriteRawAsync([System.Runtime.CompilerServices.Newtonsoft.Json.Nullable(2)] string json, CancellationToken cancellationToken)
  {
    ...
    CancellationToken cancellationToken)
  {
    ...
    return task.IsCompletedSuccessfully() ? this.WriteDigitsAsync(uvalue, negative, cancellationToken) : this.WriteIntegerValueAsync(task, uvalue, negative, cancellationToken);
  }
  ...
  internal Task DoWritePropertyNameAsync(string name, CancellationToken cancellationToken)
  {
    ...
    return task2.IsCompletedSuccessfully() ? this._writer.WriteAsync(':', cancellationToken) : JavaScriptUtils.WriteCharAsync(task2, this._writer, ':', cancellationToken);
  }
  ...
  internal Task DoWriteStartArrayAsync(CancellationToken cancellationToken)
  {
    ...
    return task.IsCompletedSuccessfully() ? this._writer.WriteAsync('[', cancellationToken) : this.DoWriteStartArrayAsync(task, cancellationToken);
  }
  ...
  internal Task DoWriteStartObjectAsync(CancellationToken cancellationToken)
  {
    ...
    return task.IsCompletedSuccessfully() ? this._writer.WriteAsync('{', cancellationToken) : this.DoWriteStartObjectAsync(task, cancellationToken);
  }
  ...
  internal Task DoWriteUndefinedAsync(CancellationToken cancellationToken)
  {
    ...
    return task.IsCompletedSuccessfully() ? this._writer.WriteAsync(JsonConvert.Undefined, cancellationToken) : this.DoWriteUndefinedAsync(task, cancellationToken);
  }
  ...
  public override Task WriteValueAsync([System.Runtime.CompilerServices.Newtonsoft.Json.Nullable(2)] byte[] value, CancellationToken cancellationToken = default (CancellationToken))
  {
    if (!this._safeAsync)
  ...
  public override Task WriteValueAsync([System.Runtime.CompilerServices.Newtonsoft.Json.Nullable(2)] object value, CancellationToken cancellationToken = default (CancellationToken))
  {
    if (!this._safeAsync)
      return base.WriteValueAsync(value, cancellationToken);
    if (value == null)
  ...
  public override Task WriteValueAsync([System.Runtime.CompilerServices.Newtonsoft.Json.Nullable(2)] string value, CancellationToken cancellationToken = default (CancellationToken))
  {
    return !this._safeAsync ? base.WriteValueAsync(value, cancellationToken) : this.DoWriteValueAsync(value, cancellationToken);
  }

  internal Task DoWriteValueAsync([System.Runtime.CompilerServices.Newtonsoft.Json.Nullable(2)] string value, CancellationToken cancellationToken)
  {
  ...
  public override Task WriteValueAsync([System.Runtime.CompilerServices.Newtonsoft.Json.Nullable(2)] Uri value, CancellationToken cancellationToken = default (CancellationToken))
  {
    if (!this._safeAsync)
      return base.WriteValueAsync(value, cancellationToken);
  ...
  {
    Task task = this.InternalWriteValueAsync(JsonToken.String, cancellationToken);
    return task.IsCompletedSuccessfully() ? this.WriteEscapedStringAsync(value.OriginalString, true, cancellationToken) : this.WriteValueNotNullAsync(task, value, cancellationToken);
  }
  ...
  public override Task WriteCommentAsync([System.Runtime.CompilerServices.Newtonsoft.Json.Nullable(2)] string text, CancellationToken cancellationToken = default (CancellationToken))
  {
    return !this._safeAsync ? base.WriteCommentAsync(text, cancellationToken) : this.DoWriteCommentAsync(text, cancellationToken);
  }

  internal async Task DoWriteCommentAsync([System.Runtime.CompilerServices.Newtonsoft.Json.Nullable(2)] string text, CancellationToken cancellationToken)
  {
    JsonTextWriter jsonTextWriter = this;
  ...
  public override Task WriteRawValueAsync([System.Runtime.CompilerServices.Newtonsoft.Json.Nullable(2)] string json, CancellationToken cancellationToken = default (CancellationToken))
  {
    return !this._safeAsync ? base.WriteRawValueAsync(json, cancellationToken) : this.DoWriteRawValueAsync(json, cancellationToken);
  }

  internal Task DoWriteRawValueAsync([System.Runtime.CompilerServices.Newtonsoft.Json.Nullable(2)] string json, CancellationToken cancellationToken)
  {
    this.UpdateScopeWithFinishedValue();
    Task task = this.AutoCompleteAsync(JsonToken.Undefined, cancellationToken);
    return task.IsCompletedSuccessfully() ? this.WriteRawAsync(json, cancellationToken) : this.DoWriteRawValueAsync(task, json, cancellationToken);
  }

  private async Task DoWriteRawValueAsync(
    Task task,
    [System.Runtime.CompilerServices.Newtonsoft.Json.Nullable(2)] string json,
    CancellationToken cancellationToken)
  {
    JsonTextWriter jsonTextWriter = this;
    ConfiguredTaskAwaitable configuredTaskAwaitable = task.ConfigureAwait(false);
  ...
  private int WriteValueToBuffer(DateTime value)
  {
    ...
    writeBuffer1[0] = (char) quoteChar1;
    int num2 = DateTimeUtils.WriteDateTimeString(this._writeBuffer, 1, value, new TimeSpan?(), value.Kind, this.DateFormatHandling);
    char[] writeBuffer2 = this._writeBuffer;
    int index = num2;
    int buffer = index + 1;
    int quoteChar2 = (int) this._quoteChar;
    writeBuffer2[index] = (char) quoteChar2;
    return buffer;
  }
  ...
  private int WriteValueToBuffer(DateTimeOffset value)
  {
    ...
    int quoteChar1 = (int) this._quoteChar;
    writeBuffer1[0] = (char) quoteChar1;
    int num2 = DateTimeUtils.WriteDateTimeString(this._writeBuffer, 1, this.DateFormatHandling == DateFormatHandling.IsoDateFormat ? value.DateTime : value.UtcDateTime, new TimeSpan?(value.Offset), DateTimeKind.Local, this.DateFormatHandling);
    char[] writeBuffer2 = this._writeBuffer;
    int index = num2;
    int buffer = index + 1;
    int quoteChar2 = (int) this._quoteChar;
  ...
  private void WriteIntegerValue(long value)
  {
    ...
    {
      this._writer.Write((char) (48L /*0x30*/ + value));
    }
    else
    {
