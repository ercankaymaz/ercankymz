...
label_3:
  ...
  internal async Task<bool> ReadAndMoveToContentAsync(CancellationToken cancellationToken)
  {
    ...
    bool contentAsync;
    if (contentAsync = await configuredTaskAwaitable)
    {
  ...
  {
label_2:
    ConfiguredTaskAwaitable<bool>.ConfiguredTaskAwaiter awaiter = this.ReadAsync(cancellationToken).ConfigureAwait(false).GetAwaiter();
    ...
    else
    {
      ...
      // ISSUE: explicit reference operation
      // ISSUE: reference to a compiler-generated field
      (^this).\u003C\u003Et__builder.AwaitUnsafeOnCompleted<ConfiguredTaskAwaitable<bool>.ConfiguredTaskAwaiter, JsonReader.\u003CMoveToContentFromNonContentAsync\u003Ed__14>(ref awaiter, this);
    }
  }
  ...
  public virtual int Depth
  {
    get
    {
      ...
      return !JsonTokenUtils.IsStartToken(this.TokenType) && this._currentPosition.Type != JsonContainerType.None ? count + 1 : count;
    }
  }

  [System.Runtime.CompilerServices.Newtonsoft.Json.Nullable(1)]
  public virtual string Path
  {
    [System.Runtime.CompilerServices.Newtonsoft.Json.NullableContext(1)] get
    {
  ...
  public CultureInfo Culture
  {
    ...
    [System.Runtime.CompilerServices.Newtonsoft.Json.NullableContext(1)] set
    {
      this._culture = value;
    }
  }
