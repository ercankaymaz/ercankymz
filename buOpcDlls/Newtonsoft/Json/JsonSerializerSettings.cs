...
public class JsonSerializerSettings
{
  ...
  public EventHandler<ErrorEventArgs> Error { [return: Nullable(new byte[] {2, 1})] get; [param: Nullable(new byte[] {2, 1})] set; }
  ...
  {
    [NullableContext(1)] get => this._dateFormatString ?? "yyyy'-'MM'-'dd'T'HH':'mm':'ss.FFFFFFFK";
    [NullableContext(1)] set
    {
  ...
  {
    [NullableContext(1)] get => this._culture ?? JsonSerializerSettings.DefaultCulture;
    [NullableContext(1)] set => this._culture = value;
  }
  ...
  public JsonSerializerSettings(JsonSerializerSettings original)
  {
    ...
    this.Converters = (IList<JsonConverter>) original.Converters.ToList<JsonConverter>();
