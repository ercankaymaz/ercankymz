...
public class JsonSerializer
{
  ...
  {
    [NullableContext(2)] get => this.GetReferenceResolver();
  ...
  {
    [NullableContext(2)] get => this._traceWriter;
    [NullableContext(2)] set => this._traceWriter = value;
  }

  [Nullable(2)]
  public virtual IEqualityComparer EqualityComparer
  {
    [NullableContext(2)] get => this._equalityComparer;
    [NullableContext(2)] set => this._equalityComparer = value;
  }
...
label_19:
  ...
  internal static JsonConverter GetMatchingConverter(
    [Nullable(new byte[] {2, 1})] IList<JsonConverter> converters,
    Type objectType)
  {
    if (converters != null)
    {
