  ...
  IConvertible
{
  ...
  {
    if ((settings != null ? (settings.CopyAnnotations ? 1 : 0) : 1) == 0)
      return;
  ...
  internal static int Compare(JTokenType valueType, object objA, object objB)
  {
    ...
    switch (valueType)
    {
      ...
      case JTokenType.Integer:
        ...
        return !(objA is float) && !(objB is float) && !(objA is double) && !(objB is double) ? Convert.ToInt64(objA, (IFormatProvider) CultureInfo.InvariantCulture).CompareTo(Convert.ToInt64(objB, (IFormatProvider) CultureInfo.InvariantCulture)) : JValue.CompareFloat(objA, objB);
      case JTokenType.Float:
        ...
        return !(objA is ulong) && !(objB is ulong) && !(objA is Decimal) && !(objB is Decimal) ? JValue.CompareFloat(objA, objB) : Convert.ToDecimal(objA, (IFormatProvider) CultureInfo.InvariantCulture).CompareTo(Convert.ToDecimal(objB, (IFormatProvider) CultureInfo.InvariantCulture));
      case JTokenType.Boolean:
...
label_6:
        ...
        {
          Decimal num3 = Convert.ToDecimal(objA, (IFormatProvider) CultureInfo.InvariantCulture);
          Decimal num4 = Convert.ToDecimal(objB, (IFormatProvider) CultureInfo.InvariantCulture);
          switch (operation)
          {
            case ExpressionType.Add:
            case ExpressionType.AddAssign:
  ...
  {
    return (JToken) new JValue(this, settings);
  }
  ...
  private class JValueDynamicProxy : DynamicProxy<JValue>
  {
    ...
    public override bool TryBinaryOperation(
      ...
      object arg,
      [Nullable(2), NotNullWhen(true)] out object result)
    {
