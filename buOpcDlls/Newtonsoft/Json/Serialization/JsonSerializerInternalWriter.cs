...
internal class JsonSerializerInternalWriter(JsonSerializer serializer) : JsonSerializerInternalBase(serializer)
{
    ...
    JsonProperty containerProperty)
  {
    ...
    {
      JsonConverter jsonConverter1;
      if (member == null)
      {
        jsonConverter1 = (JsonConverter) null;
      }
      else
      {
        jsonConverter1 = member.Converter;
        if (jsonConverter1 != null)
          goto label_12;
      }
      JsonConverter jsonConverter2;
      if (containerProperty == null)
      {
        jsonConverter2 = (JsonConverter) null;
      }
      else
      {
        jsonConverter2 = containerProperty.ItemConverter;
        if (jsonConverter2 != null)
        {
          jsonConverter1 = jsonConverter2;
          goto label_12;
        }
      }
      ...
      {
        jsonConverter3 = (JsonConverter) null;
      }
      else
      {
        jsonConverter3 = containerContract.ItemConverter;
        if (jsonConverter3 != null)
        {
          jsonConverter1 = jsonConverter3;
          goto label_12;
        }
      }
      jsonConverter1 = valueContract.Converter ?? this.Serializer.GetMatchingConverter(valueContract.UnderlyingType) ?? valueContract.InternalConverter;
label_12:
      JsonConverter converter = jsonConverter1;
  ...
  private bool? ResolveIsReference(
    [Nullable(1)] JsonContract contract,
  ...
  private void SerializeObject(
    ...
    [Nullable(2)] JsonProperty member,
    [Nullable(2)] JsonContainerContract collectionContract,
    [Nullable(2)] JsonProperty containerProperty)
  {
    this.OnSerializing(writer, (JsonContract) contract, value);
  ...
  private bool CalculatePropertyValues(
    ...
    [Nullable(2)] JsonProperty member,
    JsonProperty property,
    [Nullable(2), NotNullWhen(true)] out JsonContract memberContract,
    [Nullable(2)] out object memberValue)
  {
  ...
  {
    bool flag1;
    bool flag2 = (flag1 = ((int) this.ResolveIsReference((JsonContract) contract, member, containerContract, containerProperty) ?? (this.HasFlag(this.Serializer._preserveReferencesHandling, PreserveReferencesHandling.Arrays) ? 1 : 0)) != 0) && (member == null || member.Writable || this.HasCreatorParameter(containerContract, member));
    bool flag3 = this.ShouldWriteType(TypeNameHandling.Arrays, (JsonContract) contract, member, containerContract, containerProperty);
    int num = flag2 | flag3 ? 1 : 0;
    if (num != 0)
    {
      writer.WriteStartObject();
      if (flag2)
