...
public class DefaultContractResolver : IContractResolver
{
  ...
  public NamingStrategy NamingStrategy { [System.Runtime.CompilerServices.Newtonsoft.Json.NullableContext(2)] get; [System.Runtime.CompilerServices.Newtonsoft.Json.NullableContext(2)] set; }
  ...
  protected virtual List<MemberInfo> GetSerializableMembers(Type objectType)
  {
    ...
    IEnumerable<MemberInfo> memberInfos = ReflectionUtils.GetFieldsAndProperties(objectType, BindingFlags.Instance | BindingFlags.Static | BindingFlags.Public | BindingFlags.NonPublic).Where<MemberInfo>((Func<MemberInfo, bool>) ([System.Runtime.CompilerServices.Newtonsoft.Json.NullableContext(0)] (m) =>
    {
    ...
    if (memberSerialization != MemberSerialization.Fields)
    {
      ...
      if (typeof (Exception).IsAssignableFrom(objectType))
        source = source.Where<MemberInfo>((Func<MemberInfo, bool>) ([System.Runtime.CompilerServices.Newtonsoft.Json.NullableContext(0)] (m) => !string.Equals(m.Name, "TargetSite", StringComparison.Ordinal))).ToList<MemberInfo>();
    }
    else
    {
      foreach (MemberInfo memberInfo in memberInfos)
  ...
  protected virtual JsonObjectContract CreateObjectContract(Type objectType)
  {
    ...
    if (contract.IsInstantiable)
    {
      ...
      {
        if (contract.NonNullableUnderlyingType.IsValueType())
        {
  ...
  {
    return this.GetClassHierarchyForType(type).SelectMany<Type, MemberInfo>((Func<Type, IEnumerable<MemberInfo>>) ([System.Runtime.CompilerServices.Newtonsoft.Json.NullableContext(0)] (baseType) =>
    {
    ...
    })).LastOrDefault<MemberInfo>((Func<MemberInfo, bool>) ([System.Runtime.CompilerServices.Newtonsoft.Json.NullableContext(0)] (m) =>
    {
      switch (m.MemberType())
      {
  ...
  private static void SetExtensionDataDelegates(JsonObjectContract contract, MemberInfo member)
  {
    ...
    if (attribute.ReadData)
    {
      ...
      ExtensionDataSetter extensionDataSetter = (ExtensionDataSetter) ((o, key, [System.Runtime.CompilerServices.Newtonsoft.Json.Nullable(2)] value) =>
      {
    ...
    if (attribute.WriteData)
    {
      ...
      ExtensionDataGetter extensionDataGetter = (ExtensionDataGetter) ([return: System.Runtime.CompilerServices.Newtonsoft.Json.Nullable(new byte[] {2, 0, 1, 1})] (o) =>
      {
  ...
  {
    IEnumerator<ConstructorInfo> enumerator = ((IEnumerable<ConstructorInfo>) objectType.GetConstructors(BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic)).Where<ConstructorInfo>((Func<ConstructorInfo, bool>) ([System.Runtime.CompilerServices.Newtonsoft.Json.NullableContext(0)] (c) => c.IsDefined(typeof (JsonConstructorAttribute), true))).GetEnumerator();
  ...
  private JsonProperty MatchProperty(JsonPropertyCollection properties, string name, Type type)
  {
    ...
    return closestMatchProperty != null && !(closestMatchProperty.PropertyType != type) ? closestMatchProperty : (JsonProperty) null;
  }

  protected virtual JsonProperty CreatePropertyFromConstructorParameter(
    [System.Runtime.CompilerServices.Newtonsoft.Json.Nullable(2)] JsonProperty matchingMemberProperty,
  ...
  private void GetCallbackMethodsForType(
    Type type,
    [System.Runtime.CompilerServices.Newtonsoft.Json.Nullable(new byte[] {2, 1})] out List<SerializationCallback> onSerializing,
    [System.Runtime.CompilerServices.Newtonsoft.Json.Nullable(new byte[] {2, 1})] out List<SerializationCallback> onSerialized,
    [System.Runtime.CompilerServices.Newtonsoft.Json.Nullable(new byte[] {2, 1})] out List<SerializationCallback> onDeserializing,
    [System.Runtime.CompilerServices.Newtonsoft.Json.Nullable(new byte[] {2, 1})] out List<SerializationCallback> onDeserialized,
    [System.Runtime.CompilerServices.Newtonsoft.Json.Nullable(new byte[] {2, 1})] out List<SerializationErrorCallback> onError)
  {
  ...
  private static bool IsValidCallback(
    ...
    Type attributeType,
    [System.Runtime.CompilerServices.Newtonsoft.Json.Nullable(2)] MethodInfo currentCallback,
    [System.Runtime.CompilerServices.Newtonsoft.Json.Nullable(2)] ref Type prevAttributeType)
  {
  ...
  {
    return !type.IsGenericTypeDefinition() && type.ContainsGenericParameters() ? "{0}.{1}".FormatWith((IFormatProvider) CultureInfo.InvariantCulture, (object) type.Namespace, (object) type.Name) : type.FullName;
  }
    ...
    MemberSerialization memberSerialization)
  {
    ...
    return (IList<JsonProperty>) source.OrderBy<JsonProperty, int>((Func<JsonProperty, int>) ([System.Runtime.CompilerServices.Newtonsoft.Json.NullableContext(0)] (p) => p.Order ?? -1)).ToList<JsonProperty>();
  }
  ...
  [return: System.Runtime.CompilerServices.Newtonsoft.Json.Nullable(new byte[] {2, 1})]
  ...
  internal class EnumerableDictionaryWrapper<[System.Runtime.CompilerServices.Newtonsoft.Json.Nullable(2)] TEnumeratorKey, [System.Runtime.CompilerServices.Newtonsoft.Json.Nullable(2)] TEnumeratorValue> : 
    IEnumerable<KeyValuePair<object, object>>,
    IEnumerable
  {
    [System.Runtime.CompilerServices.Newtonsoft.Json.Nullable(new byte[] {1, 0, 1, 1})]
    private readonly IEnumerable<KeyValuePair<TEnumeratorKey, TEnumeratorValue>> _e;

    public EnumerableDictionaryWrapper(
      [System.Runtime.CompilerServices.Newtonsoft.Json.Nullable(new byte[] {1, 0, 1, 1})] IEnumerable<KeyValuePair<TEnumeratorKey, TEnumeratorValue>> e)
    {
      ValidationUtils.ArgumentNotNull((object) e, nameof (e));
      this._e = e;
    }

    [return: System.Runtime.CompilerServices.Newtonsoft.Json.Nullable(new byte[] {1, 0, 1, 1})]
