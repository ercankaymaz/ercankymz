...
label_18:
  ...
  private bool ReadMetadataPropertiesToken(
    [Nullable(1)] JTokenReader reader,
    ref Type objectType,
...
label_20:
  ...
  private void ResolveTypeName(
    ...
    JsonContainerContract containerContract,
    JsonProperty containerMember,
    [Nullable(1)] string qualifiedTypeName)
  {
  ...
  private object EnsureType(
    [Nullable(1)] JsonReader reader,
    object value,
    [Nullable(1)] CultureInfo culture,
    JsonContract contract,
    Type targetType)
  {
  ...
  private bool SetPropertyValue(
    ...
    [Nullable(2)] JsonConverter propertyConverter,
    [Nullable(2)] JsonContainerContract containerContract,
    [Nullable(2)] JsonProperty containerProperty,
    JsonReader reader,
    object target)
  {
  ...
  private bool CalculatePropertyDetails(
    [Nullable(1)] JsonProperty property,
    ref JsonConverter propertyConverter,
    JsonContainerContract containerContract,
    JsonProperty containerProperty,
    [Nullable(1)] JsonReader reader,
    [Nullable(1)] object target,
    ...
    out bool ignoredValue)
  {
    ...
    {
      JsonContract propertyContract1 = property.PropertyContract;
      if ((propertyContract1 != null ? (propertyContract1.ContractType != JsonContractType.Linq ? 1 : 0) : 1) != 0)
      {
        currentValue = property.ValueProvider.GetValue(target);
...
label_22:
  ...
  private void ThrowUnexpectedEndException(
    JsonReader reader,
    JsonContract contract,
    [Nullable(2)] object currentObject,
    string message)
  {
    try
    {
...
label_12:
    ...
    [Nullable(2)] JsonProperty member)
  {
    ...
    reader.MaxDepth = this.Serializer.MaxDepth;
    reader.ReadAndAssert();
...
label_22:
    ...
    [Nullable(2)] string id)
  {
    ...
    if (this.TraceWriter != null && this.TraceWriter.LevelFilter >= TraceLevel.Info)
    {
      string str = string.Join(", ", contract.CreatorParameters.Select<JsonProperty, string>((Func<JsonProperty, string>) ([NullableContext(0)] (p) => p.PropertyName)));
    ...
    if (flag)
    {
      foreach (JsonProperty property1 in (Collection<JsonProperty>) contract.Properties)
      {
        ...
        if (!property.Ignored && source.All<JsonSerializerInternalReader.CreatorPropertyContext>((Func<JsonSerializerInternalReader.CreatorPropertyContext, bool>) ([NullableContext(0)] (p) => p.Property != property)))
    ...
    foreach (JsonSerializerInternalReader.CreatorPropertyContext creatorPropertyContext in source)
    {
      ...
      if (constructorProperty == null && creatorPropertyContext.Property != null)
        constructorProperty = contract.CreatorParameters.ForgivingCaseSensitiveFind<JsonProperty>((Func<JsonProperty, string>) ([NullableContext(0)] [return: Nullable(1)] (p) => p.PropertyName), creatorPropertyContext.Property.UnderlyingName);
...
label_23:
  ...
  public object CreateNewObject(
    ...
    [Nullable(2)] JsonProperty containerMember,
    [Nullable(2)] JsonProperty containerProperty,
    [Nullable(2)] string id,
    out bool createdFromNonDefaultCreator)
  {
...
label_27:
  ...
  private void SetPropertyPresence(
    JsonReader reader,
    JsonProperty property,
    [Nullable(new byte[] {2, 1})] Dictionary<JsonProperty, JsonSerializerInternalReader.PropertyPresence> requiredProperties)
  {
