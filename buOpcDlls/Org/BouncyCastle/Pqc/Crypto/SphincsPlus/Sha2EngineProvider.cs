...
// Type: Org.BouncyCastle.Pqc.Crypto.SphincsPlus.Sha2EngineProvider
...
internal sealed class Sha2EngineProvider : ISphincsPlusEngineProvider
{
  ...
  {
    return (SphincsPlusEngine) new SphincsPlusEngine.Sha2Engine(this.robust, this.n, this.w, this.d, this.a, this.k, this.h);
  }
}
