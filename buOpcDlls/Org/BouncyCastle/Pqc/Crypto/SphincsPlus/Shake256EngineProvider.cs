...
// Type: Org.BouncyCastle.Pqc.Crypto.SphincsPlus.Shake256EngineProvider
...
internal sealed class Shake256EngineProvider : ISphincsPlusEngineProvider
{
  ...
  {
    return (SphincsPlusEngine) new SphincsPlusEngine.Shake256Engine(this.robust, this.n, this.w, this.d, this.a, this.k, this.h);
  }
}
