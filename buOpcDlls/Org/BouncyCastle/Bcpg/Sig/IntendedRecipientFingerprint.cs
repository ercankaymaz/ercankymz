...
// Type: Org.BouncyCastle.Bcpg.Sig.IntendedRecipientFingerprint
...
public class IntendedRecipientFingerprint : SignatureSubpacket
{
  ...
  public IntendedRecipientFingerprint(bool critical, int keyVersion, byte[] fingerprint)
    : base(SignatureSubpacketTag.IntendedRecipientFingerprint, critical, false, Arrays.Prepend(fingerprint, (byte) keyVersion))
  {
  }
