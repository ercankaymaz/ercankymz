...
public sealed class TnepresEngine : SerpentEngineBase
{
  ...
  {
    int[] sourceArray = new int[16 /*0x10*/];
    int num1 = 0;
    int off;
    for (off = key.Length - 4; off > 0; off -= 4)
      sourceArray[num1++] = (int) Pack.BE_To_UInt32(key, off);
    if (off != 0)
    ...
    int num2 = 132;
    int[] destinationArray = new int[132];
    for (int index3 = 8; index3 < 16 /*0x10*/; ++index3)
      sourceArray[index3] = Integers.RotateLeft(sourceArray[index3 - 8] ^ sourceArray[index3 - 5] ^ sourceArray[index3 - 3] ^ sourceArray[index3 - 1] ^ -1640531527 ^ index3 - 8, 11);
    Array.Copy((Array) sourceArray, 8, (Array) destinationArray, 0, 8);
    for (int index4 = 8; index4 < num2; ++index4)
      destinationArray[index4] = Integers.RotateLeft(destinationArray[index4 - 8] ^ destinationArray[index4 - 5] ^ destinationArray[index4 - 3] ^ destinationArray[index4 - 1] ^ -1640531527 ^ index4, 11);
    ...
    this.Sb7(destinationArray[16 /*0x10*/], destinationArray[17], destinationArray[18], destinationArray[19]);
    destinationArray[16 /*0x10*/] = this.X0;
    ...
    this.Sb4(destinationArray[28], destinationArray[29], destinationArray[30], destinationArray[31 /*0x1F*/]);
    destinationArray[28] = this.X0;
    destinationArray[29] = this.X1;
    destinationArray[30] = this.X2;
    destinationArray[31 /*0x1F*/] = this.X3;
    this.Sb3(destinationArray[32 /*0x20*/], destinationArray[33], destinationArray[34], destinationArray[35]);
    destinationArray[32 /*0x20*/] = this.X0;
    ...
    this.Sb7(destinationArray[48 /*0x30*/], destinationArray[49], destinationArray[50], destinationArray[51]);
    destinationArray[48 /*0x30*/] = this.X0;
    ...
    this.Sb4(destinationArray[60], destinationArray[61], destinationArray[62], destinationArray[63 /*0x3F*/]);
    destinationArray[60] = this.X0;
    destinationArray[61] = this.X1;
    destinationArray[62] = this.X2;
    destinationArray[63 /*0x3F*/] = this.X3;
    this.Sb3(destinationArray[64 /*0x40*/], destinationArray[65], destinationArray[66], destinationArray[67]);
    destinationArray[64 /*0x40*/] = this.X0;
    ...
    this.Sb7(destinationArray[80 /*0x50*/], destinationArray[81], destinationArray[82], destinationArray[83]);
    destinationArray[80 /*0x50*/] = this.X0;
    ...
    this.Sb3(destinationArray[96 /*0x60*/], destinationArray[97], destinationArray[98], destinationArray[99]);
    destinationArray[96 /*0x60*/] = this.X0;
    ...
    this.Sb7(destinationArray[112 /*0x70*/], destinationArray[113], destinationArray[114], destinationArray[115]);
    destinationArray[112 /*0x70*/] = this.X0;
    ...
    this.Sb4(destinationArray[124], destinationArray[125], destinationArray[126], destinationArray[(int) sbyte.MaxValue]);
    destinationArray[124] = this.X0;
    destinationArray[125] = this.X1;
    destinationArray[126] = this.X2;
    destinationArray[(int) sbyte.MaxValue] = this.X3;
    this.Sb3(destinationArray[128 /*0x80*/], destinationArray[129], destinationArray[130], destinationArray[131]);
    destinationArray[128 /*0x80*/] = this.X0;
  ...
  internal override void EncryptBlock(byte[] input, int inOff, byte[] output, int outOff)
  {
    ...
    this.LT();
    this.Sb4(this.wKey[16 /*0x10*/] ^ this.X0, this.wKey[17] ^ this.X1, this.wKey[18] ^ this.X2, this.wKey[19] ^ this.X3);
    this.LT();
    ...
    this.LT();
    this.Sb7(this.wKey[28] ^ this.X0, this.wKey[29] ^ this.X1, this.wKey[30] ^ this.X2, this.wKey[31 /*0x1F*/] ^ this.X3);
    this.LT();
    this.Sb0(this.wKey[32 /*0x20*/] ^ this.X0, this.wKey[33] ^ this.X1, this.wKey[34] ^ this.X2, this.wKey[35] ^ this.X3);
    this.LT();
    ...
    this.LT();
    this.Sb4(this.wKey[48 /*0x30*/] ^ this.X0, this.wKey[49] ^ this.X1, this.wKey[50] ^ this.X2, this.wKey[51] ^ this.X3);
    this.LT();
    ...
    this.LT();
    this.Sb7(this.wKey[60] ^ this.X0, this.wKey[61] ^ this.X1, this.wKey[62] ^ this.X2, this.wKey[63 /*0x3F*/] ^ this.X3);
    this.LT();
    this.Sb0(this.wKey[64 /*0x40*/] ^ this.X0, this.wKey[65] ^ this.X1, this.wKey[66] ^ this.X2, this.wKey[67] ^ this.X3);
    this.LT();
    ...
    this.LT();
    this.Sb4(this.wKey[80 /*0x50*/] ^ this.X0, this.wKey[81] ^ this.X1, this.wKey[82] ^ this.X2, this.wKey[83] ^ this.X3);
    this.LT();
    ...
    this.LT();
    this.Sb0(this.wKey[96 /*0x60*/] ^ this.X0, this.wKey[97] ^ this.X1, this.wKey[98] ^ this.X2, this.wKey[99] ^ this.X3);
    this.LT();
    ...
    this.LT();
    this.Sb4(this.wKey[112 /*0x70*/] ^ this.X0, this.wKey[113] ^ this.X1, this.wKey[114] ^ this.X2, this.wKey[115] ^ this.X3);
    this.LT();
    ...
    this.LT();
    this.Sb7(this.wKey[124] ^ this.X0, this.wKey[125] ^ this.X1, this.wKey[126] ^ this.X2, this.wKey[(int) sbyte.MaxValue] ^ this.X3);
    ...
    Pack.UInt32_To_BE((uint) (this.wKey[128 /*0x80*/] ^ this.X0), output, outOff + 12);
  }
