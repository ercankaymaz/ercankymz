...
public class JPakeParticipant
{
  ...
  public JPakeParticipant(string participantId, char[] password, JPakePrimeOrderGroup group)
    : this(participantId, password, group, (IDigest) new Sha256Digest(), CryptoServicesRegistrar.GetSecureRandom())
  {
  }
    ...
    SecureRandom random)
  {
    ...
    JPakeUtilities.ValidateNotNull((object) password, nameof (password));
    JPakeUtilities.ValidateNotNull((object) group, nameof (p));
    JPakeUtilities.ValidateNotNull((object) digest, nameof (digest));
    JPakeUtilities.ValidateNotNull((object) random, nameof (random));
    if (password.Length == 0)
      throw new ArgumentException("Password must not be empty.");
    this.participantId = participantId;
    this.password = new char[password.Length];
    Array.Copy((Array) password, (Array) this.password, password.Length);
    this.p = group.P;
    this.q = group.Q;
    this.g = group.G;
    this.digest = digest;
  ...
  public virtual JPakeRound2Payload CreateRound2PayloadToSend()
  {
    ...
    BigInteger x2s = JPakeUtilities.CalculateX2s(this.q, this.x2, JPakeUtilities.CalculateS(this.q, this.password));
  ...
  public virtual BigInteger CalculateKeyingMaterial()
  {
    ...
    BigInteger s = JPakeUtilities.CalculateS(this.q, this.password);
    Array.Clear((Array) this.password, 0, this.password.Length);
    this.password = (char[]) null;
    BigInteger keyingMaterial = JPakeUtilities.CalculateKeyingMaterial(this.p, this.q, this.gx4, this.x2, s, this.b);
    this.x1 = (BigInteger) null;
    this.x2 = (BigInteger) null;
    this.b = (BigInteger) null;
    ...
    BigInteger keyingMaterial)
  {
    ...
    this.gx1 = (BigInteger) null;
    this.gx2 = (BigInteger) null;
    this.gx3 = (BigInteger) null;
    this.gx4 = (BigInteger) null;
