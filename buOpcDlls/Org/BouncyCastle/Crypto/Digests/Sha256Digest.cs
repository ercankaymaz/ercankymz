...
public class Sha256Digest : GeneralDigest
{
  ...
  internal override void ProcessBlock()
  {
    for (int index = 16 /*0x10*/; index <= 63 /*0x3F*/; ++index)
      this.X[index] = Sha256Digest.Theta1(this.X[index - 2]) + this.X[index - 7] + Sha256Digest.Theta0(this.X[index - 15]) + this.X[index - 16 /*0x10*/];
    uint num1 = this.H1;
    uint num2 = this.H2;
    uint num3 = this.H3;
    uint num4 = this.H4;
  ...
  {
    return (uint) ((((int) (x >> 6) | (int) x << 26) ^ ((int) (x >> 11) | (int) x << 21) ^ ((int) (x >> 25) | (int) x << 7)) + ((int) z ^ (int) x & ((int) y ^ (int) z)));
  }

  private static uint Sum0Maj(uint x, uint y, uint z)
  {
    return (uint) ((((int) (x >> 2) | (int) x << 30) ^ ((int) (x >> 13) | (int) x << 19) ^ ((int) (x >> 22) | (int) x << 10)) + ((int) x & (int) y | (int) z & ((int) x ^ (int) y)));
  }
  ...
  public override IMemoable Copy() => (IMemoable) new Sha256Digest(this);
