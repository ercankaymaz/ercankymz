...
public class Sha1Digest : GeneralDigest
{
  ...
  private uint H4;
  private uint H5;
  private uint[] X = new uint[80 /*0x50*/];
  private int xOff;
  ...
  internal override void ProcessBlock()
  {
    ...
    {
      uint num = this.X[index - 3] ^ this.X[index - 8] ^ this.X[index - 14] ^ this.X[index - 16 /*0x10*/];
      this.X[index] = num << 1 | num >> 31 /*0x1F*/;
    }
    uint u1 = this.H1;
    uint u2 = this.H2;
    uint num1 = this.H3;
    ...
    {
      int num5 = (int) num3;
      int num6 = ((int) u1 << 5 | (int) (u1 >> 27)) + (int) Sha1Digest.F(u2, num1, num2);
      uint[] x1 = this.X;
      int index2 = num4;
      int num7 = index2 + 1;
      ...
      int num11 = (int) num2;
      int num12 = ((int) u3 << 5 | (int) (u3 >> 27)) + (int) Sha1Digest.F(u1, num10, num1);
      uint[] x2 = this.X;
      int index3 = num7;
      int num13 = index3 + 1;
      ...
      int num17 = (int) num1;
      int num18 = ((int) u4 << 5 | (int) (u4 >> 27)) + (int) Sha1Digest.F(u3, num16, num10);
      uint[] x3 = this.X;
      int index4 = num13;
      int num19 = index4 + 1;
      ...
      num3 = u3 << 30 | u3 >> 2;
      int num22 = (int) num10;
      int num23 = ((int) u5 << 5 | (int) (u5 >> 27)) + (int) Sha1Digest.F(u4, num3, num16);
      uint[] x4 = this.X;
      int index5 = num19;
      int num24 = index5 + 1;
      ...
      num2 = u4 << 30 | u4 >> 2;
      int num27 = (int) num16;
      int num28 = ((int) u2 << 5 | (int) (u2 >> 27)) + (int) Sha1Digest.F(u5, num2, num3);
      uint[] x5 = this.X;
      int index6 = num24;
      num4 = index6 + 1;
    ...
    {
      int num31 = (int) num3;
      int num32 = ((int) u1 << 5 | (int) (u1 >> 27)) + (int) Sha1Digest.H(u2, num1, num2);
      uint[] x6 = this.X;
      int index8 = num4;
      int num33 = index8 + 1;
      ...
      int num37 = (int) num2;
      int num38 = ((int) u6 << 5 | (int) (u6 >> 27)) + (int) Sha1Digest.H(u1, num36, num1);
      uint[] x7 = this.X;
      int index9 = num33;
      int num39 = index9 + 1;
      ...
      int num43 = (int) num1;
      int num44 = ((int) u7 << 5 | (int) (u7 >> 27)) + (int) Sha1Digest.H(u6, num42, num36);
      uint[] x8 = this.X;
      int index10 = num39;
      int num45 = index10 + 1;
      ...
      num3 = u6 << 30 | u6 >> 2;
      int num48 = (int) num36;
      int num49 = ((int) u8 << 5 | (int) (u8 >> 27)) + (int) Sha1Digest.H(u7, num3, num42);
      uint[] x9 = this.X;
      int index11 = num45;
      int num50 = index11 + 1;
      ...
      num2 = u7 << 30 | u7 >> 2;
      int num53 = (int) num42;
      int num54 = ((int) u2 << 5 | (int) (u2 >> 27)) + (int) Sha1Digest.H(u8, num2, num3);
      uint[] x10 = this.X;
      int index12 = num50;
      num4 = index12 + 1;
    ...
    {
      int num57 = (int) num3;
      int num58 = ((int) u1 << 5 | (int) (u1 >> 27)) + (int) Sha1Digest.G(u2, num1, num2);
      uint[] x11 = this.X;
      int index14 = num4;
      int num59 = index14 + 1;
      ...
      int num63 = (int) num2;
      int num64 = ((int) u9 << 5 | (int) (u9 >> 27)) + (int) Sha1Digest.G(u1, num62, num1);
      uint[] x12 = this.X;
      int index15 = num59;
      int num65 = index15 + 1;
      ...
      int num69 = (int) num1;
      int num70 = ((int) u10 << 5 | (int) (u10 >> 27)) + (int) Sha1Digest.G(u9, num68, num62);
      uint[] x13 = this.X;
      int index16 = num65;
      int num71 = index16 + 1;
      ...
      num3 = u9 << 30 | u9 >> 2;
      int num74 = (int) num62;
      int num75 = ((int) u11 << 5 | (int) (u11 >> 27)) + (int) Sha1Digest.G(u10, num3, num68);
      uint[] x14 = this.X;
      int index17 = num71;
      int num76 = index17 + 1;
      ...
      num2 = u10 << 30 | u10 >> 2;
      int num79 = (int) num68;
      int num80 = ((int) u2 << 5 | (int) (u2 >> 27)) + (int) Sha1Digest.G(u11, num2, num3);
      uint[] x15 = this.X;
      int index18 = num76;
      num4 = index18 + 1;
    ...
    {
      int num83 = (int) num3;
      int num84 = ((int) u1 << 5 | (int) (u1 >> 27)) + (int) Sha1Digest.H(u2, num1, num2);
      uint[] x16 = this.X;
      int index20 = num4;
      int num85 = index20 + 1;
      ...
      int num89 = (int) num2;
      int num90 = ((int) u12 << 5 | (int) (u12 >> 27)) + (int) Sha1Digest.H(u1, num88, num1);
      uint[] x17 = this.X;
      int index21 = num85;
      int num91 = index21 + 1;
      ...
      int num95 = (int) num1;
      int num96 = ((int) u13 << 5 | (int) (u13 >> 27)) + (int) Sha1Digest.H(u12, num94, num88);
      uint[] x18 = this.X;
      int index22 = num91;
      int num97 = index22 + 1;
      ...
      int num101 = ((int) u14 << 5 | (int) (u14 >> 27)) + (int) Sha1Digest.H(u13, num3, num94);
      uint[] x19 = this.X;
      int index23 = num97;
      ...
      int num106 = ((int) u2 << 5 | (int) (u2 >> 27)) + (int) Sha1Digest.H(u14, num2, num3);
      uint[] x20 = this.X;
      int index24 = num102;
      num4 = index24 + 1;
  ...
  public override IMemoable Copy() => (IMemoable) new Sha1Digest(this);
