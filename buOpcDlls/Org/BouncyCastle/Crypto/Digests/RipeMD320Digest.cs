...
public class RipeMD320Digest : GeneralDigest
{
  ...
  {
    this.Finish();
    Pack.UInt32_To_LE((uint) this.H0, output, outOff);
    Pack.UInt32_To_LE((uint) this.H1, output, outOff + 4);
    Pack.UInt32_To_LE((uint) this.H2, output, outOff + 8);
    Pack.UInt32_To_LE((uint) this.H3, output, outOff + 12);
    Pack.UInt32_To_LE((uint) this.H4, output, outOff + 16 /*0x10*/);
    Pack.UInt32_To_LE((uint) this.H5, output, outOff + 20);
    Pack.UInt32_To_LE((uint) this.H6, output, outOff + 24);
    Pack.UInt32_To_LE((uint) this.H7, output, outOff + 28);
    Pack.UInt32_To_LE((uint) this.H8, output, outOff + 32 /*0x20*/);
    Pack.UInt32_To_LE((uint) this.H9, output, outOff + 36);
    this.Reset();
    return 40;
  }
  ...
  private int RL(int x, int n) => x << n | x >>> 32 /*0x20*/ - n;
  ...
  public override IMemoable Copy() => (IMemoable) new RipeMD320Digest(this);
