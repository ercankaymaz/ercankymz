...
{
  private const int MyByteLength = 128 /*0x80*/;
  private byte[] xBuf;
  private int xBufOff;
  ...
  internal ulong H7;
  internal ulong H8;
  private ulong[] W = new ulong[80 /*0x50*/];
  private int wOff;
  ...
  protected void CopyIn(LongDigest t)
  {
    ...
    this.H7 = t.H7;
    this.H8 = t.H8;
    Array.Copy((Array) t.W, 0, (Array) this.W, 0, t.W.Length);
    this.wOff = t.wOff;
  }
  ...
  {
    if (this.byteCount1 <= 2305843009213693951L /*0x1FFFFFFFFFFFFFFF*/)
      return;
    this.byteCount2 += this.byteCount1 >>> 61;
    this.byteCount1 &= 2305843009213693951L /*0x1FFFFFFFFFFFFFFF*/;
  }
  ...
  internal void ProcessBlock()
  {
    ...
    for (int index = 16 /*0x10*/; index <= 79; ++index)
      this.W[index] = LongDigest.Sigma1(this.W[index - 2]) + this.W[index - 7] + LongDigest.Sigma0(this.W[index - 15]) + this.W[index - 16 /*0x10*/];
    ulong num1 = this.H1;
    ulong num2 = this.H2;
    ulong num3 = this.H3;
    ulong num4 = this.H4;
    ...
    {
      long num9 = (long) num8;
      long num10 = (long) LongDigest.Sum1(num5) + (long) LongDigest.Ch(num5, num6, num7) + (long) LongDigest.K[index1];
      ulong[] w1 = this.W;
      int index3 = index1;
      int index4 = index3 + 1;
      ...
      ulong num15 = num13 + (LongDigest.Sum0(num1) + LongDigest.Maj(num1, num2, num3));
      long num16 = (long) num7;
      long num17 = (long) LongDigest.Sum1(num14) + (long) LongDigest.Ch(num14, num5, num6) + (long) LongDigest.K[index4];
      ulong[] w2 = this.W;
      int index5 = index4;
      int index6 = index5 + 1;
      ...
      ulong num22 = num20 + (LongDigest.Sum0(num15) + LongDigest.Maj(num15, num1, num2));
      long num23 = (long) num6;
      long num24 = (long) LongDigest.Sum1(num21) + (long) LongDigest.Ch(num21, num14, num5) + (long) LongDigest.K[index6];
      ulong[] w3 = this.W;
      int index7 = index6;
      int index8 = index7 + 1;
      ...
      ulong num29 = num27 + (LongDigest.Sum0(num22) + LongDigest.Maj(num22, num15, num1));
      long num30 = (long) num5;
      long num31 = (long) LongDigest.Sum1(num28) + (long) LongDigest.Ch(num28, num21, num14) + (long) LongDigest.K[index8];
      ulong[] w4 = this.W;
      int index9 = index8;
      ...
      ulong num36 = num34 + (LongDigest.Sum0(num29) + LongDigest.Maj(num29, num22, num15));
      long num37 = (long) num14;
      long num38 = (long) LongDigest.Sum1(num35) + (long) LongDigest.Ch(num35, num28, num21) + (long) LongDigest.K[index10];
      ulong[] w5 = this.W;
      int index11 = index10;
      ...
      num8 = num15 + num41;
      num4 = num41 + (LongDigest.Sum0(num36) + LongDigest.Maj(num36, num29, num22));
      long num42 = (long) num21;
      long num43 = (long) LongDigest.Sum1(num8) + (long) LongDigest.Ch(num8, num35, num28) + (long) LongDigest.K[index12];
      ulong[] w6 = this.W;
      int index13 = index12;
      ...
      num7 = num22 + num46;
      num3 = num46 + (LongDigest.Sum0(num4) + LongDigest.Maj(num4, num36, num29));
      long num47 = (long) num28;
      long num48 = (long) LongDigest.Sum1(num7) + (long) LongDigest.Ch(num7, num8, num35) + (long) LongDigest.K[index14];
      ulong[] w7 = this.W;
      int index15 = index14;
      ...
      num6 = num29 + num51;
      num2 = num51 + (LongDigest.Sum0(num3) + LongDigest.Maj(num3, num4, num36));
      long num52 = (long) num35;
      long num53 = (long) LongDigest.Sum1(num6) + (long) LongDigest.Ch(num6, num7, num8) + (long) LongDigest.K[index16];
      ulong[] w8 = this.W;
      int index17 = index16;
      index1 = index17 + 1;
      ...
      num5 = num36 + num56;
      num1 = num56 + (LongDigest.Sum0(num2) + LongDigest.Maj(num2, num3, num4));
    }
    this.H1 += num1;
    this.H2 += num2;
    this.H3 += num3;
    ...
    this.H8 += num8;
    this.wOff = 0;
    Array.Clear((Array) this.W, 0, 16 /*0x10*/);
  }
