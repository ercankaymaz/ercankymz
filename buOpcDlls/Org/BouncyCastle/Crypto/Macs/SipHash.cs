...
public class SipHash : IMac
{
  ...
  public virtual void Init(ICipherParameters parameters)
  {
    ...
    this.k0 = bs.Length == 16 /*0x10*/ ? (long) Pack.LE_To_UInt64(bs, 0) : throw new ArgumentException("must be a 128-bit key", nameof (parameters));
  ...
  protected virtual void ApplySipRounds(int n)
  {
    ...
    for (int index = 0; index < n; ++index)
    {
      long x3 = num1 + x1;
      long num3 = num2 + x2;
      long num4 = SipHash.RotateLeft(x1, 13);
      long num5 = SipHash.RotateLeft(x2, 16 /*0x10*/);
      long x4 = num4 ^ x3;
      long x5 = num5 ^ num3;
      long num6 = SipHash.RotateLeft(x3, 32 /*0x20*/);
      long x6 = num3 + x4;
      num1 = num6 + x5;
      long num7 = SipHash.RotateLeft(x4, 17);
      long num8 = SipHash.RotateLeft(x5, 21);
      x1 = num7 ^ x6;
      x2 = num8 ^ num1;
      num2 = SipHash.RotateLeft(x6, 32 /*0x20*/);
    }
    this.v0 = num1;
    this.v1 = x1;
    this.v2 = num2;
