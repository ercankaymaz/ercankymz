...
public static class TeleTrusTNamedCurves
{
  ...
  public static X9ECParameters GetByName(string name)
  {
    ...
    return oid != null ? TeleTrusTNamedCurves.GetByOid(oid) : (X9ECParameters) null;
  }

  public static X9ECParametersHolder GetByNameLazy(string name)
  {
    DerObjectIdentifier oid = TeleTrusTNamedCurves.GetOid(name);
    return oid != null ? TeleTrusTNamedCurves.GetByOidLazy(oid) : (X9ECParametersHolder) null;
  }

  public static X9ECParameters GetByOid(DerObjectIdentifier oid)
  {
    return TeleTrusTNamedCurves.GetByOidLazy(oid)?.Parameters;
  }

  public static X9ECParametersHolder GetByOidLazy(DerObjectIdentifier oid)
  {
    return CollectionUtilities.GetValueOrNull<DerObjectIdentifier, X9ECParametersHolder>((IDictionary<DerObjectIdentifier, X9ECParametersHolder>) TeleTrusTNamedCurves.curves, oid);
  }

  public static string GetName(DerObjectIdentifier oid)
  {
    return CollectionUtilities.GetValueOrNull<DerObjectIdentifier, string>((IDictionary<DerObjectIdentifier, string>) TeleTrusTNamedCurves.names, oid);
  }

  public static DerObjectIdentifier GetOid(string name)
  {
    return CollectionUtilities.GetValueOrNull<string, DerObjectIdentifier>((IDictionary<string, DerObjectIdentifier>) TeleTrusTNamedCurves.objIds, name);
  }
  ...
  public static IEnumerable<string> Names
  {
    get
    {
      return CollectionUtilities.Proxy<string>((IEnumerable<string>) TeleTrusTNamedCurves.objIds.Keys);
    }
  }

  internal class BrainpoolP160r1Holder : X9ECParametersHolder
  {
    internal static readonly X9ECParametersHolder Instance = (X9ECParametersHolder) new TeleTrusTNamedCurves.BrainpoolP160r1Holder();
    ...
    {
      BigInteger order = TeleTrusTNamedCurves.FromHex("E95E4A5F737059DC60DF5991D45029409E60FC09");
      BigInteger one = BigInteger.One;
      return TeleTrusTNamedCurves.ConfigureCurve((ECCurve) new FpCurve(TeleTrusTNamedCurves.FromHex("E95E4A5F737059DC60DFC7AD95B3D8139515620F"), TeleTrusTNamedCurves.FromHex("340E7BE2A280EB74E2BE61BADA745D97E8F7C300"), TeleTrusTNamedCurves.FromHex("1E589A8595423412134FAA2DBDEC95C8D8675E58"), order, one, true));
    }
  ...
  {
    internal static readonly X9ECParametersHolder Instance = (X9ECParametersHolder) new TeleTrusTNamedCurves.BrainpoolP160t1Holder();
    ...
    protected override ECCurve CreateCurve()
    {
      BigInteger order = TeleTrusTNamedCurves.FromHex("E95E4A5F737059DC60DF5991D45029409E60FC09");
      BigInteger one = BigInteger.One;
      return TeleTrusTNamedCurves.ConfigureCurve((ECCurve) new FpCurve(TeleTrusTNamedCurves.FromHex("E95E4A5F737059DC60DFC7AD95B3D8139515620F"), TeleTrusTNamedCurves.FromHex("E95E4A5F737059DC60DFC7AD95B3D8139515620C"), TeleTrusTNamedCurves.FromHex("7A556B6DAE535B7B51ED2C4D7DAA7A0B5C55F380"), order, one, true));
    }
  ...
  {
    internal static readonly X9ECParametersHolder Instance = (X9ECParametersHolder) new TeleTrusTNamedCurves.BrainpoolP192r1Holder();
    ...
    protected override ECCurve CreateCurve()
    {
      BigInteger order = TeleTrusTNamedCurves.FromHex("C302F41D932A36CDA7A3462F9E9E916B5BE8F1029AC4ACC1");
      BigInteger one = BigInteger.One;
      return TeleTrusTNamedCurves.ConfigureCurve((ECCurve) new FpCurve(TeleTrusTNamedCurves.FromHex("C302F41D932A36CDA7A3463093D18DB78FCE476DE1A86297"), TeleTrusTNamedCurves.FromHex("6A91174076B1E0E19C39C031FE8685C1CAE040E5C69A28EF"), TeleTrusTNamedCurves.FromHex("469A28EF7C28CCA3DC721D044F4496BCCA7EF4146FBF25C9"), order, one, true));
    }
  ...
  {
    internal static readonly X9ECParametersHolder Instance = (X9ECParametersHolder) new TeleTrusTNamedCurves.BrainpoolP192t1Holder();
  ...
  {
    internal static readonly X9ECParametersHolder Instance = (X9ECParametersHolder) new TeleTrusTNamedCurves.BrainpoolP224r1Holder();
    ...
    protected override ECCurve CreateCurve()
    {
      BigInteger order = TeleTrusTNamedCurves.FromHex("D7C134AA264366862A18302575D0FB98D116BC4B6DDEBCA3A5A7939F");
      BigInteger one = BigInteger.One;
      return TeleTrusTNamedCurves.ConfigureCurve((ECCurve) new FpCurve(TeleTrusTNamedCurves.FromHex("D7C134AA264366862A18302575D1D787B09F075797DA89F57EC8C0FF"), TeleTrusTNamedCurves.FromHex("68A5E62CA9CE6C1C299803A6C1530B514E182AD8B0042A59CAD29F43"), TeleTrusTNamedCurves.FromHex("2580F63CCFE44138870713B1A92369E33E2135D266DBB372386C400B"), order, one, true));
    }
  ...
  {
    internal static readonly X9ECParametersHolder Instance = (X9ECParametersHolder) new TeleTrusTNamedCurves.BrainpoolP224t1Holder();
  ...
  {
    internal static readonly X9ECParametersHolder Instance = (X9ECParametersHolder) new TeleTrusTNamedCurves.BrainpoolP256r1Holder();
    ...
    protected override ECCurve CreateCurve()
    {
      BigInteger order = TeleTrusTNamedCurves.FromHex("A9FB57DBA1EEA9BC3E660A909D838D718C397AA3B561A6F7901E0E82974856A7");
      BigInteger one = BigInteger.One;
      return TeleTrusTNamedCurves.ConfigureCurve((ECCurve) new FpCurve(TeleTrusTNamedCurves.FromHex("A9FB57DBA1EEA9BC3E660A909D838D726E3BF623D52620282013481D1F6E5377"), TeleTrusTNamedCurves.FromHex("7D5A0975FC2C3057EEF67530417AFFE7FB8055C126DC5C6CE94A4B44F330B5D9"), TeleTrusTNamedCurves.FromHex("26DC5C6CE94A4B44F330B5D9BBD77CBF958416295CF7E1CE6BCCDC18FF8C07B6"), order, one, true));
    }
  ...
  {
    internal static readonly X9ECParametersHolder Instance = (X9ECParametersHolder) new TeleTrusTNamedCurves.BrainpoolP256t1Holder();
  ...
  {
    internal static readonly X9ECParametersHolder Instance = (X9ECParametersHolder) new TeleTrusTNamedCurves.BrainpoolP320r1Holder();
    ...
    protected override ECCurve CreateCurve()
    {
      BigInteger order = TeleTrusTNamedCurves.FromHex("D35E472036BC4FB7E13C785ED201E065F98FCFA5B68F12A32D482EC7EE8658E98691555B44C59311");
      BigInteger one = BigInteger.One;
  ...
  {
    internal static readonly X9ECParametersHolder Instance = (X9ECParametersHolder) new TeleTrusTNamedCurves.BrainpoolP320t1Holder();
  ...
  {
    internal static readonly X9ECParametersHolder Instance = (X9ECParametersHolder) new TeleTrusTNamedCurves.BrainpoolP384r1Holder();
    ...
    protected override ECCurve CreateCurve()
    {
      BigInteger order = TeleTrusTNamedCurves.FromHex("8CB91E82A3386D280F5D6F7E50E641DF152F7109ED5456B31F166E6CAC0425A7CF3AB6AF6B7FC3103B883202E9046565");
      BigInteger one = BigInteger.One;
  ...
  {
    internal static readonly X9ECParametersHolder Instance = (X9ECParametersHolder) new TeleTrusTNamedCurves.BrainpoolP384t1Holder();
  ...
  {
    internal static readonly X9ECParametersHolder Instance = (X9ECParametersHolder) new TeleTrusTNamedCurves.BrainpoolP512r1Holder();
    ...
    protected override ECCurve CreateCurve()
    {
      BigInteger order = TeleTrusTNamedCurves.FromHex("AADD9DB8DBE9C48B3FD4E6AE33C9FC07CB308DB3B3C9D20ED6639CCA70330870553E5C414CA92619418661197FAC10471DB1D381085DDADDB58796829CA90069");
      BigInteger one = BigInteger.One;
  ...
  {
    internal static readonly X9ECParametersHolder Instance = (X9ECParametersHolder) new TeleTrusTNamedCurves.BrainpoolP512t1Holder();
