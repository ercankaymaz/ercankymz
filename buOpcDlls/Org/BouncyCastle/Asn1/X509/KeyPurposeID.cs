...
public sealed class KeyPurposeID : DerObjectIdentifier
{
  ...
  public static readonly KeyPurposeID IdKPServerAuth = KeyPurposeID.id_kp_serverAuth;
  [Obsolete("Use 'id_kp_clientAuth' instead")]
  public static readonly KeyPurposeID IdKPClientAuth = KeyPurposeID.id_kp_clientAuth;
  [Obsolete("Use 'id_kp_codeSigning' instead")]
  public static readonly KeyPurposeID IdKPCodeSigning = KeyPurposeID.id_kp_codeSigning;
  [Obsolete("Use 'id_kp_emailProtection' instead")]
  public static readonly KeyPurposeID IdKPEmailProtection = KeyPurposeID.id_kp_emailProtection;
  [Obsolete("Use 'id_kp_ipsecEndSystem' instead")]
  public static readonly KeyPurposeID IdKPIpsecEndSystem = KeyPurposeID.id_kp_ipsecEndSystem;
  [Obsolete("Use 'id_kp_ipsecTunnel' instead")]
  public static readonly KeyPurposeID IdKPIpsecTunnel = KeyPurposeID.id_kp_ipsecTunnel;
  [Obsolete("Use 'id_kp_ipsecUser' instead")]
  public static readonly KeyPurposeID IdKPIpsecUser = KeyPurposeID.id_kp_ipsecUser;
  [Obsolete("Use 'id_kp_timeStamping' instead")]
  public static readonly KeyPurposeID IdKPTimeStamping = KeyPurposeID.id_kp_timeStamping;
  [Obsolete("Use 'id_kp_OCSPSigning' instead")]
  public static readonly KeyPurposeID IdKPOcspSigning = KeyPurposeID.id_kp_OCSPSigning;
  [Obsolete("Use 'id_kp_smartcardlogon' instead")]
  public static readonly KeyPurposeID IdKPSmartCardLogon = KeyPurposeID.id_kp_smartcardlogon;
  [Obsolete("Use 'id_kp_macAddress' instead")]
  public static readonly KeyPurposeID IdKPMacAddress = KeyPurposeID.id_kp_macAddress;
