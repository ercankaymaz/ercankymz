...
public class RoleSyntax : Asn1Encodable
{
  ...
  public static RoleSyntax GetInstance(object obj)
  {
    ...
    return obj != null ? new RoleSyntax(Asn1Sequence.GetInstance(obj)) : (RoleSyntax) null;
  }
  ...
  public RoleSyntax(GeneralName roleName)
    : this((GeneralNames) null, roleName)
  {
  }
  ...
  public override Asn1Object ToAsn1Object()
  {
    ...
    elementVector.AddOptionalTagged(false, 0, (Asn1Encodable) this.roleAuthority);
    elementVector.Add((Asn1Encodable) new DerTaggedObject(true, 1, (Asn1Encodable) this.roleName));
