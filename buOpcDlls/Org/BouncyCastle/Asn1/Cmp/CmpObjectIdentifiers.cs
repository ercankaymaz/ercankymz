...
public static class CmpObjectIdentifiers
{
  ...
  public static readonly DerObjectIdentifier id_regCtrl_algId = CmpObjectIdentifiers.id_pkip.Branch("1.11");
  public static readonly DerObjectIdentifier id_regCtrl_rsaKeyLen = CmpObjectIdentifiers.id_pkip.Branch("1.12");
}
