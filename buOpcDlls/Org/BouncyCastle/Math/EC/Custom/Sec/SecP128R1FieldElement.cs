...
internal class SecP128R1FieldElement : AbstractFpFieldElement
{
  ...
  public override int FieldSize => SecP128R1FieldElement.Q.BitLength;
  ...
  {
    uint[] numArray = Nat128.Create();
    SecP128R1Field.Inv(((SecP128R1FieldElement) b).x, numArray);
  ...
  {
    uint[] numArray = Nat128.Create();
    SecP128R1Field.Inv(this.x, numArray);
    return (ECFieldElement) new SecP128R1FieldElement(numArray);
  }
  ...
  public override ECFieldElement Sqrt()
  {
    ...
    return !Nat128.Eq(x, numArray9) ? (ECFieldElement) null : (ECFieldElement) new SecP128R1FieldElement(numArray8);
  }
