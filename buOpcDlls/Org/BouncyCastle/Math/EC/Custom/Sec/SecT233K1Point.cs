...
internal class SecT233K1Point : AbstractF2mPoint
{
  ...
  {
    return (ECPoint) new SecT233K1Point((ECCurve) null, this.AffineXCoord, this.AffineYCoord);
  }
  ...
  public override ECPoint Add(ECPoint b)
  {
    ...
    SecT233FieldElement rawZcoord1 = (SecT233FieldElement) this.RawZCoords[0];
    SecT233FieldElement rawYcoord2 = (SecT233FieldElement) b.RawYCoord;
    SecT233FieldElement rawZcoord2 = (SecT233FieldElement) b.RawZCoords[0];
    ...
    {
      SecT233Field.Multiply(rawXcoord2.x, rawZcoord1.x, numArray1);
      SecT233Field.Multiply(rawYcoord2.x, rawZcoord1.x, numArray2);
    }
    bool isOne2;
    ...
    {
      SecT233Field.Multiply(rawXcoord1.x, rawZcoord2.x, numArray3);
      SecT233Field.Multiply(rawYcoord1.x, rawZcoord2.x, ext64);
    }
    SecT233Field.AddTo(ext64, numArray2);
    SecT233Field.Add(numArray3, numArray1, ext64);
    if (Nat256.IsZero64(ext64))
      return Nat256.IsZero64(numArray2) ? this.Twice() : curve.Infinity;
    if (rawXcoord2.IsZero)
    {
      ECPoint ecPoint = this.Normalize();
      SecT233FieldElement xcoord = (SecT233FieldElement) ecPoint.XCoord;
      ...
      if (ecFieldElement1.IsZero)
        return (ECPoint) new SecT233K1Point(curve, ecFieldElement1, curve.B);
      ...
      return (ECPoint) new SecT233K1Point(curve, ecFieldElement1, y, new ECFieldElement[1]
      {
        ecFieldElement2
      });
    }
    SecT233Field.Square(ext64, ext64);
    SecT233Field.Multiply(numArray3, numArray2, numArray3);
    SecT233Field.Multiply(numArray1, numArray2, numArray1);
    ulong[] numArray4 = numArray3;
    SecT233Field.Multiply(numArray4, numArray1, numArray4);
    if (Nat256.IsZero64(numArray4))
      return (ECPoint) new SecT233K1Point(curve, (ECFieldElement) new SecT233FieldElement(numArray4), curve.B);
    ulong[] numArray5 = numArray2;
    SecT233Field.Multiply(numArray5, ext64, numArray5);
    if (!isOne2)
      SecT233Field.Multiply(numArray5, rawZcoord2.x, numArray5);
    ulong[] numArray6 = numArray1;
    SecT233Field.AddTo(ext64, numArray6);
    SecT233Field.SquareExt(numArray6, ext64);
    SecT233Field.Add(rawYcoord1.x, rawZcoord1.x, numArray6);
    SecT233Field.MultiplyAddToExt(numArray5, numArray6, ext64);
    SecT233Field.Reduce(ext64, numArray6);
    if (!isOne1)
      SecT233Field.Multiply(numArray5, rawZcoord1.x, numArray5);
    return (ECPoint) new SecT233K1Point(curve, (ECFieldElement) new SecT233FieldElement(numArray4), (ECFieldElement) new SecT233FieldElement(numArray6), new ECFieldElement[1]
    {
      (ECFieldElement) new SecT233FieldElement(numArray5)
    });
  }
  ...
  public override ECPoint Twice()
  {
    ...
    return (ECPoint) new SecT233K1Point(curve, ecFieldElement2, y, new ECFieldElement[1]
    {
      b2
    });
  }
  ...
  public override ECPoint TwicePlus(ECPoint b)
  {
    ...
    if (x3.IsZero)
      return (ECPoint) new SecT233K1Point(curve, x3, curve.B);
    ...
    return (ECPoint) new SecT233K1Point(curve, x4, y2, new ECFieldElement[1]
    {
      y1
    });
  }
  ...
  public override ECPoint Negate()
  {
    ...
    ECFieldElement rawYcoord = this.RawYCoord;
    ECFieldElement rawZcoord = this.RawZCoords[0];
    return (ECPoint) new SecT233K1Point(this.Curve, rawXcoord, rawYcoord.Add(rawZcoord), new ECFieldElement[1]
    {
      rawZcoord
    });
  }
