...
internal class SecP160R1FieldElement : AbstractFpFieldElement
{
  ...
  public override int FieldSize => SecP160R1FieldElement.Q.BitLength;
  ...
  {
    uint[] numArray = Nat160.Create();
    SecP160R1Field.Inv(((SecP160R1FieldElement) b).x, numArray);
  ...
  {
    uint[] numArray = Nat160.Create();
    SecP160R1Field.Inv(this.x, numArray);
    return (ECFieldElement) new SecP160R1FieldElement(numArray);
  }
  ...
  public override ECFieldElement Sqrt()
  {
    ...
    return !Nat160.Eq(x, numArray10) ? (ECFieldElement) null : (ECFieldElement) new SecP160R1FieldElement(numArray9);
  }
