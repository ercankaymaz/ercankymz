...
internal class SecT409R1Curve : AbstractF2mCurve
{
  ...
  public SecT409R1Curve()
    : base(409, 87, 0, 0)
  {
    this.m_infinity = new SecT409R1Point((ECCurve) this, (ECFieldElement) null, (ECFieldElement) null);
  ...
  protected override ECCurve CloneCurve() => (ECCurve) new SecT409R1Curve();
  ...
  {
    return (ECPoint) new SecT409R1Point((ECCurve) this, x, y);
  }
  ...
  protected internal override ECPoint CreateRawPoint(
    ...
    ECFieldElement[] zs)
  {
    return (ECPoint) new SecT409R1Point((ECCurve) this, x, y, zs);
  }
  ...
  public override ECLookupTable CreateCacheSafeLookupTable(ECPoint[] points, int off, int len)
  {
    ...
    return (ECLookupTable) new SecT409R1Curve.SecT409R1LookupTable(this, numArray, len);
  }
  ...
  private class SecT409R1LookupTable : AbstractECLookupTable
  {
    ...
    {
      return this.m_outer.CreateRawPoint((ECFieldElement) new SecT409FieldElement(x), (ECFieldElement) new SecT409FieldElement(y), SecT409R1Curve.SECT409R1_AFFINE_ZS);
    }
  }
}
