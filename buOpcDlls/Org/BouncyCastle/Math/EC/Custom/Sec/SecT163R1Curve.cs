...
internal class SecT163R1Curve : AbstractF2mCurve
{
  ...
  public SecT163R1Curve()
    : base(163, 3, 6, 7)
  {
    this.m_infinity = new SecT163R1Point((ECCurve) this, (ECFieldElement) null, (ECFieldElement) null);
  ...
  protected override ECCurve CloneCurve() => (ECCurve) new SecT163R1Curve();
  ...
  {
    return (ECPoint) new SecT163R1Point((ECCurve) this, x, y);
  }
  ...
  protected internal override ECPoint CreateRawPoint(
    ...
    ECFieldElement[] zs)
  {
    return (ECPoint) new SecT163R1Point((ECCurve) this, x, y, zs);
  }
  ...
  public override ECLookupTable CreateCacheSafeLookupTable(ECPoint[] points, int off, int len)
  {
    ...
    return (ECLookupTable) new SecT163R1Curve.SecT163R1LookupTable(this, numArray, len);
  }
  ...
  private class SecT163R1LookupTable : AbstractECLookupTable
  {
    ...
    {
      return this.m_outer.CreateRawPoint((ECFieldElement) new SecT163FieldElement(x), (ECFieldElement) new SecT163FieldElement(y), SecT163R1Curve.SECT163R1_AFFINE_ZS);
    }
  }
}
