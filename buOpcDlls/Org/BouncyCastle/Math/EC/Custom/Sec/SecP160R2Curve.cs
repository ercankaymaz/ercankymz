...
internal class SecP160R2Curve : AbstractFpCurve
{
  ...
  public SecP160R2Curve()
    : base(SecP160R2Curve.q, true)
  {
    this.m_infinity = new SecP160R2Point((ECCurve) this, (ECFieldElement) null, (ECFieldElement) null);
  ...
  protected override ECCurve CloneCurve() => (ECCurve) new SecP160R2Curve();

  public override bool SupportsCoordinateSystem(int coord) => coord == 2;

  public virtual BigInteger Q => SecP160R2Curve.q;

  public override ECPoint Infinity => (ECPoint) this.m_infinity;

  public override int FieldSize => SecP160R2Curve.q.BitLength;
  ...
  {
    return (ECPoint) new SecP160R2Point((ECCurve) this, x, y);
  }
  ...
  protected internal override ECPoint CreateRawPoint(
    ...
    ECFieldElement[] zs)
  {
    return (ECPoint) new SecP160R2Point((ECCurve) this, x, y, zs);
  }
  ...
  public override ECLookupTable CreateCacheSafeLookupTable(ECPoint[] points, int off, int len)
  {
    ...
    return (ECLookupTable) new SecP160R2Curve.SecP160R2LookupTable(this, numArray, len);
  }
  ...
  private class SecP160R2LookupTable : AbstractECLookupTable
  {
    ...
    {
      return this.m_outer.CreateRawPoint((ECFieldElement) new SecP160R2FieldElement(x), (ECFieldElement) new SecP160R2FieldElement(y), SecP160R2Curve.SECP160R2_AFFINE_ZS);
    }
  }
}
