...
internal class SecT233K1Curve : AbstractF2mCurve
{
  ...
  public SecT233K1Curve()
    : base(233, 74, 0, 0)
  {
    this.m_infinity = new SecT233K1Point((ECCurve) this, (ECFieldElement) null, (ECFieldElement) null);
  ...
  protected override ECCurve CloneCurve() => (ECCurve) new SecT233K1Curve();
  ...
  {
    return (ECPoint) new SecT233K1Point((ECCurve) this, x, y);
  }
  ...
  protected internal override ECPoint CreateRawPoint(
    ...
    ECFieldElement[] zs)
  {
    return (ECPoint) new SecT233K1Point((ECCurve) this, x, y, zs);
  }
  ...
  public override ECLookupTable CreateCacheSafeLookupTable(ECPoint[] points, int off, int len)
  {
    ...
    return (ECLookupTable) new SecT233K1Curve.SecT233K1LookupTable(this, numArray, len);
  }
  ...
  private class SecT233K1LookupTable : AbstractECLookupTable
  {
    ...
    {
      return this.m_outer.CreateRawPoint((ECFieldElement) new SecT233FieldElement(x), (ECFieldElement) new SecT233FieldElement(y), SecT233K1Curve.SECT233K1_AFFINE_ZS);
    }
  }
}
