...
internal class SecT283K1Point : AbstractF2mPoint
{
  ...
  {
    return (ECPoint) new SecT283K1Point((ECCurve) null, this.AffineXCoord, this.AffineYCoord);
  }
  ...
  public override ECPoint Add(ECPoint b)
  {
    ...
    SecT283FieldElement rawXcoord1 = (SecT283FieldElement) this.RawXCoord;
    SecT283FieldElement rawXcoord2 = (SecT283FieldElement) b.RawXCoord;
    if (rawXcoord1.IsZero)
      return rawXcoord2.IsZero ? curve.Infinity : b.Add((ECPoint) this);
    SecT283FieldElement rawYcoord1 = (SecT283FieldElement) this.RawYCoord;
    SecT283FieldElement rawZcoord1 = (SecT283FieldElement) this.RawZCoords[0];
    SecT283FieldElement rawYcoord2 = (SecT283FieldElement) b.RawYCoord;
    SecT283FieldElement rawZcoord2 = (SecT283FieldElement) b.RawZCoords[0];
    ulong[] numArray1 = Nat.Create64(9);
    ulong[] numArray2 = Nat320.Create64();
    ulong[] numArray3 = Nat320.Create64();
    ulong[] numArray4 = Nat320.Create64();
    bool isOne1;
    if (isOne1 = rawZcoord1.IsOne)
    {
      Nat320.Copy64(rawXcoord2.x, numArray2);
      Nat320.Copy64(rawYcoord2.x, numArray3);
    }
    else
    {
      SecT283Field.Multiply(rawXcoord2.x, rawZcoord1.x, numArray2);
      SecT283Field.Multiply(rawYcoord2.x, rawZcoord1.x, numArray3);
    }
    bool isOne2;
    if (isOne2 = rawZcoord2.IsOne)
    {
      Nat320.Copy64(rawXcoord1.x, numArray4);
      Nat320.Copy64(rawYcoord1.x, numArray1);
    }
    else
    {
      SecT283Field.Multiply(rawXcoord1.x, rawZcoord2.x, numArray4);
      SecT283Field.Multiply(rawYcoord1.x, rawZcoord2.x, numArray1);
    }
    SecT283Field.AddTo(numArray1, numArray3);
    SecT283Field.Add(numArray4, numArray2, numArray1);
    if (Nat320.IsZero64(numArray1))
      return Nat320.IsZero64(numArray3) ? this.Twice() : curve.Infinity;
    if (rawXcoord2.IsZero)
    {
      ECPoint ecPoint = this.Normalize();
      SecT283FieldElement xcoord = (SecT283FieldElement) ecPoint.XCoord;
      ...
      if (ecFieldElement1.IsZero)
        return (ECPoint) new SecT283K1Point(curve, ecFieldElement1, curve.B);
      ...
      return (ECPoint) new SecT283K1Point(curve, ecFieldElement1, y, new ECFieldElement[1]
      {
        ecFieldElement2
      });
    }
    SecT283Field.Square(numArray1, numArray1);
    SecT283Field.Multiply(numArray4, numArray3, numArray4);
    SecT283Field.Multiply(numArray2, numArray3, numArray2);
    ulong[] numArray5 = numArray4;
    SecT283Field.Multiply(numArray5, numArray2, numArray5);
    if (Nat320.IsZero64(numArray5))
      return (ECPoint) new SecT283K1Point(curve, (ECFieldElement) new SecT283FieldElement(numArray5), curve.B);
    ulong[] numArray6 = numArray3;
    SecT283Field.Multiply(numArray6, numArray1, numArray6);
    if (!isOne2)
      SecT283Field.Multiply(numArray6, rawZcoord2.x, numArray6);
    ulong[] numArray7 = numArray2;
    SecT283Field.AddTo(numArray1, numArray7);
    SecT283Field.SquareExt(numArray7, numArray1);
    SecT283Field.Add(rawYcoord1.x, rawZcoord1.x, numArray7);
    SecT283Field.MultiplyAddToExt(numArray6, numArray7, numArray1);
    SecT283Field.Reduce(numArray1, numArray7);
    if (!isOne1)
      SecT283Field.Multiply(numArray6, rawZcoord1.x, numArray6);
    return (ECPoint) new SecT283K1Point(curve, (ECFieldElement) new SecT283FieldElement(numArray5), (ECFieldElement) new SecT283FieldElement(numArray7), new ECFieldElement[1]
    {
      (ECFieldElement) new SecT283FieldElement(numArray6)
    });
  }
  ...
  public override ECPoint Twice()
  {
    ...
    return (ECPoint) new SecT283K1Point(curve, ecFieldElement2, y, new ECFieldElement[1]
    {
      b2
    });
  }
  ...
  public override ECPoint TwicePlus(ECPoint b)
  {
    ...
    if (x3.IsZero)
      return (ECPoint) new SecT283K1Point(curve, x3, curve.B);
    ...
    return (ECPoint) new SecT283K1Point(curve, x4, y2, new ECFieldElement[1]
    {
      y1
    });
  }
  ...
  public override ECPoint Negate()
  {
    ...
    ECFieldElement rawYcoord = this.RawYCoord;
    ECFieldElement rawZcoord = this.RawZCoords[0];
    return (ECPoint) new SecT283K1Point(this.Curve, rawXcoord, rawYcoord.Add(rawZcoord), new ECFieldElement[1]
    {
      rawZcoord
    });
  }
