...
internal class SecP224K1Point : AbstractFpPoint
{
  ...
  {
    return (ECPoint) new SecP224K1Point((ECCurve) null, this.AffineXCoord, this.AffineYCoord);
  }
  ...
  public override ECPoint Add(ECPoint b)
  {
    ...
    {
      (ECFieldElement) p224K1FieldElement
    };
    return (ECPoint) new SecP224K1Point(curve, (ECFieldElement) x2, (ECFieldElement) y, zs);
  }
  ...
  public override ECPoint Twice()
  {
    ...
    return (ECPoint) new SecP224K1Point(curve, (ECFieldElement) x, (ECFieldElement) y, new ECFieldElement[1]
    {
      (ECFieldElement) p224K1FieldElement
    });
  }
  ...
  {
    return this.IsInfinity ? (ECPoint) this : (ECPoint) new SecP224K1Point(this.Curve, this.RawXCoord, this.RawYCoord.Negate(), this.RawZCoords);
  }
}
