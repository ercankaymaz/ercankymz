...
internal class SecP160R1Curve : AbstractFpCurve
{
  ...
  {
    (ECFieldElement) new SecP160R1FieldElement(BigInteger.One)
  };
  protected readonly SecP160R1Point m_infinity;

  public SecP160R1Curve()
    : base(SecP160R1Curve.q, true)
  {
    this.m_infinity = new SecP160R1Point((ECCurve) this, (ECFieldElement) null, (ECFieldElement) null);
  ...
  protected override ECCurve CloneCurve() => (ECCurve) new SecP160R1Curve();

  public override bool SupportsCoordinateSystem(int coord) => coord == 2;

  public virtual BigInteger Q => SecP160R1Curve.q;

  public override ECPoint Infinity => (ECPoint) this.m_infinity;

  public override int FieldSize => SecP160R1Curve.q.BitLength;

  public override ECFieldElement FromBigInteger(BigInteger x)
  {
    return (ECFieldElement) new SecP160R1FieldElement(x);
  }

  protected internal override ECPoint CreateRawPoint(ECFieldElement x, ECFieldElement y)
  {
    return (ECPoint) new SecP160R1Point((ECCurve) this, x, y);
  }
  ...
  protected internal override ECPoint CreateRawPoint(
    ...
    ECFieldElement[] zs)
  {
    return (ECPoint) new SecP160R1Point((ECCurve) this, x, y, zs);
  }
  ...
  public override ECLookupTable CreateCacheSafeLookupTable(ECPoint[] points, int off, int len)
  {
    ...
    for (int index = 0; index < len; ++index)
    {
      ...
      Nat160.Copy(((SecP160R1FieldElement) point.RawXCoord).x, 0, numArray, zOff1);
      int zOff2 = zOff1 + 5;
      Nat160.Copy(((SecP160R1FieldElement) point.RawYCoord).x, 0, numArray, zOff2);
      zOff1 = zOff2 + 5;
    }
    return (ECLookupTable) new SecP160R1Curve.SecP160R1LookupTable(this, numArray, len);
  }

  public override ECFieldElement RandomFieldElement(SecureRandom r)
  {
    uint[] numArray = Nat160.Create();
    SecP160R1Field.Random(r, numArray);
    return (ECFieldElement) new SecP160R1FieldElement(numArray);
  }

  public override ECFieldElement RandomFieldElementMult(SecureRandom r)
  {
    uint[] numArray = Nat160.Create();
    SecP160R1Field.RandomMult(r, numArray);
    return (ECFieldElement) new SecP160R1FieldElement(numArray);
  }
  ...
  private class SecP160R1LookupTable : AbstractECLookupTable
  {
    ...
    {
      return this.m_outer.CreateRawPoint((ECFieldElement) new SecP160R1FieldElement(x), (ECFieldElement) new SecP160R1FieldElement(y), SecP160R1Curve.SECP160R1_AFFINE_ZS);
    }
  }
}
