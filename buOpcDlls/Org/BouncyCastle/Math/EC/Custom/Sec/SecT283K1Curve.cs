...
internal class SecT283K1Curve : AbstractF2mCurve
{
  ...
  public SecT283K1Curve()
    : base(283, 5, 7, 12)
  {
    this.m_infinity = new SecT283K1Point((ECCurve) this, (ECFieldElement) null, (ECFieldElement) null);
  ...
  protected override ECCurve CloneCurve() => (ECCurve) new SecT283K1Curve();
  ...
  {
    return (ECPoint) new SecT283K1Point((ECCurve) this, x, y);
  }
  ...
  protected internal override ECPoint CreateRawPoint(
    ...
    ECFieldElement[] zs)
  {
    return (ECPoint) new SecT283K1Point((ECCurve) this, x, y, zs);
  }
  ...
  public override ECLookupTable CreateCacheSafeLookupTable(ECPoint[] points, int off, int len)
  {
    ...
    return (ECLookupTable) new SecT283K1Curve.SecT283K1LookupTable(this, numArray, len);
  }
  ...
  private class SecT283K1LookupTable : AbstractECLookupTable
  {
    ...
    {
      return this.m_outer.CreateRawPoint((ECFieldElement) new SecT283FieldElement(x), (ECFieldElement) new SecT283FieldElement(y), SecT283K1Curve.SECT283K1_AFFINE_ZS);
    }
  }
}
