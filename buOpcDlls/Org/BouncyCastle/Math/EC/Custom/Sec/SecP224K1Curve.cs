...
internal class SecP224K1Curve : AbstractFpCurve
{
  ...
  {
    (ECFieldElement) new SecP224K1FieldElement(BigInteger.One)
  };
  protected readonly SecP224K1Point m_infinity;

  public SecP224K1Curve()
    : base(SecP224K1Curve.q, true)
  {
    this.m_infinity = new SecP224K1Point((ECCurve) this, (ECFieldElement) null, (ECFieldElement) null);
  ...
  protected override ECCurve CloneCurve() => (ECCurve) new SecP224K1Curve();

  public override bool SupportsCoordinateSystem(int coord) => coord == 2;

  public virtual BigInteger Q => SecP224K1Curve.q;

  public override ECPoint Infinity => (ECPoint) this.m_infinity;

  public override int FieldSize => SecP224K1Curve.q.BitLength;

  public override ECFieldElement FromBigInteger(BigInteger x)
  {
    return (ECFieldElement) new SecP224K1FieldElement(x);
  }

  protected internal override ECPoint CreateRawPoint(ECFieldElement x, ECFieldElement y)
  {
    return (ECPoint) new SecP224K1Point((ECCurve) this, x, y);
  }
  ...
  protected internal override ECPoint CreateRawPoint(
    ...
    ECFieldElement[] zs)
  {
    return (ECPoint) new SecP224K1Point((ECCurve) this, x, y, zs);
  }
  ...
  public override ECLookupTable CreateCacheSafeLookupTable(ECPoint[] points, int off, int len)
  {
    ...
    for (int index = 0; index < len; ++index)
    {
      ...
      Nat224.Copy(((SecP224K1FieldElement) point.RawXCoord).x, 0, numArray, zOff1);
      int zOff2 = zOff1 + 7;
      Nat224.Copy(((SecP224K1FieldElement) point.RawYCoord).x, 0, numArray, zOff2);
      zOff1 = zOff2 + 7;
    }
    return (ECLookupTable) new SecP224K1Curve.SecP224K1LookupTable(this, numArray, len);
  }

  public override ECFieldElement RandomFieldElement(SecureRandom r)
  {
    uint[] numArray = Nat224.Create();
    SecP224K1Field.Random(r, numArray);
  ...
  {
    uint[] numArray = Nat224.Create();
    SecP224K1Field.RandomMult(r, numArray);
    return (ECFieldElement) new SecP224K1FieldElement(numArray);
  }
  ...
  private class SecP224K1LookupTable : AbstractECLookupTable
  {
    ...
    {
      return this.m_outer.CreateRawPoint((ECFieldElement) new SecP224K1FieldElement(x), (ECFieldElement) new SecP224K1FieldElement(y), SecP224K1Curve.SECP224K1_AFFINE_ZS);
    }
  }
}
