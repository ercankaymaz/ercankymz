...
internal class SecP192R1Curve : AbstractFpCurve
{
  ...
  {
    (ECFieldElement) new SecP192R1FieldElement(BigInteger.One)
  };
  protected readonly SecP192R1Point m_infinity;

  public SecP192R1Curve()
    : base(SecP192R1Curve.q, true)
  {
    this.m_infinity = new SecP192R1Point((ECCurve) this, (ECFieldElement) null, (ECFieldElement) null);
  ...
  protected override ECCurve CloneCurve() => (ECCurve) new SecP192R1Curve();

  public override bool SupportsCoordinateSystem(int coord) => coord == 2;

  public virtual BigInteger Q => SecP192R1Curve.q;

  public override ECPoint Infinity => (ECPoint) this.m_infinity;

  public override int FieldSize => SecP192R1Curve.q.BitLength;

  public override ECFieldElement FromBigInteger(BigInteger x)
  {
    return (ECFieldElement) new SecP192R1FieldElement(x);
  }

  protected internal override ECPoint CreateRawPoint(ECFieldElement x, ECFieldElement y)
  {
    return (ECPoint) new SecP192R1Point((ECCurve) this, x, y);
  }
  ...
  protected internal override ECPoint CreateRawPoint(
    ...
    ECFieldElement[] zs)
  {
    return (ECPoint) new SecP192R1Point((ECCurve) this, x, y, zs);
  }
  ...
  public override ECLookupTable CreateCacheSafeLookupTable(ECPoint[] points, int off, int len)
  {
    ...
    for (int index = 0; index < len; ++index)
    {
      ...
      Nat192.Copy(((SecP192R1FieldElement) point.RawXCoord).x, 0, numArray, zOff1);
      int zOff2 = zOff1 + 6;
      Nat192.Copy(((SecP192R1FieldElement) point.RawYCoord).x, 0, numArray, zOff2);
      zOff1 = zOff2 + 6;
    }
    return (ECLookupTable) new SecP192R1Curve.SecP192R1LookupTable(this, numArray, len);
  }

  public override ECFieldElement RandomFieldElement(SecureRandom r)
  {
    uint[] numArray = Nat192.Create();
    SecP192R1Field.Random(r, numArray);
  ...
  {
    uint[] numArray = Nat192.Create();
    SecP192R1Field.RandomMult(r, numArray);
    return (ECFieldElement) new SecP192R1FieldElement(numArray);
  }
  ...
  private class SecP192R1LookupTable : AbstractECLookupTable
  {
    ...
    {
      return this.m_outer.CreateRawPoint((ECFieldElement) new SecP192R1FieldElement(x), (ECFieldElement) new SecP192R1FieldElement(y), SecP192R1Curve.SECP192R1_AFFINE_ZS);
    }
  }
}
