...
internal class SecT233R1Curve : AbstractF2mCurve
{
  ...
  {
    (ECFieldElement) new SecT233FieldElement(BigInteger.One)
  };
  ...
  public SecT233R1Curve()
    : base(233, 74, 0, 0)
  {
    this.m_infinity = new SecT233R1Point((ECCurve) this, (ECFieldElement) null, (ECFieldElement) null);
  ...
  protected override ECCurve CloneCurve() => (ECCurve) new SecT233R1Curve();
  ...
  {
    return (ECFieldElement) new SecT233FieldElement(x);
  }

  protected internal override ECPoint CreateRawPoint(ECFieldElement x, ECFieldElement y)
  {
    return (ECPoint) new SecT233R1Point((ECCurve) this, x, y);
  }
  ...
  protected internal override ECPoint CreateRawPoint(
    ...
    ECFieldElement[] zs)
  {
    return (ECPoint) new SecT233R1Point((ECCurve) this, x, y, zs);
  }
  ...
  public override ECLookupTable CreateCacheSafeLookupTable(ECPoint[] points, int off, int len)
  {
    ...
    for (int index = 0; index < len; ++index)
    {
      ...
      Nat256.Copy64(((SecT233FieldElement) point.RawXCoord).x, 0, numArray, zOff1);
      int zOff2 = zOff1 + 4;
      Nat256.Copy64(((SecT233FieldElement) point.RawYCoord).x, 0, numArray, zOff2);
      zOff1 = zOff2 + 4;
    }
    return (ECLookupTable) new SecT233R1Curve.SecT233R1LookupTable(this, numArray, len);
  }
  ...
  private class SecT233R1LookupTable : AbstractECLookupTable
  {
    ...
    {
      return this.m_outer.CreateRawPoint((ECFieldElement) new SecT233FieldElement(x), (ECFieldElement) new SecT233FieldElement(y), SecT233R1Curve.SECT233R1_AFFINE_ZS);
    }
  }
}
