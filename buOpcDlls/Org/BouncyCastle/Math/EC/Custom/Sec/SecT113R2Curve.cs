...
internal class SecT113R2Curve : AbstractF2mCurve
{
  ...
  public SecT113R2Curve()
    : base(113, 9, 0, 0)
  {
    this.m_infinity = new SecT113R2Point((ECCurve) this, (ECFieldElement) null, (ECFieldElement) null);
  ...
  protected override ECCurve CloneCurve() => (ECCurve) new SecT113R2Curve();
  ...
  {
    return (ECPoint) new SecT113R2Point((ECCurve) this, x, y);
  }
  ...
  protected internal override ECPoint CreateRawPoint(
    ...
    ECFieldElement[] zs)
  {
    return (ECPoint) new SecT113R2Point((ECCurve) this, x, y, zs);
  }
  ...
  public override ECLookupTable CreateCacheSafeLookupTable(ECPoint[] points, int off, int len)
  {
    ...
    return (ECLookupTable) new SecT113R2Curve.SecT113R2LookupTable(this, numArray, len);
  }
  ...
  private class SecT113R2LookupTable : AbstractECLookupTable
  {
    ...
    {
      return this.m_outer.CreateRawPoint((ECFieldElement) new SecT113FieldElement(x), (ECFieldElement) new SecT113FieldElement(y), SecT113R2Curve.SECT113R2_AFFINE_ZS);
    }
  }
}
