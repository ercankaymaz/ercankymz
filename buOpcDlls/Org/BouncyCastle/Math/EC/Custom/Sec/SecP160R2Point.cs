...
internal class SecP160R2Point : AbstractFpPoint
{
  ...
  {
    return (ECPoint) new SecP160R2Point((ECCurve) null, this.AffineXCoord, this.AffineYCoord);
  }
  ...
  public override ECPoint Add(ECPoint b)
  {
    ...
    return (ECPoint) new SecP160R2Point(curve, (ECFieldElement) x2, (ECFieldElement) y, zs);
  }
  ...
  public override ECPoint Twice()
  {
    ...
    return (ECPoint) new SecP160R2Point(curve, (ECFieldElement) x, (ECFieldElement) y, new ECFieldElement[1]
    {
      (ECFieldElement) p160R2FieldElement
    });
  }
  ...
  {
    return this.IsInfinity ? (ECPoint) this : (ECPoint) new SecP160R2Point(this.Curve, this.RawXCoord, this.RawYCoord.Negate(), this.RawZCoords);
  }
}
