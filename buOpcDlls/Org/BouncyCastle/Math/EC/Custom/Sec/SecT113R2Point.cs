...
internal class SecT113R2Point : AbstractF2mPoint
{
  ...
  {
    return (ECPoint) new SecT113R2Point((ECCurve) null, this.AffineXCoord, this.AffineYCoord);
  }
  ...
  public override ECPoint Add(ECPoint b)
  {
    ...
    if (rawXcoord2.IsZero)
    {
      ...
      if (ecFieldElement4.IsZero)
        return (ECPoint) new SecT113R2Point(curve, ecFieldElement4, curve.B.Sqrt());
    ...
    return (ECPoint) new SecT113R2Point(curve, ecFieldElement4, y, new ECFieldElement[1]
    {
      ecFieldElement5
    });
  }
  ...
  public override ECPoint Twice()
  {
    ...
    if (x.IsZero)
      return (ECPoint) new SecT113R2Point(curve, x, curve.B.Sqrt());
    ...
    return (ECPoint) new SecT113R2Point(curve, ecFieldElement2, y, new ECFieldElement[1]
    {
      b3
    });
  }
  ...
  public override ECPoint TwicePlus(ECPoint b)
  {
    ...
    if (x2.IsZero)
      return (ECPoint) new SecT113R2Point(curve, x2, curve.B.Sqrt());
    ...
    return (ECPoint) new SecT113R2Point(curve, x3, y2, new ECFieldElement[1]
    {
      y1
    });
  }
  ...
  public override ECPoint Negate()
  {
    ...
    ECFieldElement rawYcoord = this.RawYCoord;
    ECFieldElement rawZcoord = this.RawZCoords[0];
    return (ECPoint) new SecT113R2Point(this.Curve, rawXcoord, rawYcoord.Add(rawZcoord), new ECFieldElement[1]
    {
      rawZcoord
    });
  }
