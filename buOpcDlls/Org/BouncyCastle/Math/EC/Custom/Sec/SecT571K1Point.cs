...
internal class SecT571K1Point : AbstractF2mPoint
{
  ...
  {
    return (ECPoint) new SecT571K1Point((ECCurve) null, this.AffineXCoord, this.AffineYCoord);
  }
  ...
  public override ECPoint Add(ECPoint b)
  {
    ...
    if (rawXcoord2.IsZero)
    {
      ...
      t571FieldElement1 = (SecT571FieldElement) b2.Square().Add(b2).Add((ECFieldElement) xcoord);
      if (t571FieldElement1.IsZero)
        return (ECPoint) new SecT571K1Point(curve, (ECFieldElement) t571FieldElement1, curve.B);
    ...
    return (ECPoint) new SecT571K1Point(curve, (ECFieldElement) t571FieldElement1, (ECFieldElement) y2, new ECFieldElement[1]
    {
  ...
  public override ECPoint Twice()
  {
    ...
    if (ecFieldElement1.IsZero)
      return (ECPoint) new SecT571K1Point(curve, ecFieldElement1, curve.B);
    ...
    return (ECPoint) new SecT571K1Point(curve, ecFieldElement2, y, new ECFieldElement[1]
    {
      b2
    });
  }
  ...
  public override ECPoint TwicePlus(ECPoint b)
  {
    ...
    if (x3.IsZero)
      return (ECPoint) new SecT571K1Point(curve, x3, curve.B);
    ...
    return (ECPoint) new SecT571K1Point(curve, x4, y2, new ECFieldElement[1]
    {
      y1
    });
  }
  ...
  public override ECPoint Negate()
  {
    ...
    ECFieldElement rawYcoord = this.RawYCoord;
    ECFieldElement rawZcoord = this.RawZCoords[0];
    return (ECPoint) new SecT571K1Point(this.Curve, rawXcoord, rawYcoord.Add(rawZcoord), new ECFieldElement[1]
    {
      rawZcoord
    });
  }
