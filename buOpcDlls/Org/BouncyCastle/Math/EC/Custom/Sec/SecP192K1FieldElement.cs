...
internal class SecP192K1FieldElement : AbstractFpFieldElement
{
  ...
  public override int FieldSize => SecP192K1FieldElement.Q.BitLength;
  ...
  {
    uint[] numArray = Nat192.Create();
    SecP192K1Field.Inv(((SecP192K1FieldElement) b).x, numArray);
  ...
  {
    uint[] numArray = Nat192.Create();
    SecP192K1Field.Inv(this.x, numArray);
    return (ECFieldElement) new SecP192K1FieldElement(numArray);
  }
  ...
  public override ECFieldElement Sqrt()
  {
    ...
    SecP192K1Field.SquareN(numArray6, 16 /*0x10*/, numArray7);
    ...
    return !Nat192.Eq(x, numArray12) ? (ECFieldElement) null : (ECFieldElement) new SecP192K1FieldElement(numArray11);
  }
