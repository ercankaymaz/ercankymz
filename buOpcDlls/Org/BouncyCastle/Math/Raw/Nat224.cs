...
internal static class Nat224
{
  ...
  {
    int num = Nat224.Gte(x, xOff, y, yOff) ? 1 : 0;
    if (num != 0)
    {
  ...
  public static void Mul(uint[] x, uint[] y, uint[] zz)
  {
    ...
    ulong num9 = (ulong) (0L + (long) num8 * (long) num1);
    zz[0] = (uint) num9;
    ulong num10 = (num9 >> 32 /*0x20*/) + num8 * num2;
    zz[1] = (uint) num10;
    ulong num11 = (num10 >> 32 /*0x20*/) + num8 * num3;
    zz[2] = (uint) num11;
    ulong num12 = (num11 >> 32 /*0x20*/) + num8 * num4;
    zz[3] = (uint) num12;
    ulong num13 = (num12 >> 32 /*0x20*/) + num8 * num5;
    zz[4] = (uint) num13;
    ulong num14 = (num13 >> 32 /*0x20*/) + num8 * num6;
    zz[5] = (uint) num14;
    ulong num15 = (num14 >> 32 /*0x20*/) + num8 * num7;
    zz[6] = (uint) num15;
    ulong num16 = num15 >> 32 /*0x20*/;
    zz[7] = (uint) num16;
    for (int index = 1; index < 7; ++index)
    {
      ulong num17 = (ulong) x[index];
      ulong num18 = (ulong) (0L + ((long) num17 * (long) num1 + (long) zz[index]));
      zz[index] = (uint) num18;
      ulong num19 = (num18 >> 32 /*0x20*/) + (num17 * num2 + (ulong) zz[index + 1]);
      zz[index + 1] = (uint) num19;
      ulong num20 = (num19 >> 32 /*0x20*/) + (num17 * num3 + (ulong) zz[index + 2]);
      zz[index + 2] = (uint) num20;
      ulong num21 = (num20 >> 32 /*0x20*/) + (num17 * num4 + (ulong) zz[index + 3]);
      zz[index + 3] = (uint) num21;
      ulong num22 = (num21 >> 32 /*0x20*/) + (num17 * num5 + (ulong) zz[index + 4]);
      zz[index + 4] = (uint) num22;
      ulong num23 = (num22 >> 32 /*0x20*/) + (num17 * num6 + (ulong) zz[index + 5]);
      zz[index + 5] = (uint) num23;
      ulong num24 = (num23 >> 32 /*0x20*/) + (num17 * num7 + (ulong) zz[index + 6]);
      zz[index + 6] = (uint) num24;
      ulong num25 = num24 >> 32 /*0x20*/;
      zz[index + 7] = (uint) num25;
    }
  }
  ...
  public static void Mul(uint[] x, int xOff, uint[] y, int yOff, uint[] zz, int zzOff)
  {
    ...
    ulong num16 = num15 >> 32 /*0x20*/;
    zz[zzOff + 7] = (uint) num16;
    for (int index = 1; index < 7; ++index)
    {
      ++zzOff;
      ulong num17 = (ulong) x[xOff + index];
      ulong num18 = (ulong) (0L + ((long) num17 * (long) num1 + (long) zz[zzOff]));
      zz[zzOff] = (uint) num18;
      ulong num19 = (num18 >> 32 /*0x20*/) + (num17 * num2 + (ulong) zz[zzOff + 1]);
      zz[zzOff + 1] = (uint) num19;
      ulong num20 = (num19 >> 32 /*0x20*/) + (num17 * num3 + (ulong) zz[zzOff + 2]);
      zz[zzOff + 2] = (uint) num20;
      ulong num21 = (num20 >> 32 /*0x20*/) + (num17 * num4 + (ulong) zz[zzOff + 3]);
      zz[zzOff + 3] = (uint) num21;
      ulong num22 = (num21 >> 32 /*0x20*/) + (num17 * num5 + (ulong) zz[zzOff + 4]);
      zz[zzOff + 4] = (uint) num22;
      ulong num23 = (num22 >> 32 /*0x20*/) + (num17 * num6 + (ulong) zz[zzOff + 5]);
      zz[zzOff + 5] = (uint) num23;
      ulong num24 = (num23 >> 32 /*0x20*/) + (num17 * num7 + (ulong) zz[zzOff + 6]);
      zz[zzOff + 6] = (uint) num24;
      ulong num25 = num24 >> 32 /*0x20*/;
      zz[zzOff + 7] = (uint) num25;
    }
  }
  ...
  public static uint MulAddTo(uint[] x, uint[] y, uint[] zz)
  {
    ...
    for (int index = 0; index < 7; ++index)
    {
      ulong num9 = (ulong) x[index];
      ulong num10 = (ulong) (0L + ((long) num9 * (long) num1 + (long) zz[index]));
      zz[index] = (uint) num10;
      ulong num11 = (num10 >> 32 /*0x20*/) + (num9 * num2 + (ulong) zz[index + 1]);
      zz[index + 1] = (uint) num11;
      ulong num12 = (num11 >> 32 /*0x20*/) + (num9 * num3 + (ulong) zz[index + 2]);
      zz[index + 2] = (uint) num12;
      ulong num13 = (num12 >> 32 /*0x20*/) + (num9 * num4 + (ulong) zz[index + 3]);
      zz[index + 3] = (uint) num13;
      ulong num14 = (num13 >> 32 /*0x20*/) + (num9 * num5 + (ulong) zz[index + 4]);
      zz[index + 4] = (uint) num14;
      ulong num15 = (num14 >> 32 /*0x20*/) + (num9 * num6 + (ulong) zz[index + 5]);
      zz[index + 5] = (uint) num15;
      ulong num16 = (num15 >> 32 /*0x20*/) + (num9 * num7 + (ulong) zz[index + 6]);
      zz[index + 6] = (uint) num16;
      ulong num17 = num16 >> 32 /*0x20*/;
      ulong num18 = num8 + (num17 + (ulong) zz[index + 7]);
  ...
  public static uint MulAddTo(uint[] x, int xOff, uint[] y, int yOff, uint[] zz, int zzOff)
  {
    ...
    for (int index = 0; index < 7; ++index)
    {
      ulong num9 = (ulong) x[xOff + index];
      ulong num10 = (ulong) (0L + ((long) num9 * (long) num1 + (long) zz[zzOff]));
      zz[zzOff] = (uint) num10;
      ulong num11 = (num10 >> 32 /*0x20*/) + (num9 * num2 + (ulong) zz[zzOff + 1]);
      zz[zzOff + 1] = (uint) num11;
      ulong num12 = (num11 >> 32 /*0x20*/) + (num9 * num3 + (ulong) zz[zzOff + 2]);
      zz[zzOff + 2] = (uint) num12;
      ulong num13 = (num12 >> 32 /*0x20*/) + (num9 * num4 + (ulong) zz[zzOff + 3]);
      zz[zzOff + 3] = (uint) num13;
      ulong num14 = (num13 >> 32 /*0x20*/) + (num9 * num5 + (ulong) zz[zzOff + 4]);
      zz[zzOff + 4] = (uint) num14;
      ulong num15 = (num14 >> 32 /*0x20*/) + (num9 * num6 + (ulong) zz[zzOff + 5]);
      zz[zzOff + 5] = (uint) num15;
      ulong num16 = (num15 >> 32 /*0x20*/) + (num9 * num7 + (ulong) zz[zzOff + 6]);
      zz[zzOff + 6] = (uint) num16;
      ulong num17 = num16 >> 32 /*0x20*/;
      ulong num18 = num8 + (num17 + (ulong) zz[zzOff + 7]);
  ...
  public static uint Mul33DWordAdd(uint x, ulong y, uint[] z, int zOff)
  {
    ...
    z[zOff + 3] = (uint) num8;
    return num8 >> 32 /*0x20*/ != 0UL ? Nat.IncAt(7, z, zOff, 4) : 0U;
  }
  ...
  public static uint Mul33WordAdd(uint x, uint y, uint[] z, int zOff)
  {
    ...
    z[zOff + 2] = (uint) num4;
    return num4 >> 32 /*0x20*/ != 0UL ? Nat.IncAt(7, z, zOff, 3) : 0U;
  }
  ...
  public static void Square(uint[] x, uint[] zz)
  {
    ...
    ulong num81 = num70 + ((num80 >> 32 /*0x20*/) + num71 * num26);
    ulong num82 = num73 + ((num81 >> 32 /*0x20*/) + num71 * num39);
    ulong num83 = num75 + ((num82 >> 32 /*0x20*/) + num71 * num54);
    ulong num84 = num74 + (num83 >> 32 /*0x20*/);
    uint num85 = (uint) num79;
    zz[7] = num85 << 1 | num78;
    uint num86 = num85 >> 31 /*0x1F*/;
    uint num87 = (uint) num80;
    zz[8] = num87 << 1 | num86;
    uint num88 = num87 >> 31 /*0x1F*/;
    uint num89 = (uint) num81;
    zz[9] = num89 << 1 | num88;
    uint num90 = num89 >> 31 /*0x1F*/;
    uint num91 = (uint) num82;
    zz[10] = num91 << 1 | num90;
    uint num92 = num91 >> 31 /*0x1F*/;
    uint num93 = (uint) num83;
    zz[11] = num93 << 1 | num92;
    uint num94 = num93 >> 31 /*0x1F*/;
    uint num95 = (uint) num84;
    zz[12] = num95 << 1 | num94;
    uint num96 = num95 >> 31 /*0x1F*/;
    uint num97 = zz[13] + (uint) (num84 >> 32 /*0x20*/);
    zz[13] = num97 << 1 | num96;
  }
  ...
  public static void Square(uint[] x, int xOff, uint[] zz, int zzOff)
  {
    ...
    ulong num84 = num74 + (num83 >> 32 /*0x20*/);
    uint num85 = (uint) num79;
    zz[zzOff + 7] = num85 << 1 | num78;
    uint num86 = num85 >> 31 /*0x1F*/;
    uint num87 = (uint) num80;
    zz[zzOff + 8] = num87 << 1 | num86;
    uint num88 = num87 >> 31 /*0x1F*/;
    uint num89 = (uint) num81;
    zz[zzOff + 9] = num89 << 1 | num88;
    uint num90 = num89 >> 31 /*0x1F*/;
    uint num91 = (uint) num82;
    zz[zzOff + 10] = num91 << 1 | num90;
    uint num92 = num91 >> 31 /*0x1F*/;
    uint num93 = (uint) num83;
    zz[zzOff + 11] = num93 << 1 | num92;
    uint num94 = num93 >> 31 /*0x1F*/;
    uint num95 = (uint) num84;
    zz[zzOff + 12] = num95 << 1 | num94;
    uint num96 = num95 >> 31 /*0x1F*/;
    uint num97 = zz[zzOff + 13] + (uint) (num84 >> 32 /*0x20*/);
    zz[zzOff + 13] = num97 << 1 | num96;
  }
