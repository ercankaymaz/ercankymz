...
internal static class Nat160
{
  ...
  public static uint AddTo(uint[] x, int xOff, uint[] z, int zOff, uint cIn)
  {
    ...
    z[zOff + 4] = (uint) num5;
    return (uint) ((num5 >> 32 /*0x20*/) + ((ulong) x[xOff + 5] + (ulong) z[zOff + 5]));
  }
  ...
  {
    int num = Nat160.Gte(x, xOff, y, yOff) ? 1 : 0;
    if (num != 0)
    {
  ...
  public static void Mul(uint[] x, uint[] y, uint[] zz)
  {
    ...
    ulong num7 = (ulong) (0L + (long) num6 * (long) num1);
    zz[0] = (uint) num7;
    ulong num8 = (num7 >> 32 /*0x20*/) + num6 * num2;
    zz[1] = (uint) num8;
    ulong num9 = (num8 >> 32 /*0x20*/) + num6 * num3;
    zz[2] = (uint) num9;
    ulong num10 = (num9 >> 32 /*0x20*/) + num6 * num4;
    zz[3] = (uint) num10;
    ulong num11 = (num10 >> 32 /*0x20*/) + num6 * num5;
    zz[4] = (uint) num11;
    ulong num12 = num11 >> 32 /*0x20*/;
    zz[5] = (uint) num12;
    for (int index = 1; index < 5; ++index)
    {
      ulong num13 = (ulong) x[index];
      ulong num14 = (ulong) (0L + ((long) num13 * (long) num1 + (long) zz[index]));
      zz[index] = (uint) num14;
      ulong num15 = (num14 >> 32 /*0x20*/) + (num13 * num2 + (ulong) zz[index + 1]);
      zz[index + 1] = (uint) num15;
      ulong num16 = (num15 >> 32 /*0x20*/) + (num13 * num3 + (ulong) zz[index + 2]);
      zz[index + 2] = (uint) num16;
      ulong num17 = (num16 >> 32 /*0x20*/) + (num13 * num4 + (ulong) zz[index + 3]);
      zz[index + 3] = (uint) num17;
      ulong num18 = (num17 >> 32 /*0x20*/) + (num13 * num5 + (ulong) zz[index + 4]);
      zz[index + 4] = (uint) num18;
      ulong num19 = num18 >> 32 /*0x20*/;
      zz[index + 5] = (uint) num19;
    }
  }
  ...
  public static void Mul(uint[] x, int xOff, uint[] y, int yOff, uint[] zz, int zzOff)
  {
    ...
    ulong num12 = num11 >> 32 /*0x20*/;
    zz[zzOff + 5] = (uint) num12;
    for (int index = 1; index < 5; ++index)
    {
      ++zzOff;
      ulong num13 = (ulong) x[xOff + index];
      ulong num14 = (ulong) (0L + ((long) num13 * (long) num1 + (long) zz[zzOff]));
      zz[zzOff] = (uint) num14;
      ulong num15 = (num14 >> 32 /*0x20*/) + (num13 * num2 + (ulong) zz[zzOff + 1]);
      zz[zzOff + 1] = (uint) num15;
      ulong num16 = (num15 >> 32 /*0x20*/) + (num13 * num3 + (ulong) zz[zzOff + 2]);
      zz[zzOff + 2] = (uint) num16;
      ulong num17 = (num16 >> 32 /*0x20*/) + (num13 * num4 + (ulong) zz[zzOff + 3]);
      zz[zzOff + 3] = (uint) num17;
      ulong num18 = (num17 >> 32 /*0x20*/) + (num13 * num5 + (ulong) zz[zzOff + 4]);
      zz[zzOff + 4] = (uint) num18;
      ulong num19 = num18 >> 32 /*0x20*/;
      zz[zzOff + 5] = (uint) num19;
    }
  }
  ...
  public static uint MulAddTo(uint[] x, uint[] y, uint[] zz)
  {
    ...
    for (int index = 0; index < 5; ++index)
    {
      ulong num7 = (ulong) x[index];
      ulong num8 = (ulong) (0L + ((long) num7 * (long) num1 + (long) zz[index]));
      zz[index] = (uint) num8;
      ulong num9 = (num8 >> 32 /*0x20*/) + (num7 * num2 + (ulong) zz[index + 1]);
      zz[index + 1] = (uint) num9;
      ulong num10 = (num9 >> 32 /*0x20*/) + (num7 * num3 + (ulong) zz[index + 2]);
      zz[index + 2] = (uint) num10;
      ulong num11 = (num10 >> 32 /*0x20*/) + (num7 * num4 + (ulong) zz[index + 3]);
      zz[index + 3] = (uint) num11;
      ulong num12 = (num11 >> 32 /*0x20*/) + (num7 * num5 + (ulong) zz[index + 4]);
      zz[index + 4] = (uint) num12;
      ulong num13 = num12 >> 32 /*0x20*/;
      ulong num14 = num6 + (num13 + (ulong) zz[index + 5]);
  ...
  public static uint MulAddTo(uint[] x, int xOff, uint[] y, int yOff, uint[] zz, int zzOff)
  {
    ...
    for (int index = 0; index < 5; ++index)
    {
      ulong num7 = (ulong) x[xOff + index];
      ulong num8 = (ulong) (0L + ((long) num7 * (long) num1 + (long) zz[zzOff]));
      zz[zzOff] = (uint) num8;
      ulong num9 = (num8 >> 32 /*0x20*/) + (num7 * num2 + (ulong) zz[zzOff + 1]);
      zz[zzOff + 1] = (uint) num9;
      ulong num10 = (num9 >> 32 /*0x20*/) + (num7 * num3 + (ulong) zz[zzOff + 2]);
      zz[zzOff + 2] = (uint) num10;
      ulong num11 = (num10 >> 32 /*0x20*/) + (num7 * num4 + (ulong) zz[zzOff + 3]);
      zz[zzOff + 3] = (uint) num11;
      ulong num12 = (num11 >> 32 /*0x20*/) + (num7 * num5 + (ulong) zz[zzOff + 4]);
      zz[zzOff + 4] = (uint) num12;
      ulong num13 = num12 >> 32 /*0x20*/;
      ulong num14 = num6 + (num13 + (ulong) zz[zzOff + 5]);
  ...
  public static uint Mul33DWordAdd(uint x, ulong y, uint[] z, int zOff)
  {
    ...
    z[zOff + 3] = (uint) num8;
    return num8 >> 32 /*0x20*/ != 0UL ? Nat.IncAt(5, z, zOff, 4) : 0U;
  }
  ...
  public static uint Mul33WordAdd(uint x, uint y, uint[] z, int zOff)
  {
    ...
    z[zOff + 2] = (uint) num4;
    return num4 >> 32 /*0x20*/ != 0UL ? Nat.IncAt(5, z, zOff, 3) : 0U;
  }
  ...
  public static uint MulWordsAdd(uint x, uint y, uint[] z, int zOff)
  {
    ...
    z[zOff + 1] = (uint) num3;
    return num3 >> 32 /*0x20*/ != 0UL ? Nat.IncAt(5, z, zOff, 2) : 0U;
  }
  ...
  public static void Square(uint[] x, uint[] zz)
  {
    ...
    ulong num49 = num43 + ((num48 >> 32 /*0x20*/) + num39 * num26);
    ulong num50 = num42 + (num49 >> 32 /*0x20*/);
    uint num51 = (uint) num47;
    zz[5] = num51 << 1 | num46;
    uint num52 = num51 >> 31 /*0x1F*/;
    uint num53 = (uint) num48;
    zz[6] = num53 << 1 | num52;
    uint num54 = num53 >> 31 /*0x1F*/;
    uint num55 = (uint) num49;
    zz[7] = num55 << 1 | num54;
    uint num56 = num55 >> 31 /*0x1F*/;
    uint num57 = (uint) num50;
    zz[8] = num57 << 1 | num56;
    uint num58 = num57 >> 31 /*0x1F*/;
    uint num59 = zz[9] + (uint) (num50 >> 32 /*0x20*/);
    zz[9] = num59 << 1 | num58;
  }
  ...
  public static void Square(uint[] x, int xOff, uint[] zz, int zzOff)
  {
    ...
    ulong num50 = num42 + (num49 >> 32 /*0x20*/);
    uint num51 = (uint) num47;
    zz[zzOff + 5] = num51 << 1 | num46;
    uint num52 = num51 >> 31 /*0x1F*/;
    uint num53 = (uint) num48;
    zz[zzOff + 6] = num53 << 1 | num52;
    uint num54 = num53 >> 31 /*0x1F*/;
    uint num55 = (uint) num49;
    zz[zzOff + 7] = num55 << 1 | num54;
    uint num56 = num55 >> 31 /*0x1F*/;
    uint num57 = (uint) num50;
    zz[zzOff + 8] = num57 << 1 | num56;
    uint num58 = num57 >> 31 /*0x1F*/;
    uint num59 = zz[zzOff + 9] + (uint) (num50 >> 32 /*0x20*/);
    zz[zzOff + 9] = num59 << 1 | num58;
  }
