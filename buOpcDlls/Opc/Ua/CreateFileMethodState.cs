...
// Type: Opc.Ua.CreateFileMethodState
...
[ComVisible(true)]
public class CreateFileMethodState(NodeState parent) : MethodState(parent)
{
  ...
  {
    return (NodeState) new CreateFileMethodState(parent);
  }

  protected override void Initialize(ISystemContext context)
  {
    base.Initialize(context);
    this.Initialize(context, "");
