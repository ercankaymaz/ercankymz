...
// Type: Opc.Ua.AddCommentMethodState
...
[ComVisible(true)]
public class AddCommentMethodState(NodeState parent) : MethodState(parent)
{
  ...
  {
    return (NodeState) new AddCommentMethodState(parent);
  }

  protected override void Initialize(ISystemContext context)
  {
    base.Initialize(context);
    this.Initialize(context, "");
    ...
    IList<object> _outputArguments)
  {
    ...
    LocalizedText inputArgument2 = (LocalizedText) _inputArguments[1];
    if (this.OnCall != null)
