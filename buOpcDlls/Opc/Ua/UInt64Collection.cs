...
public class UInt64Collection : List<ulong>, ICloneable
{
  ...
  {
    return values != null ? new UInt64Collection((IEnumerable<ulong>) values) : new UInt64Collection();
  }

  public static implicit operator UInt64Collection(ulong[] values)
  {
    return UInt64Collection.ToUInt64Collection(values);
  }

  public virtual object Clone() => this.MemberwiseClone();

  public new object MemberwiseClone() => (object) new UInt64Collection((IEnumerable<ulong>) this);
}
