...
// Type: Opc.Ua.GenerateFileForReadMethodState
...
[ComVisible(true)]
public class GenerateFileForReadMethodState(NodeState parent) : MethodState(parent)
{
    ...
    IList<object> _outputArguments)
  {
    ...
    object inputArgument = _inputArguments[0];
    NodeId outputArgument1 = (NodeId) _outputArguments[0];
    uint outputArgument2 = (uint) _outputArguments[1];
    NodeId outputArgument3 = (NodeId) _outputArguments[2];
    if (this.OnCall != null)
      serviceResult = this.OnCall(_context, (MethodState) this, _objectId, inputArgument, ref outputArgument1, ref outputArgument2, ref outputArgument3);
