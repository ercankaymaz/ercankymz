...
// Type: Opc.Ua.MoveOrCopyMethodState
...
[ComVisible(true)]
public class MoveOrCopyMethodState(NodeState parent) : MethodState(parent)
{
  ...
  {
    return (NodeState) new MoveOrCopyMethodState(parent);
  }

  protected override void Initialize(ISystemContext context)
  {
    base.Initialize(context);
    this.Initialize(context, "");
    ...
    IList<object> _outputArguments)
  {
    ...
    bool inputArgument3 = (bool) _inputArguments[2];
    string inputArgument4 = (string) _inputArguments[3];
    NodeId outputArgument = (NodeId) _outputArguments[0];
    if (this.OnCall != null)
      serviceResult = this.OnCall(_context, (MethodState) this, _objectId, inputArgument1, inputArgument2, inputArgument3, inputArgument4, ref outputArgument);
