...
// Type: Opc.Ua.DeleteMonitoredItemsResponse
  ...
  IServiceResponse
{
  ...
  public DeleteMonitoredItemsResponse() => this.Initialize();
  ...
  public virtual ExpandedNodeId TypeId => (ExpandedNodeId) DataTypeIds.DeleteMonitoredItemsResponse;

  public virtual ExpandedNodeId BinaryEncodingId
  {
    get => (ExpandedNodeId) ObjectIds.DeleteMonitoredItemsResponse_Encoding_DefaultBinary;
  }

  public virtual ExpandedNodeId XmlEncodingId
  {
    get => (ExpandedNodeId) ObjectIds.DeleteMonitoredItemsResponse_Encoding_DefaultXml;
  }

  public virtual ExpandedNodeId JsonEncodingId
  {
    get => (ExpandedNodeId) ObjectIds.DeleteMonitoredItemsResponse_Encoding_DefaultJson;
  }
  ...
  {
    return this == encodeable || encodeable is DeleteMonitoredItemsResponse monitoredItemsResponse && Utils.IsEqual((object) this.m_responseHeader, (object) monitoredItemsResponse.m_responseHeader) && Utils.IsEqual((object) this.m_results, (object) monitoredItemsResponse.m_results) && Utils.IsEqual((object) this.m_diagnosticInfos, (object) monitoredItemsResponse.m_diagnosticInfos);
  }

  public virtual object Clone() => (object) (DeleteMonitoredItemsResponse) this.MemberwiseClone();

  public new object MemberwiseClone()
  {
    DeleteMonitoredItemsResponse monitoredItemsResponse = (DeleteMonitoredItemsResponse) base.MemberwiseClone();
    monitoredItemsResponse.m_responseHeader = (ResponseHeader) Utils.Clone((object) this.m_responseHeader);
    monitoredItemsResponse.m_results = (StatusCodeCollection) Utils.Clone((object) this.m_results);
