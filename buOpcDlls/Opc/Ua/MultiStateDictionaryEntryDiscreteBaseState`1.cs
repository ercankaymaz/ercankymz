...
// Type: Opc.Ua.MultiStateDictionaryEntryDiscreteBaseState`1
...
[ComVisible(true)]
public class MultiStateDictionaryEntryDiscreteBaseState<T> : 
  MultiStateDictionaryEntryDiscreteBaseState
{
