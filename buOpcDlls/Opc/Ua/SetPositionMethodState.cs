...
// Type: Opc.Ua.SetPositionMethodState
...
[ComVisible(true)]
public class SetPositionMethodState(NodeState parent) : MethodState(parent)
{
  ...
  {
    return (NodeState) new SetPositionMethodState(parent);
  }

  protected override void Initialize(ISystemContext context)
  {
    base.Initialize(context);
    this.Initialize(context, "");
    ...
    IList<object> _outputArguments)
  {
    ...
    ulong inputArgument2 = (ulong) _inputArguments[1];
    if (this.OnCall != null)
