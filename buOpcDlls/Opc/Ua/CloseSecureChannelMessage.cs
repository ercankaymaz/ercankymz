...
// Type: Opc.Ua.CloseSecureChannelMessage
...
public class CloseSecureChannelMessage : IServiceMessage
{
  ...
  public IServiceRequest GetRequest() => (IServiceRequest) this.CloseSecureChannelRequest;

  public object CreateResponse(IServiceResponse response)
  {
    if (!(response is CloseSecureChannelResponse CloseSecureChannelResponse))
    {
    ...
    return (object) new CloseSecureChannelResponseMessage(CloseSecureChannelResponse);
  }
}
