...
// Type: Opc.Ua.AddConnectionMethodState
...
[ComVisible(true)]
public class AddConnectionMethodState(NodeState parent) : MethodState(parent)
{
  ...
  {
    return (NodeState) new AddConnectionMethodState(parent);
  }

  protected override void Initialize(ISystemContext context)
  {
    base.Initialize(context);
    this.Initialize(context, "");
    ...
    IList<object> _outputArguments)
  {
    ...
    PubSubConnectionDataType encodeable = (PubSubConnectionDataType) ExtensionObject.ToEncodeable((ExtensionObject) _inputArguments[0]);
