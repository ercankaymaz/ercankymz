...
// Type: Opc.Ua.ProgramDiagnostic2Value
...
public class ProgramDiagnostic2Value : BaseVariableValue
{
  ...
  public ProgramDiagnostic2Value(
    ProgramDiagnostic2State variable,
    ...
    : base(dataLock)
  {
    ...
    if (this.m_value == null)
      this.m_value = new ProgramDiagnostic2DataType();
    this.Initialize(variable);
  }

  public ProgramDiagnostic2State Variable => this.m_variable;
  ...
  private void Initialize(ProgramDiagnostic2State variable)
  {
    lock (this.Lock)
    {
      ...
      BaseVariableState methodInputValues = (BaseVariableState) this.m_variable.LastMethodInputValues;
      if (methodInputValues != null)
      {
        methodInputValues.OnReadValue = new NodeValueEventHandler(this.OnRead_LastMethodInputValues);
        methodInputValues.OnWriteValue = new NodeValueEventHandler(this.OnWrite_LastMethodInputValues);
        updateList.Add((BaseInstanceState) methodInputValues);
      }
      BaseVariableState methodOutputValues = (BaseVariableState) this.m_variable.LastMethodOutputValues;
      if (methodOutputValues != null)
      {
        methodOutputValues.OnReadValue = new NodeValueEventHandler(this.OnRead_LastMethodOutputValues);
        methodOutputValues.OnWriteValue = new NodeValueEventHandler(this.OnWrite_LastMethodOutputValues);
        updateList.Add((BaseInstanceState) methodOutputValues);
      }
    ...
    ref DateTime timestamp)
  {
    lock (this.Lock)
    {
      ...
      if (!Utils.IsEqual((object) this.m_value, (object) newValue))
      {
        ...
        this.m_value = (ProgramDiagnostic2DataType) this.Write((object) newValue);
  ...
  private void UpdateChildrenChangeMasks(
    ISystemContext context,
    ref ProgramDiagnostic2DataType newValue,
    ref StatusCode statusCode,
    ref DateTime timestamp)
  {
    ...
    if (!Utils.IsEqual((object) this.m_value.LastMethodInputValues, (object) newValue.LastMethodInputValues))
      this.UpdateChildVariableStatus((BaseVariableState) this.m_variable.LastMethodInputValues, ref statusCode, ref timestamp);
    if (!Utils.IsEqual((object) this.m_value.LastMethodOutputValues, (object) newValue.LastMethodOutputValues))
      this.UpdateChildVariableStatus((BaseVariableState) this.m_variable.LastMethodOutputValues, ref statusCode, ref timestamp);
    ...
    ref DateTime timestamp)
  {
    ...
    {
      this.DoBeforeReadProcessing(context, node);
      BaseDataVariableState<NodeId> createSessionId = this.m_variable?.CreateSessionId;
    ...
    ref DateTime timestamp)
  {
    ...
    {
      this.DoBeforeReadProcessing(context, node);
      BaseDataVariableState<string> createClientName = this.m_variable?.CreateClientName;
    ...
    ref DateTime timestamp)
  {
    ...
    {
      this.DoBeforeReadProcessing(context, node);
      BaseDataVariableState<DateTime> invocationCreationTime = this.m_variable?.InvocationCreationTime;
    ...
    ref DateTime timestamp)
  {
    ...
    {
      this.DoBeforeReadProcessing(context, node);
      BaseDataVariableState<string> lastMethodCall = this.m_variable?.LastMethodCall;
    ...
    ref DateTime timestamp)
  {
    ...
    {
      this.DoBeforeReadProcessing(context, node);
      BaseDataVariableState<NodeId> lastMethodSessionId = this.m_variable?.LastMethodSessionId;
    ...
    ref DateTime timestamp)
  {
    ...
    {
      this.DoBeforeReadProcessing(context, node);
      BaseDataVariableState<Argument[]> methodInputArguments = this.m_variable?.LastMethodInputArguments;
    ...
    ref DateTime timestamp)
  {
    ...
    {
      this.DoBeforeReadProcessing(context, node);
      BaseDataVariableState<Argument[]> methodOutputArguments = this.m_variable?.LastMethodOutputArguments;
    ...
    ref DateTime timestamp)
  {
    ...
    {
      this.DoBeforeReadProcessing(context, node);
      BaseDataVariableState<object[]> methodInputValues = this.m_variable?.LastMethodInputValues;
      if (methodInputValues != null && StatusCode.IsBad(methodInputValues.StatusCode))
      {
        value = (object) null;
        statusCode = methodInputValues.StatusCode;
        return new ServiceResult(statusCode);
      }
      if (this.m_value != null)
        value = (object) this.m_value.LastMethodInputValues;
      ServiceResult status = this.Read(context, node, indexRange, dataEncoding, ref value, ref statusCode, ref timestamp);
      if (methodInputValues != null && ServiceResult.IsNotBad(status))
      {
        timestamp = methodInputValues.Timestamp;
        if (statusCode != methodInputValues.StatusCode)
        {
          statusCode = methodInputValues.StatusCode;
          status = new ServiceResult(statusCode);
        }
    ...
    ref DateTime timestamp)
  {
    ...
    {
      this.UpdateChildVariableStatus((BaseVariableState) this.m_variable.LastMethodInputValues, ref statusCode, ref timestamp);
      this.m_value.LastMethodInputValues = (VariantCollection) this.Write(value);
      this.UpdateParent(context, ref statusCode, ref timestamp);
    }
    return ServiceResult.Good;
  }
    ...
    ref DateTime timestamp)
  {
    ...
    {
      this.DoBeforeReadProcessing(context, node);
      BaseDataVariableState<object[]> methodOutputValues = this.m_variable?.LastMethodOutputValues;
      if (methodOutputValues != null && StatusCode.IsBad(methodOutputValues.StatusCode))
      {
        value = (object) null;
        statusCode = methodOutputValues.StatusCode;
        return new ServiceResult(statusCode);
      }
      if (this.m_value != null)
        value = (object) this.m_value.LastMethodOutputValues;
      ServiceResult status = this.Read(context, node, indexRange, dataEncoding, ref value, ref statusCode, ref timestamp);
      if (methodOutputValues != null && ServiceResult.IsNotBad(status))
      {
        timestamp = methodOutputValues.Timestamp;
        if (statusCode != methodOutputValues.StatusCode)
        {
          statusCode = methodOutputValues.StatusCode;
          status = new ServiceResult(statusCode);
        }
    ...
    ref DateTime timestamp)
  {
    ...
    {
      this.UpdateChildVariableStatus((BaseVariableState) this.m_variable.LastMethodOutputValues, ref statusCode, ref timestamp);
      this.m_value.LastMethodOutputValues = (VariantCollection) this.Write(value);
      this.UpdateParent(context, ref statusCode, ref timestamp);
    }
    return ServiceResult.Good;
  }
    ...
    ref DateTime timestamp)
  {
    ...
    {
      this.DoBeforeReadProcessing(context, node);
      BaseDataVariableState<DateTime> lastMethodCallTime = this.m_variable?.LastMethodCallTime;
    ...
    ref DateTime timestamp)
  {
    ...
    {
      this.DoBeforeReadProcessing(context, node);
      BaseDataVariableState<StatusCode> methodReturnStatus = this.m_variable?.LastMethodReturnStatus;
    ...
    ref DateTime timestamp)
  {
    ...
    {
      this.UpdateChildVariableStatus((BaseVariableState) this.m_variable.LastMethodReturnStatus, ref statusCode, ref timestamp);
      this.m_value.LastMethodReturnStatus = (StatusCode) this.Write(value);
      this.UpdateParent(context, ref statusCode, ref timestamp);
    }
    return ServiceResult.Good;
  }
