...
// Type: Opc.Ua.SubscriptionDiagnosticsArrayState
...
[ComVisible(true)]
public class SubscriptionDiagnosticsArrayState(NodeState parent) : 
  BaseDataVariableState<SubscriptionDiagnosticsDataType[]>(parent)
{
  ...
  {
    return NodeId.Create((object) 2171U, "http://opcfoundation.org/UA/", namespaceUris);
  }
  ...
  protected override void Initialize(ISystemContext context)
  {
    ...
    this.Initialize(context, "//////////8XYIkCAgAAAAAAKAAAAFN1YnNjcmlwdGlvbkRpYWdub3N0aWNzQXJyYXlUeXBlSW5zdGFuY2UBAHsIAQB7CHsIAAABAGoDAQAAAAEAAAAAAAAAAQH/////AAAAAA==");
