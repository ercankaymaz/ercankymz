...
// Type: Opc.Ua.ConditionRefreshMethodState
...
[ComVisible(true)]
public class ConditionRefreshMethodState(NodeState parent) : MethodState(parent)
{
  ...
  {
    return (NodeState) new ConditionRefreshMethodState(parent);
  }

  protected override void Initialize(ISystemContext context)
  {
    base.Initialize(context);
    this.Initialize(context, "");
