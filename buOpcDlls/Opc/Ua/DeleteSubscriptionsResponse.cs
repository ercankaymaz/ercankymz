...
// Type: Opc.Ua.DeleteSubscriptionsResponse
...
[ComVisible(true)]
public class DeleteSubscriptionsResponse : IEncodeable, ICloneable, IJsonEncodeable, IServiceResponse
{
  private ResponseHeader m_responseHeader;
  private StatusCodeCollection m_results;
  private DiagnosticInfoCollection m_diagnosticInfos;

  public DeleteSubscriptionsResponse() => this.Initialize();
  ...
  public virtual ExpandedNodeId TypeId => (ExpandedNodeId) DataTypeIds.DeleteSubscriptionsResponse;

  public virtual ExpandedNodeId BinaryEncodingId
  {
    get => (ExpandedNodeId) ObjectIds.DeleteSubscriptionsResponse_Encoding_DefaultBinary;
  }

  public virtual ExpandedNodeId XmlEncodingId
  {
    get => (ExpandedNodeId) ObjectIds.DeleteSubscriptionsResponse_Encoding_DefaultXml;
  }

  public virtual ExpandedNodeId JsonEncodingId
  {
    get => (ExpandedNodeId) ObjectIds.DeleteSubscriptionsResponse_Encoding_DefaultJson;
  }
  ...
  {
    return this == encodeable || encodeable is DeleteSubscriptionsResponse subscriptionsResponse && Utils.IsEqual((object) this.m_responseHeader, (object) subscriptionsResponse.m_responseHeader) && Utils.IsEqual((object) this.m_results, (object) subscriptionsResponse.m_results) && Utils.IsEqual((object) this.m_diagnosticInfos, (object) subscriptionsResponse.m_diagnosticInfos);
  }

  public virtual object Clone() => (object) (DeleteSubscriptionsResponse) this.MemberwiseClone();

  public new object MemberwiseClone()
  {
    DeleteSubscriptionsResponse subscriptionsResponse = (DeleteSubscriptionsResponse) base.MemberwiseClone();
    subscriptionsResponse.m_responseHeader = (ResponseHeader) Utils.Clone((object) this.m_responseHeader);
    subscriptionsResponse.m_results = (StatusCodeCollection) Utils.Clone((object) this.m_results);
