...
// Type: Opc.Ua.PubSubGroupTypeRemoveReaderMethodState
...
[ComVisible(true)]
public class PubSubGroupTypeRemoveReaderMethodState(NodeState parent) : MethodState(parent)
{
  ...
  {
    return (NodeState) new PubSubGroupTypeRemoveReaderMethodState(parent);
  }

  protected override void Initialize(ISystemContext context)
  {
    base.Initialize(context);
    this.Initialize(context, "");
