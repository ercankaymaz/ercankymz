...
// Type: Opc.Ua.SessionSecurityDiagnosticsArrayState
...
[ComVisible(true)]
public class SessionSecurityDiagnosticsArrayState(NodeState parent) : 
  BaseDataVariableState<SessionSecurityDiagnosticsDataType[]>(parent)
{
  ...
  {
    return NodeId.Create((object) 2243U, "http://opcfoundation.org/UA/", namespaceUris);
  }
  ...
  protected override void Initialize(ISystemContext context)
  {
    ...
    this.Initialize(context, "//////////8XYIkCAgAAAAAAKwAAAFNlc3Npb25TZWN1cml0eURpYWdub3N0aWNzQXJyYXlUeXBlSW5zdGFuY2UBAMMIAQDDCMMIAAABAGQDAQAAAAEAAAAAAAAAAQH/////AAAAAA==");
