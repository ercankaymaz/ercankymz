...
// Type: Opc.Ua.GetEndpointsMessage
...
public class GetEndpointsMessage : IServiceMessage
{
  ...
  public IServiceRequest GetRequest() => (IServiceRequest) this.GetEndpointsRequest;

  public object CreateResponse(IServiceResponse response)
  {
    if (!(response is GetEndpointsResponse GetEndpointsResponse))
    {
      GetEndpointsResponse = new GetEndpointsResponse();
      GetEndpointsResponse.ResponseHeader = ((ServiceFault) response).ResponseHeader;
    }
    return (object) new GetEndpointsResponseMessage(GetEndpointsResponse);
  }
}
