...
// Type: Opc.Ua.ConditionRefresh2MethodState
...
[ComVisible(true)]
public class ConditionRefresh2MethodState(NodeState parent) : MethodState(parent)
{
  ...
  {
    return (NodeState) new ConditionRefresh2MethodState(parent);
  }

  protected override void Initialize(ISystemContext context)
  {
    base.Initialize(context);
    this.Initialize(context, "");
