...
public class RepublishMessage : IServiceMessage
{
  ...
  public IServiceRequest GetRequest() => (IServiceRequest) this.RepublishRequest;

  public object CreateResponse(IServiceResponse response)
  {
    if (!(response is RepublishResponse RepublishResponse))
    {
      RepublishResponse = new RepublishResponse();
      RepublishResponse.ResponseHeader = ((ServiceFault) response).ResponseHeader;
    }
    return (object) new RepublishResponseMessage(RepublishResponse);
  }
}
