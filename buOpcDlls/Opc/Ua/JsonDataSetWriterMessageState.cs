...
// Type: Opc.Ua.JsonDataSetWriterMessageState
...
[ComVisible(true)]
public class JsonDataSetWriterMessageState(NodeState parent) : DataSetWriterMessageState(parent)
{
  ...
  {
    return NodeId.Create((object) 21128U, "http://opcfoundation.org/UA/", namespaceUris);
  }

  protected override void Initialize(ISystemContext context)
  {
    base.Initialize(context);
    this.Initialize(context, "//////////8EYIACAQAAAAAAJAAAAEpzb25EYXRhU2V0V3JpdGVyTWVzc2FnZVR5cGVJbnN0YW5jZQEAiFIBAIhSiFIAAP////8BAAAAFWCJCgIAAAAAABkAAABEYXRhU2V0TWVzc2FnZUNvbnRlbnRNYXNrAQCJUgAuAESJUgAAAQAqPf////8BAf////8AAAAA");
