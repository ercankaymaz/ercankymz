...
// Type: Opc.Ua.AddCertificateMethodState
...
[ComVisible(true)]
public class AddCertificateMethodState(NodeState parent) : MethodState(parent)
{
  ...
  {
    return (NodeState) new AddCertificateMethodState(parent);
  }

  protected override void Initialize(ISystemContext context)
  {
    base.Initialize(context);
    this.Initialize(context, "");
    ...
    IList<object> _outputArguments)
  {
    ...
    byte[] inputArgument1 = (byte[]) _inputArguments[0];
