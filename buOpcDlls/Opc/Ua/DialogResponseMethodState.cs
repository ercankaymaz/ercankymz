...
// Type: Opc.Ua.DialogResponseMethodState
...
[ComVisible(true)]
public class DialogResponseMethodState(NodeState parent) : MethodState(parent)
{
  ...
  {
    return (NodeState) new DialogResponseMethodState(parent);
  }

  protected override void Initialize(ISystemContext context)
  {
    base.Initialize(context);
    this.Initialize(context, "");
    ...
    IList<object> _outputArguments)
  {
    ...
    int inputArgument = (int) _inputArguments[0];
    if (this.OnCall != null)
