...
// Type: Opc.Ua.ModifyMonitoredItemsResponse
  ...
  IServiceResponse
{
  ...
  public ModifyMonitoredItemsResponse() => this.Initialize();
  ...
  private void Initialize()
  {
    ...
    this.m_results = new MonitoredItemModifyResultCollection();
  ...
  public virtual ExpandedNodeId TypeId => (ExpandedNodeId) DataTypeIds.ModifyMonitoredItemsResponse;

  public virtual ExpandedNodeId BinaryEncodingId
  {
    get => (ExpandedNodeId) ObjectIds.ModifyMonitoredItemsResponse_Encoding_DefaultBinary;
  }

  public virtual ExpandedNodeId XmlEncodingId
  {
    get => (ExpandedNodeId) ObjectIds.ModifyMonitoredItemsResponse_Encoding_DefaultXml;
  }

  public virtual ExpandedNodeId JsonEncodingId
  {
    get => (ExpandedNodeId) ObjectIds.ModifyMonitoredItemsResponse_Encoding_DefaultJson;
  }
  ...
  public virtual void Encode(IEncoder encoder)
  {
    ...
    encoder.WriteEncodeableArray("Results", (IList<IEncodeable>) this.Results.ToArray(), typeof (MonitoredItemModifyResult));
  ...
  public virtual void Decode(IDecoder decoder)
  {
    ...
    this.Results = (MonitoredItemModifyResultCollection) (MonitoredItemModifyResult[]) decoder.ReadEncodeableArray("Results", typeof (MonitoredItemModifyResult));
