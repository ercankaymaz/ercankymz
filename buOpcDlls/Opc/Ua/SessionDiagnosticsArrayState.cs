...
// Type: Opc.Ua.SessionDiagnosticsArrayState
...
[ComVisible(true)]
public class SessionDiagnosticsArrayState(NodeState parent) : 
  BaseDataVariableState<SessionDiagnosticsDataType[]>(parent)
{
  ...
  {
    return NodeId.Create((object) 2196U, "http://opcfoundation.org/UA/", namespaceUris);
  }
  ...
  protected override void Initialize(ISystemContext context)
  {
    ...
    this.Initialize(context, "//////////8XYIkCAgAAAAAAIwAAAFNlc3Npb25EaWFnbm9zdGljc0FycmF5VHlwZUluc3RhbmNlAQCUCAEAlAiUCAAAAQBhAwEAAAABAAAAAAAAAAEB/////wAAAAA=");
