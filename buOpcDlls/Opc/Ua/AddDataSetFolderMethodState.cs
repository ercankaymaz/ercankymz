...
// Type: Opc.Ua.AddDataSetFolderMethodState
...
[ComVisible(true)]
public class AddDataSetFolderMethodState(NodeState parent) : MethodState(parent)
{
  ...
  {
    return (NodeState) new AddDataSetFolderMethodState(parent);
  }

  protected override void Initialize(ISystemContext context)
  {
    base.Initialize(context);
    this.Initialize(context, "");
