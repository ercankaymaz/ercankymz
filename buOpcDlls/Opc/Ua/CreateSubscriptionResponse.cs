...
// Type: Opc.Ua.CreateSubscriptionResponse
...
public class CreateSubscriptionResponse : IEncodeable, ICloneable, IJsonEncodeable, IServiceResponse
{
  ...
  public CreateSubscriptionResponse() => this.Initialize();
  ...
  public virtual ExpandedNodeId TypeId => (ExpandedNodeId) DataTypeIds.CreateSubscriptionResponse;

  public virtual ExpandedNodeId BinaryEncodingId
  {
    get => (ExpandedNodeId) ObjectIds.CreateSubscriptionResponse_Encoding_DefaultBinary;
  }

  public virtual ExpandedNodeId XmlEncodingId
  {
    get => (ExpandedNodeId) ObjectIds.CreateSubscriptionResponse_Encoding_DefaultXml;
  }

  public virtual ExpandedNodeId JsonEncodingId
  {
    get => (ExpandedNodeId) ObjectIds.CreateSubscriptionResponse_Encoding_DefaultJson;
  }
  ...
  {
    return this == encodeable || encodeable is CreateSubscriptionResponse subscriptionResponse && Utils.IsEqual((object) this.m_responseHeader, (object) subscriptionResponse.m_responseHeader) && Utils.IsEqual((object) this.m_subscriptionId, (object) subscriptionResponse.m_subscriptionId) && Utils.IsEqual((object) this.m_revisedPublishingInterval, (object) subscriptionResponse.m_revisedPublishingInterval) && Utils.IsEqual((object) this.m_revisedLifetimeCount, (object) subscriptionResponse.m_revisedLifetimeCount) && Utils.IsEqual((object) this.m_revisedMaxKeepAliveCount, (object) subscriptionResponse.m_revisedMaxKeepAliveCount);
  }

  public virtual object Clone() => (object) (CreateSubscriptionResponse) this.MemberwiseClone();

  public new object MemberwiseClone()
  {
    CreateSubscriptionResponse subscriptionResponse = (CreateSubscriptionResponse) base.MemberwiseClone();
    subscriptionResponse.m_responseHeader = (ResponseHeader) Utils.Clone((object) this.m_responseHeader);
    subscriptionResponse.m_subscriptionId = (uint) Utils.Clone((object) this.m_subscriptionId);
