...
public interface ISessionChannel : IChannelBase
{
  ...
  Task<CreateMonitoredItemsResponseMessage> CreateMonitoredItemsAsync(
    CreateMonitoredItemsMessage request);
  ...
  Task<ModifyMonitoredItemsResponseMessage> ModifyMonitoredItemsAsync(
    ModifyMonitoredItemsMessage request);
  ...
  Task<DeleteMonitoredItemsResponseMessage> DeleteMonitoredItemsAsync(
    DeleteMonitoredItemsMessage request);
  ...
  Task<TransferSubscriptionsResponseMessage> TransferSubscriptionsAsync(
    TransferSubscriptionsMessage request);
  ...
  Task<DeleteSubscriptionsResponseMessage> DeleteSubscriptionsAsync(
    DeleteSubscriptionsMessage request);
}
