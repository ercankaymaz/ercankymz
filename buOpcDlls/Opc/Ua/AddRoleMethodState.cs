...
// Type: Opc.Ua.AddRoleMethodState
...
[ComVisible(true)]
public class AddRoleMethodState(NodeState parent) : MethodState(parent)
{
  ...
  {
    return (NodeState) new AddRoleMethodState(parent);
  }

  protected override void Initialize(ISystemContext context)
  {
    base.Initialize(context);
    this.Initialize(context, "");
