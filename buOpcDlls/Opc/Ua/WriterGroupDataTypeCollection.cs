...
// Type: Opc.Ua.WriterGroupDataTypeCollection
...
public class WriterGroupDataTypeCollection : List<WriterGroupDataType>, ICloneable
{
  ...
  {
    return values != null ? new WriterGroupDataTypeCollection((IEnumerable<WriterGroupDataType>) values) : new WriterGroupDataTypeCollection();
  }
  ...
  public object Clone() => (object) (WriterGroupDataTypeCollection) this.MemberwiseClone();

  public new object MemberwiseClone()
  {
    WriterGroupDataTypeCollection dataTypeCollection = new WriterGroupDataTypeCollection(this.Count);
    for (int index = 0; index < this.Count; ++index)
      dataTypeCollection.Add((WriterGroupDataType) Utils.Clone((object) this[index]));
