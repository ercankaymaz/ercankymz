...
{
  public static NodeState Construct(NodeState parent) => (NodeState) new PropertyTypeState();

  protected override void Initialize(ISystemContext context)
  {
    this.SuperTypeId = NodeId.Create((object) 62U, "http://opcfoundation.org/UA/", context.NamespaceUris);
    this.NodeId = NodeId.Create((object) 68U, "http://opcfoundation.org/UA/", context.NamespaceUris);
    this.BrowseName = QualifiedName.Create("PropertyType", "http://opcfoundation.org/UA/", context.NamespaceUris);
    this.DisplayName = new LocalizedText("PropertyType", string.Empty, "PropertyType");
