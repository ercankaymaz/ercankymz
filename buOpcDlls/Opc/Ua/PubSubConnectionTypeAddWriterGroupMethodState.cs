...
// Type: Opc.Ua.PubSubConnectionTypeAddWriterGroupMethodState
...
[ComVisible(true)]
public class PubSubConnectionTypeAddWriterGroupMethodState(NodeState parent) : MethodState(parent)
{
  ...
  {
    return (NodeState) new PubSubConnectionTypeAddWriterGroupMethodState(parent);
  }

  protected override void Initialize(ISystemContext context)
  {
    base.Initialize(context);
    this.Initialize(context, "");
    ...
    IList<object> _outputArguments)
  {
    ...
    WriterGroupDataType encodeable = (WriterGroupDataType) ExtensionObject.ToEncodeable((ExtensionObject) _inputArguments[0]);
