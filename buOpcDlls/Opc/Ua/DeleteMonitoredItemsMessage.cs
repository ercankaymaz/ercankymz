...
// Type: Opc.Ua.DeleteMonitoredItemsMessage
...
public class DeleteMonitoredItemsMessage : IServiceMessage
{
  ...
  public IServiceRequest GetRequest() => (IServiceRequest) this.DeleteMonitoredItemsRequest;

  public object CreateResponse(IServiceResponse response)
  {
    if (!(response is DeleteMonitoredItemsResponse DeleteMonitoredItemsResponse))
    {
    ...
    return (object) new DeleteMonitoredItemsResponseMessage(DeleteMonitoredItemsResponse);
  }
}
