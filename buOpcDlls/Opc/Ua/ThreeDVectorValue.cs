...
public class ThreeDVectorValue : BaseVariableValue
{
    ...
    : base(dataLock)
  {
    ...
    if (this.m_value == null)
      this.m_value = new ThreeDVector();
    this.Initialize(variable);
  }

  public ThreeDVectorState Variable => this.m_variable;
  ...
  private void Initialize(ThreeDVectorState variable)
  {
    lock (this.Lock)
    {
      ...
      variable.Value = (Vector) this.m_value;
    ...
    ref DateTime timestamp)
  {
    lock (this.Lock)
    {
      ...
      if (!Utils.IsEqual((object) this.m_value, (object) newValue))
      {
        ...
        this.m_value = (ThreeDVector) this.Write((object) newValue);
