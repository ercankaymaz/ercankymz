...
[ComVisible(true)]
public class OpenMethodState(NodeState parent) : MethodState(parent)
{
  ...
  {
    return (NodeState) new OpenMethodState(parent);
  }

  protected override void Initialize(ISystemContext context)
  {
    base.Initialize(context);
    this.Initialize(context, "");
    ...
    IList<object> _outputArguments)
  {
    ...
    byte inputArgument = (byte) _inputArguments[0];
