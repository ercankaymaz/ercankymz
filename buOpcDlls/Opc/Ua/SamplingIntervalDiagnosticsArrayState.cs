...
// Type: Opc.Ua.SamplingIntervalDiagnosticsArrayState
...
[ComVisible(true)]
public class SamplingIntervalDiagnosticsArrayState(NodeState parent) : 
  BaseDataVariableState<SamplingIntervalDiagnosticsDataType[]>(parent)
{
  ...
  {
    return NodeId.Create((object) 2164U, "http://opcfoundation.org/UA/", namespaceUris);
  }
  ...
  protected override void Initialize(ISystemContext context)
  {
    ...
    this.Initialize(context, "//////////8XYIkCAgAAAAAALAAAAFNhbXBsaW5nSW50ZXJ2YWxEaWFnbm9zdGljc0FycmF5VHlwZUluc3RhbmNlAQB0CAEAdAh0CAAAAQBYAwEAAAABAAAAAAAAAAEB/////wAAAAA=");
