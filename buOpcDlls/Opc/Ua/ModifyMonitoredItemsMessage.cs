...
// Type: Opc.Ua.ModifyMonitoredItemsMessage
...
public class ModifyMonitoredItemsMessage : IServiceMessage
{
  ...
  public IServiceRequest GetRequest() => (IServiceRequest) this.ModifyMonitoredItemsRequest;

  public object CreateResponse(IServiceResponse response)
  {
    if (!(response is ModifyMonitoredItemsResponse ModifyMonitoredItemsResponse))
    {
    ...
    return (object) new ModifyMonitoredItemsResponseMessage(ModifyMonitoredItemsResponse);
  }
}
