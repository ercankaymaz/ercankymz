...
// Type: Opc.Ua.UnsignedRationalNumberCollection
...
public class UnsignedRationalNumberCollection : List<UnsignedRationalNumber>, ICloneable
{
  ...
  {
    return values != null ? new UnsignedRationalNumberCollection((IEnumerable<UnsignedRationalNumber>) values) : new UnsignedRationalNumberCollection();
  }
  ...
  public object Clone() => (object) (UnsignedRationalNumberCollection) this.MemberwiseClone();

  public new object MemberwiseClone()
  {
    UnsignedRationalNumberCollection numberCollection = new UnsignedRationalNumberCollection(this.Count);
    for (int index = 0; index < this.Count; ++index)
      numberCollection.Add((UnsignedRationalNumber) Utils.Clone((object) this[index]));
