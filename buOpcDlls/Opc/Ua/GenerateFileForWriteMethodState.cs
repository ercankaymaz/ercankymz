...
// Type: Opc.Ua.GenerateFileForWriteMethodState
...
[ComVisible(true)]
public class GenerateFileForWriteMethodState(NodeState parent) : MethodState(parent)
{
  ...
  {
    return (NodeState) new GenerateFileForWriteMethodState(parent);
  }

  protected override void Initialize(ISystemContext context)
  {
    base.Initialize(context);
    this.Initialize(context, "");
