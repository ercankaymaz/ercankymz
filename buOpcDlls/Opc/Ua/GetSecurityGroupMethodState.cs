...
// Type: Opc.Ua.GetSecurityGroupMethodState
...
[ComVisible(true)]
public class GetSecurityGroupMethodState(NodeState parent) : MethodState(parent)
{
  ...
  {
    return (NodeState) new GetSecurityGroupMethodState(parent);
  }

  protected override void Initialize(ISystemContext context)
  {
    base.Initialize(context);
    this.Initialize(context, "");
