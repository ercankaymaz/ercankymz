...
[ComVisible(true)]
public class WriteMethodState(NodeState parent) : MethodState(parent)
{
  ...
  {
    return (NodeState) new WriteMethodState(parent);
  }

  protected override void Initialize(ISystemContext context)
  {
    base.Initialize(context);
    this.Initialize(context, "");
